...
Begin VB.Form frmOSMS_PurchaseOrder 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "PurchaseOrder.frx":1B5D
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":1CAF
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "PurchaseOrder.frx":2D89
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":2EDB
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "PurchaseOrder.frx":3239
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":338B
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "PurchaseOrder.frx":3685
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":37D7
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "PurchaseOrder.frx":3B2F
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":3C81
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         Picture         =   "PurchaseOrder.frx":3FE0
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Left            =   2580
         MaskColor       =   &H0000FFFF&
         Picture         =   "PurchaseOrder.frx":430B
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Left            =   1680
         MaskColor       =   &H0000FFFF&
         Picture         =   "PurchaseOrder.frx":4649
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstPO_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "PurchaseOrder.frx":49CF
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   690
         MouseIcon       =   "PurchaseOrder.frx":4B31
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":4C83
         Style           =   1  'Graphical
         TabIndex        =   80
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   -90
         MouseIcon       =   "PurchaseOrder.frx":4FC1
         MousePointer    =   99  'Custom
         Picture         =   "PurchaseOrder.frx":5113
         Style           =   1  'Graphical
         TabIndex        =   81
   ...
   End
End
Attribute VB_Name = "frmOSMS_PurchaseOrder"
...
Dim SUPPLIER_VAT                                       As Integer
Attribute SUPPLIER_VAT.VB_VarUserMemId = 1073938455
...
'UPDATED MARCH 13, 2007 ERROR, INVALID FIELD NAME    - 20070313
...
Private Sub chkUseHARIDNP_Click()
    ...
    If chkUseHARIDNP.Value = 1 Then
        ...
        If Not rsDNPP.EOF And Not rsDNPP.BOF Then
            ...
            'txtUnitCost.Text = N2Str2Zero(rsDNPP!DNPP)
            If ISNONVAT = True Then
                txtUnitCost.Text = ToDoubleNumber(NumericVal(txtTranINVAmt.Text))
            Else
                txtUnitCost.Text = ToDoubleNumber(NumericVal(txtTranINVAmt.Text) / ConvertToBIRDecimalFormat(12))
            End If
...
Private Sub cmdCancelPO_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Cancel this Transactions?", "Cancel Transactions") = True Then
        gconDMIS.Execute "update OSMS_PO_HD set" & _
                       " status = 'C'," & _
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            ...
            rsPO_HDDup.Open "select pono from OSMS_PO_HD where [TYPE] = 'A' AND pono = '" & txtPONo.Text & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    ...
    Dim T_TPOQTY, TPO_T_ONORDER                        As Long
    Dim rsPMIS_AccessoriesClone                        As ADODB.Recordset
    ...
    Dim VTXTShipTo, VTXTSHP_Addrs1, VTXTPO_Amount      As String
    ...
    If AddorEdit = "ADD" Then
        'MODIFIED: FML - 04272007
        gconDMIS.Execute "Insert into OSMS_PO_HD" & _
    ...
    Else
        ...
        gconDMIS.Execute "update PMIS_Tdaytran set" & _
                       ...
                       " tranno = " & VTXTPONo & _
                       " where [TYPE] = 'A' AND tranno = '" & PrevPONO & "'"
...
Sub rsRefresh()
    ...
    rsPO_HD.Open "select * from OSMS_PO_HD order by pono asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub FillDetails()
    ...
    If Not rsPMIS_Tdaytran.EOF And Not rsPMIS_Tdaytran.BOF Then
        ...
        If ISNONVAT = True Then PO_TOTVAT = 0 Else PO_TOTVAT = PO_TOTINVAMT - (PO_TOTINVAMT / ConvertToBIRDecimalFormat(12))
...
Function SetPartIDPartNo(DDD As String)
    Set rsPMIS_Accessories = New ADODB.Recordset
    rsPMIS_Accessories.Open "Select id,partno from PMIS_Accessories where partno = '" & DDD & "'", gconDMIS
    If Not rsPMIS_Accessories.EOF And Not rsPMIS_Accessories.BOF Then
...
Function StorePartsEntry(ByVal ID As Variant)
    ...
    If Not rsPMIS_Tdaytran.EOF And Not rsPMIS_Tdaytran.BOF Then
        ...
        txtTranItemNo.Text = Null2String(rsPMIS_Tdaytran!itemno)
...
Private Sub grdDetails_DblClick()
    If Null2String(rsPO_HD!Status) = "P" Then
        MsgSpeechBox "Item are Already Posted and cannot be edited"
    ElseIf Null2String(rsPO_HD!Status) = "C" Then
        MsgSpeechBox "Item are Already Cancelled and cannot be edited"
    Else
        Dim fild                                       As String
        grdDetails.Row = grdDetails.Row
        grdDetails.Col = 0
...
Private Sub txtPONo_LostFocus()
    If Frame1.Enabled = True Then
        ...
        If Len(txtPONo.Text) >= 3 Then
            Set rsPO_HDDup = New ADODB.Recordset
            rsPO_HDDup.Open "select pono from OSMS_PO_HD where [TYPE] = 'A' AND pono = '" & txtPONo.Text & "'", gconDMIS
            If Not rsPO_HDDup.EOF And Not rsPO_HDDup.BOF Then
...
Private Sub txttranQty_Change()
    If txtTranQty.Text <> "" Then
        ...
        Else
            txtTranINVAmt.Text = ToDoubleNumber(NumericVal(txtUnitCost.Text) * ConvertToBIRDecimalFormat(12))
        End If
...
Sub FillGrid()
    ...
    Set rsPO_HD = New ADODB.Recordset
    Set rsPO_HD = gconDMIS.Execute("select pono,pono from OSMS_PO_HD WHERE [TYPE] = 'A' order by pono asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsPO_HD = gconDMIS.Execute("select pono, pono from OSMS_PO_HD where [TYPE] = 'A' AND pono like'" & XXX & "%'")
    If Not (rsPO_HD.EOF And rsPO_HD.BOF) Then
...
Sub FillGrid2()
    ...
    lstPO_HD.Sorted = False: lstPO_HD.ListItems.Clear
    Set rsPO_HD = New ADODB.Recordset
    Set rsPO_HD = gconDMIS.Execute("select supname, pono from OSMS_PO_HD where [TYPE] = 'A' order by pono asc")
    If Not (rsPO_HD.EOF And rsPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, rsPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set rsPO_HD = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsPO_HD = gconDMIS.Execute("select supname, pono from OSMS_PO_HD where [TYPE] = 'A' AND supname like '" & XXX & "%' order by pono asc")
    If Not (rsPO_HD.EOF And rsPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, rsPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
'UPDATED FOR DMIS 2.0 PURCHASE ORDER FORMAT
Sub FillCboModel()
