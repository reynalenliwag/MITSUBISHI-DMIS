...
Private Sub cmdOk_Click()
    ...
    With wizVar
        ...
        If CHANGE_USER = True Then
            rsAccess.Open "select * from ALL_Rams_Users where user_name = '" & labUserName.Caption & "'", gconDMIS, adOpenKeyset
        Else
...
10:
    ...
    If OpenConnection = True Then
        ...
        If CHANGE_USER = True Then
            rsAccess.Open "Select User_name from All_RAMS_USERs WHERE USERGROUP='SDM' and LOCK=0 Order by User_Name Asc", gconDMIS, adOpenKeyset
        Else
        ...
        Else                                                 'USERCODE,USERNAME,PASSWORD,USERGROUP
            If CHANGE_USER = True Then
                gconDMIS.Execute ("INSERT INTO ALL_RAMS_USERS (USERCODE,USER_NAME,PASSWORD,USERGROUP,LOCK) values('AD" & Left(Day(Now), 1) & "' ,'ADMIN','616C6Fñ™Æùù','SDM',0)")
            Else
