...
Begin VB.Form frmCMISBankDeposit 
   ...
   Begin VB.PictureBox picBankDepo 
      ...
      Begin VB.ComboBox cboCheckTransactions 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "BankDeposit.frx":0D47
         Left            =   1590
         List            =   "BankDeposit.frx":0D49
         Sorted          =   -1  'True
      ...
      Begin MSFlexGridLib.MSFlexGrid grdCheckCardTransactions 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "BankDeposit.frx":0D4B
      End
      ...
      Begin VB.CommandButton cmdCancelBANKDEPO 
         ...
         Height          =   795
         Left            =   8100
         MouseIcon       =   "BankDeposit.frx":1065
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":11B7
         Style           =   1  'Graphical
         TabIndex        =   66
         Top             =   5670
         Width           =   705
      ...
      Begin VB.CommandButton cmdSaveBANKDEPO 
         ...
         Height          =   795
         Left            =   7410
         MouseIcon       =   "BankDeposit.frx":14F5
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":1647
         Style           =   1  'Graphical
         TabIndex        =   68
         Top             =   5670
         Width           =   705
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   3510
         MouseIcon       =   "BankDeposit.frx":1997
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":1AE9
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   2820
         MouseIcon       =   "BankDeposit.frx":1E4F
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":1FA1
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   2130
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "BankDeposit.frx":2307
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":2459
         Style           =   1  'Graphical
         TabIndex        =   53
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "BankDeposit.frx":277E
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":28D0
         Style           =   1  'Graphical
         TabIndex        =   50
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "BankDeposit.frx":2C2C
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":2D7E
         Style           =   1  'Graphical
         TabIndex        =   51
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "BankDeposit.frx":3091
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":31E3
         Style           =   1  'Graphical
         TabIndex        =   52
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstBANKDEPO 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "BankDeposit.frx":34DD
         NumItems        =   2
    ...
    If cboType.Text = "CARD" Then
        ...
        If Not rsCHECKDet.EOF And Not rsCHECKDet.BOF Then
            ...
            Do While Not rsCHECKDet.EOF
                ...
                grdCheckCardTransactions.AddItem " " & Null2String(rsCHECKDet!CUSCDE) & Chr(9) & " " & Null2String(rsCHECKDet!cusname) & Chr(9) & Null2String(rsCHECKDet!DATECREATE) & Chr(9) & ToDoubleNumber(N2Str2Zero(rsCHECKDet!cardamount)) & Chr(9) & rsCHECKDet!Id
    ...
    If cboType.Text = "CASH" Then
        ...
        If Not rsCHECKDet.EOF And Not rsCHECKDet.BOF Then
            ...
            Do While Not rsCHECKDet.EOF
                ...
                grdCheckCardTransactions.AddItem " " & Null2String(rsCHECKDet!CUSCDE) & Chr(9) & " " & Null2String(rsCHECKDet!cusname) & Chr(9) & Null2String(rsCHECKDet!DATECREATE) & Chr(9) & ToDoubleNumber(N2Str2Zero(rsCHECKDet!CashAmount)) & Chr(9) & rsCHECKDet!Id
        ...
        If cboType.Text = "CHECK" Then
            ...
            If Not rsCHECKDet.EOF And Not rsCHECKDet.BOF Then
                ...
                Do While Not rsCHECKDet.EOF
                    ...
                    grdCheckCardTransactions.AddItem " " & Null2String(rsCHECKDet!bankcode) & Chr(9) & " " & SetBankName(Null2String(rsCHECKDet!bankcode)) & Chr(9) & Null2String(rsCHECKDet!TimeCreate) & Chr(9) & ToDoubleNumber(N2Str2Zero(rsCHECKDet!ChkAmount)) & Chr(9) & rsCHECKDet!Id
