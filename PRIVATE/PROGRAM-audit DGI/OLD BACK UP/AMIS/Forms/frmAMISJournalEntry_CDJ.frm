...
SaveJournalDetails:
                ...
                If COMPANY_CODE = "HAI" Or COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Then
                    ...
                    Else
                        ...
                        Set rsDet = gconDMIS.Execute("Select Acct_code,acct_name from AMIS_journal_det DET where voucherno =" & PV_MRRNO & " and jtype ='APJ' AND CREDIT <> 0 ORDER BY ACCT_CODE")
