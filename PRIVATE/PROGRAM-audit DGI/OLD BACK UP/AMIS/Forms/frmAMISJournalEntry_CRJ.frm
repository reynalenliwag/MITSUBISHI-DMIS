   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_CRJ.frx":68CB
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_CRJ.frx":6962
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
        ...
        If xJOURNALTYPE = "CRJ" Then
            ...
            If Not rsMULTI_ACCT_CODE.EOF And Not rsMULTI_ACCT_CODE.BOF Then
                ...
                Else
                    ...
                    rsAcctCode.Open "SELECT VOUCHERNO,ACCT_CODE,JTYPE FROM AMIS_JOURNAL_DET DET INNER JOIN AMIS_CHARTACCOUNT AC ON DET.ACCT_CODE=AC.ACCTCODE WHERE DET.VOUCHERNO = '" & txtVoucherNo.Text & "' AND DET.JTYPE='" & xJOURNALTYPE & "' AND IS_SCHEDULE_ACCNT=1 AND DET.CREDIT <>0", gconDMIS, adOpenForwardOnly
