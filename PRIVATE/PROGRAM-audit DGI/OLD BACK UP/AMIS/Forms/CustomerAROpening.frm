...
Begin VB.Form frmAMISCustomerAROpening 
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "CustomerAROpening.frx":5B55
      End
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "CustomerAROpening.frx":5B71
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               MultiLine       =   0   'False
               Appearance      =   0
               TextRTF         =   $"CustomerAROpening.frx":5CD3
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "CustomerAROpening.frx":5D66
            MousePointer    =   99  'Custom
            Picture         =   "CustomerAROpening.frx":5EB8
            Style           =   1  'Graphical
            TabIndex        =   26
            Top             =   720
            Width           =   1005
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Left            =   7020
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "CustomerAROpening.frx":61C2
            MousePointer    =   99  'Custom
            Picture         =   "CustomerAROpening.frx":6314
            Style           =   1  'Graphical
            TabIndex        =   24
            Top             =   690
            Width           =   975
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Left            =   8040
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "CustomerAROpening.frx":6756
            MousePointer    =   99  'Custom
            Picture         =   "CustomerAROpening.frx":68A8
            Style           =   1  'Graphical
            TabIndex        =   25
            Top             =   690
            Width           =   1005
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CustomerAROpening.frx":6BD6
   End
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CustomerAROpening.frx":6BF2
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CustomerAROpening.frx":6D54
   End
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CustomerAROpening.frx":6D70
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   Begin wizButton.cmd cmdShowPostRange 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CustomerAROpening.frx":6ED2
   End
   Begin VB.PictureBox picShowPostRange 
      ...
      Begin wizProgBar.Prg prgPostRange 
         ...
         _ExtentX        =   4048
         _ExtentY        =   503
         Picture         =   "CustomerAROpening.frx":6EEE
         ForeColor       =   0
         BarPicture      =   "CustomerAROpening.frx":6F0A
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.PictureBox picGJ 
      ...
      Begin MSComctlLib.ListView lstGJ 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CustomerAROpening.frx":6F26
         NumItems        =   6
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "ITEM #"
            Object.Width           =   1587
      ...
      Begin VB.PictureBox picGJEntry 
         ...
         Begin VB.CommandButton cmdGJCancel 
            ...
            Left            =   8160
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "CustomerAROpening.frx":7088
            MousePointer    =   99  'Custom
            Picture         =   "CustomerAROpening.frx":71DA
            Style           =   1  'Graphical
            TabIndex        =   81
            Top             =   690
            Width           =   1005
         ...
         Begin VB.CommandButton cmdGJSave 
            ...
            Left            =   7140
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "CustomerAROpening.frx":74EC
            MousePointer    =   99  'Custom
            Picture         =   "CustomerAROpening.frx":763E
            Style           =   1  'Graphical
            TabIndex        =   80
            Top             =   690
            Width           =   975
         ...
         Begin VB.CommandButton cmdGJDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "CustomerAROpening.frx":7A80
            MousePointer    =   99  'Custom
            Picture         =   "CustomerAROpening.frx":7BD2
            Style           =   1  'Graphical
            TabIndex        =   83
            Top             =   720
            Width           =   1005
         ...
         Begin RichTextLib.RichTextBox txtGJAccountName 
            ...
            MultiLine       =   0   'False
            Appearance      =   0
            TextRTF         =   $"CustomerAROpening.frx":7EDC
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   9
               Charset         =   0
         ...
         Begin RichTextLib.RichTextBox txtGJAccountParticulars 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"CustomerAROpening.frx":7F6F
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin wizButton.cmd cmdGJEntry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "CustomerAROpening.frx":8006
      End
      Begin RichTextLib.RichTextBox txtParticulars2 
         ...
         ScrollBars      =   2
         Appearance      =   0
         TextRTF         =   $"CustomerAROpening.frx":8022
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
...
Sub FillCboAcctName()
    ...
    If COMPANY_CODE = "HAI" Then
        Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where (Titles IN ('1102','2102','2107') AND IS_SCHEDULE_ACCNT=1) Order by AcctCode asc")
    Else
        Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where (Titles IN ('1102','1103') AND IS_SCHEDULE_ACCNT=1) Order by AcctCode asc")
    End If
    If Not rsCOBAcctName.EOF And Not rsCOBAcctName.BOF Then
...
Private Sub cmdUnPost_Click()
    ...
    Dim rsCRJ_Detail                              As ADODB.Recordset
    Set rsCRJ_Detail = New ADODB.Recordset
    Set rsCRJ_Detail = gconDMIS.Execute("Select * from AMIS_CRJ_Detail where INVOICETYPE = '" & SetInvCode(cboInvoiceType.Text) & "' AND INVOICENO = '" & txtInvoiceNo.Text & "' AND INVOICEDATE = '" & CDate(txtInvoiceDate.Text) & "' and status <> 'C'")
    If Not rsCRJ_Detail.EOF And Not rsCRJ_Detail.BOF Then
    ...
    If Not rsCOUNT_CODE.EOF And Not rsCOUNT_CODE.BOF Then
        If NumericVal(rsCOUNT_CODE!COUNT_CODE) > 1 Then
            ...
            rsAR_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.INVOICENO,HD.INVOICETYPE,HD.INVOICEDATE,ACCT_CODE,INVOICEAMT " & _
                              ...
                              "WHERE LEFT(DET.ACCT_CODE,5) IN ('11-02','11-03','21-02','21-07') AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & "", gconDMIS, adOpenKeyset
        ...
        Else
            ...
            rsAR_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.INVOICENO,HD.INVOICETYPE,HD.INVOICEDATE,ACCT_CODE,INVOICEAMT " & _
                              "FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE " & _
                              "WHERE LEFT(DET.ACCT_CODE,5) IN ('11-02','11-03','21-02','21-07') AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & " AND HD.STATUS = 'P'", gconDMIS, adOpenKeyset
            If Not rsAR_VOUCHER.EOF And Not rsAR_VOUCHER.BOF Then
                xVOUCHERNO = N2Str2Null(Null2String(rsAR_VOUCHER!jtype) & "-" & Null2String(rsAR_VOUCHER!VOUCHERNO))
                xJdate = N2Str2Null(Null2String(rsAR_VOUCHER!JDate))
                xJType = N2Str2Null(Null2String(rsAR_VOUCHER!jtype))
