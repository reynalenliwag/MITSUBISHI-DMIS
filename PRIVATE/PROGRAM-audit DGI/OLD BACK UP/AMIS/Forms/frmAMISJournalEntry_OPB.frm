...
Begin VB.Form frmAMISJournalEntry_OPB 
   ...
   Begin VB.PictureBox picGJ 
      ...
      Begin VB.PictureBox picGJEntry 
         ...
         Begin VB.CommandButton cmdGJCancel 
            ...
            Left            =   8160
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_OPB.frx":4912
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_OPB.frx":4A64
            Style           =   1  'Graphical
            TabIndex        =   39
            Top             =   1050
            Width           =   1005
         ...
         Begin VB.CommandButton cmdGJSave 
            ...
            Left            =   7140
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_OPB.frx":4D76
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_OPB.frx":4EC8
            Style           =   1  'Graphical
            TabIndex        =   37
            Top             =   1050
            Width           =   975
         ...
         Begin VB.CommandButton cmdGJDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_OPB.frx":530A
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_OPB.frx":545C
            Style           =   1  'Graphical
            TabIndex        =   36
            Top             =   1050
            Width           =   1005
         ...
         Begin RichTextLib.RichTextBox txtGJAccountName 
            ...
            MultiLine       =   0   'False
            Appearance      =   0
            TextRTF         =   $"frmAMISJournalEntry_OPB.frx":5766
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   9
               Charset         =   0
         ...
         Begin RichTextLib.RichTextBox txtGJAccountParticulars 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"frmAMISJournalEntry_OPB.frx":57F9
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin wizButton.cmd cmdGJEntry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_OPB.frx":5890
      End
      Begin RichTextLib.RichTextBox txtParticulars2 
         ...
         BackColor       =   16777215
         ScrollBars      =   2
         TextRTF         =   $"frmAMISJournalEntry_OPB.frx":58AC
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
      ...
      Begin MSComctlLib.ListView lstGJ 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_OPB.frx":5943
         NumItems        =   6
   ...
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_OPB.frx":5AA5
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_OPB.frx":5C07
   End
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_OPB.frx":5C23
   End
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_OPB.frx":5C3F
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
