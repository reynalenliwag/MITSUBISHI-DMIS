...
Begin VB.Form frmAMISMASTERFILEBanks 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "Banks.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4170
         MouseIcon       =   "Banks.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3480
         MouseIcon       =   "Banks.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "Banks.frx":16B7
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":1809
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2100
         MouseIcon       =   "Banks.frx":1B65
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":1CB7
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1410
         MouseIcon       =   "Banks.frx":1FCA
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":211C
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "Banks.frx":2416
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":2568
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "Banks.frx":28C0
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":2A12
         Style           =   1  'Graphical
         TabIndex        =   12
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "Banks.frx":2D71
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":2EC3
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "Banks.frx":3201
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":3353
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   End
End
Attribute VB_Name = "frmAMISMASTERFILEBanks"
...
Sub InitCbo()
    ...
    Set rsCOA = gconDMIS.Execute("Select AcctCode from AMIS_ChartAccount Where Titles = '1101' Order by AcctCode asc")
    If Not rsCOA.EOF And Not rsCOA.BOF Then
        rsCOA.MoveFirst: cboAcctCode.Clear
        Do While Not rsCOA.EOF
            cboAcctCode.AddItem Null2String(rsCOA!ACCTCODE)
            rsCOA.MoveNext
        Loop
    End If
    Set rsCOA = Nothing
...
Sub rsRefresh()
    ...
    rsBanks.Open "select * from ALL_Banks order by BankCode asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    FillGrid
End Sub
...
Sub StoreEntry(XXX As Variant)
    ...
    rsBanks2.Open "select * from ALL_Banks where ID = " & XXX, gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Private Sub cmdDelete_Click()
    ...
    If MsgBox("Delete Current Record", vbQuestion + vbYesNo, "Delete") = vbYes Then
        SQL_STATEMENT = "delete from ALL_Banks where ID = " & lstBanks.SelectedItem.SubItems(2)
...
'    Exit Sub
    ...
    If AddorEdit = "ADD" Then
        ...
        rsBanksDup.Open "select BankCode from ALL_Banks where BankCode = " & VtxtBankCode, gconDMIS
        ...
        SQL_STATEMENT = "Insert into ALL_Banks " & _
    ...
    Else
        SQL_STATEMENT = "update ALL_Banks set" & _
...
Private Sub FillGrid()
    ...
    Set rsBanks2 = New ADODB.Recordset
    Set rsBanks2 = gconDMIS.Execute("select bankcode,bankname,ID from ALL_Banks")
