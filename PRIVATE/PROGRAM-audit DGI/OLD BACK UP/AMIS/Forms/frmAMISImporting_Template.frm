...
Begin VB.Form frmAMISImporting_Template 
   ...
   Begin VB.PictureBox picDetails 
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.PictureBox picTranType 
            ...
            Begin VB.ComboBox cboTranType1 
               ...
               Left            =   120
               List            =   "frmAMISImporting_Template.frx":10FE
               Style           =   2  'Dropdown List
               TabIndex        =   82
               Top             =   300
               Width           =   2625
         ...
         Begin VB.ComboBox cboDRCR 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmAMISImporting_Template.frx":1141
            Left            =   6780
            List            =   "frmAMISImporting_Template.frx":114B
            Style           =   2  'Dropdown List
            TabIndex        =   48
            Top             =   330
            Width           =   1185
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8315
            MouseIcon       =   "frmAMISImporting_Template.frx":115E
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISImporting_Template.frx":12B0
            Style           =   1  'Graphical
            TabIndex        =   33
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISImporting_Template.frx":15EE
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISImporting_Template.frx":1740
            Style           =   1  'Graphical
            TabIndex        =   40
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               Enabled         =   -1  'True
               MultiLine       =   0   'False
               TextRTF         =   $"frmAMISImporting_Template.frx":1A6B
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "frmAMISImporting_Template.frx":1AFE
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISImporting_Template.frx":1C50
            Style           =   1  'Graphical
            TabIndex        =   34
            Top             =   765
            Width           =   705
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISImporting_Template.frx":1FA0
      End
      Begin MSComctlLib.ListView lstDetails 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISImporting_Template.frx":1FBC
         NumItems        =   6
      ...
      Begin VB.PictureBox picSALESVEHICLE 
         ...
         Begin VB.ComboBox cboModel 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmAMISImporting_Template.frx":211E
            Left            =   150
            List            =   "frmAMISImporting_Template.frx":212B
            Sorted          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   91
            Top             =   90
         ...
         Begin VB.ComboBox cboTerm 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmAMISImporting_Template.frx":2152
            Left            =   5190
            List            =   "frmAMISImporting_Template.frx":2162
            Sorted          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   90
            Top             =   90
      ...
      Begin VB.PictureBox picSALESPARTS 
         ...
         Begin VB.ComboBox cboPayType 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmAMISImporting_Template.frx":218C
            Left            =   150
            List            =   "frmAMISImporting_Template.frx":2199
            Sorted          =   -1  'True
            TabIndex        =   88
            Top             =   90
            Width           =   825
         ...
         Begin VB.ComboBox cboPayClass 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmAMISImporting_Template.frx":21AB
            Left            =   1080
            List            =   "frmAMISImporting_Template.frx":21B8
            Sorted          =   -1  'True
            TabIndex        =   87
            Top             =   90
            Width           =   2025
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   6840
         MouseIcon       =   "frmAMISImporting_Template.frx":21DF
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":2331
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   6090
         MouseIcon       =   "frmAMISImporting_Template.frx":2697
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":27E9
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Left            =   5340
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISImporting_Template.frx":2B4F
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":2CA1
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4590
         MouseIcon       =   "frmAMISImporting_Template.frx":2FDB
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":312D
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3840
         MouseIcon       =   "frmAMISImporting_Template.frx":3489
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":35DB
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3090
         MouseIcon       =   "frmAMISImporting_Template.frx":38EE
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":3A40
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "frmAMISImporting_Template.frx":3D90
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":3EE2
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1590
         MouseIcon       =   "frmAMISImporting_Template.frx":4240
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":4392
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "frmAMISImporting_Template.frx":468C
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":47DE
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   90
         MouseIcon       =   "frmAMISImporting_Template.frx":4B36
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":4C88
         Style           =   1  'Graphical
         TabIndex        =   15
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   6840
         MouseIcon       =   "frmAMISImporting_Template.frx":4FE7
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":5139
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   6090
         MouseIcon       =   "frmAMISImporting_Template.frx":5477
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISImporting_Template.frx":55C9
         Style           =   1  'Graphical
         TabIndex        =   12
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin VB.ComboBox cboTransactionType 
         ...
         ForeColor       =   &H00701E2A&
         Height          =   330
         ItemData        =   "frmAMISImporting_Template.frx":5919
         Left            =   1920
         List            =   "frmAMISImporting_Template.frx":591B
         Style           =   2  'Dropdown List
         TabIndex        =   30
         Top             =   960
         Width           =   2235
      ...
      Begin VB.ComboBox cboType 
         ...
         ForeColor       =   &H00701E2A&
         Height          =   330
         ItemData        =   "frmAMISImporting_Template.frx":591D
         Left            =   4830
         List            =   "frmAMISImporting_Template.frx":591F
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   29
         Top             =   960
   ...
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISImporting_Template.frx":5921
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISImporting_Template.frx":5A83
   End
End
...
Private Sub cboTranType1_Change()
    If cboTranType1.Text = "OUTPUT TAX" Or cboTranType1.Text = "AR" Or cboTranType1.Text = "SHOP SUPPLIES" Or cboTranType1.Text = "INTERNAL" Then
...
'    SendToBack
    ...
    If J_TRANTYPE1 = "'OUTPUT TAX'" Or J_TRANTYPE1 = "'AR'" Or J_TRANTYPE1 = "'SHOP SUPPLIES'" Then
        J_TRANTYPE2 = "NULL"
        J_TRANTYPE3 = "NULL"
    Else
...
'    End If
    ...
    If AddorEdit = "ADD" Then
        SQL_STATEMENT = "INSERT INTO AMIS_IMPORTTEMPLATE_HD " & _
                        "(CODE,DESCRIPTION,TRANTYPE_ID,TYPE_ID,GENUINE,PAY_CLASS,NONVAT,DISCOUNT,PAY_TYPE,MODEL_ID,CUSTOMER,INTERNAL,WARRANTY,INSURANCE,LABOR_GJ,LABOR_BP,LABOR_PMS,SUBLET,PARTS_GJ,PARTS_BP,MATERIALS,ACC_GJ,ACC_BP,DISC_LABOR,DISC_PARTS,DISC_MAT,DISC_ACC) VALUES " & _
                        "(" & J_CODE & "," & J_DESCRIPTION & "," & J_TRANTYPE & "," & J_TYPE & ",'" & J_GENUINE & "'," & J_PAYCLASS & ",'" & J_NON_VAT & "','" & J_DISCOUNT & "'," & J_PAYTYPE & "," & J_MODEL & ",'" & J_CUSTOMER & "','" & J_INTERNAL & "','" & J_WARRANTY & "','" & J_INSURANCE & "','" & J_LABOR_GJ & "','" & J_LABOR_BP & "','" & J_LABOR_PMS & "','" & J_SUBLET & "','" & J_PARTS_GJ & "','" & J_PARTS_BP & "','" & J_MATERIALS & "','" & J_ACC_GJ & "','" & J_ACC_BP & "','" & J_DISC_LABOR & "','" & J_DISC_PARTS & "','" & J_DISC_MAT & "','" & J_DISC_ACC & "')"
        gconDMIS.Execute SQL_STATEMENT
    ...
    Else
        SQL_STATEMENT = "UPDATE AMIS_IMPORTTEMPLATE_HD SET DESCRIPTION=" & J_DESCRIPTION & ",TRANTYPE_ID=" & J_TRANTYPE & ",TYPE_ID=" & J_TYPE & ",GENUINE='" & J_GENUINE & "',PAY_CLASS=" & J_PAYCLASS & ",NONVAT='" & J_NON_VAT & "',DISCOUNT='" & J_DISCOUNT & "',PAY_TYPE=" & J_PAYTYPE & ",MODEL_ID=" & J_MODEL & ",CUSTOMER='" & J_CUSTOMER & "',INTERNAL='" & J_INTERNAL & "',WARRANTY='" & J_WARRANTY & "',INSURANCE='" & J_INSURANCE & "',LABOR_GJ='" & J_LABOR_GJ & "',LABOR_BP='" & J_LABOR_BP & "',LABOR_PMS='" & J_LABOR_PMS & "',SUBLET='" & J_SUBLET & "',PARTS_GJ='" & J_PARTS_GJ & "',PARTS_BP='" & J_PARTS_BP & "',MATERIALS='" & J_MATERIALS & "',ACC_GJ='" & J_ACC_GJ & "',ACC_BP='" & J_ACC_BP & "',DISC_LABOR='" & J_DISC_LABOR & "',DISC_PARTS='" & J_DISC_PARTS & "',DISC_MAT='" & J_DISC_MAT & "',DISC_ACC='" & J_DISC_ACC & "' WHERE ID='" & labID.Caption & "'"
        gconDMIS.Execute SQL_STATEMENT
...
Private Sub StoreMemVars()
    If Not rsAMIS_TEMPLATES.EOF And Not rsAMIS_TEMPLATES.BOF Then
        ...
        If cboTransactionType = "SALES" And cboType.Text = "VEHICLES" Then
            cboModel.Text = rsAMIS_TEMPLATES!MODEL_ID
        ...
        ElseIf cboTransactionType = "SALES" And (cboType.Text = "PARTS" Or cboType.Text = "MATERIALS") Then
