...
Begin VB.Form frmSMIS_Trans_Quotation_Print 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin RichTextLib.RichTextBox rtfText1 
         ...
         Enabled         =   -1  'True
         ScrollBars      =   3
         TextRTF         =   $"Log_Quotation_Print.frx":13DF
      ...
      Begin RichTextLib.RichTextBox rtfText2 
         ...
         Enabled         =   -1  'True
         ScrollBars      =   3
         TextRTF         =   $"Log_Quotation_Print.frx":1456
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   9
            Charset         =   0
      ...
      Begin RichTextLib.RichTextBox rtfText3 
         ...
         Enabled         =   -1  'True
         ScrollBars      =   2
         TextRTF         =   $"Log_Quotation_Print.frx":14CD
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   765
         Left            =   6870
         MouseIcon       =   "Log_Quotation_Print.frx":1544
         MousePointer    =   99  'Custom
         Picture         =   "Log_Quotation_Print.frx":1696
         Style           =   1  'Graphical
         TabIndex        =   21
         TabStop         =   0   'False
   ...
   Begin VB.PictureBox picViewVehicles 
      ...
      Begin VB.CommandButton cmdCancelViewVehicles 
         ...
         Index           =   0
         Left            =   5070
         MouseIcon       =   "Log_Quotation_Print.frx":1B35
         MousePointer    =   99  'Custom
         Picture         =   "Log_Quotation_Print.frx":1C87
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Cancel"
         Top             =   5220
      ...
      Begin VB.CommandButton cmdSelectViewVehicles 
         ...
         Height          =   720
         Left            =   4380
         MouseIcon       =   "Log_Quotation_Print.frx":1FC5
         MousePointer    =   99  'Custom
         Picture         =   "Log_Quotation_Print.frx":2117
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Select"
         Top             =   5220
