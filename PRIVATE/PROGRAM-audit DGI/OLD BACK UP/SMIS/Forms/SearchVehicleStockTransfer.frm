...
Begin VB.Form frmSMIS_SearchVehicleStockTransfer 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Search Stock Transfer"
   ClientHeight    =   6480
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8250
   ...
   ForeColor       =   &H00FCFCFC&
   Icon            =   "SearchVehicleStockTransfer.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab SearchTab 
      ...
      TabPicture(0)   =   "SearchVehicleStockTransfer.frx":01CA
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Picture1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "By &Company Name"
      TabPicture(1)   =   "SearchVehicleStockTransfer.frx":01E6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Picture3"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "By &SR No"
      TabPicture(2)   =   "SearchVehicleStockTransfer.frx":0202
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Picture5"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "By &VIN#"
      TabPicture(3)   =   "SearchVehicleStockTransfer.frx":021E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Picture7"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "By Conduction Sticker#"
      TabPicture(4)   =   "SearchVehicleStockTransfer.frx":023A
      ...
      Begin VB.PictureBox Picture9 
         ...
         Begin MSComctlLib.ListView lstIgnitionKey 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleStockTransfer.frx":0256
            NumItems        =   7
      ...
      Begin VB.PictureBox Picture7 
         ...
         Begin MSComctlLib.ListView lstProdNo 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleStockTransfer.frx":0570
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "VIN#"
               Object.Width           =   5380
      ...
      Begin VB.PictureBox Picture5 
         ...
         Begin MSComctlLib.ListView lstInvoiceNo 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleStockTransfer.frx":088A
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Tranno"
               Object.Width           =   2117
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin MSComctlLib.ListView lstCustomer 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleStockTransfer.frx":0BA4
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Company Name"
               Object.Width           =   3616
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin MSComctlLib.ListView lstDate 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleStockTransfer.frx":0EBE
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Date"
               Object.Width           =   2205
   ...
   End
End
Attribute VB_Name = "frmSMIS_SearchVehicleStockTransfer"
...
Sub ShowStatus()
    ...
    Set RSSTATUS = gconDMIS.Execute("SELECT COUNT(*) T, STATUS FROM SMIS_STOCKTRANSFER  GROUP BY STATUS")
...
Private Sub lstCustomer_DblClick()
    ...
    frmSMIS_Trans_MRR1.SearchID (Trim(Me.lstCustomer.SelectedItem.SubItems(6)))
    Unload Me
End Sub
...
Private Sub lstDate_DblClick()
    ...
    frmSMIS_Trans_MRR1.SearchID (Trim(Me.lstDate.SelectedItem.SubItems(6)))
...
Private Sub lstIgnitionKey_DblClick()
    ...
    frmSMIS_Trans_MRR1.SearchID (Trim(Me.lstIgnitionKey.SelectedItem.SubItems(6)))
    Unload Me
End Sub
...
Private Sub lstInvoiceNo_DblClick()
    ...
    frmSMIS_Trans_MRR1.SearchID (Trim(Me.lstInvoiceNo.SelectedItem.SubItems(6)))
    Unload Me
End Sub
...
Private Sub lstProdNo_DblClick()
    ...
    frmSMIS_Trans_MRR1.SearchID (Trim(Me.lstProdNo.SelectedItem.SubItems(6)))
    Unload Me
End Sub
...
Private Sub SearchTab_Click(PreviousTab As Integer)
    ...
    Select Case SEARCH_TAB
        ...
        Case 1
            ...
            Me.Caption = "Search Invoice by  Company Name"
            txtCustomer_Change
            On Error Resume Next
            txtCustomer.SetFocus
        Case 2
            txtInvoiceNumber.Enabled = True: lstInvoiceNo.Enabled = True
            Me.Caption = "Search Invoice by  SR Number"
...
Private Sub txtCustomer_Change()
    ...
    If txtCustomer = "" Then
        ...
        Set rsSalesInvoice = gconDMIS.Execute("SELECT   ENTITY_TO , DESCRIPTIONs, MODEL, COLOR, CSNO  ,ENTITY_TO, ID ,STATUS FROM SMIS_STOCKTRANSFER where ENTITY_TO is Not null order by ENTITY_TO asc")
    ...
    Else
        Me.lstCustomer.Sorted = False: Me.lstCustomer.ListItems.Clear
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  ENTITY_TO, DESCRIPTIONs, MODEL, COLOR, CSNO  ,ENTITY_TO, ID ,STATUS FROM SMIS_STOCKTRANSFER  WHERE  ENTITY_TO is Not null AND ENTITY_TO like '" & Trim(ReplaceQuote(Me.txtCustomer)) & "%'order by ENTITY_TO asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
            Listview_Loadval Me.lstCustomer.ListItems, rsSalesInvoice
        End If
    End If
    ...
    For i = 1 To lstCustomer.ListItems.Count
        If lstCustomer.ListItems(i).ListSubItems(7).Text = "C" Then
            SetColorX vbRed, lstCustomer.ListItems(i)
        ElseIf lstCustomer.ListItems(i).ListSubItems(7).Text = "" Or lstCustomer.ListItems(i).ListSubItems(7).Text = "U" Then
...
Private Sub txtDate_Change()
    ...
    If txtDate = "" Then
        ...
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  convert(varchar, Deyt,101), DESCRIPTIONs, MODEL, COLOR, CSNO  ,ENTITY_TO, ID,STATUS FROM SMIS_STOCKTRANSFER WHERE DEYT IS NOT NULL  order by deyt asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
    ...
    Else
        Me.lstDate.Sorted = False: Me.lstDate.ListItems.Clear
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  convert(varchar, Deyt,101), DESCRIPTIONs, MODEL, COLOR, CSNO  ,ENTITY_TO, ID ,STATUS FROM SMIS_STOCKTRANSFER  WHERE  convert(varchar, Deyt,101) like '%" & Trim(ReplaceQuote(Me.txtDate)) & "%' order by deyt asc")
    ...
    For i = 1 To lstDate.ListItems.Count
        If lstDate.ListItems(i).ListSubItems(7).Text = "C" Then
            SetColorX vbRed, lstDate.ListItems(i)
        ElseIf lstDate.ListItems(i).ListSubItems(7).Text = "" Or lstDate.ListItems(i).ListSubItems(7).Text = "U" Then
...
Private Sub txtIgnitionKey_Change()
    ...
    If txtIgnitionKey = "" Then
        ...
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  CSNO, DESCRIPTIONs , Model, color, CSNO, ENTITY_TO, ID, status FROM SMIS_STOCKTRANSFER where CSNO is not null " & SAFILTER & " order by CSNO asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
    ...
    Else
        Me.lstProdNo.Sorted = False: Me.lstProdNo.ListItems.Clear
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  CSNO, DESCRIPTIONS , MODEL, COLOR, CSNO, ENTITY_TO, ID, STATUS FROM SMIS_STOCKTRANSFER WHERE  CSNO is not null  and CSNO like '" & Trim(ReplaceQuote(Me.txtIgnitionKey)) & "%' " & SAFILTER & " order by CSNO asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
            Listview_Loadval Me.lstIgnitionKey.ListItems, rsSalesInvoice
        End If
    End If
    ...
    For i = 1 To lstIgnitionKey.ListItems.Count
        If lstIgnitionKey.ListItems(i).ListSubItems(7).Text = "C" Then
            SetColorX vbRed, lstIgnitionKey.ListItems(i)
        ElseIf lstIgnitionKey.ListItems(i).ListSubItems(7).Text = "" Or lstIgnitionKey.ListItems(i).ListSubItems(7).Text = "U" Then
...
Private Sub txtInvoiceNumber_Change()
    ...
    If txtInvoiceNumber = "" Then
        ...
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  SDNO,  DESCRIPTIONs , Model, color, CSNO, ENTITY_TO, ID, status FROM SMIS_STOCKTRANSFER WHERE SDNO IS NOT NULL " & SAFILTER & " order by SDNO ASC")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
    ...
    Else
        Me.lstInvoiceNo.Sorted = False: Me.lstInvoiceNo.ListItems.Clear
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  SDNO,  DESCRIPTIONs , Model, color, CSNO, ENTITY_TO, ID, status   FROM SMIS_STOCKTRANSFER  WHERE  SDNO like '%" & Trim(ReplaceQuote(Me.txtInvoiceNumber)) & "%' " & SAFILTER & " order by SDNO asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
            Listview_Loadval Me.lstInvoiceNo.ListItems, rsSalesInvoice
        End If
    End If
    ...
    For i = 1 To lstInvoiceNo.ListItems.Count
        If lstInvoiceNo.ListItems(i).ListSubItems(7).Text = "C" Then
            SetColorX vbRed, lstInvoiceNo.ListItems(i)
        ElseIf lstInvoiceNo.ListItems(i).ListSubItems(7).Text = "" Or lstInvoiceNo.ListItems(i).ListSubItems(7).Text = "U" Then
...
Private Sub txtProdNo_Change()
    ...
    If txtProdNo = "" Then
        Me.lstProdNo.Sorted = False: Me.lstProdNo.ListItems.Clear
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  VINO, DESCRIPTIONs , Model, color, CSNO, ENTITY_TO, ID, status  FROM SMIS_STOCKTRANSFER where VINO is not null " & SAFILTER & " order by VINO asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
    ...
    Else
        Me.lstProdNo.Sorted = False: Me.lstProdNo.ListItems.Clear
        Set rsSalesInvoice = New ADODB.Recordset
        Set rsSalesInvoice = gconDMIS.Execute("SELECT  VINO, DESCRIPTIONs , Model, color, CSNO, ENTITY_TO, ID, status  FROM SMIS_STOCKTRANSFER where VINO is not null AND VINO like '" & Trim(ReplaceQuote(Me.txtProdNo)) & "%' " & SAFILTER & " order by VINO asc")
        If Not (rsSalesInvoice.EOF And rsSalesInvoice.BOF) Then
            Listview_Loadval Me.lstProdNo.ListItems, rsSalesInvoice
        End If
    End If
    ...
    For i = 1 To lstProdNo.ListItems.Count
        If lstProdNo.ListItems(i).ListSubItems(7).Text = "C" Then
            SetColorX vbRed, lstProdNo.ListItems(i)
        ElseIf lstProdNo.ListItems(i).ListSubItems(7).Text = "" Or lstProdNo.ListItems(i).ListSubItems(7).Text = "U" Then
