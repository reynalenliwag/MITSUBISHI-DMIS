...
If IsNull(txtTime.Text) = False Then
   'Time = txtTime.Text
   'LOGTIME = txtTime.Text
   'frmMain.BarTime.Caption = LOGTIME
Else
   MsgBoxXP "Invalid Time!", vbCritical
End If
Exit Sub
