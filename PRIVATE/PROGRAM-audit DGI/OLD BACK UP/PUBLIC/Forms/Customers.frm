...
Begin VB.Form frmAllCustomer 
   ...
   Begin VB.PictureBox picChildList 
      ...
      Begin VB.CommandButton cmdCancelChildList 
         ...
         Height          =   645
         Left            =   5040
         MouseIcon       =   "Customers.frx":8E94
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":8FE6
         Style           =   1  'Graphical
         TabIndex        =   96
         ToolTipText     =   "Cancel"
         Top             =   4080
      ...
      Begin VB.CommandButton cmdSelectChild 
         ...
         Height          =   645
         Left            =   4350
         MouseIcon       =   "Customers.frx":9324
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":9476
         Style           =   1  'Graphical
         TabIndex        =   94
         ToolTipText     =   "Select"
         Top             =   4080
      ...
      Begin VB.CommandButton cmdAddChildInfo 
         ...
         Height          =   645
         Left            =   3660
         MouseIcon       =   "Customers.frx":9914
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":9A66
         Style           =   1  'Graphical
         TabIndex        =   95
   ...
   Begin VB.PictureBox picContactAE 
      ...
      Begin VB.CommandButton cmdSaveContact 
         ...
         Height          =   675
         Left            =   2970
         MouseIcon       =   "Customers.frx":A209
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":A35B
         Style           =   1  'Graphical
         TabIndex        =   123
      ...
      Begin VB.CommandButton cmdDeleteContact 
         ...
         Height          =   675
         Left            =   2340
         MouseIcon       =   "Customers.frx":A6AB
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":A7FD
         Style           =   1  'Graphical
         TabIndex        =   124
      ...
      Begin VB.ComboBox cboContactRelation 
         ...
         ForeColor       =   &H00400000&
         Height          =   345
         ItemData        =   "Customers.frx":AB28
         Left            =   1140
         List            =   "Customers.frx":AB2A
         TabIndex        =   111
         Top             =   790
         Width           =   3045
      End
   ...
   Begin VB.PictureBox picContactList 
      ...
      Begin VB.CommandButton cmdCancelContactList 
         ...
         Height          =   645
         Left            =   5010
         MouseIcon       =   "Customers.frx":AB2C
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":AC7E
         Style           =   1  'Graphical
         TabIndex        =   104
         ToolTipText     =   "Cancel"
         Top             =   4110
      ...
      Begin VB.CommandButton cmdEditContact 
         ...
         Height          =   645
         Left            =   4320
         MouseIcon       =   "Customers.frx":AFBC
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":B10E
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   645
         Left            =   3630
         MouseIcon       =   "Customers.frx":B5CC
         MousePointer    =   99  'Custom
         Picture         =   "Customers.frx":B71E
         Style           =   1  'Graphical
         TabIndex        =   103
