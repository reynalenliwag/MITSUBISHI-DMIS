...
Sub GET_AP_VOUCHERNO()
    ...
    rsAP_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.INVOICENO,HD.INVOICETYPE,HD.INVOICEDATE,HD.DUEDATE,ACCT_CODE,DET.ENTITY " & _
                      "FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE " & _
    ...
    If Not rsAP_VOUCHER.EOF And Not rsAP_VOUCHER.BOF Then
        Do While Not rsAP_VOUCHER.EOF
            ...
            Else
                ...
                If Null2String(rsAP_VOUCHER!ACCT_CODE) = "21-01002-00" Then
