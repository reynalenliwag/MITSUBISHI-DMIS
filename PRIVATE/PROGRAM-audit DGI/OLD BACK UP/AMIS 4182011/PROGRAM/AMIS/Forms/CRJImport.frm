                    ...
                    Do While Not rsOFF_DT.EOF
                        ...
                        If CMIS_DT_TRANTYPE = "SI" Then
                            If COMPANY_CODE = "DGI" Then
                                ...
                                rsDEFERRED.Open "SELECT DET.CREDIT FROM AMIS_JOURNAL_HD HD " & _
                                                "INNER JOIN AMIS_JOURNAL_DET DT" & _
                                                "ON HD.VOUCHERNO=DT.VOUCHERNO AND HD.JTYPE=DT.JTYPE " & _
                                                "WHERE HD.INVOICENO=" & DEF_INVOICENO & " AND HD.INVOICETYPE=" & DEF_INVOICETYPE & " AND DT.ACCT_CODE='21-05001-00'"
...
InitGrids:     DoEvents: cmdCheck.Enabled = False: cmdClearJournals.Enabled = False
    ...
    If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HGH" Or COMPANY_CODE = "DGI" Then
        GoTo ShowTrans
    Else
