    ...
    If AddorEdit = "ADD" Then
        ...
        If xJOURNALTYPE = "CDJ" Then
            ...
            SQL_STATEMENT = "insert into AMIS_CV_Detail " & _
                            ...
                            ", " & PV_STATUS & "," & PV_VENDORCODE & "," & J_CLASS & ",'" & lblInvoiceNo.Caption & "','" & lblInvoiceType.Caption & "')"
            gconDMIS.Execute SQL_STATEMENT
            
            SQL_STATEMENT = "UPDATE CMIS_DEPOSITS SET APPLIED='Y',INVOICENO=" & J_JVOUCHERNO & ",INVOICETYPE='" & xJOURNALTYPE & "' WHERE OR_NUM='" & lblInvoiceNo.Caption & "'"
            gconDMIS.Execute SQL_STATEMENT
...
Private Sub cmdPVDelete_Click()
    ...
    If xJOURNALTYPE = "CDJ" Then
        If MsgBox("Delete This CV Detail, Are you Sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
            SQL_STATEMENT = "UPDATE CMIS_DEPOSITS SET APPLIED='N',INVOICENO=NULL,INVOICETYPE=NULL WHERE OR_NUM='" & lblInvoiceNo.Caption & "'"
            gconDMIS.Execute SQL_STATEMENT
