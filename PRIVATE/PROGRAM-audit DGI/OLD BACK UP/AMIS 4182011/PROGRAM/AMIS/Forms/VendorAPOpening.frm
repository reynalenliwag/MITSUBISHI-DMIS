...
Sub FillCboAcctName()
    ...
    'If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Then
        Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where Titles IN ('1102','1103','2101','2102','2107') AND ISNULL(IS_SCHEDULE_ACCNT,0) = 1 and Description IS NOT NULL Order by AcctCode asc")
    'Else
...
Sub GET_AR_VOUCHERNO()
    ...
    rsCOUNT_CODE.Open "SELECT COUNT(DISTINCT ACCT_CODE) AS COUNT_CODE FROM AMIS_JOURNAL_DET " & _
                      "WHERE VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & " AND JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND LEFT(ACCT_CODE,5) IN('11-02','11-03','21-02','21-07')", gconDMIS, adOpenKeyset
