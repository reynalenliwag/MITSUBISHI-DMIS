...
Sub FillAll()
    ...
    Else
        ...
        If Not rsPayrollSetup.EOF And Not rsPayrollSetup.BOF Then
            ...
            Do While Format(TransactionDate, "mm/dd/yyyy") <= Format(DateSerial(cboYear, What_month(RTrim(LTrim(cboMonth))), EndDayFirstCutOff), "mm/dd/yyyy")
            ...
            Do While TransactionDate <= DateSerial(cboYear, What_month(Trim(cboMonth)), EndDaySecondCutOff)
...
Private Sub Command1_Click()
    ...
    For i = 1 To Grid1.Rows - 1
        ...
        If IsDate(Grid1.Cell(i, 1).Text) = True Then
            gconDMIS.Execute "update HRMS_Attend " & _
                           " set INAM= " & VINAM & ", OUTAM = " & VOUTAM & _
                           " ,INPM= " & vINPM & ", OUTPM= " & VOUTPM & _
                           " Where EmpNo = " & N2Str2Null(varEmpNo) & " And convert(varchar, DateToday ,101) = '" & Format((Grid1.Cell(i, 1).Text), "mm/dd/yyyy") & "'"
        End If
    Next
    ...
    For i = 0 To Grid2.Rows - 1
        ...
        If IsDate(Grid2.Cell(i, 1).Text) = True Then
            gconDMIS.Execute "update HRMS_Attend " & _
                           " set INAM= " & VINAM & ", OUTAM = " & VOUTAM & _
                           " ,INPM= " & vINPM & ", OUTPM= " & VOUTPM & _
                           " Where EmpNo = " & N2Str2Null(varEmpNo) & " And convert(varchar, DateToday ,101) = '" & Format((Grid2.Cell(i, 1).Text), "mm/dd/yyyy") & "'"
        End If
    Next
    ...
    If Not rsAttend.EOF And Not rsAttend.BOF Then
        ...
        Do While Not rsAttend.EOF
            ...
            gconDMIS.Execute "update HRMS_Attend " & _
                             "Set ActualDays = " & vActualDays & ", EnteredDays = " & vEnteredDays & _
                           " Where EmpNo = " & N2Str2Null(varEmpNo) & " And convert(varchar, DateToday ,101) = '" & Format((rsAttend!datetoday), "mm/dd/yyyy") & "'"
            rsAttend.MoveNext
        Loop
    End If
    FillAll
...
Private Sub Command2_Click()
    ...
    If PAYROLLCODE_TO2 < PAYROLLCODE_FROM1 Then
        ...
        If What_month(Trim(cboMonth.Text)) = 1 Then
            GENFROM = DateSerial(NumericVal(cboYear.Text) - 1, What_month(Trim(cboMonth.Text)) - 1, PAYROLLCODE_FROM1)
        End If
    End If
