...
Begin VB.Form frmCRIS_Inquiry_SalesAppointment 
   ...
   EndProperty
   Icon            =   "Inquiry_Appointments.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox picAddEdit 
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   675
         Left            =   1950
         MouseIcon       =   "Inquiry_Appointments.frx":058A
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_Appointments.frx":06DC
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   675
         Left            =   1320
         MouseIcon       =   "Inquiry_Appointments.frx":0A42
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_Appointments.frx":0B94
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   675
         Left            =   690
         MouseIcon       =   "Inquiry_Appointments.frx":0EBF
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_Appointments.frx":1011
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   675
         Left            =   60
         MouseIcon       =   "Inquiry_Appointments.frx":136D
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_Appointments.frx":14BF
         Style           =   1  'Graphical
         TabIndex        =   5
...
'Upating Code       : AXP-0713200714:45
Private Sub cmdAdd_Click()
    On Error GoTo Errorcode:
    Call FormSearch.SearchForProspects("PROSPECTTYPE IN ('P','C','G','I') AND ISDATE(LOGSO)=0 and status<>'C'")
...
Private Sub cmdDelete_Click()
    ...
    LogAudit "X", "SALES APPOINTMENT", lvInquiry.SelectedRows.Row(0).Record(2).Value & " " & lvInquiry.SelectedRows.Row(0).Record(3).Value
...
Private Sub cmdPrint_Click()
    ...
    If lvInquiry.Records.Count = 0 Then
        ...
        End With
    End If
    LogAudit "V", "SALES APPOINTMENT", "MONTH :" & What_month(cboMonth) & " YEAR:" & cboYear & " SAE NAME :" & cboSAE
    Exit Sub
Errorcode:
    ShowVBError
End Sub
...
Sub InitData()
    ...
    While Not rsSAE.EOF
        cboSAE.AddItem Null2String(rsSAE!Name)
...
Sub ShowMonthlyAppointments()
    ...
    LogAudit "I", "SALES APPOINTMENT", "MONTH :" & What_month(cboMonth) & " YEAR:" & cboYear & " SAE NAME :" & cboSAE
