...
Begin VB.Form frmCSMS_Inquiry_ListByRO 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "INQUIRY BY REPAIR ORDER"
   ClientHeight    =   6720
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   12375
   ForeColor       =   &H00DEDFDE&
   Icon            =   "Inquiry_ListByRO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   795
         Left            =   11370
         MouseIcon       =   "Inquiry_ListByRO.frx":030A
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_ListByRO.frx":045C
         Style           =   1  'Graphical
         TabIndex        =   17
   ...
   Begin MSFlexGridLib.MSFlexGrid grdQUERY2 
      ...
      Appearance      =   0
      FormatString    =   $"Inquiry_ListByRO.frx":0797
   ...
   Begin MSFlexGridLib.MSFlexGrid grdQUERY 
      ...
      Appearance      =   0
      MousePointer    =   99
      FormatString    =   $"Inquiry_ListByRO.frx":0826
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "Inquiry_ListByRO.frx":0966
   End
   ...
   End
End
Attribute VB_Name = "frmCSMS_Inquiry_ListByRO"
...
Sub FillRECGrid(SA_Code As Variant)
    On Error GoTo ErrorCode
    kcnt = 0
    cleargrid grdQUERY
    Set rsEmpNo = New ADODB.Recordset
    rsEmpNo.Open "select code,naym from CSMS_vw_EmpNo where naym = " & N2Str2Null(cbo(5).Text), gconDMIS
    Set rsREPOR = New ADODB.Recordset
    rsREPOR.Open "Select * from CSMS_RepOr where Transtype='R' and recd_by = " & N2Str2Null(rsEmpNo!code) & " order by rep_or asc", gconDMIS
...
Private Sub Command1_Click()
    ...
    LogAudit "I", "INQUIRY BY REPAIR ORDER", SearchString1
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCSMS_Inquiry_ListByRO = Nothing
End Sub
