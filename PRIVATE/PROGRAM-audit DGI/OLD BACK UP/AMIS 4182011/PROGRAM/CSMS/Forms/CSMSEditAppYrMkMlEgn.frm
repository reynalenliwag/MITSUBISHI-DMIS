...
Begin VB.Form frmCSMSEDITAppYrMkMlEgn 
   ...
   EndProperty
   ForeColor       =   &H8000000F&
   Icon            =   "CSMSEditAppYrMkMlEgn.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3840
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   1470
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   60
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":0D47
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":0E99
         Style           =   1  'Graphical
         TabIndex        =   59
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   3510
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":11F5
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":1347
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   1590
         Width           =   645
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   675
         Left            =   2820
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":1685
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":17D7
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   1590
         Width           =   645
   ...
   Begin VB.PictureBox picEngine 
      ...
      Begin VB.CommandButton cmdSaveEngine 
         ...
         Height          =   675
         Left            =   2280
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":1B27
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":1C79
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   2910
         Width           =   645
      ...
      Begin VB.CommandButton cmdCancelEngine 
         ...
         Height          =   675
         Left            =   2970
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":1FC9
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":211B
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   2910
         Width           =   645
   ...
   Begin VB.PictureBox picMake 
      ...
      Begin VB.CommandButton cmdMakeCancel 
         ...
         Height          =   675
         Left            =   3510
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":2459
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":25AB
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   1590
         Width           =   645
      ...
      Begin VB.CommandButton cmdMakeSave 
         ...
         Height          =   675
         Left            =   2880
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":28E9
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":2A3B
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   1590
         Width           =   645
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   375
         Left            =   4500
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":2D8B
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":2EDD
         Style           =   1  'Graphical
         TabIndex        =   58
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   375
         Left            =   4500
         MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":3047
         MousePointer    =   99  'Custom
         Picture         =   "CSMSEditAppYrMkMlEgn.frx":3199
         Style           =   1  'Graphical
         TabIndex        =   55
         ToolTipText     =   "Add Record"
         Top             =   1680
      ...
      Begin VB.PictureBox Picture6 
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   795
            Left            =   2760
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":3303
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":3455
            Style           =   1  'Graphical
            TabIndex        =   34
         ...
         Begin VB.CommandButton cmdSelect 
            ...
            Height          =   795
            Left            =   2040
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":37BB
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":390D
            Style           =   1  'Graphical
            TabIndex        =   54
            ToolTipText     =   "Select"
            Top             =   0
      ...
      Begin VB.PictureBox Picture4 
         ...
         Begin VB.Label Label2 
            ...
            Height          =   225
            Left            =   180
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":3C49
            MousePointer    =   99  'Custom
            TabIndex        =   32
            Top             =   870
            Width           =   825
         ...
         Begin VB.Label Label4 
            ...
            Height          =   225
            Left            =   150
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":3F53
            MousePointer    =   99  'Custom
            TabIndex        =   31
            Top             =   1710
            Width           =   1305
         ...
         Begin VB.Label Label3 
            ...
            Height          =   225
            Left            =   180
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":425D
            MousePointer    =   99  'Custom
            TabIndex        =   30
            Top             =   1290
            Width           =   795
         ...
         Begin VB.Label Label1 
            ...
            Height          =   195
            Left            =   180
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":4567
            MousePointer    =   99  'Custom
            TabIndex        =   29
            Top             =   420
            Width           =   675
   ...
   Begin VB.PictureBox picYear 
      ...
      Begin VB.PictureBox picSaveYear 
         ...
         Begin VB.CommandButton cmdYearCancel 
            ...
            Height          =   795
            Left            =   1530
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":4871
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":49C3
            Style           =   1  'Graphical
            TabIndex        =   68
            Top             =   0
            Width           =   765
         ...
         Begin VB.CommandButton cmdYearSave 
            ...
            Height          =   795
            Left            =   780
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":4D01
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":4E53
            Style           =   1  'Graphical
            TabIndex        =   69
            Top             =   0
            Width           =   765
      ...
      Begin VB.PictureBox picAddYear 
         ...
         Begin VB.CommandButton Command7 
            ...
            Height          =   795
            Left            =   4020
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":51A3
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":52F5
            Style           =   1  'Graphical
            TabIndex        =   71
            Top             =   30
            Width           =   765
         ...
         Begin VB.CommandButton cmdExit 
            ...
            Height          =   795
            Left            =   5415
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":5633
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":5785
            Style           =   1  'Graphical
            TabIndex        =   66
            ToolTipText     =   "Exit Window"
            Top             =   45
         ...
         Begin VB.CommandButton cmdDeleteYear 
            ...
            Height          =   795
            Left            =   3270
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":5AEB
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":5C3D
            Style           =   1  'Graphical
            TabIndex        =   65
            ToolTipText     =   "Delete Selected Record"
            Top             =   30
         ...
         Begin VB.CommandButton cmdEditYear 
            ...
            Height          =   795
            Left            =   2520
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":5F68
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":60BA
            Style           =   1  'Graphical
            TabIndex        =   64
            ToolTipText     =   "Edit Selected Record"
            Top             =   30
         ...
         Begin VB.CommandButton cmdAddYear 
            ...
            Height          =   795
            Left            =   1770
            MouseIcon       =   "CSMSEditAppYrMkMlEgn.frx":6416
            MousePointer    =   99  'Custom
            Picture         =   "CSMSEditAppYrMkMlEgn.frx":6568
            Style           =   1  'Graphical
            TabIndex        =   63
            ToolTipText     =   "Add Record"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frmCSMSEDITAppYrMkMlEgn"
...
Private Sub cmdSelect_Click()
    ...
    frmCSMSEditAppVehicle.txtYear = cboYear
    frmCSMSEditAppVehicle.txtMake = cboMake
    frmCSMSEditAppVehicle.txtModel = cboModel
    frmCSMSEditAppVehicle.txtEngine = cboEngine
    frmCSMSEditAppVehicle.txtDescription = cboYear & " " & cboModel
    Unload Me
    Exit Sub
Errorcode:
    ShowVBError
