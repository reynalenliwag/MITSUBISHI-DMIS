...
Begin VB.Form frmCSMS_TECHTrainingPlan 
   ...
   EndProperty
   Icon            =   "frmCSMS_TrainingPlan1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox picture1 
      ...
      Begin VB.CommandButton cmdexit 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "frmCSMS_TrainingPlan1.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TrainingPlan1.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmddelete 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "frmCSMS_TrainingPlan1.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TrainingPlan1.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdedit 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "frmCSMS_TrainingPlan1.frx":11FF
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TrainingPlan1.frx":1351
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdadd 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmCSMS_TrainingPlan1.frx":16AD
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TrainingPlan1.frx":17FF
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmCSMS_TrainingPlan1.frx":1B12
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TrainingPlan1.frx":1C64
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "frmCSMS_TrainingPlan1.frx":1FB4
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TrainingPlan1.frx":2106
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   End
End
Attribute VB_Name = "frmCSMS_TECHTrainingPlan"
