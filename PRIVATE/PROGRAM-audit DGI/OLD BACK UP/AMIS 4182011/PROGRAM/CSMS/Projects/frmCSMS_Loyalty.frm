...
Begin VB.Form frmCSMS_Loyalty 
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmCSMS_Loyalty.frx":058A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_Loyalty.frx":06DC
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   11880
         MouseIcon       =   "frmCSMS_Loyalty.frx":0A4A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_Loyalty.frx":0B9C
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   11100
         MouseIcon       =   "frmCSMS_Loyalty.frx":0F02
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_Loyalty.frx":1054
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton cmdGenerate 
         ...
         Height          =   795
         Left            =   10320
         MouseIcon       =   "frmCSMS_Loyalty.frx":20D6
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_Loyalty.frx":2228
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Generate Date"
         Top             =   30
   ...
   Begin VB.PictureBox Picgenerate 
      ...
      Begin VB.CommandButton cmd_cancel 
         ...
         Height          =   795
         Left            =   3660
         MouseIcon       =   "frmCSMS_Loyalty.frx":2596
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_Loyalty.frx":26E8
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Cancel"
         Top             =   1950
      ...
      Begin VB.CommandButton cmd_process 
         ...
         Height          =   795
         Left            =   2940
         MouseIcon       =   "frmCSMS_Loyalty.frx":2A26
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_Loyalty.frx":2B78
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin wizProgBar.Prg Prgbr 
         ...
         _ExtentX        =   7646
         _ExtentY        =   556
         Picture         =   "frmCSMS_Loyalty.frx":3BFA
         ForeColor       =   255
         BorderStyle     =   2
         BarPicture      =   "frmCSMS_Loyalty.frx":3C16
         ShowText        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
      ...
      Begin VB.CommandButton cmdDone 
         ...
         Height          =   795
         Left            =   3660
         Picture         =   "frmCSMS_Loyalty.frx":3C32
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   " "
         Top             =   1950
