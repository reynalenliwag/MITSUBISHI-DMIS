...
Begin VB.Form frmSMIS_Trans_Ordering 
   ...
   Begin VB.PictureBox picmultiple 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton Command3 
            ...
            Height          =   795
            Left            =   840
            MouseIcon       =   "Ordering.frx":0E25
            MousePointer    =   99  'Custom
            Picture         =   "Ordering.frx":0F77
            Style           =   1  'Graphical
            TabIndex        =   67
            Top             =   60
            Width           =   705
         ...
         Begin VB.CommandButton Command4 
            ...
            Height          =   795
            Left            =   150
            MouseIcon       =   "Ordering.frx":12B5
            MousePointer    =   99  'Custom
            Picture         =   "Ordering.frx":1407
            Style           =   1  'Graphical
            TabIndex        =   68
            Top             =   60
            Width           =   705
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7140
         MouseIcon       =   "Ordering.frx":1757
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":18A9
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   6450
         MouseIcon       =   "Ordering.frx":1C0F
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":1D61
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   5760
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Ordering.frx":20C7
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":2219
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5070
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Ordering.frx":2553
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":26A5
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   4380
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Ordering.frx":29CA
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":2B1C
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   3690
         MouseIcon       =   "Ordering.frx":2E61
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":2FB3
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3000
         MouseIcon       =   "Ordering.frx":330F
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":3461
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   795
         Left            =   2310
         MouseIcon       =   "Ordering.frx":3774
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":38C6
         Style           =   1  'Graphical
         TabIndex        =   76
         ToolTipText     =   "Add Record"
         Top             =   60
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "Ordering.frx":3BD9
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":3D2B
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   930
         MouseIcon       =   "Ordering.frx":4025
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":4177
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   240
         MouseIcon       =   "Ordering.frx":44CF
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":4621
         Style           =   1  'Graphical
         TabIndex        =   73
   ...
   Begin VB.PictureBox picSaves 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "Ordering.frx":4980
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":4AD2
         Style           =   1  'Graphical
         TabIndex        =   70
         Top             =   60
         Width           =   705
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   90
         MouseIcon       =   "Ordering.frx":4E10
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":4F62
         Style           =   1  'Graphical
         TabIndex        =   71
         Top             =   60
         Width           =   705
...
Sub FillSearchGrid()
    ...
    If optVModel.Value = True Then
        Set temprs = gconDMIS.Execute("SELECT ModelDescript, PO_NO , ID FROM SMIS_PO WHERE ModelDescript Like " & N2Str2Null(ReplaceQuote(textSearch & "%")))
    ElseIf optDate.Value = True Then
        Set temprs = gconDMIS.Execute("SELECT convert(varchar, DateOrdered,101), PO_NO , ID FROM SMIS_PO WHERE  convert(varchar, DateOrdered,101)  Like " & N2Str2Null(ReplaceQuote(textSearch & "%")))
    ElseIf optPO.Value = True Then
        XXX = Format(textSearch, "000000")
        Set temprs = gconDMIS.Execute("SELECT convert(varchar, DateOrdered,101), PO_NO ,  ID FROM SMIS_PO WHERE  PO_NO Like '%" & XXX & "%'")
    End If
...
Private Sub Check1_Click()
    ...
    Else
        TXTWTAX.Visible = True
    End If
     'TXTWTAX.Text = Round((((ToDoubleNumber(txtPy_CD_Amount.Text)) / 1.12) * 0.01), 2)
End Sub
...
Private Sub cmdPrint_Click()
    ...
    If COMPANY_CODE = "HBK" Or (VALID_COMPANY_CODE_FORHAI = True) Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HAS" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HOT" Then
        picContact.Visible = False
    Else
...
'Updated: ACL
'Description: Add field ModeofPayment
'Date: 3272011
    If AddorEdit = "ADD" Then
