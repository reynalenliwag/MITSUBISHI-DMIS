...
Begin VB.Form frmSMIS_Report_Print_HAS 
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin wizButton.cmd cmdjob 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "Print_HAS.frx":0F92
      End
      Begin wizButton.cmd cmdAuthorization 
         Height          =   435
         Left            =   150
         TabIndex        =   28
         ToolTipText     =   "PNP Motor Vehicle Clearance Application"
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "Print_HAS.frx":0FAE
      End
      Begin wizButton.cmd cmdPlateEndingRequest 
         Height          =   435
         Left            =   150
         TabIndex        =   29
         ToolTipText     =   "PNP Motor Vehicle Clearance Application"
         ...
         _ExtentX        =   7170
         _ExtentY        =   767
         TX              =   "Plate Ending Request Waiver"
         ENAB            =   -1  'True
         BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   11.25
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "Print_HAS.frx":0FCA
      End
      Begin wizButton.cmd cmdRequestVehicleRegistration 
         Height          =   435
         Left            =   150
         TabIndex        =   30
         ToolTipText     =   "PNP Motor Vehicle Clearance Application"
         ...
         _ExtentX        =   7170
         _ExtentY        =   767
         TX              =   "Request for Vehicle Registration"
         ENAB            =   -1  'True
         BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   11.25
   ...
   End
End
Attribute VB_Name = "frmSMIS_Report_Print_HAS"
...
Private Sub cmdAuthorization_Click()
'''ProgrammedBy:Ryan DC. Culaway
''Date:Thursday June 13,2008
    
    rptPrint.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
    rptPrint.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
 PrintSQLReport rptPrint, SMIS_REPORT_PATH & "Authorization.rpt", "{customer.cuscde}='" & CUSCODE & "' AND {vehicle.ignkey}='" & Null2String(frmSMIS_Trans_VehicleInvoice.txtVehicleConductionSticker) & "'", DMIS_REPORT_Connection, 1
End Sub
...
Private Sub cmdPlateEndingRequest_Click()
'''ProgrammedBy:Ryan DC. Culaway
''Date:Thursday June 13,2008
    
    rptPrint.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
    rptPrint.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
    PrintSQLReport rptPrint, SMIS_REPORT_PATH & "PlateEndingRequest.rpt", "{customer.cuscde}='" & CUSCODE & "' AND {vehicle.ignkey}='" & Null2String(frmSMIS_Trans_VehicleInvoice.txtVehicleConductionSticker) & "'", DMIS_REPORT_Connection, 1
End Sub

Private Sub cmdPrintCreditMemo_Click()
    'IGNKEYNO = Null2String(frmSMIS_Trans_VehicleInvoice.txtVehicleConductionSticker.Text)
    Screen.MousePointer = 11
    ''''''
    Dim lng                             As Integer
    ...
    '
    PrintSQLReport rptPrint, SMIS_REPORT_PATH & "CREDITMEMO.rpt", "{SMIS_MrrInv_Detail.IgnkeyNo} = '" & IGNKEYNO & "'", DMIS_REPORT_Connection, 1
...
Private Sub cmdRequestVehicleRegistration_Click()
'''ProgrammedBy:Ryan DC. Culaway
''Date:Thursday June 13,2008
    
    rptPrint.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
    rptPrint.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
    PrintSQLReport rptPrint, SMIS_REPORT_PATH & "RequestForVehicleRegistration.rpt", "{customer.cuscde}='" & CUSCODE & "' AND {vehicle.ignkey}='" & Null2String(frmSMIS_Trans_VehicleInvoice.txtVehicleConductionSticker) & "'", DMIS_REPORT_Connection, 1
...
Private Sub cmdVDR_Click()
    ...
    If Not rsCustomer.EOF And Not rsCustomer.BOF Then
        ...
        'DATE UPDATED: 08/08/2008
        If COMPANY_CODE = "HAS" Then
           rptPrint.Formulas(0) = "PreparedBy='" & Null2String(PreparedBy) & "'"
           rptPrint.Formulas(1) = "SalesApproved='" & Null2String(ApprovedBy) & "'"
           rptPrint.Formulas(2) = "GM='" & Null2String(GeneralManager) & "'"
           rptPrint.Formulas(3) = "SalesDispatcher='" & Null2String(SalesDispatcher) & "'"
        End If
        ...
        If Not rsCustomer.EOF And Not rsCustomer.BOF Then
            ...
            If Null2String(rsPurchAgree!TERM) = "COD" Or Null2String(rsPurchAgree!TERM) = "CPO" Then
                ...
                If COMPANY_CODE = "HAS" Then
                    ...
                    PrintSQLReport rptPrint, SMIS_REPORT_PATH & "vi_acct.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
                End If
            ...
            Else
                ...
                If COMPANY_CODE = "HAS" Then
                    ...
                    rptPrint.Formulas(2) = "ApprovedBy='" & Null2String(ApprovedBy) & "'"
                    rptPrint.Formulas(3) = "GM='" & Null2String(GeneralManager) & "'"
                    PrintSQLReport rptPrint, SMIS_REPORT_PATH & "VI_FIN_acct.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
                End If
