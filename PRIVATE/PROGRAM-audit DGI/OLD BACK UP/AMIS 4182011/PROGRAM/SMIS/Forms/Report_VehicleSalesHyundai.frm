...
Sub PRINT_DEALER_ENDING_INVENTORY()
    ...
    Set rsCust = gconDMIS.Execute("SELECT DESCRIPT , IGNKEY,VINO AS VINNO ,COLOR,PULLOUTDATE  FROM SMIS_MRRINV_TABLE where released=0 and status <> 'C' ORDER BY DESCRIPT ASC")
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            frmALL_AuditInquiry.Caption = "Audit Inquiry (HYUNDAI REPORTS)"
            Call frmALL_AuditInquiry.DisplayHistory("", "HYUNDAI REPORTS", "PRINTING")
