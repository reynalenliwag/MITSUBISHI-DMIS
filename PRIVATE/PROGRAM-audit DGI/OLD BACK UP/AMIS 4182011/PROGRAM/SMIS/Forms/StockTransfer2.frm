...
Begin VB.Form frmSMIS_Trans_MRR2 
   ...
   Begin VB.PictureBox picTops 
      ...
      Begin VB.ComboBox cboEntityFrom 
         ...
         Width           =   3405
      End
      Begin VB.ComboBox cboEntity_FROM 
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.PictureBox picBottoms 
      ...
      Begin VB.PictureBox picSaves 
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   795
            Left            =   930
            MouseIcon       =   "StockTransfer2.frx":08CA
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":0A1C
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Cancel"
            Top             =   30
         ...
         Begin VB.CommandButton cmdSave 
            ...
            Height          =   795
            Left            =   240
            MouseIcon       =   "StockTransfer2.frx":0D5A
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":0EAC
            Style           =   1  'Graphical
            TabIndex        =   5
      ...
      Begin VB.PictureBox picAdds 
         ...
         Begin VB.CommandButton cmdExit 
            ...
            Height          =   795
            Left            =   7380
            MouseIcon       =   "StockTransfer2.frx":11FC
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":134E
            Style           =   1  'Graphical
            TabIndex        =   15
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   795
            Left            =   6690
            MouseIcon       =   "StockTransfer2.frx":16B4
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":1806
            Style           =   1  'Graphical
            TabIndex        =   14
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   795
            Left            =   300
            MouseIcon       =   "StockTransfer2.frx":1B6C
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":1CBE
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.CommandButton cmdCancelCO 
            ...
            Left            =   6000
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "StockTransfer2.frx":1FE9
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":213B
            Style           =   1  'Graphical
            TabIndex        =   103
         ...
         Begin VB.CommandButton cmdPost 
            ...
            Left            =   5310
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "StockTransfer2.frx":2475
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":25C7
            Style           =   1  'Graphical
            TabIndex        =   102
         ...
         Begin VB.CommandButton cmdUnPost 
            ...
            Left            =   4620
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "StockTransfer2.frx":28EC
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":2A3E
            Style           =   1  'Graphical
            TabIndex        =   104
         ...
         Begin VB.CommandButton cmdEdit 
            ...
            Height          =   795
            Left            =   3930
            MouseIcon       =   "StockTransfer2.frx":2D83
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":2ED5
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmdAdd 
            ...
            Height          =   795
            Left            =   3240
            MouseIcon       =   "StockTransfer2.frx":3231
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":3383
            Style           =   1  'Graphical
            TabIndex        =   11
         ...
         Begin VB.CommandButton cmdFind 
            ...
            Height          =   795
            Left            =   2550
            MouseIcon       =   "StockTransfer2.frx":3696
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":37E8
            Style           =   1  'Graphical
            TabIndex        =   10
         ...
         Begin VB.CommandButton cmdNext 
            ...
            Height          =   795
            Left            =   1860
            MouseIcon       =   "StockTransfer2.frx":3AE2
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":3C34
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmdPrevious 
            ...
            Height          =   795
            Left            =   1170
            MouseIcon       =   "StockTransfer2.frx":3F8C
            MousePointer    =   99  'Custom
            Picture         =   "StockTransfer2.frx":40DE
            Style           =   1  'Graphical
            TabIndex        =   8
   ...
   Begin VB.PictureBox picViewVehicles 
      ...
      Begin VB.CommandButton cmdCancelViewVehicles 
         ...
         Index           =   2
         Left            =   8850
         MouseIcon       =   "StockTransfer2.frx":443D
         MousePointer    =   99  'Custom
         Picture         =   "StockTransfer2.frx":458F
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Cancel"
         Top             =   4200
      ...
      Begin VB.CommandButton cmdSelect 
         ...
         Height          =   600
         Left            =   8220
         MouseIcon       =   "StockTransfer2.frx":48CD
         MousePointer    =   99  'Custom
         Picture         =   "StockTransfer2.frx":4A1F
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Select"
         Top             =   4200
   ...
   End
End
Attribute VB_Name = "frmSMIS_Trans_MRR2"
...
Sub InitMemVars()
    ...
    Combo_Loadval cboEntity_FROM, gconDMIS.Execute("select distinct entity_to from smis_stocktransfer where entity_to is not null")
End Sub
...
Private Sub cboEntity_FROM_KeyPress(KeyAscii As Integer)
...
Private Sub cmdCancelCO_Click()
    ...
    gconDMIS.Execute ("Update SMIS_MRRINV SET ISTATUS='T' , datereleased = " & N2Date2Null(rsST!DEYT) & ", RELEASED=1  WHERE ignkey=" & N2Str2Null(rsST!CSNO))
    LogAudit "C", "VEHICLE TRANSFER", cboEntity_FROM & " MODEL: " & txtV_ModelDescript & " CS NO:" & txtV_IgnKey
    rsST.Requery
    rsST.Find ("ID=" & labid)
    StoreMemVars
...
Private Sub cmdPost_Click()
    ...
    LogAudit "P", "VEHICLE TRANSFER", cboEntity_FROM & " MODEL: " & txtV_ModelDescript & " CS NO:" & txtV_IgnKey
    rsST.Requery
    rsST.Find ("ID=" & labid)
    StoreMemVars
...
Private Sub cmdUnPost_Click()
    ...
    LogAudit "U", "VEHICLE TRANSFER", cboEntity_FROM & " MODEL: " & txtV_ModelDescript & " CS NO:" & txtV_IgnKey
    rsST.Requery
    rsST.Find ("ID=" & labid)
    StoreMemVars
...
Private Sub cmdPrint_Click()
    ...
    LogAudit "V", "VEHICLE TRANSFER", cboEntity_FROM & " MODEL: " & txtV_ModelDescript & " CS NO:" & txtV_IgnKey
...
Private Sub cmdSave_Click()
    ...
    If RTrim(LTrim(cboEntity_FROM)) = "" Then
        ShowIsRequiredMsg " To "
        On Error Resume Next
        cboEntity_FROM.SetFocus
        Exit Sub
    End If
    ...
    'vtxt_Entity_To = N2Str2Null(cboEntity_FROM)
    vtxt_Entity_From = N2Str2Null(cboEntity_FROM)
    ...
    If AddorEdit = "ADD" Then
        ...
        SQL = SQL & vtxt_Entity_From & " ," & vtxt_SDNO & " ,"
        ...
        LogAudit "A", "VEHICLE TRANSFER", cboEntity_FROM & " MODEL: " & txtV_ModelDescript & " CS NO:" & txtV_IgnKey
    ...
    Else
        ...
        LogAudit "E", "VEHICLE TRANSFER", cboEntity_FROM & " MODEL: " & txtV_ModelDescript & " CS NO:" & txtV_IgnKey
    End If

    gconDMIS.Execute ("Update SMIS_MRRINV SET ISTATUS='O', released=0, datereleased= NULL WHERE ignkey=" & vtxt_CSNO)
    rsST.Requery
...
Private Sub cmdSelect_Click()
    ...
    With lvViewVehicles.SelectedRows(0)
        ...
        Set rsCheck = gconDMIS.Execute("Select * from SMIS_Stocktransfer where CSNO = '" & .Record(4).Value & "" & "' and ENTITY_TO IS NOT NULL and STATUS = 'P'")
            If Not rsCheck.EOF And Not rsCheck.BOF Then
                ...
                ShowHidePictureBox2 picViewVehicles, False
            Else
                MsgBox ("Please POST this unit in STOCK TRANSFER OUT... Not yet Posted!"), vbInformation, "SMIS"
                Exit Sub
            End If
        Set rsCheck = Nothing
    End With
    ...
    'UPDATED BY: JUN
    'DATE UPDATED: 10242008
'     Dim rsDSNO As ADODB.Recordset
'        Set rsDSNO = gconDMIS.Execute("Select SDNO from SMIS_STOCKTRANSFER where CSNO = " & N2Str2Null(txtV_IgnKey) & "")
'        If Not rsDSNO.EOF And Not rsDSNO.BOF Then
'            txtSDNO.Text = Null2String(rsDSNO!SDNO)
'        End If
'     Set rsDSNO = Nothing
...
Private Sub cmdSelectVehicles_Click()
    ...
    flex_FillReportView gconDMIS.Execute("SELECT Make, Model , Yeer, Descript, ignkey,prodno,engineno,FrameNo,Vino,SerialNo,color,ModelCode, id , Transmission from SMIS_MRRINV where iStatus ='T'"), lvViewVehicles
...
Private Sub rsRefresh()
    ...
    Call rsST.Open("SELECT * from SMIS_StockTransfer WHERE ENTITY_FROM IS NOT NULL ORDER BY ID desc", gconDMIS, adOpenKeyset)
End Sub
...
Private Sub StoreMemVars()
    If Not rsST.EOF And Not rsST.BOF Then
        ...
        cboEntity_FROM = Null2String(rsST!Entity_From)
