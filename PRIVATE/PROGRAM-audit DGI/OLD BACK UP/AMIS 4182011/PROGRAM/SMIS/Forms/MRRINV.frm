...
Private Sub cmdPost_Click()
    ...
    Set rsCusVeh1 = gconDMIS.Execute("Select CUSCDE,NIYM,INVOICENO From CSMS_CUSVEH WHERE UPPER(MAKE) = 'HYUNDAI' AND VCOND_NO='" & txtIgnKey & "'")
...
Private Sub cmdServiceVehicle_Click()
    ...
    txtVehDet = txtVehDet & " MAKE            :HYUNDAI"
...
'    End If
    ...
    If Not (rsCusVeh1.EOF Or rsCusVeh1.BOF) Then
        ...
        SQL = SQL & " WHERE UPPER(MAKE) = 'HYUNDAI' AND VCOND_NO='" & txtIgnKey & "'"
...
Private Sub rsRefresh()
    ...
    Call rsMRRINV.Open("SELECT * from SMIS_MrrInv_Table order by id DESC", gconDMIS, adOpenKeyset)
End Sub
