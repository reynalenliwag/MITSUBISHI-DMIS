...
Begin VB.Form frmCMISOREntry 
   ...
   Begin VB.PictureBox picDetails 
      ...
      Begin VB.ComboBox cboTranType 
         ...
         ForeColor       =   &H00973640&
         Height          =   390
         ItemData        =   "OREntry.frx":4D90
         Left            =   1200
         List            =   "OREntry.frx":4D92
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Top             =   510
         Width           =   4245
   ...
   Begin VB.PictureBox picOptions 
      ...
      Begin VB.CommandButton cmdCancelOR 
         ...
         Left            =   60
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "OREntry.frx":6142
         MousePointer    =   99  'Custom
         Picture         =   "OREntry.frx":644C
         Style           =   1  'Graphical
         TabIndex        =   5
    ...
    If MsgBox("Print Official Receipt now?", vbQuestion + vbYesNo) = vbYes Then
        ...
        Else
            If OR_VAT_NONVAT = "VAT" Then
                ...
                Else
                    PrintSQLReport rptChat, CMIS_REPORT_PATH & "OfficialReceipt2.rpt", "{OFF_HD.VAT} = 1" & " AND {OFF_HD.OR_NUM} = '" & txtOR_NUM.Text & "'", DMIS_REPORT_Connection, 1
                End If
            Else
