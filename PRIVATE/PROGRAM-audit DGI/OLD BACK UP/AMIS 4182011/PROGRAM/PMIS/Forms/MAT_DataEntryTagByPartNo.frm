...
Begin VB.Form frmPMISMAT_DataEntryTagByPartNo 
   ...
   ClientWidth     =   7575
   ForeColor       =   &H00DEDFDE&
   Icon            =   "MAT_DataEntryTagByPartNo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin MSFlexGridLib.MSFlexGrid grdTags 
      ...
      Appearance      =   0
      MousePointer    =   99
      MouseIcon       =   "MAT_DataEntryTagByPartNo.frx":030A
   End
End
Attribute VB_Name = "frmPMISMAT_DataEntryTagByPartNo"
