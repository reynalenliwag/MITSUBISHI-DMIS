...
Begin VB.Form frmPMISTrans_CustomerOrder_AC 
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "AC_CustomerOrder.frx":3CAB
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -540
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   810
         MouseIcon       =   "AC_CustomerOrder.frx":69E7
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":6B39
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "AC_CustomerOrder.frx":6E77
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":6FC9
         Style           =   1  'Graphical
         TabIndex        =   89
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "AC_CustomerOrder.frx":7796
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":78E8
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "AC_CustomerOrder.frx":7C26
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":7D78
         Style           =   1  'Graphical
         TabIndex        =   84
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3030
         MouseIcon       =   "AC_CustomerOrder.frx":80C8
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":821A
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   1560
         Width           =   855
