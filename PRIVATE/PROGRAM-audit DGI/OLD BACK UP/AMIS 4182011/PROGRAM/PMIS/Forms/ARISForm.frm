...
Begin VB.Form frmPMISAC_ARISForms 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "ARISForm.frx":73A7
         MousePointer    =   99  'Custom
         Picture         =   "ARISForm.frx":74F9
         Style           =   1  'Graphical
         TabIndex        =   86
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "ARISForm.frx":7824
         MousePointer    =   99  'Custom
         Picture         =   "ARISForm.frx":7976
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "ARISForm.frx":7CB4
         MousePointer    =   99  'Custom
         Picture         =   "ARISForm.frx":7E06
         Style           =   1  'Graphical
         TabIndex        =   85
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3405
         MouseIcon       =   "ARISForm.frx":8156
         MousePointer    =   99  'Custom
         Picture         =   "ARISForm.frx":82A8
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   1575
         Width           =   855
