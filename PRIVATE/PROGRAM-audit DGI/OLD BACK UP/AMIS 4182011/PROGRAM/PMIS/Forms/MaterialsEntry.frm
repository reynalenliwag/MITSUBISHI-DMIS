...
Begin VB.Form frmPMISMaterialsEntry 
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstPartsEntry 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "MaterialsEntry.frx":08CA
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "MaterialsEntry.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   705
         MouseIcon       =   "MaterialsEntry.frx":0EDD
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":102F
         Style           =   1  'Graphical
         TabIndex        =   43
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1425
         MouseIcon       =   "MaterialsEntry.frx":1387
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":14D9
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2130
         MouseIcon       =   "MaterialsEntry.frx":17D3
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":1925
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2835
         MouseIcon       =   "MaterialsEntry.frx":1C38
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":1D8A
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "MaterialsEntry.frx":20E6
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":2238
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4260
         MouseIcon       =   "MaterialsEntry.frx":2563
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":26B5
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   4965
         MouseIcon       =   "MaterialsEntry.frx":2A1B
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":2B6D
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   15
         Width           =   705
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "MaterialsEntry.frx":2ED3
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":3025
         Style           =   1  'Graphical
         TabIndex        =   47
         Top             =   0
         Width           =   705
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   705
         MouseIcon       =   "MaterialsEntry.frx":3375
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsEntry.frx":34C7
         Style           =   1  'Graphical
         TabIndex        =   46
         Top             =   0
         Width           =   705
   ...
   End
End
Attribute VB_Name = "frmPMISMaterialsEntry"
