    ...
    If AddorEdit = "EDIT" Then
        ...
        ElseIf Null2String(RSPARTS_DETAIL!NON_HARI) = "Y" Then
            If cboClass.ListIndex = 0 Then
                MsgBox "This is a Non-Hari parts, cannot change to HARI parts.", vbInformation + vbOKOnly
                cboClass.ListIndex = 1
                Exit Sub
        ...
        ElseIf Null2String(RSPARTS_DETAIL!NON_HARI) = "N" Then
            If cboClass.ListIndex = 1 Then
                MsgBox "This is a Hari parts, cannot change to Non-HARI parts.", vbInformation + vbOKOnly
                cboClass.ListIndex = 0
                Exit Sub
            ElseIf cboClass.ListIndex = 2 Then
        ...
        ElseIf Null2String(RSPARTS_DETAIL!NON_HARI) = "0" Then
            If cboClass.ListIndex = 0 Then
                MsgBox "This is an Other Brand parts, cannot change to HARI parts.", vbInformation + vbOKOnly
                cboClass.ListIndex = 2
                Exit Sub
            ElseIf cboClass.ListIndex = 1 Then
                MsgBox "This is an Other Brand parts, cannot change to Non-Hari.", vbInformation + vbOKOnly
                cboClass.ListIndex = 2
                Exit Sub
            End If
        End If
