...
Begin VB.Form frmPMISReports_MoveCat 
   ...
   Begin wizButton.cmd cmdE1 
      ...
      _ExtentX        =   7646
      _ExtentY        =   714
      TX              =   "RANK E - NON-MOVING FOR 1 YEAR  "
      ENAB            =   0   'False
   ...
   Begin wizButton.cmd cmd_rankA4 
      ...
      Left            =   60
      TabIndex        =   15
      ToolTipText     =   "View detailed list of rank A4 parts"
      Top             =   1866
      Width           =   4335
      _ExtentX        =   7646
      _ExtentY        =   714
      TX              =   "RANK A4 - FAST MOVING PARTS"
      ENAB            =   -1  'True
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   8.25
