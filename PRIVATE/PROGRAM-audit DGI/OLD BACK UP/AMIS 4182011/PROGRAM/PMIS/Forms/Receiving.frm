...
Begin VB.Form frmPMISTrans_Receiving2 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   7410
         MouseIcon       =   "Receiving.frx":4A74
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":4BC6
         Style           =   1  'Graphical
         TabIndex        =   111
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   825
         Left            =   3060
         MouseIcon       =   "Receiving.frx":4EF1
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":5043
         Style           =   1  'Graphical
         TabIndex        =   108
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   6690
         MouseIcon       =   "Receiving.frx":58AC
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":59FE
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   5970
         MouseIcon       =   "Receiving.frx":5D3C
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":5E8E
         Style           =   1  'Graphical
         TabIndex        =   113
      ...
      Begin VB.Frame fraUpdateMaster 
         ...
         Begin VB.ComboBox cboClass 
            Height          =   315
            ItemData        =   "Receiving.frx":61DE
            Left            =   1290
            List            =   "Receiving.frx":61E0
            Style           =   2  'Dropdown List
            TabIndex        =   120
            Top             =   2190
            Width           =   2835
         ...
         Begin VB.CommandButton cmdOKUpdate 
            ...
            Height          =   555
            Left            =   4260
            MouseIcon       =   "Receiving.frx":61E2
            MousePointer    =   99  'Custom
            Picture         =   "Receiving.frx":6334
            Style           =   1  'Graphical
            TabIndex        =   89
            Top             =   1470
            Width           =   555
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboClasscode 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "Receiving.frx":65E9
         Left            =   5550
         List            =   "Receiving.frx":65EB
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   420
         Width           =   3015
