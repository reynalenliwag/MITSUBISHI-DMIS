...
Begin VB.Form frmPMISAC_CounterInquiry 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "AC_CountInq.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "AC_CountInq.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_CountInq.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "AC_CountInq.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2460
         MouseIcon       =   "AC_CountInq.frx":1224
         MousePointer    =   99  'Custom
         Picture         =   "AC_CountInq.frx":1376
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1740
         MouseIcon       =   "AC_CountInq.frx":16D4
         MousePointer    =   99  'Custom
         Picture         =   "AC_CountInq.frx":1826
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1020
         MouseIcon       =   "AC_CountInq.frx":1B20
         MousePointer    =   99  'Custom
         Picture         =   "AC_CountInq.frx":1C72
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   300
         MouseIcon       =   "AC_CountInq.frx":1FCA
         MousePointer    =   99  'Custom
         Picture         =   "AC_CountInq.frx":211C
         Style           =   1  'Graphical
         TabIndex        =   84
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstParts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_CountInq.frx":247B
         NumItems        =   2
   ...
   End
End
Attribute VB_Name = "frmPMISAC_CounterInquiry"
...
Sub rsRefresh()
    ...
    rsPartMas.Open "select * from PMIS_Accessories WHERE ACTIVE = 'Y' order by STOCKNO asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub FillGrid()
    ...
    Set rsParts = gconDMIS.Execute("select STOCKNO,STOCKNO from PMIS_Accessories WHERE [TYPE] = 'A' AND ACTIVE = 'Y' order by STOCKNO asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsParts = New ADODB.Recordset
    Set rsParts = gconDMIS.Execute("select STOCKNO, STOCKNO from PMIS_Accessories where [TYPE] = 'A' AND ACTIVE = 'Y'  AND STOCKNO like'" & XXX & "%'")
    If Not (rsParts.EOF And rsParts.BOF) Then
        lstParts.Enabled = True
        Listview_Loadval Me.lstParts.ListItems, rsParts
        lstParts.Refresh
...
Sub FillGrid2()
    ...
    lstParts.Sorted = False: lstParts.ListItems.Clear
    Set rsParts = New ADODB.Recordset
    Set rsParts = gconDMIS.Execute("select STOCKDESC, STOCKNO from PMIS_Accessories WHERE ACTIVE = 'Y' order by STOCKDESC asc")
    If Not (rsParts.EOF And rsParts.BOF) Then
        lstParts.Enabled = True
        Listview_Loadval Me.lstParts.ListItems, rsParts
        lstParts.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set rsParts = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsParts = gconDMIS.Execute("select STOCKDESC, STOCKNO from PMIS_Accessories where [TYPE] = 'A'  AND ACTIVE = 'Y' AND STOCKDESC like'" & XXX & "%'")
    If Not (rsParts.EOF And rsParts.BOF) Then
        lstParts.Enabled = True
        Listview_Loadval Me.lstParts.ListItems, rsParts
        lstParts.Refresh
