...
Begin VB.Form frmPMIS_Physical_CreateINVDATA 
   ...
   ClientWidth     =   4365
   ForeColor       =   &H00DEDFDE&
   Icon            =   "CreateINVData.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "CreateINVData.frx":1472
   ScaleHeight     =   780
   ScaleWidth      =   4365
   ...
   Begin VB.CommandButton cmdCreateData 
      ...
      Height          =   540
      Left            =   750
      MouseIcon       =   "CreateINVData.frx":1AEC
      MousePointer    =   99  'Custom
      TabIndex        =   0
      ToolTipText     =   "Create Cut-Off Database"
      Top             =   75
      Width           =   3315
   End
   ...
   End
End
Attribute VB_Name = "frmPMIS_Physical_CreateINVDATA"
...
Sub Create_Database()
    ...
    frmSplash.Show
    frmSplash.labCon.Caption = "Creating CutOff Part Master File... Please wait..."
    DoEvents
...
Sub Create_Part_MasterFile_Table()
    ...
    Set FLDCUTOFF(7) = tdCUTOFF.CreateField("LOCATION", dbText, 100)
    Set FLDCUTOFF(8) = tdCUTOFF.CreateField("MAC", dbDouble)
    Set FLDCUTOFF(9) = tdCUTOFF.CreateField("MAD", dbLong)
    Set FLDCUTOFF(10) = tdCUTOFF.CreateField("OLDNO", dbText, 30)
    Set FLDCUTOFF(11) = tdCUTOFF.CreateField("NEWNO", dbText, 30)
    Set FLDCUTOFF(12) = tdCUTOFF.CreateField("GENNO", dbText, 30)
    ...
    Set FLDCUTOFF(49) = tdCUTOFF.CreateField("TAGNO", dbLong)
...
Sub Create_ConPhy_MasterFile_Table()
    ...
    Set FLDCONPHY(3) = tdCONPHY.CreateField("LOCATION", dbText, 100)
    ...
    Set FLDCONPHY(9) = tdCONPHY.CreateField("TAGNO", dbLong)
    ...
    Set FLDCONPHY(15) = tdCONPHY.CreateField("GROUP_NO", dbText, 10)
    ...
    Set FLDCONPHY(19) = tdCONPHY.CreateField("NEWPARTNO", dbText, 30)
    For I = 0 To 19
...
Sub Create_PhyCnt_MasterFile_Table()
    ...
    Set FLDPHYCNT(3) = tdPHYCNT.CreateField("LOCATION", dbText, 100)
    ...
    Set FLDPHYCNT(9) = tdPHYCNT.CreateField("TAGNO", dbLong)
    ...
    Set FLDPHYCNT(15) = tdPHYCNT.CreateField("GROUP_NO", dbText, 10)
    ...
    Set FLDPHYCNT(19) = tdPHYCNT.CreateField("NEWPARTNO", dbText, 30)
    For I = 0 To 19
...
Sub Create_TagNumber_MasterFile_Table()
    ...
    Set FLDTAGS(1) = tdTAGS.CreateField("TAG", dbLong)
...
Private Sub cmdCreateData_Click()
    ...
    'If Function_Access(LOGID, "Acess_Process", "FILES CREATE INVENTORY DATABASE") = False Then Exit Sub
    ...
    Create_Database
    NEW_LogAudit "G", "PHYSICAL COUNT", "", "", "", "", "Create Inventory Database", ""
    If err = 32755 Then Exit Sub
End Sub
