...
Begin VB.Form frmCMISOREntry 
   ...
   Begin VB.PictureBox picDetails 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   90
         MouseIcon       =   "OREntry.frx":5E49
         MousePointer    =   99  'Custom
         Picture         =   "OREntry.frx":5F9B
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   2910
         Width           =   705
      ...
      Begin VB.ComboBox cboTranType 
         ...
         ForeColor       =   &H00973640&
         Height          =   390
         ItemData        =   "OREntry.frx":65D0
         Left            =   1200
         List            =   "OREntry.frx":65D2
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Top             =   510
         Width           =   4245
 ...
 If SetTranTypeCode(cboTranType.Text) = "VI" Then
          ...
          '--May 13 Friday 2011. Customer Downpayment instead total amount with financed corporation
           ...
           If Not rsPurchAgree.EOF And Not rsPurchAgree.BOF Then
            If txtCustype.Text = "B" Then
               Set rsBankFinance = gconDMIS.Execute("Select BalToFinanced as BalanceFinance,FINANCINGCODE,VI_No as VI,SO_NO From SMIS_PurchAgree  where FINANCINGCODE = " & N2Str2Null(txtCUSCDE.Text) & "and VI_No=" & N2Str2Null(txtReference.Text))
