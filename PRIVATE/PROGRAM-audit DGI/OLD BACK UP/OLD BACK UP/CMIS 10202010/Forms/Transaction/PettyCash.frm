...
Private Sub Command1_Click()
    ...
    rsPettyUpdate.Open "SELECT DISTINCT AMIS_CHARTACCOUNT.ACCTCODE,ACCOUNT_CD,AMIS_CHARTACCOUNTHAI.DESCRIPTION FROM CMIS_PETTY INNER JOIN AMIS_CHARTACCOUNTHAI ON AMIS_CHARTACCOUNTHAI.ACCTCODE=CMIS_PETTY.ACCOUNT_CD INNER JOIN AMIS_CHARTACCOUNT ON AMIS_CHARTACCOUNT.DESCRIPTION=AMIS_CHARTACCOUNTHAI.DESCRIPTION WHERE CMIS_PETTY.ACCOUNT_CD NOT IN (SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE AMIS_CHARTACCOUNT.ACCTCODE=CMIS_PETTY.ACCOUNT_CD) AND CMIS_PETTY.ACCOUNT_CD IS NOT NULL ORDER BY CMIS_PETTY.ACCOUNT_CD", gconDMIS, adOpenKeyset
