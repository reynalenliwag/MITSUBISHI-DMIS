...
Private Sub cmdOK_Click()
    ...
    Else
        Set RSCUSTOMERINFO = gconDMIS.Execute("SELECT CUSTCODE CODE FROM PMIS_VW_ISS_HISTORY WHERE TYPE=" & N2Str2Null(TTYPE) & " AND TRANTYPE=" & N2Str2Null(INVTYPE) & " AND TRANNO=" & N2Str2Null(Format(txt_InvNo, "000000")))
    End If
