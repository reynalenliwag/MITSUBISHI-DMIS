...
Begin VB.Form frmCreditCardCompany 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Picture         =   "CreditCardCompany.frx":0AFC
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3675
         MouseIcon       =   "CreditCardCompany.frx":0E62
         MousePointer    =   99  'Custom
         Picture         =   "CreditCardCompany.frx":0FB4
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2980
         MouseIcon       =   "CreditCardCompany.frx":12DF
         MousePointer    =   99  'Custom
         Picture         =   "CreditCardCompany.frx":1431
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2295
         MouseIcon       =   "CreditCardCompany.frx":178D
         MousePointer    =   99  'Custom
         Picture         =   "CreditCardCompany.frx":18DF
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1605
         MouseIcon       =   "CreditCardCompany.frx":1BF2
         MousePointer    =   99  'Custom
         Picture         =   "CreditCardCompany.frx":1D44
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   915
         MouseIcon       =   "CreditCardCompany.frx":203E
         MousePointer    =   99  'Custom
         Picture         =   "CreditCardCompany.frx":2190
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   225
         MouseIcon       =   "CreditCardCompany.frx":24E8
         MousePointer    =   99  'Custom
         Picture         =   "CreditCardCompany.frx":263A
         Style           =   1  'Graphical
         TabIndex        =   9
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lvBank 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CreditCardCompany.frx":2999
         NumItems        =   4
...
If AddorEdit = "ADD" Then
    ...
    End If
Else
    gconDMIS.Execute ("Update CMIS_CardBank Set AcctName =" & vCusName & ", BankCharges=" & vBankCharges & ", EWT=" & vEWT & " where ID = '" & lblID.Caption & "'")
