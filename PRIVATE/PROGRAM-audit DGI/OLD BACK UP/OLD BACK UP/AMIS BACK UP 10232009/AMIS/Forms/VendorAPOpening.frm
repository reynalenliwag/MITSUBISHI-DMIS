...
Begin VB.Form frmAMISVendorAPOpening 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8505
         MouseIcon       =   "VendorAPOpening.frx":0B1F
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":0C71
         Style           =   1  'Graphical
         TabIndex        =   201
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7815
         MouseIcon       =   "VendorAPOpening.frx":0FD7
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":1129
         Style           =   1  'Graphical
         TabIndex        =   200
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   7125
         MouseIcon       =   "VendorAPOpening.frx":148F
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":15E1
         Style           =   1  'Graphical
         TabIndex        =   199
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6435
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "VendorAPOpening.frx":190C
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":1A5E
         Style           =   1  'Graphical
         TabIndex        =   198
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   5745
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "VendorAPOpening.frx":1D98
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":1EEA
         Style           =   1  'Graphical
         TabIndex        =   197
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5055
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "VendorAPOpening.frx":222F
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":2381
         Style           =   1  'Graphical
         TabIndex        =   196
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4365
         MouseIcon       =   "VendorAPOpening.frx":26A6
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":27F8
         Style           =   1  'Graphical
         TabIndex        =   195
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3675
         MouseIcon       =   "VendorAPOpening.frx":2B54
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":2CA6
         Style           =   1  'Graphical
         TabIndex        =   194
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   2985
         MouseIcon       =   "VendorAPOpening.frx":2FB9
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":310B
         Style           =   1  'Graphical
         TabIndex        =   193
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2295
         MouseIcon       =   "VendorAPOpening.frx":345B
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":35AD
         Style           =   1  'Graphical
         TabIndex        =   192
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1605
         MouseIcon       =   "VendorAPOpening.frx":390B
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":3A5D
         Style           =   1  'Graphical
         TabIndex        =   191
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   915
         MouseIcon       =   "VendorAPOpening.frx":3D57
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":3EA9
         Style           =   1  'Graphical
         TabIndex        =   190
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   225
         MouseIcon       =   "VendorAPOpening.frx":4201
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":4353
         Style           =   1  'Graphical
         TabIndex        =   189
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   690
         MouseIcon       =   "VendorAPOpening.frx":46B2
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":4804
         Style           =   1  'Graphical
         TabIndex        =   204
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "VendorAPOpening.frx":4B42
         MousePointer    =   99  'Custom
         Picture         =   "VendorAPOpening.frx":4C94
         Style           =   1  'Graphical
         TabIndex        =   203
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      TabPicture(0)   =   "VendorAPOpening.frx":4FE4
      ...
      TabPicture(1)   =   "VendorAPOpening.frx":5000
      ...
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "VendorAPOpening.frx":501C
            NumItems        =   6
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   90
            MouseIcon       =   "VendorAPOpening.frx":517E
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":52D0
            Style           =   1  'Graphical
            TabIndex        =   156
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8295
            MouseIcon       =   "VendorAPOpening.frx":55FB
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":574D
            Style           =   1  'Graphical
            TabIndex        =   165
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7560
            MouseIcon       =   "VendorAPOpening.frx":5A8B
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":5BDD
            Style           =   1  'Graphical
            TabIndex        =   164
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               BackColor       =   16777215
               MultiLine       =   0   'False
               TextRTF         =   $"VendorAPOpening.frx":5F2D
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "VendorAPOpening.frx":5FC0
      End
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "VendorAPOpening.frx":5FDC
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "VendorAPOpening.frx":613E
      End
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   90
            MouseIcon       =   "VendorAPOpening.frx":615A
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":62AC
            Style           =   1  'Graphical
            TabIndex        =   184
            Top             =   720
            Width           =   705
   ...
   Begin VB.PictureBox picGJ 
      ...
      Begin MSComctlLib.ListView lstGJ 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorAPOpening.frx":6F25
         NumItems        =   6
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "ITEM #"
            Object.Width           =   1587
      ...
      Begin VB.PictureBox picGJEntry 
         ...
         Begin VB.CommandButton cmdGJCancel 
            ...
            Left            =   8160
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "VendorAPOpening.frx":7087
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":71D9
            Style           =   1  'Graphical
            TabIndex        =   97
            Top             =   690
            Width           =   1005
         ...
         Begin VB.CommandButton cmdGJSave 
            ...
            Left            =   7140
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "VendorAPOpening.frx":74EB
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":763D
            Style           =   1  'Graphical
            TabIndex        =   94
            Top             =   690
            Width           =   975
         ...
         Begin VB.CommandButton cmdGJDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "VendorAPOpening.frx":7A7F
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":7BD1
            Style           =   1  'Graphical
            TabIndex        =   95
            Top             =   720
            Width           =   1005
         ...
         Begin RichTextLib.RichTextBox txtGJAccountName 
            ...
            MultiLine       =   0   'False
            Appearance      =   0
            TextRTF         =   $"VendorAPOpening.frx":7EDB
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   9
               Charset         =   0
         ...
         Begin RichTextLib.RichTextBox txtGJAccountParticulars 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"VendorAPOpening.frx":7F6E
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin wizButton.cmd cmdGJEntry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "VendorAPOpening.frx":8005
      End
      Begin RichTextLib.RichTextBox txtParticulars2 
         ...
         BackColor       =   16777215
         ScrollBars      =   2
         TextRTF         =   $"VendorAPOpening.frx":8021
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorAPOpening.frx":80B8
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "VendorAPOpening.frx":821A
   End
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorAPOpening.frx":8236
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   Begin wizButton.cmd cmdShowPostRange 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "VendorAPOpening.frx":8398
   End
   ...
   Begin VB.PictureBox picShowPostRange 
      ...
      Begin wizProgBar.Prg prgPostRange 
         ...
         _ExtentX        =   4048
         _ExtentY        =   503
         Picture         =   "VendorAPOpening.frx":83B4
         ForeColor       =   0
         BarPicture      =   "VendorAPOpening.frx":83D0
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Option Explicit
Dim rsJournal_HD, rsJournal_Det, rsPV_Detail, rsCV_Detail, rsCRJ_Detail, rsJV_detail, rsChartAccount, rsJournal_HD2, rsProfile As ADODB.Recordset
Attribute rsJournal_Det.VB_VarUserMemId = 1073938432
Attribute rsPV_Detail.VB_VarUserMemId = 1073938432
Attribute rsCV_Detail.VB_VarUserMemId = 1073938432
Attribute rsCRJ_Detail.VB_VarUserMemId = 1073938432
Attribute rsJV_detail.VB_VarUserMemId = 1073938432
Attribute rsChartAccount.VB_VarUserMemId = 1073938432
Attribute rsJournal_HD2.VB_VarUserMemId = 1073938432
Attribute rsProfile.VB_VarUserMemId = 1073938432
...
Attribute rsPayTerm.VB_VarUserMemId = 1073938442
Attribute rsBanks.VB_VarUserMemId = 1073938442
Attribute rsCUSTOMER.VB_VarUserMemId = 1073938442
Attribute rsInvoiceType.VB_VarUserMemId = 1073938442
...
Attribute SearchBy.VB_VarUserMemId = 1073938449
...
Attribute TOTCREDIT.VB_VarUserMemId = 1073938451
Attribute TOTTAX.VB_VarUserMemId = 1073938451
Attribute OUTBALANCE.VB_VarUserMemId = 1073938451
Attribute TOTAL_AR_AMOUNT.VB_VarUserMemId = 1073938451
Attribute TOTALPVAMOUNT.VB_VarUserMemId = 1073938451
Attribute COMP_SJ_OUTPUT_TAX.VB_VarUserMemId = 1073938451
...
Attribute PrevInvoiceNo.VB_VarUserMemId = 1073938460
Attribute PrevPV_VoucherNo.VB_VarUserMemId = 1073938460
...
Sub FillCboAcctName()
    Dim rsCOBAcctName                                                 As ADODB.Recordset
    Set rsCOBAcctName = New ADODB.Recordset
    Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where (Titles = '2101' or Titles = '2102') Order by AcctCode asc")
    If Not rsCOBAcctName.EOF And Not rsCOBAcctName.BOF Then
...
Sub rsRefresh()
    If JOURNALTYPE = "VPJ" Then Me.Caption = "VENDOR OPENING BALANCE - DATA ENTRY"
    ...
    rsJournal_HD.Open "select * from AMIS_Journal_HD where jtype = '" & JOURNALTYPE & "' order by VoucherNo asc", gconDMIS, adOpenKeyset
End Sub
...
Private Sub cmdPrint_Click()
    ...
    If JOURNALTYPE = "CDJ" Then cmdPrinting.ZOrder 0: picPrinting.ZOrder 0
    LogAudit "V", "VENDOR A/P OPENING", JOURNALTYPE & "-" & txtVoucherNo
    Exit Sub
Errorcode:
    ShowVBError
End Sub
    ...
    If AddorEdit = "ADD" Then
        ...
        If JOURNALTYPE = "VPJ" Then
            gconDMIS.Execute "insert into AMIS_PV_Detail " & _
                             "(JTYPE,VoucherNo,itemno,PO_No,MRR_No,INV_No,PROD_No,Amount,status)" & _
                           " values ('VPJ'," & J_JVOUCHERNO & ", " & PV_ITEMNO & ", " & PV_PONO & _
...
Private Sub cmdSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute "Insert into AMIS_Journal_HD" & _
                       " (jdate,voucherno,jtype,vendorcode,customercode,invoicedate,invoicetype,invoiceno,invoiceamt,duedate,paytype,refno,refdate,terms,dealer,amounttopay,Balance,AmountPaid,jno,debit,credit,outbalance,status,CheckNo,CheckDate,BankCode,remarks,PaidStatus,ReceiveStatus,USERCODE,LASTUPDATE)" & _
...
Private Sub txtBankCode_Change()
    If JOURNALTYPE = "APJ" Or JOURNALTYPE = "CDJ" Then cboBankName.Text = SetBankName(txtBankCode.Text)
    If JOURNALTYPE = "SJ" Or JOURNALTYPE = "CRJ" Then cboBankName2.Text = SetBankName(txtBankCode.Text)
End Sub
...
Private Sub txtDebit_GotFocus()
    If NumericVal(txtCredit.Text) = 0 Then
        If NumericVal(txtDebit.Text) = 0 Then
            ...
            Else
                If txtAcct_Name.Text = "OUTPUT TAX" And JOURNALTYPE = "SJ" Then
...
Private Sub txtTax_LostFocus()
    If SetAcctType(cboAcct_Code.Text) = "C" Then
        ...
        txtCredit.SetFocus
    Else
        If JOURNALTYPE = "SJ" And txtAcct_Name.Text = "OUTPUT TAX" Then
            txtDebit.Text = ZERO
            txtCredit.Text = ToDoubleNumber(txtNetAmt.Text)
            On Error Resume Next
            txtCredit.SetFocus
