...
Begin VB.Form frmAMISFILESChartOfAccount 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Picture         =   "ChartOfAccount.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   5880
         MouseIcon       =   "ChartOfAccount.frx":0EE4
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":1036
         Style           =   1  'Graphical
         TabIndex        =   46
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   5190
         MouseIcon       =   "ChartOfAccount.frx":139C
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":14EE
         Style           =   1  'Graphical
         TabIndex        =   45
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4500
         MouseIcon       =   "ChartOfAccount.frx":1819
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":196B
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3810
         MouseIcon       =   "ChartOfAccount.frx":1CC7
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":1E19
         Style           =   1  'Graphical
         TabIndex        =   43
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3090
         MouseIcon       =   "ChartOfAccount.frx":212C
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":227E
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2370
         MouseIcon       =   "ChartOfAccount.frx":25CE
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":2720
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1680
         MouseIcon       =   "ChartOfAccount.frx":2A7E
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":2BD0
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   990
         MouseIcon       =   "ChartOfAccount.frx":2ECA
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":301C
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   300
         MouseIcon       =   "ChartOfAccount.frx":3374
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":34C6
         Style           =   1  'Graphical
         TabIndex        =   40
   ...
   Begin VB.PictureBox picWizard 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   795
            Left            =   780
            MouseIcon       =   "ChartOfAccount.frx":3841
            MousePointer    =   99  'Custom
            Picture         =   "ChartOfAccount.frx":3993
            Style           =   1  'Graphical
            TabIndex        =   38
            ToolTipText     =   "Cancel"
            Top             =   60
         ...
         Begin VB.CommandButton cmdSave 
            ...
            Height          =   795
            Left            =   90
            MouseIcon       =   "ChartOfAccount.frx":3CD1
            MousePointer    =   99  'Custom
            Picture         =   "ChartOfAccount.frx":3E23
            Style           =   1  'Graphical
            TabIndex        =   37
      ...
      Begin MSComctlLib.ListView lstRelatedAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "ChartOfAccount.frx":4173
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   1764
