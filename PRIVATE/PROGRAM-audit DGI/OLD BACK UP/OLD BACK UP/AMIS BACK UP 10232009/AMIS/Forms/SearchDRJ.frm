...
Private Sub ListCustomer_DblClick()
    frmAMISDRJJournalEntry.SearchVoucherNo (Trim(Me.ListCustomer.SelectedItem.SubItems(2)))
    Unload Me
End Sub
...
Private Sub ListVoucherNo_DblClick()
    frmAMISDRJJournalEntry.SearchVoucherNo (Trim(Me.ListVoucherNo.SelectedItem))
    Unload Me
End Sub

Private Sub ListOrNumber_DblClick()
    frmAMISDRJJournalEntry.SearchVoucherNo (Trim(Me.ListOrNumber.SelectedItem.SubItems(4)))
    Unload Me
End Sub
