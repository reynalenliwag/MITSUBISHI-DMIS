...
Begin VB.Form frmAMIS_UniportedReports 
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   1770
      MouseIcon       =   "frmAMIS_UniportedReports.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "frmAMIS_UniportedReports.frx":0152
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   900
      MouseIcon       =   "frmAMIS_UniportedReports.frx":059D
      MousePointer    =   99  'Custom
      Picture         =   "frmAMIS_UniportedReports.frx":06EF
      Style           =   1  'Graphical
      TabIndex        =   9
