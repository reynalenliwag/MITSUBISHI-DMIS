...
Begin VB.Form frmSALESImport 
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   13200
      MouseIcon       =   "SALESImport.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "SALESImport.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmdCheck 
      ...
      Height          =   795
      Left            =   12480
      MouseIcon       =   "SALESImport.frx":07C2
      MousePointer    =   99  'Custom
      Picture         =   "SALESImport.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmdShowTrans 
      ...
      Height          =   375
      Left            =   3600
      MouseIcon       =   "SALESImport.frx":0BAF
      MousePointer    =   99  'Custom
      Style           =   1  'Graphical
      TabIndex        =   1
      ToolTipText     =   "Process Import of SALES"
   ...
   Begin wizProgBar.Prg progCPB 
      ...
      _ExtentX        =   10345
      _ExtentY        =   556
      Picture         =   "SALESImport.frx":0D01
      ForeColor       =   255
      Appearance      =   2
      BorderStyle     =   2
      BarPicture      =   "SALESImport.frx":0D1D
      ShowText        =   -1  'True
   ...
   Begin wizProgBar.Prg Prg1 
      ...
      _ExtentX        =   10345
      _ExtentY        =   556
      Picture         =   "SALESImport.frx":0D39
      ForeColor       =   255
      Appearance      =   2
      BorderStyle     =   2
      BarColor        =   4194304
      BarPicture      =   "SALESImport.frx":0D55
      ShowText        =   -1  'True
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
...
On Error GoTo ERR_ImportPurelyInternal
    ...
    For GridImport = 1 To Grid1.Rows - 1
        If N2Str2Zero(Grid1.Cell(GridImport, 1).Text) = 0 Then
            ...
            If Not rsPMIOS_ORD_HD.EOF And Not rsPMIOS_ORD_HD.BOF Then
                ...
                End If
                If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HAS" Then
                    If PMIOS_PAY_CLASS = "I" Then
                        'Update bY: BTT - 07092008
                        'J_GROSS = Round(NumericVal(PMIOS_TTLINVAMT), 2)
                        J_TAX = Round(NumericVal(Round((PMIOS_TTLINVAMT / 1.12), 2) * 0.12), 2)
