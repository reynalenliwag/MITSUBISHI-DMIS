...
Begin VB.Form frmAMISDRJJournalEntry 
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "DRJJounalEntry.frx":4358
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":44AA
            Style           =   1  'Graphical
            TabIndex        =   155
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7110
            MouseIcon       =   "DRJJounalEntry.frx":47D5
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":4927
            Style           =   1  'Graphical
            TabIndex        =   156
            Top             =   735
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   7845
            MouseIcon       =   "DRJJounalEntry.frx":4C77
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":4DC9
            Style           =   1  'Graphical
            TabIndex        =   158
            Top             =   735
            Width           =   705
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   240
            MouseIcon       =   "DRJJounalEntry.frx":5107
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":5259
            Style           =   1  'Graphical
            TabIndex        =   185
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               Enabled         =   -1  'True
               MultiLine       =   0   'False
               TextRTF         =   $"DRJJounalEntry.frx":5584
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8310
            MouseIcon       =   "DRJJounalEntry.frx":5617
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":5769
            Style           =   1  'Graphical
            TabIndex        =   202
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "DRJJounalEntry.frx":5AA7
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":5BF9
            Style           =   1  'Graphical
            TabIndex        =   201
            Top             =   720
            Width           =   705
      ...
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "DRJJounalEntry.frx":5F65
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
   ...
   End
End
Attribute VB_Name = "frmAMISDRJJournalEntry"
...
Function SetBankName(VVV As Variant)
    Set rsBanks = New ADODB.Recordset
    If JOURNALTYPE = "CRJ" Or JOURNALTYPE = "DRJ" Then
...
Function SetDebitCredit(VVV As Variant) As String
    ...
    If Not rsAccountType.EOF And Not rsAccountType.BOF Then
        ...
        ElseIf JOURNALTYPE = "CRJ" Or JOURNALTYPE = "DRJ" Then
    ...
    If JOURNALTYPE <> "GJ" And JOURNALTYPE <> "OPB" And JOURNALTYPE <> "ADJ" And JOURNALTYPE <> "PDJ" And JOURNALTYPE <> "CLO" Then
        ...
        If Not rsJournal_Det.EOF And Not rsJournal_Det.BOF Then
            ...
            Do While Not rsJournal_Det.EOF
                ...
                If JOURNALTYPE = "SJ" Then COMP_SJ_OUTPUT_TAX = 0
...
Sub InitCbo()
    ...
    If JOURNALTYPE = "APJ" Or JOURNALTYPE = "CDJ" Then
    ...
    If JOURNALTYPE = "SJ" Or JOURNALTYPE = "CRJ" Or JOURNALTYPE = "DRJ" Then
        Set rsBanks = New ADODB.Recordset
...
Sub rsRefresh()
    ...
    If JOURNALTYPE = "CRJ" Then Me.Caption = "UN-DEPOSITED CASH RECEIPTS JOURNAL ENTRY"
    If JOURNALTYPE = "DRJ" Then Me.Caption = "DEPOSITED CASH RECEIPTS JOURNAL ENTRY"
    ...
    If MsgBox("Are you sure you want to Cancel this Transaction?", vbQuestion + vbYesNo, "Cancel Journal") = vbYes Then
        ...
        If JOURNALTYPE = "CDJ" Then
            ...
            If Not rsCV_Detail.EOF And Not rsCV_Detail.BOF Then
                ...
                NEW_LogAudit "C", "DEPOSITED RECEIPTS JOURNAL", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, JOURNALTYPE, txtJNo
            End If
...
Private Sub cmdJournalDelete_Click()
    ...
    If MsgBox("Delete This Journal, Are you Sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
        ...
        LogAudit "X", "JOURNAL ENTRY", JOURNALTYPE & " - " & txtAcct_Name
    End If
    Dim cnt                                                           As Integer
    Dim rsJournalDup                                                  As ADODB.Recordset
    Set rsJournalDup = New ADODB.Recordset
    ...
    If Not rsJournalDup.EOF And Not rsJournalDup.BOF Then
        ...
        Do While Not rsJournalDup.EOF
            ...
            gconDMIS.Execute SQL_STATEMENT
            NEW_LogAudit "X", "DEPOSITED RECEIPTS JOURNAL", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, JOURNALTYPE, txtJNo
            rsJournalDup.MoveNext
        Loop
    End If
    FillDetails
...
Private Sub cmdJournalSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        NEW_LogAudit "A", "DEPOSITED RECEIPTS JOURNAL", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, JOURNALTYPE, txtJNo
    ...
    Else
        ...
        NEW_LogAudit "E", "DEPOSITED RECEIPTS JOURNAL", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, JOURNALTYPE, txtJNo
...
'    End If
    ...
    If JOURNALTYPE = "CRJ" Or JOURNALTYPE = "DRJ" Then
        ...
        Set rsCheckDetails = gconDMIS.Execute("Select Acct_Code, Credit from AMIS_Journal_Det Where left(Acct_Code,5) = '11-02' and Jtype = '" & JOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
...
PostJournal:
    ...
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "P", "DEPOSITED RECEIPTS JOURNAL", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, JOURNALTYPE, txtJNo
    ...
    Dim rsCHECK_POSTED As ADODB.Recordset
        Set rsCHECK_POSTED = gconDMIS.Execute("SELECT STATUS FROM AMIS_JOURNAL_DET WHERE JTYPE = '" & JOURNALTYPE & "' AND VOUCHERNO = '" & txtVoucherNo.Text & "' AND STATUS <> 'P'")
...
Private Sub cmdPrint_Click()
    ...
    If JOURNALTYPE = "DRJ" Then ShowReport "DepositedReceipts", "Vouchers", "{Journal_Hd.jno} = '" & txtJNo.Text & "'", "DEPOSITED CASH RECEIPTS JOURNAL PRINTOUT", LOGDATE, False
    LogAudit "V", "JOURNAL ENTRY", JOURNALTYPE & ":" & cboNameofVendor & " - " & txtVoucherNo
    Exit Sub
Errorcode:
    ShowVBError
End Sub
...
'    End If
    ...
    Else
        ...
        J_DEALER = "NULL"
    End If
    If JOURNALTYPE = "CDJ" Or JOURNALTYPE = "CRJ" Or JOURNALTYPE = "DRJ" Then
    ...
    If AddorEdit = "ADD" Then
        ...
        If Not rsJournal_HDDup.EOF And Not rsJournal_HDDup.BOF Then txtJNo.Text = Format(N2Str2Zero(rsJournal_HDDup!JNo) + 1, "000000") Else txtJNo.Text = "000001"
        J_JNO = N2Str2Null(txtJNo.Text)
        J_VOUCHERNO = GetVoucherNo(JOURNALTYPE)
...
'    End If
    ...
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "U", "DEPOSITED RECEIPTS JOURNAL", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, JOURNALTYPE, txtJNo
...
Private Sub txtBankCode_Change()
    ...
    If JOURNALTYPE = "SJ" Or JOURNALTYPE = "CRJ" Or JOURNALTYPE = "DRJ" Then cboBankName2.Text = SetBankName(txtbankcode.Text)
End Sub
