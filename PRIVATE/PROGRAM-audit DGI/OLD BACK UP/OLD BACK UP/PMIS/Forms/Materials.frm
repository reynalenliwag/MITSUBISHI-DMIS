...
Begin VB.Form frmPMISMaster_Materials 
   ...
   End
End
Attribute VB_Name = "frmPMISMaster_Materials"
...
Sub StoreMemvars()
    If Not rsPartMas.EOF And Not rsPartMas.BOF Then
        ...
        tmpMaterials = N2Str2Null(LTrim(RTrim(txtPartNo.Text)))
        ...
        txtSRP.Text = FormatNumber(NumericVal(rsPartMas!SRP))
...
Private Sub cmdPrint_Click()
    ...
    Call NEW_LogAudit("V", "MATERIALS MASTER FILE", "", labid, "", "MAT CODE: " & txtPartNo, "", "")
    Exit Sub
...
Private Sub cmdDelete_Click()
    ...
    If Not rsPartMas.BOF Or Not rsPartMas.EOF Then
        If ShowConfirmDelete = True Then
            SQL_STATEMENT = "delete from CSMS_MATMAS where id = " & labid.Caption
            
            gconDMIS.Execute SQL_STATEMENT
            Call NEW_LogAudit("X", "MATERIALS MASTER FILE", SQL_STATEMENT, labid, "", "MAT CODE: " & txtPartNo, "", "")
                       
            'LogAudit "X", "MATERIALS MASTER FILE", txtPartNo & "-" & txtPartDesc
            ShowDeletedMsg
        End If
    Else
...
Private Sub cmdSave_Click()
    ...
    If IsNull(txtPartNo.Text) = True Then
        MsgSpeechBox "Material Number must not be empty"
        On Error Resume Next
        txtPartNo.SetFocus
        Exit Sub
    End If
    ...
    If AddorEdit = "ADD" Then
        ...
        If Not rsfindDup.EOF And Not rsfindDup.BOF Then
            MsgSpeechBox "Material Number already exist!"
            On Error Resume Next
            txtPartNo.SetFocus
            Exit Sub
        End If
    ...
    '        Dim rsUpdateDaytran As ADODB.Recordset
    '        Set rsUpdateDaytran = New ADODB.Recordset
    '        Set rsUpdateDaytran = gconDMIS.Execute("update pmis_tdaytran SET STOCK_ORD = " & N2Str2Null(LTrim(RTrim(txtPartNo.Text))) & ",STOCK_SUP = " & N2Str2Null(LTrim(RTrim(txtPartNo.Text))) & " where type = 'M' AND STOCK_ORD = " & N2Str2Null(tmpMaterials))
    '
    '        Set rsUpdateDaytran = New ADODB.Recordset
    '        Set rsUpdateDaytran = gconDMIS.Execute("update pmis_daytran SET STOCK_ORD = " & N2Str2Null(LTrim(RTrim(txtPartNo.Text))) & ",STOCK_SUP = " & N2Str2Null(LTrim(RTrim(txtPartNo.Text))) & " where type = 'M' AND STOCK_ORD = " & N2Str2Null(tmpMaterials))
    '
    '        Set rsUpdateDaytran = New ADODB.Recordset
    '        Set rsUpdateDaytran = gconDMIS.Execute("update pmis_stockmas SET STOCKNO = " & N2Str2Null(LTrim(RTrim(txtPartNo.Text))) & " where type = 'M' AND STOCKNO = " & N2Str2Null(tmpMaterials))
    '
    '        Set rsUpdateDaytran = New ADODB.Recordset
    '        Set rsUpdateDaytran = gconDMIS.Execute("UPDATE CSMS_RO_DET SET DETCDE = " & N2Str2Null(LTrim(RTrim(txtPartNo.Text))) & " WHERE LIVIL = '3' AND DETCDE = " & N2Str2Null(tmpMaterials) & "")
    '
    '        Set rsUpdateDaytran = Nothing
    '    End If
    ...
    If AddorEdit = "ADD" Then
        ...
        End If
        SQL_STATEMENT = "Insert into CSMS_MATMAS" & _
        ...
        gconDMIS.Execute SQL_STATEMENT
        Call NEW_LogAudit("A", "MATERIALS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(txtPartNo), "STOCKNO", "CSMS_MATMAS"), "", "MAT CODE: " & txtPartNo, "", "")
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        Call NEW_LogAudit("E", "MATERIALS MASTER FILE", SQL_STATEMENT, labid, "", "MAT CODE: " & txtPartNo, "", "")
    ...
    Dim TMP_S                                                         As String
    TMP_S = textSearch
    textSearch.Text = "": textSearch.Text = TMP_S
    On Error Resume Next
    If AddorEdit = "EDIT" Then
    ...
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            If Picture1.Visible = True Then
                ...
                frmALL_AuditInquiry.Caption = "Audit Inquiry (MATERIAL MASTER FILE)"
                Call frmALL_AuditInquiry.DisplayHistory(labid, "MATERIALS MASTER FILE")
            End If
    End Select
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmPMISMaster_Parts = Nothing
    UnloadForm Me
End Sub
