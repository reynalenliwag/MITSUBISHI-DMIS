...
Sub FillDetails()
    ...
    RSDAYTRAN.Open "select id,trantype,tranno,itemno,STOCK_ORD,STOCK_SUP,tranqty,tranucost,traninvamt from PMIS_DayTran where type = 'P' and trantype = 'RR' and tranno = " & N2Str2Null(RSREC_HIST!RRNO) & " order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
