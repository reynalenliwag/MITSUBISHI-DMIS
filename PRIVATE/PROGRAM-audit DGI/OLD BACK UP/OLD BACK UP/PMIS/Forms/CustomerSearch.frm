...
Begin VB.Form frmCustomerSearch 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label2 
         ...
         Caption         =   $"CustomerSearch.frx":030A
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9
            Charset         =   0
   ...
   Begin MSComctlLib.ListView lstCustomer 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "CustomerSearch.frx":0399
      NumItems        =   10
   ...
   Begin VB.CommandButton cmdAdd 
      ...
      Height          =   915
      Left            =   6480
      MouseIcon       =   "CustomerSearch.frx":04FB
      MousePointer    =   99  'Custom
      Picture         =   "CustomerSearch.frx":064D
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   915
      Left            =   5640
      MouseIcon       =   "CustomerSearch.frx":0960
      MousePointer    =   99  'Custom
      Picture         =   "CustomerSearch.frx":0AB2
      Style           =   1  'Graphical
      TabIndex        =   10
      ToolTipText     =   "Cancel"
      Top             =   5700
   ...
   Begin VB.CommandButton cmdSelect 
      ...
      Height          =   915
      Left            =   4800
      MouseIcon       =   "CustomerSearch.frx":0DF0
      MousePointer    =   99  'Custom
      Picture         =   "CustomerSearch.frx":0F42
      Style           =   1  'Graphical
      TabIndex        =   11
...
Private Sub cmdSelect_Click()
    If Trim(txtCode.Text) <> "" Then
        frmPMISTrans_CustomerOrder.txtCustCode.Text = txtCode.Text
        frmPMISTrans_CustomerOrder.SetCustomer
        Unload Me
    End If
End Sub
