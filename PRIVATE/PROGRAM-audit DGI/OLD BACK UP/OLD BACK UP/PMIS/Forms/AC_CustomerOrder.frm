...
Begin VB.Form frmPMISTrans_CustomerOrder_AC 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "AC_CustomerOrder.frx":0D47
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":0E99
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "AC_CustomerOrder.frx":11D7
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":1329
         Style           =   1  'Graphical
         TabIndex        =   86
   ...
   Begin wizButton.cmd cmdAddTran 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "AC_CustomerOrder.frx":1679
   End
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "AC_CustomerOrder.frx":1695
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":17E7
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7080
         MouseIcon       =   "AC_CustomerOrder.frx":1B4D
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":1C9F
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_CustomerOrder.frx":2005
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":2157
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_CustomerOrder.frx":2491
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":25E3
         Style           =   1  'Graphical
         TabIndex        =   103
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "AC_CustomerOrder.frx":2908
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":2A5A
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "AC_CustomerOrder.frx":2DB6
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":2F08
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_CustomerOrder.frx":321B
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":336D
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "AC_CustomerOrder.frx":36BD
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":380F
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "AC_CustomerOrder.frx":3B6D
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":3CBF
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "AC_CustomerOrder.frx":3FB9
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":410B
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "AC_CustomerOrder.frx":4463
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":45B5
         Style           =   1  'Graphical
         TabIndex        =   101
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_CustomerOrder.frx":4914
         NumItems        =   2
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "AC_CustomerOrder.frx":4A76
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -540
   ...
   Begin wizButton.cmd cmdSignatories 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "AC_CustomerOrder.frx":77B2
   End
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3030
         MouseIcon       =   "AC_CustomerOrder.frx":77CE
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":7920
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   1560
         Width           =   855
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   810
         MouseIcon       =   "AC_CustomerOrder.frx":7C86
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":7DD8
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "AC_CustomerOrder.frx":8116
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":8268
         Style           =   1  'Graphical
         TabIndex        =   91
...
Sub FillGrid3()
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select Custname,tranno from PMIS_Ord_Hd where [TYPE] = 'A' AND trantype = '" & COUNTERTYPE & "' order by CUSTNAME asc")
...
Sub FillSearchCusTomer(XXX As String)
    ...
    Set rsOrd_Hd = gconDMIS.Execute("select custname, tranno from PMIS_Ord_Hd where [TYPE] = 'A' AND trantype = '" & COUNTERTYPE & "' and CUSTNAME  like '" & XXX & "%' order by CUSTNAME")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True: Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd: lstOrd_Hd.Refresh
    Else
        lstOrd_Hd.Enabled = False
...
Sub FillGrid()
    ...
    lstOrd_Hd.Sorted = False: lstOrd_Hd.ListItems.Clear
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select Tranno,tranno from PMIS_Ord_Hd where [TYPE] = 'A' AND trantype = '" & COUNTERTYPE & "' order by Tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsOrd_Hd = gconDMIS.Execute("select tranno, tranno from PMIS_Ord_Hd where [TYPE] = 'A' AND trantype = '" & COUNTERTYPE & "' and tranno like '" & XXX & "%'")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Sub FillGrid2()
    ...
    lstOrd_Hd.Enabled = False
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select rono,tranno from PMIS_Ord_Hd where [TYPE] = 'A' AND trantype = '" & COUNTERTYPE & "' and rono is not null order by tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsOrd_Hd = gconDMIS.Execute("select Rono, tranno from PMIS_Ord_Hd where [TYPE] = 'A' AND trantype = '" & COUNTERTYPE & "' and rono like '" & XXX & "%' order by tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Private Sub cboRefPRSNo_GotFocus()
    ...
    rsPRS.Open "Select tranno,refpisno from PMIS_vw_PRS WHERE [TYPE] = 'A' order by Tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
'=[ EAP:033109: check parts if current onhand is not zero in posting ]=
   ...
   If Not (rsTdytran.BOF And rsTdytran.EOF) Then
        Do While Not rsTdytran.EOF
            ...
            rsPrtMas.Open "Select STOCKNO,onhand from PMIS_ACCESSORIES where STOCKNO = '" & rsTdytran!STOCK_ORD & "' ", gconDMIS
...
Private Sub cmdTranSave_Click()
    ...
    If txtTranType.Text <> "ADB" Then
        Set RSPARTMAS = New ADODB.Recordset
        RSPARTMAS.Open "SELECT STOCKNO,ONHAND,SSTOCK,RESSERVICE,TISSQTY,MAC ,ISSUANCES FROM PMIS_ACCESSORIES WHERE STOCKNO = '" & cboTranPartNo.Text & "' AND ACTIVE = 'Y'", gconDMIS
        If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
            CurONHAND = N2Str2IntZero(RSPARTMAS!ONHAND)
            CurSAFESTOCK = N2Str2IntZero(RSPARTMAS!SSTOCK)
            CurTISSQTY = N2Str2IntZero(RSPARTMAS!TISSQTY)
