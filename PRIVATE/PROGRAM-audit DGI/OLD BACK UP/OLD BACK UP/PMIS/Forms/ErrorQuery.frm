...
'                End If
        ...
        If DupTranType = "RR" Then
            If MsgQuestionBox("View This Transaction?", "Duplicate Transaction") = True Then
                If VTYPE = "A" Then
                    frmPMISAC_Receiving.Show
                    frmPMISAC_Receiving.FindDupRRno (DupTranNo)
                End If
                If VTYPE = "M" Then
                    frmPMISMAT_Receiving.Show
                    frmPMISMAT_Receiving.FindDupRRno (DupTranNo)
                End If
                If VTYPE = "P" Then
...
'                End If
        ...
        If No_MstrTranType = "RR" Then
            If MsgQuestionBox("View This Transaction?", "No Master Transaction") = True Then
                If VTYPE = "A" Then
                    frmPMISAC_Receiving.Show
                    frmPMISAC_Receiving.FindDupRRno (No_MstrTranNo)
                End If
                If VTYPE = "M" Then
                    frmPMISMAT_Receiving.Show
                    frmPMISMAT_Receiving.FindDupRRno (No_MstrTranNo)
                End If
                If VTYPE = "P" Then
                    frmPMISTrans_Receiving2.Show
...
'                End If
        ...
        If NODetTranType = "RR" Then
            If MsgQuestionBox("View This Transaction?", "No Detail Transaction") = True Then
                If VTYPE = "A" Then
                    frmPMISAC_Receiving.Show
                    frmPMISAC_Receiving.FindDupRRno (NODetTranNo)
                End If
                If VTYPE = "M" Then
                    frmPMISMAT_Receiving.Show
                    frmPMISMAT_Receiving.FindDupRRno (NODetTranNo)
                End If
                If VTYPE = "P" Then
                    frmPMISTrans_Receiving2.Show
