...
Begin VB.Form frmPMISAC_Purchase 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Left            =   2580
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":0D47
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":0E99
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Left            =   1680
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":11D7
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1329
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "AC_Purchase.frx":1695
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":17E7
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "AC_Purchase.frx":1B4D
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1C9F
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7080
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":2005
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2157
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":2491
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":25E3
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":2928
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2A7A
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "AC_Purchase.frx":2D9F
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2EF1
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "AC_Purchase.frx":324D
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":339F
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_Purchase.frx":36B2
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":3804
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "AC_Purchase.frx":3B54
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":3CA6
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "AC_Purchase.frx":4004
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4156
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "AC_Purchase.frx":4450
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":45A2
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "AC_Purchase.frx":48FA
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4A4C
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstPO_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_Purchase.frx":4DAB
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   690
         MouseIcon       =   "AC_Purchase.frx":4F0D
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":505F
         Style           =   1  'Graphical
         TabIndex        =   80
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   -90
         MouseIcon       =   "AC_Purchase.frx":539D
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":54EF
         Style           =   1  'Graphical
         TabIndex        =   81
...
Private Sub cmdSave_Click()
    ...
    Else
        If ADDOREDIT = "ADD" Then
            ...
            rsPO_HDDup.Open "select pono from PMIS_PO_HD where [TYPE] = 'A' AND pono = '" & txtPONo.Text & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
