...
Begin VB.Form frmPMIS_Physical_DataEntryTagByPartNo 
   ...
   ClientWidth     =   7575
   ForeColor       =   &H00DEDFDE&
   Icon            =   "DataEntryTagByPartNo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin MSFlexGridLib.MSFlexGrid grdTags 
      ...
      Appearance      =   0
      MousePointer    =   99
      MouseIcon       =   "DataEntryTagByPartNo.frx":030A
   End
End
...
Sub rsRefresh()
    ...
    rsTAGS.Open "Select * from tags  order by PARTNO, val(tag) asc", gconINVENTORY, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub FillGrid()
    ...
    If Not rsTAGS.EOF And Not rsTAGS.BOF Then
        ...
        Do While Not rsTAGS.EOF
            kcnt = kcnt + 1
            grdTags.AddItem Null2String(rsTAGS!PARTNO) & Chr(9) & _
