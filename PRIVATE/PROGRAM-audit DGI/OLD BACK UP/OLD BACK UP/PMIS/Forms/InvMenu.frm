...
Begin VB.Form frmPMISINVMenu 
   ...
   Begin VB.Frame fraDE 
      ...
      Begin MSForms.Label mDEPhyTicket 
         ...
         Size            =   "2566;2937"
         MousePointer    =   99
         Picture         =   "InvMenu.frx":0000
         MouseIcon       =   "InvMenu.frx":031A
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.Label mDETagNumbers 
         ...
         Size            =   "2566;2990"
         MousePointer    =   99
         Picture         =   "InvMenu.frx":047C
         MouseIcon       =   "InvMenu.frx":0796
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame fraIQ 
      ...
      Begin MSForms.Label mIQTagMaster 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "InvMenu.frx":08F8
         MouseIcon       =   "InvMenu.frx":0C12
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame fraRP 
      ...
      Begin MSForms.Label mRPVarianceRep 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "InvMenu.frx":A8F4
         MouseIcon       =   "InvMenu.frx":AC0E
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame Frame1 
      ...
      Begin wizButton.cmd cmdExit 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   99
         MICON           =   "InvMenu.frx":B9D8
      End
   End
End
Attribute VB_Name = "frmPMISINVMenu"
...
Private Sub cmdReports_Click()
    ...
    fraIQ.Visible = False
    fraPR.Visible = False
    fraRP.Left = cmdReports.Left + 100
    fraRP.Top = cmdReports.Top + 500
    cmdExit.Top = fraPR.Height + 750 + 500 + 500 + 300
End Sub
