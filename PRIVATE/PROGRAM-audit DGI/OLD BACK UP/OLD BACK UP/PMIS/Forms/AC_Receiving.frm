...
Begin VB.Form frmPMISAC_Receiving 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7980
         MouseIcon       =   "AC_Receiving.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdCancelRR 
         ...
         Left            =   7200
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Receiving.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6390
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Receiving.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5640
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Receiving.frx":1B5D
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":1CAF
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "AC_Receiving.frx":1FD4
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":2126
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4080
         MouseIcon       =   "AC_Receiving.frx":2482
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":25D4
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3300
         MouseIcon       =   "AC_Receiving.frx":28E7
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":2A39
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2520
         MouseIcon       =   "AC_Receiving.frx":2D89
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":2EDB
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1740
         MouseIcon       =   "AC_Receiving.frx":3239
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":338B
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   960
         MouseIcon       =   "AC_Receiving.frx":3685
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":37D7
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "AC_Receiving.frx":3B2F
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":3C81
         Style           =   1  'Graphical
         TabIndex        =   80
   ...
   Begin VB.Frame fra_Search 
      ...
      Begin MSComctlLib.ListView lstRR_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_Receiving.frx":3FE0
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "AC_Receiving.frx":4142
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":4294
         Style           =   1  'Graphical
         TabIndex        =   91
         ToolTipText     =   "Cancel "
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "AC_Receiving.frx":45D2
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":4724
         Style           =   1  'Graphical
         TabIndex        =   90
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton Command1 
         Height          =   825
         Left            =   3090
         MouseIcon       =   "AC_Receiving.frx":4AAA
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":4BFC
         Style           =   1  'Graphical
         TabIndex        =   114
      ...
      Begin VB.Frame fraUpdateMaster 
         ...
         Begin VB.CommandButton cmdOKUpdate 
            ...
            Height          =   555
            Left            =   3675
            MouseIcon       =   "AC_Receiving.frx":5465
            MousePointer    =   99  'Custom
            Picture         =   "AC_Receiving.frx":55B7
            Style           =   1  'Graphical
            TabIndex        =   94
            Top             =   1380
            Width           =   555
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   6660
         MouseIcon       =   "AC_Receiving.frx":5852
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":59A4
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   5940
         MouseIcon       =   "AC_Receiving.frx":5CCF
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":5E21
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin wizButton.cmd cmdUpdateMaster 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "AC_Receiving.frx":615F
      End
      Begin VB.CommandButton cmdTranSave 
         Caption         =   "&Save"
         Height          =   795
         Left            =   5220
         MouseIcon       =   "AC_Receiving.frx":617B
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":62CD
         Style           =   1  'Graphical
         TabIndex        =   74
   ...
   End
End
Attribute VB_Name = "frmPMISAC_Receiving"
...
Sub StoreMemvars()
    If Not rsRR_HD.EOF And Not rsRR_HD.BOF Then
        ...
        labAPJ = CheckAPJNum(Null2String(rsRR_HD!RRNO), "AI")
...
Private Sub cmdPost_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Post this Transactions?", "Post Transactions") = True Then
        ...
        If Not rsTdayTran.EOF And Not rsTdayTran.BOF Then
            ...
            Do While Not rsTdayTran.EOF
                Set RSPARTMAS = New ADODB.Recordset
                RSPARTMAS.Open "Select STOCKNO,onhand,trecqty,onorder,served,receipts,ACTIVE from PMIS_Accessories where TYPE = 'A' AND STOCKNO = " & N2Str2Null(rsTdayTran!STOCK_ORD), gconDMIS
...
'                                    " where STOCKNO = " & N2Str2Null(rsPartMas!STOCKNO)
                    ...
                    SQL_STATEMENT = "update pmis_accessories set onhand = " & N2Str2Zero(RSPARTMAS!ONHAND) + NumericVal(rsTdayTran!tranqty) & ", " & _
                                   ...
                                   " last_recd = '" & LOGDATE & "', " & _
                                   " supcode = " & N2Str2Null(txtRecvd_Code.Text) & "," & _
                                   " dnp = '" & (Trim(rsTdayTran!TRANUCOST)) & "'" & _
                                   " where stockno = " & N2Str2Null(RSPARTMAS!STOCKNO)
                    Else
                    SQL_STATEMENT = "update pmis_accessories set onhand = " & N2Str2Zero(RSPARTMAS!ONHAND) + NumericVal(rsTdayTran!tranqty) & ", " & _
                                   " trecqty = " & N2Str2Zero(RSPARTMAS!trecqty) + NumericVal(rsTdayTran!tranqty) & ", " & _
...
Private Sub cmdTranSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        rsTDaytranClone.Open "select trantype,tranno,itemno,STOCK_ORD from PMIS_TdayTran where [TYPE] = 'A' AND STOCK_ORD = '" & cboTranPartNo.Text & "' and trantype = 'RR' and tranno =" & N2Str2Null(rsRR_HD!RRNO) & " order by itemno asc", gconDMIS
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "AA", "ACCESSORIES RECEIVING", SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, "RR", ""
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "EE", "ACCESSORIES RECEIVING", SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, "RR", labDetID
    ...
    gconDMIS.Execute ("Update pmis_stockmas set srp = '" & Trim(txtNewSRP.Text) & "', stockdesc = '" & cboTranDescription & "' where stockno = '" & cboTranPartNo & "' and [type] = 'A'")
...
Private Sub cmdUnPost_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Unpost this Transactions?", "Unpost Transactions") = True Then
        ...
        Set rsTdayTran = New ADODB.Recordset
        rsTdayTran.Open "select id,itemno,trantype,tranno,STOCK_ORD,tranqty,traninvamt,status from PMIS_TdayTran where [TYPE] = 'A' AND trantype = 'RR' and tranno = " & N2Str2Null(rsRR_HD!RRNO) & " order by itemno asc", gconDMIS
        If Not rsTdayTran.EOF And Not rsTdayTran.BOF Then
            rsTdayTran.MoveFirst
...
Private Sub cmdSave_Click()
    ...
    If Trim(txtRRNo.Text) = "" Then
        MsgSpeechBox "ARR Number must not be empty"
        On Error Resume Next
        txtRRNo.SetFocus
        Exit Sub
    Else
    ...
    Else
        ...
        If Trim(cboTranPartNo.Text) <> "" Then
            gconDMIS.Execute "insert into PMIS_Accessories " & _
                           ...
                           " values ('A'," & N2Str2Null(cboTranPartNo.Text) & "," & N2Str2Null(Mid(cboTranDescription.Text, 1, 50)) & "," & NewPmasMAC & "," & NewPmasDNP & "," & NewPmasSRP & ",'" & LOGDATE & "','Y')"
        End If
        chkHARI_PARTS.Value = 0
        Screen.MousePointer = 0
    End If
