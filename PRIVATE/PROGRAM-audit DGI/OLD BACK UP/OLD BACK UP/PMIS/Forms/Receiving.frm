...
Begin VB.Form frmPMISTrans_Receiving2 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   7410
         MouseIcon       =   "Receiving.frx":0CB7
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":0E09
         Style           =   1  'Graphical
         TabIndex        =   113
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   825
         Left            =   3060
         MouseIcon       =   "Receiving.frx":1134
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":1286
         Style           =   1  'Graphical
         TabIndex        =   110
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   6690
         MouseIcon       =   "Receiving.frx":1B0B
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":1C5D
         Style           =   1  'Graphical
         TabIndex        =   114
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   5970
         MouseIcon       =   "Receiving.frx":1F9B
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":20ED
         Style           =   1  'Graphical
         TabIndex        =   115
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   9000
         MouseIcon       =   "Receiving.frx":243D
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":258F
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8220
         MouseIcon       =   "Receiving.frx":28F5
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":2A47
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdCancelRR 
         ...
         Left            =   7440
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Receiving.frx":2DAD
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":2EFF
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5880
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Receiving.frx":36D0
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":3822
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5100
         MouseIcon       =   "Receiving.frx":3B47
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":3C99
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4320
         MouseIcon       =   "Receiving.frx":3FF5
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":4147
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "Receiving.frx":445A
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":45AC
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2760
         MouseIcon       =   "Receiving.frx":48FC
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":4A4E
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1980
         MouseIcon       =   "Receiving.frx":4DAC
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":4EFE
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1200
         MouseIcon       =   "Receiving.frx":51F8
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":534A
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   420
         MouseIcon       =   "Receiving.frx":56A2
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":57F4
         Style           =   1  'Graphical
         TabIndex        =   77
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "Receiving.frx":5CB5
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":5E07
         Style           =   1  'Graphical
         TabIndex        =   88
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "Receiving.frx":6145
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":6297
         Style           =   1  'Graphical
         TabIndex        =   87
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboClasscode 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "Receiving.frx":6601
         Left            =   5550
         List            =   "Receiving.frx":6603
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   420
         Width           =   3015
...
Function SetSupCode(nnn As String)
    Set rsSupplier = New ADODB.Recordset
    rsSupplier.Open "Select supname,supcode,sup_addrs,vat_percnt,NONVAT,Terms from PMIS_vw_Supplier where supname = '" & Replace(nnn, "'", "") & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsSupplier.EOF And Not rsSupplier.BOF Then
...
Private Sub cmdCancelRR_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Cancel this Transactions?", "Cancel Transactions") = True Then
        ...
        SQL_STATEMENT = "update PMIS_TdayTran set" & _
                       ...
                       " usercode = " & N2Str2Null(LOGCODE) & "," & _
                       " lastupdate = '" & LOGDATE & "'" & _
                       " where tranno = " & N2Str2Null(RSRR_HD!RRNO) & " and trantype = 'RR'"
        gconDMIS.Execute SQL_STATEMENT
 ...
 If Function_Access(LOGID, "Acess_Post", "PURCHASE RECEIVING STORING") = False Then Exit Sub
    ...
    If MsgQuestionBox("Are you sure you want to Post this Transactions?", "Post Transactions") = True Then
        ...
        'DESCRIPTION : TO NOT ALLOW POSTING OF RECEIVING WHEN AN ITEM IS NOT YET VERIFY
            ...
            Set RSTMP = gconDMIS.Execute("SELECT TREMARKS FROM PMIS_TDAYTRAN WHERE TREMARKS IS NULL " & _
                " AND TYPE = 'P' AND TRANTYPE = 'RR' AND TRANNO = " & N2Str2Null(RSRR_HD!RRNO) & "")
        ...
        Set RSTDAYTRAN = New ADODB.Recordset
        RSTDAYTRAN.Open "select id,itemno,trantype,tranno,STOCK_ORD,tranqty,traninvamt,mac,tranucost from PMIS_TdayTran where [TYPE] = 'P' AND trantype = 'RR' and tranno = " & N2Str2Null(RSRR_HD!RRNO) & " order by itemno asc", gconDMIS
        If Not RSTDAYTRAN.EOF And Not RSTDAYTRAN.BOF Then
            ...
            Do While Not RSTDAYTRAN.EOF
                Set RSPARTMAS = New ADODB.Recordset
                RSPARTMAS.Open "Select STOCKNO,onhand,trecqty,onorder,served,receipts,ACTIVE from PMIS_PARTMAS where TYPE = " & MODULE_STOCK_TYPE & " AND STOCKNO = " & N2Str2Null(RSTDAYTRAN!STOCK_ORD), gconDMIS
...
Private Sub cmdTranSave_Click()
    ...
    If ADDOREDIT = "ADD" Then
        ...
        rsTDaytranClone.Open "select trantype,tranno,itemno,STOCK_ORD from PMIS_TdayTran where [TYPE] = 'P' AND STOCK_ORD = '" & cboTranPartNo.Text & "' and trantype = 'RR' and tranno =" & N2Str2Null(RSRR_HD!RRNO) & " order by itemno asc", gconDMIS
    ...
    If NumericVal(txtNewSRP) <> PrevPmasSRP Then
        If MsgBox("You changed the SRP of this Part Number. Proceed saving?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
            'proceed saving
        Else
            Exit Sub
        End If
    ...
    If optGJ.Value = True Then
        SQL_STATEMENT = "Update PMIS_PARTMAS set STOCKTYPE = 'GJ' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    Else
        SQL_STATEMENT = "Update PMIS_PARTMAS set STOCKTYPE = 'BP' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    End If
    Call NEW_LogAudit("E", "PART MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(cboTranPartNo), "STOCKNO", "PMIS_PARTMAS"), "", "RR NO: " & txtRRNo & " STOCKTYPE", "", "")
        
    If optLocalPurchase.Value = True Then
        SQL_STATEMENT = "Update PMIS_PARTMAS set PARTSORIGIN = 'L' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    ElseIf optConsigned.Value = True Then
        SQL_STATEMENT = "Update PMIS_PARTMAS set PARTSORIGIN = 'C' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    Else
        SQL_STATEMENT = "Update PMIS_PARTMAS set PARTSORIGIN = 'M' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    End If
    Call NEW_LogAudit("E", "PART MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(cboTranPartNo), "STOCKNO", "PMIS_PARTMAS"), "", "RR NO: " & txtRRNo & " PARTS ORIGIN", "", "")
    
    If cboClass.Text = "HARI" Then
        SQL_STATEMENT = "Update PMIS_PARTMAS set NON_HARI = 'N' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    ElseIf cboClass.Text = "Non-HARI" Then
        SQL_STATEMENT = "Update PMIS_PARTMAS set NON_HARI = 'Y' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    Else
        SQL_STATEMENT = "Update PMIS_PARTMAS set NON_HARI = 'O' where stockno = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    End If
    Call NEW_LogAudit("E", "PART MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(cboTranPartNo), "STOCKNO", "PMIS_PARTMAS"), "", "RR NO: " & txtRRNo & " CLASS", "RR", "")
    
    If cboClass.Text = "HARI" Then
        SQL_STATEMENT = "Update PMIS_Tdaytran set NON_HARI = 'N' where stock_ord = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    ElseIf cboClass.Text = "Non-HARI" Then
        SQL_STATEMENT = "Update PMIS_Tdaytran set NON_HARI = 'Y' where stock_ord = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    Else
        SQL_STATEMENT = "Update PMIS_Tdaytran set NON_HARI = 'O' where stock_ord = '" & cboTranPartNo.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
    End If
    ...
    gconDMIS.Execute ("Update pmis_stockmas set srp = " & NumericVal(txtNewSRP.Text) & ", stockdesc = '" & cboTranDescription & "' where stockno = '" & cboTranPartNo & "' and [type] = 'P'")

    'cmdOkUpdate_Click
    rsRefresh
    InitPartsClassification
    On Error Resume Next
    RSRR_HD.Find "id = " & labID.Caption
    cmdTranCancel.Value = True
...
Private Sub cmdUnPost_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Unpost this Transactions?", "Unpost Transactions") = True Then
        Set RSTDAYTRAN = New ADODB.Recordset
        RSTDAYTRAN.Open "select id,itemno,trantype,tranno,STOCK_ORD,tranqty,traninvamt,status from PMIS_TdayTran where [TYPE] = 'P' AND trantype = 'RR' and tranno = " & N2Str2Null(RSRR_HD!RRNO) & " order by itemno asc", gconDMIS
        If Not RSTDAYTRAN.EOF And Not RSTDAYTRAN.BOF Then
            RSTDAYTRAN.MoveFirst
            '=================================
            ...
            Do While Not RSTDAYTRAN.EOF
                Set RSPARTMAS = New ADODB.Recordset
                RSPARTMAS.Open "Select STOCKNO,onhand,trecqty,onorder,served,receipts from PMIS_PARTMAS where STOCKNO = " & N2Str2Null(RSTDAYTRAN!STOCK_ORD), gconDMIS
                If Not RSPARTMAS.EOF And Not RSPARTMAS.EOF Then
...
'                        End If
    ...
    End If
    'Get the previous mac
    'ADDED Procedure by: NVB
    'Desc: To Get the previous mac when unposting transaction
    'Date: 5/19/2009
...
Private Sub cmdSave_Click()
    ...
    If ADDOREDIT = "ADD" Then
        ...
        Set rsTdaytranDup = New ADODB.Recordset
            rsTdaytranDup.Open "select trantype,tranno from PMIS_TdayTran where [TYPE] = 'P' AND trantype = 'RR' and tranno = " & N2Str2Null(RSRR_HD!RRNO), gconDMIS
        If rsTdaytranDup.EOF And rsTdaytranDup.BOF Then
            ...
            Else
                rstdaytranDUp2.Open "SELECT ID,ITEMNO,STOCK_ORD,STOCK_SUP,TRANQTY AS TRANQTY,TRANINVAMT,TRANUCOST FROM PMIS_TDAYTRAN WHERE TRANTYPE='PO' AND TRANNO=" & N2Str2Null(txtPONo.Text) & " order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
            End If
...
Private Sub Command1_Click()
    ...
    Set rsPartMasClone = New ADODB.Recordset
    rsPartMasClone.Open "select STOCKNO,tpoqty,onorder,mac,dnp,srp,onhand,NON_HARI,PARTSORIGIN from PMIS_PARTMAS where STOCKNO = " & N2Str2Null(cboTranPartNo.Text), gconDMIS
    If Not rsPartMasClone.EOF And Not rsPartMasClone.BOF Then
    ...
    Else
        ...
        On Error GoTo Errorcode:
            gconDMIS.Execute "insert into PMIS_PARTMAS " & _
                             "(TYPE,STOCKNO,MAC,DNP,SRP,STOCKDESC,date_entered,ACTIVE)" & _
                           " values ('P'," & N2Str2Null(cboTranPartNo.Text) & "," & NewPmasMAC & "," & NewPmasDNP & "," & NewPmasSRP & ", " & N2Str2Null(Mid(cboTranDescription.Text, 1, 50)) & ",'" & LOGDATE & "','Y')"
        End If
        chkHARI_PARTS.Value = 0
        Screen.MousePointer = 0
    End If
...
Private Sub txtPONo_LostFocus()
    ...
    If cboClasscode.Text = "PURCHASED CASH" Or cboClasscode = "PURCHASED CHARGE" Then
        If txtPONo.Text <> "" And ADDOREDIT = "ADD" And Len(txtPONo.Text) > 0 Then
            Dim rsRR_HDDup                                            As ADODB.Recordset
            Set rsRR_HDDup = New ADODB.Recordset
            rsRR_HDDup.Open "select pono from PMIS_RR_HD where [TYPE] = 'P' AND pono = '" & Repleys(txtPONo.Text) & "' AND status ='P'", gconDMIS
            If Not rsRR_HDDup.EOF And Not rsRR_HDDup.BOF Then
