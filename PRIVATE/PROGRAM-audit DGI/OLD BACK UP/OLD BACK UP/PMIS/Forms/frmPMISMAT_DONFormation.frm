...
Begin VB.Form frmPMISMAT_DONFormation 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Materials Order Number Formation"
   ClientHeight    =   4545
   ClientLeft      =   1620
   ClientTop       =   5880
   ClientWidth     =   4440
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   675
      Left            =   3660
      MouseIcon       =   "frmPMISMAT_DONFormation.frx":0000
   ...
   Begin VB.CommandButton cmdOk 
      ...
      Height          =   675
      Left            =   3000
      MouseIcon       =   "frmPMISMAT_DONFormation.frx":0152
      MousePointer    =   99  'Custom
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_DONFormation"
...
Sub GetSeries()
    With frmPMISMAT_Purchase
        If txtedit = "EDIT" Then
            lbl5.Text = Mid(.txtDON, 8, 2)
        Else
            Dim rsPO_HD                                               As ADODB.Recordset
            Set rsPO_HD = New ADODB.Recordset
            rsPO_HD.Open "Select ORDER_SERIES from PMIS_PO_HD where [TYPE] = 'M' AND ORDERTYPE = '" & lbl2.Caption & "' order by Order_series desc ", gconDMIS
...
Private Sub cmdOk_Click()
    ...
    Dim rsPO_HD                                                       As ADODB.Recordset
    Set rsPO_HD = New ADODB.Recordset
    rsPO_HD.Open "select DON,PONO from PMIS_PO_HD where [TYPE] = 'M' AND DON = '" & DON & "' and status='P'", gconDMIS
    If Not rsPO_HD.EOF And Not rsPO_HD.BOF Then
