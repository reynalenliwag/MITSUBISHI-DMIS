...
Begin VB.Form frmPMISInquiry_CustomerOrderHist 
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Picture         =   "CustomerOrderHist.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   1530
         Width           =   855
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CustomerOrderHist.frx":0D82
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   6360
         MouseIcon       =   "CustomerOrderHist.frx":1854
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrderHist.frx":19A6
         Style           =   1  'Graphical
         TabIndex        =   50
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   5580
         MouseIcon       =   "CustomerOrderHist.frx":1CF6
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrderHist.frx":1E48
         Style           =   1  'Graphical
         TabIndex        =   51
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   4800
         MouseIcon       =   "CustomerOrderHist.frx":21A6
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrderHist.frx":22F8
         Style           =   1  'Graphical
         TabIndex        =   52
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   4020
         MouseIcon       =   "CustomerOrderHist.frx":25F2
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrderHist.frx":2744
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   3240
         MouseIcon       =   "CustomerOrderHist.frx":2A9C
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrderHist.frx":2BEE
         Style           =   1  'Graphical
         TabIndex        =   48
...
Sub FillSearchCusTomer(XXX As String)
    ...
    Set rsOrd_Hd = gconDMIS.Execute("select custname, tranno from PMIS_Ord_Hist where [TYPE] = 'P' AND trantype = '" & COUNTERTYPE & "' and CUSTNAME  like '" & XXX & "%' order by CUSTNAME")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True: Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd: lstOrd_Hd.Refresh
    Else
        lstOrd_Hd.Enabled = False
...
Sub FillGrid2()
    ...
    lstOrd_Hd.Sorted = False: lstOrd_Hd.ListItems.Clear
    Set RSORD_HIST = New ADODB.Recordset
    Set RSORD_HIST = gconDMIS.Execute("select rono,ID from PMIS_Ord_Hist where type = 'P' and trantype = '" & COUNTERTYPE & "' and rono is not null order by id desc")
    If Not (RSORD_HIST.EOF And RSORD_HIST.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HIST
        lstOrd_Hd.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set RSORD_HIST = gconDMIS.Execute("select Rono, ID from PMIS_Ord_Hist where type = 'P' and trantype = '" & COUNTERTYPE & "' and rono like '" & XXX & "%' order by Rono desc")
    If Not (RSORD_HIST.EOF And RSORD_HIST.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HIST
        lstOrd_Hd.Refresh
