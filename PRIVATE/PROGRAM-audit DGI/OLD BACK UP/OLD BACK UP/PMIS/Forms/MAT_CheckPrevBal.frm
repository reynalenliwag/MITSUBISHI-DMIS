...
Begin VB.Form frmPMISMAT_CheckPrevBal 
   BackColor       =   &H00FF8080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Check Previous Balance [Requested, Receipts, Issuance]"
   ClientHeight    =   7335
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9990
   ...
   FillColor       =   &H8000000D&
   ForeColor       =   &H00FF8080&
   Icon            =   "MAT_CheckPrevBal.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   9090
      MouseIcon       =   "MAT_CheckPrevBal.frx":01CA
      MousePointer    =   99  'Custom
      Picture         =   "MAT_CheckPrevBal.frx":031C
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   795
      Left            =   8370
      MouseIcon       =   "MAT_CheckPrevBal.frx":0682
      MousePointer    =   99  'Custom
      Picture         =   "MAT_CheckPrevBal.frx":07D4
      Style           =   1  'Graphical
      TabIndex        =   63
   ...
   Begin VB.CommandButton cmdCheck 
      ...
      Height          =   795
      Left            =   7680
      MouseIcon       =   "MAT_CheckPrevBal.frx":0C73
      MousePointer    =   99  'Custom
      Picture         =   "MAT_CheckPrevBal.frx":0DC5
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Process Checking of Materials Previous Balance"
      Top             =   6450
      Width           =   705
   End
   Begin VB.Frame Frame3 
      ...
      Begin VB.Label Label5 
         BackColor       =   &H8000000D&
         BackStyle       =   0  'Transparent
         Caption         =   "MTD Materials Receipts"
         BeginProperty Font 
            Name            =   "Courier New"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label6 
         BackColor       =   &H8000000D&
         BackStyle       =   0  'Transparent
         Caption         =   "MTD Materials Issuance"
         BeginProperty Font 
            Name            =   "Courier New"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label7 
         BackColor       =   &H8000000D&
         BackStyle       =   0  'Transparent
         Caption         =   "YTD Total Materials Issuance"
         BeginProperty Font 
            Name            =   "Courier New"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label8 
         BackColor       =   &H8000000D&
         BackStyle       =   0  'Transparent
         Caption         =   "YTD Total Materials Receipts"
         BeginProperty Font 
            Name            =   "Courier New"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.PictureBox picCPB 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin wizButton.cmd cmd1 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "MAT_CheckPrevBal.frx":1060
         End
      End
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   17171
         _ExtentY        =   556
         Picture         =   "MAT_CheckPrevBal.frx":107C
         ForeColor       =   255
         Appearance      =   2
         BorderStyle     =   2
         BarPicture      =   "MAT_CheckPrevBal.frx":1098
         ShowText        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_CheckPrevBal"
...
Private Sub cmdCheck_Click()
    If Function_Access(LOGID, "Acess_Process", "MATERIALS CHECK PREVIOUS BALANCE") = False Then Exit Sub
    CheckBalance
...
Private Sub cmdPrint_Click()
    ...
    PrintSQLReport rptPrintStkStat, PMIS_REPORT_PATH & "stock2.rpt", "{STKSTAT.TYPE} = 'M'", DMIS_REPORT_Connection, 1
