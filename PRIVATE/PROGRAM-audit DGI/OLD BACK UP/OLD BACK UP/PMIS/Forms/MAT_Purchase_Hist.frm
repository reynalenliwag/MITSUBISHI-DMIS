...
Begin VB.Form frmPMISMAT_Purchase_Hist 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         Picture         =   "MAT_Purchase_Hist.frx":046C
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "MAT_Purchase_Hist.frx":0797
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":08E9
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "MAT_Purchase_Hist.frx":0C4F
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":0DA1
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1107
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1441
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPost 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1786
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Left            =   4740
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1AAB
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Left            =   3960
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1E07
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "MAT_Purchase_Hist.frx":211A
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":226C
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "MAT_Purchase_Hist.frx":25BC
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":270E
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "MAT_Purchase_Hist.frx":2A6C
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":2BBE
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Purchase_Hist.frx":2EB8
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":300A
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_Purchase_Hist.frx":3362
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":34B4
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Left            =   720
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":3813
         Style           =   1  'Graphical
         TabIndex        =   80
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   -60
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":3B51
         Style           =   1  'Graphical
         TabIndex        =   81
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtRemarks 
         ...
         TabIndex        =   12
         Text            =   "MAT_Purchase_Hist.frx":3EA1
