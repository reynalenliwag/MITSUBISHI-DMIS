...
Begin VB.Form frmPMISAC_CreateConsPhyCNT 
   ...
   FillColor       =   &H8000000D&
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AC_ConsolidatePHYCNT.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   4770
      MouseIcon       =   "AC_ConsolidatePHYCNT.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "AC_ConsolidatePHYCNT.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmdCreate 
      ...
      Height          =   795
      Left            =   3810
      MouseIcon       =   "AC_ConsolidatePHYCNT.frx":07C2
      MousePointer    =   99  'Custom
      Picture         =   "AC_ConsolidatePHYCNT.frx":0ACC
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   Begin VB.PictureBox picCPB 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin wizButton.cmd cmd1 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "AC_ConsolidatePHYCNT.frx":0DEC
         End
      End
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   9922
         _ExtentY        =   556
         Picture         =   "AC_ConsolidatePHYCNT.frx":0E08
         ForeColor       =   255
         Appearance      =   2
         BorderStyle     =   2
         BarPicture      =   "AC_ConsolidatePHYCNT.frx":0E24
         ShowText        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmPMISAC_CreateConsPhyCNT"
...
Private Sub cmdCreate_Click()
    ...
    LogAudit "R", "CONSOLIDATE PHYSICAL COUNT"
