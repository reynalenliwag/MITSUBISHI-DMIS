...
Begin VB.Form frmPMISAcc_CustomerOrderHist 
   ...
   ClientWidth     =   11430
   ForeColor       =   &H00DEDFDE&
   Icon            =   "frmPMISAcc_CustomerOrderHist.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7920
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7140
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6360
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   86
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5580
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4800
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":1B3D
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":1C8F
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4020
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":1FEB
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":213D
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3240
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":2450
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":25A2
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2460
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":28F2
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":2A44
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1680
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":2DA2
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":2EF4
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   900
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":31EE
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":3340
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   120
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":3698
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":37EA
         Style           =   1  'Graphical
         TabIndex        =   85
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   1260
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":3B49
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":3C9B
         Style           =   1  'Graphical
         TabIndex        =   74
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   540
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":3FD9
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":412B
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2130
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":447B
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":45CD
         Style           =   1  'Graphical
         TabIndex        =   91
         Top             =   2550
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1425
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":490B
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":4A5D
         Style           =   1  'Graphical
         TabIndex        =   90
         Top             =   2550
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2850
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":4DAD
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":4EFF
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   2550
         Width           =   705
   ...
   Begin wizButton.cmd cmdAddTran 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmPMISAcc_CustomerOrderHist.frx":522A
   End
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1200
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":5246
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_CustomerOrderHist.frx":5398
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   1530
         Width           =   855
   ...
   Begin wizButton.cmd cmdSignatories 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmPMISAcc_CustomerOrderHist.frx":56FE
   End
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmPMISAcc_CustomerOrderHist.frx":571A
         NumItems        =   2
   ...
   End
End
Attribute VB_Name = "frmPMISAcc_CustomerOrderHist"
...
Private Sub cmdPrint_Click()
    ...
    If rsORD_HIST!TRANTYPE = "CHG" Then
        ...
        End If
    End If
    LogAudit "V", "ACCESSORIES CUSTOMER ORDER HISTORY", txtTranNo & txtCustCode
End Sub
Sub CHGPRINTING()
...
Function SetPartIDSTOCKNO(DDD As String)
    Set rsPartMas = New ADODB.Recordset
    rsPartMas.Open "Select id,STOCKNO from PMIS_STOCKMAS where type = 'A' and STOCKNO = '" & DDD & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsPartMas.EOF And Not rsPartMas.BOF Then
