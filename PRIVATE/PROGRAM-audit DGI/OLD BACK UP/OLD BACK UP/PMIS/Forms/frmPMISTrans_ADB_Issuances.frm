...
Begin VB.Form frmPMISTrans_ADB_Issuances 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7980
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7200
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":0EE4
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":1036
         Style           =   1  'Graphical
         TabIndex        =   91
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6420
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":139C
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":14EE
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5640
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":1828
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":197A
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":1C9F
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":1DF1
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4080
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":214D
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":229F
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3300
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":25B2
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":2704
         Style           =   1  'Graphical
         TabIndex        =   89
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2520
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":2A54
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":2BA6
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1740
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":2F04
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":3056
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   960
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":3350
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":34A2
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":37FA
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":394C
         Style           =   1  'Graphical
         TabIndex        =   96
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   990
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":3CAB
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":3DFD
         Style           =   1  'Graphical
         TabIndex        =   85
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   210
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":413B
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":428D
         Style           =   1  'Graphical
         TabIndex        =   86
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":45DD
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":472F
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":4A5A
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":4BAC
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.ComboBox cboTranPartNo 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmPMISTrans_ADB_Issuances.frx":4EEA
         Left            =   1440
         List            =   "frmPMISTrans_ADB_Issuances.frx":4EEC
         Sorted          =   -1  'True
         TabIndex        =   17
         Text            =   "Combo1"
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":4EEE
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":5040
         Style           =   1  'Graphical
         TabIndex        =   81
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":5390
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   59
         Top             =   -540
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3000
         MouseIcon       =   "frmPMISTrans_ADB_Issuances.frx":80CC
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances.frx":821E
         Style           =   1  'Graphical
         TabIndex        =   83
         Top             =   1560
         Width           =   855
...
Private Sub cboRefPRSNo_LostFocus()
    If ADDOREDIT = "ADD" Then
        ...
        If Not rsRR_HDDup.EOF And Not rsRR_HDDup.BOF Then
            MsgBox "MRS Number Already Received", vbInformation, "Invalid PRS Number"
            Exit Sub
        Else
            Set rsRR_HDDup = New ADODB.Recordset
            rsRR_HDDup.Open "select tranno,DS1,custname,custcode,rono from PMIS_vw_PRS where [TYPE] = 'P' AND refpisno = '" & cboRefPRSNo.Text & "'", gconDMIS
            If (rsRR_HDDup.EOF Or rsRR_HDDup.BOF) Then
                MsgSpeechBox "Invalid Requisition Number!"
            End If
        End If
    End If
End Sub
...
Sub ShowStock_Issused(VTXTRONO As String)
    ...
    If otp_RIVADB.Value = True Then
        Set RSADB = gconDMIS.Execute("SELECT STOCK_ORD ,AVG(PMIS_STOCKMAS.ONHAND) ONHAND , sum(TRANQTY) as TRANQTY FROM PMIS_ALLDAYTRAN INNER JOIN PMIS_STOCKMAS " & _
                                   ...
                                   " WHERE  PMIS_STOCKMAS.TYPE='P' AND " & _
                                   " (TRANNO  IN (SELECT TRANNO FROM PMIS_ORD_HD WHERE TRANTYPE='ADB' AND TYPE='P' AND RONO='" & VTXTRONO & "'   AND STATUS='P') " & _
                                   " OR TRANNO IN (SELECT TRANNO FROM PMIS_ORD_HIST WHERE TRANTYPE='ADB' AND TYPE='P' AND RONO='" & VTXTRONO & "'   AND STATUS='P')) " & _
    ...
    Else
        Set RSADB = gconDMIS.Execute("SELECT PMIS_ALLDAYTRAN.TRANNO, PMIS_ALLDAYTRAN.TRANDATE, STOCK_ORD ,PMIS_STOCKMAS.STOCKDESC ,PMIS_STOCKMAS.ONHAND , TRANQTY FROM PMIS_ALLDAYTRAN INNER JOIN PMIS_STOCKMAS " & _
                                   " ON PMIS_STOCKMAS.TYPE=PMIS_ALLDAYTRAN.TYPE AND PMIS_ALLDAYTRAN.STOCK_ORD=PMIS_STOCKMAS.STOCKNO WHERE PMIS_STOCKMAS.TYPE='P' AND " & _
                                   " (TRANNO  IN (SELECT TRANNO FROM PMIS_ORD_HD WHERE TRANTYPE='ADB' AND TYPE='P' AND RONO='" & VTXTRONO & "'   AND STATUS='P') " & _
                                   " OR TRANNO IN (SELECT TRANNO FROM PMIS_ORD_HIST WHERE TRANTYPE='ADB' AND TYPE='P' AND RONO='" & VTXTRONO & "'   AND STATUS='P')) " & _
...
Private Sub Text1_Change()
    ...
    SQLX = "SELECT TRANDATE,TRANNO ,RONO ,'CURRT' AS DSTATUS FROM PMIS_ORD_HD WHERE TRANTYPE='ADB' AND TYPE='P' AND ISNULL(STATUS3,'')  <>'F' AND ISNULL(STATUS2,'')  <>'R' AND STATUS='P' " & searchstring & vbCrLf
    SQLX = SQLX & " UNION " & vbCrLf
    SQLX = SQLX & "SELECT TRANDATE,TRANNO ,RONO ,'HIST' AS DSTATUS FROM PMIS_ORD_HIST WHERE TRANTYPE='ADB' AND TYPE='P' AND ISNULL(STATUS3,'')  <>'F' AND  ISNULL(STATUS2,'')  <>'R' AND STATUS='P' " & searchstring & " ORDER BY RONO"
...
Private Sub cmdPost_Click()
    ...
    Dim PCURONHAND As Long, PCurTISSQTY As Long, PCURISSUANCES As Long
    Dim rsTdaytranDup As ADODB.Recordset, rsPartmasDup As ADODB.Recordset
    ...
    STR_SQLX = STR_SQLX & " PMIS_ORD_HD.STATUS='P' AND PMIS_ORD_HD.TYPE='P' "
    ...
    STR_SQLX = STR_SQLX & " PMIS_ORD_HIST.STATUS='P' AND PMIS_ORD_HIST.TYPE='P' "
    STR_SQLX = STR_SQLX & " GROUP BY STOCK_ORD"
...
Function GetTotal_ADB_Filled(xro_no As String, x_stockno As String) As Long
    ...
    STR_SQLX = STR_SQLX & " PMIS_ORD_HD.STATUS='P' AND PMIS_ORD_HD.TYPE='P' AND PMIS_ORD_HD.STATUS2='R' "
    STR_SQLX = STR_SQLX & " GROUP BY STOCK_ORD"
    STR_SQLX = STR_SQLX & " Union "
    ...
    STR_SQLX = STR_SQLX & " PMIS_ORD_HIST.STATUS='P' AND PMIS_ORD_HIST.TYPE='P' AND PMIS_ORD_HIST.STATUS2='R'"
    STR_SQLX = STR_SQLX & " GROUP BY STOCK_ORD"
...
Private Sub cmdSave_Click()
    ...
    Else
        If ADDOREDIT = "ADD" Then
            ...
            If txtTranType = "ADB" Then
                RSFINDDUP.Open "SELECT TRANNO  FROM PMIS_ORD_HD WHERE [TYPE] = 'P'  AND TRANTYPE='ADB' and tranno = '" & txtTranNo.Text & "'", gconDMIS, adOpenKeyset
            Else
                RSFINDDUP.Open "select trantype,tranno from PMIS_vw_ISS_HISTORY where [TYPE] = 'P' AND trantype = '" & txtTranType.Text & "' and tranno = '" & txtTranNo.Text & "' order by trantype,tranno", gconDMIS, adOpenForwardOnly, adLockReadOnly
            End If
    ...
    If ADDOREDIT = "ADD" Then
        SQL_STATEMENT = "Insert into PMIS_Ord_Hd" & _
                      ...
                      " values ('R','P'," & VTXTTRANTYPE & ", " & VTXTTRANNO & ", " & VTXTTRANDATE & ", " & _
...
Sub X_FillSearchGrid(XXX As String)
    ...
    If optTranno.Value = True Then
        Set rsOrd_Hd = gconDMIS.Execute("select tranno, ID from PMIS_Ord_Hd where [TYPE] = 'P' AND trantype = '" & COUNTERTYPE & "' and tranno like '" & XXX & "%' AND STATUS2='R'")
    ElseIf optRONo.Value = True Then
        Set rsOrd_Hd = gconDMIS.Execute("select Rono, id from PMIS_Ord_Hd where [TYPE] = 'P' AND trantype = '" & COUNTERTYPE & "' and rono like '" & XXX & "%' AND STATUS2='R'  order by tranno asc")
    Else
        Set rsOrd_Hd = gconDMIS.Execute("select custname, id  from PMIS_Ord_Hd where [TYPE] = 'P' AND trantype = '" & COUNTERTYPE & "' and CUSTNAME  like '" & XXX & "%' AND STATUS2='R'  order by CUSTNAME")
    End If
...
Sub InitCbo()
    ...
    RSPARTMAS.Open "SELECT DISTINCT STOCK_ORD FROM PMIS_ALLDAYTRAN INNER JOIN PMIS_STOCKMAS " & _
                 " ON PMIS_STOCKMAS.TYPE=PMIS_ALLDAYTRAN.TYPE AND PMIS_ALLDAYTRAN.STOCK_ORD=PMIS_STOCKMAS.STOCKNO WHERE PMIS_STOCKMAS.TYPE='P' AND " & _
                 " (TRANNO  IN (SELECT TRANNO FROM PMIS_ORD_HD WHERE TRANTYPE='ADB' AND TYPE='P' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  <>'R' AND STATUS='P') " & _
                 " OR TRANNO IN (SELECT TRANNO FROM PMIS_ORD_HIST WHERE TRANTYPE='ADB' AND TYPE='P' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  <>'R' AND STATUS='P'))   " & _
...
Sub InsertAdvanceBill()
    ...
    If txtTranType.Text = "RIV" Then
        ...
        Dim RS_ADB_ISSUE                               As ADODB.Recordset
        Dim RS_ONHAND                                  As ADODB.Recordset
        Set RS_ADB_ISSUE = gconDMIS.Execute("SELECT STOCK_ORD,SUM(TRANQTY ) AS TQTY FROM PMIS_TDAYTRAN WHERE TRANNO  IN(SELECT TRANNO FROM PMIS_ORD_HD WHERE TRANTYPE='ADB' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  <>'R' AND STATUS='P')  AND TRANTYPE='ADB'GROUP BY STOCK_ORD")

        While Not RS_ADB_ISSUE.EOF
            '1 CHECK ON HAND QUANTITY FIRST
            '2 CHECK IF ITS ALREADY OVER OR EUQAL ISSUED
            '3. IF NOT THEN ADD QUANTITY IN TDAYTRAN
            Set RS_ONHAND = gconDMIS.Execute("SELECT ONHAND FROM PMIS_STOCKMAS WHERE TYPE='P' AND STOCKNO=" & N2Str2Null(RS_ADB_ISSUE!STOCK_ORD))
            If Not RS_ONHAND.EOF Or Not RS_ONHAND.BOF Then

                If N2Str2IntZero(RS_ONHAND!ONHAND) <= 0 Then
                    MsgBox "Part Number " & Null2String(RS_ADB_ISSUE!STOCK_ORD) & " is Out of Stock."
                ElseIf N2Str2IntZero(RS_ONHAND!ONHAND) > N2Str2IntZero(RS_ADB_ISSUE!TQTY) Then
                    MsgBox "Part Number " & Null2String(RS_ADB_ISSUE!STOCK_ORD) & " is Exceeds the Current Onhand."
                End If
...
Sub rsRefresh()
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'P' AND trantype = 'RIV' AND STATUS2='R' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Sub SetPartDetails(XXX As String)
    ...
    If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
        ...
        STR_SQLX = STR_SQLX & "(SELECT TRANNO FROM PMIS_ORD_HD WHERE TYPE='P' AND  TRANTYPE='ADB' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  <>'R' AND STATUS='P')"
        ...
        STR_SQLX = STR_SQLX & "(SELECT TRANNO FROM PMIS_ORD_HIST WHERE TYPE='P' AND TRANTYPE='ADB' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  <>'R' AND STATUS='P')"
        STR_SQLX = STR_SQLX & "AND TRANTYPE='ADB'"
        STR_SQLX = STR_SQLX & "AND STOCK_ORD='" & XXX & "'"
        STR_SQLX = STR_SQLX & "GROUP BY STOCK_ORD"
        ...
        STR_SQLX = "SELECT 'CURRENT', SUM(TRANQTY) AS TQTY FROM PMIS_TDAYTRAN WHERE TRANNO  IN"
        STR_SQLX = STR_SQLX & "(SELECT TRANNO FROM PMIS_ORD_HD WHERE TYPE='P' AND  TRANTYPE='RIV' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  ='R' AND STATUS='P')"
        STR_SQLX = STR_SQLX & "AND TRANTYPE='RIV'"
        STR_SQLX = STR_SQLX & "AND STOCK_ORD='" & XXX & "'"
        STR_SQLX = STR_SQLX & "GROUP BY STOCK_ORD"
        STR_SQLX = STR_SQLX & " Union " & vbCrLf
        STR_SQLX = STR_SQLX & "SELECT 'OLD', SUM(TRANQTY) AS TQTY FROM PMIS_DAYTRAN WHERE TRANNO  IN"
        STR_SQLX = STR_SQLX & "(SELECT TRANNO FROM PMIS_ORD_HIST WHERE TYPE='P' AND TRANTYPE='RIV' AND RONO='" & txtRONO & "' AND ISNULL(STATUS2,'')  ='R' AND STATUS='P')"
        STR_SQLX = STR_SQLX & "AND TRANTYPE='RIV'"
        STR_SQLX = STR_SQLX & "AND STOCK_ORD='" & XXX & "'"
        STR_SQLX = STR_SQLX & "GROUP BY STOCK_ORD"
...
Function SetStockCost(XXX As String) As Double
    ...
    Set rsSTKCost = gconDMIS.Execute("Select MAC from PMIS_PARTMAS where STOCKNO = '" & XXX & "'")
