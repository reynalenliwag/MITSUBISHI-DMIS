...
Begin VB.Form frmPMISMAT_Purchase 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Left            =   2580
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":0EA9
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":0FFB
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Left            =   1680
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":1339
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":148B
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "MAT_Purchase.frx":17DB
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":192D
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "MAT_Purchase.frx":1C93
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":1DE5
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7080
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":214B
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":229D
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":25D7
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":2729
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":2A6E
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":2BC0
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "MAT_Purchase.frx":2EE5
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":3037
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "MAT_Purchase.frx":3393
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":34E5
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "MAT_Purchase.frx":37F8
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":394A
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "MAT_Purchase.frx":3C9A
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":3DEC
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "MAT_Purchase.frx":414A
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":429C
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Purchase.frx":4596
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":46E8
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_Purchase.frx":4A40
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":4B92
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "MAT_Purchase.frx":4EF1
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":5043
         Style           =   1  'Graphical
         TabIndex        =   80
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   -60
         MouseIcon       =   "MAT_Purchase.frx":5381
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":54D3
         Style           =   1  'Graphical
         TabIndex        =   81
...
Sub FillGrid()
    ...
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select pono,pono   from PMIS_PO_HD WHERE [TYPE] = 'M' order by pono asc")
...
Private Sub cmdTranSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        rsPMIS_TdaytranClone.Open "select trantype,tranno,itemno,STOCK_ORD from PMIS_Tdaytran where [TYPE] = 'M' AND STOCK_ORD = '" & UCase(cboTranPartNo.Text) & "' and trantype = 'PO' and tranno =" & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            ...
            rsPO_HDDup.Open "select pono from PMIS_PO_HD where [TYPE] = 'M' AND pono = '" & txtPONo.Text & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
