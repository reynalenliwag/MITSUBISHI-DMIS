...
Begin VB.Form frmPMISTrans_PrisForms 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2850
         MouseIcon       =   "PRISForm.frx":45DD
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":472F
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   2490
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "PRISForm.frx":4A5A
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":4BAC
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   2490
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1470
         MouseIcon       =   "PRISForm.frx":4EEA
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":503C
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   2490
         Width           =   705
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "PRISForm.frx":8100
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":8252
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   1575
         Width           =   855
    ...
    Else
        ...
        Else
            ...
            If LTrim(RTrim(txtTranNo)) <> LTrim(RTrim(Null2String(rsOrd_Hd!TRANNO))) Then
                Set RSFINDDUP = New ADODB.Recordset
                RSFINDDUP.Open "select trantype,tranno from PMIS_vw_PRS where [TYPE] = 'P' AND trantype = '" & txtTranType.Text & "' and tranno = '" & txtTranNo.Text & "' order by trantype,tranno", gconDMIS, adOpenForwardOnly, adLockReadOnly
                If Not RSFINDDUP.EOF And Not RSFINDDUP.BOF Then
                    MsgSpeechBox "Transaction No. already exist!"
                    On Error Resume Next
                    txtTranNo.SetFocus
