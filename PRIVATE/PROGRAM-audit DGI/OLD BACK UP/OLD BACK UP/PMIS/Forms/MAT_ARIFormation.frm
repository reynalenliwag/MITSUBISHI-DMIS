...
Sub GetSeries()
    ...
    rsOrd_Hd.Open "select is_series from PMIS_vw_PRS where [TYPE] = 'M' AND sales_origin = '" & lbl2.Caption & "' and SI_TYPE ='" & lbl3.Caption & "' and  PAY_CLASS = '" & lbl4.Caption & "'  order by is_series desc ", gconDMIS
...
Private Sub cmdOk_Click()
    ...
    Dim rsOrd_Hd                                                      As ADODB.Recordset
    Set rsOrd_Hd = New ADODB.Recordset
    rsOrd_Hd.Open "select refpisno,TRANNO from PMIS_vw_PRS where [TYPE] = 'M' AND refpisno = '" & pisnumber & "' and status='P'", gconDMIS
    If Not rsOrd_Hd.EOF And Not rsOrd_Hd.BOF Then
