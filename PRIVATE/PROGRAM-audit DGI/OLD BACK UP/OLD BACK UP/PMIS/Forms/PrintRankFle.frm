        ...
        If Option6.Value = True Then
            ...
            If Not rsRANKFLE.EOF And Not rsRANKFLE.BOF Then
                ...
                Else
                    ...
                    rptPrintRankfle.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
                    rptPrintRankfle.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
                    PrintSQLReport rptPrintRankfle, PMIS_REPORT_PATH & "ranking.rpt", "{rankfle.date_gen} = DateTime(" & Year(cboDate_Gen.Text) & "," & Month(cboDate_Gen.Text) & "," & Day(cboDate_Gen.Text) & ")", DMIS_REPORT_Connection, 1
