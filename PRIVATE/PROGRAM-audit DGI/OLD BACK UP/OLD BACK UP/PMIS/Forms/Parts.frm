...
Private Sub cmdActiveInactive_Click()
    ...
    If cmdActiveInactive.Tag = "Y" Then
        ...
        If rsCheck.Fields(0).Value > 0 Then
            MsgBox "Part Number has been used in daily transaction file! " & vbCrLf & "Cannot make this Stock Inactive.", vbInformation
        End If
...
Private Sub cmdSave_Click()
    ...
    If ADDOREDIT = "ADD" Then
        SQL_STATEMENT = "INSERT INTO PMIS_STOCKMAS " & _
                      ...
                      " VALUES (" & LOCAL_STOCKTYPE & "," & VTXTLastM_Mac & "," & vtxtPARTNO & "," & vtxtPARTDESC & ", " & VTXTVEHTYPE & ", " & _
                      " " & VTXTMODELCODE & ", " & VTXTLocation & ", " & vtxtMAC & _
                        ", " & VTXTOLDNO & ", " & VTXTWFP & _
                        ", " & VTXTSRP & ", " & VTXTTISSQTY & ", " & VTXTTPOQTY & _
                        ", " & VTXTPHYCOUNT & ", " & VTXTADJPHYCNT & ", " & VTXTRECEIPTS & ", " & VTXTISSUANCES & ", " & VTXTSSTOCK & ", " & VTXTRESSERVICE & ", '" & LOGDATE & "', " & N2Str2Null(LOGCODE) & ",'Y'," & NON_HARI_STR & ")"
