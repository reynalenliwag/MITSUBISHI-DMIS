...
Begin VB.Form frmPMISAC_Purchase_Hist 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         Picture         =   "AC_Purchase_Hist.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "AC_Purchase_Hist.frx":0635
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":0787
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "AC_Purchase_Hist.frx":0AED
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":0C3F
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":0FA5
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":12DF
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPost 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":1624
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Left            =   4740
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":1949
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Left            =   3960
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":1CA5
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_Purchase_Hist.frx":1FB8
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":210A
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "AC_Purchase_Hist.frx":245A
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":25AC
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "AC_Purchase_Hist.frx":290A
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":2A5C
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "AC_Purchase_Hist.frx":2D56
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":2EA8
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "AC_Purchase_Hist.frx":3200
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":3352
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstPO_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_Purchase_Hist.frx":36B1
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Left            =   690
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":3813
         Style           =   1  'Graphical
         TabIndex        =   80
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   -90
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase_Hist.frx":3B51
         Style           =   1  'Graphical
         TabIndex        =   81
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtRemarks 
         ...
         TabIndex        =   12
         Text            =   "AC_Purchase_Hist.frx":3EA1
...
Sub FillGrid()
    ...
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select pono,pono from PMIS_PO_Hist WHERE [TYPE] = 'A' order by pono asc")
...
Private Sub cmdPrint_Click()
    ...
    If MsgQuestionBox("PO Transaction will be Printed. Are you Sure?", "Confirm Printing...") = True Then
        ...
        If NumericVal(txtDS1.Text) > 0 Then
            ...
            PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "Po_Hist.RPT", "{Po_hd.type} = 'A' and {Po_hd.pono} = '" & txtPONo.Text & "'", DMIS_REPORT_Connection, 1
        Else
            rptPurchaseOrder.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
            rptPurchaseOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
