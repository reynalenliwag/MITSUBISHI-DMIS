...
Private Sub cmdPrint_Click()
    ...
    rptAMISDueReport.Formulas(1) = "CompanyName = '" & COMPANY_NAME & "'"
    rptAMISDueReport.Formulas(2) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
    If (cboCOBAcctName.Text = "" And Option2.Value = True And COMPANY_CODE = "HMH") Or (cboCOBAcctName.Text = "" And Option2.Value = True And COMPANY_CODE = "HAI") Or (cboCOBAcctName.Text = "" And Option2.Value = True And COMPANY_CODE = "HGC") Or (cboCOBAcctName.Text = "" And Option2.Value = True And COMPANY_CODE = "HCI") Then
...
Sub getlastdate()
    Set RS = gconDMIS.Execute("select max(JDATE)as JDATE from AMIS_AR")
...
Function GET_MAX_DATE() As String
    ...
    rsGET_MAX_DATE.Open "SELECT MAX(JDATE) AS JDATE FROM AMIS_AR ", gconDMIS, adOpenKeyset
