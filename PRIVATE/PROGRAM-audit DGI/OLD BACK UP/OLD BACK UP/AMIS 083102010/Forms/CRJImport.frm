...
Attribute J_VOUCHERNO.VB_VarUserMemId = 1073938501
Dim J_JTYPE                                       As String
Attribute J_JTYPE.VB_VarUserMemId = 1073938502
Dim J_JNO                                         As String
Attribute J_JNO.VB_VarUserMemId = 1073938523
Dim J_REMARKS                                     As String
Attribute J_REMARKS.VB_VarUserMemId = 1073938503
Dim J_VENDORCODE                                  As String
Attribute J_VENDORCODE.VB_VarUserMemId = 1073938504
Dim J_CUSTOMERCODE                                As String
Attribute J_CUSTOMERCODE.VB_VarUserMemId = 1073938505
Dim J_OUTBALANCE                                  As Double
Attribute J_OUTBALANCE.VB_VarUserMemId = 1073938527
Dim J_AMOUNTTOPAY                                 As Double
Attribute J_AMOUNTTOPAY.VB_VarUserMemId = 1073938506
Dim J_INVOICEAMT                                  As Double
Attribute J_INVOICEAMT.VB_VarUserMemId = 1073938507
Dim J_BALANCE                                     As Double
Attribute J_BALANCE.VB_VarUserMemId = 1073938508
Dim J_AMOUNTPAID                                  As Double
Attribute J_AMOUNTPAID.VB_VarUserMemId = 1073938509
Dim J_CHECKNO                                     As String
Attribute J_CHECKNO.VB_VarUserMemId = 1073938532
Dim J_INVOICEDATE                                 As String
Attribute J_INVOICEDATE.VB_VarUserMemId = 1073938533
Dim J_DUEDATE                                     As String
Attribute J_DUEDATE.VB_VarUserMemId = 1073938510
Dim J_PAYTYPE                                     As String
Attribute J_PAYTYPE.VB_VarUserMemId = 1073938511
Dim J_INVOICETYPE                                 As String
Attribute J_INVOICETYPE.VB_VarUserMemId = 1073938536
Dim J_INVOICENO                                   As String
Attribute J_INVOICENO.VB_VarUserMemId = 1073938512
Dim J_CHECKDATE                                   As String
Attribute J_CHECKDATE.VB_VarUserMemId = 1073938538
Dim J_BANKCODE                                    As String
Attribute J_BANKCODE.VB_VarUserMemId = 1073938513
Dim J_REFNO                                       As String
Attribute J_REFNO.VB_VarUserMemId = 1073938540
Dim J_REFDATE                                     As String
Attribute J_REFDATE.VB_VarUserMemId = 1073938514
Dim J_TERMS                                       As String
Attribute J_TERMS.VB_VarUserMemId = 1073938542
Dim J_DEALER                                      As String
Attribute J_DEALER.VB_VarUserMemId = 1073938515
Dim J_PAIDSTATUS                                  As String
Attribute J_PAIDSTATUS.VB_VarUserMemId = 1073938544
Dim J_RECEIVESTATUS                               As String
Attribute J_RECEIVESTATUS.VB_VarUserMemId = 1073938516

'Dim J_ACCT_CODE, J_ACCT_NAME                       As String
'Dim J_DEBIT, J_CREDIT, J_TAX, J_GROSS, J_NET       As Double
Dim J_STATUS                                      As String
Attribute J_STATUS.VB_VarUserMemId = 1073938546
Dim J_JITEMNO                                     As String
Attribute J_JITEMNO.VB_VarUserMemId = 1073938547
Dim rsJournal_HDDup                               As ADODB.Recordset
Attribute rsJournal_HDDup.VB_VarUserMemId = 1073938548
Dim LIM                                           As Integer
Attribute LIM.VB_VarUserMemId = 1073938549
Dim TRANSACTIONDATE                               As String
Attribute TRANSACTIONDATE.VB_VarUserMemId = 1073938517
Dim Indx                                          As Integer
Attribute Indx.VB_VarUserMemId = 1073938518
Dim xTranDate                                     As String
Attribute xTranDate.VB_VarUserMemId = 1073938519
Dim xCUT_OFF_DATE                                 As String
Attribute xCUT_OFF_DATE.VB_VarUserMemId = 1073938520
    ...
    For GridImport = 1 To Grid1.Rows - 1
        If N2Str2Zero(Grid1.Cell(GridImport, 1).Text) = 0 Then
            ...
            If Grid1.Cell(GridImport, 2).Text = "VAT" Then
                Set rsOFF_HD = gconDMIS.Execute("Select * from CMIS_OFF_HD Where OR_NUM = '" & Grid1.Cell(GridImport, 3).Text & "' AND VAT = 1 AND OR_DATE >= '" & xCUT_OFF_DATE & "' AND  OR_DATE <= '" & CDate(dtpTranDate) & "' Order by OR_NUM ASC")
            Else
                Set rsOFF_HD = gconDMIS.Execute("Select * from CMIS_OFF_HD Where OR_NUM = '" & Grid1.Cell(GridImport, 3).Text & "' AND VAT = 0 AND OR_DATE >= '" & xCUT_OFF_DATE & "' AND  OR_DATE <= '" & CDate(dtpTranDate) & "' Order by OR_NUM ASC")
            End If
            If Not rsOFF_HD.EOF And Not rsOFF_HD.BOF Then
                'If Null2String(rsOFF_HD!OR_NUM) = "019577" Then Stop
...
'                        J_JITEMNO = "'" & Format(J_ITEMCOUNT, "0000") & "'"
                        ...
                        'OTH
                        If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HAI" Then    ' BTT
                            ...
                            End If
                        ElseIf COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Then
                            If CMIS_DT_TRANTYPE = "AI" Then
                        ...
                        If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HGC" Then
...
'HEADER
    ...
    For GridImport = 1 To Grid2.Rows - 1
        If N2Str2Zero(Grid2.Cell(GridImport, 1).Text) = 0 Then
            ...
            Else
                If Grid2.Cell(GridImport, 2).Text = "VAT" Then
                    Set rsOFF_HD = gconDMIS.Execute("Select * from CMIS_OFF_HD_Deposited Where DEPOSIT = 1 AND DATDEPOSIT >= '" & xCUT_OFF_DATE & "' AND DATDEPOSIT <= '" & CDate(dtpTranDate) & "' AND OR_NUM = '" & Grid2.Cell(GridImport, 3).Text & "' AND VAT = 1 Order by OR_NUM ASC")
                Else
                    Set rsOFF_HD = gconDMIS.Execute("Select * from CMIS_OFF_HD_Deposited Where DEPOSIT = 1 AND DATDEPOSIT >= '" & xCUT_OFF_DATE & "' AND DATDEPOSIT <= '" & CDate(dtpTranDate) & "' AND OR_NUM = '" & Grid2.Cell(GridImport, 3).Text & "' AND VAT = 0 Order by OR_NUM ASC")
                End If
            End If
            If Not rsOFF_HD.EOF And Not rsOFF_HD.BOF Then
                CMIS_OR_NUM = Null2String(rsOFF_HD!OR_NUM)
...
Sub ShowUnImportedPaidInvoices(VarTranType As String, VarTranno As String)
    ...
    If VarTranType = "PI" Or VarTranType = "MI" Or VarTranType = "AI" Then
        ...
        Set rsPMIOS_ORD_HD = gconDMIS.Execute("Select * from PMIS_vw_ISS_HISTORY Where TYPE = '" & Left(VarTranType, 1) & "' AND (TranType = 'CSH' OR  TranType = 'CHG') and STATUS = 'P' AND tranno = '" & VarTranno & "' AND TRANDATE > '" & xCUT_OFF_DATE & "' AND TRANDATE <= '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' order by Tranno ASC")
    ...
    If VarTranType = "SI" Then
        ...
        Set rsCSMIOS_REPOR = gconDMIS.Execute("Select CSMS_REPOR.REP_OR,CSMS_REPOR.INVOICE,CSMS_REPOR.RO_AMOUNT from CSMS_REPOR  WHERE INVOICE = '" & VarTranno & "' AND DTE_COMP > '" & xCUT_OFF_DATE & "' AND DTE_COMP <= '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' ORDER BY CSMS_REPOR.REP_OR ASC")
        'UPDATE BY: JUN
        ...
        'UPDATE BY: JUN | DATE UPDATED: 01/14/2010 |DESCRIPTION: DO NOT ALLOWED TO IMPORT TRANSACTION LESS THAT CUTOFF DATE
        Set rsCSMIOS_REPOR = gconDMIS.Execute("Select CSMS_REPOR.REP_OR,CSMS_REPOR.INVOICE,SUM(CSMS_RO_DET.DETPRC) AS AMOUNT from CSMS_REPOR INNER JOIN CSMS_RO_DET ON CSMS_REPOR.REP_OR = CSMS_RO_DET.REP_OR WHERE INVOICE <> 'INT RO' AND RO_AMOUNT = 0 AND DETAMT > 0 AND (WCODE = 'S' OR WCODE = 'C') AND invoice = '" & VarTranno & "' AND DTE_COMP >= '" & xCUT_OFF_DATE & "' AND DTE_COMP <= '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' GROUP BY CSMS_REPOR.REP_OR,INVOICE")
        'UPDATE BY: JUN
        If Not rsCSMIOS_REPOR.EOF And Not rsCSMIOS_REPOR.BOF Then
            rsCSMIOS_REPOR.MoveFirst:
            Do While Not rsCSMIOS_REPOR.EOF
        ...
        Set rsCSMIOS_REPOR = gconDMIS.Execute("Select CSMS_REPOR.REP_OR,CSMS_REPOR.INVOICE,SUM(CSMS_RO_DET.DETAMT) AS AMOUNT from CSMS_REPOR INNER JOIN CSMS_RO_DET ON CSMS_REPOR.REP_OR = CSMS_RO_DET.REP_OR WHERE RO_AMOUNT = 0 AND DETAMT > 0 AND WCODE = 'W' AND invoice = '" & VarTranno & "' AND DTE_COMP > '" & xCUT_OFF_DATE & "' AND DTE_COMP <= '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' GROUP BY CSMS_REPOR.REP_OR,INVOICE")
        'UPDATE BY: JUN
        If Not rsCSMIOS_REPOR.EOF And Not rsCSMIOS_REPOR.BOF Then
            rsCSMIOS_REPOR.MoveFirst:
            Do While Not rsCSMIOS_REPOR.EOF
    ...
    If VarTranType = "VI" Then
        ...
        Set rsSMIS_PURCHAGREE = gconDMIS.Execute("Select * from SMIS_PurchAgree Where VI_NO = '" & VarTranno & "' AND DATERELEASED > '" & xCUT_OFF_DATE & "' AND CONVERT(VARCHAR,DATERELEASED,101) <= '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' order by VI_NO ASC")
    ...
    For GridImport = 1 To Grid3.Rows - 1
        If N2Str2Zero(Grid3.Cell(GridImport, 1).Text) = 0 Then
            ...
            ElseIf UCase(Grid3.Cell(GridImport, 2).Text) = UCase("Materials") Then
                Set rsPMIOS_ORD_HD = gconDMIS.Execute("Select * from PMIS_vw_ISS_HISTORY Where Type = 'M' AND TranType = '" & Left(Grid3.Cell(GridImport, 3).Text, 3) & "' and Tranno = '" & Right(Grid3.Cell(GridImport, 3).Text, 6) & "' AND STATUS = 'P' AND trandate >= '" & xCUT_OFF_DATE & "' AND trandate <= '" & CDate(dtpTranDate) & "' order by Tranno ASC")
                PMIS_TYPE = "MI"
            ElseIf UCase(Grid3.Cell(GridImport, 2).Text) = UCase("Parts") Then
                Set rsPMIOS_ORD_HD = gconDMIS.Execute("Select * from PMIS_vw_ISS_HISTORY Where Type = 'P' AND TranType = '" & Left(Grid3.Cell(GridImport, 3).Text, 3) & "' and Tranno = '" & Right(Grid3.Cell(GridImport, 3).Text, 6) & "' AND STATUS = 'P' AND trandate >= '" & xCUT_OFF_DATE & "' AND trandate <= '" & CDate(dtpTranDate) & "' order by Tranno ASC")
                PMIS_TYPE = "PI"
            Else
                GoTo NextGrid
            End If
            ...
            If Not rsPMIOS_ORD_HD.EOF And Not rsPMIOS_ORD_HD.BOF Then
                ...
                Else
                    ...
                    If PMIOS_TYPE = "M" Then
                        If PMIOS_PAY_CLASS = "C" Then
                            ...
                            If COMPANY_CODE = "HPI" Then
                                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("PARTS"))
                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("PARTS")))
                            ElseIf COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HGC" Then
                    ...
                    Else
                        ...
                        End If
                    End If
                    If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HAS" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HAI" Or COMPANY_CODE = "HMH" Then
                        If PMIOS_PAY_CLASS = "I" Then
                            'Update bY: BTT - 07092008
                            'J_GROSS = Round(NumericVal(PMIOS_TTLINVAMT), 2)
        ...
        If N2Str2Zero(Grid3.Cell(GridImport, 1).Text) = 0 Then
            ...
            If Not rsSMIS_PURCHAGREE.EOF And Not rsSMIS_PURCHAGREE.BOF Then
                If CheckSJExisting("VI", Null2String(rsSMIS_PURCHAGREE!VI_NO)) = True Then
                    GoTo DuplicateInvoiceNo
                Else
                    'If Null2String(rsSMIS_PURCHAGREE!VI_NO) = "003034" Then Stop
...
Function ImportPurelyInternal() As Boolean
    ...
    For GridImport = 1 To Grid3.Rows - 1
        If N2Str2Zero(Grid3.Cell(GridImport, 1).Text) = 0 Then
            ...
            Set rsCSMIOS_REPOR = gconDMIS.Execute("Select * from CSMS_REPOR where REP_OR = '" & Grid3.Cell(GridImport, 2).Text & "' and dte_comp >= '" & xCUT_OFF_DATE & "' AND dte_comp <= '" & CDate(dtpTranDate) & "' order by invoice ASC")
            If Not rsCSMIOS_REPOR.EOF And Not rsCSMIOS_REPOR.BOF Then
                ItemCnt = 0
...
Function ImportCSMSSales() As Boolean
    ...
    For GridImport = 1 To Grid3.Rows - 1
        If N2Str2Zero(Grid3.Cell(GridImport, 1).Text) = 0 Then
            ...
            'Set rsCSMIOS_REPOR = gconDMIS.Execute("Select * from CSMS_REPOR where RO_AMOUNT > 0 AND invoice = '" & Grid2.Cell(GridImport, 3).Text & "' and dte_comp = '" & CDate(dtpTranDate) & "' order by invoice ASC")
            'ORIGINAL CODE:
            SQL_STATEMENT = "Select * from CSMS_REPOR where REP_OR = '" & Grid3.Cell(GridImport, 2).Text & "' and dte_comp >= '" & xCUT_OFF_DATE & "' AND dte_comp <= '" & CDate(dtpTranDate) & "' order by invoice ASC"
...
InitGrids:     DoEvents: cmdCheck.Enabled = False: cmdClearJournals.Enabled = False
    ...
    If COMPANY_CODE = "HAI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HGC" Then
        GoTo ShowTrans
    Else
...
Private Sub Form_Load()
    ...
    'UPDATED BY: JUN | DATE UPDATED: 01-14-2010 | DESCRIPTION: GET THE CUT-OFF DATE
    ...
    If Not rsGET_CUT_OFF_DATE.EOF And Not rsGET_CUT_OFF_DATE.BOF Then
        xCUT_OFF_DATE = Null2String(rsGET_CUT_OFF_DATE!Cut_Off_Date)
    End If
    If xCUT_OFF_DATE = "" Then
...
Private Sub IMPORT_ACCESSORIES()
    If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HAI" Then
        If CSMIOS_ACCESSORIES > 0 Then
            ItemCnt = ItemCnt + 1: J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
            If CSMIOS_TERM = "CSH" Then
                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("ACCESSORIES", "INSTALLED"))
