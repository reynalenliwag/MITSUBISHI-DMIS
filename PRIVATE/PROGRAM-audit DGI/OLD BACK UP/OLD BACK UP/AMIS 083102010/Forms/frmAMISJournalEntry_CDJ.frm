...
Begin VB.Form frmAMISJournalEntry_CDJ 
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_CDJ.frx":291A
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Label Label21 
         ...
         Height          =   255
         Left            =   4710
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":29B1
         MousePointer    =   99  'Custom
         TabIndex        =   216
         Top             =   300
         Width           =   4605
      ...
      Begin VB.Label Label50 
         ...
         Height          =   255
         Left            =   4710
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":2CBB
         MousePointer    =   99  'Custom
         TabIndex        =   215
         Top             =   30
         Width           =   4605
      ...
      Begin VB.Label Label42 
         ...
         Height          =   255
         Left            =   60
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":2FC5
         MousePointer    =   99  'Custom
         TabIndex        =   214
         Top             =   30
         Width           =   4605
      ...
      Begin VB.Label Label4 
         ...
         Height          =   255
         Left            =   60
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":32CF
         MousePointer    =   99  'Custom
         TabIndex        =   213
         Top             =   300
         Width           =   4605
   ...
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_CDJ.frx":35D9
   End
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":35F5
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":3757
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin wizButton.cmd cmdShowPostRange 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_CDJ.frx":38B9
   End
   Begin VB.PictureBox picShowPostRange 
      ...
      Begin wizProgBar.Prg prgPostRange 
         ...
         _ExtentX        =   4154
         _ExtentY        =   503
         Picture         =   "frmAMISJournalEntry_CDJ.frx":38D5
         ForeColor       =   0
         BarPicture      =   "frmAMISJournalEntry_CDJ.frx":38F1
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_CDJ.frx":390D
   End
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8820
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":3929
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":3A7B
         Style           =   1  'Graphical
         TabIndex        =   211
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8070
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":3DE1
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":3F33
         Style           =   1  'Graphical
         TabIndex        =   210
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7320
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":4299
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":43EB
         Style           =   1  'Graphical
         TabIndex        =   209
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6540
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":4725
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":4877
         Style           =   1  'Graphical
         TabIndex        =   208
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5790
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":4BBC
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":4D0E
         Style           =   1  'Graphical
         TabIndex        =   207
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5040
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":5033
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":5185
         Style           =   1  'Graphical
         TabIndex        =   206
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4290
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":54E1
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":5633
         Style           =   1  'Graphical
         TabIndex        =   205
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":5946
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":5A98
         Style           =   1  'Graphical
         TabIndex        =   204
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":5DE8
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":5F3A
         Style           =   1  'Graphical
         TabIndex        =   203
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2040
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":6298
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":63EA
         Style           =   1  'Graphical
         TabIndex        =   202
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1290
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":66E4
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":6836
         Style           =   1  'Graphical
         TabIndex        =   201
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   540
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":6B8E
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":6CE0
         Style           =   1  'Graphical
         TabIndex        =   200
   ...
   Begin VB.PictureBox picGJ 
      ...
      Begin VB.PictureBox picGJEntry 
         ...
         Begin VB.CommandButton cmdGJCancel 
            ...
            Left            =   8160
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":703F
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_CDJ.frx":7191
            Style           =   1  'Graphical
            TabIndex        =   103
            Top             =   1050
            Width           =   1005
         ...
         Begin VB.CommandButton cmdGJSave 
            ...
            Left            =   7140
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":74A3
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_CDJ.frx":75F5
            Style           =   1  'Graphical
            TabIndex        =   101
            Top             =   1050
            Width           =   975
         ...
         Begin VB.CommandButton cmdGJDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":7A37
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_CDJ.frx":7B89
            Style           =   1  'Graphical
            TabIndex        =   100
            Top             =   1050
            Width           =   1005
         ...
         Begin RichTextLib.RichTextBox txtGJAccountName 
            ...
            MultiLine       =   0   'False
            Appearance      =   0
            TextRTF         =   $"frmAMISJournalEntry_CDJ.frx":7E93
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   9
               Charset         =   0
         ...
         Begin RichTextLib.RichTextBox txtGJAccountParticulars 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"frmAMISJournalEntry_CDJ.frx":7F26
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin wizButton.cmd cmdGJEntry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_CDJ.frx":7FBD
      End
      ...
      Begin RichTextLib.RichTextBox txtParticulars2 
         ...
         Enabled         =   -1  'True
         ScrollBars      =   2
         TextRTF         =   $"frmAMISJournalEntry_CDJ.frx":7FD9
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
      ...
      Begin MSComctlLib.ListView lstGJ 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":8070
         NumItems        =   6
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "ITEM #"
            Object.Width           =   1587
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   765
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":81D2
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":8324
         Style           =   1  'Graphical
         TabIndex        =   198
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   10
         MouseIcon       =   "frmAMISJournalEntry_CDJ.frx":8662
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDJ.frx":87B4
         Style           =   1  'Graphical
         TabIndex        =   197
...
'            rsJClass.Open "SELECT DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE LEFT(ACCT_CODE,5) IN ('21-01','21-02','21-07') AND HD.VOUCHERNO = '" & txtVoucherNo.Text & "' AND HD.JTYPE='" & xJOURNALTYPE & "'", gconDMIS
...
'            End If
            ...
            SQL_STATEMENT = "insert into AMIS_CV_Detail " & _
                            "(CV_JTYPE,JTYPE,VoucherNo,itemno,PV_VoucherNo,JDATE,DocDate,DueDate,Amount,status,VendorCode,J_Class)" & _
...
SaveJournalDetails:
                ...
                If COMPANY_CODE = "HAI" Or COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Then
            ...
            rsCVUpdate.Open "Select * from AMIS_CV_DETAIL WHERE VOUCHERNO=" & J_VOUCHERNO & " AND CV_JTYPE=" & J_JTYPE & "", gconDMIS, adOpenKeyset
            If Not rsCVUpdate.EOF And Not rsCVUpdate.BOF Then
                Do While Not rsCVUpdate.EOF
                    gconDMIS.Execute ("UPDATE AMIS_CV_DETAIL SET J_CLASS = " & J_ACCT_CODE & " WHERE VOUCHERNO =" & J_VOUCHERNO & "AND CV_JTYPE=" & J_JTYPE & "")
                    rsCVUpdate.MoveNext
                Loop
            End If
            J_ITEMCOUNT = J_ITEMCOUNT + 1
...
Sub InitPV_Detail()
    ...
    ElseIf xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "CCM" Then
        ...
        txtPVAmount.Text = ZERO
    Else
        labPV1.Caption = "Voucher No": txtPO_No.Enabled = False: txtPO_No.Text = ""    'txtPO_No.Text = txtVoucherNo.Text:
...
Sub StoreMemVars()
    If Not rsJournal_HD.EOF And Not rsJournal_HD.BOF Then
        ...
        If xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "CSJ" Or xJOURNALTYPE = "CCM" Then
            ...
            CRJ_ORNum = Null2String(rsJournal_HD!InvoiceType)
            If xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "CSJ" Then
    ...
    If MsgBox("Are you sure you want to Post this transaction?", vbQuestion + vbYesNo, "Message") = vbYes Then
        ...
        Else
            If xJOURNALTYPE = "CDJ" Then
                ...
                Set rsCheckDetails = gconDMIS.Execute("Select Acct_Code, debit from AMIS_Journal_Det DET INNER JOIN AMIS_CHARTACCOUNT AC ON DET.ACCT_CODE=AC.ACCTCODE Where IS_SCHEDULE_ACCNT=1 and Jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
                If Not rsCheckDetails.EOF And Not rsCheckDetails.BOF Then
                    rsCheckDetails.MoveFirst
                    TotalCRJ_Credit = 0
                    Do While Not rsCheckDetails.EOF
                    ...
                    Set rsCheckCRJDetails = gconDMIS.Execute("Select SUM(AMOUNT) as TUTALINVAMT from AMIS_CV_Detail Where STATUS <> 'C' AND VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
...
Private Sub cmdUnPost_Click()
    ...
    If MsgBox("Are you sure you want to Unpost this transaction?", vbQuestion + vbYesNo, "Message") = vbYes Then
        ...
        ElseIf xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Then
            ...
            End If
            Call UNPOST_CDJ
            gconDMIS.Execute "DELETE FROM AMIS_AP WHERE VOUCHERNO = '" & xVOUCHERNO & "'"
...
Sub UNPOST_DIRECT_DISBURSEMENT()
    ...
    Dim xJType                                    As String
    Set rsDIRECT_DISBURSEMENT = New ADODB.Recordset
    rsDIRECT_DISBURSEMENT.Open "SELECT * FROM (SELECT HD.VOUCHERNO,HD.VENDORCODE,HD.AMOUNTPAID,HD.JDATE,HD.JTYPE,DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE HD.VOUCHERNO NOT IN (SELECT VOUCHERNO FROM AMIS_CV_DETAIL WHERE VOUCHERNO =HD.VOUCHERNO)) X WHERE VOUCHERNO=  " & N2Str2Null(txtVoucherNo.Text) & " AND JTYPE='CDJ' AND ACCT_CODE IN ('21-01','21-02','21-07') ", gconDMIS, adOpenKeyset
    If Not rsDIRECT_DISBURSEMENT.EOF And Not rsDIRECT_DISBURSEMENT.BOF Then
        xAMOUNT = NumericVal(rsDIRECT_DISBURSEMENT!AMOUNTPAID)
        xVENDORCODE = N2Str2Null(Null2String(rsDIRECT_DISBURSEMENT!VendorCode))
        xACCT_CODE = N2Str2Null(Null2String(rsDIRECT_DISBURSEMENT!Acct_code))
