...
Begin VB.Form frmAMISFILESChartOfAccount 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Picture         =   "ChartOfAccount.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   5880
         MouseIcon       =   "ChartOfAccount.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   46
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   5190
         MouseIcon       =   "ChartOfAccount.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   45
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4500
         MouseIcon       =   "ChartOfAccount.frx":16B7
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":1809
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3810
         MouseIcon       =   "ChartOfAccount.frx":1B65
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":1CB7
         Style           =   1  'Graphical
         TabIndex        =   43
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3090
         MouseIcon       =   "ChartOfAccount.frx":1FCA
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":211C
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2370
         MouseIcon       =   "ChartOfAccount.frx":246C
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":25BE
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1680
         MouseIcon       =   "ChartOfAccount.frx":291C
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":2A6E
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   990
         MouseIcon       =   "ChartOfAccount.frx":2D68
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":2EBA
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   300
         MouseIcon       =   "ChartOfAccount.frx":3212
         MousePointer    =   99  'Custom
         Picture         =   "ChartOfAccount.frx":3364
         Style           =   1  'Graphical
         TabIndex        =   40
   ...
   Begin VB.PictureBox picWizard 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   795
            Left            =   780
            MouseIcon       =   "ChartOfAccount.frx":36C3
            MousePointer    =   99  'Custom
            Picture         =   "ChartOfAccount.frx":3815
            Style           =   1  'Graphical
            TabIndex        =   38
            ToolTipText     =   "Cancel"
            Top             =   60
         ...
         Begin VB.CommandButton cmdSave 
            ...
            Height          =   795
            Left            =   90
            MouseIcon       =   "ChartOfAccount.frx":3B53
            MousePointer    =   99  'Custom
            Picture         =   "ChartOfAccount.frx":3CA5
            Style           =   1  'Graphical
            TabIndex        =   37
      ...
      Begin MSComctlLib.ListView lstRelatedAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "ChartOfAccount.frx":3FF5
         NumItems        =   4
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "ChartOfAccount.frx":4157
         NumItems        =   5
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
