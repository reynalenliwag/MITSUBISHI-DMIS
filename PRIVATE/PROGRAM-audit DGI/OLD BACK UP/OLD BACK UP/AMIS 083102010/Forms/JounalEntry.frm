...
Begin VB.Form frmAMISJournalEntry 
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "JounalEntry.frx":0D92
            MousePointer    =   99  'Custom
            Picture         =   "JounalEntry.frx":0EE4
            Style           =   1  'Graphical
            TabIndex        =   178
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "JounalEntry.frx":12A2
            MousePointer    =   99  'Custom
            Picture         =   "JounalEntry.frx":13F4
            Style           =   1  'Graphical
            TabIndex        =   194
            Top             =   765
            Width           =   705
      ...
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   8400
            MouseIcon       =   "JounalEntry.frx":1760
            MousePointer    =   99  'Custom
            Picture         =   "JounalEntry.frx":18B2
            Style           =   1  'Graphical
            TabIndex        =   151
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "JounalEntry.frx":1BF0
            MousePointer    =   99  'Custom
            Picture         =   "JounalEntry.frx":1D42
            Style           =   1  'Graphical
            TabIndex        =   149
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7710
            MouseIcon       =   "JounalEntry.frx":206D
            MousePointer    =   99  'Custom
            Picture         =   "JounalEntry.frx":21BF
            Style           =   1  'Graphical
            TabIndex        =   150
            Top             =   690
            Width           =   705
      ...
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "JounalEntry.frx":252B
            NumItems        =   7
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Label Label21 
         ...
         Height          =   255
         Left            =   4710
         MouseIcon       =   "JounalEntry.frx":29B1
         MousePointer    =   99  'Custom
         TabIndex        =   216
         Top             =   300
         Width           =   4605
      ...
      Begin VB.Label Label50 
         ...
         Height          =   255
         Left            =   4710
         MouseIcon       =   "JounalEntry.frx":2CBB
         MousePointer    =   99  'Custom
         TabIndex        =   215
         Top             =   30
         Width           =   4605
      ...
      Begin VB.Label Label42 
         ...
         Height          =   255
         Left            =   60
         MouseIcon       =   "JounalEntry.frx":2FC5
         MousePointer    =   99  'Custom
         TabIndex        =   214
         Top             =   30
         Width           =   4605
      ...
      Begin VB.Label Label4 
         ...
         Height          =   255
         Left            =   60
         MouseIcon       =   "JounalEntry.frx":32CF
         MousePointer    =   99  'Custom
         TabIndex        =   213
         Top             =   300
         Width           =   4605
   ...
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "JounalEntry.frx":35F5
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "JounalEntry.frx":3757
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin VB.PictureBox picShowPostRange 
      ...
      Begin wizProgBar.Prg prgPostRange 
         ...
         _ExtentX        =   4154
         _ExtentY        =   503
         Picture         =   "JounalEntry.frx":38D5
         ForeColor       =   0
         BarPicture      =   "JounalEntry.frx":38F1
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
