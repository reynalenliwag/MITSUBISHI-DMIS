...
Begin VB.Form frmAMISMASTERFILECustomer 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "Customer.frx":15242
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":15394
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4170
         MouseIcon       =   "Customer.frx":157D6
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":15928
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3480
         MouseIcon       =   "Customer.frx":15D6A
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":15EBC
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "Customer.frx":162FE
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":16450
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2100
         MouseIcon       =   "Customer.frx":16892
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":169E4
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1410
         MouseIcon       =   "Customer.frx":16E26
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":16F78
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "Customer.frx":173BA
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":1750C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   30
         Width           =   675
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   90
         MouseIcon       =   "Customer.frx":1794E
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":17AA0
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   30
         Width           =   675
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "Customer.frx":17F68
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":180BA
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   4170
         MouseIcon       =   "Customer.frx":184FC
         MousePointer    =   99  'Custom
         Picture         =   "Customer.frx":1864E
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   30
         Width           =   705
...
If MsgBox("Delete Current Record", vbQuestion + vbYesNo, "Delete") = vbYes Then
   gconAmis.Execute "delete from Customer where id = " & labID.Caption
End If
rsRefresh
StoreMemvars
End Sub
...
If AddorEdit = "ADD" Then
   ...
   Set rsCustomerDup = New ADODB.Recordset
       rsCustomerDup.Open "select AccountNo from Customer where AccountNo = " & VtxtAccountNo, gconAmis
   ...
   End If
   Set rsCustomerDup = New ADODB.Recordset
       rsCustomerDup.Open "select AccountNo from Customer where CustCode = " & VtxtCustCode, gconAmis
   If Not rsCustomerDup.EOF And Not rsCustomerDup.BOF Then
      MsgBox "Customer Code Already Exist!", vbCritical, "Duplicate Customer Code Not Allowed"
      Exit Sub
   End If
   gconAmis.Execute "Insert into Customer " & _
...
Else
   gconAmis.Execute "Update Customer set" & _
...
End If
gconAmis.Execute "update cusctl set ctlcde = '" & NewCtlCde & "' where left(ctlcde,1) = '" & Left(txtLastName.Text, 1) & "'"
rsRefresh
On Error Resume Next
...
Sub rsRefresh()
Set rsCustomer = New ADODB.Recordset
    rsCustomer.Open "select * from Customer WHERE CUSTCODE <> '999999' order by CUSTCODE asc", gconAmis, adOpenForwardOnly, adLockReadOnly
FillGrid
End Sub
...
Set rsCustomerAcc = New ADODB.Recordset
    rsCustomerAcc.Open "select custcode from customer order by custcode asc", gconAmis
...
Set rsCustomer2 = gconAmis.Execute("select CustCode,CustName,ID from Customer where custcode <> '999999' ORDER BY CUSTCODE ASC")
...
lstCustomer.Sorted = False: lstCustomer.ListItems.Clear
Set rsCustomer2 = New ADODB.Recordset
Set rsCustomer2 = gconAmis.Execute("select CustCode,CustName,ID from Customer where custcode <> '999999' and CustName like '" & XXX & "%' ORDER BY CUSTCODE ASC")
If Not (rsCustomer2.EOF And rsCustomer2.BOF) Then
   Listview_Loadval Me.lstCustomer.ListItems, rsCustomer2
   lstCustomer.Refresh
   lstCustomer.Enabled = True
...
rsCustomer.Bookmark = rsFind(rsCustomer.Clone, "ID", lstCustomer.SelectedItem.SubItems(2)).Bookmark
StoreMemvars
End Sub
...
If Len(txtCustName.Text) = 1 Then
   If AddorEdit = "ADD" Then
      ...
      Set rsCusCtl = gconAmis.Execute("select ctlcde from cusctl where left(ctlcde,1) = '" & Left(txtCustName.Text, 1) & "'")
...
If Len(txtLastName.Text) = 1 Then
   If AddorEdit = "ADD" Then
      Set rsCusCtl = New ADODB.Recordset
      Set rsCusCtl = gconAmis.Execute("select ctlcde from cusctl where left(ctlcde,1) = '" & Left(txtLastName.Text, 1) & "'")
      If Not rsCusCtl.EOF And Not rsCusCtl.BOF Then txtCustCode.Text = Null2String(rsCusCtl!ctlcde)
   End If
End If
txtCustName.Text = Trim(UCase(txtLastName.Text) & ", " & UCase(txtFirstName.Text) & " " & UCase(txtMiddleName.Text))
