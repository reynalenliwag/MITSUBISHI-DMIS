...
Begin VB.Form frmAMISJournalEntry_GJDetails 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.ComboBox cboJTYPE 
         ...
         ForeColor       =   &H000000FF&
         Height          =   360
         ItemData        =   "frmAMIS_GJ_ENTRY.frx":0D2E
         Left            =   1230
         List            =   "frmAMIS_GJ_ENTRY.frx":0D4A
         TabIndex        =   56
         Top             =   870
         Width           =   1875
      End
      ...
      Begin RichTextLib.RichTextBox txtADJ_Remarks 
         ...
         _Version        =   393217
         ScrollBars      =   2
         TextRTF         =   $"frmAMIS_GJ_ENTRY.frx":0D74
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picGJEntry 
      ...
      Begin RichTextLib.RichTextBox txtGJAccountParticulars 
         ...
         ScrollBars      =   2
         Appearance      =   0
         TextRTF         =   $"frmAMIS_GJ_ENTRY.frx":0DF0
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.CommandButton cmdGJSave 
      ...
      Left            =   7710
      MaskColor       =   &H00FFFFFF&
      MouseIcon       =   "frmAMIS_GJ_ENTRY.frx":0E87
      MousePointer    =   99  'Custom
      Picture         =   "frmAMIS_GJ_ENTRY.frx":0FD9
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   4620
      Width           =   975
   ...
   Begin VB.CommandButton cmdGJDelete 
      ...
      Left            =   6720
      MaskColor       =   &H00FFFFFF&
      MouseIcon       =   "frmAMIS_GJ_ENTRY.frx":141B
      MousePointer    =   99  'Custom
      Picture         =   "frmAMIS_GJ_ENTRY.frx":156D
      Style           =   1  'Graphical
      TabIndex        =   15
      TabStop         =   0   'False
      Top             =   4620
   ...
   Begin VB.PictureBox picChart 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMIS_GJ_ENTRY.frx":1877
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
...
On Error GoTo ErrorCode
    ...
    If cboJTYPE.Text = "CRJ" Then
        rsCHECK_MULTI_DETAIL.Open "SELECT COUNT(VOUCHERNO) AS COUNT_VOUCHERNO FROM AMIS_CRJ_DETAIL WHERE VOUCHERNO = '" & cboCDJNo.Text & "' AND CR_TYPE = '" & cboJTYPE.Text & "'", gconDMIS, adOpenKeyset
    ElseIf cboJTYPE.Text = "CDJ" Then
        rsCHECK_MULTI_DETAIL.Open "SELECT COUNT(VOUCHERNO) AS COUNT_VOUCHERNO FROM AMIS_CV_DETAIL WHERE VOUCHERNO = '" & cboCDJNo.Text & "' AND JTYPE = 'APJ'", gconDMIS, adOpenKeyset
    End If
    ...
    If AddorEdit = "ADD" Then
        If chkOther.Value = 0 Then
            xCUSCODE = N2Str2Null(WHAT_CLASS & RTrim(LTrim(txtCode.Text)))
        Else
            If txtCode.Text = "" Then
                xCUSCODE = N2Str2Null("")
            Else
...
'InitCboCDJ_No
    labClass.Caption = WHAT_CLASS & txtCode
End Sub
...
Sub FIND_SUB_DETAIL_REFERENCE()
    ...
    If RTrim(LTrim(cboJTYPE.Text)) = "CRJ" Then
        rsCHECK_MULTI_DETAIL.Open "SELECT COUNT(VOUCHERNO) AS XXX_COUNT FROM AMIS_CRJ_DETAIL WHERE VOUCHERNO = '" & cboCDJNo.Text & "' AND CR_TYPE = 'CRJ'", gconDMIS, adOpenKeyset
    ElseIf RTrim(LTrim(cboJTYPE.Text)) = "CDJ" Then
        rsCHECK_MULTI_DETAIL.Open "SELECT COUNT(VOUCHERNO) AS XXX_COUNT FROM AMIS_CV_DETAIL WHERE VOUCHERNO = '" & cboCDJNo.Text & "' AND JTYPE = 'APJ'", gconDMIS, adOpenKeyset
    Else
        Exit Sub
    End If
