...
Sub rsRefresh()
    ...
    If xJOURNALTYPE = "CRJ" Then Me.Caption = "UN-DEPOSITED CASH RECEIPTS JOURNAL ENTRY"
...
Private Sub cmdJournalDelete_Click()
    ...
    If MsgBox("Delete This Journal, Are you Sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
        ...
        LogAudit "X", "JOURNAL ENTRY", xJOURNALTYPE & " - " & txtAcct_Name
    End If
    Dim cnt                                       As Integer
    Dim rsJournalDup                              As ADODB.Recordset
    Set rsJournalDup = New ADODB.Recordset
...
Private Sub cmdPrint_Click()
    ...
    LogAudit "V", "JOURNAL ENTRY", xJOURNALTYPE & ":" & cboNameofVendor & " - " & txtVoucherNo
    Exit Sub
ErrorCode:
    ShowVBError
End Sub
...
Private Sub cmdSave_Click()
    ...
    Else
        ...
        J_DEALER = "NULL"
    End If
    If xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "DRJ" Then
    ...
    If AddorEdit = "ADD" Then
        ...
        If Not rsJournal_HDDup.EOF And Not rsJournal_HDDup.BOF Then txtJNo.Text = Format(N2Str2Zero(rsJournal_HDDup!JNo) + 1, "000000") Else txtJNo.Text = "000001"
        J_JNO = N2Str2Null(txtJNo.Text)
        J_VOUCHERNO = GetVoucherNo(xJOURNALTYPE)
