...
Private Sub labIncomeStatements_Click()
    ...
    Else
        ...
        If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='50'")
            Else
            ...
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                                 " where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode IN ('00','10','20','30','40')")
            Else
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers='50'")
            Else
            ...
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                                 ...
                                                 " AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.DepartmentCode IN ('00','10','20','30','40')")
            Else
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                                 " where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "')" & _
                                                 " AND ((AMIS_ChartAccount.Headers ='71' OR AMIS_ChartAccount.Headers='72') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.DepartmentCode <> '" & ADMIN_SECTION & "')")
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers='50'")
            Else
...
Private Sub labScheduleOfSellingExpensesBrpSection_Click()
    ...
    ReportFolder = "FinancialStatement\FinancialStatements\"
    rptAMISIncomeStatement.Formulas(30) = "ToJDate = #" & Format(dtpTo, "Short Date") & "#"
    PrintSQLReport rptAMISIncomeStatement, AMIS_REPORT_PATH & ReportFolder & "ScheduleOfSellingExpenseBrpSection.rpt", "{ChartAccount.DepartmentCode} = '" & SERVICE_SECTION & "' AND year({Journal_Det.jdate}) = " & Year(dtpTo) & " and {Journal_Det.jdate} <= date(" & Year(dtpTo) & "," & Month(dtpTo) & "," & Day(dtpTo) & ")", DMIS_REPORT_Connection, 1
