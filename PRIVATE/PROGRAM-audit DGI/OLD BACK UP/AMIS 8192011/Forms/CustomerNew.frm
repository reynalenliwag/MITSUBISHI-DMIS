...
Begin VB.Form frmAMISMASTERFILECustomerNew 
   BackColor       =   &H00DEDFDE&
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstCustomer 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CustomerNew.frx":152C8
         NumItems        =   3
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   5850
         MouseIcon       =   "CustomerNew.frx":1542A
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":1557C
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   5010
         MouseIcon       =   "CustomerNew.frx":159BE
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":15B10
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   4170
         MouseIcon       =   "CustomerNew.frx":15F52
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":160A4
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   3330
         MouseIcon       =   "CustomerNew.frx":164E6
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":16638
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2490
         MouseIcon       =   "CustomerNew.frx":16A7A
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":16BCC
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1650
         MouseIcon       =   "CustomerNew.frx":1700E
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":17160
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "CustomerNew.frx":175A2
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":176F4
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   30
         Width           =   825
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "CustomerNew.frx":17B36
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":17C88
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   30
         Width           =   825
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   5850
         MouseIcon       =   "CustomerNew.frx":180CA
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":1821C
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   30
         Width           =   855
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   5010
         MouseIcon       =   "CustomerNew.frx":1865E
         MousePointer    =   99  'Custom
         Picture         =   "CustomerNew.frx":187B0
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   30
         Width           =   855
   ...
   End
End
Attribute VB_Name = "frmAMISMASTERFILECustomerNew"
...
If OPEN_AR_SHOW = True Then
   frmAMISCustomerAROpening.InitCustomer
   frmAMISCustomerAROpening.txtCustCode.Text = txtCustCode.Text
End If
If SJ_SHOW = True Then
   frmAMISJournalEntry.InitCustomer
   frmAMISJournalEntry.txtCustCode.Text = txtCustCode.Text
End If
End Sub
