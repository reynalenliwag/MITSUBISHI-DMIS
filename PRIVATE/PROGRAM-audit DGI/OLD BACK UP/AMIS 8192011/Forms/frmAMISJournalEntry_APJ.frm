...
Function DetailPosting() As Boolean
    ...
    If AddorEdit = "ADD" Then
        ...
        If xJOURNALTYPE = "APJ" Then
            ...
            NEW_LogAudit "AA", "ACCOUNTS PAYABLE JOURNAL", SQL_STATEMENT, labID.Caption, "PV", txtVoucherNo, xJOURNALTYPE, JOURNAL_DETID
        End If
    Else
...
Private Sub cmdJournalDelete_Click()
    ...
    If MsgBox("Delete This Journal, Are you Sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
        ...
        If CheckARDetails(xJOURNALTYPE + "-" + txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the AR details"
            Exit Sub
        End If

        If CheckAPDetails(xJOURNALTYPE + "-" + txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the AP details"
            Exit Sub
        End If

        If CheckARPaymentDetails(xJOURNALTYPE, txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the Payment details"
            Exit Sub
        End If

        If CheckAPPaymentDetails(xJOURNALTYPE, txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the Payment details"
            Exit Sub
        End If
...
Private Sub cmdJournalSave_Click()
    ...
    If AddorEdit = "ADD" Then
        If CheckIfARDebitNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtDebit.Text) = True Then
            Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + txtVoucherNo.Text, cboAcct_Code.Text, txtJDate.Text, txtDebit.Text, lblClass, txtCode.Text, txtDebit.Text)
        ...
        ElseIf CheckIfAPCreditNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtCredit.Text) = True Then
            Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + txtVoucherNo.Text, cboAcct_Code.Text, txtJDate.Text, txtCredit.Text, lblClass, txtCode.Text, txtDebit.Text)
            frmAMISJournalEntry_Details.Show 1
        End If
    Else
        ...
        Else
            If CheckIfARDebitNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), txtDebit.Text) = True Then
                If CheckIfBalanceAR(lstDetails.SelectedItem.SubItems(1), NumericVal(txtDebit.Text), xJOURNALTYPE + "-" + txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, txtDebit.Text, lblClass, txtCode.Text, txtDebit.Text)
                    frmAMISJournalEntry_Details.Show 1
                End If
            ...
            ElseIf CheckIfAPCreditNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), txtCredit.Text) = True Then
                If CheckIfBalanceAP(lstDetails.SelectedItem.SubItems(1), NumericVal(txtCredit.Text), xJOURNALTYPE + "-" + txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, txtCredit.Text, lblClass, txtCode.Text, txtDebit.Text)
                    frmAMISJournalEntry_Details.Show 1
                End If
            End If
        End If
...
Function JournalEntries() As Boolean
    ...
    If AddorEdit = "ADD" Then
        ...
        NEW_LogAudit "AA", "ACCOUNTS PAYABLE JOURNAL", SQL_STATEMENT, labID.Caption, "DT", txtVoucherNo, xJOURNALTYPE, JOURNAL_DETID
