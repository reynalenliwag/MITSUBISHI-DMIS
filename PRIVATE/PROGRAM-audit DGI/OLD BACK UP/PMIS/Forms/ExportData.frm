VERSION 5.00
Object = "{D6EB33F3-3D5F-4DF1-9472-D7CF0724D0AC}#1.0#0"; "wizButton.ocx"
Object = "{B8CDB61A-9806-4F7E-814B-BE4071F425B9}#1.0#0"; "wizProgBar.ocx"
Begin VB.Form frmPMIOSExportData 
   ...
   End
End
Attribute VB_Name = "frmPMIOSExportData"
...
gconOldPMIS.Execute "delete * from tdaytran"
Set rsOldTdaytran = New ADODB.Recordset
    rsOldTdaytran.Open "select * from tdaytran order by id asc", gconPMIOS
...
'gconOldPMIS.Execute "delete * from daytran"
Set rsOldTdaytranHist = New ADODB.Recordset
    rsOldTdaytranHist.Open "select * from daytran where month(trandate) = 8 and year(trandate) = 2003 order by id asc", gconPMIOS
...
Dim varOHCUSTADDRS1 As String
Dim varOHCUSTADDRS2 As String
...
gconOldPMIS.Execute "delete * from ord_hd"
Set rsOldOrd_HD = New ADODB.Recordset
    rsOldOrd_HD.Open "select * from ord_hd order by id asc", gconPMIOS
If Not rsOldOrd_HD.EOF And Not rsOldOrd_HD.BOF Then
   ...
   Do While Not rsOldOrd_HD.EOF
      ...
      varOHCUSTNAME = N2Str2Null(Trim(Left(rsOldOrd_HD!custname, 40)))
      varOHCUSTADDRS1 = N2Str2Null(Trim(Mid(rsOldOrd_HD!custname, 41, 40)))
      varOHCUSTADDRS2 = N2Str2Null(Trim(Mid(rsOldOrd_HD!custname, 81, 40)))
      ...
      MoveSql = "INSERT INTO ORD_HD " & _
                "(TRANTYPE,TRANNO,TRANDATE,CANCDATE,CUSTCODE,CUSTNAME,CUSTADRS1,CUSTADRS2,CHARGETO,RONO,SALESMAN,SMNAME,TERMS,TTLINVAMT,DS1,DS_DESC1,DS_AMT1,NETINVAMT,NETCOST,STATUS,NETINVAMT2,NETCOST2,LISTED,USERCODE,LASTUPDATE,TOTINVAMT,DISCOUNT,VAT,NETINVOICE,TOTALCOST)" & _
                " values (" & varOHTRANTYPE & ", " & varOHTRANNO & ", " & varOHTRANDATE & ", " & varOHCANCDATE & ", " & varOHCUSTCODE & ", " & varOHCUSTNAME & ", " & varOHCUSTADDRS1 & ", " & varOHCUSTADDRS2 & ", " & varOHCHARGETO & ", " & varOHRONO & ", " & varOHSALESMAN & ", " & varOHSMNAME & ", " & varOHTERMS & ", " & varOHTTLINVAMT & ", " & varOHDS1 & ", " & varOHDS_DESC1 & ", " & varOHDS_AMT1 & ", " & varOHNETINVAMT & ", " & varOHNETCOST & ", " & varOHSTATUS & ", " & varOHNETINVAMT2 & ", " & varOHNETCOST2 & ", " & varOHLISTED & ", " & varOHUSERCODE & ", " & varOHLASTUPDATE & ", " & varOHTOTINVAMT & ", " & varOHDISCOUNT & ", " & varOHVAT & ", " & varOHNETINVOICE & ", " & varOHTOTALCOST & ")"
      gconOldPMIS.Execute MoveSql
      i = i + 1
...
Dim varOHCUSTCODE As String
Dim varOHCUSTNAME As String
Dim varOHCUSTNAME1 As String
Dim varOHCUSTNAME2 As String
Dim varOHCHARGETO As String
Dim varOHRONO As String
Dim varOHSALESMAN As String
Dim varOHSMNAME As String
...
'gconOldPMIS.Execute "delete * from ord_hist"
Set rsOldOrd_HDHist = New ADODB.Recordset
    rsOldOrd_HDHist.Open "select * from ord_hist where month(trandate) = 8 and year(trandate) = 2003 order by id asc", gconPMIOS
If Not rsOldOrd_HDHist.EOF And Not rsOldOrd_HDHist.BOF Then
   ...
   Do While Not rsOldOrd_HDHist.EOF
      ...
      varOHCUSTNAME = N2Str2Null(Trim(Left(rsOldOrd_HDHist!custname, 40)))
      varOHCUSTNAME1 = N2Str2Null(Trim(Mid(rsOldOrd_HDHist!custname, 41, 40)))
      varOHCUSTNAME2 = N2Str2Null(Trim(Mid(rsOldOrd_HDHist!custname, 81, 40)))
      ...
      MoveSql = "INSERT INTO ORD_HIST " & _
                "(TRANTYPE,TRANNO,TRANDATE,CANCDATE,CUSTCODE,CUSTNAME,CUSTADRS1,CUSTADRS2,CHARGETO,RONO,SALESMAN,SMNAME,TERMS,TTLINVAMT,DS1,DS_DESC1,DS_AMT1,NETINVAMT,NETCOST,STATUS,NETINVAMT2,NETCOST2,LISTED,USERCODE,LASTUPDATE,TOTINVAMT,DISCOUNT,VAT,NETINVOICE,TOTALCOST)" & _
                " values (" & varOHTRANTYPE & ", " & varOHTRANNO & ", " & varOHTRANDATE & ", " & varOHCANCDATE & ", " & varOHCUSTCODE & ", " & varOHCUSTNAME & ", " & varOHCUSTNAME1 & ", " & varOHCUSTNAME2 & ", " & varOHCHARGETO & ", " & varOHRONO & ", " & varOHSALESMAN & ", " & varOHSMNAME & ", " & varOHTERMS & ", " & varOHTTLINVAMT & ", " & varOHDS1 & ", " & varOHDS_DESC1 & ", " & varOHDS_AMT1 & ", " & varOHNETINVAMT & ", " & varOHNETCOST & ", " & varOHSTATUS & ", " & varOHNETINVAMT2 & ", " & varOHNETCOST2 & ", " & varOHLISTED & ", " & varOHUSERCODE & ", " & varOHLASTUPDATE & ", " & varOHTOTINVAMT & ", " & varOHDISCOUNT & ", " & varOHVAT & ", " & varOHNETINVOICE & ", " & varOHTOTALCOST & ")"
      gconOldPMIS.Execute MoveSql
      i = i + 1
...
gconOldPMIS.Execute "delete * from rr_hd"
Set rsOldRR_HD = New ADODB.Recordset
    rsOldRR_HD.Open "select * from rr_hd order by id asc", gconPMIOS
If Not rsOldRR_HD.EOF And Not rsOldRR_HD.BOF Then
   ...
   Do While Not rsOldRR_HD.EOF
      ...
      varRRADDRESS = N2Str2Null(Trim(Left(rsOldRR_HD!Address, 40)))
      varRRADDRESS2 = N2Str2Null(Trim(Mid(rsOldRR_HD!Address, 41, 40)))
      ...
      MoveSql = "INSERT INTO RR_HD " & _
                "(RRNO,RRDATE,CANCDATE,PONO,PODATE,RECVD_CODE,RECVD_FROM,ADDRESS1,ADDRESS2,DRNO,INVNO,CLASSCODE,TERMS,TTLRRAMT,DS1,DS_DESC1,DS_AMT1,NETRRAMT,STATUS,LISTED,USERCODE,LASTUPDATE,REMARKS)" & _
                " values (" & varRRRRNO & ", " & varRRRRDATE & ", " & varRRCANCDATE & ", " & varRRPONO & ", " & varRRPODATE & ", " & varRRRECVD_CODE & ", " & varRRRECVD_FROM & ", " & varRRADDRESS & ", " & varRRADDRESS2 & ", " & varRRDRNO & ", " & varRRINVNO & ", " & varRRCLASSCODE & ", " & varRRTERMS & ", " & varRRTTLRRAMT & ", " & varRRDS1 & ", " & varRRDS_DESC1 & ", " & varRRDS_AMT1 & ", " & varRRNETRRAMT & ", " & varRRSTATUS & ", " & varRRLISTED & ", " & varRRUSERCODE & ", " & varRRLASTUPDATE & ", " & varRRREMARKS & ")"
      gconOldPMIS.Execute MoveSql
      i = i + 1
...
'gconOldPMIS.Execute "delete * from rec_hist"
Set rsOldRR_HDHist = New ADODB.Recordset
    rsOldRR_HDHist.Open "select * from rec_hist where month(rrdate) = 8 and year(rrdate) = 2003 order by id asc", gconPMIOS
If Not rsOldRR_HDHist.EOF And Not rsOldRR_HDHist.BOF Then
   ...
   Do While Not rsOldRR_HDHist.EOF
      ...
      varRRRECVD_CODE = N2Str2Null(Left(rsOldRR_HDHist!recvd_code, 5))
      varRRRECVD_FROM = N2Str2Null(Trim(rsOldRR_HDHist!recvd_from))
      varRRADDRESS = N2Str2Null(Trim(Left(rsOldRR_HDHist!Address, 40)))
      varRRADDRESS2 = N2Str2Null(Trim(Mid(rsOldRR_HDHist!Address, 41, 40)))
...
gconOldPMIS.Execute "delete * from po_hd"
Set rsOldPO_HD = New ADODB.Recordset
    rsOldPO_HD.Open "select * from po_hd order by id asc", gconPMIOS
If Not rsOldPO_HD.EOF And Not rsOldPO_HD.BOF Then
   ...
   Do While Not rsOldPO_HD.EOF
      ...
      varPOSUP_ADDRS = N2Str2Null(Trim(Left(rsOldPO_HD!sup_addrs, 40)))
      varPOSUP_ADDRS2 = N2Str2Null(Trim(Mid(rsOldPO_HD!sup_addrs, 41, 40)))
      varPODEALERCODE = N2Str2Null(rsOldPO_HD!dealercode)
      varPOSHIPTO = N2Str2Null(Trim(rsOldPO_HD!Shipto))
      varPOSHP_ADDRS = N2Str2Null(Trim(Left(rsOldPO_HD!shp_addrs, 40)))
      varPOSHP_ADDRS2 = N2Str2Null(Trim(Mid(rsOldPO_HD!shp_addrs, 41, 40)))
      ...
      MoveSql = "INSERT INTO PO_HD " & _
                "(PONO,PODATE,ORDERTYPE,DON,SUPCODE,SUPNAME,SUP_ADDRS1,SUP_ADDRS2,DEALERCODE,SHIPTO,SHP_ADDRS1,SHP_ADDRS2,PO_AMOUNT,DS1,DS_DESC1,DS_AMT1,NETPOAMT,STATUS,LISTED,USERCODE,LASTUPDATE)" & _
                " values (" & varPOPONO & ", " & varPOPODATE & ", " & varPOORDERTYPE & ", " & varPODON & ", " & varPOSUPCODE & ", " & varPOSUPNAME & ", " & varPOSUP_ADDRS & ", " & varPOSUP_ADDRS2 & ", " & varPODEALERCODE & ", " & varPOSHIPTO & ", " & varPOSHP_ADDRS & ", " & varPOSHP_ADDRS2 & ", " & varPOPO_AMOUNT & ", " & varPODS1 & ", " & varPODS_DESC1 & ", " & varPODS_AMT1 & ", " & varPONETPOAMT & ", " & varPOSTATUS & ", " & varPOLISTED & ", " & varPOUSERCODE & ", " & varPOLASTUPDATE & ")"
...
'gconOldPMIS.Execute "delete * from po_hist"
Set rsOldPO_HDHist = New ADODB.Recordset
    rsOldPO_HDHist.Open "select * from po_hist where month(podate) = 8 and year(podate) = 2003 order by id asc", gconPMIOS
If Not rsOldPO_HDHist.EOF And Not rsOldPO_HDHist.BOF Then
   ...
   Do While Not rsOldPO_HDHist.EOF
      ...
      varPOSUPCODE = N2Str2Null(Left(rsOldPO_HDHist!SupCode, 5))
      varPOSUPNAME = N2Str2Null(Trim(rsOldPO_HDHist!supname))
      varPOSUP_ADDRS = N2Str2Null(Trim(Left(rsOldPO_HDHist!sup_addrs, 40)))
      varPOSUP_ADDRS2 = N2Str2Null(Trim(Mid(rsOldPO_HDHist!sup_addrs, 41, 40)))
      varPODEALERCODE = N2Str2Null(rsOldPO_HDHist!dealercode)
      varPOSHIPTO = N2Str2Null(Trim(rsOldPO_HDHist!Shipto))
      varPOSHP_ADDRS = N2Str2Null(Trim(Left(rsOldPO_HDHist!shp_addrs, 40)))
      varPOSHP_ADDRS2 = N2Str2Null(Trim(Mid(rsOldPO_HDHist!shp_addrs, 41, 40)))
...
gconOldPMIS.Execute "delete * from partmas"
Set rsOldPartmas = New ADODB.Recordset
    rsOldPartmas.Open "select * from partmas order by partno asc", gconPMIOS
   ...
   Do While Not rsOldPartmas.EOF
      ...
      If varPmasPARTNO <> "NULL" Then
         MoveSql = "INSERT INTO partmas " & _
                   ...
                   " " & varPmasSUPCODE & "," & varPmasVARIANCE & "," & varPmasSUBINVCLASS & "," & varPmasPHYCOUNT & "," & varPmasADJPHYCOUNT & "," & varPmasCUTOFFQTY & "," & varPmasCUTOFFMAC & "," & varPmasRECEIPTS & "," & varPmasISSUANCES & "," & varPmasUSERCODE & "," & varPmasLASTUPDATE & "," & varPmasDNP & "," & varPmasVALID_ICC & ")"
         On Error GoTo ErrorCode
         gconOldPMIS.Execute MoveSql
      End If
      i = i + 1
...
gconOldPMIS.Execute "delete * from shipping"
Set rsOldShipping = New ADODB.Recordset
    rsOldShipping.Open "Select * from Shipping order by partno asc", gconPMIOS
...
Dim varSupSup_addrs2 As String
...
gconOldPMIS.Execute "delete * from supplier"
Set rsOldSupplier = New ADODB.Recordset
    rsOldSupplier.Open "select * from Supplier order by supcode asc", gconPMIOS
If Not rsOldSupplier.EOF And Not rsOldSupplier.BOF Then
   ...
   Do While Not rsOldSupplier.EOF
      ...
      varSupSup_addrs = N2Str2Null(Trim(Left(rsOldSupplier!sup_addrs, 40)))
      varSupSup_addrs2 = N2Str2Null(Trim(Mid(rsOldSupplier!sup_addrs, 41, 40)))
      ...
      MoveSql = "INSERT INTO Supplier " & _
                "(supcode,supname,sup_addrs1,sup_addrs2,phoneno,contact,disc_surch,vat,vat_percnt,lastupdate,usercode)" & _
                " values (" & varSupSupCode & ", " & varSupSupName & ", " & varSupSup_addrs & ", " & varSupSup_addrs2 & ", " & varSupPhoneNo & ", " & varSupContact & ", " & varSupDisc_Surch & ", " & varSupVat & ", " & varSupVat_Percnt & ", " & varSupLastUpdate & ", " & varSupUserCode & ")"
      gconOldPMIS.Execute MoveSql
      i = i + 1
...
Dim varCustCustaddrs2 As String
...
gconOldPMIS.Execute "delete * from customer"
Set rsOldCustomer = New ADODB.Recordset
    rsOldCustomer.Open "select * from Customer order by custcode asc", gconPMIOS
If Not rsOldCustomer.EOF And Not rsOldCustomer.BOF Then
   ...
   Do While Not rsOldCustomer.EOF
      ...
      varCustCustaddrs = N2Str2Null(Trim(Left(rsOldCustomer!custadrs, 40)))
      varCustCustaddrs2 = N2Str2Null(Trim(Mid(rsOldCustomer!custadrs, 41, 40)))
      ...
      MoveSql = "INSERT INTO Customer " & _
                "(custcode,custname,custadrs1,custadrs2,phoneno,cr_amount,cr_limit,disc_surch,partsprice,lastupdate,usercode)" & _
                " values (" & varCustCustCode & ", " & varCustCustName & ", " & varCustCustaddrs & ", " & varCustCustaddrs2 & ", " & varCustPhoneNo & ", " & varCustCR_Amount & ", " & varCustCR_Limit & ", " & varCustDisc_Surch & ", " & varCustPartsPrice & ", " & varCustLastUpdate & ", " & varCustUserCode & ")"
      gconOldPMIS.Execute MoveSql
      i = i + 1
...
gconOldPMIS.Execute "delete * from [counter]"
Set rsOldCunter = New ADODB.Recordset
    rsOldCunter.Open "select * from Cunter order by modul asc", gconPMIOS
If Not rsOldCunter.EOF And Not rsOldCunter.BOF Then
   ...
   Do While Not rsOldCunter.EOF
      varCuntModul = N2Str2Null(rsOldCunter!modul)
      varCuntNextNumber = N2Str2IntZero(rsOldCunter!nextnumber)
      varCuntLastUpdate = N2Str2Null(rsOldCunter!lastupdate)
      varCuntUserCode = N2Str2Null(Left(rsOldCunter!usercode, 3))
      
      MoveSql = "INSERT INTO [Counter] " & _
                "([module],nextnumber,lastupdate,usercode)" & _
...
gconOldPMIS.Execute "delete * from salesman"
Set rsOldSalesman = New ADODB.Recordset
    rsOldSalesman.Open "select * from salesman order by empno asc", gconPMIOS
If Not rsOldSalesman.EOF And Not rsOldSalesman.BOF Then
   ...
   Do While Not rsOldSalesman.EOF
      ...
      varSMPosition = N2Str2Null(rsOldSalesman!Positions)
      ...
      MoveSql = "INSERT INTO salesman " & _
                "(empno,lastname,firstname,middleint,fullname,signname,[position],lastupdate,usercode)" & _
...
gconOldPMIS.Execute "delete * from cusctl"
Set rsOldCustCtl = New ADODB.Recordset
    rsOldCustCtl.Open "select * from CusCtl order by ctlcde asc", gconPMIOS
