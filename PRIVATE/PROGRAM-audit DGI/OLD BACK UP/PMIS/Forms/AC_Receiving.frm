...
Begin VB.Form frmPMISTrans_Receiving2_AC 
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton Command1 
         Height          =   825
         Left            =   3090
         MouseIcon       =   "AC_Receiving.frx":4A8E
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":4BE0
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      Begin VB.Frame fraUpdateMaster 
         ...
         Begin VB.CommandButton cmdOKUpdate 
            ...
            Height          =   555
            Left            =   3675
            MouseIcon       =   "AC_Receiving.frx":5449
            MousePointer    =   99  'Custom
            Picture         =   "AC_Receiving.frx":559B
            Style           =   1  'Graphical
            TabIndex        =   93
            Top             =   1380
            Width           =   555
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   6660
         MouseIcon       =   "AC_Receiving.frx":5836
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":5988
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   5940
         MouseIcon       =   "AC_Receiving.frx":5CB3
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":5E05
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   5220
         MouseIcon       =   "AC_Receiving.frx":6143
         MousePointer    =   99  'Custom
         Picture         =   "AC_Receiving.frx":6295
         Style           =   1  'Graphical
         TabIndex        =   73
...
'-----------------------------------------------------------------------------------------------------------
    ...
    End If
        ...
        gconDMIS.Execute ("Update pmis_stockmas set srp = '" & NumericVal(txtNewSRP.Text) & "' where stockno = '" & LTrim(RTrim(cboTranPartNo)) & "' and [type] = 'A'")
...
'        End If
    ...
    If AddorEdit = "ADD" Then
        If checkdup_INVO("A", txtINVNo.Text) = True Then
