...
Sub FillGrid()
    ...
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select pono,pono from PMIS_PO_HD WHERE [TYPE] = 'A' order by pono asc")
    ...
    If MsgQuestionBox("Are you sure you want to Post this Transactions?", "Post Transactions") = True Then
        ...
        If Not rsPMIS_Tdaytran.EOF And Not rsPMIS_Tdaytran.BOF Then
            ...
            Do While Not rsPMIS_Tdaytran.EOF
                ...
                If Not rsPMIS_Accessories.EOF And Not rsPMIS_Accessories.EOF Then
                    SQL_STATEMENT = "update PMIS_Accessories set " & _
...
Private Sub cmdTranSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        rsPMIS_TdaytranClone.Open "select trantype,tranno,itemno,STOCK_ORD from PMIS_Tdaytran where [TYPE] = 'A' AND STOCK_ORD = '" & UCase(cboTranPartNo.Text) & "' and trantype = 'PO' and tranno =" & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
