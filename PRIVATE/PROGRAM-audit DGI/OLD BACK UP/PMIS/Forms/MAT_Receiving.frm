...
'---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If cboClasscode.ListIndex = 1 Then
        If cboTerms.Text = 0 Then
            ...
            Exit Sub
        End If
    End If    'VALIDATION FOR TRANSACTION CODE
...
'-----------------------------------------------------------------------------------------------------------
    ...
    End If
            ...
            gconDMIS.Execute ("Update pmis_stockmas set srp = '" & NumericVal(txtNewSRP.Text) & "' where stockno = '" & LTrim(RTrim(cboTranPartNo)) & "' and [type] = 'M'")
