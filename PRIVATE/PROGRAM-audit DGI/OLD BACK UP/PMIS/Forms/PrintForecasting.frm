...
Begin VB.Form frmPMISReports_PrintForeCasting 
   ...
   Begin SHDocVwCtl.WebBrowser browRank 
      ...
      Location        =   $"PrintForecasting.frx":0E42
   End
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   795
      Left            =   2040
      MouseIcon       =   "PrintForecasting.frx":0ED7
      MousePointer    =   99  'Custom
      Picture         =   "PrintForecasting.frx":1029
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   795
      Left            =   1320
      MouseIcon       =   "PrintForecasting.frx":1474
      MousePointer    =   99  'Custom
      Picture         =   "PrintForecasting.frx":15C6
      Style           =   1  'Graphical
      TabIndex        =   9
