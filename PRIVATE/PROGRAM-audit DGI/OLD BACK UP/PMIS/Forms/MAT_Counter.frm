...
Begin VB.Form frmPMISMAT_Counter 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   5160
         MouseIcon       =   "MAT_Counter.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4440
         MouseIcon       =   "MAT_Counter.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3720
         MouseIcon       =   "MAT_Counter.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   3000
         MouseIcon       =   "MAT_Counter.frx":16B7
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":1809
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2280
         MouseIcon       =   "MAT_Counter.frx":1B65
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":1CB7
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "MAT_Counter.frx":1FCA
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":211C
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Counter.frx":2416
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":2568
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   120
         MouseIcon       =   "MAT_Counter.frx":28C0
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":2A12
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "MAT_Counter.frx":2D71
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":2EC3
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "MAT_Counter.frx":3201
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Counter.frx":3353
         Style           =   1  'Graphical
         TabIndex        =   25
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstCounter 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "MAT_Counter.frx":36A3
         NumItems        =   3
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_Counter"
...
Sub rsRefresh()
    ...
    rsCunter.Open "select * from PMIS_Counter WHERE [TYPE] = 'M' order by id asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub FillGrid()
    ...
    Set rsCounter = gconDMIS.Execute("select Modul,Description,ID from PMIS_Counter WHERE [TYPE] = 'M' order by Modul asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsCounter = gconDMIS.Execute("select Modul,Description, ID from PMIS_Counter where [TYPE] = 'M' AND Modul like'" & XXX & "%'")
    If Not (rsCounter.EOF And rsCounter.BOF) Then
        lstCounter.Enabled = True: Listview_Loadval Me.lstCounter.ListItems, rsCounter: lstCounter.Refresh
    Else
        lstCounter.Enabled = False
...
Private Sub cmdAdd_Click()
    If Function_Access(LOGID, "Acess_Add", "MATERIALS COUNTER") = False Then Exit Sub
    AddorEdit = "ADD"
    Frame1.Enabled = True
...
Private Sub cmdEdit_Click()
    If Function_Access(LOGID, "Acess_Edit", "MATERIALS COUNTER") = False Then Exit Sub
    AddorEdit = "EDIT"
    Frame1.Enabled = True
    Picture1.Visible = False
    Picture2.Visible = True
...
Private Sub cmdDelete_Click()
    If Function_Access(LOGID, "Acess_Delete", "MATERIALS COUNTER") = False Then Exit Sub
    ...
    If Not rsCunter.BOF Or Not rsCunter.EOF Then
        If ShowConfirmDelete = True Then
            ...
            Call NEW_LogAudit("X", "MATERIALS COUNTER", SQL_STATEMENT, labid, "", "MODULE: " & txtModule, "", "")
...
Private Sub cmdPrint_Click()
    If Function_Access(LOGID, "Acess_Print", "MATERIALS COUNTER") = False Then Exit Sub
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            ...
            rsfindDup.Open "select modul from PMIS_Counter where [TYPE] = 'M' AND Modul = '" & txtModule.Text & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    ...
    If AddorEdit = "ADD" Then
        SQL_STATEMENT = "Insert into PMIS_Counter" & _
                       ...
                       " values ('M'," & VTXTModule & "," & vtxtDescription & ", " & VTXTNextNumber & ", " & "'" & LOGDATE & "'" & ", " & _
                       " " & "" & N2Str2Null(LOGCODE) & "" & ")"
                       
        gconDMIS.Execute SQL_STATEMENT
        Call NEW_LogAudit("A", "MATERIALS COUNTER", SQL_STATEMENT, FindTransactionID(N2Str2Null(txtModule), "MODUL", "PMIS_Counter", "DETAILS", N2Str2Null("M"), "TYPE"), "", "MODULE: " & VTXTModule, "", "")
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        Call NEW_LogAudit("E", "MATERIALS COUNTER", SQL_STATEMENT, labid, "", "MODULE: " & VTXTModule, "", "")
    ...
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            If Picture1.Visible = True Then
                ...
                frmALL_AuditInquiry.Caption = "Audit Inquiry (MATERIALS COUNTER)"
                Call frmALL_AuditInquiry.DisplayHistory(labid, "MATERIALS COUNTER")
            End If
    End Select
End Sub
...
Private Sub lstCounter_GotFocus()
    ...
    'rsCunter.MoveFirst
    'rsCunter.Find "ID = " & lstCounter.SelectedItem.SubItems(2) & ""
