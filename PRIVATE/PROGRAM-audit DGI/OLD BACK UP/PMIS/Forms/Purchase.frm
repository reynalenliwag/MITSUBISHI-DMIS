...
Begin VB.Form frmPMISTrans_Purchase 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8580
         MouseIcon       =   "Purchase.frx":0B7E
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":0CD0
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "Purchase.frx":1036
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":1188
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Purchase.frx":14EE
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":1640
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Purchase.frx":197A
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":1ACC
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Purchase.frx":1E11
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":1F63
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "Purchase.frx":2288
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":23DA
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "Purchase.frx":2736
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":2888
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "Purchase.frx":2B9B
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":2CED
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "Purchase.frx":303D
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":318F
         Style           =   1  'Graphical
         TabIndex        =   73
         ToolTipText     =   "Move to First Record"
         Top             =   0
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "Purchase.frx":34ED
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":363F
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "Purchase.frx":3939
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":3A8B
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "Purchase.frx":3DE3
         MousePointer    =   99  'Custom
         Picture         =   "Purchase.frx":3F35
         Style           =   1  'Graphical
         TabIndex        =   81
