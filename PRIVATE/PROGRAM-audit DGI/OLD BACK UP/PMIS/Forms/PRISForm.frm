...
Begin VB.Form frmPMISTrans_PrisForms 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "PRISForm.frx":7796
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":78E8
         Style           =   1  'Graphical
         TabIndex        =   84
         Top             =   2490
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1470
         MouseIcon       =   "PRISForm.frx":7C26
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":7D78
         Style           =   1  'Graphical
         TabIndex        =   85
         Top             =   2490
         Width           =   705
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "PRISForm.frx":80C8
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":821A
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   1575
         Width           =   855
