...
Begin VB.Form frmPMISAC_CreateDNPPDATA 
   ...
   ClientWidth     =   4185
   ForeColor       =   &H8000000F&
   Icon            =   "AC_CreateNewDNPPData.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "AC_CreateNewDNPPData.frx":1472
   ScaleHeight     =   720
   ScaleWidth      =   4185
   ...
   End
End
Attribute VB_Name = "frmPMISAC_CreateDNPPDATA"
