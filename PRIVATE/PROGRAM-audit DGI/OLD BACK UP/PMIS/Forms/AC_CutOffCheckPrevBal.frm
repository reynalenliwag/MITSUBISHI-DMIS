...
Begin VB.Form frmPMISAC_CutOffCheckPrevBal 
   ...
   FillColor       =   &H8000000D&
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AC_CutOffCheckPrevBal.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   5010
      MouseIcon       =   "AC_CutOffCheckPrevBal.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "AC_CutOffCheckPrevBal.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   13
   ...
   Begin VB.CommandButton cmdCheck 
      ...
      Height          =   795
      Left            =   4290
      MouseIcon       =   "AC_CutOffCheckPrevBal.frx":07C2
      MousePointer    =   99  'Custom
      Picture         =   "AC_CutOffCheckPrevBal.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.PictureBox picCPB 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin wizButton.cmd cmd1 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "AC_CutOffCheckPrevBal.frx":0BAF
         End
      End
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   9869
         _ExtentY        =   556
         Picture         =   "AC_CutOffCheckPrevBal.frx":0BCB
         ForeColor       =   255
         Appearance      =   2
         BorderStyle     =   2
         BarPicture      =   "AC_CutOffCheckPrevBal.frx":0BE7
         ShowText        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmPMISAC_CutOffCheckPrevBal"
