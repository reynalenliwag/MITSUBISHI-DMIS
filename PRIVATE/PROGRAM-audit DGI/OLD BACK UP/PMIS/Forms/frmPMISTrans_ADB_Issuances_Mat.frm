...
Begin VB.Form frmPMISTrans_ADB_Issuances_Mat 
   ...
   ClientWidth     =   11505
   ForeColor       =   &H00DEDFDE&
   Icon            =   "frmPMISTrans_ADB_Issuances_Mat.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":0D47
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":0E99
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.ComboBox cboTranPartNo 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmPMISTrans_ADB_Issuances_Mat.frx":11D7
         Left            =   1440
         List            =   "frmPMISTrans_ADB_Issuances_Mat.frx":11D9
         Sorted          =   -1  'True
         TabIndex        =   17
         Text            =   "Combo1"
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":11DB
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":132D
         Style           =   1  'Graphical
         TabIndex        =   81
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":167D
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7980
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":17DF
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":1931
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7200
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":1C97
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":1DE9
         Style           =   1  'Graphical
         TabIndex        =   91
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6420
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":214F
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":22A1
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5640
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":25DB
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":272D
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":2A52
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":2BA4
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4080
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":2F00
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":3052
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3300
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":3365
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":34B7
         Style           =   1  'Graphical
         TabIndex        =   89
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2520
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":3807
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":3959
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1740
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":3CB7
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":3E09
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   960
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":4103
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":4255
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":45AD
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":46FF
         Style           =   1  'Graphical
         TabIndex        =   96
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   990
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":4A5E
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":4BB0
         Style           =   1  'Graphical
         TabIndex        =   85
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   210
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":4EEE
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":5040
         Style           =   1  'Graphical
         TabIndex        =   86
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3000
         MouseIcon       =   "frmPMISTrans_ADB_Issuances_Mat.frx":5390
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":54E2
         Style           =   1  'Graphical
         TabIndex        =   83
         Top             =   1560
         Width           =   855
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "frmPMISTrans_ADB_Issuances_Mat.frx":5848
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   59
         Top             =   -540
   ...
   End
End
Attribute VB_Name = "frmPMISTrans_ADB_Issuances_Mat"
...
Private Sub cboRefPRSNo_GotFocus()
    ...
    If Not rsPRS.EOF And Not rsPRS.BOF Then
        ...
        Do While Not rsPRS.EOF
            ...
            rsPRS_HDDup.Open "SELECT REFPISNO FROM PMIS_ORD_HD WHERE TRANTYPE <> 'PRS' AND [TYPE] = 'M' AND REFPRSNO = '" & Null2String(rsPRS!REFPISNO) & "'", gconDMIS
    ...
    If ADDOREDIT = "ADD" Then
        ...
        Else
            ...
            If (rsRR_HDDup.EOF Or rsRR_HDDup.BOF) Then
                MsgSpeechBox "Invalid Materials Requisition Number!"
            End If
        End If
    End If
End Sub
    ...
    If MsgQuestionBox("Are you sure you want to Cancel this Transaction?", "Cancel Transaction") = True Then
        ...
        If Not rsTdaytranDup.EOF And Not rsTdaytranDup.BOF Then
            ...
            Do While Not rsTdaytranDup.EOF
                ...
                rsPartmasDup.Open "SELECT STOCKNO,ONHAND,TISSQTY,TISSQTY,ISSUANCES,REQSERVED,S_REQSERVED FROM PMIS_STOCKMAS WHERE TYPE='M' AND STOCKNO = " & N2Str2Null(rsTdaytranDup!STOCK_ORD) & " AND ACTIVE = 'Y'", gconDMIS
                If Not rsPartmasDup.EOF And Not rsPartmasDup.BOF Then
                    ...
                    If Null2String(RSORD_HD!STATUS) = "P" Then
                        If Null2String(RSORD_HD!SALES_ORIGIN) = "W" Then
                            ...
                            'NEW LOG AUDIT-------------------------------------------------
                            Call NEW_LogAudit("E", "MATERIALS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "CSMS_MATMAS"), "", "PART NO: " & Null2String(N2Str2Null(rsTdaytranDup!STOCK_ORD)), COUNTERTYPE, "")
                            'NEW LOG AUDIT-------------------------------------------------
                        Else
                            SQL_STATEMENT = "UPDATE PMIS_STOCKMAS SET" & _
                        ...
                        gconDMIS.Execute SQL_STATEMENT
                        'NEW LOG AUDIT-------------------------------------------------
                        Call NEW_LogAudit("E", "MATERIALS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "CSMS_MATMAS"), "", "PART NO: " & Null2String(N2Str2Null(rsTdaytranDup!STOCK_ORD)), "", "")
                        'NEW LOG AUDIT-------------------------------------------------
                    End If
        ...
        Do While Not rsTdaytranDup.EOF
            ...
            If Not rsPartmasDup.EOF And Not rsPartmasDup.BOF Then
                ...
                If Null2String(RSORD_HD!SALES_ORIGIN) = "W" Then
                    ...
                    gconDMIS.Execute SQL_STATEMENT
                    '===================================================================
                    NEW_LogAudit "E", "PARTS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "CSMS_MATMAS"), "", "TRAN NO: " & txtTranNo, COUNTERTYPE, ""
                    '===================================================================
                Else
                    SQL_STATEMENT = "UPDATE PMIS_STOCKMAS SET" & _
                                  " S_REQSERVED = " & N2Str2IntZero(rsPartmasDup!S_REQSERVED) + N2Str2Zero(rsTdaytranDup!TRANQTY) & _
...
Private Sub cmdSave_Click()
    ...
    If ADDOREDIT = "ADD" Then
        ...
        Else
            SQL_STATEMENT = "UPDATE PMIS_COUNTER SET NEXTNUMBER = '" & NEXTCUNTER & "', LASTUPDATE = '" & LOGDATE & "', USERCODE = '" & "USER" & "' WHERE [TYPE] = 'M' AND MODUL = " & VTXTTRANTYPE
            gconDMIS.Execute SQL_STATEMENT
        End If
...
Sub X_FillSearchGrid(xxx As String)
    ...
    If optTranno.Value = True Then
        Set RSORD_HD = gconDMIS.Execute("SELECT TRANNO, ID FROM PMIS_ORD_HD WHERE [TYPE] = 'M' AND TRANTYPE = '" & COUNTERTYPE & "' AND TRANNO LIKE '" & xxx & "%' AND STATUS2='R'")
    ElseIf optRONo.Value = True Then
        Set RSORD_HD = gconDMIS.Execute("SELECT RONO, ID FROM PMIS_ORD_HD WHERE [TYPE] = 'M' AND TRANTYPE = '" & COUNTERTYPE & "' AND RONO LIKE '" & xxx & "%' AND STATUS2='R'  ORDER BY TRANNO ASC")
    Else
        Set RSORD_HD = gconDMIS.Execute("SELECT CUSTNAME, ID  FROM PMIS_ORD_HD WHERE [TYPE] = 'M' AND TRANTYPE = '" & COUNTERTYPE & "' AND CUSTNAME  LIKE '" & xxx & "%' AND STATUS2='R'  ORDER BY CUSTNAME")
    End If
...
Private Sub Command3_Click()
    ...
    On Error GoTo Errorcode
    Set RSTMP = gconDMIS.Execute("SELECT COUNT(*) AS BILANG FROM PMIS_vw_ISS_HISTORY WHERE (TRANTYPE = 'RIV')  AND LEFT(TRANNO,1) = 'M' AND [TYPE] = 'M'")
                                ...
                                If COUNTERTYPE <> "ADB" Then
                                    ...
                                    If Null2String(RSORD_HD!SALES_ORIGIN) = "W" Then
                                        SQL_STATEMENT = "UPDATE PMIS_STOCKMAS SET" & _
                                                      ...
                                                      " WHERE TYPE='M' AND STOCKNO = " & N2Str2Null(rsTdaytranDup!STOCK_ORD)
                                        gconDMIS.Execute SQL_STATEMENT
                                        Call NEW_LogAudit("E", "PARTS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "CSMS_MATMAS"), "P", "TRAN NO : " & Null2String(RSORD_HD!TranType) & " - UNPOST", COUNTERTYPE, "")
                                    Else
                                        SQL_STATEMENT = "UPDATE PMIS_STOCKMAS SET" & _
                                                      " S_REQSERVED = " & N2Str2IntZero(rsPartmasDup!S_REQSERVED) - N2Str2Zero(rsTdaytranDup!TRANQTY) & _
                                                      " WHERE TYPE='M' AND STOCKNO = " & N2Str2Null(rsTdaytranDup!STOCK_ORD)
...
Sub rsRefresh()
    Set RSORD_HD = New ADODB.Recordset
    RSORD_HD.Open "SELECT * FROM PMIS_ORD_HD WHERE [TYPE] = 'M' AND TRANTYPE = 'RIV' AND STATUS2='R' ORDER BY TRANNO ASC", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Sub SetPartDetails(xxx As String)
    ...
    Set RSPARTMAS = gconDMIS.Execute("SELECT * FROM PMIS_STOCKMAS WHERE TYPE = 'M' AND STOCKNO = '" & xxx & "' AND ACTIVE = 'Y'")
    TXT_ADB_ISSUE = 0
    TXT_ADB_FILL = 0
    TXT_AVL_ISSUE = 0
    TXT_CURRONHAND = 0
