...
Begin VB.Form frmPMISAC_CheckDupTrans 
   ...
   FillColor       =   &H0049B049&
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AC_CheckDupTrans.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   4965
      MouseIcon       =   "AC_CheckDupTrans.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "AC_CheckDupTrans.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   750
      Width           =   705
   ...
   Begin VB.CommandButton cmdCheck 
      ...
      Height          =   795
      Left            =   4230
      MouseIcon       =   "AC_CheckDupTrans.frx":07C2
      MousePointer    =   99  'Custom
      Picture         =   "AC_CheckDupTrans.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   750
      Width           =   705
   ...
   Begin VB.PictureBox picCPB 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin wizButton.cmd cmd1 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "AC_CheckDupTrans.frx":0BAF
         End
      End
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   9975
         _ExtentY        =   556
         Picture         =   "AC_CheckDupTrans.frx":0BCB
         ForeColor       =   255
         Appearance      =   2
         BorderStyle     =   2
         BarPicture      =   "AC_CheckDupTrans.frx":0BE7
         ShowText        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmPMISAC_CheckDupTrans"
