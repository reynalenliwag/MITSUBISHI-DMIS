...
Begin VB.Form frmPMISTrans_DealerPartInquiry 
   ...
   Begin MSFlexGridLib.MSFlexGrid Grid1 
      ...
      Appearance      =   0
      MousePointer    =   99
      FormatString    =   $"InquiryDealerPart.frx":0A2C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "InquiryDealerPart.frx":0AF8
   End
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   6900
         MouseIcon       =   "InquiryDealerPart.frx":0E12
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":0F64
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   6180
         MouseIcon       =   "InquiryDealerPart.frx":12CA
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":141C
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "InquiryDealerPart.frx":1782
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":18D4
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   4740
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "InquiryDealerPart.frx":1C0E
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":1D60
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   4020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "InquiryDealerPart.frx":2085
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":21D7
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   3300
         MouseIcon       =   "InquiryDealerPart.frx":251C
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":266E
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2580
         MouseIcon       =   "InquiryDealerPart.frx":29CA
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":2B1C
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1860
         MouseIcon       =   "InquiryDealerPart.frx":2E2F
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":2F81
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1140
         MouseIcon       =   "InquiryDealerPart.frx":327B
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":33CD
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   420
         MouseIcon       =   "InquiryDealerPart.frx":3725
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":3877
         Style           =   1  'Graphical
         TabIndex        =   74
   ...
   Begin VB.PictureBox picSaves 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "InquiryDealerPart.frx":3BD6
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":3D28
         Style           =   1  'Graphical
         TabIndex        =   85
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "InquiryDealerPart.frx":4066
         MousePointer    =   99  'Custom
         Picture         =   "InquiryDealerPart.frx":41B8
         Style           =   1  'Graphical
         TabIndex        =   86
