...
Begin VB.Form frmPMISTrans_CustomerOrder 
   ...
   Begin VB.PictureBox PICLoyaltyID 
      ...
      Begin VB.CommandButton CmdloyaltyCancel 
         ...
         Height          =   795
         Left            =   2700
         MouseIcon       =   "CustomerOrder.frx":8584
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":86D6
         Style           =   1  'Graphical
         TabIndex        =   152
         ToolTipText     =   "Cancel"
         Top             =   840
      ...
      Begin VB.CommandButton CmdloyaltySave 
         ...
         Height          =   795
         Left            =   2010
         MouseIcon       =   "CustomerOrder.frx":8A14
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":8B66
         Style           =   1  'Graphical
         TabIndex        =   153
         ToolTipText     =   "Save this Record"
         Top             =   840
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                ...
                If COUNTERTYPE <> "ADB" Then
                    ...
                    If COMPANY_CODE = "HLU" Then
                        ...
                        Set rsLOC_NUM = gconDMIS.Execute("SELECT DISTINCT LOC_NUMBER , stockno from pmis_fifo where stockno = " & RSTDAYTRANDUP!STOCK_ORD & " and Status = 'ISSUED' and tranno = '" & RSTDAYTRANDUP!TRANNO & "'")
                        ...
                        Do While Not RSTDAYTRANDUP.EOF
                            ...
                            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                                If COUNTERTYPE <> "ADB" Then
                                    ...
                                    'description:   pagal mag para explain EU?
                                     If COMPANY_CODE = "HLU" Then
