...
Begin VB.Form frmViewCashPosition 
   ...
   Begin VB.CommandButton cmdNext 
      ...
      Height          =   795
      Left            =   780
      MouseIcon       =   "ViewCashPosition.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "ViewCashPosition.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   73
   ...
   Begin VB.CommandButton cmdPrevious 
      ...
      Height          =   795
      Left            =   90
      MouseIcon       =   "ViewCashPosition.frx":07B4
      MousePointer    =   99  'Custom
      Picture         =   "ViewCashPosition.frx":0906
      Style           =   1  'Graphical
      TabIndex        =   72
   ...
   Begin wizButton.cmd cmdDetails 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "ViewCashPosition.frx":0C65
   End
