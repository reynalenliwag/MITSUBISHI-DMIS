...
Function ComputeAbsence(TIME1 As String, TIME2 As String, TIME3 As String, TIME4 As String, SHIFTINAM As String, SHIFTLUNCHOUT As String, SHIFTLUNCHIN As String, SHIFTOUTPM As String, GRACE_PERIOD As Integer, LOG_OPTION As Integer, Optional XDATE_TODAY As String)
            ...
            If Not rsAttend.EOF And Not rsAttend.BOF Then
                ...
                While Not rsAttend.EOF
                    ...
                    ElseIf CheckWorkDay(Weekday(rsAttend!datetoday)) = True Then
                        ABSENCE_DET = ComputeAbsence(LOGINAM, LOGOUTPM, LOGOUTLUNCH, LOGINLUNCH, SHIFTFROM1, SHIFTTO1, SHIFTFROM2, SHIFTTO2, GRACE_PERIOD, LOG_OPTION, LOGOUTPM)
...
'                    If MONTH(rsAttend!datetoday) = 11 Then GoTo CONT_NOV
