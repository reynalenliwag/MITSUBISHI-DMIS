...
Function SetMatPrice(mmm As String) As String
    If mmm <> "" Then
        ...
        If Not rsMatMas.EOF And Not rsMatMas.BOF Then SetMatPrice = Null2String(rsMatMas!s_price)
    End If
End Function
...
Function SetAccDisc(mmm As String) As String
    If mmm <> "" Then
        ...
        If Not rsMatMas.EOF And Not rsMatMas.BOF Then SetAccDisc = Null2String(rsMatMas!STOCKDESC) Else SetAccDisc = cboAccessories.Text
    End If
End Function
...
Function SetAccPrice(mmm As String) As String
    If mmm <> "" Then
        ...
        If Not rsMatMas.EOF And Not rsMatMas.BOF Then SetAccPrice = Null2String(rsMatMas!SRP)
    End If
End Function
...
Function SetPartPrice(ppp As String) As String
    If ppp <> "" Then
        ...
        If Not rsPartMas.EOF And Not rsPartMas.BOF Then SetPartPrice = Null2String(rsPartMas!SRP)
    End If
End Function
...
Sub StoreMemvars()
    If Not rsEsti_HD.EOF And Not rsEsti_HD.BOF Then
        ...
        If Null2String(rsEsti_HD!TRANSTYPE) = "R" Then
            lblSTATUS.Caption = "** UPLOADED TO RO **"
            txtROno.Text = Null2String(rsEsti_HD!REP_OR)
...
Sub FillDetails()
    ...
    DiscTotal = N2Str2IntZero(rsEsti_HD!l_discount) + N2Str2IntZero(rsEsti_HD!p_discount) + N2Str2IntZero(rsEsti_HD!m_discount) + N2Str2IntZero(rsEsti_HD!a_discount)
    ...
    If Not rsEsti_Det.EOF And Not rsEsti_Det.BOF Then
        With grdDetails
            ...
            .Col = 1
            .Row = 1
            .Text = Format(TOTJOBAMT, MAXIMUM_DIGIT)
            .Row = 2
            .Text = Format(TOTPARTSAMT, MAXIMUM_DIGIT)
            .Row = 3
            .Text = Format(TOTMATAMT, MAXIMUM_DIGIT)
            .Row = 4
            .Text = Format(TOTACCAMT, MAXIMUM_DIGIT)
            .Row = 5
            .Text = Format(ROTotal, MAXIMUM_DIGIT)
            .Row = 6
            .Text = Format(N2Str2Zero(rsEsti_HD!ro_amount), MAXIMUM_DIGIT)
...
Sub FillMaterials()
    ...
    Set rsEsti_Det = gconDMIS.Execute("select id,LINE_NO,detcde,detdsc,detvol,detprc,det_amt,wcode,discount_2 from CSMS_estdetails where estimateno = '" & rsEsti_HD!EstimateNo & "' and livil = '3' order by LINE_NO asc")
    If Not rsEsti_Det.EOF And Not rsEsti_Det.BOF Then
...
Private Sub grdDetails_DblClick()
    Dim fild                                           As String
    If grdDetails.Row = 1 Then SSTab1.Tab = 1
    If grdDetails.Row = 2 Then
        If SSTab1.TabEnabled(2) = True Then SSTab1.Tab = 2
    End If
    If grdDetails.Row = 3 Then
        If SSTab1.TabEnabled(3) = True Then SSTab1.Tab = 3
    End If
End Sub
...
Private Sub txtPartAccessories_Change()
    If chkAllowManDist.Value = 1 Then
        If NumericVal(txtPartAccessories.Text) > TOTACCAMT + AccInsTotal Then
            ...
            txtPartAccessories.Text = TOTACCAMT + AccInsTotal
        End If
    End If
    Call SetTotalParticipation
End Sub
...
Private Sub txtPartLabor_Change()
    If chkAllowManDist.Value = 1 Then
        If NumericVal(txtPartLabor.Text) > TOTJOBAMT + JobInsTotal Then
            ...
            txtPartLabor.Text = TOTJOBAMT + JobInsTotal
        End If
    End If
    Call SetTotalParticipation
End Sub
...
Private Sub txtPartMaterials_Change()
    If chkAllowManDist.Value = 1 Then
        If NumericVal(txtPartMaterials.Text) > TOTMATAMT + MatInsTotal Then
            ...
            txtPartMaterials.Text = TOTMATAMT + MatInsTotal
        End If
    End If
    Call SetTotalParticipation
End Sub
...
Private Sub txtPartParts_Change()
    If chkAllowManDist.Value = 1 Then
        If NumericVal(txtPartParts.Text) > TOTPARTSAMT + PartsInsTotal Then
            ...
            txtPartParts.Text = TOTPARTSAMT + PartsInsTotal
        End If
    End If
    Call SetTotalParticipation
End Sub
