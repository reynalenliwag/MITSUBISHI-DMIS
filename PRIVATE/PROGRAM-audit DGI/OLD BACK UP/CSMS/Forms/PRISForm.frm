...
Begin VB.Form frmPMISPrisForms 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "PRISForm.frx":0D47
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":0E99
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   2490
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1470
         MouseIcon       =   "PRISForm.frx":11D7
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":1329
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   2490
         Width           =   705
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "PRISForm.frx":1695
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":17E7
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7020
         MouseIcon       =   "PRISForm.frx":1B4D
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":1C9F
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "PRISForm.frx":2005
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":2157
         Style           =   1  'Graphical
         TabIndex        =   103
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "PRISForm.frx":2491
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":25E3
         Style           =   1  'Graphical
         TabIndex        =   104
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "PRISForm.frx":2908
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":2A5A
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "PRISForm.frx":2DB6
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":2F08
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "PRISForm.frx":321B
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":336D
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "PRISForm.frx":36BD
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":380F
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "PRISForm.frx":3B6D
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":3CBF
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "PRISForm.frx":3FB9
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":410B
         Style           =   1  'Graphical
         TabIndex        =   101
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "PRISForm.frx":4463
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":45B5
         Style           =   1  'Graphical
         TabIndex        =   102
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "PRISForm.frx":4A92
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":4BE4
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   1575
         Width           =   855
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "PRISForm.frx":4F4A
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":509C
         Style           =   1  'Graphical
         TabIndex        =   91
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "PRISForm.frx":53DA
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":552C
         Style           =   1  'Graphical
         TabIndex        =   92
   ...
   End
End
Attribute VB_Name = "frmPMISPrisForms"
...
Private Sub cmdPrint_Click()
    ...
    If rsOrd_Hd!TRANTYPE = "PRS" Then
        ...
        If Val(txtDS1) = 0 Then
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "InventoryRequisition_IssuanceSlip.rpt", "", DMIS_REPORT_Connection, 1
        Else
