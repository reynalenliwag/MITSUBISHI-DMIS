        ...
        Do While Not rsORD_HIST.EOF
            ...
            If Not rsDAYTRAN.EOF And Not rsDAYTRAN.BOF Then
                ...
                Do While Not rsDAYTRAN.EOF
                    ...
                    Set rsRR_HDCheck = gconDMIS.Execute("select * from PMIS_RR_HD where [TYPE] = 'P' AND ClassCode = 'RRV' and RIV_Tranno = '" & Format(Null2String(rsORD_HIST!TRANNO), "000000") & "'")
                    ...
                    End If
                    Set rsRR_HDCheck = New ADODB.Recordset
                    Set rsRR_HDCheck = gconDMIS.Execute("select * from PMIS_REC_HIST where [TYPE] = 'P' AND ClassCode = 'RRV' and RIV_Tranno = '" & Format(Null2String(rsORD_HIST!TRANNO), "000000") & "'")
                    If Not rsRR_HDCheck.EOF And Not rsRR_HDCheck.BOF Then
                        Do While Not rsRR_HDCheck.EOF
                            Set rsRR_HDTdaytranCheck = New ADODB.Recordset
        ...
        Do While Not rsOrd_Hd.EOF
            ...
            If Not rsTdayTran.EOF And Not rsTdayTran.BOF Then
                ...
                Do While Not rsTdayTran.EOF
                    ...
                    VarPartDiscount = ZERO
                    Set rsRR_HDCheck = New ADODB.Recordset
                    Set rsRR_HDCheck = gconDMIS.Execute("select * from PMIS_RR_HD where [TYPE] = 'P' AND ClassCode = 'RRV' and RIV_Tranno = '" & Format(Null2String(rsOrd_Hd!TRANNO), "000000") & "'")
                    If Not rsRR_HDCheck.EOF And Not rsRR_HDCheck.BOF Then
                        Do While Not rsRR_HDCheck.EOF
                            Set rsRR_HDTdaytranCheck = New ADODB.Recordset
                            Set rsRR_HDTdaytranCheck = gconDMIS.Execute("select * from PMIS_Tdaytran where [TYPE] = 'P' AND trantype = 'RR' and tranno = " & N2Str2Null(rsRR_HDCheck!rrno) & " order by Itemno asc")
                    ...
                    End If
                    Set rsRR_HDCheck = New ADODB.Recordset
                    Set rsRR_HDCheck = gconDMIS.Execute("select * from PMIS_REC_HIST where [TYPE] = 'P' AND ClassCode = 'RRV' and RIV_Tranno = '" & Format(Null2String(rsOrd_Hd!TRANNO), "000000") & "'")
                    If Not rsRR_HDCheck.EOF And Not rsRR_HDCheck.BOF Then
                        Do While Not rsRR_HDCheck.EOF
                            Set rsRR_HDTdaytranCheck = New ADODB.Recordset
                            Set rsRR_HDTdaytranCheck = gconDMIS.Execute("select * from PMIS_DayTran where [TYPE] = 'P' AND trantype = 'RR' and tranno = " & N2Str2Null(rsRR_HDCheck!rrno) & " order by Itemno asc")
...
Sub SetCustLimit()
    ...
    If Not rsALL_Customer_Credit.EOF And Not rsALL_Customer_Credit.BOF Then
        labCreditDays.Caption = Null2String(rsALL_Customer_Credit!CREDITDAYS) & " DAYS"
