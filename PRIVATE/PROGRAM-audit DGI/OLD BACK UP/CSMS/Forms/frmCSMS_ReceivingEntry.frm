...
Begin VB.Form frmCSMS_ReceivingEntry 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8580
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":058A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":06DC
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":0A42
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":0B94
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":0EFA
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":104C
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":1386
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":14D8
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":181D
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":196F
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":1C94
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":1DE6
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":2142
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":2294
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":25A7
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":26F9
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":2A49
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":2B9B
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Move to First Record"
         Top             =   0
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":2EF9
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":304B
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":3345
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":3497
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":37EF
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":3941
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin VB.Frame Frame3 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmCSMS_ReceivingEntry.frx":3CA0
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "lstJobSublet"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Materials"
         TabPicture(1)   =   "frmCSMS_ReceivingEntry.frx":3CBC
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "lstMaterials"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Parts"
         TabPicture(2)   =   "frmCSMS_ReceivingEntry.frx":3CD8
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lvwTran 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":3CF4
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "Tranno"
            Object.Width           =   3792
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   810
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":3E56
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":3FA8
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":42E6
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":4438
         Style           =   1  'Graphical
         TabIndex        =   16
...
Sub StoreMemvars()
    If Not rsINFO.EOF And Not rsINFO.BOF Then
        ...
        Call getAPJ_NO(Trim(txtReceive), Trim(txtInvNo))
...
Private Sub cmdSave_Click()
    ...
    If ADDOREDIT = "ADD" Then
        ...
        End If
    Else
        rsRcNumDup.Open "select RC_NO from CSMS_PO_RC_HD where RC_NO = '" & Trim(txtRcNumber) & "' and STATUS = 'P'", gconDMIS, adOpenForwardOnly, adLockReadOnly
