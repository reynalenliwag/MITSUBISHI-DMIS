   ...
   Begin XtremeSuiteControls.TabControl TabControl 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Begin VB.Label Label5 
            ...
            Height          =   225
            Left            =   450
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A15E
            MousePointer    =   99  'Custom
            TabIndex        =   71
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.Label Label4 
            ...
            Height          =   225
            Left            =   450
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A2B0
            MousePointer    =   99  'Custom
            TabIndex        =   70
            ToolTipText     =   "Click to view Repair Order Filter by Parked Status"
            Top             =   360
      ...
      Begin VB.PictureBox Frame1 
         ...
         Begin VB.Label labPark 
            ...
            Height          =   225
            Left            =   420
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A402
            MousePointer    =   99  'Custom
            TabIndex        =   57
            ToolTipText     =   "Click to view Repair Order Filter by Parked Status"
            Top             =   360
         ...
         Begin VB.Label labWork 
            ...
            Height          =   225
            Left            =   3510
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A554
            MousePointer    =   99  'Custom
            TabIndex        =   56
         ...
         Begin VB.Label labBilled 
            ...
            Height          =   225
            Left            =   9810
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A6A6
            MousePointer    =   99  'Custom
            TabIndex        =   55
         ...
         Begin VB.Label labOver 
            ...
            Height          =   225
            Left            =   8430
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A7F8
            MousePointer    =   99  'Custom
            TabIndex        =   54
         ...
         Begin VB.Label labIdleTime 
            ...
            Height          =   225
            Left            =   5190
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":A94A
            MousePointer    =   99  'Custom
            TabIndex        =   53
         ...
         Begin VB.Label labBackJob 
            ...
            Height          =   225
            Left            =   1785
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":AA9C
            MousePointer    =   99  'Custom
            TabIndex        =   52
         ...
         Begin VB.Label labFinish 
            ...
            Height          =   225
            Left            =   6945
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":ABEE
            MousePointer    =   99  'Custom
            TabIndex        =   51
         ...
         Begin VB.Label Label1 
            ...
            Height          =   225
            Left            =   11250
            MouseIcon       =   "FrmCSMS_ServiceCounter.frx":AD40
            MousePointer    =   99  'Custom
            TabIndex        =   50
...
'            If CheckIfUserIsAnServiceAdviser = False Then
...
'        If COMPANY_CODE = "HAI" Or COMPANY_CODE = "HEI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HLU" Then
'            Dim rstmp                                  As New ADODB.Recordset
'            Dim FJOB                                   As String
'            Dim SJOB                                   As String
'            Dim TJOB                                   As String
...
Sub FillEstimateDetails(xESTNO As String)
    ...
    Set RSUPLOAD = gconDMIS.Execute("Select DETCDE,DETDSC,PMS_MODEL from CSMS_PMS_Job_det where ESTIMATENO = '" & xESTNO & "' Order by [LINE_NO] Asc")
    If Not RSUPLOAD.EOF And Not RSUPLOAD.BOF Then
    ...
    If Check1.Value = 1 Then
        If CHKSTATUS = "All" Then
            Set RSUPLOAD = gconDMIS.Execute("Select [AppointmentDate], Customer, Model, PLATE_NO, RO_No, [Hours], [xHrsWork], " & _
                ...
                " END AS PERC, PromiseDate, [Today], status, Writer, TECH1, TECH2, TECH3, ACCT_NO, datefinish from CSMS_vw_RepairOrder where (TransType = 'R' and status <> 'Released') order by AppointmentDate asc")  ' AND AppointmentDate <= '" & DateValue(MonthView1) & "' order by AppointmentDate asc")    'BTT - 05242007
        Else
            Set RSUPLOAD = gconDMIS.Execute("Select [AppointmentDate], Customer, Model, PLATE_NO, RO_No, [Hours], [xHrsWork], " & _
                " CASE ISNULL([HOURS],0) " & _
                " WHEN 0 THEN 0 " & _
