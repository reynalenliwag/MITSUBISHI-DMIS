...
Begin VB.Form frmMainMenu 
   ...
   Begin XtremeSuiteControls.TabControl TabControl1 
      ...
      Begin VB.CommandButton cmdInq_Techmonitoring 
         ...
         Height          =   765
         Left            =   -65530
         MouseIcon       =   "frmCSMSMainMenu.frx":DEA7
         Picture         =   "frmCSMSMainMenu.frx":EF29
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdInq_Parts 
         ...
         Height          =   765
         Left            =   -69670
         MouseIcon       =   "frmCSMSMainMenu.frx":FFAB
         MousePointer    =   99  'Custom
      ...
      Begin VB.CommandButton cmdMaster_Customer 
         ...
         Height          =   795
         Left            =   -69670
         MouseIcon       =   "frmCSMSMainMenu.frx":1BACE
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMSMainMenu.frx":1BC20
         Style           =   1  'Graphical
         TabIndex        =   67
         Tag             =   "1020"
         ToolTipText     =   "View Customer Master List"
      ...
      Begin VB.CommandButton cmdTab_Color 
         ...
         Height          =   795
         Left            =   -69670
         MouseIcon       =   "frmCSMSMainMenu.frx":1F709
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMSMainMenu.frx":1F85B
         Style           =   1  'Graphical
         TabIndex        =   63
         Tag             =   "1084"
      ...
      Begin VB.CommandButton cmdMain_JobClock 
         ...
         Height          =   795
         Left            =   330
         MouseIcon       =   "frmCSMSMainMenu.frx":2192D
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMSMainMenu.frx":21A7F
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton cmdMain_JobEstimate 
         ...
         Height          =   795
         Left            =   330
         MouseIcon       =   "frmCSMSMainMenu.frx":24D25
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMSMainMenu.frx":24E77
         Style           =   1  'Graphical
         TabIndex        =   45
         Tag             =   "1031"
         ToolTipText     =   "View Job Estimate"
      ...
      Begin XtremeSuiteControls.TabControl TabControl2 
         ...
         Begin VB.CommandButton cmdReport_WorkshopSalesWeeklyPerformance 
            ...
            Height          =   735
            Left            =   -69670
            MouseIcon       =   "frmCSMSMainMenu.frx":386E1
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":38833
            Style           =   1  'Graphical
            TabIndex        =   10
         ...
         Begin VB.CommandButton cmdReport_WorkInProgress 
            ...
            Height          =   735
            Left            =   -65800
            MouseIcon       =   "frmCSMSMainMenu.frx":398B5
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":39A07
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmdReport_AppointmentDiary 
            ...
            Height          =   735
            Left            =   -69670
            MouseIcon       =   "frmCSMSMainMenu.frx":3AA89
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":3ABDB
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmdSummary 
            ...
            Height          =   735
            Left            =   9090
            MouseIcon       =   "frmCSMSMainMenu.frx":3FDD9
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":3FF2B
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmdReport_ServiceAdivsorSales 
            Height          =   735
            Left            =   -69670
            MouseIcon       =   "frmCSMSMainMenu.frx":40825
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":40977
            Style           =   1  'Graphical
            TabIndex        =   2
            Tag             =   "1087"
      ...
      Begin XtremeSuiteControls.TabControl TabControl3 
         ...
         Begin VB.CommandButton cmdMain_QC 
            ...
            Height          =   795
            Left            =   -69730
            MouseIcon       =   "frmCSMSMainMenu.frx":419F9
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":41B4B
            Style           =   1  'Graphical
            TabIndex        =   118
         ...
         Begin VB.CommandButton cmdSubletReceiving 
            ...
            Height          =   795
            Left            =   270
            MouseIcon       =   "frmCSMSMainMenu.frx":42BCD
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":42D1F
            Style           =   1  'Graphical
            TabIndex        =   115
            Tag             =   "1025"
...
Private Sub Command1_Click()
    ...
    'DESCRIPTION : CRF 140
'        If COMPANY_CODE <> "HGC" And COMPANY_CODE <> "HAI" Then
...
Private Sub Command16_Click()
     'UPDATE BY   : NVB 12/11/2009 10AM
     'DESCRIPTION : CRF
'     If COMPANY_CODE = "HAI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HAS" Then
