...
Begin VB.Form frmCSMS_Inquiry_ListByPlate 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "INQUIRY LIST BY PLATE NUMBER"
   ClientHeight    =   6690
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   12375
   ForeColor       =   &H00DEDFDE&
   Icon            =   "Inquiry_ListByPlate.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   795
         Left            =   11370
         MouseIcon       =   "Inquiry_ListByPlate.frx":030A
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_ListByPlate.frx":045C
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin MSFlexGridLib.MSFlexGrid grdQUERY2 
      ...
      Appearance      =   0
      FormatString    =   $"Inquiry_ListByPlate.frx":0797
   ...
   Begin MSFlexGridLib.MSFlexGrid grdQUERY 
      ...
      Appearance      =   0
      MousePointer    =   99
      FormatString    =   $"Inquiry_ListByPlate.frx":0826
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "Inquiry_ListByPlate.frx":0966
   End
   ...
   End
End
Attribute VB_Name = "frmCSMS_Inquiry_ListByPlate"
...
Sub initReporGrid()
    ...
    With grdQUERY
        .Row = 0
        .FormatString = "RO Number | Invoice No. | Plate No. |Customer Name                                  | " & _
                        "Model            | Term | Recd. By | KM Reading | Date Recd. | " & _
                        "Certificat | Invoice Amt. | Ins. Amt. | RO Vat    | Labor       | " & _
                        "Parts       | Material    |Material Tax | Print Date | Date Completed | Date Released | Invoice Bal. "
        .FixedCols = 3
    End With
End Sub
...
Sub VcmdROSearch()
    ...
    If infindstr <> "" Then
        If IsNumeric(infindstr) = True Then
            findStr = Format(Left(infindstr, 2), "K-") & Format(Right(infindstr, 6), "000000")
        Else
            ...
            findStr = Format(Left(findstr3, 2), "K-") & Format(Right(findstr3, 6), "000000")
        End If
...
Private Sub Command1_Click()
        ...
        If chk(I).Value = 1 Then
            If cbo(I) = "<ALL>" Or cbo(I) <> "" Then
                If I = 5 Then
                    ...
                    If Not SACODE = "" Then: SearchString1 = SearchString1 & " UPPER(" & cbo(I).Tag & ")='" & SACODE & "' AND "
                Else
    ...
    LogAudit "I", "INQUIRY LIST BY PLATE NUMBER", SearchString1
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCSMS_Inquiry_ListByPlate = Nothing
End Sub
