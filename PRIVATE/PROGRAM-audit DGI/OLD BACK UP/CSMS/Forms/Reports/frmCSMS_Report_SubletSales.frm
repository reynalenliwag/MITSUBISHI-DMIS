...
'-------------------------------------------------------------------------------
    ...
    Else
        ...
        Do While Not rsHEAD.EOF
            ...
            xlSheet.Cells(cnt, "A") = Null2String(rsHEAD!dte_comp)
...
'----------------------------------------------------------------------------------------------------
            xlSheet.Cells(cnt, "I") = getSubletdetails("1", "GJ", Null2String(rsHEAD!REP_OR))
            TOTGJ_SUBLABOR = TOTGJ_SUBLABOR + xlSheet.Cells(cnt, "I")
            xlSheet.Cells(cnt, "J") = getSubletdetails("3", "GJ", Null2String(rsHEAD!REP_OR))
            TOTGJ_SUBMAT = TOTGJ_SUBMAT + xlSheet.Cells(cnt, "J")
            xlSheet.Cells(cnt, "K") = getSubletdetails("2", "GJ", Null2String(rsHEAD!REP_OR))
            TOTGJ_SUBPARTS = TOTGJ_SUBPARTS + xlSheet.Cells(cnt, "K")
            xlSheet.Cells(cnt, "L") = getSubletdetails("1", "BP", Null2String(rsHEAD!REP_OR))
            TOTBP_SUBLABOR = TOTBP_SUBLABOR + xlSheet.Cells(cnt, "L")
            xlSheet.Cells(cnt, "M") = getSubletdetails("3", "BP", Null2String(rsHEAD!REP_OR))
            TOTBP_SUBMAT = TOTBP_SUBMAT + xlSheet.Cells(cnt, "M")
            xlSheet.Cells(cnt, "N") = getSubletdetails("2", "BP", Null2String(rsHEAD!REP_OR))
