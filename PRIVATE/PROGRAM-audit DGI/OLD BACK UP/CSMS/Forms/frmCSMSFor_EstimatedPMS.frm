...
Begin VB.Form frmCSMS_EstimatedPMS 
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   3150
      MouseIcon       =   "frmCSMSFor_EstimatedPMS.frx":058A
      MousePointer    =   99  'Custom
      Picture         =   "frmCSMSFor_EstimatedPMS.frx":06DC
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   2370
      MouseIcon       =   "frmCSMSFor_EstimatedPMS.frx":0B27
      MousePointer    =   99  'Custom
      Picture         =   "frmCSMSFor_EstimatedPMS.frx":0C79
      Style           =   1  'Graphical
      TabIndex        =   2
