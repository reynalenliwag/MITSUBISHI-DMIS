...
'    xOPTION1 = "VOUCHER"
    If txtVoucherNo = "" Then
        ...
        If chkCurrentVend.Value = True Then
            ...
            SQL_STATEMENT = "SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE VENDORCODE = '" & CURRENT_VENDORCODE & "' AND BALANCE <> 0 ORDER BY VOUCHERNO,JTYPE"
        ...
        Else
            ...
            SQL_STATEMENT = "SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE BALANCE <> 0 ORDER BY VOUCHERNO,JTYPE"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
    ...
    Else
        ...
        If chkCurrentVend.Value = True Then
            ...
            'Set rsJournal_HD = gconDMIS.Execute("SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE=(AMOUNTTOPAY-AMOUNTPAID),DUEDATE,JTYPE,REMARKS,ACCT_CODE FROM (SELECT HD.VOUCHERNO,HD.JDATE,HD.DUEDATE,HD.VENDORCODE,AMOUNTTOPAY=(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END), " & _
                                                "ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE (HD.JTYPE=AMIS_CV_DETAIL.JTYPE  AND PV_VOUCHERNO=HD.VOUCHERNO AND J_CLASS=DET.ACCT_CODE) GROUP BY J_CLASS) ,0) AMOUNTPAID, " & _
                                                "HD.JTYPE,HD.REMARKS,DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE HD.JTYPE IN('APJ','VPJ')AND HD.STATUS ='P') AS T " & _
            ...
            SQL_STATEMENT = "SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE VENDORCODE = '" & CURRENT_VENDORCODE & "' AND BALANCE <> 0 AND VOUCHERNO LIKE '" & Format(Trim(Repleys(Me.txtVoucherNo)), "000000") & "%' ORDER BY VOUCHERNO,JTYPE ASC"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
        Else
            ...
            SQL_STATEMENT = "SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE BALANCE <> 0 AND VOUCHERNO LIKE '" & Format(Trim(Repleys(Me.txtVoucherNo)), "000000") & "%' ORDER BY VOUCHERNO,JTYPE ASC"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
            '            End If
...
'DESCRIPTION: ONLY TAG DETAILS WITH SCHEDULE
    If txtVendorPayeeName = "" Then
        ...
        If chkCurrentVend.Value = True Then
            ...
            SQL_STATEMENT = "SELECT VENDORNAME,JDATE,VOUCHERNO,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,VENDOR_NAME AS VENDORNAME,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE VENDORCODE = '" & CURRENT_VENDORCODE & "' AND BALANCE <> 0 ORDER BY VOUCHERNO,VENDORCODE"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
        ...
        Else
            ...
            SQL_STATEMENT = "SELECT VENDORNAME,JDATE,VOUCHERNO,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,VENDOR_NAME AS VENDORNAME,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE BALANCE <> 0 ORDER BY VOUCHERNO,VENDORCODE"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
        End If
        If Not (rsJournal_HD.EOF And rsJournal_HD.BOF) Then
    ...
    Else
        ...
        If chkCurrentVend.Value = True Then
            ...
            SQL_STATEMENT = "SELECT VENDORNAME,JDATE,VOUCHERNO,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,VENDOR_NAME AS VENDORNAME,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE VENDORCODE = '" & CURRENT_VENDORCODE & "' AND BALANCE <> 0 AND VENDORNAME like '" & Format(Trim(Repleys(Me.txtVendorPayeeName)), "000000") & "%' ORDER BY VOUCHERNO,VENDORCODE"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
        Else
            ...
            SQL_STATEMENT = "SELECT VENDORNAME,JDATE,VOUCHERNO,AMOUNTTOPAY,BALANCE,DUEDATE,JTYPE,REMARKS,ACCT_CODE,INVOICENO,INVOICETYPE FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,CASE WHEN LEN(VOUCHERNO)=10 THEN LEFT(VOUCHERNO,3) ELSE LEFT(VOUCHERNO,2) END AS JTYPE,JDATE,VENDOR_CODE AS VENDORCODE,VENDOR_NAME AS VENDORNAME,AMOUNT2PAY AS AMOUNTTOPAY,DUEDATE,ACCT_CODE,ISNULL(INVOICENO,'') AS INVOICENO,ISNULL(INVOICETYPE,'') AS INVOICETYPE,NULL AS REMARKS, " & _
                            "AMOUNT2PAY - ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE JTYPE+'-'+PV_VOUCHERNO=AP.VOUCHERNO AND J_CLASS=AP.ACCT_CODE AND VENDORCODE=AP.VENDOR_CODE),0) AS BALANCE FROM AMIS_AP AP)T " & _
                            "WHERE BALANCE <> 0 AND VENDORNAME like '" & Format(Trim(Repleys(Me.txtVendorPayeeName)), "000000") & "%' ORDER BY VOUCHERNO,VENDORCODE"
            Set rsJournal_HD = gconDMIS.Execute(SQL_STATEMENT)
        End If
        If Not (rsJournal_HD.EOF And rsJournal_HD.BOF) Then
            Listview_Loadval Me.ListVendorPayeeName.ListItems, rsJournal_HD
