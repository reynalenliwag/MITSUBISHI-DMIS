...
Begin VB.Form frmAPJImport 
   ...
   Begin wizProgBar.Prg progCPB 
      ...
      _ExtentX        =   8017
      _ExtentY        =   556
      Picture         =   "APJImport.frx":3879
      BarPicture      =   "APJImport.frx":3895
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Sub ImportPurchase2(xTRANTYPE As String, XTYPE As String, XTRANNO As String, xTranDate As Date)
    ...
    'Update by al new IMPORTING Template dot save ATC
    If COMPANY_CODE = "HCC" Then
        Dim ATCSET                                     As New ADODB.Recordset
        Set ATCSET = New ADODB.Recordset
        If XTYPE = "SUBLET" Then
            ATCSET.Open "Update Amis_journal_det set ATC = 'WC 120',rate = '2.00' where acct_code = '21-04006-00' and jtype = 'APJ' and voucherno = (select top (1) max(voucherno) from amis_journal_det where jtype = 'APJ') ", gconDMIS
        Else
            ATCSET.Open "Update Amis_journal_det set ATC = 'WC 158',rate = '1.00' where acct_code = '21-04006-00' and jtype = 'APJ' and voucherno = (select top (1) max(voucherno) from amis_journal_det where jtype = 'APJ') ", gconDMIS
        End If
    End If
End Sub
...
InitGrids:     DoEvents: cmdCheck.Enabled = False: cmdClearJournals.Enabled = False
    ...
    If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "HGH" Then
