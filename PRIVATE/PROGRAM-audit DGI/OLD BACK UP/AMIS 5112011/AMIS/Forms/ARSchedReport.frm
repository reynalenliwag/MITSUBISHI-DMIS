...
Begin VB.Form frmAMISARSchedReport 
   ...
   Begin VB.PictureBox picAR 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Height          =   405
         Left            =   60
         Picture         =   "ARSchedReport.frx":08CA
         ScaleHeight     =   405
         ScaleWidth      =   465
         TabIndex        =   58
         Top             =   30
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCheck 
         ...
         Height          =   795
         Left            =   4035
         MouseIcon       =   "ARSchedReport.frx":0CAB
         MousePointer    =   99  'Custom
         Picture         =   "ARSchedReport.frx":0DFD
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   8229
         _ExtentY        =   556
         Picture         =   "ARSchedReport.frx":1098
         ForeColor       =   255
         Appearance      =   2
         BorderStyle     =   2
         BarPicture      =   "ARSchedReport.frx":10B4
         ShowText        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   825
         Left            =   2070
         MouseIcon       =   "ARSchedReport.frx":10D0
         MousePointer    =   99  'Custom
         Picture         =   "ARSchedReport.frx":1222
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   825
         Left            =   1200
         MouseIcon       =   "ARSchedReport.frx":166D
         MousePointer    =   99  'Custom
         Picture         =   "ARSchedReport.frx":17BF
         Style           =   1  'Graphical
         TabIndex        =   25
   ...
   Begin VB.PictureBox picNolink 
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   825
         Left            =   1890
         MouseIcon       =   "ARSchedReport.frx":1C5E
         MousePointer    =   99  'Custom
         Picture         =   "ARSchedReport.frx":1DB0
         Style           =   1  'Graphical
         TabIndex        =   43
         ToolTipText     =   "Close Window"
         Top             =   1920
      ...
      Begin VB.CommandButton Command6 
         ...
         Height          =   825
         Left            =   1020
         MouseIcon       =   "ARSchedReport.frx":21FB
         MousePointer    =   99  'Custom
         Picture         =   "ARSchedReport.frx":234D
         Style           =   1  'Graphical
         TabIndex        =   44
         ToolTipText     =   "Print Report"
         Top             =   1920
...
Sub getlastdate()
    Set RS = gconDMIS.Execute("select max(JDATE)as JDATE from AMIS_AR_HD")
    If Not (RS.EOF Or RS.BOF) Then
        ...
        Else
            Label9.Visible = True
            Label8.Visible = True
            Label8.Caption = Null2String(RS!JDate)
