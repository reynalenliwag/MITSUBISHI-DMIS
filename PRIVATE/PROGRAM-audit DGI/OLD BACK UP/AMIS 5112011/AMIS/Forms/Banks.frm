...
Sub rsRefresh()
    ...
    rsBanks.Open "select * from ALL_Banks WHERE CATEGORY = 'C' order by BankCode asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    FillGrid
End Sub
...
Private Sub FillGrid()
    ...
    Set rsBanks2 = New ADODB.Recordset
    Set rsBanks2 = gconDMIS.Execute("select bankcode,bankname,ID from ALL_Banks WHERE CATEGORY='C'")
