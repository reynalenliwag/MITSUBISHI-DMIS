...
Sub LOAD_ACCT_CODE()
    ...
    rsLOAD_ACCT_CODE.Open "SELECT DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('21-01','21-02','21-07') AND TRANTYPE2='DEPOSIT'", gconDMIS, adOpenKeyset
