...
Sub initMemvars()
    ...
    If xJOURNALTYPE = "COB" Or xJOURNALTYPE = "VPJ" Or xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "CRJ" Then
        ...
        ElseIf xJOURNALTYPE = "VPJ" Or xJOURNALTYPE = "CDJ" Then
    ...
    Else
        ...
        If SelectEntity = "Customer" Then
            ...
            rsCustomer.Open "Select Top 100 Code,AccountName,ENTITYCODE from ALL_ENTITY where ENTITYCODE='" & Left(SelectEntity, 1) & "' AND AccountName IS NOT NULL", gconDMIS, adOpenForwardOnly, adLockReadOnly
        ...
        ElseIf SelectEntity = "Vendor" Then
            ...
            rsVENDOR.Open "Select Top 100 Code,NameofVendor from ALL_Vendor", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Private Sub txtSearch_Change()
    If xJOURNALTYPE = "COB" Or xJOURNALTYPE = "VPJ" Or xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "CRJ" Then
        Set rsEntity = New ADODB.Recordset
        lvCustomer.ListItems.Clear
        If txtSearch.Text = "" Then
