...
'    Else
        Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where (Titles IN ('1102','1103','2101','2102','2107') AND IS_SCHEDULE_ACCNT=1) Order by AcctCode asc")
'    End If
    If Not rsCOBAcctName.EOF And Not rsCOBAcctName.BOF Then
    ...
    If Not rsCOUNT_CODE.EOF And Not rsCOUNT_CODE.BOF Then
        If NumericVal(rsCOUNT_CODE!COUNT_CODE) > 1 Then
            ...
            rsAR_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.INVOICENO,HD.INVOICETYPE,HD.INVOICEDATE,ACCT_CODE,INVOICEAMT " & _
                              ...
                              "WHERE LEFT(DET.ACCT_CODE,5) IN ('11-02','11-03','21-01','21-02','21-07') AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & "", gconDMIS, adOpenKeyset
        ...
        Else
            ...
            rsAR_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.INVOICENO,HD.INVOICETYPE,HD.INVOICEDATE,ACCT_CODE,INVOICEAMT " & _
                              "FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE " & _
                              "WHERE LEFT(DET.ACCT_CODE,5) IN ('11-02','11-03','21-01','21-02','21-07') AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & " AND HD.STATUS = 'P'", gconDMIS, adOpenKeyset
            If Not rsAR_VOUCHER.EOF And Not rsAR_VOUCHER.BOF Then
                xVOUCHERNO = N2Str2Null(Null2String(rsAR_VOUCHER!jtype) & "-" & Null2String(rsAR_VOUCHER!VOUCHERNO))
                xJdate = N2Str2Null(Null2String(rsAR_VOUCHER!JDATE))
                xJType = N2Str2Null(Null2String(rsAR_VOUCHER!jtype))
