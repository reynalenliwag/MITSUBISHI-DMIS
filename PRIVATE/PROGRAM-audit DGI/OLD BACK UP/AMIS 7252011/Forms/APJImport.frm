    ...
    For GridImport = 1 To Grid1.Rows - 1
        If N2Str2Zero(Grid1.Cell(GridImport, 1).Text) = 0 Then
            ...
            If Not rsRR_HD.EOF And Not rsRR_HD.BOF Then
                ...
                J_TAX = 0
                J_OUTBALANCE = 0
'                If COMPANY_CODE = "HCC" And ReturnATCofVENDOR(PMIOS_RECVD_CODE) <> 0 And ReturnNONVATVendor("'PMIOS_RECVD_CODE'") And PMIOS_RECVD_CODE <> "H00002" Then
'                    J_AMOUNTTOPAY = Round(NumericVal(PMIOS_NETRRAMT), 2) - Round(NumericVal(PMIOS_NETRRAMT) / 1.12, 2) * ReturnATCofVENDOR(PMIOS_RECVD_CODE)
'                Else
