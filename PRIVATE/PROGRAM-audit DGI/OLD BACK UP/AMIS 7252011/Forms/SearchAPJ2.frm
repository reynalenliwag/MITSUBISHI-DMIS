...
Private Sub ListVendorPayeeName_DblClick()
    ...
    If xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "APJ" Then
        ...
        frmAMISJournalEntry_CDJ.lblJ_CLASS.Caption = (Trim(Me.ListVendorPayeeName.SelectedItem.SubItems(7)))
...
Private Sub ListVoucherNo_DblClick()
    ...
    If xJOURNALTYPE = "CDJ" Then
        ...
        frmAMISJournalEntry_CDJ.lblJ_CLASS.Caption = (Trim(Me.ListVoucherNo.SelectedItem.SubItems(7)))
...
'    xOPTION1 = "VOUCHER"
    If txtVoucherNo = "" Then
        ...
        If chkCurrentVend.Value = True Then
            ...
            SQL_STATEMENT = "SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE=(AMOUNTTOPAY-AMOUNTPAID),JTYPE,REMARKS,ACCT_CODE FROM (SELECT HD.VOUCHERNO,HD.JDATE,VENDORCODE,AMOUNTTOPAY=(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END), " & _
            ...
            SQL_STATEMENT = SQL_STATEMENT & "SELECT VOUCHERNO,JDATE,CUSTOMERCODE,AMOUNTTOPAY,BALANCE=(AMOUNTTOPAY-AMOUNTPAID),JTYPE,REMARKS,ACCT_CODE FROM (SELECT HD.VOUCHERNO,HD.JDATE,CUSTOMERCODE, ISNULL((SELECT SUM(INVOICEAMOUNT) FROM AMIS_CRJ_DETAIL WHERE (HD.JTYPE=AMIS_CRJ_DETAIL.CR_TYPE  AND VOUCHERNO=HD.VOUCHERNO AND J_CLASS=DET.ACCT_CODE) GROUP BY J_CLASS) ,0) AMOUNTTOPAY,0 AMOUNTPAID, HD.JTYPE,HD.REMARKS,DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE HD.JTYPE IN('CRJ') AND HD.STATUS ='P') AS T WHERE CUSTOMERCODE = '" & CURRENT_VENDORCODE & "' AND (ISNULL(AMOUNTTOPAY,0)-ISNULL(AMOUNTPAID,0)) <> 0"
        ...
        Else
            ...
            Set rsJournal_HD = gconDMIS.Execute("SELECT VOUCHERNO,JDATE,VENDORCODE,AMOUNTTOPAY,BALANCE=(AMOUNTTOPAY-AMOUNTPAID),JTYPE,REMARKS,ACCT_CODE FROM (SELECT HD.VOUCHERNO,HD.JDATE,VENDORCODE,AMOUNTTOPAY=(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END), " & _
                                                "ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE (HD.JTYPE=AMIS_CV_DETAIL.JTYPE  AND PV_VOUCHERNO=HD.VOUCHERNO AND J_CLASS=DET.ACCT_CODE) GROUP BY J_CLASS) ,0) AMOUNTPAID, " & _
                                                "HD.JTYPE,HD.REMARKS,DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE HD.JTYPE IN('APJ','VPJ') AND HD.STATUS ='P') AS T " & _
...
'DESCRIPTION: ONLY TAG DETAILS WITH SCHEDULE
    If txtVendorPayeeName = "" Then
        ...
        If chkCurrentVend.Value = True Then
            ...
            Set rsJournal_HD = gconDMIS.Execute("SELECT VENDORNAME,JDATE,VOUCHERNO,AMOUNTTOPAY,BALANCE=(AMOUNTTOPAY-AMOUNTPAID),JTYPE,REMARKS,ACCT_CODE FROM (SELECT (SELECT NAMEOFVENDOR FROM ALL_VENDOR_TABLE WHERE CODE = HD.VENDORCODE) AS VENDORNAME, " & _
                                                "HD.JDATE,HD.VENDORCODE,HD.VOUCHERNO,AMOUNTTOPAY=(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END), " & _
        ...
        Else
            ...
            Set rsJournal_HD = gconDMIS.Execute("SELECT VENDORNAME,JDATE,VOUCHERNO,AMOUNTTOPAY,BALANCE=(AMOUNTTOPAY-AMOUNTPAID),JTYPE,ISNULL(REMARKS,'') AS REMARKS,ACCT_CODE FROM (SELECT (SELECT NAMEOFVENDOR FROM ALL_VENDOR_TABLE WHERE CODE = HD.VENDORCODE) AS VENDORNAME, " & _
                                                "HD.JDATE,HD.VENDORCODE,HD.VOUCHERNO,AMOUNTTOPAY=(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END), " & _
                                                "ISNULL((SELECT SUM(AMOUNT) FROM AMIS_CV_DETAIL WHERE (HD.JTYPE=AMIS_CV_DETAIL.JTYPE  AND PV_VOUCHERNO=HD.VOUCHERNO AND J_CLASS=DET.ACCT_CODE) GROUP BY J_CLASS) ,0) AS AMOUNTPAID, " & _
                                                "HD.JTYPE,HD.REMARKS,DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE HD.JTYPE IN('APJ','VPJ')AND HD.STATUS ='P') AS T " & _
                                                "WHERE (AMOUNTTOPAY-AMOUNTPAID) <> 0 ORDER BY VOUCHERNO,JTYPE")
