...
Dim rsPV As ADODB.Recordset
    If xJOURNALTYPE = "CDJ" Then
        ...
        If Not rsCV_Detail.EOF And Not rsCV_Detail.BOF Then
            ...
            rsPV.Open "SELECT SUM(CREDIT) AS CREDIT FROM AMIS_JOURNAL_DET WHERE ACCT_CODE='" & Null2String(rsCV_Detail!J_CLASS) & "' AND JTYPE='APJ' AND VOUCHERNO='" & Null2String(rsCV_Detail!pv_voucherno) & "'", gconDMIS, adOpenForwardOnly
    ...
    Else
        ...
        If Not rsDet.EOF And Not rsDet.BOF Then
            If CDJ_IS_FROM_AP = True Then
                ...
                gconDMIS.Execute ("DELETE FROM AMIS_JOURNAL_DET FROM AMIS_JOURNAL_DET AS DET INNER JOIN " & _
...
SaveJournalDetails:
                ...
                If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "DGI" Then
    ...
    If MsgBox("Are you sure you want to Post this transaction?", vbQuestion + vbYesNo, "Message") = vbYes Then
        ...
        If xJOURNALTYPE = "CDJ" Then
            ...
            If COMPANY_CODE = "DGI" Then
                ...
                Set rsCheckDetails2 = gconDMIS.Execute("Select Acct_Code, debit from AMIS_Journal_Det DET INNER JOIN AMIS_CHARTACCOUNT AC ON DET.ACCT_CODE=AC.ACCTCODE Where (IS_SCHEDULE_ACCNT=1 AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-07')) and Jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
    ...
    If xJOURNALTYPE = "CDJ" Then
        ...
        ElseIf txtPO_No.Text = "APJ" Then
            ...
            Set rsJournal_HD2 = gconDMIS.Execute("SELECT TOP 1 * FROM (SELECT HD.VOUCHERNO,HD.JDATE,HD.DUEDATE,HD.VENDORCODE,AMOUNTTOPAY=(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END),(CASE WHEN HD.JTYPE='VPJ' THEN HD.AMOUNTTOPAY WHEN HD.JTYPE='APJ' THEN DET.CREDIT END) - " & _
                                                 ...
                                                 "WHERE T.XBALANCE <>0 and VOUCHERNO = '" & txtMRR_No.Text & "' ORDER BY VOUCHERNO,ACCT_CODE ASC")
        Else
            'Set rsJournal_HD2 = gconDMIS.Execute("select VoucherNo,JType,JDate,DueDate,INVOICEAMT,Balance from AMIS_Journal_HD where VoucherNo = '" & txtMRR_No.Text & "' and status='P'")
            Exit Sub
        End If
