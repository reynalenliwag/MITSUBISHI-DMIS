...
Errorcode:
    ...
    gconAudit.Execute "ALTER  VIEW ALL_vw_AUDIT  " & vbCrLf & _
                    " AS " & vbCrLf & _
                    " SELECT     A.ACTION_DATE,  A.MODULE_NAME as description, " & _
                      "Case A.USER_ACTION " & _
                    " WHEN 'A' THEN 'ADDED'" & _
                    ...
                    " END AS USERACTION, A.TRACKING_MEMO, A.[ID], C.USERNAME, A.[USER_ID], A.MODULE_NAME, A.USER_ACTION" & _
