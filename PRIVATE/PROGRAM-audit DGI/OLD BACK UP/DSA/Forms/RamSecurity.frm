...
Begin VB.Form frmSecurity 
   ...
   Begin MSComctlLib.ListView lstUserName 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "RamSecurity.frx":AE84
      NumItems        =   1
...
'==========================================================================================
'FUNCTION / FEATURE :   Form_Unload:
'DATE STARTED       :   6/12/200716:20
'LAST UPDATED       :   6/12/200716:20
'DATABASE UPDATES   :
'WHO UPDATED        :   AXP 06122007421
'UDPATING CODE      :   AXP-06122007421
'==========================================================================================
Option Explicit
...
10:
    ...
    If OpenConnection = True Then
        ...
        Set rsAccess = New ADODB.Recordset
        rsAccess.Open "Select Username from All_RAMS_USERs WHERE USERGROUP='SDM' Order by UserName Asc", gconDMIS, adOpenKeyset
        If Not rsAccess.EOF And Not rsAccess.BOF Then
