VERSION 5.00
Begin VB.Form frmRam_CopySetting 
   ...
   End
End
Attribute VB_Name = "frmRam_CopySetting"
...
On Error GoTo Errorcode:
    ...
    gconDMIS.Execute ("INSERT INTO ALL_Rams_User_Modules  Select " & COPYTO & ",  MAINMODULEID From ALL_Rams_User_Modules WHERE USERID=" & COPYFROM)

    gconDMIS.Execute "DELETE FROM ALL_Rams_UsersAcess     WHERE     (USERID =" & COPYTO & ")"

    SQL = "Insert Into ALL_Rams_UsersAcess "
    SQL = SQL & " SELECT  MODULEID, " & COPYTO & ", Acess_Add, Acess_Edit, Acess_Delete, Acess_View, Acess_Print, Acess_Process, Acess_System, Acess_Post, Acess_UnPost, Acess_CancelEntry  From ALL_Rams_UsersAcess Where (USERID = " & COPYFROM & ")"
...
Private Sub Form_Load()
    ...
    Set TEMPRS = gconDMIS.Execute("SELECT  USERNAME,USERID FROM ALL_RAMS_USERS WHERE USERGROUP<>'SDM'")
