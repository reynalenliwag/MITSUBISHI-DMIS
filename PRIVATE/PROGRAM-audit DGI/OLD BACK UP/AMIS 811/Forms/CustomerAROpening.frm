...
'    Else
        Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where (Titles IN ('1102','1103','1104','2101','2102','2104','2106','2107') AND IS_SCHEDULE_ACCNT=1) Order by AcctCode asc")
'    End If
    If Not rsCOBAcctName.EOF And Not rsCOBAcctName.BOF Then
