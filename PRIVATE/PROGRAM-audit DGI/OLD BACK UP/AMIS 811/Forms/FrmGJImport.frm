...
Function CheckGJifExist(XXX As String) As Boolean
    Dim SQL                                            As String
    Dim RS                                             As New ADODB.Recordset
    Dim XTYPE                                          As String
    ...
    Else
        XTYPE = "MATERIALS"
    End If
    SQL = "SELECT lastupdate,refno from AMIS_journal_HD where refno='" & XXX & "' AND JTYPE='GJ' AND INVOICETYPE='" & XTYPE & "'"
...
Function ImportGJ() As Boolean
    ...
    For GridImports = 1 To Grid1.Rows - 1
        If N2Str2Zero(Grid1.Cell(i, 1).Text) = 0 Then
            ...
            SQL = "SELECT * from PMIS_adjust where ID='" & Grid1.Cell(GridImports, 7).Text & "' and type='P' and status='P' and lastupdate='" & CDate(dtpTranDate) & "'"
            ...
            If Not RsPartsAdjust.EOF And Not RsPartsAdjust.BOF Then
                ...
                J_INVOICETYPE = "'PARTS'": J_INVOICENO = "NULL"
                J_INVOICEAMT = 0: J_REFNO = N2Str2Null(RsPartsAdjust!ID)
...
'                    End If
                    ...
                    J_JITEMNO = "'0002'"
                    J_ACCT_CODE = N2Str2Null(ReturnAccountCode("ADJUSTMENT"))
                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnAccountCode("ADJUSTMENT")))
                    J_DEBIT = 0
                ...
                If theMinusAdjust <> 0 Then
                    J_REMARKS = N2Str2Null("To Record inventory adjusment with Part No:" + PMIS_PartsAdjust + "(Pcs-" + theMinusAdjusted + ")")
                    J_JITEMNO = "'0001'"
                    J_ACCT_CODE = N2Str2Null(ReturnAccountCode("ADJUSTMENT"))
                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnAccountCode("ADJUSTMENT")))
...
Function ImportMaterial() As Boolean
    ...
    For GridImports = 1 To Grid2.Rows - 1
        If N2Str2Zero(Grid2.Cell(i, 1).Text) = 0 Then
            ...
            SQL = "SELECT * from PMIS_adjust where ID='" & Grid2.Cell(GridImports, 7).Text & "' and type='M' and status='P' and lastupdate='" & CDate(dtpTranDate) & "'"
            Set RsPartsAdjust = New ADODB.Recordset
            Set RsPartsAdjust = gconDMIS.Execute(SQL)
            If Not RsPartsAdjust.EOF And Not RsPartsAdjust.BOF Then
                PMIS_AdjustDate = Null2String(RsPartsAdjust!lastupdate)
                ...
                J_TERMS = "NULL": J_DEALER = "NULL"
                J_CHECKDATE = "NULL": J_BANKCODE = "NULL"
                J_INVOICETYPE = "'MATERIALS'": J_INVOICENO = "NULL"
                J_INVOICEAMT = 0: J_REFNO = N2Str2Null(RsPartsAdjust!ID)
                J_PAIDSTATUS = "'N'": J_RECEIVESTATUS = "'N'"
                J_CHECKNO = "NULL": J_REFDATE = "NULL"
                J_AMOUNTTOPAY = 0
...
Private Sub cmdCheck_Click()
    If Module_Access(LOGID, "IMPORT ADJUSMENT", "SYSTEM") = False Then Exit Sub
    ...
    If Option1(0).Value = True Then
        If ImportGJ = False Then
            str_MSG = Replace(str_MSG, "@ACL09182716350", "Parts Adjustment")
    ...
    Else
        If ImportMaterial = False Then
            str_MSG = Replace(str_MSG, "@ACL09182716350", "Materials Adjustment")
            MsgBox str_MSG, vbCritical, "Importing Error"
            cmdExit.Enabled = True
            gconDMIS.RollbackTrans
            Screen.MousePointer = 0
    ...
    If Option1(0).Value = True Then
        ...
        If Not RsPartsAdjust.EOF And Not RsPartsAdjust.BOF Then
            ...
            Do While Not RsPartsAdjust.EOF
                ARNIE = ARNIE + 1
                If CheckGJifExist(Null2String(RsPartsAdjust!ID)) = True Then
                    loveyouarnie = 1
                Else
                    loveyouarnie = 0
                End If
                Grid1.AddItem loveyouarnie & Chr(9) & Null2String(RsPartsAdjust!PARTNO) & Chr(9) & Null2String(RsPartsAdjust!PartDesc) & Chr(9) & ToDoubleNumber(N2Str2Zero(RsPartsAdjust!Cost)) & Chr(9) & N2Str2Zero(RsPartsAdjust!Add) & Chr(9) & N2Str2Zero(RsPartsAdjust!minus) & Chr(9) & N2Str2Zero(RsPartsAdjust!ID)
        ...
        If Not RsPartsAdjust.EOF And Not RsPartsAdjust.BOF Then
            ...
            Do While Not RsPartsAdjust.EOF
                ...
                Else
                    loveyouarnie = 0
                End If
                Grid2.AddItem loveyouarnie & Chr(9) & Null2String(RsPartsAdjust!PARTNO) & Chr(9) & Null2String(RsPartsAdjust!PartDesc) & Chr(9) & ToDoubleNumber(N2Str2Zero(RsPartsAdjust!Cost)) & Chr(9) & N2Str2Zero(RsPartsAdjust!Add) & Chr(9) & N2Str2Zero(RsPartsAdjust!minus) & Chr(9) & N2Str2Zero(RsPartsAdjust!ID)
                RsPartsAdjust.MoveNext
            Loop
