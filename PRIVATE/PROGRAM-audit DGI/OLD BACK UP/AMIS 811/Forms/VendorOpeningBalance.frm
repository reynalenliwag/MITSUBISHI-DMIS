...
Begin VB.Form frmAMISVendorOpeningBalance 
   BackColor       =   &H00DEDFDE&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Vendor Opening Balances"
   ClientHeight    =   6015
   ClientLeft      =   585
   ClientTop       =   330
   ClientWidth     =   9495
   ForeColor       =   &H8000000F&
   Icon            =   "VendorOpeningBalance.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtParticular 
         ...
         TabIndex        =   5
         Text            =   "VendorOpeningBalance.frx":08CA
         Top             =   2520
         Width           =   6585
      End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "VendorOpeningBalance.frx":08D0
      ...
      TabPicture(1)   =   "VendorOpeningBalance.frx":08EC
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "picCustDeposit"
      Tab(1).Control(1)=   "cmdCustDeposit"
      Tab(1).Control(2)=   "lstCustDeposit"
      ...
      Begin MSComctlLib.ListView lstOpenInvoice 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorOpeningBalance.frx":0908
         NumItems        =   6
      ...
      Begin MSComctlLib.ListView lstCustDeposit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorOpeningBalance.frx":0A6A
         NumItems        =   5
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "OR Number"
            Object.Width           =   2540
      ...
      Begin VB.PictureBox picCustDeposit 
         ...
         Begin VB.TextBox txtCDParticular 
            ...
            ScrollBars      =   2  'Vertical
            TabIndex        =   22
            Text            =   "VendorOpeningBalance.frx":0BCC
            Top             =   330
            Width           =   2745
         End
         ...
         Begin wizButton.cmd cmdCDSave 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "VendorOpeningBalance.frx":0BD2
         End
         Begin wizButton.cmd cmdCDCancel 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "VendorOpeningBalance.frx":0BEE
         End
         Begin wizButton.cmd cmdCDDelete 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "VendorOpeningBalance.frx":0C0A
         End
      ...
      Begin VB.PictureBox picOpenInv 
         ...
         Begin wizButton.cmd cmdOISave 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "VendorOpeningBalance.frx":0C26
         End
         ...
         Begin VB.TextBox txtOIParticular 
            ...
            ScrollBars      =   2  'Vertical
            TabIndex        =   14
            Text            =   "VendorOpeningBalance.frx":0C42
            Top             =   630
            Width           =   2745
         End
         ...
         Begin wizButton.cmd cmdOICancel 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "VendorOpeningBalance.frx":0C48
         End
         Begin wizButton.cmd cmdOIDelete 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "VendorOpeningBalance.frx":0C64
         End
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image1 
         ...
         Height          =   11640
         Left            =   0
         Picture         =   "VendorOpeningBalance.frx":0C80
         Top             =   0
         Width           =   2550
      End
   End
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstCustomer 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorOpeningBalance.frx":155F8
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CUSTOMER NAME"
            Object.Width           =   8290
   ...
   End
End
Attribute VB_Name = "frmAMISVendorOpeningBalance"
