...
'    If CRJ_DETAIL_ENTRY = False Then
'        Exit Function
'    End If
...
'UPDATED BY: JUN --- DATE UPDATED: 11/19/2009 --- DESCRIPTION: THIS IS TO GET THE AR IN CRJ MOSTLY ARE A/R CREDIT CARD TRANSACTION
    ...
    rsGET_AR_CRJ.Open "SELECT DISTINCT CRJ.INVOICETYPE + '-' + CRJ.INVOICENO,HD.VOUCHERNO,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.BANK,HD.INVOICENO,HD.INVOICETYPE, " & _
                      "CRJ.INVOICEDATE,DET.ACCT_CODE,DET.DEBIT FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET " & _
    ...
    If Not rsGET_AR_CRJ.EOF And Not rsGET_AR_CRJ.BOF Then
        ...
        If N2Str2Null(rsGET_AR_CRJ!ACCT_CODE) = xCARD_CODE Then
            'If N2Str2Null(rsGET_AR_CRJ!DEBIT) = xCARD_CODE Then
        ...
        If N2Str2Null(rsGET_AR_CRJ!ACCT_CODE) <> xCARD_CODE Then
            ...
            '            End If
            xInvoiceNo = N2Str2Null(rsGET_AR_CRJ!VOUCHERNO)
            xInvoiceType = N2Str2Null(rsGET_AR_CRJ!jtype)
            xInvoicedate = N2Str2Null(rsGET_AR_CRJ!invoicedate)
            xAMOUNT_TO_PAY = GET_AR_AMOUNT(Null2String(rsGET_AR_CRJ!VOUCHERNO), Null2String(rsGET_AR_CRJ!jtype), Null2String(rsGET_AR_CRJ!ACCT_CODE))
            xAMOUNT_PAID = 0
            xBAL = Round((xAMOUNT_TO_PAY - xAMOUNT_PAID), 2)
    ...
    If Picture1.Visible = True Then
        ...
        Else
            If CheckIfARDebitNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), lstDetails.SelectedItem.SubItems(3)) = True Then
                Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, lstDetails.SelectedItem.SubItems(3), lblClass, txtCustCode.Text, lstDetails.SelectedItem.SubItems(3))
            ...
            ElseIf CheckIfAPDebitNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), lstDetails.SelectedItem.SubItems(3)) = True Then
                Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(txtVoucherNo.Text, xJOURNALTYPE, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, lstDetails.SelectedItem.SubItems(3), lblClass, txtCustCode.Text, lstDetails.SelectedItem.SubItems(3))
            ...
            ElseIf CheckIfARCreditNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), lstDetails.SelectedItem.SubItems(4)) = True Then
                Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(txtVoucherNo.Text, xJOURNALTYPE, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, lstDetails.SelectedItem.SubItems(4), lblClass, txtCustCode.Text, lstDetails.SelectedItem.SubItems(3))
                frmAMISJournalEntry_DetailPayment.Show 1
            ElseIf CheckIfAPCreditNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), lstDetails.SelectedItem.SubItems(4)) = True Then
                Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + txtVoucherNo.Text, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, lstDetails.SelectedItem.SubItems(4), lblClass, txtCustCode.Text, lstDetails.SelectedItem.SubItems(3))
                frmAMISJournalEntry_Details.Show 1
            End If
        End If
    End If
...
Function CheckIFinSJ(jtype As String, VOUCHERNO As String) As Boolean
    ...
    rsJournalDTCRJ.Open "SELECT ACCT_CODE FROM AMIS_JOURNAL_DET DT INNER JOIN AMIS_CHARTACCOUNT AC ON DT.ACCT_CODE=AC.ACCTCODE WHERE DT.JTYPE = '" & jtype & "' AND DT.VOUCHERNO = '" & VOUCHERNO & "' AND IS_SCHEDULE_ACCNT=1 AND LEFT(ACCT_CODE,5) IN ('11-02','11-03','11-04')", gconDMIS, adOpenForwardOnly
        ...
        Do While Not rsJournalDTCRJ.EOF
                ...
                If Not rsJournalDTSJ.EOF And Not rsJournalDTSJ.BOF Then
                    Do While Not rsJournalDTSJ.EOF
                        If Null2String(rsJournalDTCRJ!ACCT_CODE) = Null2String(rsJournalDTSJ!ACCT_CODE) Then
                            CheckIFinSJ = True
                            Exit Function
                        Else
                            CheckIFinSJ = False
...
Function GetVoucherNoSJ(jtype As String, VOUCHERNO As String) As String
    ...
    rsCRJDetail.Open "SELECT INVOICETYPE,INVOICENO FROM AMIS_CRJ_DETAIL WHERE CR_TYPE='" & jtype & "' AND VOUCHERNO = '" & VOUCHERNO & "'", gconDMIS, adOpenForwardOnly
