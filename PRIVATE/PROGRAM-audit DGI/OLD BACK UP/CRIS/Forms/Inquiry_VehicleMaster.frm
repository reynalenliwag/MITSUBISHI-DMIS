...
Begin VB.Form frmSMIS_Inquiry_VehicleMaster 
   ...
   Begin VB.PictureBox picInq 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   645
         Left            =   11250
         MouseIcon       =   "Inquiry_VehicleMaster.frx":058A
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_VehicleMaster.frx":06DC
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton cmdView 
         ...
         Height          =   645
         Left            =   11250
         MouseIcon       =   "Inquiry_VehicleMaster.frx":0A23
         MousePointer    =   99  'Custom
         Picture         =   "Inquiry_VehicleMaster.frx":0B75
         Style           =   1  'Graphical
         TabIndex        =   16
...
'"MAKE , CLASS, DESCRIPT, MODEL, YEER, SOURCE, COLOR, C#, P#, S#, V#, E#, F#, ISTATUS, SSTATUS, CUSTOMERNAME, ASSIGNEDSAE")
    ...
    End With
End Sub
'Upating Code       : AXP-0713200715:19
Private Sub cmdView_Click()
    ...
    If Len(SearchString1) > 0 Then
        ...
        SQL = " SELECT MAKE, CLASS,DESCRIPT , " & _
            ...
            " SSTATUS, CUSTOMERNAME, ASSIGNEDSAE , ID  FROM SMIS_vw_INQ_VEHICLEMASTER WHERE " & SearchString1
...
Private Sub Form_Load()
    ...
    FillCombo "SELECT DISTINCT ISTATUS FROM SMIS_vw_INQ_VEHICLEMASTER", -1, 0, cboInq(4)
    FillCombo "SELECT DISTINCT SSTATUS FROM SMIS_vw_INQ_VEHICLEMASTER", -1, 0, cboInq(5)
...
Private Sub lvInquiry_RowDblClick(ByVal Row As XtremeReportControl.IReportRow, ByVal Item As XtremeReportControl.IReportRecordItem)
    ...
    frmCRIS_InquiryVehicleCatalogue.SearchID (NumericVal(Row.Record(17).Value))
End Sub
