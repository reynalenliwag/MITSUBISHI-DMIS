...
Begin VB.Form frmCRIS_EntryMaster 
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lvMaster 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "EntryMaster.frx":08CA
         NumItems        =   0
      End
   End
   Begin VB.PictureBox PicSave 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   45
         MouseIcon       =   "EntryMaster.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   75
         Width           =   705
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   810
         MouseIcon       =   "EntryMaster.frx":0ECE
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":1020
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   75
         Width           =   705
   ...
   Begin VB.PictureBox PicAdd 
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "EntryMaster.frx":135E
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":14B0
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "EntryMaster.frx":180F
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":1961
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "EntryMaster.frx":1CB9
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":1E0B
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2157
         MouseIcon       =   "EntryMaster.frx":2105
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":2257
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2866
         MouseIcon       =   "EntryMaster.frx":256A
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":26BC
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3555
         MouseIcon       =   "EntryMaster.frx":2A18
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":2B6A
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   4995
         MouseIcon       =   "EntryMaster.frx":2E95
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":2FE7
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4284
         MouseIcon       =   "EntryMaster.frx":334D
         MousePointer    =   99  'Custom
         Picture         =   "EntryMaster.frx":349F
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   45
         Width           =   705
...
Private Sub cmdDelete_Click()
    ...
    If Not rsMaster.BOF Or Not rsMaster.EOF Then
        If ShowConfirmDelete = True Then
            gconDMIS.Execute "delete from CRIS_MASTERSETUP where [ID] = " & CLng(lvMaster.SelectedItem.ListSubItems(1).Text)
            ShowDeletedMsg
            m_lD = 0
        End If
    Else
...
Private Sub cmdSave_Click()
    ...
    If AddorEdit = AddState Then
        gconDMIS.Execute "Insert into CRIS_MasterSetup " & _
    ...
    Else
        gconDMIS.Execute "update CRIS_MasterSetup set " & _
