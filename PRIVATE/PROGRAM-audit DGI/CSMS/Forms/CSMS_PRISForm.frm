...
Begin VB.Form frmPMISPrisForms_CSMS 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2850
         MouseIcon       =   "CSMS_PRISForm.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   2490
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "CSMS_PRISForm.frx":0D47
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":0E99
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   2490
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1470
         MouseIcon       =   "CSMS_PRISForm.frx":11D7
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":1329
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   2490
         Width           =   705
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "CSMS_PRISForm.frx":1695
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":17E7
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7020
         MouseIcon       =   "CSMS_PRISForm.frx":1B4D
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":1C9F
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CSMS_PRISForm.frx":2005
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":2157
         Style           =   1  'Graphical
         TabIndex        =   103
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CSMS_PRISForm.frx":2491
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":25E3
         Style           =   1  'Graphical
         TabIndex        =   104
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "CSMS_PRISForm.frx":2908
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":2A5A
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "CSMS_PRISForm.frx":2DB6
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":2F08
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "CSMS_PRISForm.frx":321B
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":336D
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "CSMS_PRISForm.frx":36BD
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":380F
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "CSMS_PRISForm.frx":3B6D
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":3CBF
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "CSMS_PRISForm.frx":3FB9
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":410B
         Style           =   1  'Graphical
         TabIndex        =   101
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "CSMS_PRISForm.frx":4463
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":45B5
         Style           =   1  'Graphical
         TabIndex        =   102
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CSMS_PRISForm.frx":4914
         NumItems        =   2
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "CSMS_PRISForm.frx":4A92
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":4BE4
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   1575
         Width           =   855
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "CSMS_PRISForm.frx":4F4A
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":509C
         Style           =   1  'Graphical
         TabIndex        =   91
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "CSMS_PRISForm.frx":53DA
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_PRISForm.frx":552C
         Style           =   1  'Graphical
         TabIndex        =   92
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "CSMS_PRISForm.frx":587C
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -660
   ...
   End
End
Attribute VB_Name = "frmPMISPrisForms_CSMS"
...
Private Sub cmdPISNum_Click()
    With frmPMISPRIFormation_CSMS
        ...
        End If
    End With
    frmPMISPRIFormation_CSMS.Show 1
    On Error Resume Next
...
Private Sub cmdPrint_Click()
    If Function_Access(LOGID, "Acess_VIEW", "PARTS REQUISTION SLIP") = False Then Exit Sub

    'updating code:    JAA - 07112007
    On Error GoTo Errorcode:
    
    oVoice.Speak "Print Parts Requisition Slip, Are You Sure?", SVSFlagsAsync
    If MsgBox("Print Parts Requisition Slip, Are You Sure?", vbQuestion + vbYesNo + vbDefaultButton2) = vbYes Then
...
'        fraSignatories.ZOrder 0
        ...
        '        End If
        '         LogAudit "V", "PRIS", txtTranNo
        '         Set rsSignatories = Nothing
        '        'Updating Code   :   JAA - 06252007
        If Val(txtDS1) = 0 Then
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "RequisitionSlip_Parts.rpt", "{PMIS_vw_PRS.type} = 'P' and {PMIS_vw_PRS.trantype} = 'PRS' and {PMIS_vw_PRS.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
        'Else
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            ...
            rsfindDup.Open "select trantype,tranno from PMIS_vw_PRS where trantype = '" & txtTranType.Text & "' and tranno = '" & txtTranNo.Text & "' order by trantype,tranno", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Function SetPartIDSTOCKNO(DDD As String)
    Set rsPartMas = New ADODB.Recordset
    rsPartMas.Open "Select id,STOCKNO from PMIS_Partmas where STOCKNO = '" & DDD & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsPartMas.EOF And Not rsPartMas.BOF Then
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsOrd_Hd = gconDMIS.Execute("select tranno, tranno from PMIS_vw_PRS where trantype = '" & WAREHOUSETYPE & "' and tranno like '" & XXX & "%'")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Sub FillGrid2()
    ...
    lstOrd_Hd.Sorted = False: lstOrd_Hd.ListItems.Clear
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select rono,tranno from PMIS_vw_PRS where trantype = '" & WAREHOUSETYPE & "' and rono is not null order by tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsOrd_Hd = gconDMIS.Execute("select Rono, tranno from PMIS_vw_PRS where trantype = '" & WAREHOUSETYPE & "' and rono like '" & XXX & "%' order by tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
