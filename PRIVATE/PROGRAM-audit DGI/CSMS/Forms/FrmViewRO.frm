...
Private Sub cmdChangestat_Click()
    ...
    If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HPI" Then
    ...
    If COMPANY_CODE = "HAS" Then
        ...
        End If
    Else
        If COMPANY_CODE = "HSR" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HEI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HCI" Then
            Dim rstmp                                  As New ADODB.Recordset
            Dim FJOB                                   As String
            Dim SJOB                                   As String
            Dim TJOB                                   As String
