...
Begin VB.Form frmCSMSAdvisorPerformanceReport 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Advisor Performance Report"
   ClientHeight    =   1725
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4410
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   1275
      MouseIcon       =   "frmAdvisorPerformanceReport.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "frmAdvisorPerformanceReport.frx":0152
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   810
      Width           =   885
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   2235
      MouseIcon       =   "frmAdvisorPerformanceReport.frx":05F1
      MousePointer    =   99  'Custom
      Picture         =   "frmAdvisorPerformanceReport.frx":0743
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   810
      Width           =   885
   ...
   End
End
Attribute VB_Name = "frmCSMSAdvisorPerformanceReport"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'==============================================================
'Function/Feature: Appointment Performance Report
