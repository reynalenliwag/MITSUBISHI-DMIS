...
Begin VB.Form frmCSMS_MasterColor 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Color Master File"
   ClientHeight    =   5400
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5865
   ...
   EndProperty
   Icon            =   "frmCSMS_MasterColor.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   5400
   ScaleWidth      =   5865
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstColor 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmCSMS_MasterColor.frx":20D2
         NumItems        =   2
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   5010
         MouseIcon       =   "frmCSMS_MasterColor.frx":2234
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":2386
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4320
         MouseIcon       =   "frmCSMS_MasterColor.frx":26EC
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":283E
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3630
         MouseIcon       =   "frmCSMS_MasterColor.frx":2BA4
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":2CF6
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2940
         MouseIcon       =   "frmCSMS_MasterColor.frx":3021
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":3173
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2250
         MouseIcon       =   "frmCSMS_MasterColor.frx":34CF
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":3621
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "frmCSMS_MasterColor.frx":3934
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":3A86
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   870
         MouseIcon       =   "frmCSMS_MasterColor.frx":3D80
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":3ED2
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "frmCSMS_MasterColor.frx":422A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":437C
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   Begin VB.PictureBox picSaves 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "frmCSMS_MasterColor.frx":46DB
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":482D
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "frmCSMS_MasterColor.frx":4B6B
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterColor.frx":4CBD
         Style           =   1  'Graphical
         TabIndex        =   22
   ...
   End
End
Attribute VB_Name = "frmCSMS_MasterColor"
