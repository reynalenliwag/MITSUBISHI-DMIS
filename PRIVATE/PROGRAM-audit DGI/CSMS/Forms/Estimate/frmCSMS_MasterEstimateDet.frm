...
Begin VB.Form frmCSMS_MasterEstimateDet 
   ...
   Begin VB.PictureBox picSave 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   3750
         MouseIcon       =   "frmCSMS_MasterEstimateDet.frx":6CE2
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterEstimateDet.frx":6E34
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   825
         Left            =   5520
         MouseIcon       =   "frmCSMS_MasterEstimateDet.frx":7184
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_MasterEstimateDet.frx":72D6
         Style           =   1  'Graphical
         TabIndex        =   13
