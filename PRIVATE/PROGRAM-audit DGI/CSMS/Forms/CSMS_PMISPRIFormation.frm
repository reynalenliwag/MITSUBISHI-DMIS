...
Begin VB.Form frmPMISPRIFormation_CSMS 
   ...
   End
End
Attribute VB_Name = "frmPMISPRIFormation_CSMS"
...
Private Sub cmdOk_Click()
    If lbl2.Caption = "" Or lbl3.Caption = "" Or lbl4.Caption = "" Then
        MsgBox "PRS number not completed!"
        Exit Sub
    End If
...
Sub GetSeries()
    With frmPMISCustomerOrder_CSMS
