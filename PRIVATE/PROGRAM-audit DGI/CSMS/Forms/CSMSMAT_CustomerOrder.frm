...
Begin VB.Form frmPMISMAT_CustomerOrder_CSMS 
   ...
   ClientWidth     =   11550
   ForeColor       =   &H00DEDFDE&
   Icon            =   "CSMSMAT_CustomerOrder.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7080
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   103
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":1B3D
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":1C8F
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":1FEB
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":213D
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":2450
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":25A2
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":28F2
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":2A44
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":2DA2
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":2EF4
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":31EE
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":3340
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":3698
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":37EA
         Style           =   1  'Graphical
         TabIndex        =   101
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2520
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":3B49
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":3C9B
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   1800
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":3FC6
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":4118
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1080
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":4456
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":45A8
         Style           =   1  'Graphical
         TabIndex        =   86
   ...
   Begin wizButton.cmd cmdAddTran 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CSMSMAT_CustomerOrder.frx":48F8
   End
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":4914
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":4A66
         Style           =   1  'Graphical
         TabIndex        =   90
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   -30
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":4DA4
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":4EF6
         Style           =   1  'Graphical
         TabIndex        =   91
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":5246
         NumItems        =   2
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "CSMSMAT_CustomerOrder.frx":53A8
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -540
   ...
   Begin wizButton.cmd cmdSignatories 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CSMSMAT_CustomerOrder.frx":80E4
   End
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3060
         MouseIcon       =   "CSMSMAT_CustomerOrder.frx":8100
         MousePointer    =   99  'Custom
         Picture         =   "CSMSMAT_CustomerOrder.frx":8252
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   1560
         Width           =   855
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_CustomerOrder_CSMS"
...
Private Sub cboRefPRSNo_GotFocus()
    ...
    rsPRS.Open "Select tranno,refpisno from PMIS_vw_PRS WHERE [TYPE] = 'M' order by Tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Private Sub cboRefPRSNo_LostFocus()
    If AddorEdit = "ADD" Then
        ...
        Else
            Set rsRR_HDDup = New ADODB.Recordset
            rsRR_HDDup.Open "select tranno,DS1 from PMIS_vw_PRS where [TYPE] = 'M' AND refpisno = '" & cboRefPRSNo.Text & "'", gconDMIS
            If Not rsRR_HDDup.EOF And Not rsRR_HDDup.BOF Then
...
Private Sub cmdPISNum_Click()
    With frmPMISMAT_MIFormation_CSMS
        ...
        End If
    End With
    frmPMISMAT_MIFormation_CSMS.Show 1
    On Error Resume Next
...
Private Sub cmdPost_Click()
    ...
    Set rsTdaytranDup = Nothing
    Set rsPartmasDup = Nothing
    'If txtTranType.Text = "RIV" Then ImportMaterials txtRONO
    Exit Sub
Errorcode:
    ShowVBError
...
Private Sub cmdPrint_Click()
    ...
    '    If MsgQuestionBox("Materials Issuance Slip will be Printed. Are you Sure?", "Confirm Printing...") = True Then RIVPRINTING
    'End If
...
'        Set rsSignatories = Nothing
    ...
    LogAudit "V", "MATERIALS ISSUANCE SLIP", txtTranNo & txtCustCode
...
'            Print #1, "<td width=20%><FONT SIZE=2 FACE=TIMES NEW ROMAN>MATERIAL CODE</FONT></td>"
...
'            Print #1, "-------------------------------------------------------------------------------------------------------------------------------------------"
'            cnt1 = 0
'            If rsTdayTran.RecordCount > MAX_MAT_ISS Then
'                cnt2 = 0
'            Else
'                cnt2 = MAX_MAT_ISS - rsTdayTran.RecordCount
'            End If
'            If knt >= 3 Then cnt2 = MAX_MAT_ISS - (rsTdayTran.RecordCount - MAX_MAT_ISS)
'            Print #1, "<table border=0 cellpadding=0 cellspacing=0 width=100%>"
'            If rsTdayTran.AbsolutePosition > MAX_MAT_ISS Then
'                rsTdayTran.AbsolutePosition = MAX_MAT_ISS + 1
'            End If
'            Do While Not rsTdayTran.EOF
'                Print #1, "<tr>"
...
'                End If
'                Print #1, "</tr>"
'                If rsTdayTran.AbsolutePosition = MAX_MAT_ISS Then Exit Do
'                rsTdayTran.MoveNext
'            Loop
'            For cnt3 = 1 To cnt2
'                Print #1, "<tr>"
...
'            Print #1, "-------------------------------------------------------------------------------------------------------------------------------------------"
'            cnt1 = 0
'           'modified for HBK FX1170 printer
...
Private Sub cmdPrintRIV_Click()
    If rsOrd_Hd!TRANTYPE = "RIV" Then
        SERVICEPISPRINTING
        LogAudit "V", "MATERIALS RIV PRINTING"
    End If
    If rsOrd_Hd!TRANTYPE = "ADB" Then
        'ADBPRINTING
        LogAudit "V", "MATERIALS ADB PRINTING"
    End If
...
Private Sub cmdTranSave_Click()
    ...
    If txtTranType.Text <> "ADB" Then
        ...
        rsPartMas.Open "Select STOCKNO,onhand,sstock,resservice,TISSQTY,issuances from CSMS_MATMAS where STOCKNO = '" & cboTranPartNo.Text & "' AND ACTIVE = 'Y'", gconDMIS
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            ...
            rsfindDup.Open "select trantype,tranno from PMIS_Ord_Hd where [TYPE] = 'M' AND trantype = '" & txtTranType.Text & "' and tranno = '" & txtTranNo.Text & "' order by trantype,tranno", gconDMIS, adOpenForwardOnly, adLockReadOnly
    ...
    If AddorEdit = "ADD" Then
        ...
        LogAudit "A", "MATERIALS CUSTOMER ORDER", txtTranNo & txtCustCode
    Else
        ...
        gconDMIS.Execute "update PMIS_TdayTran set" & _
                       ...
                       " trandate = " & VTXTTranDate & "," & _
                       " tranno = " & VTXTTranNo & _
                       " where [TYPE] = 'M' AND trantype = '" & PrevOrdType & "' and tranno = '" & PrevOrdNo & "'"
        LogAudit "E", "MATERIALS CUSTOMER ORDER", txtTranNo & txtCustCode
    End If
    If AddorEdit = "ADD" Then
            ...
            If Not rsPRS_HD.EOF And Not rsPRS_HD.BOF Then
                ...
                If Not rstdaytranDUp2.EOF And Not rstdaytranDUp2.BOF Then
                    ...
                    Do While Not rstdaytranDUp2.EOF
                        ...
                        Set rsPartMasClone = gconDMIS.Execute("Select STOCKNO,ONHAND from PMIS_StockMas where TYPE = 'M' and STOCKNO = " & N2Str2Null(rstdaytranDUp2!STOCK_ORD))
                        If Not rsPartMasClone.EOF And Not rsPartMasClone.BOF Then
                           If N2Str2Zero(rsPartMasClone!ONHAND) > 0 Then
                                ...
                                gconDMIS.Execute "insert into PMIS_TdayTran " & _
                                               ...
                                               " values ('M'," & RRTRANDATE & ", '" & COUNTERTYPE & "', " & RRTRANNO & "," & _
...
Sub rsRefresh()
    If COUNTERTYPE = "CSH" Then
        ...
        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'M' and trantype = 'CSH' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    End If
    If COUNTERTYPE = "CHG" Then
        Me.Caption = "Materials Issuance Slip (CHG) Data Entry (Over the Counter)"
        Set rsOrd_Hd = New ADODB.Recordset
        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'M' and trantype = 'CHG' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    End If
    If COUNTERTYPE = "RIV" Then
        Me.Caption = "Materials Issuance Slip Data Entry (Service Requisition)"
        Set rsOrd_Hd = New ADODB.Recordset
        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'M' and trantype = 'RIV' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    End If
    If COUNTERTYPE = "DR" Then
        Me.Caption = "DR Out Issuance Data Entry"
        Set rsOrd_Hd = New ADODB.Recordset
        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'M' and trantype = 'DR' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    End If
    If COUNTERTYPE = "ADB" Then
        Me.Caption = "Materials Advance Bill Data Entry"
        Set rsOrd_Hd = New ADODB.Recordset
        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'M' and trantype = 'ADB' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    End If
...
Function SetPartIDSTOCKNO(DDD As String)
    Set rsPartMas = New ADODB.Recordset
    rsPartMas.Open "Select id,STOCKNO from CSMS_MATMAS where STOCKNO = '" & DDD & "' AND ACTIVE = 'Y'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsPartMas.EOF And Not rsPartMas.BOF Then
...
Private Sub Form_Unload(Cancel As Integer)
    PMIS_ORDER_SHOW = False: Set frmPMISMAT_CustomerOrder_CSMS = Nothing
    UnloadForm Me
End Sub
...
Sub FillGrid()
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select Tranno,tranno from PMIS_Ord_Hd where [TYPE] = 'M' AND trantype = '" & COUNTERTYPE & "' order by Tranno asc")
