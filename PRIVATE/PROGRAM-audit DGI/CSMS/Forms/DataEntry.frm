...
Begin VB.Form frmCSMSDataEntry 
   ...
   Begin VB.PictureBox picSearch 
      ...
      Begin VB.CommandButton cmdSelect 
         ...
         Height          =   885
         Left            =   12180
         MouseIcon       =   "DataEntry.frx":1B4AA
         MousePointer    =   99  'Custom
         Picture         =   "DataEntry.frx":1B5FC
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   825
         Left            =   90
         MouseIcon       =   "DataEntry.frx":1B938
         MousePointer    =   99  'Custom
         Picture         =   "DataEntry.frx":1BA8A
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Cancel"
         Top             =   7800
...
Sub getinvoicenumber()
    ...
    If Not (rsinvnumber.EOF And rsinvnumber.BOF) Then
        txtInvoiceNumber.Text = Format((rsinvnumber!InvoiceNumber), "000000")
    Else
        Set rsinv = gconDMIS.Execute("Select max (invoice) as  invoice from csms_repor where invoice not in ('INT RO','PDI RO','NO CHG') ")
        If Not (rsinv.EOF And rsinv.BOF) Then
            txtInvoiceNumber.Text = (Format((rsinv!INVOICE), "000000") + 1)
        Else
            txtInvoiceNumber.Text = "000001"
        End If
    End If
...
Private Sub cmdVoid_Click()
    ...
    If CheckIfTheresItemIssued = True Then
        MsgBox "You cannot Void this the RO when theres already issued Item." & vbCrLf & " Kindly inform parts depatment to Unpost first the Issuances.", vbInformation, "Info."
        Exit Sub
    End If
    ...
    If txtInvoiceNumber.Text <> "" And IsDate(txtInvoiceDate.Text) = True And IsDate(txtDateReleased.Text) = True Then
        ...
        Else
            ...
            Else
                ...
                Else
                    gconDMIS.Execute "Update csms_invoicectr set invoicenumber = " & Format(NumericVal(txtInvoiceNumber.Text + 1), "000000") & ",[USER] = '" & LOGNAME & "'"
                End If
            End If
...
If KeyAscii = 13 Then
    ...
    If Replace(txtvoid_reason.Text, vbCrLf, "") = "" Then
        MsgBox "Please type your reason for Voiding thid R.O.!", vbInformation + vbOKOnly
        On Error Resume Next
