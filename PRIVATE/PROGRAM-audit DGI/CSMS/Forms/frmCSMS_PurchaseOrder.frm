...
Begin VB.Form frmCSMS_PurchaseOrder 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8580
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":058A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":06DC
         Style           =   1  'Graphical
         TabIndex        =   51
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":0A42
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":0B94
         Style           =   1  'Graphical
         TabIndex        =   50
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":0EFA
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":104C
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":1386
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":14D8
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":181D
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":196F
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":1C94
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":1DE6
         Style           =   1  'Graphical
         TabIndex        =   46
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":2142
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":2294
         Style           =   1  'Graphical
         TabIndex        =   45
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":25A7
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":26F9
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":2A49
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":2B9B
         Style           =   1  'Graphical
         TabIndex        =   43
         ToolTipText     =   "Move to First Record"
         Top             =   0
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":2EF9
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":304B
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":3345
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":3497
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":37EF
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":3941
         Style           =   1  'Graphical
         TabIndex        =   40
   ...
   Begin VB.Frame Frame3 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmCSMS_PurchaseOrder.frx":3CA0
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "lstJobSublet"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Materials"
         TabPicture(1)   =   "frmCSMS_PurchaseOrder.frx":3CBC
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "lstMaterials"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Parts"
         TabPicture(2)   =   "frmCSMS_PurchaseOrder.frx":3CD8
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lvwTran 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":3CF4
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "TranNo"
            Object.Width           =   3792
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   810
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":3E56
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":3FA8
         Style           =   1  'Graphical
         TabIndex        =   54
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":42E6
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":4438
         Style           =   1  'Graphical
         TabIndex        =   53
   ...
   Begin VB.PictureBox picPrintPOExcel 
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   795
         Left            =   2820
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":4788
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":48DA
         Style           =   1  'Graphical
         TabIndex        =   73
         ToolTipText     =   "Exit Window"
         Top             =   3300
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   795
         Left            =   2040
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":4C40
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":4D92
         Style           =   1  'Graphical
         TabIndex        =   74
         ToolTipText     =   "Save this Record"
         Top             =   3300
      ...
      Begin VB.CommandButton cmdPrintPOExcel 
         ...
         Height          =   795
         Left            =   1260
         MouseIcon       =   "frmCSMS_PurchaseOrder.frx":50E2
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_PurchaseOrder.frx":5234
         Style           =   1  'Graphical
         TabIndex        =   75
         ToolTipText     =   "Print this Record"
         Top             =   3300
...
Sub editJobs()
    ...
    Set rsEditJobs = gconDMIS.Execute("Select TRANSTATUS,JOBTYPE,DETCDE,DETDSC,DET_AMT,CONTRACTAMOUNT,COMPAMOUNT,WCODE,DETAIL,TECHCODE from CSMS_Po_Dt where ID ='" & labDET & "'")
...
Sub initMemvars()
    ...
    rsPO_Counter.Open "select max (Po_No) as PO_NO from CSMS_Po_hd", gconDMIS, adOpenForwardOnly, adLockReadOnly
