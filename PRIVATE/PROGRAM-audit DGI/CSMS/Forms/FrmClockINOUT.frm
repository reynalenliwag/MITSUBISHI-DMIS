...
NORMAL_CLOCKING_OUT:
        ...
        ElseIf cboReasonClockingout.Text = "Finish Job" Then
            ...
            Else
                ...
                If Not (Again.EOF And Again.BOF) Then
                   ...
                   Set nard = gconDMIS.Execute("Select rep_or,techcode,done,status from CSMS_RO_DET where livil = '1' and rep_or='" & lbltech.SelectedItem.SubItems(2) & "' and done = 'W' and techcode='" & TechCode & "' and line_no='" & labOutItemNo.Caption & "'")
        ...
        gconDMIS.Execute "update CSMS_JobClock set " & _
            ...
            "' AND RO_No = '" & Trim(lbltech.SelectedItem.SubItems(2)) & "' and Technician = '" & LTrim(RTrim(lbltech.SelectedItem)) & "' and status = 'IN'"
        ...
        If Not rsRO_DET.EOF And Not rsRO_DET.BOF Then
            ...
            SQL_STATEMENT = "update CSMS_ro_det set " & _
                " HRSWRK = " & N2Str2Zero(rsRO_DET!HRSWRK) & " + " & NumericVal(labHours) & "," & _
                " DETCOST = " & TechCost & _
                " where LIVIL = '1' " & _
                " AND Rep_or = '" & lbltech.SelectedItem.SubItems(2) & _
                "' and LINE_NO = '" & labOutItemNo.Caption & "'"
