...
Begin VB.Form frmCSMS_ReceivingEntry 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8580
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":1082
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":11D4
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":153A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":168C
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":19F2
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":1B44
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":1E7E
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":1FD0
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":2315
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":2467
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":278C
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":28DE
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":2C3A
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":2D8C
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":309F
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":31F1
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":3541
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":3693
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Move to First Record"
         Top             =   0
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":39F1
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":3B43
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":3E3D
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":3F8F
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":42E7
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_ReceivingEntry.frx":4439
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin VB.Frame Frame3 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmCSMS_ReceivingEntry.frx":4798
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "lstJobSublet"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Materials"
         TabPicture(1)   =   "frmCSMS_ReceivingEntry.frx":47B4
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "lstMaterials"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Parts"
         TabPicture(2)   =   "frmCSMS_ReceivingEntry.frx":47D0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lvwTran 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmCSMS_ReceivingEntry.frx":47EC
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "Tranno"
            Object.Width           =   3792
...
Function SetContractorAdd(XXX As String) As String
    ...
    Dim rsContractorAdd                                As ADODB.Recordset
    Set rsContractorAdd = New ADODB.Recordset
...
Sub InitMemVars()
    Dim rsRCNUMBER_Counter                             As ADODB.Recordset

    Set rsRCNUMBER_Counter = New ADODB.Recordset
    rsRCNUMBER_Counter.Open "select RC_NO from CSMS_PO_RC_HD order by RC_No desc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsRCNUMBER_Counter.EOF And Not rsRCNUMBER_Counter.BOF Then
        txtRcNumber.Text = Format(NumericVal(Mid$(rsRCNUMBER_Counter!RC_NO, 3, 6)) + 1, "000000")
    Else
...
Sub initCboPoNumber()
    ...
    If Not rsPoNumber.EOF And Not rsPoNumber.BOF Then
        ...
        Do While Not rsPoNumber.EOF
            Dim rsstatus                               As ADODB.Recordset
            Set rsstatus = gconDMIS.Execute("Select STATUS from CSMS_PO_RC_HD where PO_NO ='" & rsPoNumber!po_no & "' AND (STATUS = 'P' or STATUS = 'R' or STATUS is NULL)")
            If Not rsstatus.EOF And Not rsstatus.BOF Then
...
Sub FillInfo()
    Dim rsRetreivePO_HD                                As ADODB.Recordset
    ...
    If Not rsRetreivePO_HD.EOF And Not rsRetreivePO_HD.BOF Then
        ...
        Dim rsRC_PO_dt                                 As ADODB.Recordset

        Me.lstJobSublet.Sorted = True: Me.lstJobSublet.ListItems.Clear: Me.lstJobSublet.Enabled = False
        Set rsRC_PO_dt = New ADODB.Recordset
        Set rsRC_PO_dt = gconDMIS.Execute("select Line_No,DETCDE,DETDSC,DET_AMT,ID from CSMS_Po_Dt where Po_no = " & cboPoNumber.Text & " and livil = '1' order by LINE_NO asc")
        ...
        If Not rsRC_PO_dt.EOF And Not rsRC_PO_dt.BOF Then
            Do While Not rsRC_PO_dt.EOF
                ...
                ITEM.SubItems(2) = Null2String(rsRC_PO_dt!DETDSC)
...
Sub StoreMemvars()
    If Not rsINFO.EOF And Not rsINFO.BOF Then
        ...
        FillListview (txtRcNumber)

        getAPJ_NO Trim(txtReceive), Trim(txtInvNo)
        ...
        If Null2String(rsINFO!Status) = "P" Then
            ...
            '
            '            Set rsUnpostDisabled = gconDMIS.Execute("Select DTE_COMP from CSMS_repor where rep_or ='" & Null2String(rsINFO!RO_NO) & "' and dte_comp is null")
...
Sub editJobs()
    ...
    Dim rsCustname                                     As ADODB.Recordset
    ...
    Set rsEditJobs = gconDMIS.Execute("Select Rep_or,ROTYPE,JOBTYPE,DETCDE,DETDSC,DET_AMT,CONTRACTAMOUNT,COMPAMOUNT,WCODE,DETAIL from CSMS_PO_RC_DT where ID ='" & labDET & "'")
...
Sub deleteJobs()
    ...
    Dim RS_RR_RONUM                                    As ADODB.Recordset
    ...
    If Not rsPosted.EOF And Not rsPosted.BOF Then
        MsgBox "Cannot Delete this Job it's already Posted" & vbCrLf & "In Purchase Order Data Entry", vbOKOnly, "INFORMATION"
        Exit Sub
    End If
...
Sub FillListview(XXX As String)
    ...
    Set rsPO_dt = gconDMIS.Execute("select Line_No,DETCDE,DETDSC,DET_AMT,ID,LIVIL,CONTRACTAMOUNT,WCODE from CSMS_PO_RC_DT where RC_NO = " & XXX & " and livil = '1' order by LINE_NO asc")
    ...
    Set rsMaterials = gconDMIS.Execute("select Line_No,DETCDE,DETDSC,DET_AMT,ID,LIVIL,CONTRACTAMOUNT,WCODE from CSMS_PO_RC_DT where RC_NO = " & XXX & " and livil = '3' order by LINE_NO asc")
    ...
    Set rsParts = gconDMIS.Execute("select Line_No,DETCDE,DETDSC,DET_AMT,ID,LIVIL,CONTRACTAMOUNT,WCODE from CSMS_PO_RC_DT where RC_NO = " & XXX & " and livil = '2' order by LINE_NO asc")
...
Private Sub cboPoNumber_LostFocus()
    Dim rsCheckPo_IsInvoice                            As ADODB.Recordset
    Dim rsAlreadyInvoice                               As ADODB.Recordset
...
Private Sub cmdSave_Click()
    Dim rsRcNumDup                                     As ADODB.Recordset
    ...
    vtxtInvNo = N2Str2Null(txtInvNo.Text)
    vtxtRcNumber = N2Str2Null(txtRcNumber.Text)
    ...
    If ADDOREDIT = "ADD" Then
        Set rsRcNumDup = New ADODB.Recordset
        rsRcNumDup.Open "Select RC_NO from CSMS_PO_RC_HD where RC_NO = '" & txtRcNumber & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    ...
    Dim rsReceiveDetail                                As ADODB.Recordset
    ...
    Set rsReceiveDetail = New ADODB.Recordset

    rsReceiveDetail.Open "Select * from CSMS_PO_DT where PO_NO = '" & cboPoNumber & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
        ...
        If Not rsReceiveDetail.EOF And Not rsReceiveDetail.BOF Then
            Do While Not rsReceiveDetail.EOF
                ...
                gconDMIS.Execute "Insert into CSMS_PO_RC_DT " & _
                                 ...
                                 "values(" & vtxtRcNumber & "," & dtPONO & "," & dtRep_or & "," & dtROTYPE & "," & dtJOBTYPE & "," & dtLIVIL & ", " & dtLINE_NO & "," & dtDETAMT & ", " & dtDETCDE & "," & dtDETDSC & "," & dtTECHNICIAN & "," & dtWCODE & "," & dtTAXRATE & "," & dtTAXVAL & "," & dtSTATUS & "," & dtDETAIL & "," & dtDET_AMT & "," & Vusercode & ",'" & vSavedate & "'," & dtTECHCODE & "," & dtCONTRACTAMOUNT & "," & dtCOMPAMOUNT & "," & dtDONE & ")"
                'End If
    ...
    If ADDOREDIT = "ADD" Then
        SQL_STATEMENT = "insert into CSMS_PO_RC_HD" & _
                        ...
                        "values(" & vtxtRcNumber & "," & vDTPicker2 & "," & vcboPoNumber & "," & dtRep_or & "," & vDTPicker1 & ", " & vtxtReceive & "," & vcboContractor & ", " & vtxtContractorAdd & ", " & vtxtTotalAmount & ", " & vtxtVatAmount & ", " & vtxtNetAmount & "," & vtxtInvNo & "," & vtxtDelReceipt & "," & Vusercode & ", '" & vSavedate & "'," & VStatus & ")"
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
...
Private Sub optRCNo_Click()
    ...
    txtSearch.BackColor = vbYellow
    txtSearch.SetFocus
    Dim rsoptRCNUM                                     As ADODB.Recordset
...
Private Sub optContractor_Click()
    ...
    txtSearch.BackColor = vbYellow
    txtSearch.SetFocus
    Dim rsoptContractor                                As ADODB.Recordset
    lvwTran.Enabled = False
    lvwTran.Sorted = False: lvwTran.ListItems.Clear
    Set rsoptContractor = gconDMIS.Execute("Select contractor_name,ID from CSMS_PO_RC_HD order by contractor_name asc")
...
Private Sub txtSearch_Change()
    ...
    Dim rcNUMBER, rcNUMBER2, rcNUMBER3                 As String
    ...
    If optRCNo.Value = True Then
        ...
        If txtSearch = "" Then
            lvwTran.Enabled = False
            lvwTran.Sorted = False: lvwTran.ListItems.Clear
            Set rsSearch = gconDMIS.Execute("Select top 30 C_NO ,ID from CSMS_PO_RC_HD order by RC_NO desc ")
...
Function CheckIfImported(xVendorCode As String, xInvoiceNo As String) As Boolean
    Dim rsImported                                     As ADODB.Recordset
