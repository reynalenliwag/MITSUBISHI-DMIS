...
Begin VB.Form frmCRIS_SearchVehicleInfo 
   ...
   ControlBox      =   0   'False
   ForeColor       =   &H00FCFCFC&
   Icon            =   "SearchVehicleInfo.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
      ...
      Begin VB.PictureBox Picture9 
         ...
         Begin MSComctlLib.ListView lstIgnitionKey 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleInfo.frx":0616
            NumItems        =   6
      ...
      Begin VB.PictureBox Picture7 
         ...
         Begin MSComctlLib.ListView lstProdNo 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleInfo.frx":0930
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Prod No"
               Object.Width           =   5380
      ...
      Begin VB.PictureBox Picture5 
         ...
         Begin MSComctlLib.ListView lstDesc 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleInfo.frx":0C4A
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Description"
               Object.Width           =   6625
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin MSComctlLib.ListView lstModel 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleInfo.frx":0F64
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Model"
               Object.Width           =   5381
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin MSComctlLib.ListView lstMake 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "SearchVehicleInfo.frx":127E
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "Make"
               Object.Width           =   5380
   ...
   End
End
Attribute VB_Name = "frmCRIS_SearchVehicleInfo"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyEscape Then
        Select Case SEARCH_TAB
            Case 0: If Trim(txtMake) <> "" Then On Error Resume Next: txtMake.SetFocus Else Unload Me
            Case 1: If Trim(txtModel) <> "" Then On Error Resume Next: txtModel.SetFocus Else Unload Me
            Case 2: If Trim(txtDesc) <> "" Then On Error Resume Next: txtDesc.SetFocus Else Unload Me
            Case 3: If Trim(txtProdNo) <> "" Then On Error Resume Next: txtProdNo.SetFocus Else Unload Me
            Case 4: If Trim(txtIgnitionKey) <> "" Then On Error Resume Next: txtIgnitionKey.SetFocus Else Unload Me
        End Select
    End If
    If Shift = 2 Then
        Select Case KeyCode
...
Private Sub lstIgnitionKey_DblClick()
    frmCRIS_InquiryVehicleCatalogue.SearchID (Trim(Me.lstIgnitionKey.SelectedItem.SubItems(5)))
    Unload Me
End Sub
...
Private Sub LstModel_DblClick()
    frmCRIS_InquiryVehicleCatalogue.SearchID (Trim(Me.lstModel.SelectedItem.SubItems(5)))
    Unload Me
End Sub
...
Private Sub lstProdNo_DblClick()
    frmCRIS_InquiryVehicleCatalogue.SearchID (Trim(Me.lstProdNo.SelectedItem.SubItems(5)))
    Unload Me
End Sub
...
Private Sub txtIgnitionKey_Change()
    lstIgnitionKey.Enabled = False: Me.lstIgnitionKey.Sorted = False: Me.lstIgnitionKey.ListItems.Clear
...
Private Sub LstMake_DblClick()
    ...
    frmCRIS_InquiryVehicleCatalogue.SearchID (Trim(Me.lstMake.SelectedItem.SubItems(5)))
    Unload Me
End Sub
...
Private Sub txtMake_Change()
    If txtMake = "" Then
        ...
        lstMake.Enabled = False: Me.lstMake.Sorted = False: Me.lstMake.ListItems.Clear
        Set rsMRRINV = New ADODB.Recordset
...
Private Sub LstDesc_DblClick()
    frmCRIS_InquiryVehicleCatalogue.SearchID (Trim(Me.lstDesc.SelectedItem.SubItems(5)))
    Unload Me
End Sub
...
Private Sub txtDesc_Change()
    If txtDesc = "" Then
        lstDesc.Enabled = False: Me.lstDesc.Sorted = False: Me.lstDesc.ListItems.Clear
        Set rsMRRINV = New ADODB.Recordset
