...
Begin VB.Form frmCRIS_Customer 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "ALL_Customers.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   58
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   785
         MouseIcon       =   "ALL_Customers.frx":0D7B
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":0ECD
         Style           =   1  'Graphical
         TabIndex        =   64
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1540
         MouseIcon       =   "ALL_Customers.frx":1225
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":1377
         Style           =   1  'Graphical
         TabIndex        =   65
         Top             =   45
         Width           =   705
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3865
         MouseIcon       =   "ALL_Customers.frx":1671
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":17C3
         Style           =   1  'Graphical
         TabIndex        =   59
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4620
         MouseIcon       =   "ALL_Customers.frx":1AD6
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":1C28
         Style           =   1  'Graphical
         TabIndex        =   60
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   5375
         MouseIcon       =   "ALL_Customers.frx":1F84
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":20D6
         Style           =   1  'Graphical
         TabIndex        =   61
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   6130
         MouseIcon       =   "ALL_Customers.frx":2401
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":2553
         Style           =   1  'Graphical
         TabIndex        =   62
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   6885
         MouseIcon       =   "ALL_Customers.frx":28B9
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":2A0B
         Style           =   1  'Graphical
         TabIndex        =   63
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3080
         MouseIcon       =   "ALL_Customers.frx":2D71
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":2EC3
         Style           =   1  'Graphical
         TabIndex        =   67
         Top             =   45
         Width           =   735
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2295
         MouseIcon       =   "ALL_Customers.frx":3213
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":3365
         Style           =   1  'Graphical
         TabIndex        =   66
         Top             =   45
         Width           =   735
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "ALL_Customers.frx":36C3
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":3815
         Style           =   1  'Graphical
         TabIndex        =   69
         Top             =   30
         Width           =   705
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   765
         MouseIcon       =   "ALL_Customers.frx":3B65
         MousePointer    =   99  'Custom
         Picture         =   "ALL_Customers.frx":3CB7
         Style           =   1  'Graphical
         TabIndex        =   70
         Top             =   30
         Width           =   705
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstCustomer 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "ALL_Customers.frx":3FF5
         NumItems        =   2
