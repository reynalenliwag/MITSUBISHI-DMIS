...
Begin VB.Form frmCSMS_EditAppCustomerSearch 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Search Customer for Appointment"
   ClientHeight    =   6645
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7350
   ForeColor       =   &H00FFC0C0&
   Icon            =   "EditApp_CustomerSearch.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.ListView lstCustomer 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "EditApp_CustomerSearch.frx":030A
      NumItems        =   10
   ...
   Begin VB.CommandButton cmdAdd 
      ...
      Height          =   915
      Left            =   6480
      MouseIcon       =   "EditApp_CustomerSearch.frx":046C
      MousePointer    =   99  'Custom
      Picture         =   "EditApp_CustomerSearch.frx":05BE
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   915
      Left            =   5640
      MouseIcon       =   "EditApp_CustomerSearch.frx":08D1
      MousePointer    =   99  'Custom
      Picture         =   "EditApp_CustomerSearch.frx":0A23
      Style           =   1  'Graphical
      TabIndex        =   10
      ToolTipText     =   "Cancel"
      Top             =   5700
   ...
   Begin VB.CommandButton cmdSelect 
      ...
      Height          =   915
      Left            =   4800
      MouseIcon       =   "EditApp_CustomerSearch.frx":0D61
      MousePointer    =   99  'Custom
      Picture         =   "EditApp_CustomerSearch.frx":0EB3
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   End
End
Attribute VB_Name = "frmCSMS_EditAppCustomerSearch"
...
Private Sub cmdSelect_Click()
    ...
    If Trim(txtCode.Text) <> "" Then
        frmCSMSEditAppointment.txtAcct_No = txtCode.Text
        frmCSMSEditAppointment.SetCustomer
        Unload Me
    End If
    Exit Sub
Errorcode:
