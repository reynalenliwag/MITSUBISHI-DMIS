    ...
    If AddorEdit = "ADD" Then
        ...
        If xJOURNALTYPE = "CDJ" Then
            ...
            SQL_STATEMENT = "insert into AMIS_CV_Detail " & _
                            ...
                            ", " & PV_STATUS & "," & PV_VENDORCODE & "," & J_CLASS & ", " & N2Str2Null(lblInvoiceNo.Caption) & "," & N2Str2Null(lblInvoiceType.Caption) & "," & labID.Caption & ")"
...
SaveJournalDetails:
            ...
            If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Then
...
Private Sub optPrintCheck_Click()
    If optPrintCheck.Value = True Then
        ...
        If COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Then
            picAlterName.Visible = True
...
Function GET_AP_VOUCHERNO() As Boolean
    ...
    rsAP_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.JTYPE+'-'+HD.VOUCHERNO AS INVOICENO,HD.CHECKDATE AS INVOICEDATE,HD.DUEDATE,ACCT_CODE,DET.CREDIT " & _
                      ...
                      "WHERE LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-06','21-07') AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & " AND HD.STATUS='N'", gconDMIS, adOpenKeyset
    If Not rsAP_VOUCHER.EOF And Not rsAP_VOUCHER.BOF Then
