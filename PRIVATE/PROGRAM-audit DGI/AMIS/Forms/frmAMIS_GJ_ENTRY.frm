...
Begin VB.Form frmAMISJournalEntry_GJDetails 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   60
      Width           =   9615
      Begin VB.CheckBox chkReclass 
         Appearance      =   0  'Flat
         Caption         =   " Reclass Account"
...
Function GET_VOUCHERNO_JTYPE(xVOUCHERNO As String, xJType As String) As String
    ...
    If xJType = "CDJ" Or xJType = "APJ" Or xJType = "VPJ" Then
        ...
        'rsVOUCHERNO_JTYPE.Open "SELECT * FROM (SELECT VENDOR_CODE AS CODE,ISNULL(ENTITYCODE,'') AS ENTITYCODE,VOUCHERNO,ACCT_CODE FROM AMIS_AP UNION SELECT CUSTOMERCODE AS CODE,'C' AS ENTITYCODE,SJVOUCHERNO AS VOUCHERNO,ACCOUNT_CODE AS ACCT_CODE FROM AMIS_AR)T WHERE VOUCHERNO='" & xJType + "-" + xVOUCHERNO & "' AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenForwardOnly
        ENTITYCODE = "V"
    ElseIf xJType = "CRJ" Or xJType = "SJ" Or xJType = "COB" Then
        ...
        'rsVOUCHERNO_JTYPE.Open "SELECT COUNT(ACCT_CODE) FROM AMIS_AP WHERE VOUCHERNO='" & xJType + "-" + xVOUCHERNO & "' GROUP BY ACCT_CODE", gconDMIS, adOpenForwardOnly
        'rsVOUCHERNO_JTYPE.Open "SELECT * FROM (SELECT VENDOR_CODE AS CODE,ISNULL(ENTITYCODE,'') AS ENTITYCODE,VOUCHERNO,ACCT_CODE FROM AMIS_AP UNION SELECT CUSTOMERCODE AS CODE,'C' AS ENTITYCODE,SJVOUCHERNO AS VOUCHERNO,ACCOUNT_CODE AS ACCT_CODE FROM AMIS_AR)T WHERE VOUCHERNO='" & xJType + "-" + xVOUCHERNO & "' AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenForwardOnly
        ENTITYCODE = "C"
    Else
        rsVOUCHERNO_JTYPE.Open "SELECT CUSTOMERCODE AS CODE FROM AMIS_JOURNAL_HD WHERE VOUCHERNO='" & xVOUCHERNO & "' AND JTYPE= '" & xJType & "' AND STATUS='P'", gconDMIS, adOpenForwardOnly
    ...
    If Not rsVOUCHERNO_JTYPE.EOF And Not rsVOUCHERNO_JTYPE.BOF Then
        If ENTITYCODE <> "" Then
            ...
            'labClass = N2String(rsVOUCHERNO_JTYPE!ENTITYCODE) & txtCode.Text
        End If
...
Function GET_VOUCHERNO_JTYPE2(xVOUCHERNO As String, xJType As String) As String
    Dim rsVOUCHERNO_JTYPE                                   As ADODB.Recordset
    Dim rsENTITY_NAME                                       As ADODB.Recordset
    Set rsVOUCHERNO_JTYPE = New ADODB.Recordset
    If xJType = "CDJ" Or xJType = "APJ" Or xJType = "VPJ" Then
...
Private Sub cboGJAccountNo_LostFocus()
    ...
    'Call GET_VOUCHERNO_JTYPE2(cboCDJNo.Text, cboJTYPE.Text)
End Sub
...
Function DetailPosting() As Boolean
    ...
    If CHECK_IF_AR_SCHED(cboGJAccountNo.Text) = True Then
        If cboCDJNo.Text <> "" And cboJTYPE.Text <> "" Then
            ...
            Dim rsGJGJ                                      As ADODB.Recordset
            Set rsGJGJ = New ADODB.Recordset
            rsGJGJ.Open "SELECT SUM(DEBIT) AS DEBIT FROM AMIS_JOURNAL_DET WHERE INVOICENO = " & N2Str2Null(cboCDJNo.Text) & " AND INVOICETYPE = " & N2Str2Null(cboJTYPE.Text) & " AND ACCT_CODE = " & N2Str2Null(cboGJAccountNo.Text) & " AND ID <> " & NumericVal(frmAMISJournalEntry_GJ.labDET.Caption) & "", gconDMIS, adOpenKeyset
            If Not rsGJGJ.EOF And Not rsGJGJ.BOF Then
                GJ_DEBIT = NumericVal(rsGJGJ!Debit)
            End If
            Set rsGJGJ = Nothing
            ...
            If Not rsCOMPUTE_AMOUNT.EOF And Not rsCOMPUTE_AMOUNT.BOF Then
                ...
                ElseIf NumericVal(txtGJCredit.Text) <> 0 Then
                    GJ_XXX_SUM = Round((NumericVal(rsCOMPUTE_AMOUNT!GJ_SUM - GJ_DEBIT) + NumericVal(txtGJCredit.Text)), 2)
                End If
            End If
            Set rsCOMPUTE_AMOUNT = Nothing

            'TEMPORARY COMMENT FOR DGI POSTING
            '            If XXX_SUM <> 0 Then
    ...
    'Temporarily disable for checking
    '        If chkReclass.Value = False Then
    '            Dim rsACCTCODE As ADODB.Recordset
    '            Set rsACCTCODE = New ADODB.Recordset
    '            rsACCTCODE.Open ("SELECT DT.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DT ON HD.VOUCHERNO=DT.VOUCHERNO AND HD.JTYPE=DT.JTYPE INNER JOIN AMIS_CHARTACCOUNT AC ON DT.ACCT_CODE=AC.ACCTCODE WHERE HD.STATUS='P' AND AC.IS_SCHEDULE_ACCNT=1 AND HD.VOUCHERNO='" & cboCDJNo.Text & "' AND HD.JTYPE='" & cboJTYPE & "'"), gconDMIS, adOpenForwardOnly
    '            If Not rsACCTCODE.EOF And Not rsACCTCODE.BOF Then
    '                If cboJTYPE.Text = "APJ" And NumericVal(txtGJDebit.Text) > 0 Then
    '                    GoTo ma
    '                ElseIf cboJTYPE.Text = "CDJ" And NumericVal(txtGJCredit.Text) > 0 Then
    '                    GoTo ma
    '                ElseIf cboJTYPE.Text = "SJ" And NumericVal(txtGJCredit.Text) > 0 Then
    '                    GoTo ma
    '                ElseIf cboJTYPE.Text = "CRJ" And NumericVal(txtGJDebit.Text) > 0 Then
    '                    GoTo ma
    '                Else
    '                    GoTo ellaine
    '                End If
    '
    'ma:                 If cboGJAccountNo.Text <> rsACCTCODE!ACCT_CODE Then
    ...
    rsCheckEntity.Open "SELECT VENDOR_CODE AS ENTITY FROM AMIS_AP WHERE VOUCHERNO='" & cboJTYPE.Text + "-" + cboCDJNo.Text & "' AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenForwardOnly
    ...
    If AddorEdit = "ADD" Then
        ...
        NEW_LogAudit "AA", "GENERAL JOURNAL", SQL_STATEMENT, frmAMISJournalEntry_GJ.labID.Caption, "", frmAMISJournalEntry_GJ.txtVoucherNo, xJOURNALTYPE, frmAMISJournalEntry_GJ.txtJNo
    ...
    Else
        ...
        NEW_LogAudit "EE", "GENERAL JOURNAL", SQL_STATEMENT, frmAMISJournalEntry_GJ.labID.Caption, "", frmAMISJournalEntry_GJ.txtVoucherNo, xJOURNALTYPE, frmAMISJournalEntry_GJ.txtJNo
...
Private Sub lvwInvNo_DblClick()
    If lvwInvNo.ListItems.Count > 0 Then
...
Sub FIND_JOURNAL_NO(xJType As String)
    ...
    If xJType = "CDJ" Then
        ...
        'rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,3) = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "APJ" Then
        rsFIND_JOURNAL_NO.Open "SELECT VOUCHERNO FROM AMIS_JOURNAL_HD WHERE JTYPE = " & N2Str2Null(xJType) & " AND STATUS = 'P'", gconDMIS, adOpenKeyset
        'rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,3) = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "CRJ" Then
        rsFIND_JOURNAL_NO.Open "SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_JOURNAL_HD WHERE JTYPE = " & N2Str2Null(xJType) & " AND STATUS = 'P'", gconDMIS, adOpenKeyset
        'rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,3) = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "GJ" Then
        ...
        'rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,2) = 'GJ' AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "SJ" Then
        rsFIND_JOURNAL_NO.Open "SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_JOURNAL_HD WHERE JTYPE = " & N2Str2Null(xJType) & " AND STATUS = 'P'", gconDMIS, adOpenKeyset
        'rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,2) = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
...
Sub FIND_JOURNAL_NO2(xJType As String)
    Dim rsFIND_JOURNAL_NO                                   As ADODB.Recordset
    Set rsFIND_JOURNAL_NO = New ADODB.Recordset
    ...
    ElseIf xJType = "GJ" Then
        rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,2) = 'GJ' AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "SJ" Then
        rsFIND_JOURNAL_NO.Open "SELECT DISTINCT * FROM (SELECT RIGHT(VOUCHERNO,6) AS VOUCHERNO,ACCT_CODE,LEFT(VOUCHERNO,2) AS JTYPE FROM AMIS_AP UNION SELECT RIGHT(SJVOUCHERNO,6) AS VOUCHERNO, ACCOUNT_CODE AS ACCT_CODE,LEFT(SJVOUCHERNO,2) AS JTYPE FROM AMIS_AR)T WHERE JTYPE = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "COB" Then
        rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,3) = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
    ElseIf xJType = "OTH" Then
        rsFIND_JOURNAL_NO.Open "SELECT DISTINCT RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP WHERE LEFT(VOUCHERNO,3) = " & N2Str2Null(xJType) & " AND ACCT_CODE='" & cboGJAccountNo.Text & "'", gconDMIS, adOpenKeyset
...
Sub FIND_SUB_DETAIL_REFERENCE()
    ...
    If RTrim(LTrim(cboJTYPE.Text)) = "CRJ" Or RTrim(LTrim(cboJTYPE.Text)) = "CDJ" Or RTrim(LTrim(cboJTYPE.Text)) = "GJ" Then
        If Not rsCHECK_MULTI_DETAIL.EOF And Not rsCHECK_MULTI_DETAIL.BOF Then
            If NumericVal(rsCHECK_MULTI_DETAIL!XXX_COUNT) > 1 Then
                ...
                ElseIf RTrim(LTrim(cboJTYPE.Text)) = "GJ" Then
                    Set rsDetails = New ADODB.Recordset
                    rsDetails.Open "SELECT ADJ_VOUCHERNO,ADJ_JTYPE FROM AMIS_JOURNAL_DET WHERE VOUCHERNO = '" & cboCDJNo.Text & "' AND JTYPE = 'GJ' AND ADJ_VOUCHERNO IS NOT NULL ORDER BY ADJ_VOUCHERNO", gconDMIS, adOpenKeyset
                    If Not rsDetails.EOF And Not rsDetails.BOF Then
                        Do While Not rsDetails.EOF
