...
Sub FillCboAcctName()
    Dim rsCOBAcctName                                       As ADODB.Recordset
    Set rsCOBAcctName = New ADODB.Recordset
    Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where Titles IN ('2101','2102','2104','2106','2107') AND ISNULL(IS_SCHEDULE_ACCNT,0) = 1 and Description IS NOT NULL Order by AcctCode asc")
    If Not rsCOBAcctName.EOF And Not rsCOBAcctName.BOF Then
