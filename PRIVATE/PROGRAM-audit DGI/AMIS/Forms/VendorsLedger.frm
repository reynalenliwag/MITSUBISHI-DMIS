...
Sub FillGrids()
    ...
    If cboAccountName.Text = "ALL ACCOUNTS" Then
        rsJournal_HDDet.Open "select DET.ID as DET_ID,DET.INVOICENO as DET_INV,DET.INVOICETYPE as DET_INV_TYPE, HD.Debit AS DM,HD.Credit AS CM,HD.AmountToPay,(SELECT TOP 1 INV_NO FROM AMIS_PV_DETAIL WHERE JTYPE=HD.JTYPE AND VOUCHERNO=HD.VOUCHERNO) AS INVOICENO, " & _
                             ...
                             "where ((((Left(DET.Acct_Code,5) = '21-01' or Left(DET.Acct_Code,5) = '21-02' or Left(DET.Acct_Code,5) = '21-07'or Left(DET.Acct_Code,5) = '21-06') OR " & _
                             "(DET.JTYPE = 'GJ' and DET.acct_code in('21-01','21-02','21-07','21-06') and DET.ADJ_JTYPE <> 'SJ') OR((HD.JTYPE = 'VCJ' AND HD.Debit = 0)) " & _
                             "OR (HD.JTYPE ='VDJ' AND HD.Credit = 0)) AND HD.VendorCode = '" & txtCode.Text & "') OR (HD.JTYPE = 'GJ' and LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') " & _
    ...
    Else
        rsJournal_HDDet.Open "select DET.ID as DET_ID,DET.INVOICENO as DET_INV,DET.INVOICETYPE as DET_INV_TYPE, HD.Debit AS DM,HD.Credit AS CM,HD.AmountToPay,(SELECT TOP 1 INV_NO FROM AMIS_PV_DETAIL WHERE JTYPE=HD.JTYPE AND VOUCHERNO=HD.VOUCHERNO) AS INVOICENO, " & _
                             ...
                             "where ((((Left(DET.Acct_Code,5) = '21-01' or Left(DET.Acct_Code,5) = '21-02' or Left(DET.Acct_Code,5) = '21-07'or Left(DET.Acct_Code,5) = '21-06') OR " & _
                             "(DET.JTYPE = 'GJ' and DET.acct_code in('21-01','21-02','21-07','21-06') and DET.ADJ_JTYPE <> 'SJ') OR((HD.JTYPE = 'VCJ' AND HD.Debit = 0)) " & _
                             "OR (HD.JTYPE ='VDJ' AND HD.Credit = 0)) AND HD.VendorCode = '" & txtCode.Text & "') OR (HD.JTYPE = 'GJ' and LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-06','21-07') " & _
