...
Begin VB.Form frmAMISJournalEntry_VDM 
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      TabPicture(0)   =   "frmAMISJournalEntry_VDM.frx":08CA
      ...
      TabPicture(1)   =   "frmAMISJournalEntry_VDM.frx":08E6
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8315
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":0902
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":0A54
            Style           =   1  'Graphical
            TabIndex        =   160
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":0D92
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":0EE4
            Style           =   1  'Graphical
            TabIndex        =   143
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               Enabled         =   -1  'True
               MultiLine       =   0   'False
               TextRTF         =   $"frmAMISJournalEntry_VDM.frx":120F
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":12A2
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":13F4
            Style           =   1  'Graphical
            TabIndex        =   159
            Top             =   765
            Width           =   705
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_VDM.frx":1744
      End
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   8400
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":1760
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":18B2
            Style           =   1  'Graphical
            TabIndex        =   116
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":1BF0
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":1D42
            Style           =   1  'Graphical
            TabIndex        =   114
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7710
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":206D
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":21BF
            Style           =   1  'Graphical
            TabIndex        =   115
            Top             =   690
            Width           =   705
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_VDM.frx":250F
      End
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":252B
            NumItems        =   7
      ...
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":268D
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VDM.frx":27EF
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picDisbursement 
         ...
         Begin RichTextLib.RichTextBox txtParticulars 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VDM.frx":2886
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VDM.frx":291A
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8820
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":29B1
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":2B03
         Style           =   1  'Graphical
         TabIndex        =   176
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8070
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":2E69
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":2FBB
         Style           =   1  'Graphical
         TabIndex        =   175
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7320
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":3321
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":3473
         Style           =   1  'Graphical
         TabIndex        =   174
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6540
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":37AD
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":38FF
         Style           =   1  'Graphical
         TabIndex        =   173
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5790
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":3C44
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":3D96
         Style           =   1  'Graphical
         TabIndex        =   172
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5040
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":40BB
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":420D
         Style           =   1  'Graphical
         TabIndex        =   171
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4290
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":4569
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":46BB
         Style           =   1  'Graphical
         TabIndex        =   170
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":49CE
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":4B20
         Style           =   1  'Graphical
         TabIndex        =   169
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":4E70
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":4FC2
         Style           =   1  'Graphical
         TabIndex        =   168
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2040
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":5320
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":5472
         Style           =   1  'Graphical
         TabIndex        =   167
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1290
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":576C
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":58BE
         Style           =   1  'Graphical
         TabIndex        =   166
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   540
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":5C16
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":5D68
         Style           =   1  'Graphical
         TabIndex        =   165
...
Private Sub cmdSave_Click()
    ...
    If txtJDate.Text = "" Or IsDate(txtJDate.Text) = False Then
        ...
        Exit Sub
    End If
    If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "VDJ" Then
        If COMPANY_CODE = "HMH" Then
            'Updated by: ACL 10202009
            If CheckIfOpen(xJOURNALTYPE, Trim(txtJDate.Text), Year(txtJDate.Text)) = False Then
                MsgBox "Warning: Action not authorized!", vbExclamation, "Error!"
