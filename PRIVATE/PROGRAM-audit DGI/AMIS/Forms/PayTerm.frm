...
Sub rsRefresh()
    ...
    rsPayTerm.Open "select * from ALL_PayTerm order by NO_DAYS asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Private Sub FillGrid()
    ...
    Set rsPayTerm2 = New ADODB.Recordset
    Set rsPayTerm2 = gconDMIS.Execute("select pay_code,pay_desc,no_days,ID from ALL_PayTerm ORDER BY NO_DAYS")
