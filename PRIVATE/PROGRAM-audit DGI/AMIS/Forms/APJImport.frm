...
Private Sub cmdCheck_Click()
    ...
    If COMPANY_CODE = "HCA" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Then
...
InitGrids:     DoEvents: cmdCheck.Enabled = False: cmdClearJournals.Enabled = False
    Grid1.Rows = 1: Grid2.Rows = 1: Grid3.Rows = 1: KIM = 0
    ...
    If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "HGH" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "HQA" Then
