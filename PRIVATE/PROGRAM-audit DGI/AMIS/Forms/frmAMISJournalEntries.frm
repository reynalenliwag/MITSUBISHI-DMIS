...
Function JournalEntriesNew() As Boolean
    ...
    If AddorEdit = "ADD" Then
        SQL_STATEMENT = "insert into AMIS_Journal_Det " & _
                        "(jdate,voucherno,jtype,jno,jitemno,acct_code,acct_name,debit,credit,tax,status,ATC,RATE,TAXBASE,INVOICENO,INVOICETYPE,ENTITY,ADJ_VOUCHERNO,ADJ_JTYPE,Adj_Remarks,IS_OTHERS,JOURNAL_HD_ID)" & _
                        " values (" & J_JDATE & ", " & J_VOUCHERNO & ", " & J_JTYPE & _
                        ", " & J_JNO & ", " & J_JITEMNO & ", " & J_ACCT_CODE & ", " & J_ACCT_NAME & ", " & J_DEBIT & _
                        ", " & J_CREDIT & ", " & J_TAX & ", " & J_STATUS & "," & J_ATC & "," & J_RATE & "," & J_TAXBASE & "," & J_INVOICENO & "," & J_INVOICETYPE & "," & J_CUSCDE & "," & xADJ_VOUCHERNO & "," & xADJ_TYPE & ", " & xADJ_REMARKS & "," & xIS_OTHERS & "," & frmAMISJournalEntry_GJ.labID.Caption & ")"
        gconDMIS.Execute SQL_STATEMENT
