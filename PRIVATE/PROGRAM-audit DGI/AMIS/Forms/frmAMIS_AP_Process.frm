        ...
        If ReportOption = "Schedule" Then
            ...
            ElseIf optAccount.Value = True Then
                ...
                Else
                    ...
                    If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Then
...
Private Sub optAccount_Click()
    If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Then
        ...
        rsChartOfAccounts.Open "SELECT ACCTCODE,DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('21-01','21-02','21-07','21-06') AND IS_SCHEDULE_ACCNT=1", gconDMIS, adOpenKeyset
...
Function Setacctcode(xDescription As String) As String
    ...
    rsDescription.Open "SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('21-01','21-02','21-07','21-06') AND IS_SCHEDULE_ACCNT=1 AND DESCRIPTION = '" & xDescription & "'", gconDMIS, adOpenKeyset
