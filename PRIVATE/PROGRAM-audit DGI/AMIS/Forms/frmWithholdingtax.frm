...
Private Sub Form_Load()
    ...
    rsMAX_MIN_DATE.Open "SELECT MAX(ISNULL(JDATE,GETDATE())) AS MAX_JDATE, MIN(ISNULL(JDATE,GETDATE())) AS MIN_JDATE FROM AMIS_JOURNAL_HD WHERE STATUS = 'P'", gconDMIS, adOpenKeyset
