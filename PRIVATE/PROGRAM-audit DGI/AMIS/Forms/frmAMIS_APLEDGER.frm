...
Sub LOAD_ACCT_CODE()
    ...
    rsLOAD_ACCT_CODE.Open "SELECT DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('21-01','21-02','21-04','21-06','21-07')", gconDMIS, adOpenKeyset
...
Sub LOAD_AP_ENTITY()
    ...
    If Not rsLOAD_AP.EOF And Not rsLOAD_AP.BOF Then
        Do While Not rsLOAD_AP.EOF
            ...
            End If
            If xVOUCHERNO = "VPJ" Or xVOUCHERNO = "APJ" Or xVOUCHERNO = "CDJ" Or xVOUCHERNO = "GJ" Or xVOUCHERNO = "SJ" Or xVOUCHERNO = "CRJ" Then
                Set REC = rptLEDGER.Records.Add
