                ...
                Else
                    ...
                    If PMIOS_TYPE = "M" Then
                        If PMIOS_PAY_CLASS = "C" Then
                            ...
                            ElseIf PMIOS_TRANTYPE = "DR" And COMPANY_CODE = "HGC" Or COMPANY_CODE = "HGH" Then
                                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("AP", "BRANCH"))
                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("AP", "BRANCH")))
                            ElseIf COMPANY_CODE = "HOT" Then
                                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LUBRICANTS"))
                    ...
                    Else
                        ...
                        If PMIOS_PAY_CLASS = "C" Then
                            If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HOT" Then
                        ...
                        Else
                            ...
                            End If
                        End If
                        If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HOT" Or COMPANY_CODE = "HAS" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HGH" Then
...
Sub INITIALIZE_ACCESSORIESCOST(XXX As String)
    If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Then
        Set rsCSMIOS_ACCESSORIES = New ADODB.Recordset
...
Private Sub cmdCheck_Click()
    ...
    If COMPANY_CODE = "HCA" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Then
...
Sub ImportSalesNew()
    ...
    For GridImport = 1 To Grid2.Rows - 1
        If N2Str2Zero(Grid2.Cell(GridImport, 1).Text) = 0 Then
            Call ImportSales2("SALES", "SERVICE", Grid2.Cell(GridImport, 2).Text, CDate(dtpTranDate))
            ImportSales
            Grid2.Cell(GridImport, 1).Text = 1
        End If
        i = i + 1
...
ImportINTRO:
                    ItemCnt = 0
                    'If rsCSMIOS_REPOR!REP_OR = "R-00069578" Then Stop
                    ...
                    If COMPANY_CODE = "HCI" And CSMIOS_PARTICIPAT <> "" Then
                        J_INVOICEAMT = Round(NumericVal(CSMIOS_ACCESSORIES), 2)
                        J_BALANCE = Round(NumericVal(CSMIOS_ACCESSORIES), 2)
                    Else
                        J_INVOICEAMT = Round(NumericVal(CSMIOS_RO_AMOUNT), 2)
                        J_BALANCE = Round(NumericVal(CSMIOS_RO_AMOUNT), 2)
                    End If
                    ...
                    If J_INVOICEAMT > 0 Then
                        'SALES SERVICE
                        '---AL FOR HCC COMBINED ACCOUNTS IN SERVICE
                        If (COMPANY_CODE = "HCC" Or COMPANY_CODE = "HCA") And (CSMIOS_PMS <> 0 Or CSMIOS_SUBLET <> 0 Or CSMIOS_LABOR <> 0) Then
                            ...
                            If CSMIOS_LABOR + CSMIOS_PMS > 0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        Else
                                            J_NET = Round(NumericVal(CSMIOS_LABOR + CSMIOS_PMS) - Round(NumericVal(J_TAX), 2), 2)
                                        End If
                                    End If
                                End If
                                J_DEBIT = 0
                        ...
                        'PMS
                        If COMPANY_CODE = "HCC" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HCA" Then
                        Else
                            If CSMIOS_PMS > 0 Then
                                ...
                                If CSMIOS_TERM = "CSH" Then
                                    ...
                                    If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "DGI" Then
                                        ...
                                        J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "LABOR", "RETAIL")))
                                    ElseIf COMPANY_CODE = "HOT" Then
                                        J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LABOR", "QS DIAG"))
                                        J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "LABOR", "QS DIAG")))
                                    Else
                                    ...
                                    Else
                                        ...
                                        If CSMIOS_TERM = "CSH" Then
                                            If COMPANY_CODE = "HSB" Or COMPANY_CODE = "DGI" Then
                                                ...
                                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LABOR", "RETAIL")))
                                            ElseIf COMPANY_CODE = "HOT" Then
                                                J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LABOR", "QS DIAG"))
                                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LABOR", "QS DIAG")))
                        ...
                        If COMPANY_CODE = "HCC" Or COMPANY_CODE = "HCA" Then
                            If CSMIOS_PARTS > 0 Or CSMIOS_MATERIALS > 0 Or CSMIOS_ACCESSORIES > 0 Then
                                ...
                                Call InsertToJournalDet(J_JDATE, J_VOUCHERNO, J_JTYPE, J_JNO, J_JITEMNO, J_ACCT_CODE, J_ACCT_NAME, J_DEBIT, J_CREDIT, J_TAX, J_GROSS, J_NET, J_STATUS)
                                'COST OF SALES
                                If Round(CSMIOS_PARTS_COST + CSMIOS_MATERIALS_COST + CSMS_ACCCOST, 2) > 0 Then
                                    ItemCnt = ItemCnt + 1: J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
                                    J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "PARTS", "RETAIL"))
                                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "PARTS", "RETAIL")))
                        ...
                        Else
                            If CSMIOS_PARTS > 0 Then
                                ...
                                If CSMIOS_TERM = "CSH" Then
                                    ...
                                    ElseIf COMPANY_CODE = "HOT" Then
                                        If CSMIOS_PMS <> 0 Then
                                            J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "PARTS", "QS DIAG"))
                                            J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "PARTS", "QS DIAG")))
                                        End If
                                    Else
                                        J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "PARTS", "RETAIL"))
                                        J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "PARTS", "RETAIL")))
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        If COMPANY_CODE = "DGI" Then
                                            J_NET = (Round(NumericVal(CSMIOS_PARTS - CSMIOS_PARTS_DISCOUNT) / 1.12, 2))    '+ Round(CSMIOS_LABOR_DISCOUNT / 1.12, 2)
                                        Else
                                ...
                                Else
                                    ...
                                    If CSMIOS_TERM = "CSH" Then
                                        ...
                                        ElseIf COMPANY_CODE = "HOT" Then
                                            If CSMIOS_PMS <> 0 Then
                                                J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "PARTS", "QS DIAG"))
                                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "PARTS", "QS DIAG")))
                                            End If
                                        Else
                                            J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "PARTS", "RETAIL"))
                                            J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "PARTS", "RETAIL")))
                                    ...
                                    J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
                                    If CSMIOS_TERM = "CSH" Then
                                        If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HOT" Or COMPANY_CODE = "DGI" Then
                                            J_ACCT_CODE = N2Str2Null(ReturnInventory("PARTS", "INVP"))
                                            J_ACCT_NAME = N2Str2Null(Setacctname(ReturnInventory("PARTS", "INVP")))
                                        Else
                                            J_ACCT_CODE = N2Str2Null(ReturnInventory("PARTS"))
                            ...
                            If CSMIOS_MATERIALS > 0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        If COMPANY_CODE = "DGI" Then
                                            J_NET = Round(NumericVal(CSMIOS_MATERIALS - CSMIOS_MATERIALS_DISCOUNT) / 1.12, 2) - SHOPSUP_NET
                                        Else
                                ...
                                ElseIf COMPANY_CODE = "HOT" Then
                                    If (ReturnShopSuplies(CSMIOS_REP_OR)) > 0 Then
                                        ItemCnt = ItemCnt + 1: J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
                                        J_ACCT_CODE = "'41-03052-30'"
                                        J_ACCT_NAME = N2Str2Null(Setacctname("'41-03052-30'"))
                                        J_GROSS = SHOPSUP: J_TAX = SHOPSUP_TAX: J_NET = SHOPSUP_NET:
                                        J_DEBIT = 0
                                        J_CREDIT = Round(NumericVal(SHOPSUP_NET), 2)
                                        ALL_DEBIT = ALL_DEBIT + J_DEBIT
                                ...
                                Else
                                    'COST OF SALES
                                    ItemCnt = ItemCnt + 1: J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
                                    If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HOT" Then
                                        J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LUBRICANTS"))
                                        J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LUBRICANTS")))
                                    Else
                                        If CSMIOS_TERM = "CSH" Then
                        ...
                        If COMPANY_CODE = "HCC" Or COMPANY_CODE = "HCA" Then
                            If CSMIOS_PARTS_DISCOUNT > 0 Or CSMIOS_MATERIALS_DISCOUNT > 0 Or CSMIOS_ACCESSORIES_DISCOUNT > 0 Then
                                ...
                                If CSMIOS_INVOICE = "PDI RO" Then
                                    J_TAX = 0: J_NET = Round(NumericVal(CSMIOS_PARTS_DISCOUNT + CSMIOS_MATERIALS_DISCOUNT + CSMIOS_ACCESSORIES_DISCOUNT), 2)
                                Else
                                    If CSMIOS_VAT_EXEMPT = True Then
                                        J_TAX = 0: J_NET = Round(NumericVal(CSMIOS_PARTS_DISCOUNT + CSMIOS_MATERIALS_DISCOUNT + CSMIOS_ACCESSORIES_DISCOUNT), 2)
                                    Else
                                        J_TAX = Round(NumericVal(Round(((CSMIOS_PARTS_DISCOUNT + CSMIOS_MATERIALS_DISCOUNT + CSMIOS_ACCESSORIES_DISCOUNT) / 1.12), 2) * 0.12), 2)
                                        J_NET = Round(NumericVal(CSMIOS_PARTS_DISCOUNT + CSMIOS_MATERIALS_DISCOUNT + CSMIOS_ACCESSORIES_DISCOUNT) - Round(NumericVal(J_TAX), 2), 2)
                                    End If
                                End If
                                J_DEBIT = NumericVal(J_NET)
                                J_CREDIT = 0
                        ...
                        If J_INVOICEAMT > 0 Then
                            ...
                            Else
                                If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HOT" Or COMPANY_CODE = "DGI" Then
                                    If CSMIOS_TERM = "CHG" Then
                            ...
                            'arjr
                            If COMPANY_CODE = "HCI" And CSMIOS_PARTICIPAT <> "" Then
                                J_DEBIT = Round(CSMIOS_ACCESSORIES, 2)
                            Else
                    ...
                    If INSURANCE_DIRECT_EXPENSE_LABOR + INSURANCE_DIRECT_EXPENSE_SPAREPARTS + INSURANCE_DIRECT_EXPENSE_GOL + INSURANCE_DIRECT_EXPENSE_ACCESSORIES > 0 Then
                        ...
                        If INSURANCE_DIRECT_EXPENSE_LABOR > 0 Then
                            ...
                            ElseIf COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HCA" Then
                                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LABOR", "RETAIL"))
                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "LABOR", "RETAIL")))
                            Else
                        ...
                        If INSURANCE_DIRECT_EXPENSE_SPAREPARTS > 0 Then
                            ...
                            If CSMIOS_PARTS_COST > 0 Then
                                ...
                                WARRANTY_ItemCnt = WARRANTY_ItemCnt + 1
                                WARRANTY_J_JITEMNO = "'" & Format(WARRANTY_ItemCnt, "0000") & "'"
                                If COMPANY_CODE = "HPI" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HOT" Then
                                    J_ACCT_CODE = N2Str2Null(ReturnInventory("PARTS", "INVP"))
                                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnInventory("PARTS", "INVP")))
                                Else
                                    If CSMIOS_TERM = "CSH" Then
                        ...
                        If COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or (COMPANY_CODE = "HCI" And CSMIOS_PARTICIPAT <> "") Then
                        ...
                        If CSMIOS_PARTS_DISCOUNT > 0 And COMPANY_CODE <> "DGI" Then
                            'DISCOUNT
                            WARRANTY_ItemCnt = WARRANTY_ItemCnt + 1: WARRANTY_J_JITEMNO = "'" & Format(WARRANTY_ItemCnt, "0000") & "'"
                            If CSMIOS_TERM = "CSH" Then
                                J_ACCT_CODE = N2Str2Null(ReturnDiscount_AccountCode("PARTS", "PARTS"))
...
Sub IMPORT_INTERNAL()
    If COMPANY_DIRECT_EXPENSE_LABOR + COMPANY_DIRECT_EXPENSE_SPAREPARTS + COMPANY_DIRECT_EXPENSE_GOL + SALES_DIRECT_EXPENSE_LABOR + SALES_DIRECT_EXPENSE_SPAREPARTS + SALES_DIRECT_EXPENSE_GOL > 0 And CSMIOS_RO_AMOUNT > 0 Then
        ...
        If Not rsINTERNAL_RO_DET.EOF And Not rsINTERNAL_RO_DET.BOF Then
            ...
            If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HMH" Then
            Else
                'COST OF SALES
                ItemCnt = ItemCnt + 1
                J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
        ...
        If Not rsINTERNAL_RO_DET.EOF And Not rsINTERNAL_RO_DET.BOF Then
            ...
            If INTERNAL_PARTS_AMT > 0 Then
                If COMPANY_CODE = "HPI" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HCC" Then
                Else
                    ItemCnt = ItemCnt + 1
                    J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
                    If COMPANY_CODE = "HBK" Then
        ...
        If COMPANY_CODE = "HMH" Then
            ...
            If Not rsINTERNAL_RO_DET.EOF And Not rsINTERNAL_RO_DET.BOF Then
                ...
                Do While Not rsINTERNAL_RO_DET.EOF
                    If N2Str2Zero(rsINTERNAL_RO_DET!DET_AMT) > 0 Then
                        ...
                        Else
                            ...
                            J_TAX = 0
                            If COMPANY_CODE = "HMH" Then
                                J_NET = Round(NumericVal(N2Str2Zero(INTERNAL_ACCESSORIES_COST)), 2)
                            Else
                                J_NET = Round(NumericVal(N2Str2Zero(rsINTERNAL_RO_DET!DET_AMT)), 2)
                            End If
                            J_DEBIT = Round(NumericVal(J_NET), 2)
                ...
                If INTERNAL_ACCESSORIES_AMT > 0 Then
                    ...
                    J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
                    If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Then
                        J_ACCT_CODE = N2Str2Null(ReturnInventory("ACCESSORIES", "INVA", "ACCESSORIES"))
                        J_ACCT_NAME = N2Str2Null(Setacctname(ReturnInventory("ACCESSORIES", "INVA", "ACCESSORIES")))
                    Else
                        J_ACCT_CODE = N2Str2Null(ReturnInventory("ACCESSORIES"))
                        J_ACCT_NAME = N2Str2Null(Setacctname(ReturnInventory("ACCESSORIES")))
                    End If
        ...
        If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HCC" Then
    ...
    If WARRANTY_DIRECT_EXPENSE_LABOR + WARRANTY_DIRECT_EXPENSE_SPAREPARTS + WARRANTY_DIRECT_EXPENSE_GOL > 0 Then
        ...
        If WARRANTY_DIRECT_EXPENSE_LABOR > 0 Then
            ...
            If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HGH" Then
                ...
                End If
            Else
                If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "HCA" Then
                    J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LABOR", "RETAIL"))
                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "LABOR", "RETAIL")))
                Else
                    J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LABOR", "WARRANTY"))
            ...
            Else
                ...
                WARRANTY_ItemCnt = WARRANTY_ItemCnt + 1: WARRANTY_J_JITEMNO = "'" & Format(WARRANTY_ItemCnt, "0000") & "'"
                If CSMIOS_TERM = "CSH" Then
                    If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HGH" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "HCA" Then
                        If CheckIfPMS_Ik_to_5k(CSMIOS_REP_OR) = True Then
                            J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LABOR", "RETAIL"))
                            J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LABOR", "RETAIL")))
                        Else
                ...
                Else
                    If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HGH" Then
                        ...
                        Else
                            ...
                            J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LABOR", "WARRANTY")))
                        End If
                    ElseIf COMPANY_CODE = "HCC" Or COMPANY_CODE = "HCA" Then
                                J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LABOR", "RETAIL"))
                                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LABOR", "RETAIL")))
                    Else
                        J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LABOR", "WARRANTY"))
        ...
        If WARRANTY_DIRECT_EXPENSE_SPAREPARTS > 0 Then
            ...
            If CSMIOS_TERM = "CSH" Then
                ...
                ElseIf COMPANY_CODE = "HPI" Then
                    J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "PARTS", "RETAIL"))
                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "PARTS", "RETAIL")))
                ElseIf COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HOT" Or COMPANY_CODE = "DGI" Then
                    J_ACCT_CODE = N2Str2Null(ReturnInventory("PARTS", "INVP"))
                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnInventory("PARTS", "INVP")))
                Else
                    J_ACCT_CODE = N2Str2Null(ReturnInventory("PARTS"))
        ...
        If WARRANTY_DIRECT_EXPENSE_GOL > 0 Then
            ...
            ElseIf COMPANY_CODE = "HPI" Then
                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LABOR", "WARRANTY"))
                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "LABOR", "WARRANTY")))
            ElseIf COMPANY_CODE = "HMH" Or COMPANY_CODE = "HOT" Then
                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "LUBRICANTS", "RETAIL"))
                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnSales_AccountCode("SERVICE", "LUBRICANTS", "RETAIL")))
            Else
            ...
            Else
                ...
                ElseIf COMPANY_CODE = "HSB" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HOT" Then
                    J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LUBRICANTS", "RETAIL"))
                    J_ACCT_NAME = N2Str2Null(Setacctname(ReturnCostofSales("SERVICE", "LUBRICANTS", "RETAIL")))
                ElseIf COMPANY_CODE = "HCA" Then
                    J_ACCT_CODE = N2Str2Null(ReturnCostofSales("SERVICE", "LUBRICANTS"))
        ...
        If CheckIfPMS_Ik_to_5k(CSMIOS_REP_OR) = True Then
            If COMPANY_CODE = "HAS" Then
                J_ACCT_CODE = N2Str2Null("11-02000-00")
                J_ACCT_NAME = N2Str2Null(Setacctname("11-02000-00"))
            ElseIf COMPANY_CODE = "HPI" Or COMPANY_CODE = "HOT" Then
                J_ACCT_CODE = N2Str2Null(ReturnAR_AccountCode("SERVICE"))
                J_ACCT_NAME = N2Str2Null(Setacctname(ReturnAR_AccountCode("SERVICE")))
            Else
        ...
        If CheckIfPMS(CSMIOS_REP_OR) = True And COMPANY_CODE <> "DGI" Then
            If CheckIfPMS_Ik_to_5k(CSMIOS_REP_OR) = True Then
                If COMPANY_CODE = "HPI" Then
                ...
                ElseIf COMPANY_CODE = "HGH" Then
                    CSMIOS_ACCT_NO = Null2String("H00259")
                    CSMIOS_NIYM = Null2String(SetCustomerName("H00259"))
                    J_CUSTOMERCODE = N2Str2Null("H00259")
                Else
                    CSMIOS_ACCT_NO = Null2String("H00001")
    ...
    Else
        ...
        For i = 1 To Grid1.Rows - 1
            ...
            If Not rsJournalHD.EOF And Not rsJournalHD.BOF Then
                Screen.MousePointer = 11
                '                gconDMIS.Execute ("delete from AMIS_Journal_DET Where (STATUS <> 'P' AND STATUS <> 'C') AND Jtype = 'SJ' and Jdate = '" & CDate(dtpTranDate) & "'")
                '                gconDMIS.Execute ("delete from AMIS_Journal_HD Where (STATUS <> 'P' AND STATUS <> 'C') AND Jtype = 'SJ' and Jdate = '" & CDate(dtpTranDate) & "'")
...
InitGrids:     DoEvents: cmdCheck.Enabled = False: cmdClearJournals.Enabled = False
    ...
    ellaine = 0
    If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HCC" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Then
        GoTo ShowTrans
    Else
...
ShowTrans:
    If chkPMIS.Value = 1 Then
        KIM = 0
        Set rsPMIOS_ORD_HD = New ADODB.Recordset
        If COMPANY_CODE = "HCI" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HGH" Or COMPANY_CODE = "DGI" Then
    ...
    If chkCSMS.Value = 1 Then
        ...
        Set rsCSMIOS_REPOR = New ADODB.Recordset
        If COMPANY_CODE = "DGI" Then
            Set rsCSMIOS_REPOR = gconDMIS.Execute("Select CSMS_REPOR.REP_OR,CSMS_REPOR.INVOICE,CSMS_REPOR.RO_AMOUNT from CSMS_REPOR  WHERE INVOICE = 'INT RO' and DTE_REL = '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' ORDER BY CSMS_REPOR.REP_OR ASC")
        Else
            Set rsCSMIOS_REPOR = gconDMIS.Execute("Select CSMS_REPOR.REP_OR,CSMS_REPOR.INVOICE,CSMS_REPOR.RO_AMOUNT from CSMS_REPOR  WHERE INVOICE IN ('INT RO') and DTE_COMP = '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' ORDER BY CSMS_REPOR.REP_OR ASC")
        End If
        If Not rsCSMIOS_REPOR.EOF And Not rsCSMIOS_REPOR.BOF Then
            ...
            Do While Not rsCSMIOS_REPOR.EOF
                ...
                Else
                    IS_Exist = 0
                End If
                Grid2.AddItem IS_Exist & Chr(9) & Null2String(rsCSMIOS_REPOR!REP_OR) & Chr(9) & Null2String(rsCSMIOS_REPOR!INVOICE) & Chr(9) & ToDoubleNumber(N2Str2Zero(rsCSMIOS_REPOR!RO_AMOUNT)) & Chr(9) & SetRONiym(Null2String(rsCSMIOS_REPOR!INVOICE))    'SetRONiym(Null2String(rsCSMIOS_REPOR!ID))
        ...
        Set rsCSMIOS_REPOR = New ADODB.Recordset
        If COMPANY_CODE = "DGI" Then
            Set rsCSMIOS_REPOR = gconDMIS.Execute("Select CSMS_REPOR.REP_OR,CSMS_REPOR.INVOICE,SUM(CSMS_RO_DET.DETAMT) AS AMOUNT from CSMS_REPOR INNER JOIN CSMS_RO_DET ON CSMS_REPOR.REP_OR = CSMS_RO_DET.REP_OR WHERE RO_AMOUNT = 0 AND DETAMT > 0 AND WCODE = 'W' AND invoice <> 'NO CHG' AND invoice <> 'PDI RO' AND invoice <> 'INT RO' and DTE_REL = '" & Format(CDate(dtpTranDate), "MM/DD/YYYY") & "' GROUP BY CSMS_REPOR.REP_OR,INVOICE")
        Else
        ...
        If Not rsTransferOut.EOF And Not rsTransferOut.BOF Then
            ...
            Do While Not rsTransferOut.EOF
                ...
                Else
                    IS_Exist = 0
                End If
                Grid3.AddItem IS_Exist & Chr(9) & Null2String(rsTransferOut!CSNO) & Chr(9) & Null2String(rsTransferOut!SDNO) & Chr(9) & Null2String(NumericVal(Cost)) & Chr(9) & Null2String(rsTransferOut!Entity_to)
...
Private Sub IMPORT_ACCESSORIES()
    If COMPANY_CODE = "HBK" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "DGI" Then
        If CSMIOS_ACCESSORIES > 0 Then
            ItemCnt = ItemCnt + 1: J_JITEMNO = "'" & Format(ItemCnt, "0000") & "'"
            If COMPANY_CODE = "HPI" Then
                J_ACCT_CODE = N2Str2Null(ReturnSales_AccountCode("SERVICE", "PARTS", "RETAIL"))
