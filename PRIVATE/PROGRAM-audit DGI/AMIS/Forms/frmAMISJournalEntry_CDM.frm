...
Begin VB.Form frmAMISJournalEntry_CDM 
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_CDM.frx":08CA
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8820
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":0961
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":0AB3
         Style           =   1  'Graphical
         TabIndex        =   181
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8070
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":0E19
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":0F6B
         Style           =   1  'Graphical
         TabIndex        =   180
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7320
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":12D1
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":1423
         Style           =   1  'Graphical
         TabIndex        =   179
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6540
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":175D
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":18AF
         Style           =   1  'Graphical
         TabIndex        =   178
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5790
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":1BF4
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":1D46
         Style           =   1  'Graphical
         TabIndex        =   177
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5040
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":206B
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":21BD
         Style           =   1  'Graphical
         TabIndex        =   176
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4290
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":2519
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":266B
         Style           =   1  'Graphical
         TabIndex        =   175
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":297E
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":2AD0
         Style           =   1  'Graphical
         TabIndex        =   174
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":2E20
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":2F72
         Style           =   1  'Graphical
         TabIndex        =   173
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2040
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":32D0
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":3422
         Style           =   1  'Graphical
         TabIndex        =   172
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1290
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":371C
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":386E
         Style           =   1  'Graphical
         TabIndex        =   171
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   540
         MouseIcon       =   "frmAMISJournalEntry_CDM.frx":3BC6
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_CDM.frx":3D18
         Style           =   1  'Graphical
         TabIndex        =   170
...
Function JournalPosting() As Boolean
    ...
    If MsgBox("Are you sure you want to Post this transaction?", vbQuestion + vbYesNo, "Message") = vbYes Then
        If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "CSJ" Then
...
Private Sub cmdSave_Click()
    ...
    If txtJDate.Text = "" Or IsDate(txtJDate.Text) = False Then
        ...
        Exit Sub
    End If
    If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "CSJ" Then
        If COMPANY_CODE = "HMH" Then
            'Updated by: ACL 10202009
            If CheckIfOpen(xJOURNALTYPE, Trim(txtJDate.Text), Year(txtJDate.Text)) = False Then
                MsgBox "Warning: Action not authorized!", vbExclamation, "Error!"
