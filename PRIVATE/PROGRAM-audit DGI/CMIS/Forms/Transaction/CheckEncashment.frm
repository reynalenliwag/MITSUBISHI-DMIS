...
Sub StoreDetails()
    ...
    TOTAL_CHECK_ENCASHMENT = 0: InitGrid: I = 0
...
Sub FillGrid()
    ...
    lstInCash.Sorted = False: lstInCash.ListItems.Clear
...
Private Sub cmdCancelInCash_Click()
    AddorEdit = ""
    picCheckEncashment.Visible = False: picCheckEncashment.ZOrder 1
    lstInCash.Enabled = True
...
Private Sub Timer1_Timer()
    If AddorEdit = "ADD" Then
        txtTimeInCash.Text = Time: DoEvents
    End If
End Sub
