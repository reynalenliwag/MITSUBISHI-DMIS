...
Begin VB.Form frmSMIS_Report_MonthlySalesAnalysis 
   ...
   ClientWidth     =   4575
   ForeColor       =   &H00FCFCFC&
   Icon            =   "frmSMIS_Report_MonthlySalesAnalysis.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   2295
      MouseIcon       =   "frmSMIS_Report_MonthlySalesAnalysis.frx":0E42
      MousePointer    =   99  'Custom
      Picture         =   "frmSMIS_Report_MonthlySalesAnalysis.frx":0F94
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   1425
      MouseIcon       =   "frmSMIS_Report_MonthlySalesAnalysis.frx":13DF
      MousePointer    =   99  'Custom
      Picture         =   "frmSMIS_Report_MonthlySalesAnalysis.frx":1531
      Style           =   1  'Graphical
      TabIndex        =   3
