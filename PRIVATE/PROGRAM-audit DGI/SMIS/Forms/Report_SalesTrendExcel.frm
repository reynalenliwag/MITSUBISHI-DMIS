...
Begin VB.Form frmSMIS_Report_SalesTrendExcel 
   ...
   ClientWidth     =   4470
   ForeColor       =   &H00FCFCFC&
   Icon            =   "Report_SalesTrendExcel.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   2160
      MouseIcon       =   "Report_SalesTrendExcel.frx":000C
      MousePointer    =   99  'Custom
      Picture         =   "Report_SalesTrendExcel.frx":015E
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   1290
      MouseIcon       =   "Report_SalesTrendExcel.frx":05A9
      MousePointer    =   99  'Custom
      Picture         =   "Report_SalesTrendExcel.frx":06FB
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frmSMIS_Report_SalesTrendExcel"
...
Sub PrintPOExcel(xYear)
    On Error GoTo ErrorCode
    Dim xlApp                                                         As Excel.Application
    Dim xlBook                                                        As Excel.Workbook
    Dim xlSheet                                                       As Excel.Worksheet
    Set xlApp = New Excel.Application
    Set xlBook = xlApp.Workbooks.Open("C:/SALESTREND1.xls")
    ...
    If Not rsModel.EOF Or Not rsModel.BOF Then
        While Not rsModel.EOF
            ...
            For j = 1 To 31
                Set rsCountProspect = gconDMIS.Execute("select COUNT(*) from CRIS_PROSPECTS  where MODEL='" & vmodel & "' AND DAY(LOGINITIALINQUIRY)=" & j & " AND MONTH(LOGINITIALINQUIRY)=" & What_month(cboMonth) & " AND YEAR(LOGINITIALINQUIRY)=" & xYear)
