...
Begin VB.Form HASREPORT 
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   2145
      MouseIcon       =   "SalesReport.frx":3482
      MousePointer    =   99  'Custom
      Picture         =   "SalesReport.frx":35D4
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   1275
      MouseIcon       =   "SalesReport.frx":3A1F
      MousePointer    =   99  'Custom
      Picture         =   "SalesReport.frx":3B71
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "HASREPORT"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False

' Update by BTT : 09182008
Option Explicit
...
Private Sub cmdPrint_Click()
    ...
    If Len(cboYear.Text) = 4 Or cboYear.Text <> "" Then
        ...
        If Not rsPurchAgree.EOF And Not rsPurchAgree.BOF Then
            ...
            PrintSQLReport rptReleased, SMIS_REPORT_PATH & "customreports\released.rpt", "year({PurchAgree.datereleased}) = " & cboYear.Text & " and month({PurchAgree.datereleased}) = " & What_month(cboMonth), DMIS_REPORT_Connection, 1
