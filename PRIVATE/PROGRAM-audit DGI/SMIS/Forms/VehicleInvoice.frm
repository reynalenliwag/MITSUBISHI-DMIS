...
Begin VB.Form frmSMIS_Trans_VehicleInvoice 
   ...
   Begin XtremeSuiteControls.TabControl SSTabVDetails 
      ...
      Begin VB.PictureBox picTinInfo 
         ...
         Begin VB.ComboBox cboAccountType 
            ...
            EndProperty
            Height          =   345
            ItemData        =   "VehicleInvoice.frx":08D0
            Left            =   930
            List            =   "VehicleInvoice.frx":08DA
            TabIndex        =   117
            Top             =   1590
            Width           =   2325
         End
         ...
         Begin VB.CommandButton cmdEditCustInfo 
            ...
            Height          =   360
            Left            =   90
            MouseIcon       =   "VehicleInvoice.frx":08ED
      ...
      Begin VB.PictureBox picVehiclesDetail 
         ...
         Begin VB.PictureBox picInsurance 
            ...
            Begin VB.ComboBox cboInsuranceCompany 
               ...
               ForeColor       =   &H00400000&
               Height          =   345
               ItemData        =   "VehicleInvoice.frx":0A3F
               Left            =   120
               List            =   "VehicleInvoice.frx":0A41
               TabIndex        =   83
               Top             =   960
               Width           =   2505
            End
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin VB.Frame fraHeader 
         ...
         Begin VB.ComboBox cboPaymentTerm 
            ...
            ForeColor       =   &H00400000&
            Height          =   345
            ItemData        =   "VehicleInvoice.frx":0A43
            Left            =   2850
            List            =   "VehicleInvoice.frx":0A45
         ...
         Begin VB.ComboBox cboPurchaseType 
            ...
            ForeColor       =   &H00400000&
            Height          =   345
            ItemData        =   "VehicleInvoice.frx":0A47
            Left            =   1320
            List            =   "VehicleInvoice.frx":0A49
            TabIndex        =   21
            Text            =   "Combo1"
            Top             =   180
            Width           =   1020
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   60
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "VehicleInvoice.frx":0A4B
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":0B9D
         Style           =   1  'Graphical
         TabIndex        =   273
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   60
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "VehicleInvoice.frx":0EC2
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":1014
         Style           =   1  'Graphical
         TabIndex        =   272
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   9030
         MouseIcon       =   "VehicleInvoice.frx":1359
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":14AB
         Style           =   1  'Graphical
         TabIndex        =   259
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8340
         MouseIcon       =   "VehicleInvoice.frx":1811
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":1963
         Style           =   1  'Graphical
         TabIndex        =   258
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7650
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "VehicleInvoice.frx":1CC9
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":1E1B
         Style           =   1  'Graphical
         TabIndex        =   257
      ...
      Begin VB.CommandButton cmdUnReleased 
         ...
         Height          =   795
         Left            =   6960
         MouseIcon       =   "VehicleInvoice.frx":2155
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":22A7
         Style           =   1  'Graphical
         TabIndex        =   254
      ...
      Begin VB.CommandButton cmdRelease 
         ...
         Height          =   795
         Left            =   6270
         MouseIcon       =   "VehicleInvoice.frx":269C
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":27EE
         Style           =   1  'Graphical
         TabIndex        =   256
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5580
         MouseIcon       =   "VehicleInvoice.frx":4F90
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":50E2
         Style           =   1  'Graphical
         TabIndex        =   255
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4890
         MouseIcon       =   "VehicleInvoice.frx":543E
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":5590
         Style           =   1  'Graphical
         TabIndex        =   253
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   4200
         MouseIcon       =   "VehicleInvoice.frx":58A3
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":59F5
         Style           =   1  'Graphical
         TabIndex        =   252
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   3510
         MouseIcon       =   "VehicleInvoice.frx":5D45
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":5E97
         Style           =   1  'Graphical
         TabIndex        =   251
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2820
         MouseIcon       =   "VehicleInvoice.frx":61F5
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":6347
         Style           =   1  'Graphical
         TabIndex        =   250
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   2130
         MouseIcon       =   "VehicleInvoice.frx":6641
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":6793
         Style           =   1  'Graphical
         TabIndex        =   249
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "VehicleInvoice.frx":6AEB
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":6C3D
         Style           =   1  'Graphical
         TabIndex        =   248
      ...
      Begin VB.CommandButton cmdRefresh 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "VehicleInvoice.frx":6F9C
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":70EE
         Style           =   1  'Graphical
         TabIndex        =   274
         ToolTipText     =   "Move to Previous Record"
         Top             =   30
   ...
   Begin VB.PictureBox picViewVehicles 
      ...
      Begin VB.CommandButton cmdCancelViewVehicles 
         ...
         Index           =   0
         Left            =   8850
         MouseIcon       =   "VehicleInvoice.frx":7F9B
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":80ED
         Style           =   1  'Graphical
         TabIndex        =   212
         ToolTipText     =   "Cancel"
         Top             =   3990
      ...
      Begin VB.CommandButton cmdSelectViewVehicles 
         ...
         Height          =   735
         Left            =   8160
         MouseIcon       =   "VehicleInvoice.frx":842B
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":857D
         Style           =   1  'Graphical
         TabIndex        =   211
         ToolTipText     =   "Select"
         Top             =   3990
   ...
   Begin VB.PictureBox picAccessories 
      ...
      Begin VB.CommandButton cmdCancelDetailProduct 
         ...
         Index           =   0
         Left            =   4020
         MouseIcon       =   "VehicleInvoice.frx":88B9
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":8A0B
         Style           =   1  'Graphical
         TabIndex        =   226
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdOkMaterials 
         ...
         Height          =   795
         Left            =   3480
         MouseIcon       =   "VehicleInvoice.frx":8D71
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":8EC3
         Style           =   1  'Graphical
         TabIndex        =   228
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   795
         Left            =   2940
         MouseIcon       =   "VehicleInvoice.frx":9213
         MousePointer    =   99  'Custom
         Picture         =   "VehicleInvoice.frx":9365
         Style           =   1  'Graphical
         TabIndex        =   225
         TabStop         =   0   'False
...
Sub StoreMemVars()
    ...
    If Not rsInvoice.EOF And Not rsInvoice.BOF Then
        ...
        If COMPANY_CODE = "DGI" Then
            Call delete_override(txtVINo.Text)
        End If
...
'        End If
        ...
        If CreditLimitLine(cboFinFinancingCo, txtFinBaltoFinanced) = True Then
            If MsgBox("You cannot post this transaction! Credit limit exception encountered. Do you want to override the credit limit?", vbYesNo, "Warning") = vbYes Then
                ...
                If Module_Access(frmCMISCreditLimitInfo.lblId, "CREDIT LIMIT OVERRIDE", "SYSTEM") = False Then
                    Exit Sub
                Else
                    Call Override_rec(cboFinFinancingCo, txtFinBaltoFinanced)
            ...
            Else
                ...
                Call frmCMISCreditLimitInfo.LOADJOURNAL(cboFinFinancingCo, txtFinBaltoFinanced)
...
'    On Error GoTo Errorcode:
    ...
    If NumericVal(txtFinInsurance.Text) > 0 Then
    ...
    If NumericVal(txtFinLTORegFee.Text) > 0 Then
    ...
    If NumericVal(txtFinOthers.Text) > 0 Then
    ...
    If NumericVal(txtCashInsurance.Text) > 0 Then
        ShowIsRequiredMsg "Please select Insurance Entity"
        On Error Resume Next
    ...
    If NumericVal(txtCashLTORegFee.Text) > 0 Then
        ShowIsRequiredMsg "Please select LTO Entity"
        On Error Resume Next
        cmdLTOFee2.SetFocus
        Exit Sub
    ...
    If NumericVal(txtCashOthers.Text) > 0 Then
        ShowIsRequiredMsg "Please select TPL Entity"
        On Error Resume Next
        cmdTPLFee2.SetFocus
        Exit Sub
...
'    frmCMISCreditLimitInfo.PicCrInfo.Visible = True
    ...
    'credit limit
Set RsCreditLimit1 = gconDMIS.Execute("SELECT *,DATEADD(month,(terms_expiry_year * 12)+terms_expiry_month, getdate()) as expiry FROM ALL_CUSTOMER_TERMS WHERE customercode in (select cuscde from all_customer where acctname = '" & xCustCode & "')")
...
'        frmCMISCreditLimitInfo.txtCrLimit.Text = ToDoubleNumber(RsCreditLimit1!CREDITLIMIT)
'            MessagePop InfoWarning, "Credit Limit Required", "Credit Limit for Financing or Bank PO is required! Please check your masterfile first.", 1000, 2
    ...
    End If
'    'credit available
    Set RsCreditLimit1 = gconDMIS.Execute("select isnull(sum(baltofinanced),0)-(select isnull(sum(payment),0) from cmis_off_dt where trantype = 'VI' and paidna = 1 and cuscde = (select cuscde from all_customer where acctname ='" & xCustCode & "')) available From SMIS_SalesOrder WHERE STATUS <> 'C' OR STATUS IS NULL and financingcode in (select cuscde from all_customer where acctname = '" & xCustCode & "') and vi_no is not null")
    If RsCreditLimit1!Available <> 0 Then
        If ToDoubleNumber(RsCreditLimit1!Available) < ToDoubleNumber(xbaltofinanced) Then
'            frmCMISCreditLimitInfo.txtCRAvailable.Text = ToDoubleNumber(RsCreditLimit1!available)
'            MessagePop InfoWarning, "Credit Limit Reached", "Oops! You have reached the credit limit! Please check your masterfile first.", 1000, 2
            CreditLimitLine = True
        End If
    End If
'    'past due
'    Set RsCreditLimit1 = gconDMIS.Execute("select * from amis_ar ar inner join amis_detail dt on ar.InvoiceType = dt.InvoiceType And ar.INVOICENO = dt.INVOICENO And ar.CustomerCode = dt.CustomerCode And ar.account_code = dt.acct_code inner join all_customer_terms tr on ar.customercode=tr.customercode Where DateDiff(Day, ar.invoicedate, getdate()) > tr.creditterm and ar.amount_topay>dt.invoiceamount and ar.invoicetype = 'VI' and ar.customercode = (select cuscde from all_customer where acctname='" & xCustCode & "') and ar.status='P' and dt.status='P'")
    ...
    " and ar.customercode = (select top 1 cuscde from all_customer where acctname='" & xCustCode & "') " & _
    ...
    " and invoiceno not in (select invoiceno from amis_detail where amis_detail.invoicetype = 'VI' and status = 'P'and customercode = (select top 1 cuscde from all_customer where acctname='" & xCustCode & "') ) and ar.customercode = (select top 1 cuscde from all_customer where acctname='" & xCustCode & "') and DateDiff(Day, ar.invoicedate, getdate()) > tr.creditterm")

    If Not (RsCreditLimit1.EOF Or RsCreditLimit1.BOF) Then
'        MessagePop InfoWarning, "Past Due Invoice(s).", "This Customer has Past due invoice(s) found in your database.", 1000, 2
        CreditLimitLine = True
    End If
    'expiry
    Set RsCreditLimit1 = gconDMIS.Execute("select DATEADD(month,(terms_expiry_year * 12)+terms_expiry_month, getdate()) as expiry,getdate() present from all_customer_terms where customercode = (select cuscde from all_customer where acctname='" & xCustCode & "')")
    If Not (RsCreditLimit1.EOF Or RsCreditLimit1.BOF) Then
...
Sub Override_rec(xcusname As String, xbaltofin As Double)
    Dim SQL                                                           As String
    ...
    Dim RsCreditLimit2 As New ADODB.Recordset
        Set RsCreditLimit2 = gconDMIS.Execute("SELECT *,DATEADD(month,(terms_expiry_year * 12)+terms_expiry_month, getdate()) as expiry FROM ALL_CUSTOMER_TERMS WHERE customercode in (select cuscde from all_customer where acctname = '" & xcusname & "')")
        If Not (RsCreditLimit2.EOF Or RsCreditLimit2.BOF) Then
            xlimit = ToDoubleNumber(NumericVal(RsCreditLimit2!CREDITLIMIT))
        End If
        'credit available
        Set RsCreditLimit2 = gconDMIS.Execute("select isnull(sum(baltofinanced),0)-(select isnull(sum(payment),0) from cmis_off_dt where trantype = 'VI' and paidna = 1 and cuscde = (select cuscde from all_customer where acctname ='" & xcusname & "')) available,(select isnull(sum(payment),0) from cmis_off_dt where trantype = 'VI' and paidna = 1 and cuscde = (select cuscde from all_customer where acctname ='" & xcusname & "')) payment  From SMIS_SalesOrder WHERE STATUS <> 'C' OR STATUS IS NULL and financingcode in (select cuscde from all_customer where acctname = '" & xcusname & "') and vi_no is not null")
        If RsCreditLimit2!Available <> 0 Then
            xavailable = xlimit - ToDoubleNumber(ToDoubleNumber(RsCreditLimit2!Available) + ToDoubleNumber(xbaltofin))
        End If
    '    'past due
'        Set RsCreditLimit2 = gconDMIS.Execute("select * from amis_ar ar inner join amis_detail dt on ar.InvoiceType = dt.InvoiceType And ar.INVOICENO = dt.INVOICENO And ar.CustomerCode = dt.CustomerCode And ar.account_code = dt.acct_code inner join all_customer_terms tr on ar.customercode=tr.customercode Where DateDiff(Day, ar.invoicedate, getdate()) > tr.creditterm and ar.amount_topay>dt.invoiceamount and ar.invoicetype = 'VI' and ar.customercode = (select cuscde from all_customer where acctname='" & xcusname & "') and ar.status='P' and dt.status='P'")
        ...
        " Where DateDiff(Day, ar.invoicedate, getdate()) > tr.creditterm " & _
        " and ar.amount_topay>dt.invoiceamount and ar.invoicetype = 'VI' " & _
        " and ar.customercode = (select top 1 cuscde from all_customer where acctname='" & xcusname & "') " & _
        " and ar.status='P' and dt.status='P' " & _
        " Union " & _
        " select ar.customercode,ar.invoicetype,invoiceno,amount_topay,0 as invoiceamount from amis_ar ar inner join all_customer_terms tr on ar.customercode=tr.customercode where ar.invoicetype = 'VI' and status = 'P' " & _
        " and invoiceno not in (select invoiceno from amis_detail where amis_detail.invoicetype = 'VI' and status = 'P'and customercode = (select top 1 cuscde from all_customer where acctname='" & xcusname & "') ) and ar.customercode = (select top 1 cuscde from all_customer where acctname='" & xcusname & "') and DateDiff(Day, ar.invoicedate, getdate()) > tr.creditterm")
        ...
        End If
    '    'expiry
        Set RsCreditLimit2 = gconDMIS.Execute("select DATEADD(month,(terms_expiry_year * 12)+terms_expiry_month, getdate()) as expiry,getdate() present from all_customer_terms where customercode = (select cuscde from all_customer where acctname='" & xcusname & "')")
        If Not (RsCreditLimit2.EOF Or RsCreditLimit2.BOF) Then
    ...
    rsoverride.Open "select * from CreditLimit_override where invoicetype = 'VI' and invoiceno = '" & txtVINo.Text & "'", gconDMIS
    If Not rsoverride.EOF And Not rsoverride.BOF Then
    Else
        SQL = " INSERT INTO CreditLimit_override("
        SQL = SQL & " who_over_ride, invoicetype, invoiceno , invoicedate,creditlimit,available,invoiceamount,pastdue,expiredterm,usercode)"
        SQL = SQL & " values ('" & frmCMISCreditLimitInfo.lblUsercode & "','VI', '" & txtVINo.Text & "', '" & dtDateInvoiced & "','" & ToDoubleNumber(xlimit) & "','" & ToDoubleNumber(xavailable) & "','" & ToDoubleNumber(xbaltofin) & "','" & xpastdue & "','" & xXpired & "','" & xcodeuser & "' )"
        gconDMIS.Execute SQL
    End If
End Sub
