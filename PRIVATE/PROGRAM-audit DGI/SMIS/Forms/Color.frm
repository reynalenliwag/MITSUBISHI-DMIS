...
Begin VB.Form frmSMIS_Files_Color 
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   5010
         MouseIcon       =   "Color.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4320
         MouseIcon       =   "Color.frx":0EE4
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":1036
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3630
         MouseIcon       =   "Color.frx":139C
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":14EE
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2940
         MouseIcon       =   "Color.frx":1819
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":196B
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2250
         MouseIcon       =   "Color.frx":1CC7
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":1E19
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "Color.frx":212C
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":227E
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   870
         MouseIcon       =   "Color.frx":2578
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":26CA
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "Color.frx":2A22
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":2B74
         Style           =   1  'Graphical
         TabIndex        =   20
   ...
   Begin VB.PictureBox picSaves 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "Color.frx":2ED3
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":3025
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "Color.frx":3363
         MousePointer    =   99  'Custom
         Picture         =   "Color.frx":34B5
         Style           =   1  'Graphical
         TabIndex        =   23
...
Private Sub cmdDelete_Click()
    ...
    If Not rsColor.BOF Or Not rsColor.EOF Then
        If ShowConfirmDelete = True Then
            ...
            NEW_LogAudit "X", "VEHICLE COLOR", SQL_STATEMENT, labid, "", "Code: " & txtColor_code, "", ""
...
Private Sub cmdSave_Click()
    ...
    Dim vRyanID                                                       As String
    Set rsHanapID = New ADODB.Recordset
    If AddorEdit = "ADD" Then
        SQL_STATEMENT = "Insert into ALL_Color" & _
                      " (color_code,color_desc)" & _
                      " values (" & N2Str2Null(txtColor_code.Text) & ", " & N2Str2Null(txtColor_desc.Text) & ")"
        gconDMIS.Execute (SQL_STATEMENT)

        NEW_LogAudit "A", "VEHICLE COLOR", SQL_STATEMENT, FindTransactionID(N2Str2Null(txtColor_code), "COLOR_CODE", "ALL_COLOR"), "", "Color Code:" & txtColor_code, "", ""
    ...
    Else
        ...
        NEW_LogAudit "A", "VEHICLE COLOR", SQL_STATEMENT, labid, "", "Color Code:" & txtColor_code, "", ""
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            frmALL_AuditInquiry.Caption = "Audit Inquiry (VEHICLE COLOR)"
            Call frmALL_AuditInquiry.DisplayHistory(N2Str2Null(labid), "VEHICLE COLOR")
            'End If
    End Select
End Sub
