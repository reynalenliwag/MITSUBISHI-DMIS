...
Sub GetSeries()
    ...
    RSORD_HD.Open "select is_series from PMIS_vw_PRS where [TYPE] = 'P' AND sales_origin = '" & lbl2.Caption & "' and SI_TYPE ='" & lbl3.Caption & "' and  PAY_CLASS = '" & lbl4.Caption & "'  order by is_series desc ", gconDMIS
...
Private Sub cmdOk_Click()
    ...
    Dim RSORD_HD                                       As ADODB.Recordset
    Set RSORD_HD = New ADODB.Recordset
    RSORD_HD.Open "select refpisno,TRANNO from PMIS_vw_PRS where [TYPE] = 'P' AND refpisno = '" & PISNUMBER & "' and status='P'", gconDMIS
    If Not RSORD_HD.EOF And Not RSORD_HD.BOF Then
