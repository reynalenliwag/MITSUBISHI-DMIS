...
Sub FillGrid()
    ...
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select pono,pono from PMIS_PO_Hist WHERE [TYPE] = 'M' order by pono asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSPO_HD = gconDMIS.Execute("select pono, pono from PMIS_PO_Hist where [TYPE] = 'M' AND pono like'" & XXX & "%'")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, RSPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
