...
Begin VB.Form frmPMISAC_AddPhyCntTicket 
   ...
   EndProperty
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AC_AddPhyCntTicket.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox picMatAdjust 
      ...
      Begin VB.CommandButton cmdF6 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "AC_AddPhyCntTicket.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "AC_AddPhyCntTicket.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "AC_AddPhyCntTicket.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "AC_AddPhyCntTicket.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "AC_AddPhyCntTicket.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "AC_AddPhyCntTicket.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton cmdChange 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "AC_AddPhyCntTicket.frx":16B7
         MousePointer    =   99  'Custom
         Picture         =   "AC_AddPhyCntTicket.frx":1809
         Style           =   1  'Graphical
         TabIndex        =   31
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   0
         Picture         =   "AC_AddPhyCntTicket.frx":1C61
         Style           =   1  'Graphical
         TabIndex        =   32
   ...
   Begin VB.PictureBox picPhyCnt2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   6120
         MouseIcon       =   "AC_AddPhyCntTicket.frx":1F74
         MousePointer    =   99  'Custom
         Picture         =   "AC_AddPhyCntTicket.frx":20C6
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   5400
         MouseIcon       =   "AC_AddPhyCntTicket.frx":2404
         MousePointer    =   99  'Custom
         Picture         =   "AC_AddPhyCntTicket.frx":2556
         Style           =   1  'Graphical
         TabIndex        =   26
   ...
   Begin MSFlexGridLib.MSFlexGrid grdPhyCnt 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "AC_AddPhyCntTicket.frx":28A6
   End
End
Attribute VB_Name = "frmPMISAC_AddPhyCntTicket"
...
Sub InitGrid()
    With grdPhyCnt
        .Row = 0
        .FormatString = "TAG NO.      | Accessories No.  | Description          | Location         | Computer QTY | QTY Counted  | " & _
