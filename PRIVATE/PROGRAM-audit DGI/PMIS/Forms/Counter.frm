...
Function checkavailable_tranno() As Boolean
    ...
    Set rsvalidno = New ADODB.Recordset
    no = Format(VTXTNextNumber, "000000")
    sqlcommand = "Select * from pmis_tdaytran where [TYPE] = '" & LOCAL_STOCKTYPE & "' and tranno = '" & no & "' and trantype = " & VTXTModule & " "
    sqlcommand = sqlcommand + "UNION ALL "
    sqlcommand = sqlcommand + "Select * from pmis_daytran where [TYPE] = '" & LOCAL_STOCKTYPE & "' and tranno = '" & no & "' and trantype = " & VTXTModule & ""
    Set rsvalidno = gconDMIS.Execute(sqlcommand)
