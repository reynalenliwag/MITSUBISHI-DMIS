...
Begin VB.Form frmPMISMAT_DataEntryTag 
   ...
   ClientWidth     =   7650
   ForeColor       =   &H00DEDFDE&
   Icon            =   "MAT_DataEntryTag.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox picTags2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   2280
         MouseIcon       =   "MAT_DataEntryTag.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "MAT_DataEntryTag.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "MAT_DataEntryTag.frx":0D5A
         MousePointer    =   99  'Custom
         Picture         =   "MAT_DataEntryTag.frx":0EAC
         Style           =   1  'Graphical
         TabIndex        =   10
   ...
   Begin wizButton.cmd cmdTags2 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "MAT_DataEntryTag.frx":11FC
   End
   Begin MSFlexGridLib.MSFlexGrid grdTags 
      ...
      Appearance      =   0
      MousePointer    =   99
      MouseIcon       =   "MAT_DataEntryTag.frx":1218
   End
   Begin VB.PictureBox picMatAdjust 
      ...
      Begin VB.CommandButton cmdF6 
         ...
         Height          =   795
         Left            =   3360
         MouseIcon       =   "MAT_DataEntryTag.frx":1532
         MousePointer    =   99  'Custom
         Picture         =   "MAT_DataEntryTag.frx":1684
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   2640
         MouseIcon       =   "MAT_DataEntryTag.frx":19EA
         MousePointer    =   99  'Custom
         Picture         =   "MAT_DataEntryTag.frx":1B3C
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   1920
         Picture         =   "MAT_DataEntryTag.frx":1EA2
         Style           =   1  'Graphical
         TabIndex        =   14
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_DataEntryTag"
