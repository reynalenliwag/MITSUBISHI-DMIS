...
Begin VB.Form frmPMISMAT_MRISForms 
   ...
   Begin SHDocVwCtl.WebBrowser browRIV 
      ...
      Location        =   "http://www.mysearch.com/jsp/cfg_redir2.jsp?id=NE&psa=A45AA88B-947E-4FC9-91E7-33C5ED2369CD&url=http://www.ask.com/web&l=dir&q="
   End
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "MAT_MRISForm.frx":7319
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":746B
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "MAT_MRISForm.frx":7796
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":78E8
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "MAT_MRISForm.frx":7C38
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":7D8A
         Style           =   1  'Graphical
         TabIndex        =   67
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "MAT_MRISForm.frx":80C8
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":821A
         Style           =   1  'Graphical
         TabIndex        =   79
         Top             =   1575
         Width           =   855
