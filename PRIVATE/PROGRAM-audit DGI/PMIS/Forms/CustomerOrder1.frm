...
Begin VB.Form frmPMISTrans_CustomerOrder 
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "CustomerOrder.frx":0A2C
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -540
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7980
         MouseIcon       =   "CustomerOrder.frx":3768
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":38BA
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7200
         MouseIcon       =   "CustomerOrder.frx":3C20
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":3D72
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6420
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CustomerOrder.frx":40D8
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":422A
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5640
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CustomerOrder.frx":4564
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":46B6
         Style           =   1  'Graphical
         TabIndex        =   101
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "CustomerOrder.frx":49DB
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":4B2D
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4080
         MouseIcon       =   "CustomerOrder.frx":4E89
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":4FDB
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3300
         MouseIcon       =   "CustomerOrder.frx":52EE
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":5440
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2520
         MouseIcon       =   "CustomerOrder.frx":5790
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":58E2
         Style           =   1  'Graphical
         TabIndex        =   91
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1740
         MouseIcon       =   "CustomerOrder.frx":5C40
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":5D92
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   960
         MouseIcon       =   "CustomerOrder.frx":608C
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":61DE
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "CustomerOrder.frx":6536
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":6688
         Style           =   1  'Graphical
         TabIndex        =   99
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3000
         MouseIcon       =   "CustomerOrder.frx":69E7
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":6B39
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   1560
         Width           =   855
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   990
         MouseIcon       =   "CustomerOrder.frx":6E9F
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":6FF1
         Style           =   1  'Graphical
         TabIndex        =   88
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   210
         MouseIcon       =   "CustomerOrder.frx":732F
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":7481
         Style           =   1  'Graphical
         TabIndex        =   89
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "CustomerOrder.frx":77D1
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":7923
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "CustomerOrder.frx":7C4E
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":7DA0
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.ComboBox cboTranPartNo 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "CustomerOrder.frx":80DE
         Left            =   1440
         List            =   "CustomerOrder.frx":80E0
         Sorted          =   -1  'True
         TabIndex        =   17
         Text            =   "Combo1"
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "CustomerOrder.frx":80E2
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":8234
         Style           =   1  'Graphical
         TabIndex        =   84
...
Private Sub Command6_Click()
        If txtTranType = "CSH" Then
            Screen.MousePointer = 11
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CSH.RPT", "({ord_hd.TYPE} = 'P' or {ord_hd.TYPE} = 'M' or {ord_hd.TYPE} = 'A') AND ({ord_hd.STATUS} = 'P' OR {ord_hd.STATUS} = 'B')  AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
            Screen.MousePointer = 0
        ElseIf txtTranType = "CHG" Then
            Screen.MousePointer = 11
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CHG.RPT", "({ord_hd.TYPE} = 'P' or {ord_hd.TYPE} = 'M' or {ord_hd.TYPE} = 'A') AND ({ord_hd.STATUS} = 'P' OR {ord_hd.STATUS} = 'B')  AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
            Screen.MousePointer = 0
        End If
End Sub
...
Sub X_FillSearchGrid(xxx As String)
    ...
    If optTranno.Value = True Then
        Set RSORD_LIST = gconDMIS.Execute("SELECT TRANNO, ID FROM PMIS_ORD_HD WHERE [TYPE] = 'P' AND TRANTYPE = '" & txtTranType & "' AND TRANNO LIKE '" & xxx & "%' ORDER BY ID")
    ElseIf optRONo.Value = True Then
        Set RSORD_LIST = gconDMIS.Execute("SELECT RONO, ID FROM PMIS_ORD_HD WHERE [TYPE] = 'P' AND TRANTYPE = '" & txtTranType & "' AND RONO LIKE '" & xxx & "%'  ORDER BY TRANNO ASC")
    Else
        Set RSORD_LIST = gconDMIS.Execute("SELECT CUSTNAME, ID  FROM PMIS_ORD_HD WHERE [TYPE] = 'P' AND TRANTYPE = '" & txtTranType & "' AND CUSTNAME  LIKE '" & xxx & "%' ORDER BY CUSTNAME")
    End If
