...
Begin VB.Form frmPMISMAT_INVMenu 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame fraDE 
      ...
      Begin MSForms.Label mDEPhyTicket 
         ...
         Size            =   "2566;2408"
         MousePointer    =   99
         Picture         =   "MAT_InvMenu.frx":0000
         MouseIcon       =   "MAT_InvMenu.frx":031A
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.Label mDETagNumbers 
         ...
         Size            =   "2566;2355"
         MousePointer    =   99
         Picture         =   "MAT_InvMenu.frx":047C
         MouseIcon       =   "MAT_InvMenu.frx":0B38
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame fraIQ 
      ...
      Begin MSForms.Label mIQTagMaster 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "MAT_InvMenu.frx":0C9A
         MouseIcon       =   "MAT_InvMenu.frx":153D
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mIQDispLedger 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         MouseIcon       =   "MAT_InvMenu.frx":169F
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mIQDispTag 
         ...
         Width           =   1455
         BackColor       =   16777215
         Caption         =   "Display Tag Master File by Material Code"
         Size            =   "2566;2408"
         MousePointer    =   99
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "MAT_InvMenu.frx":1801
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame fraPR 
      ...
      Begin MSForms.Label mPRGenLedger 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         MouseIcon       =   "MAT_InvMenu.frx":1ECC
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mPRConsPhyCnt 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         MouseIcon       =   "MAT_InvMenu.frx":202E
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mPRCreateCutOff 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         MouseIcon       =   "MAT_InvMenu.frx":2190
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mPRPostEdited 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "MAT_InvMenu.frx":22F2
         MouseIcon       =   "MAT_InvMenu.frx":2BCC
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame fraRP 
      ...
      Begin MSForms.Label mRPUnaccPartNo 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "MAT_InvMenu.frx":35B2
         MouseIcon       =   "MAT_InvMenu.frx":3E9E
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mRPUnaccTagNo 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         MouseIcon       =   "MAT_InvMenu.frx":4000
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.Label mRPVarianceRep 
         ...
         BorderColor     =   16384
         BorderStyle     =   1
         Picture         =   "MAT_InvMenu.frx":4162
         MouseIcon       =   "MAT_InvMenu.frx":4875
         FontName        =   "Arial"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin VB.Frame Frame1 
      ...
      Begin wizButton.cmd cmdExit 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   99
         MICON           =   "MAT_InvMenu.frx":563F
      End
   End
End
Attribute VB_Name = "frmPMISMAT_INVMenu"
...
Private Sub cmdExit_Click()
    If MsgBox("Are you Sure You Want To Exit Inventory Menu", vbInformation + vbYesNo) = vbNo Then: Exit Sub
    Unload Me
End Sub
