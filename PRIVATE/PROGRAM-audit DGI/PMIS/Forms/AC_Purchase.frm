...
Begin VB.Form frmPMISAC_Purchase 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "AC_Purchase.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7080
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":1B5D
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1CAF
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "AC_Purchase.frx":1FD4
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2126
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "AC_Purchase.frx":2482
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":25D4
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_Purchase.frx":28E7
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2A39
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "AC_Purchase.frx":2D89
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2EDB
         Style           =   1  'Graphical
         TabIndex        =   66
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "AC_Purchase.frx":3239
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":338B
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "AC_Purchase.frx":3685
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":37D7
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "AC_Purchase.frx":3B2F
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":3C81
         Style           =   1  'Graphical
         TabIndex        =   74
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstPO_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_Purchase.frx":3FE0
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   690
         MouseIcon       =   "AC_Purchase.frx":4142
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4294
         Style           =   1  'Graphical
         TabIndex        =   79
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   -90
         MouseIcon       =   "AC_Purchase.frx":45D2
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4724
         Style           =   1  'Graphical
         TabIndex        =   80
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":4A8E
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4BE0
         Style           =   1  'Graphical
         TabIndex        =   23
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSPO_HD = gconDMIS.Execute("select pono, pono from PMIS_PO_HD where [TYPE] = 'A' AND pono like'" & XXX & "%'")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
