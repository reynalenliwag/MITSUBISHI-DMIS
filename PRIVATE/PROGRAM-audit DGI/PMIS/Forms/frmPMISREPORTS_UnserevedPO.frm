...
start1:
           ...
           'Label.Caption = "(" & Round((Prgbr.Value / Prgbr.Max) * 100, 0) & " % Completed)"
...
Private Sub Timer1_Timer()
  Dim i As Long
  Picture1.Line (xp, 0)-(xp + xw, Picture1.ScaleHeight), vbWhite, BF
  xp = xp + xi
  If xp > Picture1.ScaleWidth Then xp = 0
  xt = xp
  For i = 1 To 3
    Picture1.Line (xt, 0)-(xt + xw, Picture1.ScaleHeight), vbGreen, BF
    xt = xt + xi
    If xt > Picture1.ScaleWidth Then xt = 0
  Next
