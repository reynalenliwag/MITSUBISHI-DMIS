...
Begin VB.Form frmPMISAcc_ReceivingHist 
   ...
   ClientWidth     =   11835
   ForeColor       =   &H00DEDFDE&
   Icon            =   "frmPMISAcc_ReceivingHist.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7020
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdCancelRR 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":1B3D
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":1C8F
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":1FEB
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":213D
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":2450
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":25A2
         Style           =   1  'Graphical
         TabIndex        =   91
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":28F2
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":2A44
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":2DA2
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":2EF4
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":31EE
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":3340
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":3698
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":37EA
         Style           =   1  'Graphical
         TabIndex        =   98
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtRemarks 
         ...
         TabIndex        =   14
         Text            =   "frmPMISAcc_ReceivingHist.frx":3B49
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstREC_Hist 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":3B63
         NumItems        =   2
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Left            =   2370
         MaskColor       =   &H0000FFFF&
         Picture         =   "frmPMISAcc_ReceivingHist.frx":3CC5
         Style           =   1  'Graphical
         TabIndex        =   48
         Top             =   3120
         Width           =   1005
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Left            =   1230
         MaskColor       =   &H0000FFFF&
         Picture         =   "frmPMISAcc_ReceivingHist.frx":3FD7
         Style           =   1  'Graphical
         TabIndex        =   47
         Top             =   3120
         Width           =   975
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         Picture         =   "frmPMISAcc_ReceivingHist.frx":4419
         Style           =   1  'Graphical
         TabIndex        =   49
         Top             =   3120
         Width           =   1005
   ...
   Begin wizButton.cmd cmdAddTran 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmPMISAcc_ReceivingHist.frx":4723
   End
   Begin wizButton.cmd cmdUpdateMaster 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmPMISAcc_ReceivingHist.frx":473F
   End
   Begin VB.Frame fraUpdateMaster 
      ...
      Begin wizButton.cmd cmdOkUpdate 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmPMISAcc_ReceivingHist.frx":475B
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   660
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":4777
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":48C9
         Style           =   1  'Graphical
         TabIndex        =   102
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   -120
         MouseIcon       =   "frmPMISAcc_ReceivingHist.frx":4C07
         MousePointer    =   99  'Custom
         Picture         =   "frmPMISAcc_ReceivingHist.frx":4D59
         Style           =   1  'Graphical
         TabIndex        =   103
   ...
   End
End
Attribute VB_Name = "frmPMISAcc_ReceivingHist"
...
Private Sub cmdPrint_Click()
    ...
    If MsgQuestionBox("Receiving Report Transaction will be Printed. Are you Sure?", "Confirm Printing...") = True Then
        ...
        PrintSQLReport rptReceiving, PMIS_REPORT_PATH & "rr_hist.rpt", "{RR_HD.type} = 'A' and {RR_HD.rrno} = '" & txtRRNo.Text & "'", DMIS_REPORT_Connection, 1
...
Sub rsRefresh()
    ...
    rsREC_HIST.Open "select * from PMIS_Rec_Hist where type = 'A' order by rrno desc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub FillDetails()
    ...
    RR_QTY_REC = 0
    Set rsDaytran = New ADODB.Recordset
    rsDaytran.Open "select id,trantype,tranno,itemno,STOCK_ORD,STOCK_SUP,tranqty,tranucost,traninvamt from PMIS_DayTran where type = 'A' and trantype = 'RR' and tranno = " & N2Str2Null(rsREC_HIST!RRNO) & " order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsDaytran.EOF And Not rsDaytran.BOF Then
        Screen.MousePointer = 11
        rsDaytran.MoveFirst
        Do While Not rsDaytran.EOF
    ...
    If cboClasscode.Text = "PCG" Then
        If txtPONo.Text <> "" And AddorEdit = "ADD" And Len(txtPONo.Text) > 0 Then
            ...
            If Not rsPO_Hist.EOF And Not rsPO_Hist.BOF Then
                ...
                Set rsDAYTRANDup = New ADODB.Recordset
                rsDAYTRANDup.Open "select id,itemno,STOCK_ORD,STOCK_SUP,tranqty,traninvamt,tranucost from PMIS_DayTran where type = 'P' and trantype = 'PO' and tranno = " & N2Str2Null(rsPO_Hist!PONO) & " order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
                If Not rsDAYTRANDup.EOF And Not rsDAYTRANDup.BOF Then
                    Screen.MousePointer = 11
                    rsDAYTRANDup.MoveFirst
                    cleargrid grdDetails
...
Private Sub lstREC_HIST_DblClick()
    'If cmdEdit.Value = True Then cmdEdit.Enabled = False
    cmdEdit.Value = False
End Sub
...
Sub FillGrid()
    ...
    Set rsREC_HIST = New ADODB.Recordset
    Set rsREC_HIST = gconDMIS.Execute("select rrno,ID from PMIS_Rec_Hist where type = 'A' order by rrno asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsREC_HIST = gconDMIS.Execute("select rrno, ID from PMIS_Rec_Hist where type = 'A' and rrno like'" & XXX & "%'")
    If Not (rsREC_HIST.EOF And rsREC_HIST.BOF) Then
        lstREC_Hist.Enabled = True
        Listview_Loadval Me.lstREC_Hist.ListItems, rsREC_HIST
        lstREC_Hist.Refresh
...
Sub FillGrid2()
    ...
    lstREC_Hist.Sorted = False: lstREC_Hist.ListItems.Clear
    Set rsREC_HIST = New ADODB.Recordset
    Set rsREC_HIST = gconDMIS.Execute("select recvd_from, ID from PMIS_Rec_Hist where type = 'A' order by rrno asc")
    If Not (rsREC_HIST.EOF And rsREC_HIST.BOF) Then
        lstREC_Hist.Enabled = True
        Listview_Loadval Me.lstREC_Hist.ListItems, rsREC_HIST
        lstREC_Hist.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set rsREC_HIST = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsREC_HIST = gconDMIS.Execute("select recvd_from, ID from PMIS_Rec_Hist where type = 'A' recvd_from like '" & XXX & "%' order by rrno asc")
    If Not (rsREC_HIST.EOF And rsREC_HIST.BOF) Then
        lstREC_Hist.Enabled = True
        Listview_Loadval Me.lstREC_Hist.ListItems, rsREC_HIST
        lstREC_Hist.Refresh
