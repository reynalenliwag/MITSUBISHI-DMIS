...
Function GenRankFile() As Boolean
    ...
    Set RSPARTMAS = New ADODB.Recordset
    RSPARTMAS.Open "select STOCKNO,STOCKDESC,TYPE,onhand,mac,last_recd,invclass,subinvclas,DATE_ENTERED,EMERGENCY_PO,LOST_SALES,ONORDER,BACKORDER,datediff(day,date_entered,getdate()) as day,datediff(month,date_entered,getdate()) as months from PMIS_STOCKMAS WHERE ACTIVE = 'Y'  order by STOCKNO asc", gconDMIS
    If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
        RSPARTMAS.MoveFirst
        ...
        Do While Not RSPARTMAS.EOF
            ...
            vTotSales = 0: vMAD12 = 0: FOR_Y1 = 0: FOR_Y2 = 0: FOR_Y3 = 0: FOR_Y4 = 0: FOR_Y5 = 0
            ...
            Set RSSHIPPING = New ADODB.Recordset
            RSSHIPPING.Open " Select PREV_MONTH,MONTHS_2,MONTHS_3,MONTHS_4,MONTHS_5,MONTHS_6,MONTHS_7,MONTHS_8,MONTHS_9,MONTHS_10,MONTHS_11,MONTHS_12,MONTHS_13,MONTHS_14, " & _
                            " MONTHS_15,MONTHS_16,MONTHS_17,MONTHS_18,MONTHS_19,MONTHS_20,MONTHS_21,MONTHS_22,MONTHS_23,MONTHS_24,MONTHS_25,MONTHS_26,MONTHS_27,MONTHS_28, " & _
                            " MONTHS_29,MONTHS_30,MONTHS_31,MONTHS_32,MONTHS_33,MONTHS_34,MONTHS_35,MONTHS_36,MONTHS_37,MONTHS_38,MONTHS_39,MONTHS_40,MONTHS_41,MONTHS_42, " & _
                            " MONTHS_43,MONTHS_44,MONTHS_45,MONTHS_46,MONTHS_47,MONTHS_48,MONTHS_49,MONTHS_50,MONTHS_51,MONTHS_52,MONTHS_53,MONTHS_54,MONTHS_55,MONTHS_56, " & _
                            " MONTHS_57,MONTHS_58,MONTHS_59,MONTHS_60 from PMIS_Shipping where [TYPE] = " & N2Str2Null(RSPARTMAS!Type) & " AND PARTNO = " & N2Str2Null(RSPARTMAS!STOCKNO), gconDMIS
            If Not RSSHIPPING.EOF And Not RSSHIPPING.BOF Then
  
  'updated by: IEBV    1252011_05pm
  'description: new formula for ranking report
  '------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                   If VALID_COMPANY_CODE_FORHAI = True And COMPANY_CODE = "HGH" Then
                        ...
                        End If
                    Else
'                        A_SALES = N2Str2Zero(RSSHIPPING!Prev_Month) + N2Str2Zero(RSSHIPPING!Months_2) + N2Str2Zero(RSSHIPPING!Months_3) + N2Str2Zero(RSSHIPPING!Months_3) + N2Str2Zero(RSSHIPPING!Months_4) + N2Str2Zero(RSSHIPPING!Months_5) + N2Str2Zero(RSSHIPPING!Months_6) + N2Str2Zero(RSSHIPPING!Months_7) + N2Str2Zero(RSSHIPPING!Months_8) + N2Str2Zero(RSSHIPPING!Months_9) + N2Str2Zero(RSSHIPPING!Months_10) + N2Str2Zero(RSSHIPPING!Months_11) + N2Str2Zero(RSSHIPPING!months_12)
'                        B_SALES = N2Str2Zero(RSSHIPPING!Months_13) + N2Str2Zero(RSSHIPPING!Months_14) + N2Str2Zero(RSSHIPPING!Months_15) + N2Str2Zero(RSSHIPPING!Months_16) + N2Str2Zero(RSSHIPPING!Months_17) + N2Str2Zero(RSSHIPPING!Months_18) + N2Str2Zero(RSSHIPPING!Months_19) + N2Str2Zero(RSSHIPPING!Months_20) + N2Str2Zero(RSSHIPPING!Months_21) + N2Str2Zero(RSSHIPPING!Months_22) + N2Str2Zero(RSSHIPPING!Months_23) + N2Str2Zero(RSSHIPPING!Months_24)
...
'
                            For itx = 0 To 11
                                FOR_Y1 = FOR_Y1 + N2Str2Zero(RSSHIPPING.Fields(itx).Value)
                            Next itx
                            For itx = 12 To 23
                                FOR_Y2 = FOR_Y2 + N2Str2Zero(RSSHIPPING.Fields(itx).Value)
                            Next itx
                            For itx = 24 To 35
                                FOR_Y3 = FOR_Y3 + N2Str2Zero(RSSHIPPING.Fields(itx).Value)
                            Next itx
                            For itx = 36 To 47
                                FOR_Y4 = FOR_Y4 + N2Str2Zero(RSSHIPPING.Fields(itx).Value)
                            Next itx
                            For itx = 48 To 59
                                FOR_Y5 = FOR_Y5 + N2Str2Zero(RSSHIPPING.Fields(itx).Value)
                            Next itx
'                            If FOR_Y1 >= 360 Then
'                                vRankType = RANK_SUPER_FAST_MOVING
'                                vSubClass = "1"
'                                GoTo con
'                            ElseIf (FOR_Y1 >= 240 And FOR_Y1 <= 359) Then
'                                vRankType = RANK_SUPER_FAST_MOVING
'                                vSubClass = "2"
'                                GoTo con
'                            ElseIf (FOR_Y1 >= 120 And FOR_Y1 <= 239) Then
'                                vRankType = RANK_SUPER_FAST_MOVING
'                                vSubClass = "3"
'                                GoTo con
'                            ElseIf (FOR_Y1 >= 48 And FOR_Y1 <= 119) Then
'                                vRankType = RANK_FAST_MOVING
'                                GoTo con
'                            ElseIf (FOR_Y1 >= 24 And FOR_Y1 <= 47) Then
'                                vRankType = RANK_MEDIUM_MOVING
'                                GoTo con
'                            ElseIf (FOR_Y1 >= 1 And FOR_Y1 <= 23) Then
'                                vRankType = RANK_SLOW_MOVING
'                                GoTo con
'                            ElseIf (FOR_Y1 = 0 And N2Str2Zero(RSPARTMAS!months) >= 12 And N2Str2Zero(RSPARTMAS!months) <= 24) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "1"
'                                GoTo con
'                            ElseIf (FOR_Y2 > 0 And N2Str2Zero(RSPARTMAS!months) <= 24) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "1"
'                                GoTo con
'                            ElseIf (FOR_Y2 = 0 And N2Str2Zero(RSPARTMAS!months) <= 24) Then
...
'                                vSubClass = "2"
'                                GoTo con
'                            ElseIf (FOR_Y3 > 1 And N2Str2Zero(RSPARTMAS!months) <= 36) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "2"
'                                GoTo con
'                            ElseIf (FOR_Y3 = 0 And N2Str2Zero(RSPARTMAS!months) <= 36) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "3"
'                                GoTo con
'                            ElseIf (FOR_Y4 > 1 And N2Str2Zero(RSPARTMAS!months) <= 48) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "3"
'                                GoTo con
'                            ElseIf (FOR_Y4 = 0 And N2Str2Zero(RSPARTMAS!months) <= 48) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "4"
'                                GoTo con
'                            ElseIf (FOR_Y5 > 1 And N2Str2Zero(RSPARTMAS!months) <= 60) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "4"
'                                GoTo con
'                            ElseIf (FOR_Y5 = 0 And N2Str2Zero(RSPARTMAS!months) <= 60) Then
'                                vRankType = RANK_NON_MOVING
'                                vSubClass = "5"
'                                GoTo con
'                            ElseIf (N2Str2Zero(RSSHIPPING!Prev_Month) = 0) Then
'                                vRankType = RANK_NEW_PARTS
'                                GoTo con
'                            End If
'updated by: IEBV 11032012_0320pm
'description: new formula
                        Debug.Print N2Str2IntZero(RSPARTMAS!Day) & " " & N2Str2Zero(RSSHIPPING.Fields(1).Value) & "  " & FOR_Y1
                        If N2Str2IntZero(RSPARTMAS!Day) >= 30 Then
                            If N2Str2Zero(RSSHIPPING.Fields(0).Value) >= 70 And N2Str2Zero(RSSHIPPING.Fields(0).Value) <= 999999999 Then
                                vRankType = RANK_SUPER_FAST_MOVING
                                vSubClass = "1"
                            ElseIf N2Str2Zero(RSSHIPPING.Fields(0).Value) >= 50 And N2Str2Zero(RSSHIPPING.Fields(0).Value) <= 69 Then
                                vRankType = RANK_SUPER_FAST_MOVING
                                vSubClass = "2"
                            ElseIf N2Str2Zero(RSSHIPPING.Fields(0).Value) >= 30 And N2Str2Zero(RSSHIPPING.Fields(0).Value) <= 49 Then
                                vRankType = RANK_SUPER_FAST_MOVING
                                vSubClass = "3"
                            ElseIf N2Str2Zero(RSSHIPPING.Fields(0).Value) >= 20 And N2Str2Zero(RSSHIPPING.Fields(0).Value) <= 29 Then
                                vRankType = RANK_FAST_MOVING
                                vSubClass = ""
                            ElseIf N2Str2Zero(RSSHIPPING.Fields(0).Value) >= 10 And N2Str2Zero(RSSHIPPING.Fields(0).Value) <= 19 Then
                                vRankType = RANK_MEDIUM_MOVING
                                vSubClass = ""
                            ElseIf N2Str2Zero(RSSHIPPING.Fields(0).Value) >= 0 And FOR_Y1 <> 0 Then
                                vRankType = RANK_SLOW_MOVING
                                vSubClass = ""
                                GoTo con
                            ElseIf N2Str2Zero(RSPARTMAS!months) < 12 And FOR_Y1 = 0 Then
                                vRankType = RANK_SLOW_MOVING
                                vSubClass = ""
                                GoTo con
                            ElseIf (FOR_Y1 = 0 And N2Str2Zero(RSPARTMAS!months) >= 12 And N2Str2Zero(RSPARTMAS!months) < 24) Then
                            ...
                            ElseIf (FOR_Y2 > 0 And N2Str2Zero(RSPARTMAS!months) <= 24) Then
                                ...
                                vSubClass = "1"
                                GoTo con
                            ElseIf (FOR_Y2 = 0 And N2Str2Zero(RSPARTMAS!months) >= 24) And N2Str2Zero(RSPARTMAS!months) < 36 Then
                                vRankType = RANK_NON_MOVING
                                vSubClass = "2"
                                GoTo con
                            ElseIf (FOR_Y3 > 0 And N2Str2Zero(RSPARTMAS!months) <= 36) Then
                                ...
                                vSubClass = "2"
                                GoTo con
                            ElseIf (FOR_Y3 = 0 And N2Str2Zero(RSPARTMAS!months) >= 36) And N2Str2Zero(RSPARTMAS!months) < 48 Then
                                vRankType = RANK_NON_MOVING
                                vSubClass = "3"
                                GoTo con
                            ElseIf (FOR_Y4 > 0 And N2Str2Zero(RSPARTMAS!months) <= 48) Then
                                ...
                                vSubClass = "3"
                                GoTo con
                            ElseIf (FOR_Y4 = 0 And N2Str2Zero(RSPARTMAS!months) >= 48) And N2Str2Zero(RSPARTMAS!months) < 60 Then
                                vRankType = RANK_NON_MOVING
                                vSubClass = "4"
                                GoTo con
                            ElseIf (FOR_Y5 > 0 And N2Str2Zero(RSPARTMAS!months) <= 60) Then
                            ...
                            ElseIf (FOR_Y5 = 0 And N2Str2Zero(RSPARTMAS!months) >= 60) Then
                                ...
                                vSubClass = "5"
                                GoTo con
                            ElseIf (N2Str2Zero(RSPARTMAS!months) >= 12 And N2Str2Zero(RSPARTMAS!months) < 24) Then
                                If FOR_Y1 = 0 Then
                                    vRankType = RANK_NON_MOVING
                                    vSubClass = "1"
                                    GoTo con
                                End If
                            ElseIf (N2Str2Zero(RSPARTMAS!months) >= 24 And N2Str2Zero(RSPARTMAS!months) < 36) Then
                                If FOR_Y1 = 0 Then
                                    If FOR_Y2 = 0 Then
                                        vRankType = RANK_NON_MOVING
                                        vSubClass = "2"
                                ...
                                Else
                                    ...
                                    GoTo con
                                End If
                            ElseIf (N2Str2Zero(RSPARTMAS!months) >= 36 And N2Str2Zero(RSPARTMAS!months) < 48) Then
                                If FOR_Y1 = 0 Then
                                    If FOR_Y2 = 0 Then
                                        If FOR_Y3 = 0 Then
                                            vRankType = RANK_NON_MOVING
                                ...
                                Else
                                    ...
                                    GoTo con
                                End If
                            ElseIf (N2Str2Zero(RSPARTMAS!months) >= 48 And N2Str2Zero(RSPARTMAS!months) < 60) Then
                                If FOR_Y1 = 0 Then
                                    If FOR_Y2 = 0 Then
                                        If FOR_Y3 = 0 Then
                                            If FOR_Y4 = 0 Then
                                ...
                                Else
                                    ...
                                    GoTo con
                                End If
                            ElseIf (N2Str2Zero(RSPARTMAS!months) >= 60) Then
                                If FOR_Y1 = 0 Then
                                    If FOR_Y2 = 0 Then
                                        If FOR_Y3 = 0 Then
                                            If FOR_Y4 = 0 Then
...
'                    Number_Of_Years_No_Sale = 0
'                Else
'                    Number_Of_Years_No_Sale = Int((CDate(LOGDATE) - Null2Date(RSPARTMAS!DATE_ENTERED)) / 30)
'                End If
                If N2Str2IntZero(RSPARTMAS!Day) >= 30 Then
                    If N2Str2Zero(RSPARTMAS!months) < 12 Then
                        vRankType = RANK_SLOW_MOVING
                        vSubClass = ""
                    ElseIf N2Str2Zero(RSPARTMAS!months) >= 12 And N2Str2Zero(RSPARTMAS!months) < 24 Then
                        vRankType = RANK_NON_MOVING
            ...
            gconDMIS.Execute "insert into PMIS_RankFle " & _
                ...
                " values ( '" & RSPARTMAS!Type & "'  ," & N2Str2Null(RSPARTMAS!STOCKNO) & ", " & P_STOCKDESC & _
...
Private Sub cmdPost_Click()
    ...
    Set RSMONTHENDVALIDATEION = gconDMIS.Execute("select COUNT(*) from PMIS_Adjust where (isnull(status, '') = '' or status = 'N') AND month(LASTUPDATE) = '" & Month(Now) & "' and Year(LASTUPDATE) ='" & Year(Now) & "'")
    UNPOSTED_ADJ = RSMONTHENDVALIDATEION.Fields(0).Value
    
    If N2Str2IntZero(gconDMIS.Execute("Select count(id) as count from pmis_tdaytran").Fields(0).Value) = 0 Then
        MsgBox "NO Data To Process", vbInformation + vbOKOnly, "No Data"
        Exit Sub
    End If
    ...
    If (UNPOSTED_ORD + UNPOSTED_RR + UNPOSTED_PO) > 0 Then
        MsgBox "" & vbCrLf & "Unposted Issuances:" & UNPOSTED_ORD & vbCrLf & _
               ...
               "Unposted Adjustment: " & UNPOSTED_ADJ & vbCrLf & _
        ...
        SQLX = SQLX & " Union All " & vbCrLf
        SQLX = SQLX & " SELECT Lastupdate,'000000','ADJ',TYPE FROM PMIS_Adjust WHERE  (ISNULL(STATUS,'')='' OR  ISNULL(STATUS,'')='N') AND month(LASTUPDATE) = '" & Month(Now) & "' and Year(LASTUPDATE) ='" & Year(Now) & "'"
    ...
    If MsgQuestionBox("Close All Transactions, Are You Sure?", "Month End Processing") = True Then
        ...
        If FIXONHAND = False Then

            str_MSG = Replace(Replace(str_MSG, "@UTX83912839123", "Ledger Balancing"), "IVAN", error_msg)
        ...
        If FIXMAC = False Then
        
            str_MSG = Replace(Replace(str_MSG, "@UTX83912839123", "Mac Fixing"), "IVAN", error_msg)
            MsgBox str_MSG, vbCritical, "Month End Error"
            cmdExit.Enabled = True
            gconDMIS.RollbackTrans
            Screen.MousePointer = 0
        ...
        If UpdateMaster = False Then
            ...
            str_MSG = Replace(Replace(str_MSG, "@UTX83912839123", "Update Master file"), "IVAN", error_msg)
            MsgBox str_MSG, vbCritical, "Month End Error"
            cmdExit.Enabled = True
            gconDMIS.RollbackTrans
            Screen.MousePointer = 0
        ...
        If MonthEndUpdate = False Then
            ...
            str_MSG = Replace(Replace(str_MSG, "@UTX83912839123", "Month End Update"), "IVAN", error_msg)
            MsgBox str_MSG, vbCritical, "Month End Error"
            cmdExit.Enabled = True
            gconDMIS.RollbackTrans
            Screen.MousePointer = 0
        ...
        If GenRankFile = False Then
            ...
            str_MSG = Replace(Replace(str_MSG, "@UTX83912839123", "Generating Ranking"), "IVAN", error_msg)
        ...
        If CreateStockStatus = False Then
            ...
            str_MSG = Replace(Replace(str_MSG, "@UTX83912839123", "Creating Stock Status"), "IVAN", error_msg)
...
Private Sub LST_UNPOSTED_RowDblClick(ByVal Row As XtremeReportControl.IReportRow, ByVal Item As XtremeReportControl.IReportRecordItem)
    If Row.Record(2).Value = "PO" And Row.Record(3).Value = "P" Then
        frmMainMenu.cmdMain_PartsPO.Value = True
    ...
    ElseIf Row.Record(2).Value = "PO" And Row.Record(3).Value = "A" Then
        frmMainMenu.cmdAcc_PO.Value = True
    ...
    ElseIf Row.Record(2).Value = "PO" And Row.Record(3).Value = "M" Then
        frmMainMenu.cmdMat_PO.Value = True
    ...
    ElseIf Row.Record(2).Value = "RR" And Row.Record(3).Value = "P" Then
        frmMainMenu.cmdMain_PartsReceiving.Value = True
    ...
    ElseIf Row.Record(2).Value = "RR" And Row.Record(3).Value = "A" Then
        frmMainMenu.cmdAcc_RR.Value = True
    ...
    ElseIf Row.Record(2).Value = "RR" And Row.Record(3).Value = "M" Then
        frmMainMenu.cmdMat_RR.Value = True
    ...
    ElseIf Row.Record(2).Value = "CHG" And Row.Record(3).Value = "P" Then
        frmMainMenu.cmdMain_PartsIssuanceOC_CHG.Value = True
        frmPMISTrans_CustomerOrder.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder.click
    ElseIf Row.Record(2).Value = "RIV" And Row.Record(3).Value = "P" Then
        frmMainMenu.cmdMain_PartsIssuanceServiceIssuance.Value = True
        frmPMISTrans_CustomerOrder.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder.click
    ElseIf Row.Record(2).Value = "CSH" And Row.Record(3).Value = "A" Then
        frmMainMenu.cmdAcc_ISS_CSH.Value = True
    ...
    ElseIf Row.Record(2).Value = "CHG" And Row.Record(3).Value = "A" Then
        frmMainMenu.cmdAcc_ISS_CHG.Value = True
        frmPMISTrans_CustomerOrder_AC.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder_AC.click
    ElseIf Row.Record(2).Value = "RIV" And Row.Record(3).Value = "A" Then
        frmMainMenu.cmdAcc_ISS_RIV.Value = True
        frmPMISTrans_CustomerOrder_AC.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder_AC.click
    ElseIf Row.Record(2).Value = "CSH" And Row.Record(3).Value = "M" Then
        frmMainMenu.cmdMat_OverTheCounter.Value = True
    ...
    ElseIf Row.Record(2).Value = "RIV" And Row.Record(3).Value = "M" Then
        frmMainMenu.cmdMat_ServiceIssuance.Value = True
        frmPMISTrans_CustomerOrder_MAT.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder_MAT.click
    ElseIf Row.Record(2).Value = "CHG" And Row.Record(3).Value = "M" Then
         frmMainMenu.cmd_overthecounter_chg.Value = True
         frmPMISTrans_CustomerOrder_MAT.textSearch.Text = Row.Record(1).Value
         frmPMISTrans_CustomerOrder_MAT.click
    ElseIf Row.Record(2).Value = "DR" And Row.Record(3).Value = "P" Then
        frmMainMenu.cmdMain_PartsDROut.Value = True
        frmPMISTrans_CustomerOrder.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder.click
    ElseIf Row.Record(2).Value = "DR" And Row.Record(3).Value = "A" Then
        frmMainMenu.cmdAcc_ISS_DR.Value = True
        frmPMISTrans_CustomerOrder_AC.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder_AC.click
    ElseIf Row.Record(2).Value = "DR" And Row.Record(3).Value = "M" Then
        frmMainMenu.cmdMat_DROut.Value = True
        frmPMISTrans_CustomerOrder_MAT.textSearch.Text = Row.Record(1).Value
        frmPMISTrans_CustomerOrder_MAT.click
    ElseIf Row.Record(2).Value = "ADJ" And Row.Record(3).Value = "P" Then
    ...
    ElseIf Row.Record(2).Value = "ADJ" And Row.Record(3).Value = "A" Then
    ...
    ElseIf Row.Record(2).Value = "ADJ" And Row.Record(3).Value = "M" Then
...
Function FIXONHAND() As Boolean
    Dim cmd                                            As ADODB.Command
    Dim ictr                                           As Integer
    Dim COUNTER                                        As Integer
    Dim i                                              As Integer
    Dim CMDONHAND_FIX                                  As ADODB.Command
    Dim CMD_COMP_ONHAND                                As ADODB.Command
    Dim RSHD                                           As ADODB.Recordset
    Dim RSONHAND                                       As ADODB.Recordset
    Dim fylname                                        As String
    Dim Itmss                                          As String
    ...
    XTYPE(3) = "P"  'Parts
    i = 0
    fylname = COMPANY_CODE & "_" & Replace(LOGDATE, "/", "") & "" & Replace(LOGTIME, ":", "") & "(Balanced Stocks).txt"
    With CDB1
        .FileName = fylname
        .InitDir = App.Path
    ...
    For ictr = 1 To COUNTER
        ...
        Else
            VPARTS = "Materials.."
        End If
        txtCurrentActivity.Text = txtCurrentActivity.Text & vbCrLf & "Checking Ledger Balance........" & VPARTS: DoEvents
        ...
        If Not (RSHD.EOF And RSHD.BOF) Then
            RSHD.MoveFirst
            progCPB.Max = RSHD.RecordCount
            progCPB.Value = 0
            Do While Not RSHD.EOF
                i = i + 1
                Set CMD_COMP_ONHAND = New ADODB.Command
                With CMD_COMP_ONHAND
                    .NamedParameters = True
                    .CommandType = adCmdStoredProc
                    .CommandText = "SP_PMIS_CHECK_ONHAND"
                    .ActiveConnection = gconDMIS
                    .CommandTimeout = 1000
                    .Parameters.Append .CreateParameter("@STOCKNO", adVarChar, adParamInput, 50, RSHD!STOCKNO)
                    .Parameters.Append .CreateParameter("@TYPE", adVarChar, adParamInput, 50, XTYPE(ictr))
                End With
                
                Set RSONHAND = CMD_COMP_ONHAND.Execute: DoEvents
                If Not (RSONHAND.EOF And RSONHAND.BOF) Then
                    Itmss = XTYPE(ictr) & " | " & RSHD!STOCKNO & " | " & RSHD!STOCKDESC & " | " & RSHD!MAC & " | " & RSHD!SRP & " | " & RSHD!ONHAND & " | " & RSONHAND!onhandasof
                    Print #1, Itmss
                    If i = 1 Then
                        txtCurrentActivity.Text = txtCurrentActivity.Text & vbCrLf & "A txt file has been created (" & App.Path & "\" & fylname & ")"
                    End If
                End If
                
                labCPB.Caption = (Round((i / RSHD.RecordCount) * 100, 0) & "%"): DoEvents
                labProcessing.Caption = "Fixing ( " & RSHD!STOCKNO & " ) ": DoEvents
                progCPB.Value = Round((i / RSHD.RecordCount) * 100, 0): DoEvents
                
            RSHD.MoveNext
            Loop
            
            Set CMDONHAND_FIX = New ADODB.Command
            With CMDONHAND_FIX
                .NamedParameters = True
                .CommandType = adCmdStoredProc
            ...
            DoEvents
            CMDONHAND_FIX.Execute: DoEvents
        End If
    Next ictr
    Close #1
    FIXONHAND = True
...
Function FIXMAC() As Boolean
    ...
    Set CMDMAC = New ADODB.Command
        ...
        End With
    DoEvents
    txtCurrentActivity.Text = txtCurrentActivity.Text & vbCrLf & "Checking Mac........"
    CMDMAC.Execute: DoEvents
    DoEvents
    '2 : BEGINNING MAC AND COST ARE NOT EQUAL and tag it to 3
    RSMAC_CTR = 0
    RSMAC_CTR = NumericVal(gconDMIS.Execute("Select count(*) from pmis_stockmas where tag_mac = '2'").Fields(0).Value)
    If RSMAC_CTR > 0 Then
        ...
        DoEvents
    End If
    '1 : WRONG COMPUTATION OF MAC OR COST and tag it to 3
    RSMAC_CTR = 0
    RSMAC_CTR = NumericVal(gconDMIS.Execute("Select count(*) from pmis_stockmas where tag_mac = '1'").Fields(0).Value)
    If RSMAC_CTR > 0 Then
        Set CMDMAC_FIX = New ADODB.Command
        Screen.MousePointer = 11
        With CMDMAC_FIX
    ...
    End If
    'fix mac issues
    RSMAC_CTR = NumericVal(gconDMIS.Execute("Select count(*) from pmis_stockmas where tag_mac = '3'").Fields(0).Value)
    If RSMAC_CTR > 0 Then
        Set CMDMAC_FIX = New ADODB.Command
        Screen.MousePointer = 11
        With CMDMAC_FIX
        ...
        End With
        DoEvents
        txtCurrentActivity.Text = txtCurrentActivity.Text & vbCrLf & "Fixing Mac........"
        CMDMAC_FIX.Execute: DoEvents
        DoEvents
    End If
