...
Begin VB.Form frmPMISAC_ReceivingHist 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Accessories Receiving History"
   ClientHeight    =   7965
   ClientLeft      =   855
   ClientTop       =   855
   ClientWidth     =   12315
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AC_ReceivingHist.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstREC_Hist 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_ReceivingHist.frx":08CA
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7680
         MouseIcon       =   "AC_ReceivingHist.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   45
         Top             =   30
         Width           =   765
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   6930
         MouseIcon       =   "AC_ReceivingHist.frx":0EE4
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":1036
         Style           =   1  'Graphical
         TabIndex        =   46
         Top             =   30
         Width           =   765
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   6180
         MouseIcon       =   "AC_ReceivingHist.frx":139C
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":14EE
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   30
         Width           =   765
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   5430
         MouseIcon       =   "AC_ReceivingHist.frx":183E
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":1990
         Style           =   1  'Graphical
         TabIndex        =   43
         Top             =   30
         Width           =   765
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "AC_ReceivingHist.frx":1CEE
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":1E40
         Style           =   1  'Graphical
         TabIndex        =   47
         Top             =   30
         Width           =   765
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   3930
         MouseIcon       =   "AC_ReceivingHist.frx":213A
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":228C
         Style           =   1  'Graphical
         TabIndex        =   48
         Top             =   30
         Width           =   765
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_ReceivingHist.frx":25E4
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":2736
         Style           =   1  'Graphical
         TabIndex        =   49
         Top             =   30
         Width           =   765
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "AC_ReceivingHist.frx":2A95
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":2BE7
         Style           =   1  'Graphical
         TabIndex        =   52
         Top             =   0
         Width           =   705
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   705
         MouseIcon       =   "AC_ReceivingHist.frx":2F37
         MousePointer    =   99  'Custom
         Picture         =   "AC_ReceivingHist.frx":3089
         Style           =   1  'Graphical
         TabIndex        =   51
         Top             =   0
         Width           =   705
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtRemarks 
         ...
         TabIndex        =   13
         Text            =   "AC_ReceivingHist.frx":33C7
   ...
   End
End
Attribute VB_Name = "frmPMISAC_ReceivingHist"
...
Sub rsRefresh()
    ...
    RSREC_HIST.Open "select * from PMIS_Rec_Hist where type = 'A' order by ID desc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub StoreMemVars()
    ...
    If Not RSREC_HIST.EOF And Not RSREC_HIST.BOF Then
        ...
        labAPJ = CheckAPJNum(Null2String(RSREC_HIST!RRNO), "AI")
...
Sub FillDetails()
    ...
    RSDAYTRAN.Open "select id,trantype,tranno,itemno,STOCK_ORD,STOCK_SUP,tranqty,tranucost,traninvamt from PMIS_DayTran where type = 'A' and trantype = 'RR' and tranno = " & N2Str2Null(RSREC_HIST!RRNO) & " and trandate = '" & Null2String(RSREC_HIST!RRDATE) & "'order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Sub FillGrid()
    ...
    Set RSREC_HIST = New ADODB.Recordset
    Set RSREC_HIST = gconDMIS.Execute("select rrno,ID from PMIS_Rec_Hist where type = 'A' order by ID desc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSREC_HIST = gconDMIS.Execute("select rrno, ID from PMIS_Rec_Hist where type = 'A' and rrno like'" & XXX & "%' order by ID desc")
    If Not (RSREC_HIST.EOF And RSREC_HIST.BOF) Then
        lstREC_Hist.Enabled = True
        Listview_Loadval Me.lstREC_Hist.ListItems, RSREC_HIST
        lstREC_Hist.Refresh
...
Sub FillGrid2()
    ...
    lstREC_Hist.Sorted = False: lstREC_Hist.ListItems.Clear
    Set RSREC_HIST = New ADODB.Recordset
    Set RSREC_HIST = gconDMIS.Execute("select recvd_from, ID from PMIS_Rec_Hist where type = 'A' order by ID desc")
    If Not (RSREC_HIST.EOF And RSREC_HIST.BOF) Then
        lstREC_Hist.Enabled = True
        Listview_Loadval Me.lstREC_Hist.ListItems, RSREC_HIST
        lstREC_Hist.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set RSREC_HIST = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set RSREC_HIST = gconDMIS.Execute("select recvd_from, ID from PMIS_Rec_Hist where type = 'A' AND recvd_from like '" & XXX & "%' order by ID desc")
    If Not (RSREC_HIST.EOF And RSREC_HIST.BOF) Then
        lstREC_Hist.Enabled = True
        Listview_Loadval Me.lstREC_Hist.ListItems, RSREC_HIST
        lstREC_Hist.Refresh
...
Private Sub cmdPrint_Click()
    ...
    'If Function_Access(LOGID, "Acess_Print", "ACCESSORIES TRANSACTION HISTORY RECEIVING AND STORING") = False Then Exit Sub
    ...
    If MsgQuestionBox("Receiving Report Transaction will be Printed. Are you Sure?", "Confirm Printing...") = True Then
        ...
        PrintSQLReport rptReceiving, PMIS_REPORT_PATH & "RRAC_hist.rpt", "{RR_HD.type} = 'A' and {RR_HD.rrno} = '" & txtRRNo.Text & "'", DMIS_REPORT_Connection, 1
        NEW_LogAudit "V", "TRANSACTION HISTORY RECEIVING STORING", "", "", "Accessories", txtRRNo, "Receiving", ""
        Screen.MousePointer = 0
    End If
    Exit Sub
ErrorCode:
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            frmALL_AuditInquiry.Caption = "Audit Inquiry (ACCESSORIES RECEIVING)"
