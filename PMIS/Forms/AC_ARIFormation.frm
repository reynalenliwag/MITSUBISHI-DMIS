...
Sub GetSeries()
    ...
    RSORD_HD.Open "select is_series from PMIS_vw_PRS where TYPE = 'A' AND sales_origin = '" & lbl2.Caption & "' and SI_TYPE ='" & lbl3.Caption & "' and  PAY_CLASS = '" & lbl4.Caption & "'  order by REPLICATE('0',4 - LEN(IS_SERIES)) + IS_SERIES desc ", gconDMIS
...
Private Sub cmdOk_Click()
    ...
    Dim RSORD_HD                                       As ADODB.Recordset
    Set RSORD_HD = New ADODB.Recordset
    RSORD_HD.Open "select refpisno,TRANNO from PMIS_vw_PRS where TYPE = 'A' AND refpisno = '" & PISNUMBER & "' ", gconDMIS
    If Not RSORD_HD.EOF And Not RSORD_HD.BOF Then
