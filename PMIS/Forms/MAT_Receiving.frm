...
Begin VB.Form frmPMISTrans_Receiving2_MAT 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "MAT_Receiving.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   90
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "MAT_Receiving.frx":0EBC
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":100E
         Style           =   1  'Graphical
         TabIndex        =   89
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton Command1 
         Height          =   825
         Left            =   3090
         MouseIcon       =   "MAT_Receiving.frx":1378
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":14CA
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      Begin VB.Frame fraUpdateMaster 
         ...
         Begin VB.CommandButton cmdOKUpdate 
            ...
            Height          =   555
            Left            =   3675
            MouseIcon       =   "MAT_Receiving.frx":1D33
            MousePointer    =   99  'Custom
            Picture         =   "MAT_Receiving.frx":1E85
            Style           =   1  'Graphical
            TabIndex        =   93
            Top             =   1380
            Width           =   555
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   6660
         MouseIcon       =   "MAT_Receiving.frx":2120
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":2272
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   5940
         MouseIcon       =   "MAT_Receiving.frx":259D
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":26EF
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   5220
         MouseIcon       =   "MAT_Receiving.frx":2A2D
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":2B7F
         Style           =   1  'Graphical
         TabIndex        =   73
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "MAT_Receiving.frx":2ECF
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":3021
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "MAT_Receiving.frx":3387
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":34D9
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdCancelRR 
         ...
         Left            =   7080
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Receiving.frx":383F
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":3991
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Receiving.frx":3CCB
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":3E1D
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Receiving.frx":4162
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":42B4
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "MAT_Receiving.frx":45D9
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":472B
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "MAT_Receiving.frx":4A87
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":4BD9
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "MAT_Receiving.frx":4EEC
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":503E
         Style           =   1  'Graphical
         TabIndex        =   86
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "MAT_Receiving.frx":538E
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":54E0
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "MAT_Receiving.frx":583E
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":5990
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Receiving.frx":5C8A
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":5DDC
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_Receiving.frx":6134
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Receiving.frx":6286
         Style           =   1  'Graphical
         TabIndex        =   79
...
Sub initMemvars()
    ...
    'JJE Prefix 02/07/2013 5:20PM
'    If COMPANY_CODE = "DJM" Then       ** FOR APPROVAL **
'        txtRRNo.Text = "MR" + txtRRNo.Text
'    End If
    'JJE
...
Private Sub cmdCancelRR_Click()
    ...
    If LOGLEVEL <> "ADM" Then
        ...
        Exit Sub
    End If
    If chkstatus(txtRRNo.Text, "M", "RR") = "P" Then
        MessagePop InfoVoid, "Action void", "Transaction already posted!"
        Exit Sub
    ElseIf chkstatus(txtRRNo.Text, "M", "RR") = "C" Then
...
Private Sub cmdPost_Click()
    ...
    '-----------------------------------------------------------------------------------
    If txtPONo.Text <> "" Then
     If Post_ValidQuantity("M", txtPONo.Text, txtRRNo.Text) = False Then
            ...
            If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
                ...
                If ISNONVAT = True Then
                    SQL_STATEMENT = "update CSMS_MATMAS set onhand = " & N2Str2Zero(RSPARTMAS!ONHAND) + NumericVal(RSTDAYTRAN!TRANQTY) & ", " & _
                                  ...
                                  " dnp = '" & (N2Str2Zero(RSTDAYTRAN!MAC)) & "'" & _
                ...
                Else
                    SQL_STATEMENT = "update CSMS_MATMAS set onhand = " & N2Str2Zero(RSPARTMAS!ONHAND) + NumericVal(RSTDAYTRAN!TRANQTY) & ", " & _
                                  ...
                                  " last_recd = '" & LOGDATE & "', " & _
                                  " supcode = " & N2Str2Null(txtRecvd_Code.Text) & "," & _
                                  " dnp = '" & (N2Str2Zero(RSTDAYTRAN!MAC) * 1.12) & "'" & _
                                  " where STOCKNO = " & N2Str2Null(RSPARTMAS!STOCKNO)
...
'---------------------------------------------------------------------------------------------------------------------------------------------
        If AddorEdit = "ADD" Then
            If checkdup_INVO("M", txtINVNo.Text, txtRecvd_Code.Text) = True Then
                MsgBox "Invoice number already used!", vbInformation + vbOKOnly
                On Error Resume Next
                txtINVNo.SetFocus
                Exit Sub
            End If
            If checkdup_DRNO("M", txtDRNo.Text, txtRecvd_Code.Text) = True Then
        ...
        If AddorEdit = "ADD" Then
            If checkdup_rr("M", txtRRNo.Text) = True Then
                If MsgBox("RR Number already exist!, Do you want to generate new RR number?", vbQuestion + vbYesNo) = vbYes Then
                    txtRRNo.Text = getnextISSPORR("M", "RR")
                Else
                    On Error Resume Next
                    txtRRNo.SetFocus
                    Exit Sub
...
Private Sub cmdTranDelete_Click()
    ...
    If checkfcleartodelete("M", txtRRNo.Text, cboTranPartNo.Text) = False Then
...
Private Sub cmdUnPost_Click()
    ...
    If chkstatus(txtRRNo.Text, "M", "RR") = "N" Then
...
On Error GoTo errordaa
    ...
    Set RSTDAYTRAN = New ADODB.Recordset
    RSTDAYTRAN.Open "select id,itemno,trantype,tranno,STOCK_ORD,tranqty,traninvamt,status,trandate from PMIS_TdayTran where [TYPE] = 'M' AND trantype = 'RR' and tranno = " & N2Str2Null(rsRR_HD!RRNO) & " order by itemno asc", gconDMIS
    If Not RSTDAYTRAN.EOF And Not RSTDAYTRAN.BOF Then
        RSTDAYTRAN.MoveFirst
        Do While Not RSTDAYTRAN.EOF
            Set RSPARTMAS = New ADODB.Recordset
            ...
            If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
                If Null2String(RSTDAYTRAN!STATUS) = "P" Then
                    ...
                    SQL_STATEMENT = "update CSMS_MATMAS set onhand =" & tmpOnHand & ", " & _
                                  ...
                                  " last_recq = " & 0 & ", " & _
                                  " last_recd = NULL, " & _
                                  " mac = " & NumericVal(getlastmac(N2Str2Null(RSPARTMAS!STOCKNO), "M", RSTDAYTRAN!TRANDATE, RSTDAYTRAN!ID)) & ", " & _
                                  " dnp = " & NumericVal(getlastdnp(N2Str2Null(RSPARTMAS!STOCKNO), "M", RSTDAYTRAN!TRANDATE, RSTDAYTRAN!ID)) & ", " & _
                                  " supcode = NULL" & _
                                  " where STOCKNO = " & N2Str2Null(RSPARTMAS!STOCKNO)
                    gconDMIS.Execute SQL_STATEMENT
    ...
    Select Case KeyCode
        ...
        Case vbKeyF4
            If FILD <> "" And FILD <> "No Entry" Then
                If Picture1.Visible = True Then
                    If chkstatus(txtRRNo.Text, "M", "RR") <> "P" And chkstatus(txtRRNo.Text, "M", "RR") <> "C" Then
                        grdDetails_DblClick
                        Picture1.Enabled = False
                        fraDetails.Enabled = False
...
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    rsPO_POST.Open "select pono from PMIS_vw_RR_Trans where [TYPE] = 'M' AND pono = '" & txtPONo.Text & "' and isnull(status,'N') = 'N'", gconDMIS
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------
