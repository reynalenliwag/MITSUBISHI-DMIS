...
Begin VB.Form frmPMISMAT_Purchase 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "MAT_Purchase.frx":0A46
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":0B98
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "MAT_Purchase.frx":0EFE
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":1050
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7080
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":13B6
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":1508
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":1842
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":1994
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "MAT_Purchase.frx":1CD9
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":1E2B
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "MAT_Purchase.frx":2150
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":22A2
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "MAT_Purchase.frx":25FE
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":2750
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "MAT_Purchase.frx":2A63
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":2BB5
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "MAT_Purchase.frx":2F05
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":3057
         Style           =   1  'Graphical
         TabIndex        =   66
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "MAT_Purchase.frx":33B5
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":3507
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Purchase.frx":3801
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":3953
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_Purchase.frx":3CAB
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":3DFD
         Style           =   1  'Graphical
         TabIndex        =   74
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Purchase.frx":415C
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":42AE
         Style           =   1  'Graphical
         TabIndex        =   79
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_Purchase.frx":45EC
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase.frx":473E
         Style           =   1  'Graphical
         TabIndex        =   80
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSPO_HD = gconDMIS.Execute("select ID, pono from PMIS_PO_HD where [TYPE] = 'M' AND pono like'" & XXX & "%'")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, RSPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
Private Sub cmdCancelPO_Click()
    ...
    If LOGLEVEL <> "ADM" Then
        ...
        Exit Sub
    End If
    If chkstatus(txtPONo.Text, "M", "PO") = "P" Then
        MessagePop InfoVoid, "Action void", "Transaction already posted!"
        Exit Sub
    ElseIf chkstatus(txtPONo.Text, "M", "PO") = "C" Then
    ...
    If Not rsPMIS_Tdaytran.EOF And Not rsPMIS_Tdaytran.BOF Then
        ...
        Do While Not rsPMIS_Tdaytran.EOF
            ...
            If Not rsCSMS_MATMAS.EOF And Not rsCSMS_MATMAS.BOF Then
                ...
                Call TAGIFINACTIVE(Null2String(rsCSMS_MATMAS!STOCKNO), "M")
                '-----------------------------------------------------
            End If
            rsPMIS_Tdaytran.MoveNext
        Loop
...
Private Sub cmdUnPost_Click()
    ...
    If chkstatus(txtPONo.Text, "M", "PO") = "N" Then
        ...
        If AddorEdit = "ADD" Then
            If checkdup_PO("M", txtPONo.Text) = True Then
                If MsgBox("Purchase Order Number already exist!, Do you want to generate new PO number?", vbQuestion + vbYesNo) = vbYes Then
                    txtPONo.Text = getnextISSPORR("M", "PO")
                Else
                    On Error Resume Next
                    txtPONo.SetFocus
                    Exit Sub
    ...
    Select Case KeyCode
        ...
        Case vbKeyF4
            If FILD <> "" And FILD <> "No Entry" Then
                If Picture1.Visible = True Then
                    If chkstatus(txtPONo.Text, "M", "PO") <> "P" And chkstatus(txtPONo.Text, "M", "PO") <> "C" Then
                        grdDetails_DblClick
                    End If
                End If
            End If
