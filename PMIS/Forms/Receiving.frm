...
Begin VB.Form frmPMISTrans_Receiving2 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "Receiving.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   87
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "Receiving.frx":0EBC
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":100E
         Style           =   1  'Graphical
         TabIndex        =   86
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboClasscode 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "Receiving.frx":1378
         Left            =   5550
         List            =   "Receiving.frx":137A
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   7410
         MouseIcon       =   "Receiving.frx":137C
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":14CE
         Style           =   1  'Graphical
         TabIndex        =   111
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   825
         Left            =   3060
         MouseIcon       =   "Receiving.frx":17F9
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":194B
         Style           =   1  'Graphical
         TabIndex        =   108
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   6690
         MouseIcon       =   "Receiving.frx":21B4
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":2306
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   5970
         MouseIcon       =   "Receiving.frx":2644
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":2796
         Style           =   1  'Graphical
         TabIndex        =   113
      ...
      Begin VB.Frame fraUpdateMaster 
         ...
         Begin VB.ComboBox cboClass 
            Height          =   315
            ItemData        =   "Receiving.frx":2AE6
            Left            =   1290
            List            =   "Receiving.frx":2AE8
            Style           =   2  'Dropdown List
            TabIndex        =   120
            Top             =   2190
            Width           =   2835
         ...
         Begin VB.CommandButton cmdOKUpdate 
            ...
            Height          =   555
            Left            =   4260
            MouseIcon       =   "Receiving.frx":2AEA
            MousePointer    =   99  'Custom
            Picture         =   "Receiving.frx":2C3C
            Style           =   1  'Graphical
            TabIndex        =   89
            Top             =   1470
            Width           =   555
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   9000
         MouseIcon       =   "Receiving.frx":2ED7
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":3029
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8220
         MouseIcon       =   "Receiving.frx":338F
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":34E1
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdCancelRR 
         ...
         Left            =   7440
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Receiving.frx":3847
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":3999
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6660
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Receiving.frx":3CD3
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":3E25
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5880
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Receiving.frx":416A
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":42BC
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5100
         MouseIcon       =   "Receiving.frx":45E1
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":4733
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4320
         MouseIcon       =   "Receiving.frx":4A8F
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":4BE1
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "Receiving.frx":4EF4
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":5046
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2760
         MouseIcon       =   "Receiving.frx":5396
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":54E8
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1980
         MouseIcon       =   "Receiving.frx":5846
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":5998
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1200
         MouseIcon       =   "Receiving.frx":5C92
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":5DE4
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   420
         MouseIcon       =   "Receiving.frx":613C
         MousePointer    =   99  'Custom
         Picture         =   "Receiving.frx":628E
         Style           =   1  'Graphical
         TabIndex        =   76
...
Private Sub cmdCancelRR_Click()
    ...
    On Error GoTo ErrorCode:
    If chkstatus(txtRRNo.Text, "P", "RR") = "P" Then
        MessagePop InfoVoid, "Action void", "Transaction already posted!"
        Exit Sub
    ElseIf chkstatus(txtRRNo.Text, "P", "RR") = "C" Then
...
Private Sub cmdTranSave_Click()
    ...
    Else
    'updated by: IEBV
    'desciption: donot allow duplicate part if edited
        Dim FILD                                           As Integer
        Dim part                                           As String
        Dim Item                                           As Integer
        Dim I As Integer
...
Private Sub cmdUnPost_Click()
    ...
    If chkstatus(txtRRNo.Text, "P", "RR") = "N" Then
            ...
            If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
                If Null2String(RSTDAYTRAN!STATUS) = "P" Then
                    ...
                    SQL_STATEMENT = "update PMIS_PARTMAS set " & _
                        ...
                        " last_recq = " & 0 & ", " & _
                        " last_recd = NULL, " & _
                        " mac = " & NumericVal(getlastmac(N2Str2Null(RSPARTMAS!STOCKNO), "P", RSTDAYTRAN!trandate, RSTDAYTRAN!ID)) & ", " & _
                        " dnp = " & NumericVal(getlastdnp(N2Str2Null(RSPARTMAS!STOCKNO), "P", RSTDAYTRAN!trandate, RSTDAYTRAN!ID)) & ", " & _
                        " supcode = NULL" & _
                        " where STOCKNO = " & N2Str2Null(RSPARTMAS!STOCKNO) & " and [type] = " & MODULE_STOCK_TYPE
                    gconDMIS.Execute SQL_STATEMENT
        ...
        If AddorEdit = "ADD" Then
            If checkdup_rr("P", txtRRNo.Text) = True Then
                If MsgBox("RR Number already exist!, Do you want to generate new RR number?", vbQuestion + vbYesNo) = vbYes Then
                    txtRRNo.Text = getnextISSPORR("P", "RR")
                Else
                    On Error Resume Next
                    txtRRNo.SetFocus
                    Exit Sub
...
'---------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If AddorEdit = "ADD" Then
            If checkdup_INVO("P", txtINVNo.Text, txtRecvd_Code.Text) = True Then
                ...
                Exit Sub
            End If
            If checkdup_DRNO("P", txtDRNo.Text, txtRecvd_Code.Text) = True Then
...
On Error GoTo errordaa
    ...
    If AddorEdit = "ADD" Then
        ...
        NewRRCunTer = NumericVal(Right(txtRRNo.Text, 6)) + 1
    Else
        SQL_STATEMENT = "update PMIS_RR_Hd set" & _
                      " rrno = " & VTXTRRNo & "," & _
                      " rrdate = " & VTXTRRDate & "," & _
...
'                    RRSTATUS = "'N'"
                    ...
                    If RECEIVED_FROM_PO = "YES" Then
                        ...
                        If Not rsPartMasClone.EOF And Not rsPartMasClone.BOF Then
                            ...
                            'disable to tally mac from p.o to r.r
                            ...
                            SQL_STATEMENT = "insert into PMIS_TdayTran " & _
                                          ...
                                          " " & RRITEMNO & "," & RRSTOCK_ORD & "," & _
                                          " " & RRSTOCK_SUP & ", " & RRTRANQTY & "," & _
                                          " " & RRTRANUCOST & "," & NumericVal(NewPmasMAC) & ", " & RRTRANINVAMT & ", '" & LOGDATE & "', " & N2Str2Null(LOGCODE) & ", " & RRSTATUS & ", " & RRIN_OUT & "," & N2Str2Null(rsPartMasClone!NON_HARI) & ")"
                            gconDMIS.Execute SQL_STATEMENT
                        End If
                        '=================================================================================================================
                    Else
    ...
    Select Case KeyCode
        ...
        Case vbKeyF4
            If FILD <> "" And FILD <> "No Entry" Then
                If Picture1.Visible = True Then
                    If chkstatus(txtRRNo.Text, "P", "RR") <> "P" And chkstatus(txtRRNo.Text, "P", "RR") <> "C" Then
                        grdDetails_DblClick
                        Picture1.Enabled = False
                        fraDetails.Enabled = False
                    End If
...
Private Sub Form_Load()
    ...
    'JJE RR number disable for editing
'    If COMPANY_CODE = "DJM" Then       ** FOR APPROVAL **
'        txtRRNo.MaxLength = 8
