...
Begin VB.Form frmPMISMAT_CutOffCheckPrevBal 
   ...
   FillColor       =   &H8000000D&
   ForeColor       =   &H00DEDFDE&
   Icon            =   "MAT_CutOffCheckPrevBal.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   4980
      MouseIcon       =   "MAT_CutOffCheckPrevBal.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "MAT_CutOffCheckPrevBal.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   1380
      Width           =   735
   ...
   Begin VB.CommandButton cmdCheck 
      ...
      Height          =   795
      Left            =   4260
      MouseIcon       =   "MAT_CutOffCheckPrevBal.frx":07C2
      MousePointer    =   99  'Custom
      Picture         =   "MAT_CutOffCheckPrevBal.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.PictureBox picCPB 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin wizButton.cmd cmd1 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "MAT_CutOffCheckPrevBal.frx":0BAF
         End
      End
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   9869
         _ExtentY        =   556
         Picture         =   "MAT_CutOffCheckPrevBal.frx":0BCB
         ForeColor       =   255
         Appearance      =   2
         BorderStyle     =   2
         BarPicture      =   "MAT_CutOffCheckPrevBal.frx":0BE7
         ShowText        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_CutOffCheckPrevBal"
...
Sub CheckBalance()
    ...
    rsCUTOFF.Open "Select mac,onhand,STOCKNO from CUTOFF  order by STOCKNO asc", gconINVENTORY, adOpenForwardOnly, adLockReadOnly
    If Not rsCUTOFF.EOF And Not rsCUTOFF.BOF Then
        ...
        Do While Not rsCUTOFF.EOF
            ...
            i = i + 1
            progCPB.Value = (i / rsCUTOFF.RecordCount) * 100
