...
Begin VB.Form frmPMISMAT_MRIFormation 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Materials Requistion Number Formation"
   ClientHeight    =   5400
   ClientLeft      =   1620
   ClientTop       =   5880
   ClientWidth     =   4410
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   675
      Left            =   3660
      MouseIcon       =   "MAT_ARIFormation.frx":0000
   ...
   Begin VB.CommandButton cmdOk 
      ...
      Height          =   675
      Left            =   3000
      MouseIcon       =   "MAT_ARIFormation.frx":0152
      MousePointer    =   99  'Custom
      Style           =   1  'Graphical
      TabIndex        =   39
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_MRIFormation"
...
Sub GetSeries()
    ...
    RSORD_HD.Open "select is_series from PMIS_vw_PRS where [TYPE] = 'M' AND sales_origin = '" & lbl2.Caption & "' and SI_TYPE ='" & lbl3.Caption & "' and  PAY_CLASS = '" & lbl4.Caption & "'  order by REPLICATE('0',4 - LEN(IS_SERIES)) + IS_SERIES desc ", gconDMIS
...
Private Sub cmdOk_Click()
    If lbl2.Caption = "" Or lbl3.Caption = "" Or lbl4.Caption = "" Then
        MsgBox "MRS number not completed!"
        Exit Sub
    End If
    ...
    Dim RSORD_HD                                       As ADODB.Recordset
    Set RSORD_HD = New ADODB.Recordset
    RSORD_HD.Open "select refpisno,TRANNO from PMIS_vw_PRS where [TYPE] = 'M' AND refpisno = '" & PISNUMBER & "'", gconDMIS
    If Not RSORD_HD.EOF And Not RSORD_HD.BOF Then
        MsgBox "MRS number already exist in Transaction number : " & Null2String(RSORD_HD!TRANNO)
        Exit Sub
    End If
