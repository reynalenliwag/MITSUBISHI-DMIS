...
Begin VB.Form frmPMISTrans_CustomerOrder_AC 
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "AC_CustomerOrder.frx":4B67
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -540
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   3030
         MouseIcon       =   "AC_CustomerOrder.frx":78A3
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":79F5
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   1560
         Width           =   855
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "AC_CustomerOrder.frx":7D5B
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":7EAD
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "AC_CustomerOrder.frx":81D8
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":832A
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "AC_CustomerOrder.frx":8668
         MousePointer    =   99  'Custom
         Picture         =   "AC_CustomerOrder.frx":87BA
         Style           =   1  'Graphical
         TabIndex        =   84
...
Function SetSTOCKDESC2(pid As Variant)
    ...
    Else
        If pid <> "" Then
            isnovat = CHKFZERO_ORVATEX(Null2String(txtRONO.Text))
            Set RSPARTMAS = New ADODB.Recordset
...
Sub CHGPRINTING()
    ...
    If NumericVal(txtDS1.Text) = 0 Then
        ...
        Else
            ...
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CHGACC.RPT", "{ord_hd.type} = 'A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
        End If
        Screen.MousePointer = 0
    Else
        If COMPANY_CODE = "HLI" Then
        ...
        Else
            ...
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CHGACCDisc.RPT", "{ord_hd.type} = 'A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
        End If
        Screen.MousePointer = 0
    End If
End Sub
...
Sub CSHPRINTING()
    ...
    If NumericVal(txtDS1.Text) = 0 Then
        ...
        Else
            'PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CSH.RPT", "{ord_hd.TYPE} = 'A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CSHACC.RPT", "{ord_hd.TYPE} = 'A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
    ...
    Else
        ...
        Else
            ...
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "CSHACCDisc.RPT", "{ord_hd.type} = 'A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
        End If
        Screen.MousePointer = 0
    End If
End Sub
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    'requested jhen
    ElseIf COMPANY_CODE = "MGS" And (txtTranType.Text = "CSH" Or txtTranType.Text = "CHG") Then
    ...
    If COMPANY_CODE = "DGI" Or COMPANY_CODE = "DSSC" Then
        If txtTranType.Text = "CSH" Or txtTranType.Text = "CHG" Then
            Set RSCUNTER = New ADODB.Recordset
            RSCUNTER.Open "select max(nextnumber) as nextnumber from PMIS_Counter where [TYPE] = 'A' AND modul in('CSH','CHG')", gconDMIS, adOpenForwardOnly, adLockReadOnly
            If Not RSCUNTER.EOF And Not RSCUNTER.BOF Then
                txtTranNo.Text = Format(Null2String(RSCUNTER!nextnumber), "000000")
            Else
                txtTranNo.Text = "000001"
            End If
            txtTranNo.Text = "A" + txtTranNo.Text
...
'                txtTranNo.Text = "AI" + txtTranNo.Text
            End If
            txtRONO.Enabled = False
            txtTerms.Enabled = False
            'JJE
...
'                txtTranNo.Text = "AI" + txtTranNo.Text
    ...
    If txtTranType.Text = "DR" Then
        ...
        Else
            txtTranNo.Text = "000001"
        End If
        'If FOR_CAS = True Then txtTranNo.Text = "A" + txtTranNo.Text
        txtRONO.Enabled = False
        txtTerms.Enabled = True
    End If
    If txtTranType.Text = "ADB" Then
...
Sub StoreMemVars()
    If Not RSORD_HD.EOF And Not RSORD_HD.BOF Then
        ...
        If txtTranType.Text = "RIV" Or txtTranType.Text = "ADB" Then
            ...
            If labinvNo <> "" Then
                ...
                labORNo = CheckORNum(labinvNo, "AI", txtTranType.Text)
            ...
            Else
                If Null2String(RSORD_HD!STATUS) = "C" Then
                    labPosted.Caption = "CANCELLED [" & Null2String(RSORD_HD!USERCODE) & "]"
                    cmdEdit.Enabled = False
                    cmdCancelCO.Enabled = False
                    cmdPost.Enabled = False
                    cmdPrint.Enabled = False
                ElseIf Null2String(RSORD_HD!STATUS) = "P" Then
                    labPosted.Caption = "POSTED [" & Null2String(RSORD_HD!USERCODE) & "]"
                    cmdEdit.Enabled = False
                    cmdCancelCO.Enabled = False
                    cmdPost.Enabled = False
                    cmdPrint.Enabled = True
        ...
        Else
            If txtTranType.Text = "CSH" Or txtTranType.Text = "CHG" Then
                ...
                labORNo = CheckORNum(Null2String(RSORD_HD!TRANNO), "AI", txtTranType.Text)
 ...
 '---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                ...
                ElseIf (Null2String(RSORD_HD!ZERORATED) <> "" Or Null2Bit(RSORD_HD!ZERORATED) <> 0) And (Null2String(RSORD_HD!VAT_EXEMPT) = "" Or Null2Bit(RSORD_HD!VAT_EXEMPT) = 0) Then
                    ...
                    CmdVatexmpt.Caption = "Vat Exempt"
                    LAB_ZERORATED.Caption = "Zero Rated Transaction"
                    chkzerorated.Enabled = True
                    CmdVatexmpt.Enabled = False
                ElseIf (Null2String(RSORD_HD!ZERORATED) = "" Or Null2Bit(RSORD_HD!ZERORATED) = 0) And (Null2String(RSORD_HD!VAT_EXEMPT) <> "" Or Null2Bit(RSORD_HD!VAT_EXEMPT) <> 0) Then
                    chkzerorated.Caption = "Set to Zero Rated"
                    CmdVatexmpt.Caption = "Not Vat Exempt"
                    LAB_ZERORATED.Caption = "Vat Exempt Transaction"
...
Private Sub cboRefPRSNo_GotFocus()
    ...
    If txtTranType.Text = "RIV" Or txtTranType.Text = "ADB" Then
       rsPRS.Open "Select tranno,refpisno from PMIS_vw_PRS WHERE [TYPE] = 'A' and SALES_ORIGIN ='S' and status = 'P' order by Tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    ElseIf txtTranType.Text = "CSH" Or txtTranType.Text = "CHG" Or txtTranType.Text = "DR" Then
        rsPRS.Open "Select tranno,refpisno from PMIS_vw_PRS WHERE [TYPE] = 'A' and (SALES_ORIGIN ='W' or SALES_ORIGIN ='O' OR SALES_ORIGIN ='M' or SALES_ORIGIN ='J') and status = 'P' order by Tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    End If
...
Private Sub chkzerorated_Click()
    If chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "P" Or chkstatus(txtTranNo.Text, "P", txtTranType.Text) = "B" Then
        MessagePop InfoVoid, "Action void", "Transaction already posted!"
        Exit Sub
    ElseIf chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "C" Then
    ...
    If chkzerorated.Caption = "Set to Zero Rated" Then
        ...
        If ISZERONOTVAT("A", txtTranType.Text, txtTranNo.Text, "ZERO", "1") = True Then MsgBox "Transaction Already Set To Zero Rated Transaction": Exit Sub
        If ISZERONOTVAT("A", txtTranType.Text, txtTranNo.Text, "VAT", "1") = True Then MsgBox "Transaction Already Set To Vat Exempted Transaction": Exit Sub
        If MsgBox("Are you sure you want to set this to Zero Rated Transaction?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
            gconDMIS.BeginTrans
            If SETTOZERORATED("A", txtTranType.Text, txtTranNo.Text, labID.Caption, LOCALACESS) = False Then
    ...
    Else
        ...
        If ISZERONOTVAT("A", txtTranType.Text, txtTranNo.Text, "ZERO", "0") = True Then MsgBox "Transaction Already Set To Zero Rated Transaction": Exit Sub
        If ISZERONOTVAT("A", txtTranType.Text, txtTranNo.Text, "VAT", "0") = False Then MsgBox "Transaction Already Set To Vat Exempted Transaction": Exit Sub
        If MsgBox("Are you sure you want to set this to Not-Zero Rated Transaction?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
            gconDMIS.BeginTrans
            If SETTONOT_ZERORATED("A", txtTranType.Text, txtTranNo.Text, labID.Caption, LOCALACESS) = False Then
                gconDMIS.RollbackTrans
            Else
                gconDMIS.CommitTrans
...
Private Sub cmdCancelCO_Click()
    ...
    If chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "P" Or chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "B" Then
         MessagePop InfoVoid, "Action void", "Transaction already posted!"
         Exit Sub
    ElseIf chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "C" Then
         MessagePop InfoVoid, "Action void", "Transaction already cancelled!"
    ...
    If Not RSTDAYTRANDUP.EOF And Not RSTDAYTRANDUP.BOF Then
        ...
        Do While Not RSTDAYTRANDUP.EOF
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                ...
                NEW_LogAudit "C", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
            End If
...
'updated:   IEBV
'description: this will check the actual onhand as of

'-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If txtTranType.Text = "CHG" Or txtTranType.Text = "CSH" Or txtTranType.Text = "DR" Or txtTranType.Text = "RIV" Then
        'CHECK ON HAND AS OF DATE
        Dim rsTran                                     As ADODB.Recordset
        Set rsTran = gconDMIS.Execute("SELECT STOCK_ORD, TRANQTY FROM PMIS_TDAYTRAN WHERE TRANTYPE=" & N2Str2Null(txtTranType) & " AND TYPE='A' AND TRANNO=" & N2Str2Null(txtTranNo))
        While Not rsTran.EOF
            onhandasof = COMPUTE_ONHANDASOFDATE(txtTranDate, Null2String(rsTran!STOCK_ORD), "A")
    ...
    If txtTranType <> "ADB" Then
        ...
        Set rsTran = gconDMIS.Execute("SELECT STOCK_ORD, TRANQTY,ID FROM PMIS_TDAYTRAN WHERE TRANTYPE=" & N2Str2Null(txtTranType) & " AND TYPE='A' AND TRANNO=" & N2Str2Null(txtTranNo))
        While Not rsTran.EOF
            onhandasof = COMPUTE_ONHANDASOFDATE2(txtTranDate, Null2String(rsTran!STOCK_ORD), "A", Null2String(rsTran!ID))
            If onhandasof <= 0 Then
                MsgBox "Cannot post this transaction this will result negative issuance in the ledger. " & vbCrLf & "Cause: ( The issuance has been made first. ) " & vbCrLf & "Please make another issuance for this transaction." & vbCrLf & "Accessory number ( " & Null2String(rsTran!STOCK_ORD) & " )", vbInformation
                Exit Sub
            End If
            If onhandasof - N2Str2IntZero(rsTran!TRANQTY) < 0 Then
                MsgBox "Negative Issuances for the Part Number " & vbCrLf & Null2String(rsTran!STOCK_ORD) & " As of  " & txtTranDate & vbCrLf & "Posting of This Transaction is Not Allowed." & vbCrLf & "", vbInformation
...
On Error GoTo errordaa
        ...
        Do While Not RSTDAYTRANDUP.EOF
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                ...
                SQL_STATEMENT = "update PMIS_TdayTran set" & _
                              ...
                              " where id = " & RSTDAYTRANDUP!ID
                gconDMIS.Execute SQL_STATEMENT
                NEW_LogAudit "PP", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
            End If
            RSTDAYTRANDUP.MoveNext
        Loop
    End If
    SQL_STATEMENT = "update PMIS_Ord_Hd set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "P", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
    rsRefresh
    RSORD_HD.Find "id =" & labID.Caption
    StoreMemVars
...
Private Sub cmdPrint_Click()
    ...
    NEW_LogAudit "V", LOCALACESS, "", labID, "Accessories", "TRAN NO: " & txtTranNo, txtTranType.Text, ""
...
Sub DR_PARTS_PRINTING()
    If COMPANY_CODE = "MGS" Then
        ...
        rptCustomerOrder.Formulas(2) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
        If NumericVal(txtDS1.Text) = 0 Then
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "DR-ACC.RPT", "{ord_hd.TRANTYPE} = 'DR' and {ord_hd.TYPE} ='A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
        Else
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "DR-ACC.RPT", "{ord_hd.TRANTYPE} = 'DR' and {ord_hd.TYPE} = 'A' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
        End If
    End If
...
Private Sub cmdTranDelete_Click()
    ...
    If MsgQuestionBox("Delete this Accessories, Are you Sure?", "Delete Accessories Entry") = True Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "XX", LOCALACESS, SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, txtTranType.Text, labDetID
        ShowDeletedMsg
    End If
    ...
    Set RSTDAYTRANDUP = New ADODB.Recordset
    RSTDAYTRANDUP.Open "select id,itemno from PMIS_TdayTran where [TYPE] = 'A' AND trantype = " & N2Str2Null(txtTranType.Text) & " and tranno = " & N2Str2Null(RSORD_HD!TRANNO) & " order by itemno asc", gconDMIS
    If Not RSTDAYTRANDUP.EOF And Not RSTDAYTRANDUP.BOF Then
        RSTDAYTRANDUP.MoveFirst
        CNT = 0
        Do While Not RSTDAYTRANDUP.EOF
    ...
    SQL_STATEMENT = "update PMIS_Ord_Hd set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    Call NEW_LogAudit("E", LOCALACESS, SQL_STATEMENT, labID, "", "TRAN NO: " & txtTranNo & " REMOVE ACC", txtTranType.Text, "")
...
Private Sub cmdTranSave_Click()
    ...
    If txtTranType.Text <> "ADB" Then
        Set RSPARTMAS = New ADODB.Recordset
        RSPARTMAS.Open "SELECT isnull(srp,0) as srp,STOCKNO,ONHAND,SSTOCK,RESSERVICE,TISSQTY,MAC,LASTM_MAC,ISSUANCES,dnp FROM PMIS_ACCESSORIES WHERE STOCKNO = '" & cboTranPartNo.Text & "' AND ACTIVE = 'Y'", gconDMIS
        If Not RSPARTMAS.EOF And Not RSPARTMAS.BOF Then
            CURONHAND = N2Str2IntZero(RSPARTMAS!ONHAND)
            CURSAFESTOCK = N2Str2IntZero(RSPARTMAS!SSTOCK)
            CURTISSQTY = N2Str2IntZero(RSPARTMAS!TISSQTY)
           ...
           ' End If
            ...
            Else
                If (txtTranUPrice.Text) < N2Str2IntZero(RSPARTMAS!dnp) Then
                    MsgBox "Warning: This Accessories Price Cannot be less than the DNP " & vbCrLf _
                           & "Check in Accessories Master File or Process Update Master File to Proceed.", vbCritical
                    Screen.MousePointer = 0
                    Exit Sub
                End If
            End If
            ...
            If CURONHAND < CURSAFESTOCK Then
                ...
                Call NEW_LogAudit("MP", LOCALACESS, CRITICAL_QUESTION, labID, "", "TRAN NO: " & txtTranNo & " ACC NO: " & cboTranPartNo, txtTranType.Text, "")
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "AA", LOCALACESS, SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, txtTranType.Text, labDetID
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "EE", LOCALACESS, SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, txtTranType.Text, labDetID
    ...
    SQL_STATEMENT = "update PMIS_Ord_Hd set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    Call NEW_LogAudit("E", LOCALACESS, SQL_STATEMENT, labID, "", "TRAN NO: " & txtTranNo & " ADD/EDIT PARTS", txtTranType.Text, "")
...
Private Sub cmdSave_Click()
    ...
    Else
        'axp 02282008
        'JJE Prefixes
        If COMPANY_CODE = "DSSC" And (txtTranType.Text = "CSH" Or txtTranType.Text = "CHG") Then
            If Len(Trim(RTrim(txtTranNo))) <> 7 Then
                MsgBox "Invalid Transaction Number. Should Be Seven Digit In Length!", vbCritical, "Transaction Number!"
                On Error Resume Next
                txtTranNo.SetFocus
...
'        ElseIf COMPANY_CODE <> "DJM" Then ** FOR APPROVAL **
    ...
    If Trim(txtTranType.Text) = "RIV" Then
        If Trim(txtRONO.Text) = "" Then
            ...
            Exit Sub
        ElseIf checkifro_void(txtRONO.Text) = True Then
            MsgBox "Reapir Order " & txtRONO.Text & " already voided ", vbInformation + vbOKOnly
            txtRONO.Text = ""
            txtRONO.SetFocus
            Exit Sub
...
'description:    Validation fo customer that has a credit limit fo those issuance that are CHARGE
'---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If AddorEdit = "ADD" Then
            ...
            Else
                If COMPANY_CODE = "DGI" Then
                    ...
                    Else
                        RSFINDDUP.Open "select trantype,tranno from PMIS_vw_ISS_HISTORY where [TYPE] = 'A' AND trantype in('CSH','CHG') and tranno = '" & txtTranNo.Text & "' order by trantype,tranno", gconDMIS, adOpenForwardOnly, adLockReadOnly
                    End If
                Else
                    RSFINDDUP.Open "select trantype,tranno from PMIS_vw_ISS_HISTORY where [TYPE] = 'A' AND trantype = '" & txtTranType.Text & "' and tranno = '" & txtTranNo.Text & "' order by trantype,tranno", gconDMIS, adOpenForwardOnly, adLockReadOnly
                End If
            ...
            If Not RSFINDDUP.EOF And Not RSFINDDUP.BOF Then
                If MsgBox("Transaction No. already exist!, Do you want to generate new transaction number?", vbQuestion + vbYesNo) = vbYes Then
                    txtTranNo.Text = getnextISSPORR("A", txtTranType.Text)
                    txtRONO.Enabled = True
                    txtTerms.Enabled = False
                Else
                    On Error Resume Next
...
'    VTXTTRANNO = N2Str2Null(txtTranNo.Text)
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "A", LOCALACESS, SQL_STATEMENT, FindTransactionID(txtTranNo, "tranno", "PMIS_Ord_Hd", "DETAILS", N2Str2Null("A"), "TYPE"), "Accessories", "TRAN NO: " & txtTranNo & " - " & VTXTREFPRSNO, txtTranType.Text, ""
        ShowSuccessFullyAdded
    Else
        SQL_STATEMENT = "update PMIS_Ord_Hd set" & _
                      ...
                      " where id = " & labID.Caption
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "E", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "EE", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
    ...
    If AddorEdit = "ADD" Then
        If Left(txtTranNo.Text, 1) = "A" Then
            If COMPANY_CODE = "DGI" Or COMPANY_CODE = "DSSC" Then
                ...
                Else
                    gconDMIS.Execute "update PMIS_Counter set nextnumber = '" & NEXTCUNTER & "', lastupdate = '" & LOGDATE & "', usercode = '" & "USER" & "' where [TYPE] = 'A' AND modul in ('CSH','CHG')"
                End If
            Else
                gconDMIS.Execute "update PMIS_Counter set nextnumber = '" & NEXTCUNTER & "', lastupdate = '" & LOGDATE & "', usercode = '" & "USER" & "' where [TYPE] = 'A' AND modul = " & VTXTTRANTYPE
            End If
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    If AddorEdit = "ADD" Then
        ...
        Set RSTDAYTRANDUP = New ADODB.Recordset
        RSTDAYTRANDUP.Open "select trantype,tranno from PMIS_TdayTran where [TYPE] = 'A' AND trantype = '" & txtTranType.Text & "' and tranno = " & N2Str2Null(RSORD_HD!TRANNO), gconDMIS
            ...
            If Not RSPRS_HD.EOF And Not RSPRS_HD.BOF Then
                ...
                If Not rstdaytranDUp2.EOF And Not rstdaytranDUp2.BOF Then
                    ...
                    Do While Not rstdaytranDUp2.EOF
                        ...
                        Set rsPartMasClone = gconDMIS.Execute("Select STOCKNO,ONHAND,NON_HARI,mac,DNP,sstock from PMIS_StockMas where TYPE = 'A' and STOCKNO = " & N2Str2Null(rstdaytranDUp2!STOCK_ORD))
                        If Not rsPartMasClone.EOF And Not rsPartMasClone.BOF Then
                            If N2Str2Zero(rsPartMasClone!ONHAND) > 0 Then
                                ...
                                SQL_STATEMENT = "insert into PMIS_TdayTran " & _
                                              ...
                                              " values ('A'," & VMACSTOCKNO & "," & RRTRANDATE & ", '" & txtTranType.Text & "', " & RRTRANNO & "," & _
                                ...
                                gconDMIS.Execute SQL_STATEMENT
                                NEW_LogAudit "A", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
                            Else
...
rs_ord_hd.Open "select ID,trantype,tranno from PMIS_ord_hd where [TYPE] = 'A' AND trantype = '" & txtTranType.Text & "' and tranno = " & N2Str2Null(RSORD_HD!TRANNO), gconDMIS
If Not (rs_ord_hd.EOF And rs_ord_hd.BOF) Then
    Set rs_tdaytran = New ADODB.Recordset
    rs_tdaytran.Open "select id,itemno,STOCK_ORD,STOCK_SUP,tranqty,traninvamt,tranucost,tranuprice from PMIS_TdayTran where trantype = '" & txtTranType.Text & "' and tranno = " & N2Str2Null(rs_ord_hd!TRANNO) & " and [TYPE] = 'A' order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not (rs_tdaytran.EOF And rs_tdaytran.BOF) Then
        ...
        Do While Not rs_tdaytran.EOF
            ...
            Set rs_stockmas = gconDMIS.Execute("Select STOCKNO,ONHAND,NON_HARI,MAC,DNP,srp from PMIS_StockMas where TYPE = 'A' and STOCKNO = " & N2Str2Null(rs_tdaytran!STOCK_ORD))
...
Private Sub CmdVatexmpt_Click()
    ...
    If CmdVatexmpt.Caption = "Vat Exempt" Then
        ...
        If MsgBox("Are you sure you want to set this to Vat Exempt Transaction?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
            gconDMIS.BeginTrans
            If SETTOVATEXEMPT("A", txtTranType.Text, txtTranNo.Text, labID.Caption, LOCALACESS) = False Then
                gconDMIS.RollbackTrans
            Else
                gconDMIS.CommitTrans
    ...
    Else
        ...
        If ISZERONOTVAT("A", txtTranType.Text, txtTranNo.Text, "VAT", "0") = True Then MsgBox "Transaction Already Set To Not Vat Exempted Transaction": Exit Sub
        If ISZERONOTVAT("A", txtTranType.Text, txtTranNo.Text, "ZERO", "0") = False Then MsgBox "Transaction Already Set To Non-Zero Rated Transaction": Exit Sub
        If MsgBox("Are you sure you want to set this to Not Vat Exempted Transaction?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
            gconDMIS.BeginTrans
            If SETTONOT_VATEXEMPT("A", txtTranType.Text, txtTranNo.Text, labID.Caption, LOCALACESS) = False Then
                gconDMIS.RollbackTrans
            Else
                gconDMIS.CommitTrans
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        ...
        Case vbKeyF3
            If Picture1.Visible = True Then
                If chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "C" Then
                    MsgSpeechBox "Transactions are Already Cancelled and cannot be Change..."
                ElseIf chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "B" Then
                    MsgSpeechBox "Transactions are Already Billed-Out and cannot be Change..."
                ElseIf chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "P" Then
        ...
        Case vbKeyF4
            If FILD <> "" And FILD <> "No Entry" Then
                If Picture1.Visible = True Then
                    If chkstatus(txtTranNo.Text, "A", txtTranType.Text) <> "P" And chkstatus(txtTranNo.Text, "A", txtTranType.Text) <> "C" And chkstatus(txtTranNo.Text, "A", txtTranType.Text) <> "B" Then
                        grdDetails_DblClick
                        Picture1.Enabled = False
                        fraDetails.Enabled = False
                    End If
        ...
        Case vbKeyF12
            If Picture1.Visible = True And (labSJ = "" And labORNo = "") Then
                If chkstatus(txtTranNo.Text, "A", txtTranType.Text) = "P" Then
                    ...
                    If txtTranType.Text = "RIV" Then MsgBox "Unposting of this transaction will remove issuance of Accessories in CarService", vbCritical, "Critical"
...
On Error GoTo errordaa
        ...
        Do While Not RSTDAYTRANDUP.EOF
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                ...
                SQL_STATEMENT = "update PMIS_TdayTran set" & _
                              ...
                              " where id = " & RSTDAYTRANDUP!ID
                gconDMIS.Execute SQL_STATEMENT
                NEW_LogAudit "U", LOCALACESS, SQL_STATEMENT, labID, "Accessories", txtTranNo, txtTranType.Text, ""
    ...
    SQL_STATEMENT = "update PMIS_Ord_Hd set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "U", LOCALACESS, SQL_STATEMENT, labID, "Accessories", "TRAN NO: " & txtTranNo, txtTranType.Text, ""
...
Private Sub Form_Load()
    ...
    If txtTranType.Text = "RIV" Then
        ...
        fraDetails.Height = 6660
        lstOrd_Hd.Height = 4960
    ...
    ElseIf txtTranType.Text = "CSH" Then
        ...
        fraDetails.Height = 5880
        lstOrd_Hd.Height = 4200
...
'        End If
    ...
    'Updated by JJE 06/29/2012 03:43PM
    'If Company Code is DJM tranno or invno can be edited
    If COMPANY_CODE = "DJM" Then
        If txtTranType.Text = "CSH" Or txtTranType.Text = "CHG" Then
            txtTranNo.MaxLength = 6
            txtTranNo.Locked = False
        End If
    End If

    If txtTranType.Text = "DR" Then cmdPISNum.Enabled = True
