...
Begin VB.Form frmPMISTrans_PrisForms 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "PRISForm.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   89
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "PRISForm.frx":0EBC
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":100E
         Style           =   1  'Graphical
         TabIndex        =   90
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "PRISForm.frx":4624
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":4776
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   1575
         Width           =   855
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2850
         MouseIcon       =   "PRISForm.frx":4ADC
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":4C2E
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   2610
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "PRISForm.frx":4F59
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":50AB
         Style           =   1  'Graphical
         TabIndex        =   84
         Top             =   2610
         Width           =   705
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1470
         MouseIcon       =   "PRISForm.frx":53E9
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":553B
         Style           =   1  'Graphical
         TabIndex        =   85
         Top             =   2610
         Width           =   705
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7800
         MouseIcon       =   "PRISForm.frx":588B
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":59DD
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7020
         MouseIcon       =   "PRISForm.frx":5D43
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":5E95
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6240
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "PRISForm.frx":61FB
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":634D
         Style           =   1  'Graphical
         TabIndex        =   101
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5460
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "PRISForm.frx":6687
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":67D9
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4680
         MouseIcon       =   "PRISForm.frx":6AFE
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":6C50
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3900
         MouseIcon       =   "PRISForm.frx":6FAC
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":70FE
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3120
         MouseIcon       =   "PRISForm.frx":7411
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":7563
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "PRISForm.frx":78B3
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":7A05
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1560
         MouseIcon       =   "PRISForm.frx":7D63
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":7EB5
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "PRISForm.frx":81AF
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":8301
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "PRISForm.frx":8659
         MousePointer    =   99  'Custom
         Picture         =   "PRISForm.frx":87AB
         Style           =   1  'Graphical
         TabIndex        =   100
...
Sub FillDetails()
    ...
    If Not RSTDAYTRAN.EOF And Not RSTDAYTRAN.BOF Then
        ...
        If NumericVal(txtDS1.Text) <> 0 Then
            ...
            End If
            'updated by: IEBV
            'description:   to update discount
...
Sub SetCustInfo(rep As String)
    ...
    If Not RSREPOR.EOF And Not RSREPOR.BOF Then
        ...
        ElseIf Null2String(RSREPOR!STATUS) = "V" Then
            MsgBox "Warning Repair Order Already Voided.", vbInformation + vbOKOnly
                On Error Resume Next
                txtRONO.Text = ""
                txtRONO.SetFocus
                Exit Sub
...
Sub FillGrid()
    ...
    Set RSORD_HD = New ADODB.Recordset
    Set RSORD_HD = gconDMIS.Execute("select top 20 Tranno,tranno x from PMIS_vw_PRS where trantype = '" & txtTranType.Text & "' order by Tranno asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSORD_HD = gconDMIS.Execute("select top 20 tranno, tranno from PMIS_vw_PRS where trantype = '" & txtTranType.Text & "' and tranno like '" & XXX & "%'")
    If Not (RSORD_HD.EOF And RSORD_HD.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HD
        lstOrd_Hd.Refresh
...
Sub FillGrid2()
    ...
    lstOrd_Hd.Sorted = False: lstOrd_Hd.ListItems.Clear
    Set RSORD_HD = New ADODB.Recordset
    Set RSORD_HD = gconDMIS.Execute("select top 20 rono,tranno from PMIS_vw_PRS where trantype = '" & txtTranType.Text & "' and rono is not null order by tranno asc")
    If Not (RSORD_HD.EOF And RSORD_HD.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HD
        lstOrd_Hd.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set RSORD_HD = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set RSORD_HD = gconDMIS.Execute("select top 20 Rono, tranno from PMIS_vw_PRS where trantype = '" & txtTranType.Text & "' and rono like '" & XXX & "%' order by tranno asc")
    If Not (RSORD_HD.EOF And RSORD_HD.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HD
        lstOrd_Hd.Refresh
...
Private Sub cmdCancelCO_Click()
    ...
    If chkstatus(txtTranNo.Text, "P", "PRS") = "P" Then
        MessagePop InfoVoid, "Action Void", "Transaction already Posted!"
        Exit Sub
    ElseIf chkstatus(txtTranNo.Text, "P", "PRS") = "C" Then
...
On Error GoTo errordaa
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                If Null2String(RSORD_HD!STATUS) = "P" Then
                    If Null2String(RSORD_HD!SALES_ORIGIN) = "W" Then
                        ...
                        Call NEW_LogAudit("E", "PART MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(RSTDAYTRANDUP!STOCK_ORD), "STOCKNO", "PMIS_STOCKMAS"), "", "TRAN NO: " & txtTranNo & " CANCEL", "PRS", "")
                    Else
                ...
                gconDMIS.Execute SQL_STATEMENT
                'NEW_LogAudit "C", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", txtTranNo, txtTranType.Text, ""
            End If
    ...
    NEW_LogAudit "C", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", "TRAN NO: " & txtTranNo, txtTranType.Text, ""
...
Private Sub cmdPISNum_Click()
    With frmPMISPRIFormation
        ...
        .lbl11 = Mid(txtReferencePIS, 13, 1)
...
Function PUSSY() As Boolean
On Error GoTo testicles
    Dim PCURTISSQTY                                As Integer
    Dim RSTDAYTRANDUP, RSPARTMASDUP                As ADODB.Recordset
        ...
        Do While Not RSTDAYTRANDUP.EOF
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                If Null2String(RSORD_HD!SALES_ORIGIN) = "W" Then
                    ...
                    Call NEW_LogAudit("E", "PART MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(RSTDAYTRANDUP!STOCK_ORD), "STOCKNO", "PMIS_STOCKMAS"), "", "TRAN NO: " & txtTranNo, "PRS", "")
                Else
                    PCURTISSQTY = N2Str2IntZero(RSPARTMASDUP!S_ONREQUEST) + N2Str2Zero(RSTDAYTRANDUP!TRANQTY)
                    SQL_STATEMENT = "update PMIS_Partmas set" & _
                                  " S_ONREQUEST = " & PCURTISSQTY & "," & _
                ...
                SQL_STATEMENT = "update PMIS_vw_PRS_Tran set" & _
                              ...
                              " where id = " & RSTDAYTRANDUP!ID
                gconDMIS.Execute SQL_STATEMENT
                'NEW_LogAudit "P", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", "TRAN NO: " & txtTranNo, txtTranType.Text, ""
            End If
            RSTDAYTRANDUP.MoveNext
        Loop
    End If
...
Private Sub cmdPrint_Click()
    ...
    If MsgQuestionBox("Parts Requisition Slip will be Printed. Are you sure?", "Confirm Printing...") = True Then
        ...
        ElseIf Mid((RSORD_HD!REFPISNO), 3, 1) = "O" Or Mid((RSORD_HD!REFPISNO), 3, 1) = "M" Or Mid((RSORD_HD!REFPISNO), 3, 1) = "J" Then
            rptCustomerOrder.WindowTitle = "Parts Requisition Slip"
            rptCustomerOrder.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
            rptCustomerOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
            PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "RequisitionSlip_Parts_Others.rpt", "({PMIS_vw_PRS.TYPE} = 'P' and {PMIS_vw_PRS.TRANTYPE} = 'PRS' and {PMIS_vw_PRS_Tran.TYPE} = 'P' and {PMIS_vw_PRS_Tran.TRANTYPE} = 'PRS' and {PMIS_vw_PRS_Tran.TRANNO} = " & N2Str2Null(txtTranNo.Text) & ")", DMIS_REPORT_Connection, 1
        Else
            rptCustomerOrder.WindowTitle = "Parts Requisition Slip"
            rptCustomerOrder.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
            rptCustomerOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
...
Private Sub cmdTranDelete_Click()
    ...
    If MsgQuestionBox("Delete This Parts, Are you Sure?", "Delete Parts Entry") = True Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "XX", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", "PART NO: " & cboTranPartNo, txtTranType.Text, labDetID
        ShowDeletedMsg
    End If
    Dim CNT                                            As Integer
    Dim RSTDAYTRANDUP                                  As ADODB.Recordset
    Set RSTDAYTRANDUP = New ADODB.Recordset
    RSTDAYTRANDUP.Open "select id,itemno from PMIS_vw_PRS_Tran where trantype = " & N2Str2Null(txtTranType.Text) & " and tranno = " & N2Str2Null(RSORD_HD!TRANNO) & " order by itemno asc", gconDMIS
    If Not RSTDAYTRANDUP.EOF And Not RSTDAYTRANDUP.BOF Then
        RSTDAYTRANDUP.MoveFirst
        CNT = 0
        Do While Not RSTDAYTRANDUP.EOF
...
Private Sub cmdTranSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        If Len(StockISSUE) > 0 Then
            If MsgBox("Same part number had been requested for this repair order." & vbCrLf & "Repair Order#  :" & txtRONO & vbCrLf & "Transaction#    :" & StockISSUE & vbCrLf & "Do you want to continue?", vbYesNo + vbInformation, "Parts Requisition") = vbNo Then
                ...
                Exit Sub
            End If
            'NEW_LogAudit "AA", "PARTS REQUISTION SLIP", "", labID, "Parts", "PART NO. " & cboTranPartNo, txtTranType.Text, ""
        End If
    End If
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "AA", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", "PART NO. " & cboTranPartNo, txtTranType.Text, ""
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "EE", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", "PART NO: " & cboTranPartNo, txtTranType.Text, labDetID
    ...
    SQL_STATEMENT = "update PMIS_vw_PRS set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "E", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", txtTranNo, txtTranType.Text, ""
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            If checkdupRS("PRS", "P", Trim(txtReferencePIS.Text)) = True Then
                MsgBox "Reference PRS Number Already Exist"
                Exit Sub
            End If
        Else
            If Trim(Null2String(RSORD_HD!REFPISNO)) <> Trim(txtReferencePIS.Text) Then
                If checkdupRS("PRS", "P", Trim(txtReferencePIS.Text)) = True Then
                    MsgBox "Reference PRS Number Already Exist"
                    Exit Sub
                End If
    ...
    Else
        If AddorEdit = "ADD" Then
            If checkdup("P", txtTranType.Text, txtTranNo.Text) = True Then
                If MsgBox("Transaction No. already exist, Do you want to generate new PRS number?", vbQuestion + vbYesNo) = vbYes Then
                    If txtTranType.Text = "PRS" Then
                        txtTranNo.Text = getnextISSPORR("P", "PRS")
                        txtRONO.Enabled = True
                        txtTerms.Enabled = False
                    End If
                Else
...
On Error GoTo errordaa
    ...
    XTRACK_CODE = N2Str2Null(Mid(txtReferencePIS, 13, 1))
    If AddorEdit = "ADD" Then
    ...
    Else
        ...
        gconDMIS.Execute "update PMIS_vw_PRS set" & _
                        ...
                        " ttlinvamt = " & ORD_TOTUPRICE & "," & _
                        " netinvamt = " & ORD_TOTINVAMT & _
                        " where tranno = " & VTXTTRANNO & " and [type] = 'P' and trantype = " & VTXTTRANTYPE
    End If
    If AddorEdit = "ADD" Then
        Picture1.Enabled = False
        fraDetails.Enabled = False
...
If COMPANY_CODE = "DGI" Then If Mid(txtReferencePIS.Text, 5, 1) = "I" Then Exit Sub
    ...
    Select Case KeyCode
        ...
        Case vbKeyF4
            If FILD <> "" And FILD <> "No Entry" Then
                If Picture1.Visible = True Then
                    If chkstatus(txtTranNo.Text, "P", "PRS") <> "P" And chkstatus(txtTranNo.Text, "P", "PRS") <> "C" And chkstatus(txtTranNo.Text, "P", "PRS") <> "B" Then
                        grdDetails_DblClick
                        Picture1.Enabled = False
                        fraDetails.Enabled = False
                    End If
...
On Error GoTo testicles
            ...
            If Not RSPARTMASDUP.EOF And Not RSPARTMASDUP.BOF Then
                If Null2String(RSORD_HD!SALES_ORIGIN) = "W" Then
                    ...
                    SQL_STATEMENT = "update PMIS_Partmas set" & _
                                  ...
                                  " where STOCKNO = " & N2Str2Null(RSTDAYTRANDUP!STOCK_ORD)
                    gconDMIS.Execute SQL_STATEMENT
                    Call NEW_LogAudit("E", "PART MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(RSTDAYTRANDUP!STOCK_ORD), "STOCKNO", "PMIS_STOCKMAS"), "", "TRAN NO: " & txtTranNo & " UNPOST", "PRS", "")
                Else
                    PCURTISSQTY = N2Str2IntZero(RSPARTMASDUP!S_ONREQUEST) - N2Str2Zero(RSTDAYTRANDUP!TRANQTY)
                    SQL_STATEMENT = "update PMIS_Partmas set" & _
                                  " S_ONREQUEST = " & PCURTISSQTY & "," & _
                ...
                SQL_STATEMENT = "update PMIS_vw_PRS_Tran set" & _
                              ...
                              " where id = " & RSTDAYTRANDUP!ID
                gconDMIS.Execute SQL_STATEMENT
                'NEW_LogAudit "U", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", txtTranNo, txtTranType.Text, ""
            End If
            RSTDAYTRANDUP.MoveNext
        Loop
    End If
    SQL_STATEMENT = "update PMIS_vw_PRS set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "U", "PARTS REQUISTION SLIP", SQL_STATEMENT, labID, "Parts", "TRAN NO: " & txtTranNo, txtTranType.Text, ""
...
Private Sub Form_Load()
    txtTranType.Text = WAREHOUSETYPE
    Screen.MousePointer = 11
