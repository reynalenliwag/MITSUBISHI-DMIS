...
Begin VB.Form frmPMISMAT_Purchase_Hist 
   ...
   DrawWidth       =   10
   ForeColor       =   &H00DEDFDE&
   Icon            =   "MAT_Purchase_Hist.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstPO_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "MAT_Purchase_Hist.frx":030A
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "MAT_Purchase_Hist.frx":046C
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":05BE
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "MAT_Purchase_Hist.frx":0924
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":0A76
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":0DDC
         Style           =   1  'Graphical
         TabIndex        =   76
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1116
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdPost 
         ...
         MaskColor       =   &H0000FFFF&
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":145B
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Left            =   4740
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1780
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Left            =   3960
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1ADC
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "MAT_Purchase_Hist.frx":1DEF
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":1F41
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "MAT_Purchase_Hist.frx":2291
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":23E3
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "MAT_Purchase_Hist.frx":2741
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":2893
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "MAT_Purchase_Hist.frx":2B8D
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":2CDF
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_Purchase_Hist.frx":3037
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":3189
         Style           =   1  'Graphical
         TabIndex        =   75
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Left            =   720
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":34E8
         Style           =   1  'Graphical
         TabIndex        =   80
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   -60
         MousePointer    =   99  'Custom
         Picture         =   "MAT_Purchase_Hist.frx":3826
         Style           =   1  'Graphical
         TabIndex        =   81
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtRemarks 
         ...
         TabIndex        =   12
         Text            =   "MAT_Purchase_Hist.frx":3B76
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         Picture         =   "MAT_Purchase_Hist.frx":3B90
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   End
End
Attribute VB_Name = "frmPMISMAT_Purchase_Hist"
...
Function SetPartDesc2(pid As Variant)
    If pid <> "" Then
        Set rsCSMS_MATMAS = New ADODB.Recordset
        rsCSMS_MATMAS.Open "Select id,STOCKDESC from CSMS_MATMAS where id = " & pid, gconDMIS, adOpenForwardOnly, adLockReadOnly
        If Not rsCSMS_MATMAS.EOF And Not rsCSMS_MATMAS.BOF Then
...
Sub rsRefresh()
    ...
    Set RSPO_HD = gconDMIS.Execute("select * from PMIS_PO_Hist WHERE [TYPE] = 'M' order by pono asc")
    'RSPO_HD.Open "select * from PMIS_PO_Hist WHERE [TYPE] = 'M' order by pono asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub FillDetails()
    ...
    Set rsPMIS_DAYTRAN = New ADODB.Recordset
    rsPMIS_DAYTRAN.Open "select id,tranno,trantype,itemno,STOCK_ORD,STOCK_SUP,tranqty,traninvamt,tranucost,VIN from PMIS_Daytran where [TYPE] = 'M' AND tranno = " & N2Str2Null(RSPO_HD!PONO) & " and trantype = 'PO' order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsPMIS_DAYTRAN.EOF And Not rsPMIS_DAYTRAN.BOF Then
...
Sub FillGrid()
    ...
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select  pono from PMIS_PO_Hist WHERE [TYPE] = 'M' order by pono asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSPO_HD = gconDMIS.Execute("select pono from PMIS_PO_Hist where [TYPE] = 'M' AND pono like'" & XXX & "%'")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, RSPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
Sub FillGrid2()
    ...
    lstPO_HD.Enabled = False
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select supname, pono from PMIS_PO_Hist WHERE [TYPE] = 'M' order by pono asc")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, RSPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set RSPO_HD = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set RSPO_HD = gconDMIS.Execute("select supname, pono from PMIS_PO_Hist where [TYPE] = 'M' AND supname like '" & XXX & "%' order by pono asc")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
...
Private Sub cmdCancelPO_Click()
    ...
    If LOGLEVEL <> "ADM" Then
        ...
        Exit Sub
    End If
    Dim rsPMIS_DAYTRANDup, rsCSMS_MATMASDup            As ADODB.Recordset
    ...
    If MsgQuestionBox("Are you sure you want to Cancel this Transactions?", "Cancel Transactions") = True Then
        ...
        rsPMIS_DAYTRANDup.Open "select Tranqty,STOCK_ORD,trantype,tranno,STATUS from PMIS_Daytran where [TYPE] = 'M' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO), gconDMIS
        If Not rsPMIS_DAYTRANDup.EOF And Not rsPMIS_DAYTRANDup.BOF Then
            ...
            Do While Not rsPMIS_DAYTRANDup.EOF
                ...
                rsCSMS_MATMASDup.Open "select STOCKNO,onorder,tpoqty,ordered,emergency_po from CSMS_MATMAS where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRANDup!STOCK_ORD), gconDMIS
                If Not rsCSMS_MATMASDup.EOF And Not rsCSMS_MATMASDup.BOF Then
                    PCurOnOrder = N2Str2IntZero(rsCSMS_MATMASDup!ONORDER) - N2Str2Zero(rsPMIS_DAYTRANDup!TRANQTY)
                    PCurTpoQty = N2Str2IntZero(rsCSMS_MATMASDup!tpoqty) - N2Str2Zero(rsPMIS_DAYTRANDup!TRANQTY)
                    If Null2String(rsPMIS_DAYTRANDup!Status) = "P" Then
                        gconDMIS.Execute "update CSMS_MATMAS set" & _
                                       " purchases = " & N2Str2Zero(rsCSMS_MATMASDup!purchases) - NumericVal(rsPMIS_DAYTRANDup!TRANQTY) & "," & _
                                       " onorder = " & PCurOnOrder & "," & _
                                       " ORDERED = " & N2Str2IntZero(rsCSMS_MATMASDup!Ordered) - N2Str2Zero(rsPMIS_DAYTRANDup!TRANQTY) & "," & _
                                       " tpoqty = " & PCurTpoQty & "," & _
                                       " usercode = " & N2Str2Null(LOGCODE) & "," & _
                                       " lastupdate = '" & LOGDATE & "'" & _
                                       " where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRANDup!STOCK_ORD)
                        If Mid(txtDON.Text, 3, 1) = "E" Then
                            gconDMIS.Execute "update CSMS_MATMAS set" & _
                                           " EMERGENCY_PO = " & N2Str2IntZero(rsCSMS_MATMASDup!emergency_po) - N2Str2Zero(rsPMIS_DAYTRANDup!TRANQTY) & _
                                           " where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRANDup!STOCK_ORD)
                        End If
                    End If
                End If
        ...
        LogAudit "P", "MATERIALS PURCHASE ORDER", txtPONo
        rsRefresh
        On Error Resume Next
...
Private Sub cmdPost_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Post this Transactions?", "Post Transactions") = True Then
        Set rsPMIS_DAYTRAN = New ADODB.Recordset
        rsPMIS_DAYTRAN.Open "select id,itemno,trantype,tranno,STOCK_ORD,tranqty,traninvamt from PMIS_Daytran where [TYPE] = 'M' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
        If Not rsPMIS_DAYTRAN.EOF And Not rsPMIS_DAYTRAN.BOF Then
            '            rsPMIS_Daytran.MoveFirst
            '            Do While Not rsPMIS_Daytran.EOF
            '                If N2Str2Zero(rsPMIS_Daytran!TRANINVAMT) <= 0 Then
            '                    MessagePop InfoWait, "Warning: Transaction with Invoice Amount equal to Zero Encountered!"
            '                    'Exit Sub
            '                End If
            '                rsPMIS_Daytran.MoveNext
            '            Loop
            ...
            Do While Not rsPMIS_DAYTRAN.EOF
                Set rsCSMS_MATMAS = New ADODB.Recordset
                rsCSMS_MATMAS.Open "Select STOCKNO,onhand,tpoqty,onorder,ordered,emergency_po,purchases from CSMS_MATMAS where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRAN!STOCK_ORD), gconDMIS
                If Not rsCSMS_MATMAS.EOF And Not rsCSMS_MATMAS.EOF Then
                    gconDMIS.Execute "update CSMS_MATMAS set " & _
                                   " purchases = " & N2Str2Zero(rsCSMS_MATMAS!purchases) + NumericVal(rsPMIS_DAYTRAN!TRANQTY) & "," & _
                                   " tpoqty = " & N2Str2Zero(rsCSMS_MATMAS!tpoqty) + NumericVal(rsPMIS_DAYTRAN!TRANQTY) & "," & _
                                   " ONORDER = " & N2Str2Zero(rsCSMS_MATMAS!ONORDER) + NumericVal(rsPMIS_DAYTRAN!TRANQTY) & "," & _
                                   " ORDERED = " & N2Str2Zero(rsCSMS_MATMAS!Ordered) + NumericVal(rsPMIS_DAYTRAN!TRANQTY) & _
                    ...
                    If Mid(txtDON.Text, 3, 1) = "E" Then
                        gconDMIS.Execute "update CSMS_MATMAS set" & _
                                       " EMERGENCY_PO = " & N2Str2Zero(rsCSMS_MATMAS!emergency_po) + N2Str2Zero(rsPMIS_DAYTRAN!TRANQTY) & _
                                       " where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRAN!STOCK_ORD)
                    End If
                End If
                rsPMIS_DAYTRAN.MoveNext
            Loop
        ...
        If NumericVal(txtDS1.Text) > 0 Then
            ...
            rptPurchaseOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
             ...
             If COMPANY_CODE = "HCI" Then
                    PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "PO_Hist_Printing.RPT", "{Po_hd.type} = 'M' AND {Po_hd.pono} = '" & txtPONo.Text & "'", DMIS_REPORT_Connection, 1
            Else
                    PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "PO_Hist.RPT", "{Po_hd.type} = 'M' AND {Po_hd.pono} = '" & txtPONo.Text & "'", DMIS_REPORT_Connection, 1
            End If
        Else
            rptPurchaseOrder.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
            rptPurchaseOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
            PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "POnonvat.RPT", "{Po_hd.type} = 'M' AND {Po_hd.pono} = '" & txtPONo.Text & "'", DMIS_REPORT_Connection, 1
        End If
        Screen.MousePointer = 0
        NEW_LogAudit "V", "PURCHASE ORDER - HISTORY", "", "", "Materials", txtPONo, "Purchase Order", ""
    End If
...
Private Sub cmdTranDelete_Click()
    ...
    Set rsPMIS_DAYTRANDup = New ADODB.Recordset
    rsPMIS_DAYTRANDup.Open "select id,itemno from PMIS_Daytran where [TYPE] = 'M' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
    If Not rsPMIS_DAYTRANDup.EOF And Not rsPMIS_DAYTRANDup.BOF Then
        rsPMIS_DAYTRANDup.MoveFirst
        CNT = 0
        Do While Not rsPMIS_DAYTRANDup.EOF
...
Private Sub cmdTranSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        rsPMIS_DAYTRANClone.Open "select trantype,tranno,itemno,STOCK_ORD from PMIS_Daytran where [TYPE] = 'M' AND STOCK_ORD = '" & UCase(cboTranPartNo.Text) & "' and trantype = 'PO' and tranno =" & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
...
Private Sub cmdUnPost_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Unpost this Transactions?", "Unpost Transactions") = True Then
        ...
        Dim PCurOnOrder, PCurTpoQty                    As Integer
        Set rsPMIS_DAYTRANDup = New ADODB.Recordset
        rsPMIS_DAYTRANDup.Open "select ID,Tranqty,STOCK_ORD,trantype,tranno,STATUS from PMIS_Daytran where [TYPE] = 'M' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO), gconDMIS
        If Not rsPMIS_DAYTRANDup.EOF And Not rsPMIS_DAYTRANDup.BOF Then
            rsPMIS_DAYTRANDup.MoveFirst
            Do While Not rsPMIS_DAYTRANDup.EOF
                Set rsCSMS_MATMASDup = New ADODB.Recordset
                rsCSMS_MATMASDup.Open "select STOCKNO,onorder,tpoqty,ordered,emergency_po,purchases from CSMS_MATMAS where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRANDup!STOCK_ORD), gconDMIS
                If Not rsCSMS_MATMASDup.EOF And Not rsCSMS_MATMASDup.BOF Then
                    PCurOnOrder = N2Str2IntZero(rsCSMS_MATMASDup!ONORDER) - N2Str2Zero(rsPMIS_DAYTRANDup!TRANQTY)
                    PCurTpoQty = N2Str2IntZero(rsCSMS_MATMASDup!tpoqty) - N2Str2Zero(rsPMIS_DAYTRANDup!TRANQTY)
                    If Null2String(rsPMIS_DAYTRANDup!Status) = "P" Then
                        gconDMIS.Execute "update CSMS_MATMAS set" & _
                                       ...
                                       " onorder = " & PCurOnOrder & "," & _
                                       " tpoqty = " & PCurTpoQty & "," & _
                                       " ORDERED = " & N2Str2IntZero(rsCSMS_MATMASDup!Ordered) - NumericVal(rsPMIS_DAYTRANDup!TRANQTY) & "," & _
                                       " usercode = " & N2Str2Null(LOGCODE) & "," & _
                                       " lastupdate = '" & LOGDATE & "'" & _
                                       " where STOCKNO = " & N2Str2Null(rsPMIS_DAYTRANDup!STOCK_ORD)
                        If Mid(txtDON.Text, 3, 1) = "E" Then
            ...
            Loop
        End If
        LogAudit "U", "MATERIALS PURCHASE ORDER", txtPONo
        rsRefresh
        RSPO_HD.Find "id =" & labID.Caption
        StoreMemVars
    End If
...
Private Sub cmdSave_Click()
    ...
    Else
        If AddorEdit = "ADD" Then
            ...
            rsPO_HDDup.Open "select pono from PMIS_PO_Hist where [TYPE] = 'M' AND pono = '" & txtPONo.Text & "'", gconDMIS, adOpenForwardOnly, adLockReadOnly
    ...
    If AddorEdit = "ADD" Then
        ...
        LogAudit "A", "MATERIALS PURCHASE ORDER", txtPONo
    Else
        gconDMIS.Execute "update PMIS_PO_Hist set" & _
                       " pono = " & VTXTPONo & "," & _
                       " ppno = " & VTXTPPNo & "," & _
        ...
        gconDMIS.Execute "update PMIS_Daytran set" & _
                       ...
                       " tranno = " & VTXTPONo & _
                       " where [TYPE] = 'M' AND tranno = '" & Null2String(RSPO_HD!PONO) & "'"
        LogAudit "E", "MATERIALS PURCHASE ORDER", PrevPONO
    End If
    If AddorEdit = "ADD" Then
...
Private Sub txtPONo_LostFocus()
    If Frame1.Enabled = True Then
        If Len(txtPONo.Text) >= 3 Then
            ...
            If AddorEdit = "ADD" Then
                Set rsPO_HDDup = New ADODB.Recordset
                rsPO_HDDup.Open "select pono from PMIS_PO_Hist where [TYPE] = 'M' AND pono = '" & txtPONo.Text & "'", gconDMIS
                If Not rsPO_HDDup.EOF And Not rsPO_HDDup.BOF Then
