...
Sub DRPRINTING()
    Screen.MousePointer = 11
        PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "DR_HIst.RPT", "{ord_hd.TRANTYPE} = 'DR' and {ord_hd.TYPE} = 'P' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
...
Sub SERVICEPISPRINTING()
    ...
    If Not RSTDAYTRAN.EOF And Not RSTDAYTRAN.BOF Then
        ...
        For knt = 1 To cntCOPY
            ...
            Print #1, "<td align=center width=60%><font size=2 FACE=TIMES NEW ROMAN>" & RSPROFILE!CompanyName & "</font></td>"
            ...
            Print #1, "<td align=center width=60%><font size=4 FACE=TIMES NEW ROMAN><strong>PARTS ISSUANCE SLIP</strong></font></td>"
            ...
            Print #1, "<tr>"
            Print #1, "<td width=60%><FONT SIZE=1 FACE=TIMES NEW ROMAN<b>Transaction Number:</b></FONT><FONT SIZE=2 FACE=TIMES NEW ROMAN><b><i><u>" & "SERVICE PIS-" & Null2String(RSORD_HIST!TRANNO) & "</b></i></u></FONT></td>"
            Print #1, "<td width=40%><FONT SIZE=1 FACE=TIMES NEW ROMAN<b>Transaction Date: " & Null2String(RSORD_HIST!TRANDATE) & "</b></FONT></td>"
            Print #1, "</tr>"
            Print #1, "<tr>"
            Print #1, "<td width=60%><FONT SIZE=1 FACE=TIMES NEW ROMAN><b>Customer: " & Null2String(RSORD_HIST!CUSTCODE) & "</b></FONT></td>"
            Print #1, "<td width=40%><FONT SIZE=1 FACE=TIMES NEW ROMAN><b></b></FONT></td>"
            Print #1, "</tr>"
            Print #1, "<tr>"
            Print #1, "<td width=60%><FONT SIZE=1 FACE=TIMES NEW ROMAN><b>" & Null2String(RSORD_HIST!CUSTNAME) & "</b></FONT></td>"
            Print #1, "<td width=40%><FONT SIZE=1 FACE=TIMES NEW ROMAN><b></b></FONT></td>"
            Print #1, "</tr>"
            Print #1, "</table>"
            Print #1, "-------------------------------------------------------------------------------------------------------------------------------------------"
            Print #1, "<table border=0 cellpadding=0 cellspacing=0 width=100%>"
            Print #1, "<tr>"
            Print #1, "<td width=10%><FONT SIZE=1 FACE=TIMES NEW ROMAN>ITM #</FONT></td>"
            Print #1, "<td width=15%><FONT SIZE=1 FACE=TIMES NEW ROMAN>PART NUMBER</FONT></td>"
            Print #1, "<td width=35%><FONT SIZE=1 FACE=TIMES NEW ROMAN>DESCRIPTION</FONT></td>"
            Print #1, "<td align=right width=8%><FONT SIZE=1 FACE=TIMES NEW ROMAN>QTY</FONT></td>"
            Print #1, "<td align=right width=17%><FONT SIZE=1 FACE=TIMES NEW ROMAN>UNIT PRICE</FONT></td>"
            Print #1, "<td align=right width=17%><FONT SIZE=1 FACE=TIMES NEW ROMAN>TOTAL PRICE</FONT></td>"
            Print #1, "</tr>"
            Print #1, "</table>"
            Print #1, "-------------------------------------------------------------------------------------------------------------------------------------------"
            cnt1 = 0
            ...
            Do While Not RSTDAYTRAN.EOF
                Print #1, "<tr>"
                Print #1, "<td width=10%><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & Null2String(RSTDAYTRAN!itemno) & "</FONT></td>"
                Print #1, "<td width=15%><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & Null2String(RSTDAYTRAN!STOCK_ORD) & "</FONT></td>"
                Print #1, "<td width=35%><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & SetSTOCKDESC(Null2String(RSTDAYTRAN!STOCK_SUP)) & "</FONT></td>"
                Print #1, "<td align=right width=8%><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & N2Str2IntZero(RSTDAYTRAN!TRANQTY) & "</FONT></td>"
                Print #1, "<td align=right width=17%><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & Format(N2Str2Zero(RSTDAYTRAN!TRANUPRICE), MAXIMUM_DIGIT) & "</FONT></td>"
                Print #1, "<td align=right width=17%><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & Format(N2Str2Zero(RSTDAYTRAN!TRANQTY) * N2Str2Zero(RSTDAYTRAN!TRANUPRICE), MAXIMUM_DIGIT) & "</FONT></td>"
                If knt <> 4 Then
            ...
            For cnt3 = 1 To cnt2
                Print #1, "<tr>"
                Print #1, "<td width=10%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=15%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=35%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=8%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=17%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=17%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "</tr>"
            Next
            Print #1, "</table>"
            ...
            If cntCOPY = 4 And knt < 3 Then
                Print #1, "<table border=0 cellpadding=0 cellspacing=0 width=100%>"
                Print #1, "<tr>"
                Print #1, "<td width=10%><FONT SIZE=4>&nbsp;</FONT></td>"
                Print #1, "<td width=15%><FONT SIZE=4>&nbsp;</FONT></td>"
                Print #1, "<td width=35%><FONT SIZE=4>&nbsp;</FONT></td>"
                Print #1, "<td width=8%><FONT SIZE=4>&nbsp;</FONT></td>"
                Print #1, "<td width=17%><FONT SIZE=4>&nbsp;</FONT></td>"
                Print #1, "<td width=17%><FONT SIZE=4>&nbsp;</FONT></td>"
                Print #1, "</tr>"
                Print #1, "</table>"
            Else
                ...
                Print #1, "<td width=10%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=15%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td width=35%><FONT SIZE=1 FACE=TIMES NEW ROMAN>*** TOTAL PIS</FONT></td>"
                Print #1, "<td align=right width=8%><FONT SIZE=2 FACE=TIMES NEW ROMAN>" & TOTALQTY & "</FONT></td>"
                Print #1, "<td width=17%><FONT SIZE=1>&nbsp;</FONT></td>"
                Print #1, "<td align=right width=17%><FONT SIZE=2 FACE=TIMES NEW ROMAN>" & Format(TOTALPRICE, MAXIMUM_DIGIT) & "</FONT></td>"
                Print #1, "</tr>"
                Print #1, "</table>"
            End If
            Print #1, "<table border=0 cellpadding=0 cellspacing=0 width=100%>"
            ...
            Print #1, "<table border=0 cellpadding=0 cellspacing=0 width=100%>"
            Print #1, "<tr>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & txtPreparedBy.Text & "</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & txtIssuedBy.Text & "</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & txtApprovedBy.Text & "</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>" & txtRequestedBy.Text & "</FONT></td>"
            Print #1, "</tr>"
            Print #1, "<tr>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>---------------------------------</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>---------------------------------</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>---------------------------------</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>---------------------------------</FONT></td>"
            Print #1, "</tr>"
            Print #1, "<tr>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>Prepared By</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>Issued By</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>Approved By</FONT></td>"
            Print #1, "<td width=25% align=center><FONT SIZE=1 FACE=TIMES NEW ROMAN>Requested By</FONT></td>"
            Print #1, "</tr>"
            Print #1, "</table>"
            Print #1, "<table border=0 cellpadding=0 cellspacing=0 width=100%>"
            Print #1, "<tr>"
            Print #1, "<td width=25%><FONT SIZE=2>&nbsp;</FONT></td>"
            Print #1, "<td width=25%><FONT SIZE=2>&nbsp;</FONT></td>"
            Print #1, "</tr>"
            Print #1, "</table>"
            If knt <> 2 And knt <> 4 Then
                ...
                Print #1, "<tr>"
                Print #1, "<td width=25%><FONT SIZE=2>&nbsp;</FONT></td>"
                Print #1, "<td width=25%><FONT SIZE=22>&nbsp;</FONT></td>"
                Print #1, "</tr>"
                Print #1, "</table>"
                Print #1, "-------------------------------------------------------------------------------------------------------------------------------------------"
                Print #1, "<table>"
...
Sub StoreMemVars()
    If Not RSORD_HIST.EOF And Not RSORD_HIST.BOF Then
        ...
        End If
        '=========================================================
        labORNo = CheckORNum(Null2String(RSORD_HIST!TRANNO), "PI", txtTranType.Text)
        ...
        If Null2String(RSORD_HIST!ZERORATED) = "" Or Null2Bit(RSORD_HIST!ZERORATED) = 0 Then
...
Sub FillGrid3()
    ...
    Set RSORD_HD = gconDMIS.Execute("select Custname,tranno from PMIS_Ord_Hist where [TYPE] = 'P' AND trantype = '" & txtTranType.Text & "' order by CUSTNAME asc")
...
Sub FillSearchCusTomer(XXX As String)
    ...
    Set RSORD_HD = gconDMIS.Execute("select TOP 100 custname, tranno from PMIS_Ord_Hist where [TYPE] = 'P' AND trantype = '" & txtTranType.Text & "' and CUSTNAME  like '" & XXX & "%' order by CUSTNAME")
    If Not (RSORD_HD.EOF And RSORD_HD.BOF) Then
        lstOrd_Hd.Enabled = True: Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HD: lstOrd_Hd.Refresh
    Else
        lstOrd_Hd.Enabled = False
...
Sub FillGrid()
    ...
    lstOrd_Hd.Sorted = False: lstOrd_Hd.ListItems.Clear
    Set RSORD_HIST = New ADODB.Recordset
    Set RSORD_HIST = gconDMIS.Execute("select  Tranno,ID from PMIS_Ord_Hist where type = 'P' and trantype = '" & txtTranType.Text & "' order by id desc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSORD_HIST = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set RSORD_HIST = gconDMIS.Execute("select  tranno, ID from PMIS_Ord_Hist where type = 'P' and trantype = '" & txtTranType.Text & "' and tranno like '" & XXX & "%' order by id desc")
    If Not (RSORD_HIST.EOF And RSORD_HIST.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HIST
        lstOrd_Hd.Refresh
...
Sub FillGrid2()
    ...
    lstOrd_Hd.Sorted = False: lstOrd_Hd.ListItems.Clear
    Set RSORD_HIST = New ADODB.Recordset
    Set RSORD_HIST = gconDMIS.Execute("select TOP 100 rono,ID from PMIS_Ord_Hist where type = 'P' and trantype = '" & txtTranType.Text & "' and rono is not null order by id desc")
    If Not (RSORD_HIST.EOF And RSORD_HIST.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HIST
        lstOrd_Hd.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set RSORD_HIST = gconDMIS.Execute("select TOP 100 Rono, ID from PMIS_Ord_Hist where type = 'P' and trantype = '" & txtTranType.Text & "' and rono like '" & XXX & "%' order by Rono desc")
    If Not (RSORD_HIST.EOF And RSORD_HIST.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, RSORD_HIST
        lstOrd_Hd.Refresh
...
Private Sub cmdPrint_Click()
    ...
    If RSORD_HIST!TranType = "CHG" Then
        ...
        End If
    End If
    If RSORD_HIST!TranType = "DR" Then
        If MsgQuestionBox("Parts Issuance Slip (DR) will be Printed. Are you Sure?", "Confirm Printing...") = True Then
            DRPRINTING
        End If
    End If
    NEW_LogAudit "V", "PARTS ISSUANCE - HISTORY", "", "", "Parts", txtTranNo, txtTranType.Text, ""
End Sub
...
Private Sub Form_Load()
    ...
    If txtTranType.Text <> "RIV" And txtTranType.Text <> "ADB" Then optRONo.Enabled = False
...
Sub click()
    RSORD_HIST.Requery
    RSORD_HIST.MoveFirst
    RSORD_HIST.Find ("ID=" & lstOrd_Hd.SelectedItem.ListSubItems(1).Text)
    StoreMemVars
End Sub
