...
Begin VB.Form frmPMISAC_Purchase 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSComctlLib.ListView lstPO_HD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AC_Purchase.frx":08CA
         NumItems        =   2
   ...
   Begin VB.Frame fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Left            =   3480
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":0A46
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":0B98
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Left            =   2580
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":0EC3
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1015
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Left            =   1680
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":1353
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":14A5
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8640
         MouseIcon       =   "AC_Purchase.frx":17F5
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1947
         Style           =   1  'Graphical
         TabIndex        =   66
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "AC_Purchase.frx":1CAD
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":1DFF
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmdCancelPO 
         ...
         Left            =   7080
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":2165
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":22B7
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":25F1
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2743
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "AC_Purchase.frx":2A88
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":2BDA
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "AC_Purchase.frx":2EFF
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":3051
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "AC_Purchase.frx":33AD
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":34FF
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "AC_Purchase.frx":3812
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":3964
         Style           =   1  'Graphical
         TabIndex        =   65
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "AC_Purchase.frx":3CB4
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":3E06
         Style           =   1  'Graphical
         TabIndex        =   64
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "AC_Purchase.frx":4164
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":42B6
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "AC_Purchase.frx":45B0
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4702
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "AC_Purchase.frx":4A5A
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":4BAC
         Style           =   1  'Graphical
         TabIndex        =   72
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   810
         MouseIcon       =   "AC_Purchase.frx":4F0B
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":505D
         Style           =   1  'Graphical
         TabIndex        =   77
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "AC_Purchase.frx":539B
         MousePointer    =   99  'Custom
         Picture         =   "AC_Purchase.frx":54ED
         Style           =   1  'Graphical
         TabIndex        =   78
   ...
   End
End
Attribute VB_Name = "frmPMISAC_Purchase"
...
Dim rsPMIS_PP_HD                                       As ADODB.Recordset
Dim rsPMIS_Tdaytran                                    As ADODB.Recordset
Dim rsPMIS_Accessories                                 As ADODB.Recordset
Dim rsSupplier                                         As ADODB.Recordset
Dim rsALL_Profile                                      As ADODB.Recordset
Dim rsPMIS_Counter                                     As ADODB.Recordset
Dim Pcnt                                               As Integer
Dim PO_TOTQTY                                          As Integer
Dim AddorEdit                                          As String
Dim PO_TOTUCOST                                        As Double
Dim PO_TOTINVAMT                                       As Double
...
Sub fill_LblRefRRno()
    ...
    SQL = SQL & ") T WHERE PONO = '" & Null2String(txtPONo) & "' AND TYPE = 'A' AND STATUS = 'P'" & vbCrLf
...
Function SetPartDesc2(pid As Variant)
    If pid <> "" Then
        Set rsPMIS_Accessories = New ADODB.Recordset
        rsPMIS_Accessories.Open "Select id,partdesc,dnp from PMIS_Accessories where id = " & pid, gconDMIS, adOpenForwardOnly, adLockReadOnly
        If Not rsPMIS_Accessories.EOF And Not rsPMIS_Accessories.BOF Then
            
            SetPartDesc2 = Null2String(rsPMIS_Accessories!PARTDESC)
            
            txtUnitCost.Text = Round(N2Str2Zero(rsPMIS_Accessories!dnp) / ConvertToBIRDecimalFormat(VAT_RATE), 2)
...
Sub rsRefresh()
    ...
    RSPO_HD.Open "select * from PMIS_PO_HD WHERE [TYPE] = 'A' order by pono asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Sub initMemvars()
    ...
    'JJE Prefixes 02/07/2013 9:50AM
'    If COMPANY_CODE = "DJM" Then       ** FOR APPROVAL **
'        txtPONo.Text = "AP" + txtPONo
'    End If
    'JJE
...
Sub FillDetails()
    ...
    Set rsPMIS_Tdaytran = New ADODB.Recordset
    rsPMIS_Tdaytran.Open "select id,tranno,trantype,itemno,STOCK_ORD,STOCK_SUP,tranqty,traninvamt,tranucost,VIN from PMIS_Tdaytran where [TYPE] = 'A' AND tranno = " & N2Str2Null(RSPO_HD!PONO) & " and trantype = 'PO' order by itemno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsPMIS_Tdaytran.EOF And Not rsPMIS_Tdaytran.BOF Then
...
Sub FillGrid()
    ...
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select pono from PMIS_PO_HD WHERE [TYPE] = 'A' order by pono asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set RSPO_HD = gconDMIS.Execute("select ID, pono from PMIS_PO_HD where [TYPE] = 'A' AND pono like'" & XXX & "%'")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
...
Sub FillGrid2()
    ...
    lstPO_HD.Sorted = False: lstPO_HD.ListItems.Clear
    Set RSPO_HD = New ADODB.Recordset
    Set RSPO_HD = gconDMIS.Execute("select supname, pono from PMIS_PO_HD where [TYPE] = 'A' order by pono asc")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, RSPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set RSPO_HD = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set RSPO_HD = gconDMIS.Execute("select supname, pono from PMIS_PO_HD where [TYPE] = 'A' AND supname like '" & XXX & "%' order by pono asc")
    If Not (RSPO_HD.EOF And RSPO_HD.BOF) Then
        lstPO_HD.Enabled = True: Listview_Loadval Me.lstPO_HD.ListItems, RSPO_HD: lstPO_HD.Refresh
    Else
        lstPO_HD.Enabled = False
...
'        cboTranDescription.Text = SetPartDesc2(txtPartID.Text)
        ...
        txtPartID.Text = SetPartIDDesc(cboTranPartNo.Text)
        cboTranDescription.Text = SetPartDesc2(txtPartID.Text)
...
On Error GoTo ErrorCode
    ...
    If chkstatus(txtPONo.Text, "A", "PO") = "P" Then
        MessagePop InfoVoid, "Action void", "Transaction already posted!"
        Exit Sub
    ElseIf chkstatus(txtPONo.Text, "A", "PO") = "C" Then
...
On Error GoTo errordaa
    ...
    Dim rsPMIS_TdaytranDup, rsPMIS_AccessoriesDup      As ADODB.Recordset
    ...
    NEW_LogAudit "C", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "PO NO: " & txtPONo, "", ""

    Set rsPMIS_TdaytranDup = New ADODB.Recordset
    rsPMIS_TdaytranDup.Open "select Tranqty,STOCK_ORD,trantype,tranno,STATUS from PMIS_Tdaytran where [TYPE] = 'A' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO), gconDMIS
    If Not rsPMIS_TdaytranDup.EOF And Not rsPMIS_TdaytranDup.BOF Then
        ...
        Do While Not rsPMIS_TdaytranDup.EOF
            ...
            rsPMIS_AccessoriesDup.Open "select partno,onorder,tpoqty,ordered,emergency_po from PMIS_Accessories where partno = " & N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD), gconDMIS
            If Not rsPMIS_AccessoriesDup.EOF And Not rsPMIS_AccessoriesDup.BOF Then
                PCurOnOrder = N2Str2IntZero(rsPMIS_AccessoriesDup!ONORDER) - N2Str2Zero(rsPMIS_TdaytranDup!TRANQTY)
                PCurTpoQty = N2Str2IntZero(rsPMIS_AccessoriesDup!tpoqty) - N2Str2Zero(rsPMIS_TdaytranDup!TRANQTY)
                If Null2String(rsPMIS_TdaytranDup!Status) = "P" Then
                    SQL_STATEMENT = "update PMIS_Accessories set" & _
                                  " purchases = " & N2Str2Zero(rsPMIS_AccessoriesDup!purchases) - NumericVal(rsPMIS_TdaytranDup!TRANQTY) & "," & _
                                  " onorder = " & PCurOnOrder & "," & _
                                  " ORDERED = " & N2Str2IntZero(rsPMIS_AccessoriesDup!Ordered) - N2Str2Zero(rsPMIS_TdaytranDup!TRANQTY) & "," & _
                                  " tpoqty = " & PCurTpoQty & "," & _
                                  " usercode = " & N2Str2Null(LOGCODE) & "," & _
                                  " lastupdate = '" & LOGDATE & "'" & _
                                  " where partno = " & N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD)
                    gconDMIS.Execute SQL_STATEMENT
                    Call NEW_LogAudit("E", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo & " CANCEL EMERGENCY", "", "")

                    If Mid(txtDON.Text, 3, 1) = "E" Then
                        SQL_STATEMENT = "update PMIS_Accessories set" & _
                                      " EMERGENCY_PO = " & N2Str2IntZero(rsPMIS_AccessoriesDup!emergency_po) - N2Str2Zero(rsPMIS_TdaytranDup!TRANQTY) & _
                                      " where partno = " & N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD)
                        gconDMIS.Execute SQL_STATEMENT
                        Call NEW_LogAudit("E", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo & " CANCEL EMERGENCY", "", "")
                    End If
    ...
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "CC", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "PO NO: " & txtPONo, "PO", ""

    Set rsPMIS_TdaytranDup = Nothing
    Set rsPMIS_AccessoriesDup = Nothing
...
On Error GoTo errordaa
    Set rsPMIS_Tdaytran = New ADODB.Recordset
    rsPMIS_Tdaytran.Open "select id,itemno,trantype,tranno,STOCK_ORD,tranqty,traninvamt from PMIS_Tdaytran where [TYPE] = 'A' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
    If Not rsPMIS_Tdaytran.EOF And Not rsPMIS_Tdaytran.BOF Then
        rsPMIS_Tdaytran.MoveFirst
        Do While Not rsPMIS_Tdaytran.EOF
            Set rsPMIS_Accessories = New ADODB.Recordset
            rsPMIS_Accessories.Open "Select partno,onhand,tpoqty,onorder,ordered,emergency_po,purchases from PMIS_Accessories where partno = " & N2Str2Null(rsPMIS_Tdaytran!STOCK_ORD), gconDMIS
            If Not rsPMIS_Accessories.EOF And Not rsPMIS_Accessories.BOF Then
                SQL_STATEMENT = "update PMIS_Accessories set " & _
                              " purchases = " & N2Str2Zero(rsPMIS_Accessories!purchases) + NumericVal(rsPMIS_Tdaytran!TRANQTY) & "," & _
                              " tpoqty = " & N2Str2Zero(rsPMIS_Accessories!tpoqty) + NumericVal(rsPMIS_Tdaytran!TRANQTY) & "," & _
                              " ONORDER = " & N2Str2Zero(rsPMIS_Accessories!ONORDER) + NumericVal(rsPMIS_Tdaytran!TRANQTY) & "," & _
                              " ORDERED = " & N2Str2Zero(rsPMIS_Accessories!Ordered) + NumericVal(rsPMIS_Tdaytran!TRANQTY) & _
                              " where partno = " & N2Str2Null(rsPMIS_Accessories!PARTNO)
                gconDMIS.Execute SQL_STATEMENT
                Call NEW_LogAudit("E", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsPMIS_Tdaytran!STOCK_ORD), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo & " POSTED", "", "")
                ...
                gconDMIS.Execute SQL_STATEMENT
                NEW_LogAudit "PP", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "PO NO: " & txtPONo, "PO", ""

                If Mid(txtDON.Text, 3, 1) = "E" Then
                    SQL_STATEMENT = "update PMIS_Accessories set" & _
                                  " EMERGENCY_PO = " & N2Str2Zero(rsPMIS_Accessories!emergency_po) + N2Str2Zero(rsPMIS_Tdaytran!TRANQTY) & _
                                  " where partno = " & N2Str2Null(rsPMIS_Tdaytran!STOCK_ORD)
                    gconDMIS.Execute SQL_STATEMENT
                    Call NEW_LogAudit("E", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsPMIS_Tdaytran!PARTNO), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo & " POSTED EMERGENCY", "", "")
                End If
                'updated by: IEBV 092820121200pm
                'description: to set partnumber as active if not active
                Call TAGIFINACTIVE(Null2String(rsPMIS_Accessories!PARTNO), "A")
                '-----------------------------------------------------
            End If
            rsPMIS_Tdaytran.MoveNext
        Loop
    ...
    SQL_STATEMENT = "update PMIS_PO_HD set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "P", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "PO NO: " & txtPONo, "", ""

    Set rsPMIS_Tdaytran = Nothing
    Set rsPMIS_Accessories = Nothing
...
Private Sub cmdPrint_Click()
    ...
    If MsgQuestionBox("PO Transaction will be Printed. Are you Sure?", "Confirm Printing...") = True Then
        ...
        ' show contact person in report (HCI)
        ...
        If NumericVal(txtDS1.Text) > 0 Then
            ...
            If COMPANY_CODE = "HCO" Then
                rptPurchaseOrder.Formulas(2) = "ContactPerson = '" & cboContactCode & "'"
            End If
            
            PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "POacc.RPT", "{Po_hd.type} = 'A' AND {Po_hd.pono} = '" & txtPONo.Text & "' and {Tdaytran.trantype} = 'PO'", DMIS_REPORT_Connection, 1
        Else
            rptPurchaseOrder.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
            rptPurchaseOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
            rptPurchaseOrder.Formulas(2) = "PreparedBy = '" & (gconDMIS.Execute("Select PreparedBy from all_profile where modulename = 'PMIS'").Fields(0).Value) & "'"
            ...
            If COMPANY_CODE = "HCO" Then
                rptPurchaseOrder.Formulas(2) = "ContactPerson = '" & cboContactCode & "'"
            End If
            PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "POacc_nonvat.rpt", "{Po_hd.type} = 'A' and {Po_hd.pono} = '" & txtPONo.Text & "'", DMIS_REPORT_Connection, 1
            'PrintSQLReport rptPurchaseOrder, PMIS_REPORT_PATH & "POnonvat.RPT", "{Po_hd.type} = 'A' ", DMIS_REPORT_Connection, 1
        End If
        Screen.MousePointer = 0
        Call NEW_LogAudit("V", "ACCESSORIES PURCHASE ORDER", "", labID, "", "PO NO: " & txtPONo, "", "")
    End If
End Sub
...
Private Sub cmdTranDelete_Click()
    ...
    If MsgQuestionBox("Delete This Parts, Are you Sure?", "Delete Parts Entry") = True Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "XX", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, "PO", ""
    End If

    Dim CNT                                            As Integer
    Dim rsPMIS_TdaytranDup                             As ADODB.Recordset
    Set rsPMIS_TdaytranDup = New ADODB.Recordset
    rsPMIS_TdaytranDup.Open "select id,itemno from PMIS_Tdaytran where [TYPE] = 'A' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
    If Not rsPMIS_TdaytranDup.EOF And Not rsPMIS_TdaytranDup.BOF Then
        rsPMIS_TdaytranDup.MoveFirst
        CNT = 0
        Do While Not rsPMIS_TdaytranDup.EOF
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
    End If
    Call NEW_LogAudit("E", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "", "PO NO: " & txtPONo, "", "")
...
Private Sub cmdTranSave_Click()
    ...
    If cboTranDescription.Text = "" Then
        MsgBox "Warning:   Accessories description must have a value", vbInformation + vbOKOnly
        On Error Resume Next
...
'----------------------------------------------------------------------------------------------------------------
    CTR = 0
    CTR = (gconDMIS.Execute("SELECT COUNT(*) FROM PMIS_STOCKMAS WHERE STOCKNO = " & N2Str2Null(LTrim(RTrim(cboTranPartNo.Text))) & " AND [TYPE] = 'A' ").Fields(0).Value)
    If CTR > 0 Then
        'do nothing
    Else
        Msg = "Part Number Doesn't Exist On Accessories Master file." & vbCrLf
        ...
        If MsgBox(Msg, vbQuestion + vbYesNo) = vbYes Then
            ...
            sqlcommand = sqlcommand + " VALUES ('A'," & N2Str2Null(LTrim(RTrim(cboTranPartNo.Text))) & ",'" & UCase(cboTranDescription.Text) & "', "
            sqlcommand = sqlcommand + " 'GJ', '" & Null2String(RSPO_HD!USERCODE) & "','" & LOGDATE & "', 'N') "
            gconDMIS.Execute sqlcommand
            Call NEW_LogAudit("A", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(LTrim(RTrim(cboTranPartNo))), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo, "", "")
        Else
            Exit Sub
        End If
    End If
'----------------------------------------------------------------------------------------------------------------
    ...
    If AddorEdit = "ADD" Then
        ...
        rsPMIS_TdaytranClone.Open "select trantype,tranno,itemno,STOCK_ORD from PMIS_Tdaytran where [TYPE] = 'A' AND STOCK_ORD = " & UCase(N2Str2Null(LTrim(RTrim(cboTranPartNo.Text)))) & " and trantype = 'PO' and tranno =" & N2Str2Null(RSPO_HD!PONO) & " order by itemno asc", gconDMIS
    ...
    Else
        ...
        For FILD = 2 To i
             ...
             If cboTranPartNo.Text = part And txtTranItemNo.Text <> Format(Item, "0000") Then
                MsgSpeechBox "Warning: Accesory Number already used in this transaction"
                On Error Resume Next
                Screen.MousePointer = 0
                Exit Sub
             End If
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "AA", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, "PO", ""
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "EE", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "ACC NO: " & cboTranPartNo, "PO", labDetID
    ...
    Else
        ...
        Else
            ...
            gconDMIS.Execute SQL_STATEMENT
        End If
        Call NEW_LogAudit("A", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(cboTranPartNo), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo, "", "")
    End If
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
    End If
    Call NEW_LogAudit("E", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "", "PO NO: " & txtPONo & " ADD/EDIT ACC.", "", "")
...
Function PO_EXISTS(PO_NO As String) As Boolean
    ...
    SQL = SQL & "Union All" & vbCrLf
    SQL = SQL & "SELECT RRNO,[TYPE], ISNULL(PONO,'000000') AS PONO,STATUS FROM PMIS_REC_HIST" & vbCrLf
    SQL = SQL & ") T WHERE PONO = '" & PO_NO & "' AND TYPE = 'A' AND STATUS = 'P'" & vbCrLf
...
Private Sub cmdUnPost_Click()
    ...
    If chkfnotyet_posted(txtPONo.Text, "A") = True Then MessagePop InfoFriend, "Action Void", "You cannot Unpost this transaction, Its already received but not yet posted!": Exit Sub

    If chkstatus(txtPONo.Text, "A", "PO") = "N" Then
    ...
    If MsgQuestionBox("Are you sure you want to Unpost this Transactions?", "Unpost Transaction") = True Then
...
On Error GoTo errordaa
    ...
    SQL_STATEMENT = "update PMIS_PO_HD set" & _
                  ...
                  " where id = " & labID.Caption
    gconDMIS.Execute SQL_STATEMENT
    NEW_LogAudit "U", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "PO NO: " & txtPONo, "", ""

    Dim rsPMIS_TdaytranDup, rsPMIS_AccessoriesDup  As ADODB.Recordset
    Dim PCurOnOrder, PCurTpoQty                    As Integer
    Set rsPMIS_TdaytranDup = New ADODB.Recordset
    rsPMIS_TdaytranDup.Open "select ID,Tranqty,STOCK_ORD,trantype,tranno,STATUS from PMIS_Tdaytran where [TYPE] = 'A' AND trantype = 'PO' and tranno = " & N2Str2Null(RSPO_HD!PONO), gconDMIS
    If Not rsPMIS_TdaytranDup.EOF And Not rsPMIS_TdaytranDup.BOF Then
        rsPMIS_TdaytranDup.MoveFirst
        Do While Not rsPMIS_TdaytranDup.EOF
            Set rsPMIS_AccessoriesDup = New ADODB.Recordset
            rsPMIS_AccessoriesDup.Open "select partno,onorder,tpoqty,ordered,emergency_po,purchases from PMIS_Accessories where partno = " & N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD), gconDMIS
            If Not rsPMIS_AccessoriesDup.EOF And Not rsPMIS_AccessoriesDup.BOF Then
                PCurOnOrder = N2Str2IntZero(rsPMIS_AccessoriesDup!ONORDER) - N2Str2Zero(rsPMIS_TdaytranDup!TRANQTY)
                PCurTpoQty = N2Str2IntZero(rsPMIS_AccessoriesDup!tpoqty) - N2Str2Zero(rsPMIS_TdaytranDup!TRANQTY)
                If Null2String(rsPMIS_TdaytranDup!Status) = "P" Then
                    SQL_STATEMENT = "update PMIS_Accessories set" & _
                                  ...
                                  " onorder = " & PCurOnOrder & "," & _
                                  " tpoqty = " & PCurTpoQty & "," & _
                                  " ORDERED = " & N2Str2IntZero(rsPMIS_AccessoriesDup!Ordered) - NumericVal(rsPMIS_TdaytranDup!TRANQTY) & "," & _
                                  " usercode = " & N2Str2Null(LOGCODE) & "," & _
                                  " lastupdate = '" & LOGDATE & "'" & _
                                  " where partno = " & N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD)
                    gconDMIS.Execute SQL_STATEMENT
                    Call NEW_LogAudit("E", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo & " UNPOSTED", "", "")
                    ...
                    If Mid(txtDON.Text, 3, 1) = "E" Then
                        SQL_STATEMENT = "update PMIS_Accessories set" & _
                                      ...
                                      " where partno = " & N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD)
                        gconDMIS.Execute SQL_STATEMENT
                        Call NEW_LogAudit("E", "ACCESSORIES MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsPMIS_TdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_Accessories"), "", "TRAN NO: " & txtPONo & " UNPOSTED EMERGENCY", "", "")
                    End If
                End If
            End If
            SQL_STATEMENT = "update PMIS_Tdaytran set" & _
            ...
            gconDMIS.Execute SQL_STATEMENT
            NEW_LogAudit "UU", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", "PO NO: " & txtPONo, "PO", ""
            rsPMIS_TdaytranDup.MoveNext
        Loop
    End If
...
On Error GoTo errordaa
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "A", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, FindTransactionID(txtPONo, "pono", "PMIS_PO_HD", "DETAILS", N2Str2Null("A"), "TYPE"), "Accessories", txtPONo, "PO", ""
    Else
        SQL_STATEMENT = "update PMIS_PO_HD set" & _
                      " pono = " & VTXTPONo & "," & _
                      " ppno = " & VTXTPPNo & "," & _
                      ...
                      " where id = " & labID.Caption
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "E", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", txtPONo, "", ""

        SQL_STATEMENT = "update PMIS_Tdaytran set" & _
                      " trandate = " & VTXTPODate & "," & _
                      " tranno = " & VTXTPONo & _
                      " where [TYPE] = 'A' AND tranno = '" & Null2String(RSPO_HD!PONO) & "' and trantype = 'PO'"
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "E", "ACCESSORIES PURCHASE ORDER", SQL_STATEMENT, labID, "Accessories", txtPONo, "", ""
    ...
    Select Case KeyCode
        ...
        Case vbKeyF4
            If FILD <> "" And FILD <> "No Entry" Then
                If Picture1.Visible = True Then
                    If chkstatus(txtPONo.Text, "A", "PO") <> "P" And chkstatus(txtPONo.Text, "A", "PO") <> "C" Then
                        grdDetails_DblClick
                        Picture1.Enabled = False
                        fraDetails.Enabled = False
                    End If
...
Private Sub Form_Load()
    ...
    'JJE Prefixes 02/07/2013 9:53AM
'    If COMPANY_CODE = "DJM" Then       ** FOR APPROVAL **
'        txtPONo.MaxLength = 8
...
'    End If
    ...
    Frame1.Enabled = False
    cmdAddTran.Enabled = False: picConfirmation.Visible = False: fraAddTran.Enabled = False
...
'                rsPO_HDDup.Open "select pono from PMIS_PO_HD where [TYPE] = 'A' AND pono = '" & txtPONo.Text & "'", gconDMIS
...
'        End If
'    End If
 'updated by: IEBV to check if po no. already exist
 '------------------------------------------------------------------------------
'    If Frame1.Enabled = True Then
'        If Len(txtPONo.Text) >= 3 Then
'            If AddorEdit = "ADD" Then
