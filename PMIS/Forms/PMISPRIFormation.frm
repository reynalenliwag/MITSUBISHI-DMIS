...
Begin VB.Form frmPMISPRIFormation 
   BorderStyle     =   1  'Fixed Single
   Caption         =   " Parts Requistion Number Formation"
   ClientHeight    =   5400
   ClientLeft      =   1620
   ClientTop       =   5880
   ClientWidth     =   4395
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   675
      Left            =   3660
      MouseIcon       =   "PMISPRIFormation.frx":0000
   ...
   Begin VB.CommandButton cmdOk 
      ...
      Height          =   675
      Left            =   3000
      MouseIcon       =   "PMISPRIFormation.frx":0152
      MousePointer    =   99  'Custom
      Style           =   1  'Graphical
      TabIndex        =   39
   ...
   End
End
Attribute VB_Name = "frmPMISPRIFormation"
...
Sub GetSeries()
    ...
    RSORD_HD.Open "select is_series from PMIS_vw_PRS where [TYPE] = 'P' AND sales_origin = '" & lbl2.Caption & "' and SI_TYPE ='" & lbl3.Caption & "' and  PAY_CLASS = '" & lbl4.Caption & "'  order by REPLICATE('0',4 - LEN(IS_SERIES)) + IS_SERIES desc ", gconDMIS
...
Private Sub cmdOk_Click()
    If lbl2.Caption = "" Or lbl3.Caption = "" Or lbl4.Caption = "" Then
        MsgBox "PRS number not completed!", vbInformation
        Exit Sub
    End If
    ...
    Dim RSORD_HD                                       As ADODB.Recordset
    Set RSORD_HD = New ADODB.Recordset
    RSORD_HD.Open "select refpisno,TRANNO from PMIS_vw_PRS where [TYPE] = 'P' AND refpisno = '" & PISNUMBER & "' ", gconDMIS
    If Not RSORD_HD.EOF And Not RSORD_HD.BOF Then
        MsgBox "PRS number already exist in Transaction number : " & Null2String(RSORD_HD!TRANNO)
        Exit Sub
    End If
    ...
    With frmPMISTrans_PrisForms
        ...
        .txtTranDate = Format(dtTranDate, "MM/dd/yyyy")
            If COMPANY_CODE = "DGI" Then
                ...
                End If
            End If
        If Mid(PISNUMBER, 3, 1) = "S" Then
            .cmdunloackDISC.Enabled = False
            .txtDS_Amt1.Text = "0"
            .txtDS1.Text = "0"
            .txtDS_Desc1.Text = ""
        Else
            .cmdunloackDISC.Enabled = True
        End If
    End With
