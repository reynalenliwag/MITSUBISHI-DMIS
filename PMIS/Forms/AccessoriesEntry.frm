...
Begin VB.Form frmPMISAccessoriesEntry 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "New Accessories Data Entry"
   ClientHeight    =   4365
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8970
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AccessoriesEntry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstPartsEntry 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "AccessoriesEntry.frx":08CA
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "AccessoriesEntry.frx":0A2C
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":0B7E
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   705
         MouseIcon       =   "AccessoriesEntry.frx":0EDD
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":102F
         Style           =   1  'Graphical
         TabIndex        =   43
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1425
         MouseIcon       =   "AccessoriesEntry.frx":1387
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":14D9
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2130
         MouseIcon       =   "AccessoriesEntry.frx":17D3
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":1925
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2835
         MouseIcon       =   "AccessoriesEntry.frx":1C38
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":1D8A
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "AccessoriesEntry.frx":20E6
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":2238
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4260
         MouseIcon       =   "AccessoriesEntry.frx":2563
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":26B5
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   15
         Width           =   705
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   4965
         MouseIcon       =   "AccessoriesEntry.frx":2A1B
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":2B6D
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   15
         Width           =   705
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "AccessoriesEntry.frx":2ED3
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":3025
         Style           =   1  'Graphical
         TabIndex        =   47
         Top             =   0
         Width           =   705
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   705
         MouseIcon       =   "AccessoriesEntry.frx":3375
         MousePointer    =   99  'Custom
         Picture         =   "AccessoriesEntry.frx":34C7
         Style           =   1  'Graphical
         TabIndex        =   46
         Top             =   0
         Width           =   705
   ...
   End
End
Attribute VB_Name = "frmPMISAccessoriesEntry"
