        ...
        Do While Not RSCSMSORD_HIST.EOF
            ...
            If Not RSCSMSDAYTRAN.EOF And Not RSCSMSDAYTRAN.BOF Then
                ...
                If FOR_CAS = True Then
                    If IsNumeric(Mid(RSCSMSORD_HIST!TRANNO, 1, 1)) = False Then
                        xRO_RIV_TRANNO(xRO_RIV_TRANNO_COUNTER) = Null2String(Mid(RSCSMSORD_HIST!TRANNO, 2, Len(RSCSMSORD_HIST!TRANNO)))
                    Else
    ...
    If Not RSCSMSORD_HD.EOF And Not RSCSMSORD_HD.BOF Then
        ...
        Do While Not RSCSMSORD_HD.EOF
            ...
            If Not RSCSMSTDAYTRAN.EOF And Not RSCSMSTDAYTRAN.BOF Then
                ...
                xRO_RIV_TRANNO_COUNTER = xRO_RIV_TRANNO_COUNTER + 1
                If FOR_CAS = True Then
                    If IsNumeric(Mid(Null2String(RSCSMSORD_HD!TRANNO), 1, 1)) = False Then
                        xRO_RIV_TRANNO(xRO_RIV_TRANNO_COUNTER) = Null2String(Mid(RSCSMSORD_HD!TRANNO, 2, Len(RSCSMSORD_HD!TRANNO)))
                    Else
