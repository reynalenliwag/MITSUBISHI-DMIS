...
Public Function SHOW_AUDITDETAILS(labID As Single) As Boolean
    ...
    If COMPANY_CODE = COMPANY_VERSION Then
        Set RSMEMO = gconAudit.Execute("SELECT ACTION_DATE,DESCRIPTION,USERACTION,TRACKING_MEMO,USER_NAME AS USERNAME,TRANNO FROM ALL_VW_AUDIT WHERE ID = " & labID)
    Else
...
Private Sub cmdPrint_Click()
    If wbName.ReadyState = READYSTATE_COMPLETE Then
        wbName.ExecWB OLECMDID_PRINTPREVIEW, OLECMDEXECOPT_DODEFAULT
    End If
End Sub
