...
Dim rsLOGPCNAME                                             As ADODB.Recordset
...
Private Sub cmdOK_Click()
    ...
    With wizVar
        ...
        Set rsLOGPCNAME = New ADODB.Recordset
        rsLOGPCNAME.Open "Select host_name() as pcname", gconACCESS, adOpenKeyset
        ...
        If Not rsALL_vw_RAMS_PAccess.EOF And Not rsALL_vw_RAMS_PAccess.BOF Then
            ...
            Else
                ...
                LOGPCNAME = Null2String(rsLOGPCNAME!PCNAME)
