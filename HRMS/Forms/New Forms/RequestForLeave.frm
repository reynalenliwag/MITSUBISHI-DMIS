...
Begin VB.Form frmHRMS_RequestForLeave 
   ...
   Caption         =   "Request/ Approved Leave & OT"
   ClientHeight    =   6045
   ClientLeft      =   1110
   ClientTop       =   2625
   ClientWidth     =   11190
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   5730
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "RequestForLeave.frx":1391
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":14E3
         Style           =   1  'Graphical
         TabIndex        =   60
         ToolTipText     =   "Unpost this Transaction"
         Top             =   120
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5040
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "RequestForLeave.frx":1828
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":197A
         Style           =   1  'Graphical
         TabIndex        =   59
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   4350
         MouseIcon       =   "RequestForLeave.frx":1C9F
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":1DF1
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   3660
         MouseIcon       =   "RequestForLeave.frx":211C
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":226E
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2970
         MouseIcon       =   "RequestForLeave.frx":25CA
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":271C
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2280
         MouseIcon       =   "RequestForLeave.frx":2A2F
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":2B81
         Style           =   1  'Graphical
         TabIndex        =   46
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1590
         MouseIcon       =   "RequestForLeave.frx":2E7B
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":2FCD
         Style           =   1  'Graphical
         TabIndex        =   45
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   900
         MouseIcon       =   "RequestForLeave.frx":3325
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":3477
         Style           =   1  'Graphical
         TabIndex        =   44
   ...
   Begin VB.PictureBox picSaves 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   2340
         MouseIcon       =   "RequestForLeave.frx":37D6
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":3928
         Style           =   1  'Graphical
         TabIndex        =   41
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   1650
         MouseIcon       =   "RequestForLeave.frx":3C66
         MousePointer    =   99  'Custom
         Picture         =   "RequestForLeave.frx":3DB8
         Style           =   1  'Graphical
         TabIndex        =   42
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin RichTextLib.RichTextBox txtReason 
            ...
            _ExtentY        =   6271
            _Version        =   393217
            TextRTF         =   $"RequestForLeave.frx":4108
   ...
   Begin VB.PictureBox picStatus1 
      ...
      Begin VB.PictureBox picML 
         ...
         Begin VB.ComboBox cboML 
            Height          =   345
            ItemData        =   "RequestForLeave.frx":4189
            Left            =   30
            List            =   "RequestForLeave.frx":4193
            TabIndex        =   64
            Top             =   270
            Width           =   4095
         End
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.CommandButton cmdStatusCancel 
            ...
            Height          =   795
            Left            =   720
            MouseIcon       =   "RequestForLeave.frx":41A9
            MousePointer    =   99  'Custom
            Picture         =   "RequestForLeave.frx":42FB
            Style           =   1  'Graphical
            TabIndex        =   67
            ToolTipText     =   "Cancel"
            Top             =   30
         ...
         Begin VB.CommandButton cmdStatusOK 
            ...
            Height          =   795
            Left            =   30
            MouseIcon       =   "RequestForLeave.frx":4639
            MousePointer    =   99  'Custom
            Picture         =   "RequestForLeave.frx":478B
            Style           =   1  'Graphical
            TabIndex        =   66
            ToolTipText     =   "Save this Record"
            Top             =   30
...
Function GetDayNo(YY As String) As String
    ...
    If Not (rsDAYSNO.BOF And rsDAYSNO.EOF) Then
        xdays = NumericVal(Trim(rsDAYSNO!DAYS_NO))
    End If
...
'    Set rsot = Nothing
    ...
    Combo_Loadval cboApprovedBy, gconDMIS.Execute("SELECT LASTNAME + ', ' + FIRSTNAME  FROM HRMS_EMPINFO WHERE ACTIVEINACTIVE = 'A' ORDER BY LASTNAME")
    On Error Resume Next
    'cboApprovedBy.Text = "Nicdao, Angelica"
    cboApprovedBy.ListIndex = 0
    Set rsot = Nothing
...
'
        ...
        txtNotes.Text = Null2String(rsRequest!NOTES)
...
Private Sub cmdAdd_Click()
    ...
    'cboOvertime.Text = "MATERNITY LEAVE"
End Sub
...
Private Sub cmdSave_Click()
  ...
  If optLeave.Value = True Then
    Set checkrange = gconDMIS.Execute("select leave_code from hrms_leavemaster where leave_desc = '" & Trim(cboLeaveType.Text) & "'")
      ...
      If CHECK = True Then
            Msg = "You Cannot Continue! " & UCase(xNAME) & vbCrLf
            Msg = Msg & "Have Only " & xAVE & " of Maximum " & cboLeaveType & vbCrLf
            Msg = Msg & "Exceed Limit!"
   ...
   If cboCutOff.Text = "2nd Cut-Off" Then vCUTOFF = 2
    ...
    If optLeave.Value = True Then
        ...
        VREQCODE = N2Str2Null(GETTYPE(cboLeaveType))
...
Function GETTYPE(XDESC As String) As String
    Dim sqltxt As String
...
Function GotValidate(XXX As String, EMP As String) As Boolean
    ...
    var1 = 0: var2 = 0
    xdatediff = (DateDiff("D", dtFromDate, dtToDate) + 1) - SEARCHSUNDAY(dtFromDate, dtToDate) - SEARCHHOLIDAY(dtFromDate, dtToDate) - SEARCHSATURDAY(dtFromDate, dtToDate)
...
Private Sub cmdStatusOK_Click()
    ...
    If STATUSX = "A" Then
        ...
        gconDMIS.Execute ("UPDATE HRMS_REQUESTLEAVE_OT SET " & _
            " DTE_ACTION = " & vDTE_APPROVED & _
            ", STATUS = 'A' " & _
            ", APPROVEDBY = " & vAPPROVEDBY & _
            ", NOTES = " & vNotes & _
            ", ML_TYPE = " & N2Str2Null(cboML) & _
            " where id = " & LABID)
        Call rsrefresh
        rsRequest.Find ("REQNO='" & labREQNO & "'")
        Call StoreMemVars
...
'    Next
    ...
    yType = Null2String(rsGetType!reqcode)
    yUsed = GetUsed
