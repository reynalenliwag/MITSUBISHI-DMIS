...
'    SERVERNAME = "SERVER\MITSU"
'    SQLSERVERNAME = "SERVER\MITSU"
...
End Sub
'updated by: IEBV
'description: to add columns needed in VAT EXEMPT FEAtures
Sub ADDVATABLECOL()
Dim sqlcommand                              As String

sqlcommand = "IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='CSMS_REPOR' AND COLUMN_NAME='VAT_EXEMPT1') " & vbCrLf & " " & _
             " ALTER TABLE CSMS_REPOR" & vbCrLf & " " & _
             " ADD VAT_EXEMPT1 CHAR(1) DEFAULT '0' "
