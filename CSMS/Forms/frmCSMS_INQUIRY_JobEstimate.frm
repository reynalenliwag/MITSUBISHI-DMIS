...
Begin VB.Form frmCSMS_INQUIRY_JobEstimate 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         EndProperty
         TabCaption(0)   =   "JOBS"
         TabPicture(0)   =   "frmCSMS_INQUIRY_JobEstimate.frx":1082
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "lsvJobs"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "PARTS"
         TabPicture(1)   =   "frmCSMS_INQUIRY_JobEstimate.frx":109E
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "lsvParts"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "MATERIALS"
         TabPicture(2)   =   "frmCSMS_INQUIRY_JobEstimate.frx":10BA
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "lsvMat"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "ACCESSORIES"
         TabPicture(3)   =   "frmCSMS_INQUIRY_JobEstimate.frx":10D6
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   795
      Left            =   7740
      MouseIcon       =   "frmCSMS_INQUIRY_JobEstimate.frx":10F2
      MousePointer    =   99  'Custom
      Picture         =   "frmCSMS_INQUIRY_JobEstimate.frx":1244
      Style           =   1  'Graphical
      TabIndex        =   21
