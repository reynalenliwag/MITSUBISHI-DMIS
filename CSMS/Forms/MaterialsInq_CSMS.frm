...
Begin VB.Form frmPMISMaterialsInq_CSMS 
   ...
   ClientWidth     =   8925
   ForeColor       =   &H00DEDFDE&
   Icon            =   "MaterialsInq_CSMS.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   5100
         MouseIcon       =   "MaterialsInq_CSMS.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   56
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4380
         MouseIcon       =   "MaterialsInq_CSMS.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3660
         MouseIcon       =   "MaterialsInq_CSMS.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   58
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2940
         MouseIcon       =   "MaterialsInq_CSMS.frx":16B7
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":1809
         Style           =   1  'Graphical
         TabIndex        =   59
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2220
         MouseIcon       =   "MaterialsInq_CSMS.frx":1B65
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":1CB7
         Style           =   1  'Graphical
         TabIndex        =   60
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1500
         MouseIcon       =   "MaterialsInq_CSMS.frx":1FCA
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":211C
         Style           =   1  'Graphical
         TabIndex        =   61
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "MaterialsInq_CSMS.frx":2416
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":2568
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MaterialsInq_CSMS.frx":28C0
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":2A12
         Style           =   1  'Graphical
         TabIndex        =   63
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstParts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "MaterialsInq_CSMS.frx":2D71
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "MaterialsInq_CSMS.frx":2ED3
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":3025
         Style           =   1  'Graphical
         TabIndex        =   65
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "MaterialsInq_CSMS.frx":3363
         MousePointer    =   99  'Custom
         Picture         =   "MaterialsInq_CSMS.frx":34B5
         Style           =   1  'Graphical
         TabIndex        =   66
   ...
   End
End
Attribute VB_Name = "frmPMISMaterialsInq_CSMS"
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmPMISMaterialsInq_CSMS = Nothing
    UnloadForm Me
End Sub
