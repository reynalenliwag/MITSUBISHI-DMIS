...
Begin VB.Form frmCSMS_SATRAIN 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Service Advisor Training/Seminar Information"
   ClientHeight    =   5400
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9150
   Icon            =   "frmCSMS_TRAIN.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox picture1 
      ...
      Begin VB.CommandButton cmdexit 
         ...
         Height          =   765
         Left            =   2070
         MouseIcon       =   "frmCSMS_TRAIN.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TRAIN.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmddelete 
         ...
         Height          =   765
         Left            =   1380
         MouseIcon       =   "frmCSMS_TRAIN.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TRAIN.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdedit 
         ...
         Height          =   765
         Left            =   690
         MouseIcon       =   "frmCSMS_TRAIN.frx":11FF
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TRAIN.frx":1351
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdadd 
         ...
         Height          =   765
         Left            =   0
         MouseIcon       =   "frmCSMS_TRAIN.frx":16AD
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TRAIN.frx":17FF
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin VB.PictureBox picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   765
         Left            =   0
         MouseIcon       =   "frmCSMS_TRAIN.frx":1B12
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TRAIN.frx":1C64
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   765
         Left            =   690
         MouseIcon       =   "frmCSMS_TRAIN.frx":1FB4
         MousePointer    =   99  'Custom
         Picture         =   "frmCSMS_TRAIN.frx":2106
         Style           =   1  'Graphical
         TabIndex        =   10
   ...
   End
End
Attribute VB_Name = "frmCSMS_SATRAIN"
...
Private Sub cmdSave_Click()
    ...
    If ADD_EDIT = "ADD" Then
        ...
        'NEW LOG AUDIT-----------------------------------------------------
        'Call LogAudit("A", "SERVICE ADVISER TRAINING ATTENDED", vTRAIN)
