...
Begin VB.Form frmMainMenu 
   ...
   Begin XtremeSuiteControls.TabControl TabControl1 
      ...
      Begin XtremeSuiteControls.TabControl TabControl2 
         ...
         Item(1).Control(16)=   "Label1(1)"
         Item(1).Control(17)=   "cmdinvoicelist"
         Item(1).Control(18)=   "Label1(3)"
         Item(1).Control(19)=   "cmdWorkInProgressSublet"
         ...
         Begin VB.CommandButton cmdWorkInProgressSublet 
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.CommandButton cmdReport_UnitsReceivedWeeklyPerformance 
            ...
            Height          =   735
            Left            =   -69670
            MouseIcon       =   "frmCSMSMainMenu.frx":3C389
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":3C4DB
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmdReport_AfterSales 
            ...
            Height          =   735
            Left            =   -59980
            MouseIcon       =   "frmCSMSMainMenu.frx":3D55D
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":3D6AF
            Style           =   1  'Graphical
            TabIndex        =   11
         ...
         Begin VB.CommandButton Command9 
            ...
            Height          =   735
            Left            =   330
            MouseIcon       =   "frmCSMSMainMenu.frx":43929
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":43A7B
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmdEstimatedPMS 
            ...
            Height          =   735
            Left            =   9090
            MouseIcon       =   "frmCSMSMainMenu.frx":44AFD
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":44C4F
            TabIndex        =   4
            Tag             =   "1150"
         ...
         Begin VB.CommandButton cmdSummary 
            ...
            Height          =   735
            Left            =   9090
            MouseIcon       =   "frmCSMSMainMenu.frx":456FD
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":4584F
            TabIndex        =   3
      ...
      Begin XtremeSuiteControls.TabControl TabControl3 
         ...
         Begin VB.CommandButton Command8 
            ...
            Height          =   795
            Left            =   -69730
            MouseIcon       =   "frmCSMSMainMenu.frx":4DE15
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":4DF67
            Style           =   1  'Graphical
            TabIndex        =   54
         ...
         Begin VB.CommandButton Command7 
            ...
            Height          =   795
            Left            =   -69730
            MouseIcon       =   "frmCSMSMainMenu.frx":4EFE9
            MousePointer    =   99  'Custom
            Picture         =   "frmCSMSMainMenu.frx":4F13B
            Style           =   1  'Graphical
            TabIndex        =   53
...
Private Sub cmdWorkInProgressSublet_Click()
    If Module_Access(LOGID, "WORKING IN PROGRESS SUBLET", "REPORTS") = False Then Exit Sub
    frmCSMSWorkInProgressSublet.Show
    frmCSMSWorkInProgressSublet.ZOrder 0
End Sub
...
Private Sub Form_Load()
    ...
    cmdReport_HyundaiDealerMonthlyPerformance.Visible = False
    Label41.Visible = False
    cmdReport_UnitsReceivedWeeklyPerformance.Visible = False
    Label43.Visible = False
    cmdReport_ActualManning.Visible = False
    Label39.Visible = False
    cmdReport_WorkshopSalesWeeklyPerformance.Visible = False
    Label42.Visible = False
    Command6.Visible = False 'Schedule of Monthly Performance Report
    Label17(1).Visible = False
    Command7.Visible = False 'Workshop Bay Monitoring
    Label55.Visible = False
    Command8.Visible = False  'Workshop Bay Masterfile
    Label56.Visible = False
    Command15.Visible = False  'Loyalty File Generation
