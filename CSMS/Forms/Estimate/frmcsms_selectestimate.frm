...
Begin VB.Form frmcsms_selectestimate 
   ...
   ClientTop       =   330
   ClientWidth     =   7680
   Icon            =   "frmcsms_selectestimate.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5865
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdunloackFR 
         ...
         Height          =   375
         Left            =   2970
         Picture         =   "frmcsms_selectestimate.frx":1082
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   1980
         Width           =   405
      ...
      Begin VB.TextBox txtNote 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   15
         Text            =   "frmcsms_selectestimate.frx":160C
         Top             =   2880
         Width           =   5655
      End
      ...
      Begin VB.ComboBox cboBP_TYPE 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmcsms_selectestimate.frx":1612
         Left            =   2700
         List            =   "frmcsms_selectestimate.frx":161C
         Sorted          =   -1  'True
      ...
      Begin VB.CommandButton cmdunloackSR 
         ...
         Height          =   345
         Left            =   6240
         Picture         =   "frmcsms_selectestimate.frx":162E
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   2040
         Width           =   405
   ...
   Begin VB.CommandButton cmdOk 
      ...
      Height          =   855
      Left            =   6120
      MouseIcon       =   "frmcsms_selectestimate.frx":1BB8
      MousePointer    =   99  'Custom
      Picture         =   "frmcsms_selectestimate.frx":1D0A
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   855
      Left            =   6840
      MouseIcon       =   "frmcsms_selectestimate.frx":1FA5
      MousePointer    =   99  'Custom
      Picture         =   "frmcsms_selectestimate.frx":20F7
      Style           =   1  'Graphical
      TabIndex        =   1
      ToolTipText     =   "Cancel"
      Top             =   4890
