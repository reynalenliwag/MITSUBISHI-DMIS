...
Begin VB.Form frmPMISMAT_MRISForms 
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "MAT_MRISForm.frx":3FC6
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":4118
         Style           =   1  'Graphical
         TabIndex        =   86
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "MAT_MRISForm.frx":4456
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":45A8
         Style           =   1  'Graphical
         TabIndex        =   87
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "MAT_MRISForm.frx":4914
         NumItems        =   2
   ...
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "MAT_MRISForm.frx":77CE
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":7920
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   1575
         Width           =   855
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "MAT_MRISForm.frx":7C86
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":7DD8
         Style           =   1  'Graphical
         TabIndex        =   91
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "MAT_MRISForm.frx":8116
         MousePointer    =   99  'Custom
         Picture         =   "MAT_MRISForm.frx":8268
         Style           =   1  'Graphical
         TabIndex        =   92
