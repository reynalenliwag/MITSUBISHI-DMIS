VERSION 5.00
Begin VB.Form frmCSMS_AccInquiry 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Checking Accessories Availability"
   ClientHeight    =   6795
   ClientLeft      =   315
   ClientTop       =   330
   ClientWidth     =   10815
   ForeColor       =   &H00DEDFDE&
   Icon            =   "AccessoriesInquiry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Label labNote 
      BackColor       =   &H8000000D&
      BackStyle       =   0  'Transparent
      Caption         =   $"AccessoriesInquiry.frx":030A
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCSMS_AccInquiry"
    ...
    For I = 0 To 14
        If txtPartNo(I).Text <> "" Then
            ...
            If Option1.Value = True Then
                ...
                rsPartMas.Open "select STOCKNO,STOCKDESC,dnp,newno,srp,modelcode,location,invclass,subinvclas,onhand from PMIS_stockMas where ltrim(rtrim(STOCKNO)) = " & N2Str2Null(txtPartNo(I).Text) & " AND TYPE = 'A'", gconDMIS
            ...
            End If
            'NEW LOG AUDIT-----------------------------------------------------
            Call NEW_LogAudit("I", "ACCESSORIES INQUIRY", "", "", "", "ACC NO: " & txtPartNo(I).Text, "", "")
            'NEW LOG AUDIT-----------------------------------------------------
        Else
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            frmALL_AuditInquiry.Caption = "Audit Inquiry (ACCESSORIES INQUIRY)"
            Call frmALL_AuditInquiry.DisplayHistory("", "ACCESSORIES INQUIRY", "PRINTING")
