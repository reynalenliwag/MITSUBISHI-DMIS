...
Function GetSQL() As String
    ...
    'Updated By JJE 08/16/2012 10:07AM
    'Fixing DETCOST and HRSWRK Computation
    SQL = "SELECT RO_NO,INVOICE,NIYM,JOBTYPE,DETCDE,DETDSC," & vbCrLf
    SQL = SQL & "CAST(CASE ROTYPE WHEN 'SR' THEN S_DETCOST" & vbCrLf
    SQL = SQL & "ELSE (CASE WHEN S_DETCOST < 0 THEN 0" & vbCrLf
    SQL = SQL & "ELSE (CASE WHEN ROUND((SALARY * B_HRSWRK),2) <> S_DETCOST THEN SALARY * J_HRSWRK" & vbCrLf
    SQL = SQL & "ELSE S_DETCOST END)END)" & vbCrLf
