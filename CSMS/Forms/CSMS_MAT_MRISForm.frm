...
Begin VB.Form frmPMISMAT_MRISForms 
   ...
   ClientWidth     =   11430
   ForeColor       =   &H00DEDFDE&
   Icon            =   "CSMS_MAT_MRISForm.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7860
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7080
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6300
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   103
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5520
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   104
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4740
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":1B3D
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":1C8F
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3960
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":1FEB
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":213D
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3180
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":2450
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":25A2
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2400
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":28F2
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":2A44
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":2DA2
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":2EF4
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   840
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":31EE
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":3340
         Style           =   1  'Graphical
         TabIndex        =   101
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":3698
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":37EA
         Style           =   1  'Graphical
         TabIndex        =   102
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":3B49
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":3C9B
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":3FC6
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":4118
         Style           =   1  'Graphical
         TabIndex        =   86
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":4456
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":45A8
         Style           =   1  'Graphical
         TabIndex        =   87
   ...
   Begin wizButton.cmd cmdAddTran 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CSMS_MAT_MRISForm.frx":48F8
   End
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":4914
         NumItems        =   2
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "CSMS_MAT_MRISForm.frx":4A76
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -660
   ...
   Begin wizButton.cmd cmdSignatories 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "CSMS_MAT_MRISForm.frx":77B2
   End
   Begin VB.PictureBox fraSignatories 
      ...
      Begin VB.CommandButton cmdPrintRIV 
         ...
         Height          =   645
         Left            =   1125
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":77CE
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":7920
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   1575
         Width           =   855
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":7C86
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":7DD8
         Style           =   1  'Graphical
         TabIndex        =   91
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "CSMS_MAT_MRISForm.frx":8116
         MousePointer    =   99  'Custom
         Picture         =   "CSMS_MAT_MRISForm.frx":8268
         Style           =   1  'Graphical
         TabIndex        =   92
...
Sub FillGrid()
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select Tranno,tranno from PMIS_vw_PRS where trantype = '" & "MRS" & "' order by Tranno asc")
...
Sub FillSearchGrid(XXX As String)
    ...
    Set rsOrd_Hd = gconDMIS.Execute("select tranno, tranno from PMIS_vw_PRS WHERE TYPE = 'M' and trantype = '" & "MRS" & "' and tranno like '" & XXX & "%'")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Sub FillGrid2()
    ...
    lstOrd_Hd.Enabled = False
    Set rsOrd_Hd = New ADODB.Recordset
    Set rsOrd_Hd = gconDMIS.Execute("select rono,tranno from PMIS_vw_PRS WHERE TYPE = 'M' and trantype = '" & "MRS" & "' and rono is not null order by tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Sub FillSearchGrid2(XXX As String)
    ...
    Set rsOrd_Hd = New ADODB.Recordset
    XXX = Repleys(LTrim(RTrim(XXX)))
    Set rsOrd_Hd = gconDMIS.Execute("select Rono, tranno from PMIS_vw_PRS WHERE TYPE = 'M' and trantype = '" & "MRS" & "' and rono like '" & XXX & "%' order by tranno asc")
    If Not (rsOrd_Hd.EOF And rsOrd_Hd.BOF) Then
        lstOrd_Hd.Enabled = True
        Listview_Loadval Me.lstOrd_Hd.ListItems, rsOrd_Hd
        lstOrd_Hd.Refresh
...
Private Sub cmdCancelCO_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Cancel this Transaction?", "Cancel Transaction") = True Then
            ...
            Do While Not rsTdaytranDup.EOF
                ...
                If Not rsPartmasDup.EOF And Not rsPartmasDup.BOF Then
                    If Null2String(rsOrd_Hd!Status) = "P" Then
                        ...
                        End If
                        'NEW LOG AUDIT--------------------------------------------------------------
                        Call NEW_LogAudit("E", "MATERIALS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_STOCKMAS", "DETAILS", "M", "TYPE"), "", "TRAN NO: " & txtTranNo & " - UNPOSTED", "MRS", "")
                        'NEW LOG AUDIT--------------------------------------------------------------
                    End If
                    ...
                    gconDMIS.Execute SQL_STATEMENT
                    'NEW LOG AUDIT-------------------------------------------------------------------------
                    Call NEW_LogAudit("C", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo, "MRS", "")
                    'NEW LOG AUDIT-------------------------------------------------------------------------
                End If
        ...
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("C", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo, "", "")
        'NEW LOG AUDIT-----------------------------------------------------
...
Private Sub cmdPost_Click()
    ...
    If MsgQuestionBox("Are you sure you want to Post this Transaction?", "Post Transaction") = True Then
            ...
            Do While Not rsTdaytranDup.EOF
                ...
                If Not rsPartmasDup.EOF And Not rsPartmasDup.BOF Then
                    If Null2String(rsOrd_Hd!SALES_ORIGIN) = "W" Then
                        ...
                        gconDMIS.Execute SQL_STATEMENT
                        'NEW LOG AUDIT-------------------------------------------------------------------------
                        Call NEW_LogAudit("E", "MATERIALS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_STOCKMAS", "DETAILS", "M", "TYPE"), "M", "TRAN NO: " & txtTranNo & " - POSTED", "MRS", "")
                        'NEW LOG AUDIT-------------------------------------------------------------------------
                    Else
                        PCurTISSQTY = N2Str2IntZero(rsPartmasDup!S_ONREQUEST) + N2Str2Zero(rsTdaytranDup!tranqty)
                        gconDMIS.Execute "update PMIS_Stockmas set" & _
                                       ...
                                       " WHERE TYPE = 'M' and STOCKNO = " & N2Str2Null(rsTdaytranDup!STOCK_ORD)
                        'NEW LOG AUDIT-------------------------------------------------------------------------
                        Call NEW_LogAudit("E", "MATERIALS MASTER FILE", SQL_STATEMENT, FindTransactionID(N2Str2Null(rsTdaytranDup!STOCK_ORD), "STOCKNO", "PMIS_STOCKMAS", "DETAILS", N2Str2Null("M"), "TYPE"), "M", "TRAN NO: " & txtTranNo & " - POSTED", "MRS", "")
                        'NEW LOG AUDIT-------------------------------------------------------------------------
                    End If
                    SQL_STATEMENT = "update PMIS_vw_PRS_Tran set" & _
                                  " status = 'P'," & _
                    ...
                    gconDMIS.Execute SQL_STATEMENT
                    'NEW LOG AUDIT-------------------------------------------------------------------------
                    Call NEW_LogAudit("PP", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "M", "TRAN NO: " & txtTranNo, "MRS", rsTdaytranDup!ID)
                    'NEW LOG AUDIT-------------------------------------------------------------------------
                End If
                rsTdaytranDup.MoveNext
            Loop
        ...
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("P", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo, "", "")
        'NEW LOG AUDIT-----------------------------------------------------
...
Private Sub cmdPrint_Click()
    ...
    Screen.MousePointer = 11
    rptCustomerOrder.WindowTitle = "MATERIALS REQUISITION SLIP"
    rptCustomerOrder.Formulas(0) = "CompanyName = '" & COMPANY_NAME & "'"
    rptCustomerOrder.Formulas(1) = "CompanyAddress = '" & COMPANY_ADDRESS & "'"
    PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "RequisitionSlip_Materials.rpt", "{PMIS_vw_PRS.TYPE} = 'M' and {PMIS_vw_PRS.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_Connection, 1
...
Private Sub cmdTranDelete_Click()
    ...
    If MsgQuestionBox("Delete This Materials, Are you Sure?", "Delete Materials Entry") = True Then
        ...
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("XX", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, FindTransactionID(txtTranNo, "TRANNO", "PMIS_ORD_HD", "DETAILS", N2Str2Null("MRS"), "TRANTYPE"), "", "MAT CODE: " & cboTranPartNo, "", labDetID.Caption)
        'NEW LOG AUDIT-----------------------------------------------------
    ...
    Set rsTdaytranDup = New ADODB.Recordset
    rsTdaytranDup.Open "select id,itemno from PMIS_vw_PRS_Tran where [TYPE] = 'M' and trantype = " & N2Str2Null("MRS") & " and tranno = " & N2Str2Null(rsOrd_Hd!TRANNO) & " order by itemno asc", gconDMIS
    If Not rsTdaytranDup.EOF And Not rsTdaytranDup.BOF Then
        rsTdaytranDup.MoveFirst
        cnt = 0
        Do While Not rsTdaytranDup.EOF
    ...
    gconDMIS.Execute SQL_STATEMENT
    'NEW LOG AUDIT--------------------------------------------------------------------------
    Call NEW_LogAudit("E", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo, "MRS", "")
    'NEW LOG AUDIT--------------------------------------------------------------------------
...
Private Sub cmdTranSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("AA", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, FindTransactionID(txtTranNo, "TRANNO", "PMIS_ORD_HD", "DETAILS", N2Str2Null("MRS"), "TRANTYPE"), "", "MAT CODE: " & cboTranPartNo, "", labDetID.Caption)
        'NEW LOG AUDIT-----------------------------------------------------
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("EE", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, FindTransactionID(txtTranNo, "TRANNO", "PMIS_ORD_HD", "DETAILS", N2Str2Null("MRS"), "TRANTYPE"), "", "MAT CODE: " & cboTranPartNo, "", labDetID.Caption)
        'NEW LOG AUDIT-----------------------------------------------------
    ...
    gconDMIS.Execute SQL_STATEMENT
    'NEW LOG AUDIT--------------------------------------------------------------------------
    Call NEW_LogAudit("E", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo & " - ADD/EDIT DETAILS", "MRS", "")
    'NEW LOG AUDIT--------------------------------------------------------------------------
...
Private Sub cmdSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("A", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, FindTransactionID(N2Str2Null(txtTranNo), "TRANNO", "PMIS_vw_PRS"), "", "TRAN NO: " & txtTranNo, "", "")
        'NEW LOG AUDIT-----------------------------------------------------
        ShowSuccessFullyAdded
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
        Call NEW_LogAudit("E", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo, "", "")
        'NEW LOG AUDIT-----------------------------------------------------
            ...
            If Picture1.Visible = True Then
                If Null2String(rsOrd_Hd!Status) = "P" Then
                    ...
                    If MsgQuestionBox("Are you sure you want to UnPost this Transaction?", "UnPost Transaction") = True Then
                        ...
                        gconDMIS.Execute SQL_STATEMENT
                        'NEW LOG AUDIT-----------------------------------------------------
                        Call NEW_LogAudit("U", "MATERIALS REQUISITION SLIP", SQL_STATEMENT, labid, "", "TRAN NO: " & txtTranNo, "", "")
                        'NEW LOG AUDIT-----------------------------------------------------
