...
Begin VB.Form frmCSMS_Inquiry_Query 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "CAR SERVICE MANAGEMENT INFORMATION AND OPERATIONS SYSTEM'S QUERY"
   ClientHeight    =   7680
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   12375
   ForeColor       =   &H00DEDFDE&
   Icon            =   "CSMIOSQuery.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdPARTSINQUIRYExit 
      ...
      Height          =   795
      Left            =   11550
      MouseIcon       =   "CSMIOSQuery.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "CSMIOSQuery.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   795
         Left            =   11370
         MouseIcon       =   "CSMIOSQuery.frx":07C2
         MousePointer    =   99  'Custom
         Picture         =   "CSMIOSQuery.frx":0914
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin MSFlexGridLib.MSFlexGrid grdQUERY 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "CSMIOSQuery.frx":0C4F
   End
   ...
   End
End
Attribute VB_Name = "frmCSMS_Inquiry_Query"
...
Sub FillCUSVEHGrid()
    ...
    rsCusVeh.Open "select * from CSMS_CusVeh order by niym asc", gconDMIS
...
Sub FillRECGrid()
    ...
    cleargrid grdQUERY
    If cbo(5).Text = "" Then
        rsREPOR.Open "Select * from CSMS_RepOr where Transtype='R' and order by rep_or asc", gconDMIS
    Else
        rsREPOR.Open "Select * from CSMS_RepOr where Transtype='R' and recd_by = " & GetSACode(cbo(5).Text) & " order by rep_or asc", gconDMIS
    End If
    ...
    If Not rsREPOR.EOF And Not rsREPOR.BOF Then
        ...
        Do While Not rsREPOR.EOF
            kcnt = kcnt + 1
            grdQUERY.AddItem Null2String(rsREPOR!recd_by) & Chr(9) & Null2String(rsREPOR!rep_OR) & Chr(9) & Null2String(rsREPOR!invoice) & Chr(9) & Null2String(rsREPOR!PLATE_NO) & Chr(9) & _
                             Null2String(rsREPOR!ACCT_NO) & Chr(9) & Null2String(rsREPOR!NIYM) & Chr(9) & _
                             Null2String(rsREPOR!MODEL) & Chr(9) & _
                             Null2String(rsREPOR!TERM) & Chr(9) & _
                             Null2String(rsREPOR!km_rdg) & Chr(9) & Null2String(rsREPOR!dte_recd) & Chr(9) & _
                             Null2String(rsREPOR!certific8) & Chr(9) & N2Str2Zero(rsREPOR!amount) & Chr(9) & _
                             N2Str2Zero(rsREPOR!insamt) & Chr(9) & N2Str2Zero(rsREPOR!rovat) & Chr(9) & _
                             N2Str2Zero(rsREPOR!labor) & Chr(9) & N2Str2Zero(rsREPOR!parts) & Chr(9) & _
                             N2Str2Zero(rsREPOR!material) & Chr(9) & N2Str2Zero(rsREPOR!l_disc) & Chr(9) & _
                             N2Str2Zero(rsREPOR!p_disc) & Chr(9) & N2Str2Zero(rsREPOR!m_disc) & Chr(9) & _
                             N2Str2Zero(rsREPOR!wl_amt) & Chr(9) & N2Str2Zero(rsREPOR!wp_amt) & Chr(9) & _
                             N2Str2Zero(rsREPOR!wm_amt) & Chr(9) & N2Str2Zero(rsREPOR!l_taxval) & Chr(9) & _
                             N2Str2Zero(rsREPOR!p_taxval) & Chr(9) & N2Str2Zero(rsREPOR!m_taxval) & Chr(9) & _
                             Null2String(rsREPOR!prin_dte) & Chr(9) & Null2String(rsREPOR!dte_comp) & Chr(9) & _
                             Null2String(rsREPOR!dte_rel) & Chr(9) & N2Str2Zero(rsREPOR!invbal) & Chr(9) & _
                             Null2String(rsREPOR!Status) & Chr(9) & Null2String(rsREPOR!usercde) & Chr(9) & rsREPOR!ID
            rsREPOR.MoveNext
            labTotalRO.Caption = "Total RO " & Format(kcnt, "###,###,###,##0")
            If kcnt = 1 Then grdQUERY.RemoveItem 1
            DoEvents
        Loop
        Screen.MousePointer = 0
...
Sub FillReporGrid()
    ...
    If Not rsREPOR.EOF And Not rsREPOR.BOF Then
        ...
        Do While Not rsREPOR.EOF
            kcnt = kcnt + 1
            grdQUERY.AddItem Null2String(rsREPOR!rep_OR) & Chr(9) & Null2String(rsREPOR!invoice) & Chr(9) & Null2String(rsREPOR!PLATE_NO) & Chr(9) & _
                             Null2String(rsREPOR!ACCT_NO) & Chr(9) & Null2String(rsREPOR!NIYM) & Chr(9) & _
                             Null2String(rsREPOR!MODEL) & Chr(9) & _
                             Null2String(rsREPOR!TERM) & Chr(9) & Null2String(rsREPOR!recd_by) & Chr(9) & _
                             Null2String(rsREPOR!km_rdg) & Chr(9) & Null2String(rsREPOR!dte_recd) & Chr(9) & _
                             Null2String(rsREPOR!certific8) & Chr(9) & N2Str2Zero(rsREPOR!amount) & Chr(9) & _
                             N2Str2Zero(rsREPOR!insamt) & Chr(9) & N2Str2Zero(rsREPOR!rovat) & Chr(9) & _
                             N2Str2Zero(rsREPOR!labor) & Chr(9) & N2Str2Zero(rsREPOR!parts) & Chr(9) & _
...
Sub initCUSVEHGrid()
    ...
    With grdQUERY
        .Row = 0
        .FormatString = "Customer Code | Customer Name                                  | Plate No. | Conduction Sticker | Color Code | " & _
                        "Model            | Engine     | Product No. | Serial No. | " & _
                        "TIN Number | Date Sold | Warranty Certificate | Date Delivered | ID"
        .FixedCols = 0
        For k = 15 To 32
            .ColWidth(k) = 1
        Next
...
Sub initRECGrid()
    ...
    With grdQUERY
        .Row = 0
        .FormatString = "Service Advisor | RO Number | Invoice No. | Plate No. | Accnt. No | Customer Name                                  | " & _
                        "Model            | Term | KM Reading | Date Recd. | " & _
                        "Certificat | Invoice Amt. | Ins. Amt. | RO Vat    | Labor       | " & _
                        "Parts       | Material     | L. Discount | P. Discount | M. Discount | " & _
                        "L. Warranty | P. Warranty | M. Warranty | Labor Tax | Parts Tax | " & _
                        "Material Tax | Print Date | Date Completed | Date Released | Invoice Bal. | " & _
                        "Status | User Code | ID"
        .FixedCols = 0
    End With
End Sub
...
Sub initReporGrid()
    ...
    With grdQUERY
        .Row = 0
        .FormatString = "RO Number | Invoice No. | Plate No. | Accnt. No | Customer Name                                  | " & _
                        "Model            | Term | Recd. By | KM Reading | Date Recd. | " & _
                        "Certificat | Invoice Amt. | Ins. Amt. | RO Vat    | Labor       | " & _
                        "Parts       | Material     | L. Discount | P. Discount | M. Discount | " & _
                        "L. Warranty | P. Warranty | M. Warranty | Labor Tax | Parts Tax | " & _
                        "Material Tax | Print Date | Date Completed | Date Released | Invoice Bal. "
        .FixedCols = 3
    End With
End Sub
...
Sub initRoDetGrid()
    ...
    With grdQUERY2
        .Row = 0
        .FormatString = "RO Number | Level | Line No. | Det. Code | Description                           | " & _
                        "Det. Volume | Det. Price | Det. Amount | Code | Tax Rate | " & _
                        "Disc. Rate | Tax Value | Disc. Value | PO Code "
        .FixedCols = 2
    End With
End Sub
...
Sub VcmdRODetails()
    ...
    If fild <> "" Then
        ...
        If Not rsRO_DET.EOF And Not rsRO_DET.BOF Then
            ...
            Do While Not rsRO_DET.EOF
                grdQUERY2.AddItem Null2String(rsRO_DET!rep_OR) & Chr(9) & _
                                  Null2String(rsRO_DET!LIVIL) & Chr(9) & _
                                  Null2String(rsRO_DET!LINE_NO) & Chr(9) & _
                                  Null2String(rsRO_DET!DETCDE) & Chr(9) & _
                                  Null2String(rsRO_DET!DETDSC) & Chr(9) & _
                                  ...
                                  N2Str2Zero(rsRO_DET!disval) & Chr(9) & _
                                  Null2String(rsRO_DET!pocode)
                YzaCnt = YzaCnt + 1
                rsRO_DET.MoveNext
            Loop
        End If
    ...
    Else
        MsgSpeechBox "No Entry on Repor"
        Exit Sub
    End If
End Sub
...
Private Sub cmdSAExit_Click()
    On Error Resume Next
    Unload Me
End Sub

Private Sub cmdSearchSA_Click()
    VcmdSearchSA
End Sub
...
Private Sub Command1_Click()
    ...
    If SearchBy = "RO" Then
        ...
        Me.Caption = "INQUIRY BY REPAIR ORDER"
        rsREPOR.Open "select * from CSMS_RepOr where Transtype='R' " & SearchString1 & " order by rep_or asc", gconDMIS
        If Not rsREPOR.EOF And Not rsREPOR.BOF Then
            FillReporGrid
        End If
    End If
    If SearchBy = "INV" Then
        Me.Caption = "INQUIRY BY INVOICE NUMBER"
        Set rsREPOR = New ADODB.Recordset
        rsREPOR.Open "select * from CSMS_RepOr where Transtype='R'  " & SearchString1 & " order by invoice asc", gconDMIS
        If Not rsREPOR.EOF And Not rsREPOR.BOF Then
            FillReporGrid
        End If
    End If
    If SearchBy = "PLN" Then
        Me.Caption = "INQUIRY BY PLATE NUMBER"
        Set rsREPOR = New ADODB.Recordset
        rsREPOR.Open "select * from CSMS_RepOr where Transtype='R'  " & SearchString1 & " order by Plate_No asc", gconDMIS
        If Not rsREPOR.EOF And Not rsREPOR.BOF Then
            FillReporGrid
        End If
    End If
    If SearchBy = "SA" Then
        Me.Caption = "INQUIRY SERVICE ADVISOR WORK DETAILS"
    ...
    End If
    LogAudit "I", "INQUIRY QUERY", SearchString1
End Sub
...
Private Sub Form_Load()
    ...
    ElseIf SearchBy = "RO" Then
        initReporGrid
        Set rsREPOR = New ADODB.Recordset
        Me.Caption = "INQUIRY BY REPAIR ORDER"
        rsREPOR.Open "select * from CSMS_RepOr where Transtype='R' order by rep_or asc", gconDMIS
        If Not rsREPOR.EOF And Not rsREPOR.BOF Then
            FillReporGrid
        End If

    ElseIf SearchBy = "INV" Then
        initReporGrid
        Me.Caption = "INQUIRY BY INVOICE NUMBER"
        Set rsREPOR = New ADODB.Recordset
        rsREPOR.Open "select * from CSMS_RepOr where Transtype='R'  order by invoice asc", gconDMIS
        If Not rsREPOR.EOF And Not rsREPOR.BOF Then
            FillReporGrid
        End If

    ElseIf SearchBy = "PLN" Then
        initReporGrid
        Me.Caption = "INQUIRY BY PLATE NUMBER"
        Set rsREPOR = New ADODB.Recordset
        rsREPOR.Open "select * from CSMS_RepOr where Transtype='R'  order by Plate_No asc", gconDMIS
        If Not rsREPOR.EOF And Not rsREPOR.BOF Then
            FillReporGrid
        End If

    ElseIf SearchBy = "SA" Then
        Me.Caption = "INQUIRY SERVICE ADVISOR WORK DETAILS"
        initRECGrid
        cleargrid grdQUERY
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCSMS_Inquiry_Query = Nothing
End Sub
...
Private Sub grdQUERY_RowColChange()
    VcmdRODetails
    grdQUERY.SetFocus
    grdQUERY.ColSel = grdQUERY.Cols - 1
End Sub
