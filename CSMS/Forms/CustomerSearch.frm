...
Begin VB.Form frmCustomerSearch 
   ...
   Begin VB.CommandButton cmdAdd 
      ...
      Height          =   720
      Left            =   60
      MouseIcon       =   "CustomerSearch.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "CustomerSearch.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin MSComctlLib.ListView lstCustomer 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "CustomerSearch.frx":076F
      NumItems        =   10
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   735
      Left            =   6480
      MouseIcon       =   "CustomerSearch.frx":08D1
      MousePointer    =   99  'Custom
      Picture         =   "CustomerSearch.frx":0A23
      Style           =   1  'Graphical
      TabIndex        =   10
      ToolTipText     =   "Cancel"
      Top             =   5700
   ...
   Begin VB.CommandButton cmdSelect 
      ...
      Height          =   735
      Left            =   5760
      MouseIcon       =   "CustomerSearch.frx":0D61
      MousePointer    =   99  'Custom
      Picture         =   "CustomerSearch.frx":0EB3
      Style           =   1  'Graphical
      TabIndex        =   9
...
Sub FillGrid()
    ...
    Set rsCustomer = New ADODB.Recordset
    Set rsCustomer = gconDMIS.Execute("select CusCde,LastName,FirstName,AcctName,Mobile,HomePhone,Fax,CustomerAdd,City,ProvincialAdd from ALL_Customer order by lastname asc")
...
Private Sub cmdSelect_Click()
    If Trim(txtcode.Text) <> "" Then
        With frmCSMSEstimateEntry
            ...
            .txtAcct_No.Text = txtcode.Text
            .txtNiym.Text = UCase(txtName.Text)
            .txtAddress.Text = SetAddress(txtcode.Text)
