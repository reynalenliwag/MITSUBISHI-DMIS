...
Begin VB.Form frmCSMSDataEntry 
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.PictureBox picvoid 
         ...
         Visible         =   0   'False
         Width           =   5100
         Begin VB.TextBox txtvoid_reason 
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   9
               Charset         =   0
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TabDlg.SSTab SSTab1x 
            ...
            TabPicture(0)   =   "DataEntry.frx":10AA
            Tab(0).ControlEnabled=   0   'False
            Tab(0).ControlCount=   0
            TabCaption(1)   =   " F3-Jobs"
            TabPicture(1)   =   "DataEntry.frx":13CC
            Tab(1).ControlEnabled=   0   'False
            Tab(1).ControlCount=   0
            TabCaption(2)   =   " F4-Parts"
            TabPicture(2)   =   "DataEntry.frx":16E6
            Tab(2).ControlEnabled=   0   'False
            Tab(2).ControlCount=   0
            TabCaption(3)   =   " F5-Materials"
            TabPicture(3)   =   "DataEntry.frx":1A00
            Tab(3).ControlEnabled=   0   'False
            Tab(3).ControlCount=   0
            TabCaption(4)   =   " F6-Accessories"
            TabPicture(4)   =   "DataEntry.frx":1D1A
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.CommandButton cmdExit 
            ...
            Height          =   795
            Left            =   4140
            MouseIcon       =   "DataEntry.frx":4D6E
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":4EC0
            Style           =   1  'Graphical
            TabIndex        =   223
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   795
            Left            =   3450
            MouseIcon       =   "DataEntry.frx":5226
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":5378
            Style           =   1  'Graphical
            TabIndex        =   224
         ...
         Begin VB.CommandButton cmdReleaseRO 
            ...
            Height          =   795
            Left            =   2760
            MouseIcon       =   "DataEntry.frx":56DE
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":5830
            Style           =   1  'Graphical
            TabIndex        =   225
         ...
         Begin VB.CommandButton cmdEdit 
            ...
            Height          =   795
            Left            =   2070
            MouseIcon       =   "DataEntry.frx":7FD2
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":8124
            Style           =   1  'Graphical
            TabIndex        =   226
         ...
         Begin VB.CommandButton cmdFind 
            ...
            Height          =   795
            Left            =   1380
            MouseIcon       =   "DataEntry.frx":8480
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":85D2
            Style           =   1  'Graphical
            TabIndex        =   227
      ...
      Begin VB.PictureBox Picture5 
         ...
         Top             =   3480
         Width           =   2685
         Begin VB.CommandButton CmdVatexempt 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Vat Exempt"
            BeginProperty Font 
               Name            =   "Arial"
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   795
            Left            =   870
            MouseIcon       =   "DataEntry.frx":981E
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":9970
            Style           =   1  'Graphical
            TabIndex        =   229
            ToolTipText     =   "Cancel"
            Top             =   0
         ...
         Begin VB.CommandButton cmdSave 
            ...
            Height          =   795
            Left            =   180
            MouseIcon       =   "DataEntry.frx":9CAE
            MousePointer    =   99  'Custom
            Picture         =   "DataEntry.frx":9E00
            Style           =   1  'Graphical
            TabIndex        =   230
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox Cbo_Rotype 
            ...
            Width           =   1095
         End
         Begin Crystal.CrystalReport rptgatepass 
            Left            =   120
            Top             =   240
            _ExtentX        =   741
            _ExtentY        =   741
      ...
      Begin VB.PictureBox cmdAddMaterials 
         ...
         Begin VB.Frame fraAddMaterials 
            ...
            Begin VB.ComboBox Combo1 
               ...
               ForeColor       =   &H00000000&
               Height          =   330
               ItemData        =   "DataEntry.frx":16FF6
               Left            =   1740
               List            =   "DataEntry.frx":16FF8
               Sorted          =   -1  'True
               Style           =   2  'Dropdown List
               TabIndex        =   316
               Top             =   90
      ...
      Begin VB.PictureBox cmdFollowUp 
         ...
         Visible         =   0   'False
         Width           =   6135
         Begin VB.TextBox txtCALLED_RESULT 
            Height          =   2175
            Left            =   120
            MultiLine       =   -1  'True
            TabIndex        =   324
            Text            =   "DataEntry.frx":1B4DA
            Top             =   600
            Width           =   5895
         End
   ...
   Begin VB.PictureBox picSearch 
      ...
      Begin VB.CommandButton cmdSelect 
         ...
         Height          =   885
         Left            =   12180
         MouseIcon       =   "DataEntry.frx":1B593
         MousePointer    =   99  'Custom
         Picture         =   "DataEntry.frx":1B6E5
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   825
         Left            =   90
         MouseIcon       =   "DataEntry.frx":1BA21
         MousePointer    =   99  'Custom
         Picture         =   "DataEntry.frx":1BB73
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Cancel"
         Top             =   7800
...
Dim VOIDTRUE                                            As Boolean
Dim go                                                  As Boolean
Dim XJOBCOST                                            As Double
Dim gointernal                                          As Boolean
Dim gointernal1                                         As Boolean
Dim gointernaldate                                      As String
Dim PDIRO                                               As Boolean
Dim NoChgRO                                             As Boolean
Dim IntRO                                               As Boolean
Dim gosave                                              As Boolean
...
Function CheckORNum(yyy As String, XXX As String) As String
    Dim rsCMIS_OFF_DT                                  As New ADODB.Recordset
    Set rsCMIS_OFF_DT = gconDMIS.Execute("Select * from CMIS_OFF_DT WHERE TRANTYPE = 'SI' AND INVOICENO = '" & yyy & "' AND CUSCDE = '" & XXX & "' AND (CANCEL = 0 OR CANCEL IS NULL) AND LEFT(OR_NUM,3) <> 'SOA'")
...
Function StoreJobsEntry(ByVal ID As Variant)
    ...
    Set rsRO_DET = gconDMIS.Execute("select QUICK_SERVICE,JOBTYPE,TECHCODE,id,LINE_NO,detcde,detdsc,technician,HRSWRK,pocode,wcode,det_amt,discrate,rep_or,livil,detail,discount_2,code,detcost from CSMS_RO_Det where id = " & ID)
    If Not rsRO_DET.EOF And Not rsRO_DET.BOF Then
        ...
        XJOBCOST = N2Str2Zero(rsRO_DET!DetCost)
        ...
        End If
    End If
    If Module_Access(LOGID, "INPUT DISCOUNT", "SYSTEM") = False Then
        Frame4.Enabled = False
    Else
        If Null2String(rsRO_DET!wCode) = "C" Or Null2String(rsRO_DET!wCode) = "S" Then Exit Function
        Frame4.Enabled = True
    End If
End Function
...
Function StoreMatEntry(ByVal ID As Variant)
    Set rsRO_DET = New ADODB.Recordset
    Set rsRO_DET = gconDMIS.Execute("select JOBTYPE,rotype,detail,id,LINE_NO,detcde,detdsc,detvol,detprc,det_amt,wcode,discrate,pocode,discount_2,code,detail from CSMS_RO_Det where id = " & ID)
    If Not rsRO_DET.EOF And Not rsRO_DET.BOF Then
        labDetID.Caption = rsRO_DET!ID
        txtMatLineNo.Text = Null2String(rsRO_DET!LINE_NO)
        cboMatCode.Text = Null2String(rsRO_DET!DETCDE)
        cboMaterial.Text = Null2String(rsRO_DET!DETDSC)
        If (cboMaterial.Text = "MISCELLANEOUS CHARGES" Or Null2String(rsRO_DET!DETCDE) = "SRMATERIALS") And Null2String(rsRO_DET!ROTYPE) = "SR" Then cboMaterial.Text = Null2String(rsRO_DET!DETDSC): txtdetail.Text = UCase(Null2String(rsRO_DET!Detail))
        If Null2String(rsRO_DET!JOBTYPE) = "" Then
            Combo1.Text = "GJ"
        Else
            Combo1.Text = Null2String(rsRO_DET!JOBTYPE)
        End If
        ...
        If LOGCODE = "ADM" Or Trim(cboMatCode.Text) = "MISC" Or Trim(cboMatCode.Text) = "SRMATERIALS" Then
...
Sub PRINTRODISCOUNT()
    ...
    rptRepairOrder.Formulas(4) = "enduser = '" & xenduser & "'"
    ...
    Screen.MousePointer = 0
     If COMPANY_CODE = "HSR" Or COMPANY_CODE = "FMC" Then
    ...
    If Not rsORD_HIST.EOF And Not rsORD_HIST.BOF Then
        ...
        Do While Not rsORD_HIST.EOF
            ...
            If Not rsDAYTRAN.EOF And Not rsDAYTRAN.BOF Then
                ...
                RO_RIV_Tranno(RO_RIV_Tranno_Counter) = Null2String(Right(rsORD_HIST!TRANNO, 6))
                Do While Not rsDAYTRAN.EOF
                    ...
                    PARTSLEVEL = "'2'"
                    PARTSLINE_NO = N2Str2Null(Format(VarPartsLINE_NO, "000"))
    ...
    If Not rsOrd_Hd.EOF And Not rsOrd_Hd.BOF Then
        ...
        Do While Not rsOrd_Hd.EOF
            ...
            If Not rsTdayTran.EOF And Not rsTdayTran.BOF Then
                ...
                RO_RIV_Tranno_Counter = RO_RIV_Tranno_Counter + 1
                RO_RIV_Tranno(RO_RIV_Tranno_Counter) = Null2String(Right(rsOrd_Hd!TRANNO, 6))
...
Sub StoreMemVars()
    If Not rsREPOR.EOF And Not rsREPOR.BOF Then
        ...
        If Null2String(rsREPOR!Cancel_reason) = "" Then
            txtvoid_reason.Text = "Type your reason for voiding this R.O"
        Else
            txtvoid_reason.Text = Null2String(rsREPOR!Cancel_reason)
        End If
        ...
        If Null2String(rsREPOR!INVOICE) = "" Then
            ...
            If N2Str2Zero(rsREPOR!VAT_EXEMPT) = 0 And (Null2String(rsREPOR!VAT_EXEMPT1) = "" Or Null2Bit(rsREPOR!VAT_EXEMPT1) = 0) Then
                cmdROVatExempt.Caption = "Set to Zero Rated"
                cmdROVatExempt.Enabled = True
                CmdVatexempt.Caption = "Vat Exempt"
                CmdVatexempt.Enabled = True
                
            ElseIf N2Str2Zero(rsREPOR!VAT_EXEMPT) = 1 And (Null2String(rsREPOR!VAT_EXEMPT1) = "" Or Null2Bit(rsREPOR!VAT_EXEMPT1) = 0) Then
                cmdROVatExempt.Caption = "Set to Not Zero Rated"
                cmdROVatExempt.Enabled = True
                CmdVatexempt.Caption = "Vat Exempt"
                CmdVatexempt.Enabled = False
            ElseIf N2Str2Zero(rsREPOR!VAT_EXEMPT) = 0 And (Null2String(rsREPOR!VAT_EXEMPT1) <> "" Or Null2Bit(rsREPOR!VAT_EXEMPT1) <> 0) Then
                cmdROVatExempt.Caption = "Set to Zero Rated"
                cmdROVatExempt.Enabled = False
                CmdVatexempt.Caption = "Not Vat Exempt"
                CmdVatexempt.Enabled = True
            End If
        ...
        If Not Null2String(rsREPOR!INVOICE) = "" Then
            If CheckORNum(Null2String(rsREPOR!INVOICE), Null2String(rsREPOR!ACCT_NO)) <> "" Or CheckSJNum(Null2String(rsREPOR!INVOICE)) <> "" Then
        ...
        'DESCRIPTION : SO PROGRAM WILL NOT CHECK THE OR NUM AND SJ NUM OF THE RO IF ITS NOT INVOICE (LESS TIME QUERYING)
        If Not Null2String(rsREPOR!INVOICE) = "" Then
            If CheckORNum(Null2String(rsREPOR!INVOICE), Null2String(rsREPOR!ACCT_NO)) <> "" Then
                labORNum.Caption = CheckORNum(Null2String(rsREPOR!INVOICE), Null2String(rsREPOR!ACCT_NO))
            Else
                labORNum.Caption = ""
            End If
        Else
        ...
        If Null2String(rsREPOR!Status) = "V" Then
            cmdEdit.Enabled = False
            cmdReleaseRO.Enabled = False
            cmdPrint.Enabled = False
            Label18(41).Caption = "Date Canceled"
            txtDte_comp.Text = Null2String(rsREPOR!cancel_date)
        Else
            Label18(41).Caption = "Date Completed"
            txtDte_comp.Text = Null2String(rsREPOR!dte_comp)
...
Sub FillDetails()
    ...
    With grdDetails
        .Rows = 7
        .Col = 1
        If N2Str2Zero(rsREPOR!VAT_EXEMPT) = 1 Or (Null2String(rsREPOR!VAT_EXEMPT1) <> "" And Null2Bit(rsREPOR!VAT_EXEMPT1) <> 0) Then
...
Sub SendToFrontBill()
    ...
    'JJE
    If COMPANY_CODE = "DJM" Or COMPANY_CODE = "DSSC" Then
        txtInvoiceNumber.MaxLength = 8
        txtInvoiceNumber.Locked = True
    Else
        txtInvoiceNumber.MaxLength = 6
        txtInvoiceNumber.Locked = False
    End If
    'JJE
...
Sub getinvoicenumber()
    Dim rsinvnumber As ADODB.Recordset
    Dim rsinv       As ADODB.Recordset
    Set rsinvnumber = New ADODB.Recordset
    Set rsinv = New ADODB.Recordset
    
    Set rsinvnumber = gconDMIS.Execute("Select invoicenumber from csms_invoicectr")
    Set rsinv = gconDMIS.Execute("Select isnull(max(right(invoice,6)),0) as invoice from csms_repor where invoice not in ('INT RO','PDI RO','NO CHG') ")
    If Not (rsinv.EOF And rsinv.BOF) Then
        If COMPANY_CODE = "DJM" Or COMPANY_CODE = "MGS" Or COMPANY_CODE = "CMC" Then
            txtInvoiceNumber.Text = (Format((NumericVal(rsinv!INVOICE) + 1), "000000"))
        Else
            txtInvoiceNumber.Text = "BS" + (Format((NumericVal(rsinv!INVOICE) + 1), "000000"))
        End If
    End If
        
    Set rsinvnumber = Nothing
    Set rsinv = Nothing
End Sub
...
'----------------------------------------------------------------------------------------------------
    ...
    If NumericVal(txtAccDiscount.Text) <= 100 Then
        txtAccDiscount.Text = Format(NumericVal(txtAccDiscount.Text), DIGIT_FORMAT)
    Else
    ...
    End If
    If NumericVal(txtAccUnitPrice.Text) = 0 Then ACCDISCRATE = 0: ACCDISVAL = 0
...
Private Sub cmdJobSave_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
Else
    On Error Resume Next
    txtJobDetail.Text = txtJobDetail.Text + Chr$(KeyAscii)
    txtJobDetail.SetFocus
    txtJobDetail.SelStart = Len(txtJobDetail.Text)
End If
End Sub

Private Sub CmdVatexempt_Click()
    If Module_Access(LOGID, "RO ADVANCE OPTIONS", "SYSTEM") = False Then Exit Sub
    If Null2String(rsREPOR!Status) = "V" Then Exit Sub
    'If txtInvoiceNo.Text = "" Then
    If CheckIfRoIsAlreadyInvoice(txtRep_Or) = False Then
        If Trim(UCase(CmdVatexempt.Caption)) = "NOT VAT EXEMPT" Then
            If MsgBox("This is a Not Vat Exempted Transaction, Are you sure?", vbYesNo + vbQuestion, "Confirm") = vbYes Then
                Screen.MousePointer = 11
                SQL_STATEMENT = "update CSMS_RepOr set VAT_EXEMPT1 = 0 Where ID = " & labid.Caption
                gconDMIS.Execute SQL_STATEMENT
                
                'NEW LOG AUDIT-----------------------------------------------------
                    Call NEW_LogAudit("P", "BILLING SYSTEM", labid, "", "", "INV NO: NOT VAT EXEMPT", "", "")
                'NEW LOG AUDIT-----------------------------------------------------

                Call SetROTransToNonVATEXEMPT(txtRep_Or.Text)
                Screen.MousePointer = 0
                MessagePop InfoFriend, "Repair order Information Updated", "Repair order Sucessfully tag as NOT VAT EXEMPTED TRANSACTION!", 1000
            ...
            End If
        Else
            If MsgBox("This is a Vat Exempt Transaction, Are you sure?", vbYesNo + vbQuestion, "Confirm") = vbYes Then
                Screen.MousePointer = 11
                SQL_STATEMENT = "update CSMS_RepOr set L_TAXVAL = 0, P_TAXVAL = 0, M_TAXVAL = 0, A_TAXVAL = 0, VAT_EXEMPT1 = 1 Where ID = " & labid.Caption
                gconDMIS.Execute SQL_STATEMENT
                
                'NEW LOG AUDIT-----------------------------------------------------
                    Call NEW_LogAudit("P", "BILLING SYSTEM", labid, "", "", "INV NO: VAT EXEMPT", "", "")
                'NEW LOG AUDIT-----------------------------------------------------

                Call SetROTransToVATEXEMPT(txtRep_Or.Text)
                Screen.MousePointer = 0

                MessagePop InfoFriend, "Repair order Information Updated", "Repair order Sucessfully tag as VAT EXEMPT TRANSACTION!", 1000
                Call rsRefresh
                rsREPOR.Find "REP_OR = '" & txtRep_Or.Text & "'"
                cmdCancel.Value = True
            End If
...
End Sub
Sub SetROTransToVATEXEMPT(XXX As String)
    Dim rsRO_DET                                       As New ADODB.Recordset
    Set rsRO_DET = gconDMIS.Execute("Select * from CSMS_Ro_Det Where Rep_or = '" & XXX & "' Order by Livil,Line_No asc")
    If Not rsRO_DET.EOF And Not rsRO_DET.BOF Then
        rsRO_DET.MoveFirst
        Do While Not rsRO_DET.EOF
            ...
            'NEW LOG AUDIT---------------------------------------------------------------------------------------
                Call NEW_LogAudit("EE", "BILLING SYSTEM", SQL_STATEMENT, labid, "", "RO NO: " & txtRep_Or & " - SET TO VAT EXEMPT", "", Null2String(rsRO_DET!ID))
            'NEW LOG AUDIT---------------------------------------------------------------------------------------
            rsRO_DET.MoveNext
        Loop
    End If
End Sub
Sub SetROTransToNonVATEXEMPT(XXX As String)
    Dim vDiscKRate                                      As Double
    Dim VDiscKVal                                       As Double
    Dim rsRO_DET                                        As New ADODB.Recordset
    ...
    If Not rsRO_DET.EOF And Not rsRO_DET.BOF Then
        ...
        Do While Not rsRO_DET.EOF
            ...
            'NEW LOG AUDIT---------------------------------------------------------------------------------------
                Call NEW_LogAudit("EE", "BILLING SYSTEM", SQL_STATEMENT, labid, "", "RO NO: " & txtRep_Or & " - SET TO NOT VAT EXEMPT", "", Null2String(rsRO_DET!ID))
            'NEW LOG AUDIT---------------------------------------------------------------------------------------
            rsRO_DET.MoveNext
        Loop
    End If
...
Private Sub cmdVoid_Click()
    ...
    If CheckIfTheresItemIssued = True Then
        MsgBox "You cannot Void this the RO when theres already issued Item." & vbCrLf & " Kindly inform parts department to Unpost first the Issuances.", vbInformation, "Info."
        Exit Sub
    End If
    
     If checkifworking = True Then
        MessagePop InfoWarning, "Repair order Information", "Repair order is in progress, Cannot void RO.", 1000
        Exit Sub
    End If
    
    If checkifhassublet = True Then
        MessagePop InfoWarning, "Repair order Information", "Repair order has Sublet, Cannot void RO.", 1000
        Exit Sub
    End If
    
    If VOIDTRUE = False Then
        ...
        picvoid.ZOrder 0
        If Null2String(rsREPOR!Status) = "V" Then
            txtvoid_reason.Locked = True
        Else
            txtvoid_reason.Locked = False
            txtvoid_reason.Text = "Type your reason for voiding this R.O"
        End If
        Exit Sub
    Else
...
d2:
    If MsgBox("Are you sure you want to delete this Repair Order?", vbYesNo + vbQuestion, "Warning") = vbYes Then
      SQL_STATEMENT = "update CSMS_RepOr set status = 'V', Cancel_reason = '" & Null2String(UCase(txtvoid_reason.Text)) & "', cancel_date = '" & LOGDATE & "', usercde = '" & LOGCODE & "' where id = " & labid.Caption
        'SQL_STATEMENT = "delete from CSMS_RepOr where id = " & labid.Caption
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
            Call NEW_LogAudit("X", "BILLING SYSTEM", SQL_STATEMENT, labid, "", "RO NO: " & txtRep_Or & " - VOID RO", "", "")
        'NEW LOG AUDIT-----------------------------------------------------
        SQL_STATEMENT = "update CSMS_RO_Det set Status = 'V', usercde = '" & LOGCODE & "' where rep_or = '" & txtRep_Or.Text & "'"
        'SQL_STATEMENT = "delete from CSMS_RO_Det where rep_or = '" & txtRep_Or.Text & "'"
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
            Call NEW_LogAudit("XX", "BILLING SYSTEM", SQL_STATEMENT, labid, "", "RO NO: " & txtRep_Or & " - VOID RO", "", "")
        'NEW LOG AUDIT-----------------------------------------------------


        gconDMIS.Execute "update CSMS_PMS_Job_Det set transtatus = 'V' where REP_OR = '" & txtRep_Or & "'"
        gconDMIS.Execute "update CSMS_RepairOrder set jstatus = 'V', Status = 'Voided', usercde = '" & LOGCODE & "'  Where RO_NO = '" & txtRep_Or.Text & "'"
...
Private Sub cmdInternalRO_Click()
    ...
    If Null2String(rsREPOR!Status) = "V" Then Exit Sub
    If GOFORINTPDI(txtRep_Or.Text) = False Then MsgBox "Please set item to internal first!", vbInformation + vbOKOnly: Exit Sub
 ...
 '------------------------------------------------------------------------------------------------
 'updated by : IEBV 09202011 1040am
 'description   : TO edit date completed
    If gointernal = False Then
        Call forint
        PDIRO = False
        IntRO = True
        NoChgRO = False
    ...
    If txtInvoiceNo.Text = "" Then
        If MsgBox("Set this Repair order to a INTERNAL Repair, Are you sure?", vbYesNo + vbQuestion, "Warning") = vbYes Then
            ...
            SQL_STATEMENT = "update CSMS_RepOr set invoice = 'INT RO' " & _
                ", dte_comp = '" & CDate(gointernaldate) & "'  Where ID = " & labid.Caption
            gconDMIS.Execute SQL_STATEMENT
            'NEW LOG AUDIT-----------------------------------------------------
 ...
 'description   : TO edit date completed
  ...
  '-----------------------------------------------------------------------------------------------
    If MsgBox("This Repair Order will be set to NO CHARGE, Are you sure?", vbYesNo + vbQuestion, "Warning") = vbYes Then
        ...
        SQL_STATEMENT = "update CSMS_RepOr set invoice = 'NO CHG', dte_comp = '" & CDate(gointernaldate) & "' Where ID = " & labid.Caption
        gconDMIS.Execute SQL_STATEMENT
        'NEW LOG AUDIT-----------------------------------------------------
...
'            Set rsReporDup = gconDMIS.Execute("select invoice from CSMS_RepOr where invoice = '" & txtInvoiceNumber.Text & "'")
'        Else
...
'        End If
        ...
        If Not rsReporDup.BOF And Not rsReporDup.EOF Then
            MsgBox "Invoice Number '" & txtInvoiceNumber.Text & "' Already Exist..." & _
                         "System will generate new invoice number!", vbInformation
            Call getinvoicenumber
            Exit Sub
        Else
            If COMPANY_CODE = "HGC" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "MGS" Then
            ...
            '===[ EAP:051109: change original code. tag billed only if parts is posted.. ]====
             gconDMIS.Execute "update PMIS_Ord_Hd set Status = 'B' where isnull(STATUS,'N') = 'P' AND trantype = 'RIV' and RONO = '" & txtRep_Or.Text & "'"
             gconDMIS.Execute "update PMIS_Ord_Hist set Status = 'B' where isnull(STATUS,'N') = 'P' AND trantype = 'RIV' and RONO = '" & txtRep_Or.Text & "'"
             Dim rsbillpartsnow                         As ADODB.Recordset
             Dim rsbillpartspast                        As ADODB.Recordset
        
             Set rsbillpartsnow = New ADODB.Recordset
             Set rsbillpartsnow = gconDMIS.Execute("Select tranno from PMIS_Ord_Hd where isnull(STATUS,'N') = 'B'  AND trantype = 'RIV' and RONO = '" & txtRep_Or.Text & "'")
             If Not (rsbillpartsnow.EOF And rsbillpartsnow.BOF) Then
                gconDMIS.Execute "update PMIS_tdaytran set Status = 'B' where isnull(STATUS,'N') = 'P'  AND trantype = 'RIV' and tranno = '" & rsbillpartsnow!TRANNO & "'"
             End If
             Set rsbillpartsnow = Nothing
             
             Set rsbillpartspast = New ADODB.Recordset
             Set rsbillpartspast = gconDMIS.Execute("Select tranno  from PMIS_Ord_Hist where isnull(STATUS,'N') = 'B'  AND trantype = 'RIV' and RONO = '" & txtRep_Or.Text & "'")
             If Not (rsbillpartspast.EOF And rsbillpartspast.BOF) Then
                gconDMIS.Execute "update PMIS_daytran set Status = 'B' where isnull(STATUS,'N') = 'P'  AND trantype = 'RIV' and tranno = '" & rsbillpartspast!TRANNO & "'"
             End If
             Set rsbillpartspast = Nothing
            '===[]===

            gconDMIS.Execute "update PMIS_Ord_Hd set In_Process = 'N' where isnull(STATUS,'N') = 'B'  AND trantype = 'RIV' and rono = '" & vRONO & "'"
            gconDMIS.Execute "update PMIS_Ord_Hist set In_Process = 'N' where isnull(STATUS,'N') = 'B'  AND trantype = 'RIV' and rono = '" & vRONO & "'"
            
            'JJE
'            If COMPANY_CODE = "DJM" Then ** FOR APPROVAL **
'                If (gconDMIS.Execute("Select * from ctr").Fields(0).Value) = 0 Then
'                    gconDMIS.Execute "Insert Into csms_invoicectr (invoicenumber,[USER])  values(" & Format(Right(txtInvoiceNumber.Text, 6), "000000") + 1 & ", '" & LOGNAME & "')"
'                Else
'                    gconDMIS.Execute "Update csms_invoicectr set invoicenumber = " & Format(Right(txtInvoiceNumber.Text, 6), "000000") + 1 & ",[USER] = '" & LOGNAME & "'"
'                End If
            'JJE
'            Else
                If (gconDMIS.Execute("Select count(*) from csms_invoicectr").Fields(0).Value) = 0 Then
                    gconDMIS.Execute "Insert Into csms_invoicectr (invoicenumber,[USER])  values (" & Format(NumericVal(txtInvoiceNumber.Text + 1), "000000") & ", '" & LOGNAME & "')"
                Else
                    gconDMIS.Execute "Update csms_invoicectr set invoicenumber = " & Format(NumericVal(Left(txtInvoiceNumber.Text, 6 + 1)), "000000") & ",[USER] = '" & LOGNAME & "'"
                End If
'            End If
...
Private Sub cmdPrint_Click()
    ...
    Set rsrocuscode = gconDMIS.Execute("Select enduser as xendser from csms_cusveh where plate_no = '" & Null2String(txtPlate_No.Text) & "'")
    ...
    If Not (rsEndUser.EOF And rsEndUser.BOF) Then
         xenduser = Null2String(rsEndUser!AcctName)
    Else
         xenduser = ""
    End If
    ...
    If txtInvoiceNo.Text = "" Then
        If MsgQuestionBox("Is this for Final Billing?", "Billing System") = True Then
            ...
            If okbill = False Then
                MsgBox "There are issuance(s) that are not yet posted for this Repair Order. " & vbCrLf & "Please post the issuance(s) for this Repair Order!", vbInformation + vbOKOnly
                Exit Sub
            End If
            
'UPDATE BY   : Kevin Llanes  †----------------------------------------------------------
'DESCRIPTION : validation for insurance amount
                                   
    If chkParticipat.Value = 1 And txtLOAAmount.Text = "0.00" Then
     MsgBox "Please input Insurance Amount", vbExclamation, "Warning"
   
        On Error Resume Next
        Exit Sub
 End If
'UPDATE BY   : Kevin Llanes 06/11/2014 †----------------------------------------------------------
            Option1.Value = True
            Ichg = False
            ...
            Else
                If CheckIfAllJobIsFinish = True Then
                    Call SendToFrontBill
                    Call GetBPandGJCustomerInsuranceShare(txtRep_Or.Text)
                    'UPDATE BY   : MJP 08292008 †----------------------------------------------------------
                    'DESCRIPTION : NEXT/PREVIOUS BUTTON CAN BE STILL CLICK WHEN ENTERING A INVOICE NO
                        Call DisableFrame(False)
                    'UPDATE BY   : MJP 08292008 ----------------------------------------------------------†
...
Private Sub cmdOkRel_Click()
 ...
 'updated by : IEBV 09202011 1040am
 'description   : TO edit date completed
        If gointernal1 = True Then
            If txtReleaseDate.Text <> "" Then
                If CDate(txtReleaseDate.Text) < CDate(txtDte_recd.Value) Then
                    If Module_Access(LOGID, "BACK DATE", "SYSTEM") = False Then
                        On Error Resume Next
                ...
                Else
here:
                    gointernaldate = txtReleaseDate.Text
                    gointernal = True
                    If PDIRO = True Then Call Command1_Click
                    If NoChgRO = True Then Call cmdNoCharge_Click
                    If IntRO = True Then Call cmdInternalRO_Click
                    Call SendToBackRel
                    Exit Sub
                End If
            End If
...
'---------------------------------------------------------------------------------------------------
        ...
        If FORGATEPASS = True Then
            rptgatepass.Formulas(2) = "ORNUM = '" & labORNum.Caption & "'"
            PrintSQLReport rptgatepass, CSMS_REPORT_PATH & "service_gatepass.rpt", "{csms_repor.rep_or} = '" & txtRep_Or.Text & "'", CSMS_REPORT_CONNECTION, 1
        End If
...
Private Sub cmdJobDelete_Click()                      '
    ...
    If MsgQuestionBox("Delete This Job, Are you Sure?", "Delete Job Entry") = True Then
        Dim rscheckifokdel                                  As ADODB.Recordset
        Set rscheckifokdel = New ADODB.Recordset
        Set rscheckifokdel = gconDMIS.Execute("Select status from csms_ro_det where id = '" & labDetID.Caption & "'")
        If Not (rscheckifokdel.EOF And rscheckifokdel.BOF) Then
            If rscheckifokdel!Status = "W" Or rscheckifokdel!Status = "I" Or rscheckifokdel!Status = "L" Or rscheckifokdel!Status = "B" Or rscheckifokdel!Status = "G" Then
                MessagePop InfoVoid, "Action Void", "Can't remove job. Job already started."
                Exit Sub
            ElseIf rscheckifokdel!Status = "Y" Then
                MessagePop InfoVoid, "Action Void", "The job has already finish."
                Exit Sub
            End If
        End If
        Set rscheckifokdel = Nothing
        SQL_STATEMENT = "delete from CSMS_RO_Det where id = " & labDetID.Caption
        gconDMIS.Execute SQL_STATEMENT
...
Private Sub cmdJobSave_Click()
    ...
    'Description:   Additional validation, user cannot save if discount value is greater than the jobrate
      If optByAmt.Value = True Then
        If NumericVal(txtJobDiscountAmt.Text) > NumericVal(txtJobRate.Text) Then
  ...
  If NumericVal(txtJobDiscount.Text) <= 100 Then
        txtJobDiscount.Text = Format(NumericVal(txtJobDiscount.Text), DIGIT_FORMAT)
    Else
        MessagePop RecSaveError, "Saving Error", "Percentage Discount is greater then 100%"
    ...
    End If
    If NumericVal(txtJobRate.Text) = 0 Then JOBDISCRATE = 0: JOBDISVAL = 0
    ...
    'updated by: IEBV
    'to update the detcost
    If Null2String(JOBTECHNICIAN) <> "" Then
        If N2Str2Zero(rsRO_DET!HRSWRK) <> JOBDET_HRS Then
            Set rsTechSalary = gconDMIS.Execute("Select * from CSMS_vw_Technician where empno = " & Null2String(EmployeeNo(JOBTECHNICIAN)) & "")
            If Not rsTechSalary.EOF And Not rsTechSalary.BOF Then
                TechCost = NumericVal(JOBDET_HRS) * (Round(((N2Str2Zero(rsTechSalary!Monthly) * 12) / 314) / 8, 2))
            Else
                TechCost = XJOBCOST
            End If
        Else
...
'    End If
    ...
    Else
        SQL_STATEMENT = "update CSMS_RO_Det set" & _
            ...
            " detunt = " & JOBDETUNT & ", DETCOST = " & TechCost & "," & _
            " detvol = " & JOBDETVOL & "," & _
            " detprc = " & JOBDETPRC & "," & _
            " detamt = " & JOBDETAMT & "," & _
            " code = " & JOBCODE & "," & _
...
'----------------------------------------------------------------------------------------------------
    ...
    If NumericVal(txtMatDiscount.Text) <= 100 Then
        txtMatDiscount.Text = Format(NumericVal(txtMatDiscount.Text), DIGIT_FORMAT)
    Else
        MessagePop RecSaveError, "Saving Error", "Percentage Discount is greater then 100%"
        Exit Sub
    End If
    ...
    MATJOBTYPE = N2Str2Null(Combo1.Text)
    ...
    End If
    If NumericVal(txtMatUnitPrice.Text) = 0 Then MATDISCRATE = 0: MATDISVAL = 0
...
'    End If
    ...
    If AddorEdit = "ADD" Then
        gconDMIS.Execute "insert into CSMS_RO_Det " & _
            "(rep_or,livil,LINE_NO,detcde,detdsc,detunt,detvol,detprc,detamt,code,wcode,taxrate,discrate,taxval,disval,pocode,rep_or2,detail,det_amt,dis_val,discount_2,USERCDE,SAVEDATE,JOBTYPE,SAVETIME)" & _
            " values (" & MATREP_OR & ", " & MATLEVEL & ", " & MATLINE_NO & "," & _
    ...
    Else
        ...
        SQL_STATEMENT = "update CSMS_RO_Det set" & _
            ...
            " dis_val = " & MATDIS_VAL & "," & _
            " discount_2 = " & MATDISCOUNT_2 & "," & _
            " USERCDE = " & Vusercode & ", SAVEDATE = " & VLastUpdate & ",jobtype = " & MATJOBTYPE & " , SAVETIME = " & VLastUpdateTime & _
            " where id = " & labDetID.Caption
        gconDMIS.Execute SQL_STATEMENT
...
'----------------------------------------------------------------------------------------------------
    ...
    If NumericVal(txtPartDiscount.Text) <= 100 Then
        txtPartDiscount.Text = Format(NumericVal(txtPartDiscount.Text), DIGIT_FORMAT)
    Else
        MessagePop RecSaveError, "Saving Error", "Percentage Discount is greater then 100%"
    ...
    End If
    If NumericVal(txtUnitPrice.Text) = 0 Then PARTSDISCRATE = 0: PARTSDISVAL = 0
 ...
 '------------------------------------------------------------------------------------------------
    If txtInvoiceNo.Text = "" Then
        If MsgBox("Set this Repair order to a PDI Repair, Are you sure?", vbYesNo + vbQuestion, "Warning") = vbYes Then
            SQL_STATEMENT = "update CSMS_RepOr set invoice = 'PDI RO', dte_comp = '" & gointernaldate & "' Where ID = " & labid.Caption
            gconDMIS.Execute SQL_STATEMENT
...
'                If chkParticipat.Value = 1 Then Call UpdateParticipation
            End If
        Case vbKeyDelete
            If picvoid.Visible = True Then Exit Sub
           ' If Null2String(rsREPOR!Status) = "V" Then Exit Sub
            If Left(Me.ActiveControl.Name, 3) = "cbo" Then Me.ActiveControl.ListIndex = -1
            
        Case vbKeyReturn
            If lblvoided.Visible = True Then Exit Sub
            If picvoid.Visible = True Then Exit Sub
        ...
        Case vbKeyF1                                        'Notes After Follow Up
            If Picture1.Visible = True Then
                ...
                If txtInvoiceNo.Text <> "" Then
                    ...
                    chkCALLED_FOLLOWUP.Enabled = True
                    txtCALLED_RESULT.Enabled = True
                    
                    Set rsinquiry = New ADODB.Recordset
                    Set rsinquiry = gconDMIS.Execute("select * from CSMS_RepOr where  ID = " & labid.Caption)
                    If Not rsinquiry.EOF And Not rsinquiry.BOF Then
                        nix = Null2String(rsinquiry!CALLED_RESULT)
                    End If
                    
                    On Error Resume Next
                    'txtCALLED_RESULT.SetFocus
                    txtCALLED_RESULT.Text = Null2String(nix)
                End If
            End If
            ...
            If Picture1.Visible = True Then
                If txtInvoiceNo.Text <> "" Then
                    ...
                    If MsgBox("Cancel " & ReferenceNumber, vbQuestion + vbYesNo, "Are You Sure") = vbYes Then
                        ...
                        SQL_STATEMENT = "update CSMS_RepOr set PRIN_DTE = NULL, invoice = NULL, dte_comp = NULL, dte_rel = NULL, status = 'N', term = NULL where id = " & labid.Caption
                        gconDMIS.Execute SQL_STATEMENT
                        'NEW LOG AUDIT-----------------------------------------------------
                        ...
                        gconDMIS.Execute "update PMIS_Ord_Hd set Status = 'P' where isnull(status,'N') = 'B' AND trantype = 'RIV' and rono = '" & txtRep_Or.Text & "'"
                        gconDMIS.Execute "update PMIS_Ord_Hist set Status = 'P' where isnull(status,'N') = 'B'  AND trantype = 'RIV' and rono = '" & txtRep_Or.Text & "'"
                        gconDMIS.Execute "update PMIS_Ord_Hd set In_Process = 'Y' where isnull(status,'N') = 'B'  AND trantype = 'RIV' and rono = '" & txtRep_Or.Text & "'"
                        gconDMIS.Execute "update PMIS_Ord_Hist set In_Process = 'Y' where isnull(status,'N') = 'B'  AND trantype = 'RIV' and rono = '" & txtRep_Or.Text & "'"

                        'updated by:     IEBV 11452011
                        'description:    to update issued parts
                        Dim rsbillpartsnow                         As ADODB.Recordset
                        Dim rsbillpartspast                        As ADODB.Recordset
                    
                        Set rsbillpartsnow = New ADODB.Recordset
                        Set rsbillpartsnow = gconDMIS.Execute("Select tranno  from PMIS_Ord_Hd where isnull(status,'N') = 'P'  AND trantype = 'RIV' and RONO = '" & txtRep_Or.Text & "'")
                        If Not (rsbillpartsnow.EOF And rsbillpartsnow.BOF) Then
                           gconDMIS.Execute "update PMIS_tdaytran set Status = 'P' where isnull(status,'N') = 'B'  AND trantype = 'RIV' and tranno = '" & rsbillpartsnow!TRANNO & "'"
                        End If
                        Set rsbillpartsnow = Nothing
                        
                        Set rsbillpartspast = New ADODB.Recordset
                        Set rsbillpartspast = gconDMIS.Execute("Select tranno  from PMIS_Ord_Hist where isnull(status,'N') = 'P'  AND trantype = 'RIV' and RONO = '" & txtRep_Or.Text & "'")
                        If Not (rsbillpartspast.EOF And rsbillpartspast.BOF) Then
                           gconDMIS.Execute "update PMIS_daytran set Status = 'P' where isnull(status,'N') = 'B'  AND trantype = 'RIV' and tranno = '" & rsbillpartspast!TRANNO & "'"
                        End If
                        Set rsbillpartspast = Nothing
                        '------------------------------------------------------------------------------------
...
Private Sub lblStatus_Click(Index As Integer)
    ...
    If Index = 0 Then
        Set RSUPLOAD = gconDMIS.Execute("SELECT REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL, NULL as DONE,status FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND DTE_COMP IS NULL and status <> 'V' ORDER BY REP_OR DESC")
    ElseIf Index = 1 Then
        Set RSUPLOAD = gconDMIS.Execute("SELECT REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' as DONE,status FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND DTE_COMP IS NOT NULL AND DTE_REL IS NULL AND INVOICE IS NOT NULL and status <> 'V' ORDER BY REP_OR DESC")
    ElseIf Index = 2 Then
        Set RSUPLOAD = gconDMIS.Execute("SELECT REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' as DONE,status FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND DTE_REL IS NOT NULL  AND INVOICE IS NOT NULL and status <> 'V' ORDER BY REP_OR DESC")
    ElseIf Index = 4 Then
        Set RSUPLOAD = gconDMIS.Execute("SELECT REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' as DONE,status FROM CSMS_REPOR WHERE status = 'V' ORDER BY REP_OR DESC")
    Else
        ...
        SQLTXT = SQLTXT & "A.ID, A.DTE_REL,B.DONE,A.status FROM CSMS_REPOR A INNER JOIN (" & vbCrLf
        ...
        SQLTXT = SQLTXT & "ON A.REP_OR = B.REP_OR WHERE A.TRANSTYPE = 'R' AND A.INVOICE IS NULL and  a.status <> 'V'" & vbCrLf
...
'    End If
    ...
    If txtInvoiceNo.Text = "" Then
        ...
        '    MessagePop InfoFriend, "Info", "Sublet details cannot be edited here, please go to sublet purchasing for the editing of values"
        'End If
        If CheckifDetailsIsSublet(lstMaterials.SelectedItem.SubItems(8)) = True Then
            Call EnabledSubletMaterialObject(True)
        End If
    Else
...
Private Sub rptRO_BeforeDrawRow(ByVal Row As XtremeReportControl.IReportRow, ByVal Item As XtremeReportControl.IReportRecordItem, ByVal Metrics As XtremeReportControl.IReportRecordItemMetrics)
    ...
    ElseIf Row.Record(8).Value = "Y" And Row.Record(9).Value <> "V" Then
    ...
    ElseIf Row.Record(9).Value = "V" Then
...
Private Sub txtJobDetail_KeyPress(KeyAscii As Integer)
On Error Resume Next
If KeyAscii = 13 Then
    If gosave = False Then
        gosave = True
        txtJobDetail.TabStop = False
        txtJobDetail.SetFocus
    Else
        gosave = True
        txtJobDetail.TabStop = True
        cmdJobSave.SetFocus
    End If
Else
    gosave = False
...
Private Sub Timer1_Timer()
    ...
    ElseIf Null2String(rsREPOR!Status) = "V" Then
        If lblvoided.Visible = True Then
            lblvoided.Visible = False
        Else
...
Private Sub txtRep_Or_LostFocus()
    ...
    If FOR_J = True And Left(Null2String(rsREPOR!REP_OR), 2) = "J-" Then
        If Len(txtRep_Or) >= 3 And IsNumeric(Left(txtRep_Or.Text, 2)) = False Then
            txtRep_Or.Text = Mid(txtRep_Or.Text, 3, Len(txtRep_Or.Text) - 2)
        ElseIf IsNumeric(txtRep_Or.Text) = True Then
            txtRep_Or.Text = Format(Right(txtRep_Or.Text, 8), "00000000")
        End If
        txtRep_Or.Text = "J-" + Format(Right(NumericVal(Mid(txtRep_Or.Text, 1, Len(txtRep_Or.Text))), 8), "00000000")
    Else
...
Sub FillSearchGrid(XXX As String)
    ...
    XXX = Replace(XXX, "'", "")
    If XXX = "" Then
        Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,NULL AS DONE,status  FROM CSMS_REPOR WHERE DTE_COMP IS NULL AND TRANSTYPE = 'R' ORDER BY REP_OR DESC")
    Else
        'customer
        If optSearch(0).Value = True Then
            FIELD = "A.NIYM"
            If CHECKIFFINISHEDJOB(XXX, FIELD) = True Then
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND NIYM LIKE '%" & XXX & "%' ORDER BY NIYM ASC")
            Else
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL, NULL AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND NIYM LIKE '%" & XXX & "%' ORDER BY NIYM ASC")
            End If
        'repairorder
        ElseIf optSearch(1).Value = True Then
             FIELD = "A.REP_OR"
             If CHECKIFFINISHEDJOB(XXX, FIELD) = True Then
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND REP_OR LIKE '%" & XXX & "%' ORDER BY REP_OR DESC")
             Else
                 Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,NULL AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND REP_OR LIKE '%" & XXX & "%' ORDER BY REP_OR DESC")
             End If
        'invoice
        ElseIf optSearch(2).Value = True Then
             FIELD = "A.INVOICE"
            If CHECKIFFINISHEDJOB(XXX, FIELD) = True Then
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND INVOICE LIKE '%" & XXX & "%' ORDER BY INVOICE ASC")
            Else
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,NULL AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND INVOICE LIKE '%" & XXX & "%' ORDER BY INVOICE ASC")
            End If
        'plate number
        ElseIf optSearch(3).Value = True Then
             FIELD = "A.PLATE_NO"
            If CHECKIFFINISHEDJOB(XXX, FIELD) = True Then
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND PLATE_NO LIKE '%" & XXX & "%' ORDER BY PLATE_NO ASC")
            Else
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,NULL AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND PLATE_NO LIKE '%" & XXX & "%' ORDER BY PLATE_NO ASC")
            End If
        'vin number
        ElseIf optSearch(4).Value = True Then
             FIELD = "A.VIN"
             If CHECKIFFINISHEDJOB(XXX, FIELD) = True Then
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,'Y' AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND VIN LIKE '%" & XXX & "%' ORDER BY VIN ASC")
             Else
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,NULL AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND VIN LIKE '%" & XXX & "%' ORDER BY VIN ASC")
             End If
        'MODEL
        Else
             FIELD = "A.MODEL"
            If CHECKIFFINISHEDJOB(XXX, FIELD) = True Then
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL, 'Y' AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND MODEL LIKE '%" & XXX & "%' ORDER BY MODEL ASC")
            Else
                Set RSUPLOAD = gconDMIS.Execute("SELECT TOP 100 REP_OR, INVOICE, NIYM, PLATE_NO, VIN, MODEL, ID, DTE_REL,NULL AS DONE,status  FROM CSMS_REPOR WHERE TRANSTYPE = 'R' AND MODEL LIKE '%" & XXX & "%' ORDER BY MODEL ASC")
            End If
        End If
    End If
...
Sub InitializeRC()
    With rptRO
        ...
        .Columns.Add 9, "Status", 0, True:                .Columns(9).Alignment = xtpAlignmentLeft:       .Columns(9).AllowRemove = False:    .Columns(9).Resizable = False
...
'Updated: IEBV 06282010 1200PM for HCI
'Description: Add RoType
Function ADDROTYPE()
    Cbo_Rotype.Clear
    Cbo_Rotype.AddItem ""
...
Function EmployeeNo(XXX As String) As String
    Dim rsTechID As ADODB.Recordset
    Set rsTechID = New ADODB.Recordset
    rsTechID.Open "Select * from CSMS_vw_Technician WHERE TECHNICIAN =" & XXX & "", gconDMIS, adOpenForwardOnly
    If Not rsTechID.EOF And Not rsTechID.BOF Then
        EmployeeNo = Null2String(rsTechID!EMPNO)
    Else
        EmployeeNo = ""
    End If
End Function

Private Sub txtvoid_reason_Click()
    If lblvoided.Visible = True Then Exit Sub
    If txtvoid_reason.Text = "Type your reason for voiding this R.O" Then txtvoid_reason.Text = ""
End Sub
Private Sub txtvoid_reason_KeyPress(KeyAscii As Integer)

If KeyAscii = 13 Then
    If Null2String(rsREPOR!Status) = "V" Then Exit Sub
    If Replace(txtvoid_reason.Text, vbCrLf, "") = "" Then
        MsgBox "Please type your reason for Voiding this R.O.!", vbInformation + vbOKOnly
        On Error Resume Next
        txtvoid_reason.SetFocus
        Exit Sub
    Else
        If go = False Then go = True: Exit Sub
        VOIDTRUE = True
        cmdVoid.Value = True
    End If
ElseIf KeyAscii = 27 Then
...
Function okbill() As Boolean
Dim rsCheck                     As ADODB.Recordset

Set rsCheck = New ADODB.Recordset
Set rsCheck = gconDMIS.Execute("Select * from pmis_ord_hd where rono = '" & txtRep_Or.Text & "' and isnull(status,'N') = 'N' and trantype = 'RIV'")
...
Function checkifworking() As Boolean
Dim rscheckro                   As ADODB.Recordset

Set rscheckro = New ADODB.Recordset
Set rscheckro = gconDMIS.Execute("Select * from csms_ro_det where rep_or = '" & txtRep_Or.Text & "' and livil = '1' and isnull(status,'P') in ('L','B','G','I','F','W')")
If Not (rscheckro.EOF And rscheckro.BOF) Then
    checkifworking = True
Else
    checkifworking = False
End If
Set rscheckro = Nothing
End Function


Function checkifhassublet() As Boolean
Dim rscheckro                   As ADODB.Recordset

Set rscheckro = New ADODB.Recordset
Set rscheckro = gconDMIS.Execute("Select * from csms_ro_det where rep_or = '" & txtRep_Or.Text & "' and rotype = 'SR'")
If Not (rscheckro.EOF And rscheckro.BOF) Then
    checkifhassublet = True
Else
    checkifhassublet = False
End If
Set rscheckro = Nothing
End Function
Sub forint()
    ShortcutCaption1(10).Caption = "Enter Date"
    gointernal1 = True
    Call SendToFrontRel
End Sub


Sub GetBPandGJCustomerInsuranceShare(xRO As String)
    ...
    Dim XROX As String
    Set rsREPOR = gconDMIS.Execute("SELECT * FROM CSMS_REPOR WHERE rep_or ='" & xRO & "'")
                    ...
                    If rsDet!LIVIL = "1" Then         '----LIVIL 1
                        ...
                        ElseIf Null2String(rsDet!JOBTYPE) = "PMS" Then
                            ...
                            Else
                                ...
                                Else
'                                    GJ_INSURANCE = GJ_INSURANCE + INS_LABOR_TMP
'                                    GJ_CUSTOMER = GJ_CUSTOMER + (MPR_AMOUNT - INS_LABOR_TMP)    'GJ CUSTOMER LABOR
                                    If INS_LABOR_TMP > 0 Then
                                        If INS_LABOR_TMP >= MPR_AMOUNT Then
                                            INS_LABOR_TMP = INS_LABOR_TMP - MPR_AMOUNT    '
                                            GJ_INSURANCE = GJ_INSURANCE + MPR_AMOUNT    'GJ INSURANCE LABOR
...
Function GOFORINTPDI(XXX As String) As Boolean
Dim rsDet                                   As New ADODB.Recordset
Set rsDet = gconDMIS.Execute("Select rep_or from CSMS_ro_DET where rep_or = '" & XXX & "' and wcode is null")
