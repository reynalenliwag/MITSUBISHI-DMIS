...
Begin VB.Form frmCSMS_EstimatedPMS 
   ...
   EndProperty
   Icon            =   "frmCSMSFor_followUp_NEO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   825
      Left            =   3150
      MouseIcon       =   "frmCSMSFor_followUp_NEO.frx":058A
      MousePointer    =   99  'Custom
      Picture         =   "frmCSMSFor_followUp_NEO.frx":06DC
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   825
      Left            =   2370
      MouseIcon       =   "frmCSMSFor_followUp_NEO.frx":0B27
      MousePointer    =   99  'Custom
      Picture         =   "frmCSMSFor_followUp_NEO.frx":0C79
      Style           =   1  'Graphical
      TabIndex        =   2
