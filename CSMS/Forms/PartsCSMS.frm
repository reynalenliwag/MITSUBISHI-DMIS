...
Begin VB.Form frmPMISParts 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4380
         MouseIcon       =   "Parts.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3660
         MouseIcon       =   "Parts.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   58
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2940
         MouseIcon       =   "Parts.frx":16B7
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":1809
         Style           =   1  'Graphical
         TabIndex        =   59
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2220
         MouseIcon       =   "Parts.frx":1B65
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":1CB7
         Style           =   1  'Graphical
         TabIndex        =   60
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1500
         MouseIcon       =   "Parts.frx":1FCA
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":211C
         Style           =   1  'Graphical
         TabIndex        =   61
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "Parts.frx":2416
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":2568
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "Parts.frx":28C0
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":2A12
         Style           =   1  'Graphical
         TabIndex        =   63
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "Parts.frx":2ED3
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":3025
         Style           =   1  'Graphical
         TabIndex        =   65
         ToolTipText     =   "Cancel"
         Top             =   0
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   0
         MouseIcon       =   "Parts.frx":3363
         MousePointer    =   99  'Custom
         Picture         =   "Parts.frx":34B5
         Style           =   1  'Graphical
         TabIndex        =   66
   ...
   End
End
Attribute VB_Name = "frmPMISParts"
