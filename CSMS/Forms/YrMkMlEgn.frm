...
Event SelectedDetails(XYEAR As String, xMake As String, xMODEL As String, xENGINE As String, xModelDescription As String)
...
Private Sub cmdSelect_Click()
    On Error GoTo ErrorCode:
    RaiseEvent SelectedDetails(cboYear, cboMAKE, cboModel, cboEngine, cboYear & " " & Combo1)

    '    frmCSMSAddVehicle.txtYear = cboYear
    '    frmCSMSAddVehicle.txtMake = cboMake
    '    frmCSMSAddVehicle.txtModel = cboModel
    '    frmCSMSAddVehicle.txtENGINE = cboEngine
    '    frmCSMSAddVehicle.txtDescription = cboYear & " " & Combo1
    Unload Me
    Exit Sub
ErrorCode:
    ShowVBError
