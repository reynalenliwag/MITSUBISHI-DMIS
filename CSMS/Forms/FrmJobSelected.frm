...
Begin VB.Form frmCSMSJobSelected 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdunloackSR 
         ...
         Height          =   345
         Left            =   6600
         Picture         =   "FrmJobSelected.frx":0FD1
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   1980
         Width           =   405
      ...
      Begin VB.ComboBox cboBP_TYPE 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "FrmJobSelected.frx":155B
         Left            =   3060
         List            =   "FrmJobSelected.frx":1565
         Sorted          =   -1  'True
      ...
      Begin VB.CommandButton cmdunloackFR 
         ...
         Height          =   375
         Left            =   2970
         Picture         =   "FrmJobSelected.frx":157D
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   1980
         Width           =   405
...
Sub SaveRePairOrder()
    ...
    'updated by: IEBV   031820130545pm
    'description: to less vat if charge to internal
    If cboJobChargeTo.Text = "C" Or cboJobChargeTo.Text = "S" Then
        JOBDETPRC = (NumericVal(txtflatrate.Text) * JOBDET_HRS) / ConvertToBIRDecimalFormat(VAT_RATE)
    Else
...
If cboJobChargeTo.Text = "C" Or cboJobChargeTo.Text = "S" Then
    ...
    txtJobDiscount.Locked = True
Else
    If Module_Access(LOGID, "INPUT DISCOUNT", "SYSTEM") = True Then
        txtJobDiscount.Locked = False
    Else
        txtJobDiscount.Locked = True
    End If
End If
...
Private Sub cmdOK_Click()
    ...
    Else
        MsgBox "Percentage Discount is greater then 100%", vbInformation, "Saving Error "
    ...
    If txtCheckMe.Text = "main" Then
        ...
        frmCSMS_ServiceCounter.Click_ScheduleGrid (txtROno.Text)
    End If
...
Private Sub cmdunloackDISC_Click()
    If Module_Access(LOGID, "INPUT DISCOUNT", "SYSTEM") = True Then
        txtJobDiscount.Locked = False
        txtJobDiscount.BackColor = &HFFFFFF
        txtJobDiscount.ForeColor = &H0&
        
        On Error Resume Next
        txtJobDiscount.SetFocus
    Else
        txtJobDiscount.Locked = True
        txtJobDiscount.BackColor = &HFF8080
        txtJobDiscount.ForeColor = &HFFFFFF
    End If
End Sub
