...
Begin VB.Form frmCMISBankDeposit 
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   3510
         MouseIcon       =   "BankDeposit.frx":0BE4
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":0D36
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   2820
         MouseIcon       =   "BankDeposit.frx":109C
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":11EE
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   2130
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "BankDeposit.frx":1554
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":16A6
         Style           =   1  'Graphical
         TabIndex        =   53
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "BankDeposit.frx":19CB
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":1B1D
         Style           =   1  'Graphical
         TabIndex        =   50
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "BankDeposit.frx":1E79
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":1FCB
         Style           =   1  'Graphical
         TabIndex        =   51
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "BankDeposit.frx":22DE
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":2430
         Style           =   1  'Graphical
         TabIndex        =   52
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstBANKDEPO 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "BankDeposit.frx":272A
         NumItems        =   2
   ...
   Begin VB.PictureBox Picture6 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   750
         MouseIcon       =   "BankDeposit.frx":288C
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":29DE
         Style           =   1  'Graphical
         TabIndex        =   55
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "BankDeposit.frx":2D1C
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":2E6E
         Style           =   1  'Graphical
         TabIndex        =   56
   ...
   Begin VB.PictureBox picBankDepo 
      ...
      Begin VB.CommandButton cmdDeleteBANKDEPO 
         ...
         Height          =   795
         Left            =   210
         MouseIcon       =   "BankDeposit.frx":31BE
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":3310
         Style           =   1  'Graphical
         TabIndex        =   67
         Top             =   5670
         Width           =   705
      ...
      Begin VB.ComboBox cboCheckTransactions 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "BankDeposit.frx":363B
         Left            =   1590
         List            =   "BankDeposit.frx":363D
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   900
      ...
      Begin VB.CommandButton cmdCancelBANKDEPO 
         ...
         Height          =   795
         Left            =   8160
         MouseIcon       =   "BankDeposit.frx":3959
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":3AAB
         Style           =   1  'Graphical
         TabIndex        =   66
         Top             =   5670
         Width           =   705
      ...
      Begin VB.CommandButton cmdSaveBANKDEPO 
         ...
         Height          =   795
         Left            =   7470
         MouseIcon       =   "BankDeposit.frx":3DE9
         MousePointer    =   99  'Custom
         Picture         =   "BankDeposit.frx":3F3B
         Style           =   1  'Graphical
         TabIndex        =   68
         Top             =   5670
         Width           =   705
