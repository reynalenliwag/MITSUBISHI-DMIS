...
Private Sub cmdPrint_Click()
    ...
    If dtpFrom > dtpTo Then
        MsgSpeechBox "Invalid Date Range"
        Exit Sub
    End If
    ...
    With rptCMISReportRange
        ...
        If CMIS_Report_Range = "Petty Cash Summary Report" Or CMIS_Report_Range = "L.T.O. Summary Report" Then
            .Formulas(6) = "PCFFrom = '" & txtFrom & "' "
            .Formulas(7) = "PCFTo = '" & txtTo & "' "
        Else
            .Formulas(6) = "FromDate = '" & dtpFrom & "' "
            .Formulas(7) = "ToDate = '" & DateValue(dtpTo) & "' "
        End If
    End With
    ...
    If CMIS_Report_Range = "Cash In Flow Report" Then
        ...
        If CMIS_Type_Of_Report = "SUMMARY" Then
            ...
            'NEW LOG AUDIT---------------------------------------------------------
        ElseIf CMIS_Type_Of_Report = "DETAILED" Then
    ...
    ElseIf CMIS_Report_Range = "Card Listing Report On Hand" Then
        PrintSQLReport rptCMISReportRange, CMIS_REPORT_PATH & "Summary_Of_Credit_Card.rpt", " {OFF_HD.OR_DATE} >= Date(" & Year(dtpFrom) & "," & Month(dtpFrom) & "," & Day(dtpFrom) & ") and {OFF_HD.OR_DATE} <= Date(" & Year(dtpTo) & "," & Month(dtpTo) & "," & Day(dtpTo) & ")", DMIS_REPORT_Connection, 1
    ...
    ElseIf CMIS_Report_Range = "Credit Card Bank Deposit Report" Then
        ...
        'NEW LOG AUDIT---------------------------------------------------------
    ElseIf CMIS_Report_Range = "Daily Transmittal Report" Then
        frmCMISTypeOfReport.Show vbModal
        If CMIS_Type_Of_Report = "SUMMARY" Then
        ...
        ElseIf CMIS_Type_Of_Report = "DETAILED" Then
            'PrintSQLReport rptCMISReportRange, CMIS_REPORT_PATH, "{OFF"
        End If
    ElseIf CMIS_Report_Range = "Cash Receipts Journal Report - Summary" Then
    ...
    ElseIf CMIS_Report_Range = "Cash Receipts Journal Report - Detail" Then
    ...
    ElseIf CMIS_Report_Range = "Journal with Reference Code" Then
