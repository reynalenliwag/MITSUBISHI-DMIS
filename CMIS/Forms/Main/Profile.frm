...
Begin VB.Form frmCMISProfile 
   ...
   End
End
Attribute VB_Name = "frmCMISProfile"
...
Sub rsRefresh()
    ...
    rsProfile.Open "select * from ALL_Profile WHERE MODULENAME = 'CMIS'", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
...
Private Sub cmdSave_Click()
    ...
    SQL_STATEMENT = "Update ALL_Profile Set" & _
                    ...
                    "  WHERE MODULENAME = 'CMIS'"
    gconDMIS.Execute SQL_STATEMENT
    'NEW LOG AUDIT-----------------------------------------------------------------
        Call NEW_LogAudit("E", "MAINTAIN SYSTEM CONFIGURATION", SQL_STATEMENT, labid, "", "", "", "")
    'NEW LOG AUDIT-----------------------------------------------------------------
    ...
    Select Case KeyCode
        Case vbKeyF1 And Shift = 1:
            ...
            'If picMENU.Visible = True Then
                ...
                frmALL_AuditInquiry.Caption = "Audit Inquiry (MAINTAIN SYSTEM CONFIGURATION)"
                Call frmALL_AuditInquiry.DisplayHistory(labid, "MAINTAIN SYSTEM CONFIGURATION")
            'End If
