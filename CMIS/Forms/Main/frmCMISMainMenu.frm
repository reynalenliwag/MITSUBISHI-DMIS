...
Private Sub Form_Load()
    ...
    If COMPANY_CODE = "DJM" Then
        Label2.Caption = "Statement of Account"
    Else
        Label2.Caption = "NON VAT O.R."
    End If
End Sub
...
Private Sub TabControl1_SelectedChanged(ByVal Item As XtremeSuiteControls.ITabControlItem)
    If TabControl1.Visible = True Then
        cmdReport_SalesDiscount.Visible = False
        Label57.Visible = False
        cmdReport_CorporateTax.Visible = False
        Label62.Visible = False
        cmdReport_CashOnHand.Visible = False
        Label55.Visible = False
        cmdReport_OutPutTax.Visible = False
        Label58.Visible = False
        cmdReport_PettyCashReplishment.Visible = False
...
Private Sub cmdTables_BankInformation_Click()
    frmCreditCardCompany2.Show
End Sub
