...
Sub Save_Payment()
    ...
    Else
        If MODE_OF_PAYMENT = "CASH" Then
            ...
            If CheckIfBank(frmCMISOREntry.txtCUSCDE) = True Then
                Getdetailsinfo
...
Private Sub Form_Load()
    ...
    If COMPANY_CODE = M_COMPANY_CODE Then
        ...
        If MODE_OF_PAYMENT = "CASH" Then
            AMOUNT_TENDERED = 0
            wizDigit2.TextValue = ToDoubleNumber(NumericVal(AMOUNT_TENDERED))
            wizDigit3.TextValue = ToDoubleNumber(NumericVal(CHANGE_DUE))
    ...
    Else
        AMOUNT_TENDERED = 0
        CHANGE_DUE = 0
        wizDigit1.TextValue = ToDoubleNumber(NumericVal(RECEIPTS_AMOUNT))
        wizDigit2.TextValue = ToDoubleNumber(NumericVal(AMOUNT_TENDERED))
        wizDigit3.TextValue = ToDoubleNumber(NumericVal(CHANGE_DUE))
