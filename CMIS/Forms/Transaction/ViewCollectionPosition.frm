...
Begin VB.Form frmViewCollectionPosition 
   ...
   EndProperty
   ForeColor       =   &H00E0E0E0&
   Icon            =   "ViewCollectionPosition.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox picDetails 
      ...
      Begin VB.CommandButton Command2 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdCheckonBank 
   ...
   Begin wizButton.cmd cmdDetails 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "ViewCollectionPosition.frx":030A
   End
   ...
   Begin VB.CommandButton cmdNext 
      ...
      Height          =   795
      Left            =   780
      MouseIcon       =   "ViewCollectionPosition.frx":0326
      MousePointer    =   99  'Custom
      Picture         =   "ViewCollectionPosition.frx":0478
      Style           =   1  'Graphical
      TabIndex        =   57
   ...
   Begin VB.CommandButton cmdPrevious 
      ...
      Height          =   795
      Left            =   90
      MouseIcon       =   "ViewCollectionPosition.frx":07D0
      MousePointer    =   99  'Custom
      Picture         =   "ViewCollectionPosition.frx":0922
      Style           =   1  'Graphical
      TabIndex        =   56
   ...
   End
End
Attribute VB_Name = "frmViewCollectionPosition"
...
Private Sub cmdCheckonBank_Click()
