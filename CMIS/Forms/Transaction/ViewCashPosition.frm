...
Begin VB.Form frmViewCashPosition 
   ...
   Begin VB.PictureBox picDetails 
      ...
      Top             =   2640
      Width           =   2745
      Begin VB.CommandButton cmdPettyExpense 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdPettyAdvance 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdCheckinBank 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdCheckonHand 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdCardonBank 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdCardonHand 
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdTallySheet 
         Caption         =   "Tally Sheet..."
         Height          =   345
         Left            =   30
         TabIndex        =   10
         ...
         Width           =   2625
      End
      Begin VB.CommandButton cmdCashCount 
...
Sub StoreMemVars()
    If Not rsCash_Pos.EOF And Not rsCash_Pos.BOF Then
        ...
        If IsLTOIsPettyCash = "LTO" Then
            ...
            'JRE 121916 - FIX PETTY CASH REPLENISHMENT
            'txtPETTYCASH.Text = ToDoubleNumber(NumericVal(txtREPLENISH.Text) + NumericVal(txtEXPENSE.Text) + NumericVal(txtADVANCES.Text))
            txtPETTYCASH.Text = ToDoubleNumber(NumericVal(txtEXPENSE.Text) + NumericVal(txtADVANCES.Text))
            ...
            Else
                ...
                txtRemainingPettyFund.Text = ToDoubleNumber(N2Str2Zero(rsCash_Pos!LTO) - NumericVal(rsCash_Pos!EXPENSE + rsCash_Pos!ADVANCES))
        ...
        Else
            ...
            Else
                ...
                txtRemainingPettyFund.Text = ToDoubleNumber(N2Str2Zero(rsCash_Pos!FUND) - NumericVal(rsCash_Pos!EXPENSE + rsCash_Pos!ADVANCES))
                txtPettyCAFromCollection.Text = "0.00"
            End If
        End If
...
'            txtTotalAdvances.Text = ToDoubleNumber(((N2Str2Zero(rsCash_Pos!REPLENISH) + N2Str2Zero(rsCash_Pos!EXPENSE) + N2Str2Zero(rsCash_Pos!ADVANCES)) - N2Str2Zero(rsCash_Pos!FUND)) + NumericVal(txtTotalAdvances.Text))
        If N2Str2Zero(rsCash_Pos!FUND) < N2Str2Zero(rsCash_Pos!EXPENSE) + N2Str2Zero(rsCash_Pos!ADVANCES) Then
            txtTotalAdvances.Text = ToDoubleNumber(((N2Str2Zero(rsCash_Pos!EXPENSE) + N2Str2Zero(rsCash_Pos!ADVANCES)) - N2Str2Zero(rsCash_Pos!FUND)) + NumericVal(txtTotalAdvances.Text))
        Else
            txtTotalAdvances.Text = "0.00" 'ADDED BY JRE
        End If
...
Private Sub cmdF4_Click()
    If IsLTOIsPettyCash = "PETTY" Then
        ...
        cmdPettyExpense.Caption = "LTO Expenses..."
        cmdPettyAdvance.Caption = "LTO Advances..."
    ...
    Else
        ...
        cmdPettyExpense.Caption = "Petty Cash Expenses"
        cmdPettyAdvance.Caption = "Petty Cash Advances"
...
Private Sub cmdPettyExpense_Click()
    If IsLTOIsPettyCash = "LTO" Then
...
Private Sub cmdPettyAdvance_Click()
    If IsLTOIsPettyCash = "LTO" Then
...
Private Sub cmdCheckinBAnk_Click()
    frmCASHPOSITIONCheckInBank.Show vbModal
End Sub

Private Sub cmdCheckonHand_Click()
    TYPE_ON_HAND = "CHECK"
    frmCASHPOSITIONSelectCashOptions.Show vbModal
End Sub

Private Sub cmdCardonBank_Click()
    frmCASHPOSITIONCardInBank.Show vbModal
End Sub

Private Sub cmdCardonHand_Click()
    TYPE_ON_HAND = "CARD"
    frmCASHPOSITIONSelectCashOptions.Show vbModal
End Sub

Private Sub cmdTallySheet_Click()
    frmCASHPOSITIONTallySheet.Show vbModal
End Sub

Private Sub cmdCashCount_Click()
