...
Begin VB.Form frmCMISPettyCash 
   ...
   Begin VB.PictureBox picBreakDown 
      ...
      Begin VB.CommandButton cmdDeleteBreakDown 
         ...
         Height          =   795
         Left            =   135
         MouseIcon       =   "PettyCash.frx":62C9
         MousePointer    =   99  'Custom
         Picture         =   "PettyCash.frx":641B
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdCancelBreakDown 
         ...
         Height          =   795
         Left            =   7560
         MouseIcon       =   "PettyCash.frx":6A60
         MousePointer    =   99  'Custom
         Picture         =   "PettyCash.frx":6BB2
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdSaveBreakDown 
         ...
         Height          =   795
         Left            =   6840
         MouseIcon       =   "PettyCash.frx":6EF0
         MousePointer    =   99  'Custom
         Picture         =   "PettyCash.frx":7042
         Style           =   1  'Graphical
         TabIndex        =   76
...
Function trandelete() As Boolean
    On Error GoTo ErrorCode
...
Private Sub cmdSavePetty_Click()
    ...
    If Not rsCheckPettyPosition.EOF And Not rsCheckPettyPosition.BOF Then
        ...
        'JRE 121916 - FIX PETTY CASH REPLENISH
        ...
        Cash_Pos_Remaining_Petty_Fund = N2Str2Zero(rsCheckPettyPosition!FUND) - (N2Str2Zero(rsCheckPettyPosition!EXPENSE) + N2Str2Zero(rsCheckPettyPosition!ADVANCES))
...
Private Sub cmdShow_Click()
    ...
    ElseIf optExpense.Value = True Then
        cmdPOST.Caption = "Replenish" 'JRE 121916 - FIX PETTY CASH REPLENISHMENT (UNCOMMENTED)
        cmdPOST.Enabled = False
        txtPetty_Code.Text = "001"
        cmdAdd.Enabled = True
        cmdEdit.Enabled = True
        cmdPrint.Enabled = True 'JRE 121916 - FIX PETTY CASH REPLENISHMENT (CHANGE THE VALUE TO TRUE)
    ...
    If grdPetty.Text <> "" Then
        ...
        Else
            ...
            Else
                ...
                'JRE 121916 - FIX PETTY CASH REPLENISHMENT (ADDED)
                cmdPOST.Enabled = True
            End If
        End If
    End If
...
Private Sub Form_Load()
    ...
    cmdCancelCO.Caption = ""
    cmdCancelCO.Picture = LoadPicture("")
    rsRefresh
    StoreMemVars
...
Private Sub lstPetty_GotFocus()
    ...
    Employee.MoveFirst
    'JRE 11232016 - TO DISPLAY THE RIGHT NAME
    Employee.Find "CODE = '" & lstPetty.ListItems(Index).ListSubItems(1) & "'"
...
Private Sub lstPetty_ItemClick(ByVal Item As MSComctlLib.ListItem)
    ...
    Employee.MoveFirst
    'JRE 11232016 - TO DISPLAY THE RIGHT NAME
    Employee.Find "CODE = '" & Item.ListSubItems(1) & "'"
