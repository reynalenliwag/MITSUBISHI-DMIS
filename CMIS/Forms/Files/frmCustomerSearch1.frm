...
Private Sub cmdSelect_Click()
    If SelectCustomer = "Bank" Then
        If Trim(TXTCODE.Text) <> "" Then
            frmCreditCardCompany2.txtCuscde.Text = TXTCODE.Text
            frmCreditCardCompany2.cboCUSNAME.Text = txtName.Text
            Unload Me
        End If
    ElseIf SelectCustomer = "Customer" Then
        If Trim(TXTCODE.Text) <> "" Then
            ...
            Unload Me
        End If
    ElseIf SelectCustomer = "Financing" Then
        If Trim(TXTCODE.Text) <> "" Then
            frmSMIS_Files_FinancingCo.TXTCODE.Text = TXTCODE.Text
            frmSMIS_Files_FinancingCo.txtCompany.Text = txtName.Text
            Unload Me
        End If
    ElseIf SelectCustomer = "Terminal" Then
        If Trim(TXTCODE.Text) <> "" Then
...
'    If COMPANY_CODE = "CMC" And App.TITLE = "SMIS" Then
'        rsAllCustomer.Open "SELECT Code,LastName,FirstName,MiddleName,AccountName as AcctName,Phone as Mobile,Phone as HomePhone,Fax,Address,EntityCode from ALL_ENTITY WHERE CODE <> '999999' AND ENTITYCODE='V' ORDER BY ACCOUNTNAME", gconDMIS, adOpenKeyset
'    Else
        rsAllCustomer.Open "Select CusCde as Code,LastName,FirstName,AcctName,Mobile,HomePhone,Fax,CustomerAdd + ' ' + City + ' ' + ProvincialAdd as Address from ALL_Customer where cuscde <> '999999' order by lastname asc", gconDMIS, adOpenKeyset
'    End If
