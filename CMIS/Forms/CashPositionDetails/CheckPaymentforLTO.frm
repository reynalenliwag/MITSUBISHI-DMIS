...
Begin VB.Form frmCASHPOSITIONCheckPaymentForLTO 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Check Payment for LTO"
   ClientHeight    =   5820
   ClientLeft      =   1560
   ClientTop       =   1260
   ClientWidth     =   8685
   ForeColor       =   &H00F5F5F5&
   Icon            =   "CheckPaymentforLTO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmd_Delete 
      ...
      Height          =   795
      Left            =   1500
      MouseIcon       =   "CheckPaymentforLTO.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "CheckPaymentforLTO.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   48
   ...
   Begin VB.CommandButton cmd_Edit 
      ...
      Height          =   795
      Left            =   810
      MouseIcon       =   "CheckPaymentforLTO.frx":0787
      MousePointer    =   99  'Custom
      Picture         =   "CheckPaymentforLTO.frx":08D9
      Style           =   1  'Graphical
      TabIndex        =   50
   ...
   Begin VB.CommandButton cmd_Add 
      ...
      Height          =   795
      Left            =   120
      MouseIcon       =   "CheckPaymentforLTO.frx":0C35
      MousePointer    =   99  'Custom
      Picture         =   "CheckPaymentforLTO.frx":0D87
      Style           =   1  'Graphical
      TabIndex        =   49
   ...
   Begin VB.PictureBox pic 
      ...
      Begin MSFlexGridLib.MSFlexGrid grdPettyPay 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CheckPaymentforLTO.frx":109A
      End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      BackColor       =   16119285
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "CheckPaymentforLTO.frx":13B4
      ...
      Begin VB.PictureBox picPettyPay 
         ...
         Begin VB.CommandButton cmdCancelPettyPay 
            ...
            Height          =   795
            Left            =   7500
            Picture         =   "CheckPaymentforLTO.frx":13D0
            Style           =   1  'Graphical
            TabIndex        =   47
            ToolTipText     =   "Cancel"
            Top             =   1350
         ...
         Begin VB.CommandButton cmdSavePettyPay 
            ...
            Height          =   795
            Left            =   6810
            Picture         =   "CheckPaymentforLTO.frx":170E
            Style           =   1  'Graphical
            TabIndex        =   46
   ...
   End
End
Attribute VB_Name = "frmCASHPOSITIONCheckPaymentForLTO"
...
Sub FillGrid()
    ...
    Set rsPETTYPAY = gconDMIS.Execute("SELECT * FROM CMIS_LTOPay WHERE CUTDATE = '" & txtCutDate.Text & "' ORDER BY id ASC")
...
Sub StorePettyPayDetails(Maam As Variant)
    ...
    Set rsPettyPayDetails = gconDMIS.Execute("Select * from CMIS_LTOPay where id = " & Maam)
...
Private Sub cmd_Delete_Click()
    ...
    If ShowConfirmDelete = True Then
        gconDMIS.Execute ("DELETE FROM CMIS_LTOPay WHERE ID = " & labID.Caption)
        gconDMIS.Execute ("UPDATE CMIS_Cash_Pos SET" & _
                          " LTO_REPL = LTO_REPL + " & NumericVal(txtChkAmount.Text) & _
                          " WHERE CUTDATE = '" & txtCutDate & "'")
    End If
    cmdShow.Value = True
    LogAudit "X", "LTO PAYMENT", txtCutDate
    Exit Sub
...
Private Sub cmdSavePettyPay_Click()
    ...
    If AddorEdit = "ADD" Then
        gconDMIS.Execute ("INSERT INTO CMIS_LTOPay " & _
        ...
        gconDMIS.Execute ("UPDATE CMIS_Cash_Pos SET" & _
                          " LTO_REPL = LTO_REPL - " & vChkAmount & _
                          " WHERE CUTDATE = '" & CURRENT_CUTOFF_DATE & "'")
        LogAudit "A", "LTO PAYMENT", txtCutDate
    Else
        gconDMIS.Execute ("UPDATE CMIS_LTOPay SET" & _
                          " TYPE = " & VTYPE & "," & _
        ...
        gconDMIS.Execute ("UPDATE CMIS_Cash_Pos SET" & _
                          " LTO_REPL = LTO_REPL - " & vChkAmount & _
                          " WHERE CUTDATE = '" & CURRENT_CUTOFF_DATE & "'")
        LogAudit "E", "LTO PAYMENT", txtCutDate
    End If
