...
If App.PrevInstance = True Then
    End
End If
'IF COMPANY IS HARI THEN
'    SERVERNAME = GetSetting("ADMS 1.0", "SETTINGS", "SERVERNAME")
'    SQLSERVERNAME = GetSetting("ADMS 1.0", "SETTINGS", "SQLSERVERNAME")
'    DATABASE = GetSetting("ADMS 1.0", "SETTINGS", "DATABASE")
'
