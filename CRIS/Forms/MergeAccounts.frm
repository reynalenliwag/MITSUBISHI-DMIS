...
'                gconDMIS.Execute ("DELETE FROM ALL_CUSTOMER_TERMS WHERE CUSTOMERCODE=" & N2Str2Null(Xcode))
...
'            End If
            ...
            If COMPANY_CODE <> "HMR" Then
                If COMPANY_CODE = "DMI" Or COMPANY_CODE = "DPI" Then
                Else
                gconDMIS.Execute ("DELETE FROM ALL_CUSTOMER_TERMS WHERE CUSTOMERCODE=" & N2Str2Null(Xcode))
                gconDMIS.Execute ("UPDATE ALL_CUSTOMER_TERMS SET CUSTOMERCODE=" & N2Str2Null(txtCusCde) & "  WHERE CUSTOMERCODE=" & N2Str2Null(Xcode))
                End If
...
ErrorCode:
    MsgBox "Merging failed.", vbInformation
    Unload frmSplash
    ShowVBError
End Sub
