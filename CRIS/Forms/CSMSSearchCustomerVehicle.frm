...
Begin VB.Form frmCSMSSearchCustomerVehicle 
   ...
   EndProperty
   ForeColor       =   &H00DEDFDE&
   Icon            =   "CSMSSearchCustomerVehicle.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
      ...
      Begin XtremeSuiteControls.TabControlPage TabControlPage1 
         ...
         Begin MSComctlLib.ListView ListCustomerName 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "CSMSSearchCustomerVehicle.frx":030A
            NumItems        =   11
      ...
      Begin XtremeSuiteControls.TabControlPage tbPlateNo 
         ...
         Begin MSComctlLib.ListView ListPlateNumber 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "CSMSSearchCustomerVehicle.frx":0624
            NumItems        =   11
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "CODE"
               Object.Width           =   1764
...
Private Sub ListPlateNumber_DblClick()
    With frmCSMSAddVehicle
        ...
        .labCustomer = ListPlateNumber.SelectedItem.ListSubItems(1).Text
    End With
    Unload Me
    frmCSMSAddVehicle.Show 1
End Sub
...
Private Sub txtPlateNumber_Change()
    If txtPlateNumber = "" Then
        ...
        Set rsCusVeh = New ADODB.Recordset
        Set rsCusVeh = gconDMIS.Execute("SELECT TOP 100   [CUSCDE] ,[NIYM],[VIN],[PLATE_NO],[VCOND_NO],[CLRCDE],[YER],[MAKE],[MODEL],[ENGINE],[SELLING_DEALER],[ID]  From [DMIS].[dbo].[CSMS_CusVeh] order by niym asc")
        If Not (rsCusVeh.EOF And rsCusVeh.BOF) Then
    ...
    Else
        Me.ListPlateNumber.Sorted = False: Me.ListPlateNumber.ListItems.Clear
        Set rsCusVeh = New ADODB.Recordset
        Set rsCusVeh = gconDMIS.Execute("select TOP 100  [CUSCDE] ,[NIYM],[VIN],[PLATE_NO],[VCOND_NO],[CLRCDE],[YER],[MAKE],[MODEL],[ENGINE],[SELLING_DEALER],[ID]  From [DMIS].[dbo].[CSMS_CusVeh] Where plate_no like '" & Repleys(Trim(Me.txtPlateNumber)) & "%' order by niym asc")
        If Not (rsCusVeh.EOF And rsCusVeh.BOF) Then
            Listview_Loadval Me.ListPlateNumber.ListItems, rsCusVeh
            ListPlateNumber.Enabled = True
        End If
