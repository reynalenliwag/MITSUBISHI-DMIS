...
Begin VB.Form frmCRIS_Inquiry_ServiceAppointment 
   ...
   FillColor       =   &H00808080&
   ForeColor       =   &H00F5F5F5&
   Icon            =   "Inquiry_ServiceAppointment.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label labPark 
         ...
         Height          =   165
         Left            =   930
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":05CA
      ...
      Begin VB.Label labWork 
         ...
         Height          =   195
         Left            =   2820
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":08D4
         MousePointer    =   99  'Custom
         TabIndex        =   15
         Top             =   0
         Width           =   855
      ...
      Begin VB.Label labFinish 
         ...
         Height          =   165
         Left            =   4800
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":0BDE
         MousePointer    =   99  'Custom
         TabIndex        =   14
         Top             =   0
         Width           =   645
      ...
      Begin VB.Label labBilled 
         ...
         Height          =   165
         Left            =   5700
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":0EE8
         MousePointer    =   99  'Custom
         TabIndex        =   13
         Top             =   0
         Width           =   615
      ...
      Begin VB.Label labOver 
         ...
         Height          =   165
         Left            =   3960
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":11F2
         MousePointer    =   99  'Custom
         TabIndex        =   12
         Top             =   0
         Width           =   555
      ...
      Begin VB.Label Label1 
         ...
         Height          =   165
         Left            =   6540
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":14FC
         MousePointer    =   99  'Custom
         TabIndex        =   11
         Top             =   0
         Width           =   825
      ...
      Begin VB.Label labBackJob 
         ...
         Height          =   195
         Left            =   1680
         MouseIcon       =   "Inquiry_ServiceAppointment.frx":1806
         MousePointer    =   99  'Custom
         TabIndex        =   10
         Top             =   0
         Width           =   945
   ...
   Begin MSComCtl2.MonthView MonthView1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "Inquiry_ServiceAppointment.frx":1B10
    ...
    If (grdCounter.Rows - 1) > 0 Then
        For xx = 1 To grdCounter.Rows - 1
            ...
            Else
                ...
                End If
            End If
            LogAudit "I", "SERVICE APPOINTMENT", "DATE :" & CDate(MonthView1)
