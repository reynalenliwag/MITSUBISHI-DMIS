...
Begin VB.Form frmSMIS_Inquiry_ViewLog 
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   795
      Left            =   11460
      MouseIcon       =   "Inquiry_ViewLog.frx":030A
      MousePointer    =   99  'Custom
      Picture         =   "Inquiry_ViewLog.frx":045C
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Cancel"
      Top             =   6600
   ...
   Begin VB.CommandButton cmdSelect 
      ...
      Height          =   795
      Left            =   10770
      MouseIcon       =   "Inquiry_ViewLog.frx":079A
      MousePointer    =   99  'Custom
      Picture         =   "Inquiry_ViewLog.frx":08EC
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Select "
      Top             =   6600
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   795
      Left            =   10770
      MouseIcon       =   "Inquiry_ViewLog.frx":0C28
      MousePointer    =   99  'Custom
      Picture         =   "Inquiry_ViewLog.frx":0D7A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   6600
      Width           =   705
...
Private Sub Form_Load()
    ...
    Select Case Action
        ...
        Case "LOG:CUSTOMER"
            ...
            flex_FillReportView gconDMIS.Execute("Select convert(deyt,, LogName, Particular , CSCDE, PROSPECTID, LOGID  from CRIS_VIEWLOG WHERE CSCDE=" & N2Str2Null(CustomerCode) & "  Order By [deyt] , SN "), lvInq
        Case "SAEAPPDETAIL"
            With lvInq
