...
Begin VB.Form frmSMIS_Trans_Ordering 
   ...
   Begin VB.PictureBox picAdds 
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   6450
         MouseIcon       =   "Ordering.frx":12E1
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":1433
         Style           =   1  'Graphical
         TabIndex        =   82
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   5760
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Ordering.frx":1799
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":18EB
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5070
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Ordering.frx":1C25
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":1D77
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   4380
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "Ordering.frx":209C
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":21EE
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   3690
         MouseIcon       =   "Ordering.frx":2533
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":2685
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   3000
         MouseIcon       =   "Ordering.frx":29E1
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":2B33
         Style           =   1  'Graphical
         TabIndex        =   79
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   795
         Left            =   2310
         MouseIcon       =   "Ordering.frx":2E46
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":2F98
         Style           =   1  'Graphical
         TabIndex        =   76
         ToolTipText     =   "Add Record"
         Top             =   60
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1620
         MouseIcon       =   "Ordering.frx":32AB
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":33FD
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   930
         MouseIcon       =   "Ordering.frx":36F7
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":3849
         Style           =   1  'Graphical
         TabIndex        =   74
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   240
         MouseIcon       =   "Ordering.frx":3BA1
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":3CF3
         Style           =   1  'Graphical
         TabIndex        =   73
   ...
   Begin VB.PictureBox picSaves 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   780
         MouseIcon       =   "Ordering.frx":4052
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":41A4
         Style           =   1  'Graphical
         TabIndex        =   70
         Top             =   60
         Width           =   705
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   90
         MouseIcon       =   "Ordering.frx":44E2
         MousePointer    =   99  'Custom
         Picture         =   "Ordering.frx":4634
         Style           =   1  'Graphical
         TabIndex        =   71
         Top             =   60
         Width           =   705
...
Sub CboRefresh()
    ...
    If COMPANY_CODE = "CMC" Then
        Set rsTemp = gconDMIS.Execute("SELECT COMPANY FROM SMIS_FINCOM")
    Else
...
'    ElseIf optPO.Value = True Then     ** FOR APPROVAL DJM**
'        XXX = Format(Right(textSearch, 6), "000000")
'        Set temprs = gconDMIS.Execute("SELECT convert(varchar, DateOrdered,101),PO_NO,ID FROM SMIS_PO WHERE PO_NO Like '%" & XXX & "%' ORDER BY PO_NO DESC")
    End If
    'JJE
...
Sub InitCombo()
    ...
    Call rsS_Model.Open("Select code,descript from All_Model where LEN(code)<> 0 order by descript asc", gconDMIS, adOpenKeyset)
    If Not rsS_Model.EOF And Not rsS_Model.BOF Then
        ...
        Do While Not rsS_Model.EOF
            ...
            cbomodelcode.AddItem (Null2String(rsS_Model!Code))
            rsS_Model.MoveNext
        Loop
    End If
...
Sub SetModelLine(XXX As String, ByCode As Boolean)
    ...
    If Not (temprs.EOF Or temprs.BOF) Then
        ...
        Else
            cbomodelcode = UCase(Null2String(temprs!Code))
        End If
...
Sub StoreMemVars()
    ...
    If Not (rsPO.EOF Or rsPO.BOF) Then
        ...
        cbomodelcode = Null2String(rsPO!ModelCode)
...
'        If COMPANY_CODE = "CMC" Then
'            cboPy_FinLcIssuingBank = GetFinName(Null2String(rsPO!FinLcIssuingBank))
'        Else
...
If cbomodelcode.ListIndex <> -1 And DontChange = False Then
        SetModelLine cbomodelcode, True
 End If
    DontChange = False
...
Private Sub Check1_Click()
    ...
    Else
        TXTWTAX.Visible = True
        TXTWTAX.Text = ToDoubleNumber(Round((((NumericVal(txtPy_CD_Amount.Text) - NumericVal(txtSubsidy.Text)) / 1.12) * 0.01), 2))
    End If
End Sub
...
Function GetFinCode(FinName As String)
    Dim rsFinancing As ADODB.Recordset
    Set rsFinancing = New ADODB.Recordset
    rsFinancing.Open "SELECT CODE FROM SMIS_FINCOM WHERE COMPANY = '" & FinName & "'", gconDMIS
    If Not rsFinancing.EOF And Not rsFinancing.BOF Then
        GetFinCode = rsFinancing!Code
    End If
End Function

Function GetFinName(Code As String)
    Dim rsFinancing As ADODB.Recordset
    Set rsFinancing = New ADODB.Recordset
    rsFinancing.Open "SELECT COMPANY FROM SMIS_FINCOM WHERE CODE = '" & Code & "'", gconDMIS
    If Not rsFinancing.EOF And Not rsFinancing.BOF Then
       GetFinName = rsFinancing!company
    End If
End Function
...
Private Sub cmdSave_Click()
    ...
    If Null2String(cbomodelcode) = "" Then
...
'            SQL = SQL & N2Str2Null(GetFinCode(cboPy_FinLcIssuingBank)) & "," & N2Str2Null(txtPy_LCNo) & " ,"
'            SQL = SQL & N2Str2Null(cboPy_CD_BankName) & "," & N2Str2Null(txtPy_CD_CheckNo) & " ," & N2Str2Null(txPy_CD_Date) & "," & NumericVal(txtPy_CD_Amount) & ","
'            SQL = SQL & N2Str2Null(txtModel) & "," & N2Str2Null(txtModelYear) & " ," & N2Str2Null(cbomodelcode) & ","
...
'            SQL = SQL & " ModelCode=" & N2Str2Null(cbomodelcode) & ","
'            SQL = SQL & " Color=" & N2Str2Null(cboColor) & ","
'            SQL = SQL & " Fuel=" & N2Str2Null(txtFuel) & ","
'            SQL = SQL & " Notes=" & N2Str2Null(txtNotes) & ","
'            SQL = SQL & " FinLcIssuingBank=" & N2Str2Null(GetFinCode(cboPy_FinLcIssuingBank)) & ","
...
'    End If
    'JJE
    If COMPANY_CODE = "CMC" Then
        cbomodelcode.Enabled = True
    Else
       cbomodelcode.Enabled = False
    End If
...
Private Sub txtPONO_LostFocus()
    ...
    'JJE DJM with Prefix
'    txtPONO = Format(Right(txtPONO, 6), "000000")      ** FOR APPROVAL **
    'JJE
End Sub
