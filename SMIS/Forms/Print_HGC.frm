    ...
    If Not rsCustomer.EOF And Not rsCustomer.BOF Then
        If Null2String(rsPurchAgree!TERM) = "COD" Then
         ...
         If COMPANY_CODE = "MGS" Then
            ...
            rptPrint.Formulas(0) = "CompanyName='" & COMPANY_NAME & "'"
            rptPrint.Formulas(1) = "CompanyAddress='" & COMPANY_ADDRESS & "'"
            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "SALESCERTIFICATION.RPT", "{PURCHAGREE.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
            
'            rptPrint.Reset
'            rptPrint.Formulas(0) = "CompanyName='" & COMPANY_NAME & "'"
'            rptPrint.Formulas(1) = "CompanyAddress='" & COMPANY_ADDRESS & "'"
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "CERTIFICATION.RPT", "{PURCHAGREE.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
'
'            rptPrint.Reset
'            rptPrint.Formulas(0) = "CompanyName='" & COMPANY_NAME & "'"
'            rptPrint.Formulas(1) = "CompanyAddress='" & COMPANY_ADDRESS & "'"
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "LTO_SALESCERTIFICATION.RPT", "{PURCHAGREE.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
            
         End If

'           If COMPANY_CODE <> "DJM" Then
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "vi_LTOCOPY.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
'           End If
            Screen.MousePointer = 0
...
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "vi_compo_LTOCOPY.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
'         End If
            Screen.MousePointer = 0
        ...
        If COMPANY_CODE = "MGS" Then
            ...
            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "VI_FIN_BPO2.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "VI_FIN_BPO3.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
...
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "LTO_SALESCERTIFICATION.RPT", "{PURCHAGREE.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
        ...
        End If
'            If COMPANY_CODE <> "CMC" Then
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "VI_FIN_BPO_LTOCOPY.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
'            End If
            Screen.MousePointer = 0
        Else
            Screen.MousePointer = 11
        ...
        If COMPANY_CODE = "MGS" Then
            ...
            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "VI_FIN2.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
...
'        If COMPANY_CODE <> "CMC" Then
'            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "VI_FIN_LTOCOPY.rpt", "{purchagree.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
'        End If
            Screen.MousePointer = 0
        End If
        ...
        If COMPANY_CODE = "DJM" Then
            ...
            rptPrint.Formulas(0) = "CompanyName='" & COMPANY_NAME & "'"
            rptPrint.Formulas(1) = "CompanyAddress='" & COMPANY_ADDRESS & "'"
            PrintSQLReport rptPrint, SMIS_REPORT_PATH & "PNPCLEARANCE.RPT", "{PURCHAGREE.VI_NO} = '" & VI_NO & "'", DMIS_REPORT_Connection, 1
        End If
