...
Private Sub cmdDelete_Click()
    If ShowConfirmDelete = True Then
        ...
        LogAudit "X", "CUSTOMER REMINDERS" & " ASSIGNED TO :" & cboReminder_AssignedTo & " SUBJECT " & txtReminder_Subject
        rsRefresh
        TIMER_REMIND = ""
        StoreMemVars
    End If
...
Private Sub cmdSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        LogAudit "A", "CUSTOMER REMINDERS" & " ASSIGNED TO :" & cboReminder_AssignedTo & " SUBJECT " & txtReminder_Subject
    Else
        ...
        LogAudit "E", "CUSTOMER REMINDERS" & " ASSIGNED TO :" & cboReminder_AssignedTo & " SUBJECT " & txtReminder_Subject
    End If
