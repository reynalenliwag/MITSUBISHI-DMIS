...
Begin VB.Form frmPMISCustomerOrder 
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   405
         Left            =   1740
         Picture         =   "CustomerOrder.frx":08CA
         ScaleHeight     =   405
         ScaleWidth      =   435
         TabIndex        =   60
         Top             =   -540
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   7980
         MouseIcon       =   "CustomerOrder.frx":3606
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":3758
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7200
         MouseIcon       =   "CustomerOrder.frx":3ABE
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":3C10
         Style           =   1  'Graphical
         TabIndex        =   96
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   6420
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CustomerOrder.frx":3F76
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":40C8
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5640
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "CustomerOrder.frx":4402
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":4554
         Style           =   1  'Graphical
         TabIndex        =   103
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "CustomerOrder.frx":4879
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":49CB
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4080
         MouseIcon       =   "CustomerOrder.frx":4D27
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":4E79
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3300
         MouseIcon       =   "CustomerOrder.frx":518C
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":52DE
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2520
         MouseIcon       =   "CustomerOrder.frx":562E
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":5780
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1740
         MouseIcon       =   "CustomerOrder.frx":5ADE
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":5C30
         Style           =   1  'Graphical
         TabIndex        =   99
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   960
         MouseIcon       =   "CustomerOrder.frx":5F2A
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":607C
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   180
         MouseIcon       =   "CustomerOrder.frx":63D4
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":6526
         Style           =   1  'Graphical
         TabIndex        =   101
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   990
         MouseIcon       =   "CustomerOrder.frx":6885
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":69D7
         Style           =   1  'Graphical
         TabIndex        =   90
         ToolTipText     =   "Cancel"
         Top             =   60
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   210
         MouseIcon       =   "CustomerOrder.frx":6D15
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":6E67
         Style           =   1  'Graphical
         TabIndex        =   91
   ...
   Begin VB.Frame fraDetails 
      ...
      Begin MSComctlLib.ListView lstOrd_Hd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "CustomerOrder.frx":71B7
         NumItems        =   2
   ...
   Begin VB.PictureBox fraAddTran 
      ...
      Begin VB.CommandButton cmdTranDelete 
         ...
         Height          =   795
         Left            =   2880
         MouseIcon       =   "CustomerOrder.frx":7809
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":795B
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton cmdTranCancel 
         ...
         Height          =   795
         Left            =   2160
         MouseIcon       =   "CustomerOrder.frx":7C86
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":7DD8
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.ComboBox cboTranPartNo 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "CustomerOrder.frx":8116
         Left            =   1470
         List            =   "CustomerOrder.frx":8118
         Sorted          =   -1  'True
         TabIndex        =   17
         Text            =   "Combo1"
      ...
      Begin VB.CommandButton cmdTranSave 
         ...
         Height          =   795
         Left            =   1440
         MouseIcon       =   "CustomerOrder.frx":811A
         MousePointer    =   99  'Custom
         Picture         =   "CustomerOrder.frx":826C
         Style           =   1  'Graphical
         TabIndex        =   86
   ...
   End
End
Attribute VB_Name = "frmPMISCustomerOrder"
...
Private Sub Check1_Click()
    If Check1.Value = 1 Then
        ...
        rsPartMas.Open "Select srp,STOCKNO,mac,dnp from PMIS_PARTMAS where STOCKNO = '" & cboTranPartNo & "' AND ACTIVE = 'Y'", gconDMIS, adOpenForwardOnly, adLockReadOnly
...
Sub CHGPRINTING()
    ...
    If NumericVal(txtDS1.Text) = 0 Then
        ...
        PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "PIS.RPT", "{ord_hd.TRANTYPE} = 'CHG' and {ord_hd.TYPE} = 'P' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_CONNECTION, 1
        Screen.MousePointer = 0
    Else
        Screen.MousePointer = 11
        PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "PISDisc.RPT", "{ord_hd.TRANTYPE} = 'CHG' and {ord_hd.TYPE} = 'P' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_CONNECTION, 1
        Screen.MousePointer = 0
    End If
End Sub
...
Sub CSHPRINTING()
    ...
    If NumericVal(txtDS1.Text) = 0 Then
        Screen.MousePointer = 11
        PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "PIS.RPT", "{ord_hd.TRANTYPE} = 'CSH' and {ord_hd.TYPE} = 'P' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_CONNECTION, 1
        Screen.MousePointer = 0
    Else
        Screen.MousePointer = 11
        PrintSQLReport rptCustomerOrder, PMIS_REPORT_PATH & "PISDisc.RPT", "{ord_hd.TRANTYPE} = 'CSH' and {ord_hd.TYPE} = 'P' AND {ord_hd.tranno} = " & N2Str2Null(txtTranNo.Text), DMIS_REPORT_CONNECTION, 1
        Screen.MousePointer = 0
    End If
End Sub
...
Sub SERVICEPISPRINTING()
    ...
    If Not rsTDAYTRAN.EOF And Not rsTDAYTRAN.BOF Then
        TOTALQTY = 0
        TOTALPRICE = 0
        'If rsTDAYTRAN.RecordCount > 14 Then cntCOPY = 4 Else cntCOPY = 2
        cntCOPY = 1
        Print #1, "<html><body>"
        knt = 0
...
'            End If
            Do While Not rsTDAYTRAN.EOF
                ...
                Print #1, "</tr>"
                'If rsTDAYTRAN.AbsolutePosition = 14 Then Exit Do
                If rsTDAYTRAN.AbsolutePosition = 13 Then Exit Do
                rsTDAYTRAN.MoveNext
            Loop
            For cnt3 = 1 To cnt2
                Print #1, "<tr>"
...
Sub rsRefresh()
    ...
    Else
        ...
        If COUNTERTYPE = "CSH" Then
            ...
            LOCALACESS = "TRANSACTION PARTS ISSUANCE OVER THE COUNTER"
        ...
        If COUNTERTYPE = "CHG" Then
            LOCALACESS = "TRANSACTION PARTS ISSUANCE SERVICE ISSUANCE"
        ...
        If COUNTERTYPE = "DR" Then
            LOCALACESS = "TRANSACTION DR OUT ISSUANCE"
        ...
        End If
        If COUNTERTYPE = "ADB" Then
            LOCALACESS = "TRANSACTION ADVANCE BILL DATA ENTRY"
            Me.Caption = "Advance Bill Data Entry"
            Set rsOrd_Hd = New ADODB.Recordset
            rsOrd_Hd.Open "select * from PMIS_Ord_Hd where [TYPE] = 'P' AND trantype = 'ADB' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
        End If
        ...
        '        'Me.Caption = "Cash Counter Issuance Data Entry"
        '        Set rsOrd_Hd = New ADODB.Recordset
        '        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where trantype = 'CSH' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
        '    End If
        '    If COUNTERTYPE = "CHG" Then
        '        Me.Caption = "Charge Counter Issuance Data Entry"
        '        Set rsOrd_Hd = New ADODB.Recordset
        '        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where trantype = 'CHG' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
        '    End If
        '    If COUNTERTYPE = "DR" Then
        '        Me.Caption = "DR Out Issuance Data Entry"
        '        Set rsOrd_Hd = New ADODB.Recordset
        '        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where trantype = 'DR' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
        '    End If
        '    If COUNTERTYPE = "ADB" Then
        '        Me.Caption = "Advance Bill Data Entry"
        '        Set rsOrd_Hd = New ADODB.Recordset
        '        rsOrd_Hd.Open "select * from PMIS_Ord_Hd where trantype = 'ADB' order by tranno asc", gconDMIS, adOpenForwardOnly, adLockReadOnly
        '    End If
        'End If
...
Sub SetCustInfo(rep As String)
    ...
    rsREPOR.Open "select rep_or,niym,acct_no,invoice,model , plate_no from CSMS_repor where rep_or = '" & txtRONO.Text & "'", gconDMIS
    If Not rsREPOR.EOF And Not rsREPOR.BOF Then
        If Null2String(rsREPOR!invoice) <> "" Then
            ...
            If MsgBox("Would You Like to Continue?", vbQuestion + vbYesNo, "Continue...") = vbNo Then
                ...
                Exit Sub
            Else
                MsgBox "Pls. Input Reference Advanced Bill from Remarks Field..."
                On Error Resume Next
                txtRemarks.SetFocus
            End If
        End If
        ...
        If Null2String(rsREPOR!plate_no) <> "" Then
            ...
            End If
        End If
        'txtCustName.Text = "Name: " & txtCustName.Text & vbCrLf & "Model: " & Null2String(rsREPOR!model)
...
Private Sub Form_Unload(Cancel As Integer)
    PMIS_ORDER_SHOW = False: Set frmPMISCustomerOrder = Nothing
    UnloadForm Me
End Sub
