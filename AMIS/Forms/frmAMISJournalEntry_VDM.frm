...
Begin VB.Form frmAMISJournalEntry_VDM 
   BackColor       =   &H00E0E0E0&
   ...
   ClientWidth     =   9855
   ForeColor       =   &H00FFFFFF&
   Icon            =   "frmAMISJournalEntry_VDM.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8820
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   176
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8070
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   175
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7320
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   174
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6540
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   173
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5790
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":1B5D
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":1CAF
         Style           =   1  'Graphical
         TabIndex        =   172
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5040
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":1FD4
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":2126
         Style           =   1  'Graphical
         TabIndex        =   171
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4290
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":2482
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":25D4
         Style           =   1  'Graphical
         TabIndex        =   170
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":28E7
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":2A39
         Style           =   1  'Graphical
         TabIndex        =   169
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":2D89
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":2EDB
         Style           =   1  'Graphical
         TabIndex        =   168
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2040
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":3239
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":338B
         Style           =   1  'Graphical
         TabIndex        =   167
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1290
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":3685
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":37D7
         Style           =   1  'Graphical
         TabIndex        =   166
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   540
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":3B2F
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":3C81
         Style           =   1  'Graphical
         TabIndex        =   165
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      TabPicture(0)   =   "frmAMISJournalEntry_VDM.frx":3FE0
      ...
      TabPicture(1)   =   "frmAMISJournalEntry_VDM.frx":3FFC
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8315
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":4018
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":416A
            Style           =   1  'Graphical
            TabIndex        =   160
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":44A8
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":45FA
            Style           =   1  'Graphical
            TabIndex        =   143
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               BackColor       =   16777215
               MultiLine       =   0   'False
               TextRTF         =   $"frmAMISJournalEntry_VDM.frx":4925
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":49B8
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":4B0A
            Style           =   1  'Graphical
            TabIndex        =   159
            Top             =   765
            Width           =   705
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_VDM.frx":4E5A
      End
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   8400
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":4E76
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":4FC8
            Style           =   1  'Graphical
            TabIndex        =   116
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":5306
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":5458
            Style           =   1  'Graphical
            TabIndex        =   114
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7710
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":5783
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VDM.frx":58D5
            Style           =   1  'Graphical
            TabIndex        =   115
            Top             =   690
            Width           =   705
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_VDM.frx":5C25
      End
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":5C41
            NumItems        =   7
      ...
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_VDM.frx":5DA3
            NumItems        =   6
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VDM.frx":5F05
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picDisbursement 
         ...
         Begin RichTextLib.RichTextBox txtParticulars 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VDM.frx":5F9C
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VDM.frx":6030
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   765
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":60C7
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":6219
         Style           =   1  'Graphical
         TabIndex        =   163
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   10
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":6557
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VDM.frx":66A9
         Style           =   1  'Graphical
         TabIndex        =   162
   ...
   Begin wizButton.cmd cmdShowPostRange 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_VDM.frx":69F9
   End
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":6A15
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_VDM.frx":6B77
   End
   Begin VB.PictureBox picShowPostRange 
      ...
      Begin wizProgBar.Prg prgPostRange 
         ...
         _ExtentX        =   4154
         _ExtentY        =   503
         Picture         =   "frmAMISJournalEntry_VDM.frx":6B93
         ForeColor       =   0
         BarPicture      =   "frmAMISJournalEntry_VDM.frx":6BAF
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_VDM.frx":6BCB
   End
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_VDM.frx":6BE7
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   End
End
Attribute VB_Name = "frmAMISJournalEntry_VDM"
...
'    Set rsJournal_HD = gconDMIS.Execute("Select * from AMIS_Journal_HD Where Jtype = '" & XXX & "' Order by VoucherNo desc")
    Set rsJournal_HD = gconDMIS.Execute("Select substring(voucherno,4,len(voucherno)) voucherno from AMIS_Journal_HD Where Jtype = '" & XXX & "' Order by VoucherNo desc")
...
Sub cmdPVSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        End If
        'FOR CDJ
        If xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "VCJ" Or xJOURNALTYPE = "VDM" Then
            'Update: ACL 010410
            Dim J_CLASS                                     As String
            Dim rsJClass                                    As ADODB.Recordset
            Set rsJClass = New ADODB.Recordset
            rsJClass.Open "SELECT DET.ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE WHERE LEFT(ACCT_CODE,5) IN ('21-01','21-02') AND HD.VOUCHERNO = '" & txtVoucherNo.Text & "'", gconDMIS
    ...
    Else
        ...
        If rsDet.EOF And rsDet.BOF Then
            If CDJ_IS_FROM_AP = True Then
                ...
                If COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HBK" Then
                ...
                ElseIf COMPANY_CODE = "HGC" Then
                    ...
                    Set rsDet = gconDMIS.Execute("Select Acct_code,acct_name from AMIS_journal_det where voucherno =" & PV_MRRNO & " and jtype = 'APJ' and (left(acct_code,5)='21-01' or left(acct_code,5)='21-02' or left(acct_code,5)='21-07' or left(acct_code,5)='21-06') ")
...
Sub FillDetails()
    ...
    If xJOURNALTYPE <> "GJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "CLO" Then
        ...
        Else
            Screen.MousePointer = 0
            If xJOURNALTYPE = "VDM" Or xJOURNALTYPE = "VCJ" Or xJOURNALTYPE = "CSJ" Or xJOURNALTYPE = "CCM" Then
            Else
                cmdPost.Enabled = False
            End If
        End If
        ...
        If xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "VCJ" Or xJOURNALTYPE = "VDM" Then
            ...
            If Not rsCV_Detail.EOF And Not rsCV_Detail.BOF Then
                Screen.MousePointer = 11
                If xJOURNALTYPE = "VDM" Or xJOURNALTYPE = "VCJ" Then    ' Update by BTT 11252008
...
Sub InitCbo()
    ...
    If xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "VDM" Or xJOURNALTYPE = "VCJ" Then
...
'    Set rsJournal_HDDup = gconDMIS.Execute("select voucherno from AMIS_Journal_HD where jtype = '" & xJOURNALTYPE & "' order by voucherno desc")
    Set rsJournal_HDDup = gconDMIS.Execute("select substring(voucherno,4,len(voucherno))voucherno from AMIS_Journal_HD where jtype = '" & xJOURNALTYPE & "' order by voucherno desc")
...
Private Sub cboAcct_Code_Change()
   ...
   Dim rsWTE As ADODB.Recordset
    Set rsWTE = New ADODB.Recordset
    Set rsWTE = gconDMIS.Execute("select * from AMIS_CHARTACCOUNT where AcctCode = '" & cboAcct_Code.Text & "'  and TranType1 = 'EXPANDED'")
    If Not rsWTE.EOF And Not rsWTE.BOF Then
        fraATC.Visible = True
...
Private Sub cmdCancelCO_Click()
    ...
    If MsgBox("Are you sure you want to Cancel this Transaction?", vbQuestion + vbYesNo, "Cancel Journal") = vbYes Then
        ...
        If xJOURNALTYPE = "VDM" Then
            ...
            SQL_STATEMENT = "update AMIS_CRJ_Detail set status = 'C',JDATE=" & N2Date2Null(txtJDate.Text) & " where CR_TYPE='" & xJOURNALTYPE & "' AND VoucherNo = " & N2Str2Null(txtVoucherNo.Text)
            gconDMIS.Execute SQL_STATEMENT
        End If
        rsRefresh
        rsJournal_HD.Find "id = " & labID.Caption
...
Private Sub cmdJournalSave_Click()
    ...
    If (txtTaxBase.Text = "" Or txtTaxBase.Text = "0.00") And fraATC.Visible = True Then
        MsgBox "Tax base must have a Value.", vbInformation, ""
        On Error Resume Next
        txtTaxBase.SetFocus
        Exit Sub
    ElseIf cboATC.Text = "" And fraATC.Visible = True Then
        MsgBox "ATC code must have a value.", vbInformation, ""
        On Error Resume Next
        cboATC.SetFocus
        Exit Sub
    Else
...
On Error GoTo ErrorCode:
    ...
    If JournalPosting = False Then
        str_MSG = Replace(str_MSG, "@ACL09182716350", "Vendor Debit Memo")
...
'        If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "VDJ" Then
...
'                Set rsCheckDetails = gconDMIS.Execute("Select Acct_Code, Credit from AMIS_Journal_Det Where (left(Acct_Code,5) = '21-01' OR left(Acct_Code,5) = '21-02'  OR left(Acct_Code,5) = '21-07' OR left(Acct_Code,5) = '21-06') and Jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
...
'                End If
'                Set rsCheckDetails = New ADODB.Recordset
'                Set rsCheckDetails = gconDMIS.Execute("Select Acct_Code, debit from AMIS_Journal_Det Where (left(Acct_Code,5) = '21-01' or left(Acct_Code,5) = '21-02' or left(Acct_Code,5) = '21-07'or left(Acct_Code,5) = '21-06') and Jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
'                If Not rsCheckDetails.EOF And Not rsCheckDetails.BOF Then
'                    rsCheckDetails.MoveFirst
'                    TotalCRJ_Credit = 0
'                    Do While Not rsCheckDetails.EOF
...
Private Sub cmdPrint_Click()
    ...
    If Ans = vbYes Then
        ...
        If xJOURNALTYPE = "CDJ" Then cmdPrinting.ZOrder 0: picPrinting.ZOrder 0: If COMPANY_CODE = "HSB" Or COMPANY_CODE = "HCR" Then optCHINBANK.Caption = "BPI Bank"
        ...
        If xJOURNALTYPE = "VDM" Then ShowReport "VendorDebitMemo", "Vouchers", "{Journal_Hd.jno} = '" & txtJNo.Text & "'", "VENDOR DEBIT MEMO", LOGDATE, False
        If xJOURNALTYPE = "VCJ" Then ShowReport "AdjustmentCPayable", "Vouchers", "{Journal_Hd.jno} = '" & txtJNo.Text & "'", "VENDOR CREDIT MEMO", LOGDATE, False
        If xJOURNALTYPE = "OPB" Then ShowReport "AccountsOpenningBalance", "Vouchers", "{Amis_journal_hd.VOUCHERNO} = '" & txtVoucherNo.Text & "' and {Amis_journal_hd.jtype} = 'OPB'", "OPENING BALANCE", LOGDATE, False
    ...
    If xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "VCJ" Then
        ...
        If Not rsCheckJournal_HD.EOF And Not rsCheckJournal_HD.BOF Then
            ...
            If Null2String(rsCheckJournal_HD!JTYPE) = "VPJ" Then
                ...
                NEW_LogAudit "XX", "JOURNAL ENTRY", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
            End If
            If Null2String(rsCheckJournal_HD!JTYPE) = "VDM" Then
                SQL_STATEMENT = "update AMIS_Journal_HD set" & _
                                " PaidStatus = 'N' " & "," & _
                                " AmountPaid = AmountPaid - " & PV_AMOUNT & "," & _
                                " Balance = (Balance + " & PV_AMOUNT & ")" & _
                                " where VoucherNo = " & PV_MRRNO & " and Jtype = 'VDM'"
                gconDMIS.Execute SQL_STATEMENT
                NEW_LogAudit "XX", "JOURNAL ENTRY", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
            End If
        End If
...
Private Sub cmdSave_Click()
    ...
    If txtJDate.Text = "" Or IsDate(txtJDate.Text) = False Then
        ...
        Exit Sub
    End If
    If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "VDM" Then
    ...
    If xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "VDM" Then
        ' ' update by BTT
    ...
    End If
    J_JNO = N2Str2Null(txtJNo.Text)
    If xJOURNALTYPE = "VDM" Or xJOURNALTYPE = "CSJ" Then
    ...
    Else
       ...
       If COMPANY_CODE = "HCE" Then
             ''updated by RRL /05/18/15
           SQL_STATEMENT = "Update amis_details set " & _
                         "jdate= " & J_JDATE & " " & _
                         "where voucherno= '" & txtVoucherNo.Text & "' and jtype=" & J_JTYPE & ""
            gconDMIS.Execute SQL_STATEMENT
        
         ''updated by RRL /05/18/15
           SQL_STATEMENT = "Update amis_detail set " & _
                         "jdate= " & J_JDATE & " " & _
                         "where voucherno= '" & txtVoucherNo.Text & "' and jtype=" & J_JTYPE & ""
            gconDMIS.Execute SQL_STATEMENT
        End If
...
Private Sub Form_Load()
    ...
    If xJOURNALTYPE = "VDM" Then
        ...
        LocalAcess = "VENDOR DEBIT MEMO"       '"GENERAL JOURNAL - VENDOR DEBIT MEMO"
...
Private Sub lstDetails_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    ElseIf KeyCode = vbKeyF2 Then
        If COMPANY_CODE <> "DGI" And COMPANY_CODE <> "HMH" And COMPANY_CODE <> "DJM" Then
            LOAD_ARAP_DETAILS
        End If
    End If
End Sub
...
Private Sub txtBankCode_Change()
    If xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "VDM" Or xJOURNALTYPE = "VCJ" Then cboBankName.Text = SetBankName(txtBankCode.Text)
...
Function JournalPosting() As Boolean
    ...
    End If
    If MsgBox("Are you sure you want to Post this transaction?", vbQuestion + vbYesNo, "Message") = vbYes Then
        If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "CCM" And xJOURNALTYPE <> "VDM" Then
        ...
        Screen.MousePointer = 11
If COMPANY_CODE <> "DGI" And COMPANY_CODE <> "HMH" Then
    If COMPANY_CODE = "HMH" Then
    Else
...
PostJournal:
        ...
        If xJOURNALTYPE = "CCM" Or xJOURNALTYPE = "VDM" Then
