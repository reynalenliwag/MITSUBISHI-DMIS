...
'    OUTPUT TAX
    ...
    rsTAX.Open "SELECT UPPER(DESCRIPTION) AS DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE TRANTYPE1 IN ('INPUT TAX','OUTPUT TAX','EXPANDED','CREDITABLE','COMPENSATION','DEFERRED OUTPUT TAX')", gconDMIS, adOpenKeyset
...
Private Sub cboOption_Click()
    initGrid
    If GET_TRANTYPE(cboOption.Text) = "DEFERRED OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "INPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Then
...
Private Sub cmdPrint_Click()
    ...
    If GET_TRANTYPE(cboOption.Text) = "INPUT TAX" Then
        ...
        If Not rsREPORTS.EOF And Not rsREPORTS.BOF Then
            Do While Not rsREPORTS.EOF
                ...
                xlsWorkSheet.Cells(9 + ellaine, "G") = Null2String(rsREPORTS!TIN)
            ...
            Loop
        End If
    ElseIf GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "DEFERRED OUTPUT TAX" Then
        If Len(Dir(AMIS_REPORT_PATH & "TAX.xlt")) = 0 Then
            MsgBox "Report file cannot be found.", vbInformation
            Exit Sub
        End If
        ...
        If Not rsREPORTS.EOF And Not rsREPORTS.BOF Then
            Do While Not rsREPORTS.EOF
                ...
                xlsWorkSheet.Cells(9 + ellaine, "A") = Null2String(rsREPORTS!JDATE)
                xlsWorkSheet.Cells(9 + ellaine, "B") = Null2String(rsREPORTS!JOURNALNO)
                xlsWorkSheet.Cells(9 + ellaine, "C") = Null2String(rsREPORTS!CustomerCode)
                xlsWorkSheet.Cells(9 + ellaine, "D") = Null2String(rsREPORTS!lastname)
                xlsWorkSheet.Cells(9 + ellaine, "E") = Null2String(rsREPORTS!FIRSTNAME)
                xlsWorkSheet.Cells(9 + ellaine, "F") = Null2String(rsREPORTS!MiddleName)
                xlsWorkSheet.Cells(9 + ellaine, "G") = Null2String(rsREPORTS!Address)
                xlsWorkSheet.Cells(9 + ellaine, "H") = Null2String(rsREPORTS!CITY)
                xlsWorkSheet.Cells(9 + ellaine, "I") = Null2String(rsREPORTS!TIN)
                xlsWorkSheet.Cells(9 + ellaine, "J") = ToDoubleNumber(rsREPORTS!GROSS)
                xlsWorkSheet.Cells(9 + ellaine, "K") = ToDoubleNumber(rsREPORTS!NET)
                xlsWorkSheet.Cells(9 + ellaine, "L") = ToDoubleNumber(rsREPORTS!VAT)
                xlsWorkSheet.Cells(9 + ellaine, "M") = ToDoubleNumber(rsREPORTS!RUNNINGBALANCE)
                rsREPORTS.MoveNext
                Loading
                ellaine = ellaine + 1
            Loop
        ...
        If Not rsREPORTS.EOF And Not rsREPORTS.BOF Then
            If COMPANY_CODE = "DJM" Then
                Do While Not rsREPORTS.EOF
                    ...
                    xlsWorkSheet.Cells(15 + ellaine, "B") = Null2String(rsREPORTS!NAMEOFENTITY)
                    xlsWorkSheet.Cells(15 + ellaine, "C") = Null2String(rsREPORTS!Address)
                    xlsWorkSheet.Cells(15 + ellaine, "D") = Null2String(rsREPORTS!TIN)
                    xlsWorkSheet.Cells(15 + ellaine, "E") = Null2String(rsREPORTS!INVOICENO)
                    xlsWorkSheet.Cells(15 + ellaine, "F") = Null2String(rsREPORTS!NO_UNITS)
                    xlsWorkSheet.Cells(15 + ellaine, "G") = Null2String(rsREPORTS!Model)
                    xlsWorkSheet.Cells(15 + ellaine, "H") = Null2String(rsREPORTS!ENGINENO)
                    xlsWorkSheet.Cells(15 + ellaine, "I") = Null2String(rsREPORTS!VINO)
                    rsREPORTS.MoveNext
                    Loading
                    ellaine = ellaine + 1
                Loop
    ...
    ElseIf cboOption.Text = "ORB LIST OF SALES" Then
        ...
        If Not rsREPORTS.EOF And Not rsREPORTS.BOF Then
            If COMPANY_CODE = "DJM" Then
                Do While Not rsREPORTS.EOF
                    xlsWorkSheet.Cells(15 + ellaine, "A") = Null2String(rsREPORTS!invoicedate)
                    xlsWorkSheet.Cells(15 + ellaine, "B") = Null2String(rsREPORTS!modeldescription)
                    xlsWorkSheet.Cells(15 + ellaine, "C") = Null2String(rsREPORTS!ENGINENO)
                    xlsWorkSheet.Cells(15 + ellaine, "D") = Null2String(rsREPORTS!VINO)
                    xlsWorkSheet.Cells(15 + ellaine, "E") = Null2String(rsREPORTS!NAMEOFENTITY)
                    xlsWorkSheet.Cells(15 + ellaine, "F") = Null2String(rsREPORTS!Address)
                    xlsWorkSheet.Cells(15 + ellaine, "G") = Null2String(rsREPORTS!INVOICENO)
                    xlsWorkSheet.Cells(15 + ellaine, "H") = Null2String(rsREPORTS!SELLINGPRICE)
                    rsREPORTS.MoveNext
                    Loading
                    ellaine = ellaine + 1
                Loop
...
Private Sub Form_Load()
    ...
    rsMAX_MIN_DATE.Open "SELECT * FROM (SELECT MAX(JDATE) AS MAX_JDATE, MIN(JDATE) AS MIN_JDATE FROM AMIS_JOURNAL_HD HD WHERE STATUS = 'P' AND HD.JTYPE NOT IN ('OPB','VPJ','COB'))T WHERE MAX_JDATE IS NOT NULL", gconDMIS, adOpenKeyset
...
Sub initGrid()
    With Grid1
        If GET_TRANTYPE(cboOption.Text) = "INPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "DEFERRED OUTPUT TAX" Then
            .Cols = 12
        ...
        .Cell(0, 0).Text = "L/N"
        If GET_TRANTYPE(cboOption.Text) = "INPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "DEFERRED OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "EXPANDED" Or GET_TRANTYPE(cboOption.Text) = "COMPENSATION" Or GET_TRANTYPE(cboOption.Text) = "CREDITABLE" Then
            .Cell(0, 1).Text = "DATE"
            .Column(1).Width = 65
        ...
        If GET_TRANTYPE(cboOption.Text) = "INPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "EXPANDED" Or GET_TRANTYPE(cboOption.Text) = "COMPENSATION" Then
            ...
            .Column(4).Width = 200
        ElseIf GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "DEFERRED OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "CREDITABLE" Then
        ...
        If cboOption.Text = "ORB LIST OF PURCHASES" Then
            If COMPANY_CODE = "DJM" Then
                ...
                .Cell(0, 2).Text = "NAME OF SUPPLIER"
                .Column(2).Alignment = cellCenterCenter
                .Column(2).Width = 200
    
                .Cell(0, 3).Text = "ADDRESS"
                .Column(3).Alignment = cellCenterCenter
                .Column(3).Width = 200
                ...
                .Cell(0, 7).Text = "MAKE MODEL"
                .Column(7).Width = 110
    
                .Cell(0, 8).Text = "ENGINE NO."
                .Column(8).Width = 110
                
                .Cell(0, 9).Text = "VIN NO."
                .Column(9).Width = 110
            Else
                .Cell(0, 1).Text = "DATE"
                .Column(1).Width = 65
        ...
        ElseIf cboOption.Text = "ORB LIST OF SALES" Then
            If COMPANY_CODE = "DJM" Then
                ...
                .Cell(0, 3).Text = "ENGINE NO."
                .Column(3).Width = 110
                
                .Cell(0, 4).Text = "VIN"
                .Column(4).Width = 110
                
                .Cell(0, 5).Text = "NAME OF BUYER"
                .Column(5).Width = 200
                
                .Cell(0, 6).Text = "ADDRESS"
                .Column(6).Width = 200
                
                .Cell(0, 7).Text = "SALES INVOICE NO."
                .Column(7).Alignment = cellCenterCenter
                .Column(7).Width = 110
                
                .Cell(0, 8).Text = "NET OF VAT"
                .Column(8).Width = 110
                .Column(8).Alignment = cellRightCenter
            Else
                .Cell(0, 1).Text = "DATE"
        ...
        If GET_TRANTYPE(cboOption.Text) = "INPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "DEFFERED OUTPUT TAX" Then
...
Sub FILLREPORTS()
    ...
    If Not rsREPORTS.EOF And Not rsREPORTS.BOF Then
        While Not rsREPORTS.EOF
            ...
            ElseIf TAXREPORT = "OUTPUT TAX" Or TAXREPORT = "DEFERRED OUTPUT TAX" Then
                
                Dim DELIMTER As String
                If IsNull(rsREPORTS!FIRSTNAME) = False Then
                    DELIMTER = ", "
                Else
                    DELIMTER = ""
                End If
                ...
                Grid1.AddItem _
                            rsREPORTS!JDATE & Chr(9) & rsREPORTS!JOURNALNO & Chr(9) & _
                            rsREPORTS!CustomerCode & Chr(9) & rsREPORTS!lastname & DELIMTER & _
                            rsREPORTS!FIRSTNAME & " " & rsREPORTS!MiddleName & Chr(9) & _
                            Null2String(rsREPORTS!Address) & Chr(9) & Null2String(rsREPORTS!CITY) & Chr(9) & rsREPORTS!TIN & Chr(9) & _
                            ToDoubleNumber(rsREPORTS!GROSS) & Chr(9) & ToDoubleNumber(rsREPORTS!NET) & Chr(9) & _
                            ToDoubleNumber(rsREPORTS!VAT) & Chr(9) & ToDoubleNumber(rsREPORTS!RUNNINGBALANCE)
            ...
            ElseIf TAXREPORT = "SLP" Then
                If COMPANY_CODE = "DJM" Then
                    Grid1.AddItem _
                            rsREPORTS!invoicedate & Chr(9) & _
                            rsREPORTS!NAMEOFENTITY & Chr(9) & _
                            rsREPORTS!Address & Chr(9) & _
                            rsREPORTS!TIN & Chr(9) & _
                            rsREPORTS!INVOICENO & Chr(9) & _
                            Null2String(rsREPORTS!NO_UNITS) & Chr(9) & _
                            Null2String(rsREPORTS!Model) & Chr(9) & _
                            rsREPORTS!ENGINENO & Chr(9) & _
                            rsREPORTS!VINO
                Else
                    Grid1.AddItem _
            ...
            ElseIf TAXREPORT = "SLS" Then
                If COMPANY_CODE = "DJM" Then
                    Grid1.AddItem _
                            rsREPORTS!invoicedate & Chr(9) & _
                            Null2String(rsREPORTS!modeldescription) & Chr(9) & _
                            rsREPORTS!ENGINENO & Chr(9) & _
                            rsREPORTS!VINO & Chr(9) & _
                            rsREPORTS!NAMEOFENTITY & Chr(9) & _
                            rsREPORTS!Address & Chr(9) & _
                            rsREPORTS!INVOICENO & Chr(9) & _
                            ToDoubleNumber(rsREPORTS!SELLINGPRICE)
                Else
                    Grid1.AddItem _
                            rsREPORTS!invoicedate & Chr(9) & rsREPORTS!INVOICENO & Chr(9) & _
                            rsREPORTS!NAMEOFENTITY & Chr(9) & rsREPORTS!Address & Chr(9) & _
...
Sub INPUT_OUTPUT_TAX()
    If GET_TRANTYPE(cboOption.Text) = "OUTPUT TAX" Or GET_TRANTYPE(cboOption.Text) = "DEFERRED OUTPUT TAX" Then

            xlsWorkSheet.Cells(8, "D") = "LAST NAME"
            ...
            xlsWorkSheet.Cells(8, "E") = "FIRST NAME"
            ...
            xlsWorkSheet.Cells(8, "F") = "MIDDLE INITIAL"
            ...
            xlsWorkSheet.Cells(8, "G") = "ADDRESS"
            ...
            xlsWorkSheet.Cells(8, "J") = "GROSS AMOUNT"
            ...
            xlsWorkSheet.Cells(8, "K") = "NET OF VAT"
            ...
            xlsWorkSheet.Cells(8, "M") = "RUNNING-BALANCE"
            xlsWorkSheet.Cells(8, "M").BorderAround ColorIndex:=1, Weight:=xlThin
            xlsWorkSheet.Cells(8, "M").Font.Bold = True
            xlsWorkSheet.Cells(8, "M").Interior.Color = &HF5D8BC
