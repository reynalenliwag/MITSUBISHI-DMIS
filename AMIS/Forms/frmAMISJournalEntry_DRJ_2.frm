...
Begin VB.Form frmAMISJournalEntry_DRJ_2 
   ...
   ClientWidth     =   9735
   ForeColor       =   &H00FFFFFF&
   Icon            =   "frmAMISJournalEntry_DRJ_2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picDisbursement 
         ...
         Begin RichTextLib.RichTextBox txtParticulars 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":08CA
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":095E
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":09F5
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8550
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":0A8C
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":0BDE
         Style           =   1  'Graphical
         TabIndex        =   217
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7770
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":0F44
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":1096
         Style           =   1  'Graphical
         TabIndex        =   216
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":13FC
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":154E
         Style           =   1  'Graphical
         TabIndex        =   215
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6255
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":1888
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":19DA
         Style           =   1  'Graphical
         TabIndex        =   214
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5505
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":1D1F
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":1E71
         Style           =   1  'Graphical
         TabIndex        =   213
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4755
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":2196
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":22E8
         Style           =   1  'Graphical
         TabIndex        =   212
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4005
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":2644
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":2796
         Style           =   1  'Graphical
         TabIndex        =   211
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3255
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":2AA9
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":2BFB
         Style           =   1  'Graphical
         TabIndex        =   210
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2505
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":2F4B
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":309D
         Style           =   1  'Graphical
         TabIndex        =   209
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1755
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":33FB
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":354D
         Style           =   1  'Graphical
         TabIndex        =   208
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1005
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":3847
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":3999
         Style           =   1  'Graphical
         TabIndex        =   207
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   255
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":3CF1
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":3E43
         Style           =   1  'Graphical
         TabIndex        =   206
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      TabPicture(0)   =   "frmAMISJournalEntry_DRJ_2.frx":41A2
      ...
      Tab(0).Control(4)=   "picDatePosted"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).ControlCount=   5
      TabCaption(1)   =   "[<F4> Add &Details]   [<Ctrl+D> View &Details]   "
      TabPicture(1)   =   "frmAMISJournalEntry_DRJ_2.frx":41BE
      ...
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":41DA
            NumItems        =   6
      ...
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":433C
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_DRJ_2.frx":449E
      End
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":44BA
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":460C
            Style           =   1  'Graphical
            TabIndex        =   154
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7110
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":4937
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":4A89
            Style           =   1  'Graphical
            TabIndex        =   155
            Top             =   735
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   7845
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":4DD9
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":4F2B
            Style           =   1  'Graphical
            TabIndex        =   157
            Top             =   735
            Width           =   705
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   240
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":5269
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":53BB
            Style           =   1  'Graphical
            TabIndex        =   184
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               Enabled         =   -1  'True
               MultiLine       =   0   'False
               TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":56E6
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8310
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":5779
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":58CB
            Style           =   1  'Graphical
            TabIndex        =   201
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":5C09
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":5D5B
            Style           =   1  'Graphical
            TabIndex        =   200
            Top             =   720
            Width           =   705
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_DRJ_2.frx":60AB
      End
   End
   ...
   Begin wizButton.cmd cmdShowPostRange 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_DRJ_2.frx":60C7
   End
   Begin VB.PictureBox picShowPostRange 
      ...
      Begin wizProgBar.Prg prgPostRange 
         ...
         _ExtentX        =   4048
         _ExtentY        =   503
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":60E3
         ForeColor       =   0
         BarPicture      =   "frmAMISJournalEntry_DRJ_2.frx":60FF
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":611B
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   765
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":627D
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":63CF
         Style           =   1  'Graphical
         TabIndex        =   204
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   15
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":670D
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_DRJ_2.frx":685F
         Style           =   1  'Graphical
         TabIndex        =   203
   ...
   Begin VB.PictureBox picGJ 
      ...
      Begin MSComctlLib.ListView lstGJ 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":6BAF
         NumItems        =   6
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "ITEM #"
            Object.Width           =   1587
      ...
      Begin VB.PictureBox picGJEntry 
         ...
         Begin VB.CommandButton cmdGJCancel 
            ...
            Left            =   8160
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":6D11
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":6E63
            Style           =   1  'Graphical
            TabIndex        =   102
            Top             =   1050
            Width           =   1005
         ...
         Begin VB.CommandButton cmdGJSave 
            ...
            Left            =   7140
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":7175
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":72C7
            Style           =   1  'Graphical
            TabIndex        =   100
            Top             =   1050
            Width           =   975
         ...
         Begin VB.CommandButton cmdGJDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":7709
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_DRJ_2.frx":785B
            Style           =   1  'Graphical
            TabIndex        =   99
            Top             =   1050
            Width           =   1005
         ...
         Begin RichTextLib.RichTextBox txtGJAccountName 
            ...
            MultiLine       =   0   'False
            Appearance      =   0
            TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":7B65
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   9
               Charset         =   0
         ...
         Begin RichTextLib.RichTextBox txtGJAccountParticulars 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":7BF8
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin wizButton.cmd cmdGJEntry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_DRJ_2.frx":7C8F
      End
      Begin RichTextLib.RichTextBox txtParticulars2 
         ...
         Enabled         =   -1  'True
         ScrollBars      =   2
         TextRTF         =   $"frmAMISJournalEntry_DRJ_2.frx":7CAB
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
   ...
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_DRJ_2.frx":7D42
   End
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_DRJ_2.frx":7D5E
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_DRJ_2.frx":7EC0
   End
   ...
   End
End
Attribute VB_Name = "frmAMISJournalEntry_DRJ_2"
...
Dim rsDRJParticulars                                        As New ADODB.Recordset
Dim rsCboCusName                                            As New ADODB.Recordset
Dim rsAMIS_HD                                               As New ADODB.Recordset
...
'SJR 082114
Function StoreDRJParticulars(ByVal ID As Variant)
    Set rsAMIS_HD = New ADODB.Recordset: Set rsDRJParticulars = New ADODB.Recordset: Set rsCboCusName = New ADODB.Recordset
    rsAMIS_HD.Open "SELECT JNo,JItemNo,ADJ_REMARKS,INVOICENO,INVOICETYPE,ENTITY from AMIS_JOURNAL_DET where ID = " & N2Str2Null(ID), gconDMIS, adOpenForwardOnly, adLockReadOnly
    rsDRJParticulars.Open "select JNo,JItemNo,ADJ_REMARKS,INVOICENO,INVOICETYPE,ENTITY from AMIS_JOURNAL_DET where ID = " & N2Str2Null(ID), gconDMIS, adOpenForwardOnly, adLockReadOnly
    rsCboCusName.Open "SELECT * FROM " & _
                        ...
                        "WHERE TABLEENTIY.CODE='" & Mid(rsDRJParticulars!ENTITY, 2) & "'", gconDMIS
                        
                     
    If Not rsDRJParticulars.EOF And Not rsDRJParticulars.BOF Then

         'Cash in Bank
        If lstDetails.SelectedItem.SubItems(1) = "11-01005-00" Then
            txtCustCode.Text = ""
            cboCustName.Text = ""
            cboInvoiceType.Text = ""
            txtBankName.ZOrder 0
            txtRemarks2.Text = Null2String(rsAMIS_HD!ADJ_REMARKS)
            txtInvoiceNo.Text = Null2String(rsAMIS_HD!INVOICENO)
            
        'Cash on Hand
        ElseIf lstDetails.SelectedItem.SubItems(1) = "11-01000-00" Then
            txtRemarks2.Text = Null2String(rsDRJParticulars!ADJ_REMARKS)
            txtInvoiceNo.Text = Null2String(rsDRJParticulars!INVOICENO)
            cboInvoiceType.Text = Null2String(rsDRJParticulars!INVOICETYPE)
            cboCustName.Text = Null2String(rsCboCusName!ACCOUNTNAME)
            txtBankName.ZOrder 1
            cboCustName.ZOrder 0
...
Sub SendToBack()
    ...
    'SJR 082814
    cboCustName.ZOrder 1
    txtCustCode.ZOrder 1
    txtBankName.ZOrder 0
    txtInvoiceNo.Text = ""
End Sub
...
'SJR 082114
Private Sub cboBankName2_Change()
txtBankName.Text = cboBankName2.Text
End Sub
...
Private Sub cmdFind_Click()
    ...
    ElseIf xJOURNALTYPE = "DRJ" Then
        frmAMISSearchDRJ_2_2.Show vbModal
    Else
...
Private Sub cmdPrint_Click()
    ...
    If xJOURNALTYPE = "DRJ" Then
        If COMPANY_CODE = "HCA" Then
            ShowReport "DepositedReceiptsHCA", "Vouchers", "{Journal_Hd.VOUCHERNO} = '" & txtVoucherNo.Text & "'", "DEPOSITED CASH RECEIPTS JOURNAL PRINTOUT", LOGDATE, False
        Else
            ShowReport "DepositedReceipts", "Vouchers", "{Journal_Hd.jno} = '" & txtJNo.Text & "'", "DEPOSITED CASH RECEIPTS JOURNAL PRINTOUT", LOGDATE, False
        End If
    End If
...
Private Sub Form_Load()
    ...
    ElseIf xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "DRJ" Then
        ...
        labDate.Caption = "Date Deposited": labTerms.Visible = False
        picReceivable.Visible = True: picReceivable.ZOrder 0: picReceivable.Enabled = True
        picPayables.Visible = False: picPayables.ZOrder 1: picPayables.Enabled = False
        picDisbursement.Visible = False: picDisbursement.ZOrder 1: picDisbursement.Enabled = False
...
Private Sub lstDetails_ItemClick(ByVal Item As MSComctlLib.ListItem)
                StoreDRJParticulars lstDetails.SelectedItem.SubItems(5)
End Sub
