...
Sub LOAD_ACCT_CODE()
    ...
    rsLOAD_ACCT_CODE.Open "SELECT DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,2) = '21' AND IS_SCHEDULE_ACCNT = '1'", gconDMIS, adOpenKeyset
    cboAR_ACCT_CODE.Clear
    
'JULIE : 01082013
If COMPANY_CODE = "HMH" Then
    cboAR_ACCT_CODE.AddItem "ALL"
    cboAR_ACCT_CODE.AddItem "ENTITY NAME"
Else
    cboAR_ACCT_CODE.AddItem "ALL"
...
Sub LOAD_AP_ENTITY()
    ...
    If cboAR_ACCT_CODE.Text = "ALL" Then
        ...
        'rsLOAD_AP.Open "SELECT JDATE,VOUCHERNO AS APVOUCHERNO,ISNULL(INVOICETYPE,'') + CASE WHEN INVOICETYPE IS NULL THEN '' ELSE '-' END + ISNULL(INVOICENO,'') AS INVOICE,AMOUNT2PAY,AMOUNTPAID,INVOICENO,INVOICETYPE,VENDOR_CODE,AP.ACCT_CODE,RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE WHERE STATUS='P' AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND Jdate >= '" & dtFrom.Value & "'and Jdate <= '" & dtTO.Value & "' ORDER BY JDATE,VOUCHERNO", gconDMIS, adOpenKeyset
'        rsLOAD_AP.Open "SELECT JDATE,VOUCHERNO AS APVOUCHERNO,INVOICENO AS INVOICE,AMOUNT2PAY,AMOUNTPAID,INVOICENO,INVOICETYPE,VENDOR_CODE,AP.ACCT_CODE,RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE WHERE STATUS='P' AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND AP.VENDOR_NAME = '" & RTrim(LTrim(txtName.Text)) & "' AND Jdate >= '" & dtFrom.Value & "'and Jdate <= '" & dtTO.Value & "' ORDER BY JDATE,VOUCHERNO", gconDMIS, adOpenKeyset
     
    ' 'updated by RRL 07/07/2015
        
        If COMPANY_CODE = "HSM" Then
           rsLOAD_AP.Open " SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,ap.INVOICENO AS INVOICE,AMOUNT2PAY,AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE," & _
              "VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE" & _
              " inner join AMIS_JOURNAL_DET dt on ap.Acct_code=dt.Acct_Code " & _
              "WHERE ap.STATUS='P' AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "'" & _
              "AND AP.VENDOR_NAME = '" & RTrim(LTrim(txtName.Text)) & "' AND ap.Jdate >= '" & dtFrom.Value & "'and ap.Jdate <= '" & dtTO.Value & "'" & _
              "group BY ap.JDATE,ap.VOUCHERNO ,ap.INVOICENO ,AMOUNT2PAY,AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE," & _
              "VENDOR_CODE , ap.ACCT_CODE, Right(ap.VOUCHERNO, 6) order by ap.jdate asc", gconDMIS, adOpenKeyset
        Else
             rsLOAD_AP.Open " SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,ap.INVOICENO AS INVOICE,AMOUNT2PAY,AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE," & _
              "VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE" & _
              " inner join AMIS_JOURNAL_DET dt on ap.Acct_code=dt.Acct_Code " & _
              ...
              "AND AP.VENDOR_NAME = '" & RTrim(LTrim(txtName.Text)) & "' AND ap.Jdate >= '" & dtFrom.Value & "'and ap.Jdate <= '" & dtTO.Value & "'" & _
              "group BY ap.JDATE,ap.VOUCHERNO ,ap.INVOICENO ,AMOUNT2PAY,AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE," & _
              "VENDOR_CODE , ap.ACCT_CODE, Right(ap.VOUCHERNO, 6)", gconDMIS, adOpenKeyset
        End If
    ElseIf cboAR_ACCT_CODE.Text = "ENTITY NAME" Then
        rsLOAD_AP.Open "SELECT JDATE,VOUCHERNO AS APVOUCHERNO,INVOICENO AS INVOICE,AMOUNT2PAY,AMOUNTPAID,INVOICENO,INVOICETYPE,VENDOR_CODE,AP.ACCT_CODE,RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE WHERE STATUS='P' AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND Jdate >= '" & dtFrom.Value & "'and Jdate <= '" & dtTO.Value & "' ORDER BY JDATE,VOUCHERNO", gconDMIS, adOpenKeyset
    Else
...
'        rsLOAD_AP.Open "SELECT JDATE,VOUCHERNO AS APVOUCHERNO,ISNULL(INVOICETYPE,'') + '-' + ISNULL(INVOICENO,'') AS INVOICE,AMOUNT2PAY,AMOUNTPAID,INVOICENO,INVOICETYPE,VENDOR_CODE,AP.ACCT_CODE,RIGHT(VOUCHERNO,6) AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE WHERE STATUS='P' AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND AP.VENDOR_NAME = '" & RTrim(LTrim(txtName.Text)) & "' AND Jdate >= '" & dtFrom.Value & "'and Jdate <= '" & dtTO.Value & "' AND " & _
'                       "ACCT_CODE = '" & GET_ACCTCODE((RTrim(LTrim(cboAR_ACCT_CODE.Text)))) & "' ORDER BY JDATE,APVOUCHERNO", gconDMIS, adOpenKeyset
    ''updated by RRL 07/07/2015
       If COMPANY_CODE = "HSM" Then
        rsLOAD_AP.Open "SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,ISNULL(ap.INVOICETYPE,'') + '-' + ISNULL(ap.INVOICENO,'')" & _
               "AS INVOICE,AMOUNT2PAY,AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE,VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6)" & _
               "AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE inner join amis_journal_det dt on ap.Acct_code=dt.Acct_Code where  ap.STATUS='P' " & _
               "AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "'  AND AP.VENDOR_NAME = '" & RTrim(LTrim(txtName.Text)) & "' " & _
               "AND ap.Jdate > =  '" & dtFrom.Value & "'and ap.Jdate <='" & dtTO.Value & "' AND ap.ACCT_CODE = '" & GET_ACCTCODE((RTrim(LTrim(cboAR_ACCT_CODE.Text)))) & "' group by ap.JDATE,ap.VOUCHERNO, ISNULL(ap.INVOICETYPE,'') + '-' + ISNULL(ap.INVOICENO,'') ," & _
               "AMOUNT2PAY , AMOUNTPAID, ap.INVOICENO, ap.INVOICETYPE, VENDOR_CODE, ap.ACCT_CODE, Right(ap.VOUCHERNO, 6)order by ap.jdate asc", gconDMIS, adOpenKeyset
       Else
               rsLOAD_AP.Open "SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,ISNULL(ap.INVOICETYPE,'') + '-' + ISNULL(ap.INVOICENO,'')" & _
               "AS INVOICE,AMOUNT2PAY,AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE,VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6)" & _
               "AS VOUCHERNO FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE inner join amis_journal_det dt on ap.Acct_code=dt.Acct_Code where  ap.STATUS='P' " & _
               "AND ISNULL(AC.TRANTYPE2,'')<>'DEPOSIT' AND AP.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "'  AND AP.VENDOR_NAME = '" & RTrim(LTrim(txtName.Text)) & "' " & _
               "AND ap.Jdate > =  '" & dtFrom.Value & "'and ap.Jdate <='" & dtTO.Value & "' AND ap.ACCT_CODE = '" & GET_ACCTCODE((RTrim(LTrim(cboAR_ACCT_CODE.Text)))) & "' group by ap.JDATE,ap.VOUCHERNO, ISNULL(ap.INVOICETYPE,'') + '-' + ISNULL(ap.INVOICENO,'') ," & _
               "AMOUNT2PAY , AMOUNTPAID, ap.INVOICENO, ap.INVOICETYPE, VENDOR_CODE, ap.ACCT_CODE, Right(ap.VOUCHERNO, 6) ", gconDMIS, adOpenKeyset
       End If
...
' JULIE : 01092013 updated by request HMH
    If COMPANY_CODE = "HMH" Then
        ...
        Else
            rsLOAD_AP.Open "SELECT DISTINCT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,AP.INVOICENO AS INVOICE,ap.AMOUNT2PAY,ap.AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE,ap.VENDOR_CODE,AD.VENDORCODE,AP.VENDOR_NAME,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6) AS VOUCHERNO, hd.remarks FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE INNER JOIN AMIS_DETAILS AD ON ap.VENDOR_CODE = ad.vendorcode AND AP.VOUCHERNO = AD.PV_VOUCHERNO inner join amis_journal_hd hd on ap.voucherno=hd.jtype+'-'+hd.voucherno WHERE AP.STATUS='P' AND ap.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND ap.Jdate >= '" & dtFrom.Value & "'and ap.Jdate <= '" & dtTO.Value & "'", gconDMIS, adOpenKeyset
    End If
        ...
        If Not rsLOAD_AP.EOF And Not rsLOAD_AP.BOF Then
            Do While Not rsLOAD_AP.EOF
                xVENDORCODE = Null2String(rsLOAD_AP!VENDOR_CODE)
                xVENDORNAME = Null2String(rsLOAD_AP!VENDOR_NAME)
                If Len(rsLOAD_AP!APVoucherno) = 10 Then
                    xVOUCHERNO = Left(Null2String(rsLOAD_AP!APVoucherno), 3)
                Else
                    xVOUCHERNO = Left(Null2String(rsLOAD_AP!APVoucherno), 2)
                ...
                If xVOUCHERNO = "VPJ" Or xVOUCHERNO = "COB" Or xVOUCHERNO = "APJ" Or xVOUCHERNO = "CDJ" Or xVOUCHERNO = "SJ" Or xVOUCHERNO = "CRJ" Or xVOUCHERNO = "GJ" Then
                    If xVENDORCODE1 <> xVENDORCODE Then
                    xCounter = xCounter + 2
                        xlWorksheet.Cells(xCounter, "A") = xVENDORCODE
                        xlWorksheet.Cells(xCounter, "B") = xVENDORNAME
                        xlWorksheet.Cells(xCounter, "A").Font.Bold = True
                        xlWorksheet.Cells(xCounter, "B").Font.Bold = True
                        xVENDORCODE1 = xVENDORCODE
                    End If
                    xCounter = xCounter + 1
...
'                    xlWorksheet.Cells(xCounter, "G") = (Trim(Null2String(rsLOAD_AP!remarks)))
                    Call REFERENCE_VOUCHER_PRINTING(Null2String(rsLOAD_AP!APVoucherno), txtCode.Text, Null2String(rsLOAD_AP!ACCT_CODE), Null2String(rsLOAD_AP!INVOICE))
                End If
                rsLOAD_AP.MoveNext
                DoEvents
            Loop
    ...
    Else
        ...
        If cboAR_ACCT_CODE.Text = "ALL" Then
            ...
            'rsLOAD_AP.Open "SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,ap.INVOICETYPE + '-' + ap.INVOICENO AS INVOICE,ap.AMOUNT2PAY,ap.AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE,ap.VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6) AS VOUCHERNO,hd.remarks FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE inner join amis_journal_hd hd on ap.voucherno=hd.jtype+'-'+hd.voucherno  WHERE STATUS='P' AND ap.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND ap.Jdate >= '" & dtFrom.Value & "'and ap.Jdate <= '" & dtTO.Value & "'", gconDMIS, adOpenKeyset
            rsLOAD_AP.Open "SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,AP.INVOICENO AS INVOICE,ap.AMOUNT2PAY,ap.AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE,ap.VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6) AS VOUCHERNO,hd.remarks FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE inner join amis_journal_hd hd on ap.voucherno=hd.jtype+'-'+hd.voucherno  WHERE AP.STATUS='P' AND ap.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND ap.Jdate >= '" & dtFrom.Value & "'and ap.Jdate <= '" & dtTO.Value & "'", gconDMIS, adOpenKeyset
        Else
            ...
            rsLOAD_AP.Open "SELECT ap.JDATE,ap.VOUCHERNO AS APVOUCHERNO,AP.INVOICENO AS INVOICE,ap.AMOUNT2PAY,ap.AMOUNTPAID,ap.INVOICENO,ap.INVOICETYPE,ap.VENDOR_CODE,AP.ACCT_CODE,RIGHT(ap.VOUCHERNO,6) AS VOUCHERNO, hd.remarks FROM AMIS_AP AP INNER JOIN AMIS_CHARTACCOUNT AC ON AP.ACCT_CODE=AC.ACCTCODE inner join amis_journal_hd hd on ap.voucherno=hd.jtype+'-'+hd.voucherno WHERE AP.STATUS='P' AND ap.VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND ap.Jdate >= '" & dtFrom.Value & "'and ap.Jdate <= '" & dtTO.Value & "' AND " & _
...
'updated by RRL 07/07/2015
        If COMPANY_CODE = "HSM" Then
            rsPAYMENT.Open "SELECT det.JDATE,det.JTYPE,det.VOUCHERNO,ISNULL(det.INVOICETYPE,'') AS INVOICETYPE,ISNULL(det.INVOICENO,'')" & _
                        "AS INVOICENO,AMOUNTPAID FROM AMIS_DETAILS det inner join AMIS_JOURNAL_DET dt on det.Acct_Code=dt.Acct_Code " & _
                        "WHERE det.STATUS='P' AND det.INVOICENO='" & xInvoiceNo & "' AND PV_VOUCHERNO = '" & xVOUCHERNO & "' " & _
                        "AND VENDORCODE = '" & xVENDORCODE & "' AND det.INVOICENO='" & xInvoiceNo & "'  and " & _
                        "det.ACCT_CODE = '" & xAcctCode & "'  AND det.Jdate >= '" & dtFrom.Value & "' and det.Jdate <= '" & dtTO.Value & "' " & _
                        "Group By det.JDATE,det.JTYPE,det.VOUCHERNO,ISNULL(det.INVOICETYPE,''),det.INVOICETYPE,ISNULL(det.INVOICENO,'') , " & _
                        "Det.INVOICENO , AMOUNTPAID order by det.jdate asc ", gconDMIS, adOpenKeyset
        Else
              rsPAYMENT.Open "SELECT det.JDATE,det.JTYPE,det.VOUCHERNO,ISNULL(det.INVOICETYPE,'') AS INVOICETYPE,ISNULL(det.INVOICENO,'')" & _
                        "AS INVOICENO,AMOUNTPAID FROM AMIS_DETAILS det inner join AMIS_JOURNAL_DET dt on det.Acct_Code=dt.Acct_Code " & _
                        "WHERE det.STATUS='P' AND det.INVOICENO='" & xInvoiceNo & "' AND PV_VOUCHERNO = '" & xVOUCHERNO & "' " & _
                        ...
                        "det.ACCT_CODE = '" & xAcctCode & "'  AND det.Jdate >= '" & dtFrom.Value & "' and det.Jdate <= '" & dtTO.Value & "' " & _
                        "Group By det.JDATE,det.JTYPE,det.VOUCHERNO,ISNULL(det.INVOICETYPE,''),det.INVOICETYPE,ISNULL(det.INVOICENO,'') , " & _
                        "Det.INVOICENO , AMOUNTPAID ", gconDMIS, adOpenKeyset
        End If
...
Sub DIRECT_DISBURSEMENT(xVENDORCODE As String, xAcctCode As String)
    ...
    If cboAR_ACCT_CODE.Text = "ALL" Then
        rsDIRECT_DISBURSEMENT.Open "SELECT JDATE,VOUCHERNO,AMOUNT2PAY,AMOUNTPAID,INVOICENO FROM AMIS_AP WHERE STATUS='P' AND VENDOR_CODE='" & xVENDORCODE & "' AND LEFT(VOUCHERNO,3)='CDJ' AND Jdate >= '" & dtFrom.Value & "'and Jdate <= '" & dtTO.Value & "'", gconDMIS, adOpenForwardOnly
    Else
        rsDIRECT_DISBURSEMENT.Open "SELECT JDATE,VOUCHERNO,AMOUNT2PAY,AMOUNTPAID,INVOICENO FROM AMIS_AP WHERE STATUS='P' AND VENDOR_CODE='" & xVENDORCODE & "' AND ACCT_CODE='" & xAcctCode & "' AND LEFT(VOUCHERNO,3)='CDJ' AND Jdate >= '" & dtFrom.Value & "'and Jdate <= '" & dtTO.Value & "'", gconDMIS, adOpenForwardOnly
    End If
...
'JULIE : 01082013 UPDATED BY REQUEST OF HMH
If COMPANY_CODE = "HMH" Then
            xCounter = xCounter + 1
...
Sub FORWARDED_BALANCE()
    ...
    Else
        rsLOAD_AP.Open "SELECT JDATE,VOUCHERNO AS APVOUCHERNO,INVOICETYPE + '-' + INVOICENO,AMOUNT2PAY,AMOUNTPAID,INVOICENO,INVOICETYPE,VENDOR_CODE,ACCT_CODE,RIGHT(VOUCHERNO,6) AS VOUCHERNO " & _
                       "FROM AMIS_AP WHERE STATUS='P' AND VENDOR_CODE = '" & RTrim(LTrim(txtCode.Text)) & "' AND Jdate < '" & dtFrom.Value & "' AND " & _
                       "ACCT_CODE = (SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE DESCRIPTION = '" & (RTrim(LTrim(cboAR_ACCT_CODE.Text))) & "')", gconDMIS, adOpenKeyset
    End If
...
Sub rsRefresh()
    ...
    rsREF.Open "SELECT DISTINCT VENDOR_NAME,VENDOR_CODE FROM AMIS_AP WHERE STATUS='P' ORDER BY VENDOR_NAME ASC", gconDMIS, adOpenForwardOnly, adLockReadOnly
End Sub
