...
Sub displayReason(nard As String)
    ...
    listReason.ForeColor = &H80000008
...
'Update BY BTT - 06282008
    ...
    If MODULENAME = "AMIS" Then
        ...
        ElseIf xJOURNALTYPE = "COB" Then
            TitleApp = "CUSTOMER OPENNING BALANCE"
        ElseIf xJOURNALTYPE = "VPJ" Then
    ...
    If MODULENAME = "PMIS" Then
        'For PMIS
    ElseIf MODULENAME = "CSMS" Then
        'FOR CSMS
    ElseIf MODULENAME = "CMIS" Then
        'For CMIS
    ElseIf MODULENAME = "SMIS" Then
        'For SMIS
    End If
