...
Begin VB.Form frmAMISFinancialStatementsHSM 
   BackColor       =   &H00FFFFFF&
   ...
   ClientWidth     =   10080
   ForeColor       =   &H00FFFFFF&
   Icon            =   "FinancialStatementsHSM.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Top             =   0
         Width           =   9405
         Begin VB.PictureBox browCashFlowOLD 
            Height          =   1065
            Left            =   8370
            ScaleHeight     =   1005
            ScaleWidth      =   825
         ...
         Begin VB.Image Image3 
            Height          =   1230
            Left            =   6360
            MouseIcon       =   "FinancialStatementsHSM.frx":030A
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":045C
         ...
         Begin VB.Image Image6 
            Height          =   1230
            Left            =   3240
            MouseIcon       =   "FinancialStatementsHSM.frx":0F43
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1095
         ...
         Begin VB.Image Image9 
            Height          =   1230
            Left            =   0
            MouseIcon       =   "FinancialStatementsHSM.frx":1B7C
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1CCE
            ToolTipText     =   "View Income Statement Service - Cumulative"
            Top             =   4320
            Width           =   1290
         End
         Begin VB.Label labScheduleOfSellingExpensesBrpSection 
            Alignment       =   2  'Center
            BackColor       =   &H00FFFFFF&
            BackStyle       =   0  'Transparent
            Caption         =   "Schedule of Selling Expenses - BRP Section"
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   6.75
               Charset         =   0
            ...
            Height          =   585
            Left            =   7170
            MouseIcon       =   "FinancialStatementsHSM.frx":27B5
            MousePointer    =   99  'Custom
            TabIndex        =   23
            Top             =   8190
            Width           =   1815
         ...
         Begin VB.Label labOwnersEquity 
            ...
            Height          =   435
            Left            =   510
            MouseIcon       =   "FinancialStatementsHSM.frx":2ABF
            MousePointer    =   99  'Custom
            TabIndex        =   21
            Top             =   3720
            Width           =   4035
         ...
         Begin VB.Label labCashFlow 
            ...
            Height          =   255
            Left            =   4890
            MouseIcon       =   "FinancialStatementsHSM.frx":2DC9
            MousePointer    =   99  'Custom
            TabIndex        =   20
            Top             =   3720
            Width           =   4035
         ...
         Begin VB.Label labIncomeStatementByProductCumulative 
            ...
            Height          =   735
            Left            =   210
            MouseIcon       =   "FinancialStatementsHSM.frx":30D3
            MousePointer    =   99  'Custom
            TabIndex        =   8
            Top             =   11910
            Width           =   4395
         ...
         Begin VB.Label labIncomeStatementByProductCurrent 
            ...
            Height          =   735
            Left            =   4860
            MouseIcon       =   "FinancialStatementsHSM.frx":33DD
            MousePointer    =   99  'Custom
            TabIndex        =   7
            Top             =   11910
            Width           =   4395
         ...
         Begin VB.Label labScheduleOAdministrativeExpensesCumulative 
            ...
            Height          =   795
            Left            =   2250
            MouseIcon       =   "FinancialStatementsHSM.frx":36E7
            MousePointer    =   99  'Custom
            TabIndex        =   6
            Top             =   13965
            Width           =   5055
         ...
         Begin VB.Label labScheduleOfAdminAndSellingExpensesCurrent 
            ...
            Height          =   975
            Left            =   5280
            MouseIcon       =   "FinancialStatementsHSM.frx":39F1
            MousePointer    =   99  'Custom
            TabIndex        =   5
            Top             =   16800
            Width           =   3375
         ...
         Begin VB.Label labScheduleOfAdminAndSellingExpensesCumulative 
            ...
            Height          =   975
            Left            =   840
            MouseIcon       =   "FinancialStatementsHSM.frx":3CFB
            MousePointer    =   99  'Custom
            TabIndex        =   4
            Top             =   16800
            Width           =   3375
         ...
         Begin VB.Image Image22 
            Height          =   720
            Left            =   5580
            MouseIcon       =   "FinancialStatementsHSM.frx":4005
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":4157
            Top             =   8850
            Width           =   585
         End
         Begin VB.Image Image21 
            Height          =   660
            Left            =   3120
            MouseIcon       =   "FinancialStatementsHSM.frx":5819
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":596B
            Top             =   8820
            Width           =   1095
         End
         Begin VB.Image Image20 
            Height          =   615
            Left            =   390
            MouseIcon       =   "FinancialStatementsHSM.frx":7F7D
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":80CF
            Top             =   8880
            Width           =   1755
         End
         Begin VB.Image Image19 
            Height          =   720
            Left            =   8160
            MouseIcon       =   "FinancialStatementsHSM.frx":B971
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":BAC3
            Top             =   4920
            Width           =   585
         End
         Begin VB.Image Image18 
            Height          =   660
            Left            =   4860
            MouseIcon       =   "FinancialStatementsHSM.frx":D185
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":D2D7
            Top             =   4740
            Width           =   1095
         End
         Begin VB.Image Image17 
            Height          =   615
            Left            =   1320
            MouseIcon       =   "FinancialStatementsHSM.frx":F8E9
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":FA3B
            Top             =   4950
            Width           =   1755
         End
         Begin VB.Label labIncomeStatements 
            ...
            Height          =   255
            Left            =   4620
            MouseIcon       =   "FinancialStatementsHSM.frx":132DD
            MousePointer    =   99  'Custom
            TabIndex        =   19
            Top             =   1560
            Width           =   3135
         ...
         Begin VB.Label labBalanceSheets 
            ...
            Height          =   435
            Left            =   1800
            MouseIcon       =   "FinancialStatementsHSM.frx":135E7
            MousePointer    =   99  'Custom
            TabIndex        =   18
            Top             =   1560
            Width           =   3135
         ...
         Begin VB.Image Image16 
            Height          =   1380
            Left            =   4260
            MouseIcon       =   "FinancialStatementsHSM.frx":138F1
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":13A43
         ...
         Begin VB.Image Image15 
            Height          =   2415
            Left            =   5910
            MouseIcon       =   "FinancialStatementsHSM.frx":144D8
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1462A
         ...
         Begin VB.Image Image13 
            Height          =   2415
            Left            =   3735
            MouseIcon       =   "FinancialStatementsHSM.frx":16A07
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":16B59
         ...
         Begin VB.Image Image8 
            Height          =   1305
            Left            =   5490
            MouseIcon       =   "FinancialStatementsHSM.frx":187E3
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":18935
         ...
         Begin VB.Image Image7 
            Height          =   1305
            Left            =   2670
            MouseIcon       =   "FinancialStatementsHSM.frx":194FB
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1964D
         ...
         Begin VB.Image Image5 
            Height          =   2415
            Left            =   5910
            MouseIcon       =   "FinancialStatementsHSM.frx":1A213
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1A365
         ...
         Begin VB.Image Image1 
            Height          =   1230
            Left            =   2490
            MouseIcon       =   "FinancialStatementsHSM.frx":1C01D
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1C16F
         ...
         Begin VB.Label labScheduleOfAccounts 
            ...
            Height          =   495
            Left            =   2640
            MouseIcon       =   "FinancialStatementsHSM.frx":1CD20
            MousePointer    =   99  'Custom
            TabIndex        =   17
            Top             =   18750
            Width           =   4155
         ...
         Begin VB.Label labScheduleOfSellingExpensesServiceSection 
            ...
            Height          =   585
            Left            =   5010
            MouseIcon       =   "FinancialStatementsHSM.frx":1D02A
            MousePointer    =   99  'Custom
            TabIndex        =   16
            Top             =   8190
            Width           =   1815
         ...
         Begin VB.Label labScheduleOfSellingExpensesPartsSection 
            ...
            Height          =   585
            Left            =   2850
            MouseIcon       =   "FinancialStatementsHSM.frx":1D334
            MousePointer    =   99  'Custom
            TabIndex        =   15
            Top             =   8220
            Width           =   1815
         ...
         Begin VB.Label labScheduleOfSellingExpensesSalesSection 
            ...
            Height          =   585
            Left            =   360
            MouseIcon       =   "FinancialStatementsHSM.frx":1D63E
            MousePointer    =   99  'Custom
            TabIndex        =   14
            Top             =   8220
            Width           =   1665
         ...
         Begin VB.Label labScheduleOfSellingExpenseCumulative 
            ...
            Height          =   675
            Left            =   1650
            MouseIcon       =   "FinancialStatementsHSM.frx":1D948
            MousePointer    =   99  'Custom
            TabIndex        =   13
            Top             =   7260
            Width           =   3465
         ...
         Begin VB.Label labIncomeStatementServiceCumulative 
            ...
            Height          =   585
            Left            =   7680
            MouseIcon       =   "FinancialStatementsHSM.frx":1DC52
            MousePointer    =   99  'Custom
            TabIndex        =   12
            Top             =   4320
            Width           =   1515
         ...
         Begin VB.Label labIncomeStatementPartsCumulative 
            ...
            Height          =   435
            Left            =   4860
            MouseIcon       =   "FinancialStatementsHSM.frx":1DF5C
            MousePointer    =   99  'Custom
            TabIndex        =   11
            Top             =   4320
            Width           =   1515
         ...
         Begin VB.Label labIncomeStatementVehiclesCumulative 
            ...
            Height          =   555
            Left            =   1560
            MouseIcon       =   "FinancialStatementsHSM.frx":1E266
            MousePointer    =   99  'Custom
            TabIndex        =   10
            Top             =   4320
            Width           =   1515
         ...
         Begin VB.Image Image4 
            Height          =   2415
            Left            =   1380
            MouseIcon       =   "FinancialStatementsHSM.frx":1E570
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":1E6C2
         ...
         Begin VB.Image Image14 
            Height          =   2415
            Left            =   1380
            MouseIcon       =   "FinancialStatementsHSM.frx":2030C
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":2045E
         ...
         Begin VB.Label labScheduleOfSellingExpenseCurrent 
            ...
            Height          =   645
            Left            =   4650
            MouseIcon       =   "FinancialStatementsHSM.frx":2283B
            MousePointer    =   99  'Custom
            TabIndex        =   9
            Top             =   7260
            Width           =   3285
         ...
         Begin VB.Image Image24 
            Height          =   1770
            Left            =   1410
            MouseIcon       =   "FinancialStatementsHSM.frx":22B45
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":22C97
            Stretch         =   -1  'True
            ToolTipText     =   "View Balance Sheets"
            Top             =   2040
            Width           =   2160
         ...
         Begin VB.Image Image23 
            Height          =   1800
            Left            =   6000
            MouseIcon       =   "FinancialStatementsHSM.frx":3BDD7
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":3BF29
         ...
         Begin VB.Image Image2 
            Height          =   1230
            Left            =   5670
            MouseIcon       =   "FinancialStatementsHSM.frx":3DD31
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHSM.frx":3DE83
            ToolTipText     =   "View Income Statements"
            Top             =   210
            Width           =   990
         End
   ...
   End
End
Attribute VB_Name = "frmAMISFinancialStatementsHSM"
...
Dim SellingExpenseTotalAmount                               As Double
...
Private Sub labIncomeStatementByProductCumulative_Click()
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        If COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='51' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='52' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit)  + (" & SellingExpenseTotalAmount & ")  as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.titles in ('7103','7121','7120','7143','7145','7135') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
...
'            rptAMISIncomeStatement.Formulas(17) = "Current_LessAdminExpense = " & N2Str2Zero(rsJournal_Det!LessAdminExpense) * 0.2
        ...
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) + (" & SellingExpenseTotalAmount & ") as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Titles in ('7103','7121','7120','7143','7145','7135') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='71' or AMIS_ChartAccount.Headers='72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='71' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labIncomeStatementByProductCurrent_Click()
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        'FOR HNE ADMIN EXPENSE DIVIDE INTO 3, SALES,PARTS and Service
        If COMPANY_CODE = "HNE" Then
            Set rsSellingExpense = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7103','7121','7120','7143','7145','7135') AND AMIS_JOURNAL_DET.STATUS = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES not in('7103','7121','7120','7143','7145','7135') and AMIS_CHARTACCOUNT.headers In ('71','72') AND AMIS_JOURNAL_DET.STATUS = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
            Set rsOtherIncome = gconDMIS.Execute("select (SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit)) / 3 as OtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where  AMIS_CHARTACCOUNT.headers='81' and AMIS_CHARTACCOUNT.Departmentcode IN ('00','40') and AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "')")
            If Not rsSellingExpense.EOF And Not rsSellingExpense.BOF Then
                 SellingExpenseTotalAmount = N2Str2Zero(rsSellingExpense!LESSADMINEXPENSETOTAL / 3)
            End If
            If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='51' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='52' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit)  + (" & SellingExpenseTotalAmount & ")  as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND (AMIS_ChartAccount.titles in ('7103','7121','7120','7143','7145','7148') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
        ElseIf COMPANY_CODE = "HMH" Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) + (" & AdminExpenseTotalAmount & ") as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.TITLES not in('7103','7121','7120','7143','7145','7148','7135','7154') and AMIS_CHARTACCOUNT.headers In ('71','72') AND (AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
        Else
...
'        End If
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessOtherExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "')AND AMIS_ChartAccount.titles in ('7154','7135') AND AMIS_ChartAccount.Headers='71' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) + (" & SellingExpenseTotalAmount & ") as  LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.titles in ('7103','7121','7120','7143','7145','7148') AND (AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
        ElseIf COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_Journal_Det.JTYPE <> 'CCM' AND (AMIS_ChartAccount.Headers='71' OR AMIS_ChartAccount.Headers='72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='71' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
'        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) + (" & AdminExpenseTotalAmount & ") as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_CHARTACCOUNT.TITLES not in('7103','7121','7120','7143','7145','7135') and AMIS_CHARTACCOUNT.headers In ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) + (" & AdminExpenseTotalAmount & ") as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.TITLES not in('7103','7121','7120','7143','7145','7148','7135','7154') and AMIS_CHARTACCOUNT.headers In ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='72' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labIncomeStatementPartsCumulative_Click()
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.titles in ('7103','7121','7120','7143','7145','7135') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7103','7121','7120','7143','7145','7135') AND AMIS_JOURNAL_DET.STATUS = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.jdate <= '" & dtpTo & "'  AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
            AdminExpenseTotalAmount = N2Str2Zero(rsAdminExpenseTotalAmount!LESSADMINEXPENSETOTAL / 3)
        End If
        ElseIf COMPANY_CODE = "DSSC" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            If COMPANY_CODE = "HNE" Then
        ...
        If COMPANY_CODE = "HNE" Then
        Set rsJournal_Det = New ADODB.Recordset
        Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') AND AMIS_JOURNAL_DET.STATUS = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.jdate <= '" & dtpTo & "'  AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where  AMIS_ChartAccount.titles in ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') and AMIS_Journal_Det.Status = 'P' AND  year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
            AdminExpenseTotalAmount = N2Str2Zero(rsAdminExpenseTotalAmount!LESSADMINEXPENSETOTAL / 3)
        End If
        ElseIf COMPANY_CODE = "DSSC" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            If COMPANY_CODE = "DSSC" Then
                rptAMISIncomeStatement.Formulas(7) = "Cummulative_LessAdminExpense = " & N2Str2Zero(rsJournal_Det!LessSellingExpense)
            Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
        Set rsOtherIncome = gconDMIS.Execute("select (SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit)) / 3 as OtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where  AMIS_CHARTACCOUNT.headers='81' and AMIS_CHARTACCOUNT.Departmentcode = '00' and AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "'")
        Set rsJournal_Det = gconDMIS.Execute("select isnull(SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit),0) + (" & N2Str2Zero(rsOtherIncome!OtherIncome) & ") as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        ...
        End If
        ElseIf COMPANY_CODE = "DSSC" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers IN ('71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers IN ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            If COMPANY_CODE = "HNE" Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as InterestExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.TRANTYPE1 = 'INTEREST' AND AMIS_ChartAccount.TRANTYPE2 = 'EXPENSE' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') AND AMIS_JOURNAL_DET.STATUS = 'P' AND(AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where  AMIS_ChartAccount.titles in ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') and AMIS_Journal_Det.Status = 'P' AND  (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
            AdminExpenseTotalAmount = N2Str2Zero(rsAdminExpenseTotalAmount!LESSADMINEXPENSETOTAL / 3)
        End If
        ElseIf COMPANY_CODE = "DSSC" Then
            ...
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
                If COMPANY_CODE = "DSSC" Then
                rptAMISIncomeStatement.Formulas(17) = "Current_LessAdminExpense = " & N2Str2Zero(rsJournal_Det!LessSellingExpense)
                Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsOtherIncome = gconDMIS.Execute("select (SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit)) / 3 as OtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where  AMIS_CHARTACCOUNT.headers='81' and AMIS_CHARTACCOUNT.Departmentcode = '00' and AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "')")
            Set rsJournal_Det = gconDMIS.Execute("select ISNULL(SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit),0)+ ( " & N2Str2Zero(rsOtherIncome!OtherIncome) & ") as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
...
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessOtherExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate <= '" & CDate(PreviousMonthTo) & "') AND AMIS_ChartAccount.Headers=" & OTHER_EXPENSE)
        ...
        If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HSM" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.TRANTYPE2 NOT IN ('CHATTEL','INSURANCE','DI') AND (AMIS_ChartAccount.Headers='61' OR AMIS_ChartAccount.Headers='63')")
            Else
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HSM" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.TRANTYPE2 NOT IN ('CHATTEL','INSURANCE','DI') AND (AMIS_ChartAccount.Headers='61' OR AMIS_ChartAccount.Headers='63')")
            Else
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HSM" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.TRANTYPE2 NOT IN ('CHATTEL','INSURANCE','DI') AND (AMIS_ChartAccount.Headers='61' OR AMIS_ChartAccount.Headers='63')")
            Else
...
Private Sub labIncomeStatementServiceCumulative_Click()
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as DirectCost from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='63' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & ADMIN_SECTION)
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as DirectCost from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='63' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES  where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND (AMIS_CHARTACCOUNT.TITLES IN ('7103','7121','7120','7143','7145','7135') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7103','7121','7120','7143','7145','7135') AND AMIS_JOURNAL_DET.STATUS = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
            AdminExpenseTotalAmount = N2Str2Zero(rsAdminExpenseTotalAmount!LESSADMINEXPENSETOTAL / 3)
        End If
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
        Set rsOtherIncome = gconDMIS.Execute("select (SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit)) / 3 as OtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where  AMIS_CHARTACCOUNT.headers='81' and AMIS_CHARTACCOUNT.Departmentcode = '00' and AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') and AMIS_Journal_Det.jdate <= '" & dtpTo & "'")
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) + (" & N2Str2Zero(rsOtherIncome!OtherIncome) & ") as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
...
'        End If
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HNE" Then
        Set rsOtherIncome = gconDMIS.Execute("select (SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit)) / 3 as OtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where  AMIS_CHARTACCOUNT.headers='81' and AMIS_CHARTACCOUNT.Departmentcode = '00' and AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') and AMIS_Journal_Det.jdate <= '" & dtpTo & "'")
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) + (" & N2Str2Zero(rsOtherIncome!OtherIncome) & ") as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
...
'    End If
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='50' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='51' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='51' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='51' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='52' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='52' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales_CA from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.ACCTCODE='61-01255-10' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as DealersIncentives from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.ACCTCODE='42-01000-10' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
'        If COMPANY_CODE = "HSM" Then
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.DEBIT) - SUM(AMIS_Journal_Det.CREDIT) as FreeItemAccessories from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.ACCTCODE IN('61-01017-10','61-01000-10','61-01256-10') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
'        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
'            rptAMISIncomeStatement.Formulas(37) = "Cummulative_FreeItemAccessories = " & N2Str2Zero(rsJournal_Det!FreeItemAccessories)
'        End If
'        End If
'        Set rsJournal_Det = New ADODB.Recordset
'        If COMPANY_CODE = "HSM" Then
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.DEBIT) - SUM(AMIS_Journal_Det.CREDIT) as FreeItemLTO from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.TRANTYPE1 = 'FREE' AND AMIS_ChartAccount.TRANTYPE2 = 'LTO' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
'            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
'                rptAMISIncomeStatement.Formulas(40) = "Cummulative_FreeItemLTO = " & N2Str2Zero(rsJournal_Det!FreeItemLTO)
'            End If
'        End If
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HMH" Then
             Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.JTYPE <> 'CCM' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HNE" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where  AMIS_ChartAccount.titles in ('7103','7121','7120','7143','7145','7135') and AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7103','7121','7120','7143','7145','7135') AND AMIS_JOURNAL_DET.STATUS = 'P' AND AMIS_JOURNAL_DET.JDATE <= '" & dtpTo & "' AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
        ...
        If COMPANY_CODE = "HNE" Then
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') AND AMIS_JOURNAL_DET.STATUS = 'P' AND AMIS_JOURNAL_DET.JDATE <= '" & dtpTo & "' AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where  AMIS_ChartAccount.titles in ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') and AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
            AdminExpenseTotalAmount = N2Str2Zero(rsAdminExpenseTotalAmount!LESSADMINEXPENSETOTAL / 3)
        ...
        If COMPANY_CODE = "HNE" Then
            ...
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) + (" & N2Str2Zero(rsOtherIncome!OtherIncome) & ") as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.TITLES IN('8101','8102','8105') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='50' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HMH" Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales_CA from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.ACCTCODE='61-01255-10' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as DealersIncentives from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.ACCTCODE='42-01000-10' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
...
'        Set rsJournal_Det = New ADODB.Recordset
'        If COMPANY_CODE = "HSM" Then
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as FreeItemAccessories from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.ACCTCODE IN('61-01017-10','61-01000-10','61-01256-10') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
'        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
'            rptAMISIncomeStatement.Formulas(38) = "Current_FreeItemAccessories = " & N2Str2Zero(rsJournal_Det!FreeItemAccessories)
'        End If
'        End If
'        Set rsJournal_Det = New ADODB.Recordset
'        If COMPANY_CODE = "HSM" Then
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as FreeItemLTO from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.TRANTYPE1 = 'FREE' AND AMIS_ChartAccount.TRANTYPE2 = 'LTO'  AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
'            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
'                rptAMISIncomeStatement.Formulas(41) = "Current_FreeItemLTO = " & N2Str2Zero(rsJournal_Det!FreeItemLTO)
'            End If
'        End If
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        ElseIf COMPANY_CODE = "HNE" Then
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7103','7121','7120','7143','7145','7135') AND AMIS_JOURNAL_DET.STATUS = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where  AMIS_ChartAccount.titles in ('7103','7121','7120','7143','7145','7135') and AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
        ...
        End If
        ElseIf COMPANY_CODE = "HMH" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_Journal_Det.jtype <> 'CCM' AND AMIS_ChartAccount.Headers IN ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers IN ('71','72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode inner join AMIS_titlecode on AMIS_titlecode.code =AMIS_ChartAccount.titles where  AMIS_ChartAccount.titles in ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') and AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
            Set rsAdminExpenseTotalAmount = gconDMIS.Execute("SELECT SUM(AMIS_JOURNAL_DET.DEBIT) - SUM(AMIS_JOURNAL_DET.CREDIT) AS LESSADMINEXPENSETOTAL FROM AMIS_JOURNAL_DET INNER JOIN AMIS_CHARTACCOUNT ON AMIS_JOURNAL_DET.ACCT_CODE = AMIS_CHARTACCOUNT.ACCTCODE INNER JOIN AMIS_TITLECODE ON AMIS_TITLECODE.CODE =AMIS_CHARTACCOUNT.TITLES WHERE  AMIS_CHARTACCOUNT.TITLES IN ('7101','7104','7106','7110','7111','7115','7116','7118','7119','7122','7123','7125','7126','7127','7131','7132','7133','7150','7153','7107','7117','7134') AND AMIS_JOURNAL_DET.STATUS = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_CHARTACCOUNT.DEPARTMENTCODE = " & ADMIN_SECTION)
        If Not rsAdminExpenseTotalAmount.EOF And Not rsAdminExpenseTotalAmount.BOF Then
            AdminExpenseTotalAmount = N2Str2Zero(rsAdminExpenseTotalAmount!LESSADMINEXPENSETOTAL / 3)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        ElseIf COMPANY_CODE = "HSM" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.TITLES IN ('8101','8102','8105') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='81' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        End If
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
        ...
        Set rsJournal_Det = New ADODB.Recordset
'        If COMPANY_CODE = "HSM" Then
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as FreeItemAccessories from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_ChartAccount.ACCTCODE IN ('61-01017-10','61-01000-10','61-01256-10') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
'
'        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
'            rptAMISIncomeStatement.Formulas(39) = "Previous_FreeItemAccessories = " & N2Str2Zero(rsJournal_Det!FreeItemAccessories)
'        End If
'        End If
'        Set rsJournal_Det = New ADODB.Recordset
'        If COMPANY_CODE = "HSM" Then
'            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as FreeItemLTO from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_ChartAccount.TRANTYPE1 = 'FREE' AND AMIS_ChartAccount.TRANTYPE2 = 'LTO' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
'            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
'                rptAMISIncomeStatement.Formulas(42) = "Previous_FreeItemLTO = " & N2Str2Zero(rsJournal_Det!FreeItemLTO)
'            End If
'        End If
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HSM" Then
...
'    If COMPANY_CODE = "HNE" Then
'    Set rsSellingExpense = New ADODB.Recordset
'    Set rsSellingExpense = gconDMIS.Execute("Select Description from amis_titlecode where code in ('7103','7121','7120','7134','7143','7145')")
'    Do While Not rsSellingExpense.EOF And Not rsSellingExpense.BOF
'        rptAMISIncomeStatement.Formulas(7) = "CapsDesc = '" & Null2String(rsSellingExpense!DESCRIPTION) & "'"
'        rsSellingExpense.MoveNext
'    Loop
'    End If
    Set rsJournal_Det = New ADODB.Recordset
...
Private Sub labScheduleOfSellingExpenseCumulative_Click()
    ...
    Set rsJournal_Det = New ADODB.Recordset
    If COMPANY_CODE = "HCA" Then
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='50' OR AMIS_ChartAccount.Headers='51') AND AMIS_ChartAccount.DepartmentCode = '" & VEHICLES_SECTION & "'")
    Else
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='51' OR AMIS_ChartAccount.Headers='52') AND AMIS_ChartAccount.DepartmentCode = '" & VEHICLES_SECTION & "'")
    End If
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labScheduleOfSellingExpenseCurrent_Click()
    ...
    Set rsJournal_Det = New ADODB.Recordset
    If COMPANY_CODE = "HCA" Then
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='50' OR AMIS_ChartAccount.Headers='51') AND AMIS_ChartAccount.DepartmentCode = '" & VEHICLES_SECTION & "'")
    Else
