...
Sub initMemvars()
    ...
    Dim rsAssetCode As ADODB.Recordset
    Set rsAssetCode = New ADODB.Recordset
    Set rsAssetCode = gconDMIS.Execute("select assetcode from AMIS_Assets order by id desc")
    If Not rsAssetCode.EOF And Not rsAssetCode.BOF Then txtAssetCode.Text = Format(N2Str2Zero(rsAssetCode!assetcode) + 1, "000000") Else txtAssetCode.Text = "000001"
