...
Begin VB.Form frmListofUnposted 
   ...
   ClientTop       =   435
   ClientWidth     =   4650
   Icon            =   "frmListofUnposted.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6660
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   705
         Left            =   1740
         MouseIcon       =   "frmListofUnposted.frx":6852
         MousePointer    =   99  'Custom
         Picture         =   "frmListofUnposted.frx":69A4
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   705
         Left            =   960
         MouseIcon       =   "frmListofUnposted.frx":6DEF
         MousePointer    =   99  'Custom
         Picture         =   "frmListofUnposted.frx":6F41
         Style           =   1  'Graphical
         TabIndex        =   3
