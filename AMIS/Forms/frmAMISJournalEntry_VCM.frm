...
Begin VB.Form frmAMISJournalEntry_VCM 
   BackColor       =   &H00E0E0E0&
   ...
   ClientWidth     =   9855
   ForeColor       =   &H00FFFFFF&
   Icon            =   "frmAMISJournalEntry_VCM.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8820
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   8070
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7320
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6540
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5790
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":1B5D
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":1CAF
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   5040
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":1FD4
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":2126
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4290
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":2482
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":25D4
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3540
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":28E7
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":2A39
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":2D89
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":2EDB
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   2040
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":3239
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":338B
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1290
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":3685
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":37D7
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   540
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":3B2F
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":3C81
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VCM.frx":3FE0
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VCM.frx":4077
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picDisbursement 
         ...
         Begin RichTextLib.RichTextBox txtParticulars 
            ...
            Enabled         =   -1  'True
            ScrollBars      =   2
            TextRTF         =   $"frmAMISJournalEntry_VCM.frx":410E
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   765
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":41A2
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":42F4
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   10
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":4632
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntry_VCM.frx":4784
         Style           =   1  'Graphical
         TabIndex        =   14
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      TabPicture(0)   =   "frmAMISJournalEntry_VCM.frx":4AD4
      ...
      TabPicture(1)   =   "frmAMISJournalEntry_VCM.frx":4AF0
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8315
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":4B0C
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VCM.frx":4C5E
            Style           =   1  'Graphical
            TabIndex        =   118
            Top             =   750
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               Enabled         =   -1  'True
               MultiLine       =   0   'False
               TextRTF         =   $"frmAMISJournalEntry_VCM.frx":4F9C
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":502F
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VCM.frx":5181
            Style           =   1  'Graphical
            TabIndex        =   96
            Top             =   750
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":54D1
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VCM.frx":5623
            Style           =   1  'Graphical
            TabIndex        =   95
            Top             =   765
            Width           =   705
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_VCM.frx":594E
      End
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   8400
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":596A
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VCM.frx":5ABC
            Style           =   1  'Graphical
            TabIndex        =   151
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":5DFA
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VCM.frx":5F4C
            Style           =   1  'Graphical
            TabIndex        =   150
            Top             =   690
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7710
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":6277
            MousePointer    =   99  'Custom
            Picture         =   "frmAMISJournalEntry_VCM.frx":63C9
            Style           =   1  'Graphical
            TabIndex        =   149
            Top             =   690
            Width           =   705
      ...
      Begin VB.PictureBox fraDetails 
         ...
         Begin MSComctlLib.ListView lstDetails 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":6719
            NumItems        =   6
      ...
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmAMISJournalEntry_VCM.frx":687B
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "frmAMISJournalEntry_VCM.frx":69DD
      End
   End
   ...
   Begin wizButton.cmd cmdShowPostRange 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_VCM.frx":69F9
   End
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_VCM.frx":6A15
   End
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmAMISJournalEntry_VCM.frx":6A31
   End
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":6A4D
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin VB.PictureBox picTemplates 
      ...
      Begin MSComctlLib.ListView lstTemplates 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frmAMISJournalEntry_VCM.frx":6BAF
         NumItems        =   2
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "DESCRIPTION"
            Object.Width           =   11819
   ...
   End
End
Attribute VB_Name = "frmAMISJournalEntry_VCM"
...
Function StoreJournalEntry(ByVal ID As Variant)
    ...
    If Not rsJournal_Det.EOF And Not rsJournal_Det.BOF Then
        ...
        If xJOURNALTYPE = "VCM" And fraATC.Visible = True Then
...
Sub cmdPVSave_Click()
    ...
    If DetailPosting = False Then
        str_MSG = Replace(str_MSG, "@ACL09182716350", "VCM Details")
        str_MSG = Replace(str_MSG, "ERRORSOURCE", ERRORSOURCE)
        str_MSG = Replace(str_MSG, "ERRORDESC", ERRORDESC)
        MsgBox str_MSG, vbCritical, "VCM Detail Error "
...
Function DetailPosting() As Boolean
    ...
    If AddorEdit = "ADD" Then
        ...
        Set rsJournal_HD_APJ = gconDMIS.Execute("Select VoucherNo,VendorCode from AMIS_Journal_HD Where Jtype = 'VCM' and VendorCode = '" & txtCode.Text & "' Order By VoucherNo Asc")
        ...
        If xJOURNALTYPE = "VCM" Then
            ...
            NEW_LogAudit "AA", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "PV", txtVoucherNo, xJOURNALTYPE, CStr(JOURNAL_DETID)
        End If
    Else
        ...
        If xJOURNALTYPE = "VCM" Then
            ...
            gconDMIS.Execute SQL_STATEMENT
            NEW_LogAudit "EE", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "PV", txtVoucherNo, xJOURNALTYPE, labPVID.Caption
        End If
    End If
        ''AMOUNT TO PAY UPDATE BY NRESPIRITU
        If COMPANY_CODE = "FMC" Or COMPANY_CODE = "HMR" Then
            Dim rsAMOUNTTOPAY As New Recordset
            Dim xamounttopay As Double
            Set rsAMOUNTTOPAY = New ADODB.Recordset
            Set rsAMOUNTTOPAY = gconDMIS.Execute("SELECT SUM(AMOUNT) AS AMOUNT FROM AMIS_PV_DETAIL WHERE JTYPE = 'VCM' AND VOUCHERNO = " & J_JVOUCHERNO & "")
            If Not rsAMOUNTTOPAY.EOF And Not rsAMOUNTTOPAY.BOF Then
                xamounttopay = Round(N2Str2Zero(rsAMOUNTTOPAY!amount), 2)
                gconDMIS.Execute ("UPDATE AMIS_JOURNAL_HD SET AMOUNTTOPAY = " & xamounttopay & " WHERE JTYPE = 'VCM' AND VOUCHERNO = " & J_JVOUCHERNO & "")
            End If
        End If
        ''END OF UPDATE
    ' end of ADD
    ...
    If txtPO_No = "VCM" Then
        ...
        If Not RS_TOTALPAY.EOF Or Not RS_TOTALPAY.BOF Then
            gconDMIS.Execute ("update amis_journal_hd  set  BALANCE=AMOUNTTOPAY-" & RS_TOTALPAY!TOTALPAYMENTS & " WHERE JTYPE='VCM' AND VOUCHERNO= " & N2Str2Null(txtMRR_No))
        End If
    End If
...
Sub InitCbo()
    ...
    End If
    Set rsChartAccount = Nothing
    'If xJOURNALTYPE = "VCM" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "VDJ" Or xJOURNALTYPE = "VCJ" Then TO BE DELETED
    If xJOURNALTYPE = "VCM" Then
        Set rsATC = New ADODB.Recordset
...
Sub rsRefresh()
    If xJOURNALTYPE = "VCM" Then Me.Caption = "VENDOR CREDIT MEMO ENTRY"
    Set rsJournal_HD = New ADODB.Recordset
...
Private Sub cmdAddJournal_Click()
    ...
    '    frmNewAMISJournalEntries.Caption =_APJ.Caption
    '    Call frmNewAMISJournalEntries.LOADJOURNAL("VCM")
...
Private Sub cmdCancelCO_Click()
    ...
    If MsgBox("Are you sure you want to Cancel this Transaction?", vbQuestion + vbYesNo, "Cancel Journal") = vbYes Then
        If xJOURNALTYPE = "VCM" Then
            ...
            gconDMIS.Execute SQL_STATEMENT
            NEW_LogAudit "C", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
...
Private Sub cmdJournalCancel_Click()
    Call frmAMISJournalEntry_VCM.load_voucher_chk
    SendToBack
    StoreMemVars
    Picture1.Enabled = True
...
Private Sub cmdJournalDelete_Click()
    ...
    If MsgBox("Delete This Journal, Are you Sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "XX", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "DT", txtVoucherNo, xJOURNALTYPE, labDetID.Caption
    End If
    Dim cnt                                                 As Integer
    ...
    If Not rsJournalDup.EOF And Not rsJournalDup.BOF Then
        ...
        Do While Not rsJournalDup.EOF
            ...
            '            NEW_LogAudit "XX", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
        Loop
    End If
    FillDetails
...
Private Sub cmdJournalSave_Click()
    ...
    If JournalEntries = False Then
        str_MSG = Replace(str_MSG, "@ACL09182716350", "VENDOR CREDIT MEMO")
        str_MSG = Replace(str_MSG, "ERRORSOURCE", ERRORSOURCE)
        str_MSG = Replace(str_MSG, "ERRORDESC", ERRORDESC)
...
'    End If
    ...
    If AddorEdit = "ADD" Then
        ...
        NEW_LogAudit "AA", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "DT", txtVoucherNo, xJOURNALTYPE, CStr(JOURNAL_DETID)
    ...
    Else
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "EE", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "DT", txtVoucherNo, xJOURNALTYPE, labDetID.Caption

        'SQL_STATEMENT = "UPDATE AMIS_AR SET ACCOUNT_CODE = '" & cboAcct_Code.Text & "' WHERE SJVOUCHERNO = '" & xSJVOUCHERNO & "'"
        'gconDMIS.Execute SQL_STATEMENT
        '        NEW_LogAudit "EE", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
        If cboAcct_Code.Text = DEALER_ITW_EXPANDED Then
            SQL_STATEMENT = "UPDATE AMIS_JOURNAL_DET SET CREDIT = '" & NumericVal(txtTotDebit.Text) - NumericVal(txtCredit.Text) & "' WHERE VOUCHERNO='" & txtVoucherNo.Text & "' AND JTYPE='" & xJOURNALTYPE & "' AND LEFT(ACCT_CODE,5) IN ('21-01','21-02','21-06','21-07') AND ACCT_CODE IN (SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE IS_SCHEDULE_ACCNT=1)"
            gconDMIS.Execute SQL_STATEMENT
        End If
    ...
    gconDMIS.Execute SQL_STATEMENT
    '        NEW_LogAudit "EE", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    ''UPDATED BY NRESPIRITU
    
    If COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "HMR" Then
            Dim rsAMOUNTTOPAY As New Recordset
            Dim xamounttopay As Double
            xamounttopay = 0
            Set rsAMOUNTTOPAY = New ADODB.Recordset
            Set rsAMOUNTTOPAY = gconDMIS.Execute("SELECT top 1 CREDIT FROM AMIS_JOURNAL_DET A INNER JOIN AMIS_CHARTACCOUNT B ON A.ACCT_CODE = B.ACCTCODE WHERE A.JTYPE = 'VCM' AND A.VOUCHERNO = " & J_VOUCHERNO & " AND B.TRANTYPE2 = 'AP'  AND B.IS_SCHEDULE_ACCNT = 1")
            If Not rsAMOUNTTOPAY.EOF And Not rsAMOUNTTOPAY.BOF Then
                xamounttopay = Round(N2Str2Zero(rsAMOUNTTOPAY!Credit), 2)
                gconDMIS.Execute ("UPDATE AMIS_JOURNAL_HD SET AMOUNTTOPAY = " & xamounttopay & " WHERE JTYPE = 'VCM' AND VOUCHERNO = " & J_VOUCHERNO & " ")
            End If
    End If
    ''END UPDATED BY NRESPIRITU
    rsRefresh
    On Error Resume Next
    rsJournal_HD.Find "id = " & labID.Caption
    StoreMemVars
...
'        If MsgBox("Do you want to send this error to NSI Helpdesk?" & vbCrLf & "This may take few minutes.", vbYesNo + vbQuestion, "Question") = vbYes Then
'        sendtohelpdesk (ERRORDESC)
'        Else
'        End If
...
'        End If
        ...
        If xJOURNALTYPE = "VCM" Then
            ...
            If COMPANY_CODE = "DSSC" Then
                Set rsCheckDetails = gconDMIS.Execute("Select Acct_Code, Credit from AMIS_Journal_Det DET INNER JOIN AMIS_CHARTACCOUNT AC ON DET.ACCT_CODE=AC.ACCTCODE Where LEFT(AC.ACCTCODE,2)='21' AND IS_SCHEDULE_ACCNT=1 and trantype1 <> 'DEFERRED OUTPUT TAX' and Jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
            Else
                Set rsCheckDetails = gconDMIS.Execute("Select Acct_Code, Credit from AMIS_Journal_Det DET INNER JOIN AMIS_CHARTACCOUNT AC ON DET.ACCT_CODE=AC.ACCTCODE Where LEFT(AC.ACCTCODE,2)='21' AND IS_SCHEDULE_ACCNT=1 and Jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text))
            End If
        ...
        NEW_LogAudit "P", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
PostJournal:
        ...
        If xJOURNALTYPE = "VCM" Then
            ...
            SQL_STATEMENT = "update AMIS_Journal_HD set  status= 'P',USERCODE='" & LOGCODE & "',PCNAME='" & LOGPCNAME & "',DATEPOSTED='" & LOGDATE & "',Balance = " & TotalAPAmountToPay & "- AmountPaid where jtype = 'VCM' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text)
            gconDMIS.Execute SQL_STATEMENT
            NEW_LogAudit "P", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
        End If
...
Private Sub cmdPrint_Click()
    ...
    If Ans = vbYes Then
        ...
        If xJOURNALTYPE = "VCM" Then SaveReprintInformation xJOURNALTYPE, MODULENAME, txtVoucherNo.Text, "Null", LOGDATE, LOGNAME, False: If CANCEL_ANS = "NO" Then Exit Sub
        If xJOURNALTYPE = "VCM" Then ShowReport "AccountsPayable", "Vouchers", "{Journal_Hd.jno} = '" & txtJNo.Text & "'", "VENDOR CREDIT MEMO PRINTOUT", LOGDATE, False
        NEW_LogAudit "PX", "VENDOR CREDIT MEMO", "", "", "", txtVoucherNo, xJOURNALTYPE, txtJNo
    End If
    Exit Sub
ErrorCode:
    ShowVBError
...
Private Sub cmdPVDelete_Click()
    ...
    If xJOURNALTYPE = "VCM" Then
        If MsgBox("Delete This PV Detail, Are you Sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
            ...
            gconDMIS.Execute SQL_STATEMENT
            NEW_LogAudit "XX", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "PV", txtVoucherNo, xJOURNALTYPE, labPVID.Caption
...
Private Sub cmdSave_Click()
    ...
    ElseIf txtInvoiceDate.Text = "" Or IsDate(txtInvoiceDate.Text) = False Then
        ...
        Exit Sub
    End If
    If xJOURNALTYPE <> "ADJ" And xJOURNALTYPE <> "OPB" And xJOURNALTYPE <> "PDJ" And xJOURNALTYPE <> "VCM" Then
        '        If COMPANY_CODE = "HPI" Then
        'Updated by: ACL 10202009
        If CheckIfOpen(xJOURNALTYPE, Trim(txtJDate.Text), Year(txtJDate.Text)) = False Then
            MsgBox "Set journal period first.", vbExclamation, "Error"
    ...
    'If xJOURNALTYPE = "VCM" Or xJOURNALTYPE = "VDJ" Then
    If xJOURNALTYPE = "VCM" Then
    ...
    'If xJOURNALTYPE = "VCM" Or xJOURNALTYPE = "VDJ" Then
    If xJOURNALTYPE = "VCM" Then
        If Trim(txtRemarks.Text) = "Pls Type Your Message Here!" Then J_REMARKS = "NULL" Else J_REMARKS = Null2String(Trim(txtRemarks.Text))
    End If
    J_PAIDSTATUS = "'N'"
    J_RECEIVESTATUS = "'N'"
    ...
    If AddorEdit = "ADD" Then
        ...
        NEW_LogAudit "A", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, labID.Caption
    Else
        SQL_STATEMENT = "update AMIS_Journal_HD set" & _
                        " jdate = " & J_JDATE & "," & _
                        " voucherno = " & J_VOUCHERNO & "," & _
        ...
        'labID.Caption = FindNewID(J_VOUCHERNO, "VOUCHERNO", "AMIS_JOURNAL_HD", J_JTYPE, "JTYPE")
        NEW_LogAudit "E", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    ...
    If AddorEdit <> "ADD" Then
        ...
        SQL_STATEMENT = "update AMIS_Journal_HD set" & _
                        ...
                        " where id = " & labID.Caption
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "E", "VENDOR CREDIT MEMO AMOUNT", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    End If
    rsRefresh
    rsJournal_HD.Find "jno = " & J_JNO
    cmdCancel.Value = True
...
Private Sub cmdSelect_Click()
    ...
    Call frmNewEntity.LOADJOURNAL("VCM")
    frmNewEntity.Show 1
End Sub
...
'                Exit Sub
'            End If
    ''VALIDATION UPDATED BY: NORMAN ESPIRITU
            Dim rsCV_Detail                                 As ADODB.Recordset
            Set rsCV_Detail = New ADODB.Recordset
            Set rsCV_Detail = gconDMIS.Execute("Select * from AMIS_DetailS where PV_VoucherNo = '" & xJOURNALTYPE + "-" + txtVoucherNo.Text & "' and status <> 'C'")
            If Not rsCV_Detail.EOF And Not rsCV_Detail.BOF Then
                MsgBox "Warning: This AP Journal is already link to  " & Null2String(rsCV_Detail!JTYPE) + "-" + Null2String(rsCV_Detail!VOUCHERNO) & vbCrLf & _
    ...
    ''VALIDATION CREATED: NORMAN ESPIRITU
        ...
        If xJOURNALTYPE = "VCM" Or xJOURNALTYPE = "CDJ" Then
        ...
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "U", "VENDOR CREDIT MEMO", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
        ...
        StoreMemVars
        Screen.MousePointer = 0
        'LogAudit "U", "VENDOR CREDIT MEMO", txtJNo
        Exit Sub
    End If
ErrorCode:
    ShowVBError
...
'                           "and cannot be Change", vbInformation, "Edit Not Allowed!"
'                Else
'                    If Screen.ActiveForm.Name = "frmAMISJournalEntry_VCM" Then
'                        JournalTAB.Tab = 1
'                        cmdPV_Entry_Click
...
'        End If
    ...
    If Shift = 1 Then
        If KeyCode = vbKeyF1 Then
            ...
            Call frmALL_AuditInquiry.DisplayHistory(labID, "VENDOR CREDIT MEMO")
        End If
    End If
    If Shift = 2 Then
        ...
        If KeyCode = vbKeyF12 Then
            ...
            '                    gconDMIS.Execute ("Update AMIS_journal_hd set balance = 0, amountpaid='" & NumericVal(txtAmountToPay) & "',paidstatus='Y' where voucherno='" & txtVoucherNo & "' and jtype='VCM'")
...
Private Sub Form_Load()
    ...
    'Frame1.Top = 90
    fraATC.Visible = False
    If COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HGS" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Then
        bSelectEntity = True
...
Private Sub txtBankCode_Change()
    If xJOURNALTYPE = "VCM" Then cboBankName.Text = SetBankName(txtBankCode.Text)
End Sub
...
'        Else
'            Set rsJournal_HD2 = gconDMIS.Execute("select VoucherNo,JType,JDate,DueDate,AmountToPay,Balance from AMIS_Journal_HD where VoucherNo = '" & txtMRR_No.Text & "' and JType = 'VCM'and status='P'")
'        End If
...
Sub GettheTaxBaseAmnt()
    ...
    If xJOURNALTYPE = "VCM" Then
        SQL = "select sum(debit) as SumDebit from AMIS_journal_det where voucherno = '" & txtVoucherNo & "' and Acct_code <> '" & ReturnInPutTax & "' and jtype = 'VCM'"
    Else
...
Sub CheckIfthereISCDJ(XXX As String)
    ...
    If Not RSCDJ.EOF And Not RSCDJ.BOF Then
        gconDMIS.Execute "UPDATE AMIS_journal_hd set balance = " & TOTALPVAMOUNT - TotalAPAmountToPay & "  where voucherno='" & XXX & "' and jtype='VCM'"
    End If
    Set RSCDJ = Nothing
End Sub
...
Function GET_AP_VOUCHERNO() As Boolean
    ...
    rsAP_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.CHECKNO AS INVOICENO,HD.CHECKDATE AS INVOICEDATE,HD.DUEDATE,ACCT_CODE " & _
                      ...
                      "WHERE LEFT(DET.ACCT_CODE,2) = 21 AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & " AND HD.STATUS = 'P'", gconDMIS, adOpenKeyset
...
Sub LOAD_ARAP_DETAILS()
    If Picture1.Visible = True Then
        ...
        ElseIf CheckIfAPDebitNotZero(lstDetails.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(lstDetails.SelectedItem.SubItems(1))), lstDetails.SelectedItem.SubItems(3)) = True Then
            Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(txtVoucherNo.Text, xJOURNALTYPE, lstDetails.SelectedItem.SubItems(1), txtJDate.Text, lstDetails.SelectedItem.SubItems(3), "", txtCode.Text, lstDetails.SelectedItem.SubItems(3), labDetID.Caption)
            If Null2String(rsJournal_HD!Status) = "N" Then
