...
Begin VB.Form frmAMISJournalEntries 
   ...
   Begin VB.PictureBox fraAddJournal 
      ...
      Begin VB.CommandButton cmdEntity 
         ...
         Height          =   795
         Left            =   6930
         Picture         =   "frmAMISJournalEntries.frx":1E31
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   765
         Width           =   705
      ...
      Begin VB.CommandButton cmdParticulars 
         ...
         Height          =   795
         Left            =   750
         Picture         =   "frmAMISJournalEntries.frx":2EB3
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   1725
         Visible         =   0   'False
...
''END COUNTER CHECKING BY NRE
    ...
    Call frmNewEntity.LOADJOURNAL("GJ")
    frmNewEntity.Show 1
End Sub
...
'If Function_Access(LOGID, "Acess_Delete", LocalAcess) = False Then Exit Sub
    ...
    If MsgBox("Delete this Journal entry, are you sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
        If CheckARDetails(xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(5)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the AR details"
            Exit Sub
        End If

        If CheckAPDetails(xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(5)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the AP details"
            Exit Sub
        End If

        If CheckARPaymentDetails(xJOURNALTYPE, frmAMISJournalEntry_GJ.txtVoucherNo.Text, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(5)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the Payment details"
            Exit Sub
        End If

        If CheckAPPaymentDetails(xJOURNALTYPE, frmAMISJournalEntry_GJ.txtVoucherNo.Text, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(5)) = True Then
            MessagePop InfoWarning, "System Message", "Action not allowed. Check for the Payment details"
            Exit Sub
        End If
...
Function JournalEntriesNew() As Boolean
    ...
    J_JNO = N2Str2Null(frmAMISJournalEntry_GJ.txtJNo.Text)
    ...
    If AddorEdit = "ADD" Then
        SQL_STATEMENT = "insert into AMIS_Journal_Det " & _
                        ...
                        ", " & J_CREDIT & ", " & J_TAX & ", " & J_STATUS & "," & J_ATC & "," & J_RATE & "," & J_TAXBASE & "," & J_INVOICENO & "," & J_INVOICETYPE & "," & J_CUSCDE & "," & xADJ_VOUCHERNO & "," & xADJ_TYPE & ", " & xADJ_REMARKS & "," & xIS_OTHERS & "," & frmAMISJournalEntry_GJ.labID.Caption & "," & J_NETAMT & "," & J_GROSSAMT & ")"
        gconDMIS.Execute SQL_STATEMENT
        JOURNAL_DETID = FindNewID(J_VOUCHERNO, "VOUCHERNO", "AMIS_JOURNAL_DET", J_JTYPE, "JTYPE")

        NEW_LogAudit "AA", "GENERAL JOURNAL", SQL_STATEMENT, frmAMISJournalEntry_GJ.labID, "", frmAMISJournalEntry_GJ.txtVoucherNo, xJOURNALTYPE, CStr(JOURNAL_DETID)
...
Public Sub frmNewEntity_EntitySelected(strCode As String, strAccountName As String, strEntityClass As String)
    ...
    frmAMISJournalEntry_GJ.labcode.Caption = strCode
    frmAMISJournalEntry_GJ.labName.Caption = strAccountName
...
Sub CHECK_DETAILS()
    If AddorEdit = "ADD" Then
        If CheckIfARDebitNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtDebit.Text) = True Then
            Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, cboAcct_Code.Text, frmAMISJournalEntry_GJ.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
            frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
        ...
        ElseIf CheckIfAPDebitNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtDebit.Text) = True Then
            Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJournalEntry_GJ.txtVoucherNo.Text, xJOURNALTYPE, cboAcct_Code.Text, frmAMISJournalEntry_GJ.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
            frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
        ...
        ElseIf CheckIfARCreditNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtCredit.Text) = True Then
            Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJournalEntry_GJ.txtVoucherNo.Text, xJOURNALTYPE, cboAcct_Code.Text, frmAMISJournalEntry_GJ.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
            frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
            frmAMISJournalEntry_DetailPayment.Show 1
        ElseIf CheckIfAPCreditNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtCredit.Text) = True Then
            Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, cboAcct_Code.Text, frmAMISJournalEntry_GJ.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
             frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
            frmAMISJournalEntry_Details.Show 1
        End If
    Else
        If CheckIfSameAccount(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), cboAcct_Code.Text, xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, txtDebit.Text, txtCredit.Text) = False Then
            MessagePop InfoWarning, "System Message", "Action not allowed. " & Chr(13) & "See details for account code " & frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1)
            Exit Sub
        Else
            If CheckIfARDebitNotZero(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1))), txtDebit.Text) = True Then
                If CheckIfBalanceAR(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), NumericVal(txtDebit.Text), xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJournalEntry_GJ.labDetID.Caption)
                    frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
                    frmAMISJournalEntry_Details.Show 1
                End If
            ElseIf CheckIfAPDebitNotZero(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1))), txtDebit.Text) = True Then
                If CheckIfBalanceAPDetails(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), NumericVal(txtDebit.Text), xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJournalEntry_GJ.txtVoucherNo.Text, xJOURNALTYPE, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJournalEntry_GJ.labDetID.Caption)
                    frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
                    frmAMISJournalEntry_DetailPayment.Show 1
                End If
            ElseIf CheckIfARCreditNotZero(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1))), txtCredit.Text) = True Then
                If CheckIfBalanceARDetails(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), NumericVal(txtCredit.Text), xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJournalEntry_GJ.txtVoucherNo.Text, xJOURNALTYPE, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJournalEntry_GJ.labDetID.Caption)
                    frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
                    frmAMISJournalEntry_DetailPayment.Show 1
                End If
            ElseIf CheckIfAPCreditNotZero(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1))), txtCredit.Text) = True Then
                If CheckIfBalanceAP(frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), NumericVal(txtCredit.Text), xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJournalEntry_GJ.txtVoucherNo.Text, frmAMISJournalEntry_GJ.lstGJ.SelectedItem.SubItems(1), frmAMISJournalEntry_GJ.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJournalEntry_GJ.labDetID.Caption)
                    frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJournalEntry_GJ.txtVoucherNo.Text
                    frmAMISJournalEntry_Details.Show 1
                End If
