...
Begin VB.Form frmAMISJournalEntries_CAJE 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "CAJE Journal Entry"
   ClientHeight    =   2745
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   9195
   Icon            =   "frmAMISJournalEntries_CAJE.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox fraAddJournal 
      ...
      Begin VB.CommandButton cmdJournalCancel 
         ...
         Height          =   795
         Left            =   8315
         MouseIcon       =   "frmAMISJournalEntries_CAJE.frx":1082
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntries_CAJE.frx":11D4
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   765
         Width           =   705
      ...
      Begin VB.CommandButton cmdJournalSave 
         ...
         Height          =   795
         Left            =   7620
         MouseIcon       =   "frmAMISJournalEntries_CAJE.frx":1512
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntries_CAJE.frx":1664
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   765
         Width           =   705
      ...
      Begin VB.CommandButton cmdJournalDelete 
         ...
         Height          =   795
         Left            =   60
         MouseIcon       =   "frmAMISJournalEntries_CAJE.frx":19B4
         MousePointer    =   99  'Custom
         Picture         =   "frmAMISJournalEntries_CAJE.frx":1B06
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   765
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdEntity 
         ...
         Height          =   795
         Left            =   6930
         Picture         =   "frmAMISJournalEntries_CAJE.frx":1E31
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   765
         Width           =   705
      ...
      Begin VB.CommandButton cmdParticulars 
         ...
         Height          =   795
         Left            =   750
         Picture         =   "frmAMISJournalEntries_CAJE.frx":2EB3
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   1725
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAMISJournalEntries_CAJE"
...
''END COUNTER CHECKING BY NRE
    ...
    Call frmNewEntity.LOADJOURNAL("CAJ")
    frmNewEntity.Show 1
End Sub

Private Sub cmdJournalCancel_Click()
    Call frmAMISJouirnalEntry_CAJE.load_voucher_chk
...
'If Function_Access(LOGID, "Acess_Delete", LocalAcess) = False Then Exit Sub
    ...
    If frmAMISJouirnalEntry_CAJE.labDetID.Caption = "" Then
    ...
    If MsgBox("Delete this Journal entry, are you sure?", vbQuestion + vbYesNo, "Delete Journal Entry") = vbYes Then
        ...
        SQL_STATEMENT = "DELETE FROM AMIS_JOURNAL_DET WHERE id = " & frmAMISJouirnalEntry_CAJE.labDetID.Caption & ""
        gconDMIS.Execute SQL_STATEMENT
        NEW_LogAudit "XX", "GENERAL JOURNAL", SQL_STATEMENT, frmAMISJouirnalEntry_CAJE.labID.Caption, "DT", frmAMISJouirnalEntry_CAJE.txtVoucherNo, xJOURNALTYPE, frmAMISJouirnalEntry_CAJE.labDetID.Caption
    End If
    LOAD_NEWJOURNAL = False
    Unload Me
    Call frmAMISJouirnalEntry_CAJE.StoreSearch(frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text)
End Sub
...
''END COUNTER CHECKING BY NRE
    ...
    If AddorEdit = "ADD" Then frmAMISJouirnalEntry_CAJE.LOAD_JOURNALENTRY Else cmdJournalCancel_Click
...
Function JournalEntriesNew() As Boolean
    ...
    J_JDATE = N2Date2Null(frmAMISJouirnalEntry_CAJE.txtJDate.Text)
    J_VOUCHERNO = N2Str2Null(frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text)
    J_JTYPE = N2Str2Null(xJOURNALTYPE)
    J_JNO = N2Str2Null(frmAMISJouirnalEntry_CAJE.txtJNo.Text)
    ...
    If AddorEdit = "ADD" Then
        SQL_STATEMENT = "insert into AMIS_Journal_Det " & _
                        ...
                        ", " & J_CREDIT & ", " & J_TAX & ", " & J_STATUS & "," & J_ATC & "," & J_RATE & "," & J_TAXBASE & "," & J_INVOICENO & "," & J_INVOICETYPE & "," & J_CUSCDE & "," & xADJ_VOUCHERNO & "," & xADJ_TYPE & ", " & xADJ_REMARKS & "," & xIS_OTHERS & "," & frmAMISJouirnalEntry_CAJE.labID.Caption & "," & J_NETAMT & "," & J_GROSSAMT & ")"
        gconDMIS.Execute SQL_STATEMENT
        JOURNAL_DETID = FindNewID(J_VOUCHERNO, "VOUCHERNO", "AMIS_JOURNAL_DET", J_JTYPE, "JTYPE")

        NEW_LogAudit "AA", "CLIENT ADJUSTING JOURNAL ENTRIES", SQL_STATEMENT, frmAMISJouirnalEntry_CAJE.labID, "", frmAMISJouirnalEntry_CAJE.txtVoucherNo, xJOURNALTYPE, CStr(JOURNAL_DETID)
    ...
    Else
        gconDMIS.Execute "update AMIS_Journal_Det set" & _
                         ...
                         " where id = " & frmAMISJouirnalEntry_CAJE.labDetID.Caption
        NEW_LogAudit "EE", "CLIENT ADJUSTING JOURNAL ENTRIES", SQL_STATEMENT, frmAMISJouirnalEntry_CAJE.labID, "", frmAMISJouirnalEntry_CAJE.txtVoucherNo, xJOURNALTYPE, frmAMISJouirnalEntry_CAJE.labDetID.Caption
        MessagePop RecSave, "INFORMATION", "Record Succesfully updated"
    End If
    CHECK_DETAILS
    frmAMISJouirnalEntry_CAJE.labDetID.Caption = ""
    LOAD_NEWJOURNAL = False
    JournalEntriesNew = True
    Unload Me
    Call frmAMISJouirnalEntry_CAJE.StoreSearch(J_VOUCHERNO)
    Exit Function
ErrorCode:
...
Sub GettheTaxBaseAmnt()
    ...
    If xJOURNALTYPE = "CAJ" Then
        SQL = "select sum(debit) as SumDebit from AMIS_journal_det where voucherno = '" & frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text & "' and Acct_code <> '" & ReturnInPutTax & "' and jtype = 'CAJ'"
    End If
...
Public Sub frmNewEntity_EntitySelected(strCode As String, strAccountName As String, strEntityClass As String)
    ...
    frmAMISJouirnalEntry_CAJE.labcode.Caption = strCode
    frmAMISJouirnalEntry_CAJE.labName.Caption = strAccountName
...
Sub CHECK_DETAILS()
    If AddorEdit = "ADD" Then
        If CheckIfARDebitNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtDebit.Text) = True Then
            Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, cboAcct_Code.Text, frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
            frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
        ...
        ElseIf CheckIfAPDebitNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtDebit.Text) = True Then
            Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, xJOURNALTYPE, cboAcct_Code.Text, frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
            frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
        ...
        ElseIf CheckIfARCreditNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtCredit.Text) = True Then
            Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, xJOURNALTYPE, cboAcct_Code.Text, frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
            frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
            frmAMISJournalEntry_DetailPayment.Show 1
        ElseIf CheckIfAPCreditNotZero(cboAcct_Code.Text, CheckIfARAccount(N2Str2Null(cboAcct_Code.Text)), txtCredit.Text) = True Then
            Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, cboAcct_Code.Text, frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, JOURNAL_DETID)
             frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
            frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
            frmAMISJournalEntry_Details.Show 1
        End If
    Else
        If CheckIfSameAccount(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), cboAcct_Code.Text, xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, txtDebit.Text, txtCredit.Text) = False Then
            MessagePop InfoWarning, "System Message", "Action not allowed. " & Chr(13) & "See details for account code " & frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1)
            Exit Sub
        Else
            If CheckIfARDebitNotZero(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1))), txtDebit.Text) = True Then
                If CheckIfBalanceAR(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), NumericVal(txtDebit.Text), xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJouirnalEntry_CAJE.labDetID.Caption)
                    frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
                    frmAMISJournalEntry_Details.Show 1
                End If
            ElseIf CheckIfAPDebitNotZero(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1))), txtDebit.Text) = True Then
                If CheckIfBalanceAPDetails(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), NumericVal(txtDebit.Text), xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, xJOURNALTYPE, frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtDebit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJouirnalEntry_CAJE.labDetID.Caption)
                    frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
                    frmAMISJournalEntry_DetailPayment.Show 1
                End If
            ElseIf CheckIfARCreditNotZero(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1))), txtCredit.Text) = True Then
                If CheckIfBalanceARDetails(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), NumericVal(txtCredit.Text), xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_DetailPayment.LOAD_DATA(frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, xJOURNALTYPE, frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJouirnalEntry_CAJE.labDetID.Caption)
                    frmAMISJournalEntry_DetailPayment.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_DetailPayment.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
                    frmAMISJournalEntry_DetailPayment.Show 1
                End If
            ElseIf CheckIfAPCreditNotZero(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), CheckIfARAccount(N2Str2Null(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1))), txtCredit.Text) = True Then
                If CheckIfBalanceAP(frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), NumericVal(txtCredit.Text), xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text) = False Then
                    Call frmAMISJournalEntry_Details.LOAD_DATA(xJOURNALTYPE + "-" + frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text, frmAMISJouirnalEntry_CAJE.lstGJ.SelectedItem.SubItems(1), frmAMISJouirnalEntry_CAJE.txtJDate.Text, txtCredit.Text, lblClass.Caption, lblCode.Caption, txtDebit.Text, frmAMISJouirnalEntry_CAJE.labDetID.Caption)
                    frmAMISJournalEntry_Details.xD_JType = xJOURNALTYPE
                    frmAMISJournalEntry_Details.xD_Voucherno = frmAMISJouirnalEntry_CAJE.txtVoucherNo.Text
                    frmAMISJournalEntry_Details.Show 1
                End If
