...
Begin VB.Form frmAMISJournalEntry_DRJ 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   8550
         MouseIcon       =   "DRJJounalEntry.frx":08CA
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":0A1C
         Style           =   1  'Graphical
         TabIndex        =   217
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   7770
         MouseIcon       =   "DRJJounalEntry.frx":0D82
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":0ED4
         Style           =   1  'Graphical
         TabIndex        =   216
      ...
      Begin VB.CommandButton cmdCancelCO 
         ...
         Left            =   7020
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "DRJJounalEntry.frx":123A
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":138C
         Style           =   1  'Graphical
         TabIndex        =   215
      ...
      Begin VB.CommandButton cmdUnPost 
         ...
         Left            =   6255
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "DRJJounalEntry.frx":16C6
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":1818
         Style           =   1  'Graphical
         TabIndex        =   214
      ...
      Begin VB.CommandButton cmdPost 
         ...
         Left            =   5505
         MaskColor       =   &H0000FFFF&
         MouseIcon       =   "DRJJounalEntry.frx":1B5D
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":1CAF
         Style           =   1  'Graphical
         TabIndex        =   213
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   4755
         MouseIcon       =   "DRJJounalEntry.frx":1FD4
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":2126
         Style           =   1  'Graphical
         TabIndex        =   212
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   4005
         MouseIcon       =   "DRJJounalEntry.frx":2482
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":25D4
         Style           =   1  'Graphical
         TabIndex        =   211
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   3255
         MouseIcon       =   "DRJJounalEntry.frx":28E7
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":2A39
         Style           =   1  'Graphical
         TabIndex        =   210
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   2505
         MouseIcon       =   "DRJJounalEntry.frx":2D89
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":2EDB
         Style           =   1  'Graphical
         TabIndex        =   209
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1755
         MouseIcon       =   "DRJJounalEntry.frx":3239
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":338B
         Style           =   1  'Graphical
         TabIndex        =   208
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   1005
         MouseIcon       =   "DRJJounalEntry.frx":3685
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":37D7
         Style           =   1  'Graphical
         TabIndex        =   207
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   255
         MouseIcon       =   "DRJJounalEntry.frx":3B2F
         MousePointer    =   99  'Custom
         Picture         =   "DRJJounalEntry.frx":3C81
         Style           =   1  'Graphical
         TabIndex        =   206
   ...
   Begin VB.PictureBox Frame1 
      ...
      Begin VB.PictureBox picDisbursement 
         ...
         Begin RichTextLib.RichTextBox txtParticulars 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"DRJJounalEntry.frx":3FE0
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picReceivable 
         ...
         Begin RichTextLib.RichTextBox txtRemarks2 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"DRJJounalEntry.frx":4074
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picPayables 
         ...
         Begin RichTextLib.RichTextBox txtRemarks 
            ...
            BackColor       =   16777215
            ScrollBars      =   2
            TextRTF         =   $"DRJJounalEntry.frx":410B
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "DRJJounalEntry.frx":433C
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
      ...
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   60
            MouseIcon       =   "DRJJounalEntry.frx":44BA
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":460C
            Style           =   1  'Graphical
            TabIndex        =   154
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7110
            MouseIcon       =   "DRJJounalEntry.frx":4937
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":4A89
            Style           =   1  'Graphical
            TabIndex        =   155
            Top             =   735
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   7845
            MouseIcon       =   "DRJJounalEntry.frx":4DD9
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":4F2B
            Style           =   1  'Graphical
            TabIndex        =   157
            Top             =   735
            Width           =   705
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Height          =   795
            Left            =   240
            MouseIcon       =   "DRJJounalEntry.frx":5269
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":53BB
            Style           =   1  'Graphical
            TabIndex        =   184
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               BackColor       =   16777215
               MultiLine       =   0   'False
               TextRTF         =   $"DRJJounalEntry.frx":56E6
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8310
            MouseIcon       =   "DRJJounalEntry.frx":5779
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":58CB
            Style           =   1  'Graphical
            TabIndex        =   201
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7620
            MouseIcon       =   "DRJJounalEntry.frx":5C09
            MousePointer    =   99  'Custom
            Picture         =   "DRJJounalEntry.frx":5D5B
            Style           =   1  'Graphical
            TabIndex        =   200
            Top             =   720
            Width           =   705
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.BOF Then
        ...
        If xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "DRJ" Then
            ...
            If Left(Null2String(rsJournal_HD!INVOICENO), 2) = "NV" Then
                chkNonVat.Value = 1
                ''UPDATE BY NRE 10/20/14
                  txtInvoiceNo.Text = Right(Null2String(rsJournal_HD!INVOICENO), Len(rsJournal_HD!INVOICENO) - 2)
...
Private Sub cmdPost_Click()
    ...
    ''END COUNTER CHECKING BY NRE
     ...
     If CIALREADYEXIST(txtInvoiceNo.Text) = True Then
                MsgBox "O.R. NUM. ALREADY EXIST", vbCritical, "Warning"
                Exit Sub
    End If
...
Private Sub Form_Load()
    ...
    ElseIf xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "DRJ" Then
        ...
        labDate.Caption = "Date Deposited": labAmt.Caption = "O.R. Amount": labTerms.Visible = False
        picReceivable.Visible = True: picReceivable.ZOrder 0: picReceivable.Enabled = True
        picPayables.Visible = False: picPayables.ZOrder 1: picPayables.Enabled = False
        picDisbursement.Visible = False: picDisbursement.ZOrder 1: picDisbursement.Enabled = False
...
cmdCancel.Value = True
End Sub
Function CIALREADYEXIST(XXX As String) As Boolean
Dim rsCIAEXIST As ADODB.Recordset
Set rsCIAEXIST = New ADODB.Recordset
Set rsCIAEXIST = gconDMIS.Execute("SELECT * FROM AMIS_JOURNAL_HD where INVOICENO = '" & txtInvoiceNo.Text & "' AND JTYPE = 'DRJ' AND VOUCHERNO <> '" & txtVoucherNo.Text & "'")
If Not rsCIAEXIST.EOF And Not rsCIAEXIST.BOF Then
    CIALREADYEXIST = True
Else
    CIALREADYEXIST = False
End If
