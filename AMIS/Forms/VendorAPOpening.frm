...
Begin VB.Form frmAMISVendorAPOpening 
   ...
   Begin TabDlg.SSTab JournalTAB 
      ...
      Tab(0).Control(0)=   "lstDetails"
      Tab(0).Control(1)=   "fraDetails"
      Tab(0).Control(2)=   "fraAddJournal"
      Tab(0).Control(3)=   "cmdAddJournal"
      ...
      Begin VB.PictureBox fraAddJournal 
         ...
         Begin VB.CommandButton cmdJournalDelete 
            ...
            Picture         =   "VendorAPOpening.frx":0E0B
            Style           =   1  'Graphical
            TabIndex        =   156
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalCancel 
            ...
            Height          =   795
            Left            =   8295
            MouseIcon       =   "VendorAPOpening.frx":1136
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":1288
            Style           =   1  'Graphical
            TabIndex        =   165
            Top             =   765
            Width           =   705
         ...
         Begin VB.CommandButton cmdJournalSave 
            ...
            Height          =   795
            Left            =   7560
            MouseIcon       =   "VendorAPOpening.frx":15C6
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":1718
            Style           =   1  'Graphical
            TabIndex        =   164
            Top             =   765
            Width           =   705
         ...
         Begin VB.Frame Frame2 
            ...
            Begin RichTextLib.RichTextBox txtAcct_Name 
               ...
               Enabled         =   -1  'True
               MultiLine       =   0   'False
               TextRTF         =   $"VendorAPOpening.frx":1A68
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   9
                  Charset         =   0
      ...
      Begin wizButton.cmd cmdAddJournal 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "VendorAPOpening.frx":1AFB
      End
      Begin VB.PictureBox picPV_Entry 
         ...
         Begin VB.CommandButton cmdPVCancel 
            ...
            Height          =   795
            Left            =   8340
            MouseIcon       =   "VendorAPOpening.frx":1B17
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":1C69
            Style           =   1  'Graphical
            TabIndex        =   187
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVSave 
            ...
            Height          =   795
            Left            =   7650
            MouseIcon       =   "VendorAPOpening.frx":1FA7
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":20F9
            Style           =   1  'Graphical
            TabIndex        =   185
            Top             =   720
            Width           =   705
         ...
         Begin VB.CommandButton cmdPVDelete 
            ...
            Height          =   795
            Left            =   6960
            MouseIcon       =   "VendorAPOpening.frx":2449
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":259B
            Style           =   1  'Graphical
            TabIndex        =   184
            Top             =   720
            Width           =   705
      ...
      Begin wizButton.cmd cmdPV_Entry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "VendorAPOpening.frx":28C6
      End
      Begin VB.PictureBox picPV_Detail 
         ...
         Begin MSComctlLib.ListView lstPV_Detail 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "VendorAPOpening.frx":28E2
            NumItems        =   7
            BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
               Text            =   "ITEM #"
               Object.Width           =   1587
   ...
   Begin VB.Frame fraFindAccount 
      ...
      Begin MSComctlLib.ListView lstAccounts 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "VendorAPOpening.frx":6F5D
         NumItems        =   4
         BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            Text            =   "CODE"
            Object.Width           =   2646
   ...
   Begin wizButton.cmd cmdTemplates 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "VendorAPOpening.frx":70BF
   End
   Begin VB.PictureBox picGJ 
      ...
      Begin VB.PictureBox picGJEntry 
         ...
         Begin VB.CommandButton cmdGJCancel 
            ...
            Left            =   8160
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "VendorAPOpening.frx":70DB
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":722D
            Style           =   1  'Graphical
            TabIndex        =   97
            Top             =   690
            Width           =   1005
         ...
         Begin VB.CommandButton cmdGJSave 
            ...
            Left            =   7140
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "VendorAPOpening.frx":753F
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":7691
            Style           =   1  'Graphical
            TabIndex        =   94
            Top             =   690
            Width           =   975
         ...
         Begin VB.CommandButton cmdGJDelete 
            ...
            Left            =   90
            MaskColor       =   &H0000FFFF&
            MouseIcon       =   "VendorAPOpening.frx":7AD3
            MousePointer    =   99  'Custom
            Picture         =   "VendorAPOpening.frx":7C25
            Style           =   1  'Graphical
            TabIndex        =   95
            Top             =   720
            Width           =   1005
         ...
         Begin RichTextLib.RichTextBox txtGJAccountName 
            ...
            MultiLine       =   0   'False
            Appearance      =   0
            TextRTF         =   $"VendorAPOpening.frx":7F2F
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   9
               Charset         =   0
         ...
         Begin RichTextLib.RichTextBox txtGJAccountParticulars 
            ...
            ScrollBars      =   2
            Appearance      =   0
            TextRTF         =   $"VendorAPOpening.frx":7FC2
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   9.75
               Charset         =   0
      ...
      Begin wizButton.cmd cmdGJEntry 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "VendorAPOpening.frx":8059
      End
      Begin RichTextLib.RichTextBox txtParticulars2 
         ...
         Enabled         =   -1  'True
         ScrollBars      =   2
         TextRTF         =   $"VendorAPOpening.frx":8075
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Courier New"
            Size            =   9.75
            Charset         =   0
   ...
   Begin wizButton.cmd cmdFindAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "VendorAPOpening.frx":810C
   End
   Begin MSComctlLib.ListView lstTemplates 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "VendorAPOpening.frx":8128
      NumItems        =   2
      BeginProperty ColumnHeader(1) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
         Text            =   "DESCRIPTION"
         Object.Width           =   11819
...
Attribute rsPayTerm.VB_VarUserMemId = 1073938441
Dim rsBanks                                                 As ADODB.Recordset
Attribute rsBanks.VB_VarUserMemId = 1073938442
...
Dim xEntityClass2                                           As String
Dim WithEvents frmNewEntity                                 As frmEntity
Attribute frmNewEntity.VB_VarHelpID = -1
Dim WithEvents frmNewEntity2                                As frmEntity
Attribute frmNewEntity2.VB_VarHelpID = -1
...
Function SetVendorCodeNew(VVV As Variant, XXX As Variant)
    Set rsVENDOR = New ADODB.Recordset
    'rsVENDOR.Open "Select code,nameofvendor from ALL_Vendor where nameofvendor = " & N2Str2Null(VVV), gconDMIS, adOpenForwardOnly, adLockReadOnly
    rsVENDOR.Open "Select Code,Address from ALL_ENTITY where code = " & N2Str2Null(VVV) & " AND ENTITYCODE=" & N2Str2Null(XXX), gconDMIS, adOpenForwardOnly, adLockReadOnly
    If Not rsVENDOR.EOF And Not rsVENDOR.BOF Then
        SetVendorCodeNew = Null2String(rsVENDOR!Code)
    Else
        SetVendorCodeNew = ""
    End If
End Function
...
'If JOURNALTYPE = "VPJ" Then
    ...
    If Not rsPV_Detail.EOF And Not rsPV_Detail.BOF Then
        ...
        txtCusCde.Text = Null2String(rsPV_Detail!REFCODE)
        lblEntity.Caption = Null2String(rsPV_Detail!ENTITYCODE)
        txtCustomerName.Text = GetACCTNAME(txtCusCde.Text)
    End If
...
Sub FillCboAcctName()
    Dim rsCOBAcctName                                       As ADODB.Recordset
    Set rsCOBAcctName = New ADODB.Recordset
    Set rsCOBAcctName = gconDMIS.Execute("Select * from AMIS_ChartAccount Where Left(Titles,2) IN ('21') AND ISNULL(IS_SCHEDULE_ACCNT,0) = 1 and Description IS NOT NULL Order by AcctCode asc")
    If Not rsCOBAcctName.EOF And Not rsCOBAcctName.BOF Then
...
Sub initMemvars()
    ...
    If COMPANY_CODE = "CMC" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HGS" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HCR" Then
...
Sub StoreMemVars()
    If Not rsJournal_HD.EOF And Not rsJournal_HD.BOF Then
        ...
        txtCode.Text = SetVendorCodeNew(Null2String(rsJournal_HD!VendorCode), Null2String(rsJournal_HD!ENTITY_CLASS))
    ...
    If MsgBox("Are you sure you want to perform Batch Posting?", vbQuestion + vbYesNo, "Message") = vbYes Then
        ...
        If Not rsJournal_HD.EOF And Not rsJournal_HD.BOF Then
            Do While Not rsJournal_HD.EOF
                ...
                '                        Exit Sub
                '                    End If
                If CheckGLSLVPJ(xJOURNALTYPE, txtVoucherNo.Text) = False Then
                    Screen.MousePointer = 0
                    Exit Sub
                End If
                cmdPost_Click
...
Private Sub cmdSelect2_Click()
    Set frmNewEntity2 = New frmEntity
    frmNewEntity2.LOADJOURNAL ("COB")
    frmNewEntity2.Show
End Sub
...
Private Sub cmdCancelCO_Click()
    ...
    If MsgBox("Are you sure you want to Cancel this Transaction?", vbQuestion + vbYesNo, "Cancel Journal") = vbYes Then
        Screen.MousePointer = 11
        If COMPANY_CODE = "HGC" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HCR" Then
            If xJOURNALTYPE = "VPJ" Then
        ...
        gconDMIS.Execute "update AMIS_Journal_HD set status = 'C',USERCODE='" & LOGCODE & "',PCNAME='" & LOGPCNAME & "',DATECANCELLED='" & LOGDATE & "' where jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text)
...
Private Sub cmdJournalSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        NEW_LogAudit "AA", "VENDOR OPENING BALANCE", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    Else
        gconDMIS.Execute "update AMIS_Journal_Det set" & _
                         " jdate = " & J_JDATE & "," & _
                         " voucherno = " & J_VOUCHERNO & "," & _
        ...
        NEW_LogAudit "EE", "VENDOR OPENING BALANCE", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    End If
    FillDetails
    gconDMIS.Execute "update AMIS_Journal_HD set" & _
                     " debit = " & TOTDEBIT & "," & _
...
Private Sub cmdPost_Click()
    ...
    If JournalPosting = False Then
        str_MSG = Replace(str_MSG, "@ACL09182716350", "Vendor Opening")
...
Function JournalPosting() As Boolean
    ...
    If Function_Access(LOGID, "Acess_Post", "VENDOR OPENING BALANCE") = False Then
        JournalPosting = True
        Exit Function
    End If
...
PerformBatchPosting:
        ...
        If lstPV_Detail.ListItems.Count > 0 Then
            If NumericVal(txtAmountToPay.Text) <> NumericVal(txtTotalPV_Amount.Text) Then
                MessagePop InfoFriend, "System Message", "Detail Amount is not equal with Amount to Pay."
                Screen.MousePointer = 0
                Exit Function
            End If
        End If
        ...
        'PostJournal:
        gconDMIS.Execute "update AMIS_Journal_HD set status = 'P',USERCODE='" & LOGCODE & "',PCNAME='" & LOGPCNAME & "',DATEPOSTED='" & LOGDATE & "' where jtype = '" & xJOURNALTYPE & "' and VoucherNo = " & N2Str2Null(txtVoucherNo.Text)
        ...
        End If
        Set rsPVDETAIL = Nothing
        gconDMIS.Execute "UPDATE AMIS_AP SET STATUS='P' WHERE LEFT(VOUCHERNO,3)='" & xJOURNALTYPE & "' AND RIGHT(VOUCHERNO,6) =" & N2Str2Null(txtVoucherNo.Text) & ""
...
Private Sub cmdPVSave_Click()
    ...
    Dim PV_AMOUNT                                           As Double
    Dim PV_STATUS, PV_ITEMNO                                As String
    Dim PV_REFCODE                                          As String
    Dim PV_ENTITYCODE                                       As String
    ...
    PV_STATUS = "'N'"
    PV_REFCODE = txtCusCde.Text
    PV_ENTITYCODE = xEntityClass2

    Screen.MousePointer = 11
    If AddorEdit = "ADD" Then
            gconDMIS.Execute "insert into AMIS_PV_Detail " & _
                             "(JDATE,JTYPE,VoucherNo,itemno,PO_No,MRR_No,INV_No,PROD_No,Amount,status,REFCODE,ENTITYCODE)" & _
                             " values (" & J_JDATE & ",'VPJ'," & J_JVOUCHERNO & ", " & PV_ITEMNO & ", " & PV_PONO & _
                             ", " & PV_MRRNO & ", " & PV_INVNO & ", " & PV_PRODNO & ", " & PV_AMOUNT & _
                             ", " & PV_STATUS & ",'" & PV_REFCODE & "','" & lblEntity.Caption & "')"
    Else
        If xJOURNALTYPE = "VPJ" Then
            gconDMIS.Execute "update AMIS_PV_Detail set" & _
                             ...
                             " PROD_No = " & PV_PRODNO & "," & _
                             " Amount = " & PV_AMOUNT & "," & _
                             " REFCODE = '" & txtCusCde.Text & "'," & _
                             " ENTITYCODE = '" & lblEntity.Caption & "'," & _
                             " status = " & PV_STATUS & _
...
Private Sub cmdSave_Click()
    ...
    If AddorEdit = "ADD" Then
        ...
        gconDMIS.Execute "Insert into AMIS_Journal_HD" & _
                         " (jdate,voucherno,jtype,vendorcode,customercode,invoicedate,invoicetype,invoiceno,invoiceamt,duedate,paytype,refno,refdate,terms,dealer,amounttopay,Balance,AmountPaid,jno,debit,credit,outbalance,status,CheckNo,CheckDate,BankCode,remarks,PaidStatus,ReceiveStatus,USERCODE,PCNAME,LASTUPDATE,ENTITY_CLASS)" & _
        ...
        NEW_LogAudit "A", "VENDOR OPENING BALANCE", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    ...
    Else
        gconDMIS.Execute "update AMIS_Journal_HD set" & _
                         ...
                         " remarks = " & J_REMARKS & ", USERCODE = '" & LOGCODE & "', PCNAME='" & LOGPCNAME & "',LASTUPDATE = '" & LOGDATE & "',ENTITY_CLASS=" & J_ENTITYCLASS & "" & _
                         " where id = " & labID.Caption

        labID.Caption = FindNewID(J_VOUCHERNO, "VOUCHERNO", "AMIS_JOURNAL_HD", J_JTYPE, "JTYPE")
        NEW_LogAudit "E", "VENDOR OPENING BALANCE", SQL_STATEMENT, labID.Caption, "", txtVoucherNo, xJOURNALTYPE, txtJNo
    ...
    If Trim(txtCOBAcctNo.Text) <> "" Then
        ...
        If Not rsCOB_Journal_Det.EOF And Not rsCOB_Journal_Det.BOF Then
            gconDMIS.Execute "UPDATE AMIS_JOURNAL_DET SET" & _
                             ...
                             " ACCT_NAME = " & N2Str2Null(cboCOBAcctName.Text) & ",CREDIT=" & J_AMOUNTTOPAY & "," & _
                             " JNO = " & J_JNO & _
                             " WHERE JTYPE = 'VPJ' AND JNO = '" & PrevJNo & "'"
        Else
            gconDMIS.Execute "INSERT INTO AMIS_JOURNAL_DET (JITEMNO,JTYPE,JDATE,VOUCHERNO,JNO,ACCT_CODE,ACCT_NAME,CREDIT)" & _
                             " VALUES ('0001','VPJ'," & J_JDATE & "," & J_VOUCHERNO & "," & J_JNO & "," & N2Str2Null(txtCOBAcctNo.Text) & "," & N2Str2Null(cboCOBAcctName.Text) & "," & J_AMOUNTTOPAY & ")"
        End If
    End If
    rsRefresh
...
Private Sub cmdSelect_Click()
    ...
    Call frmNewEntity.LOADJOURNAL("VPJ")
    frmNewEntity.Show 1
End Sub
...
Private Sub cmdUnPost_Click()
    ...
    If MsgBox("Are you sure you want to Unpost this transaction?", vbQuestion + vbYesNo, "Message") = vbYes Then
        If xJOURNALTYPE = "VPJ" Then
            Dim rsCV_Detail                                 As ADODB.Recordset
            Set rsCV_Detail = New ADODB.Recordset
            Set rsCV_Detail = gconDMIS.Execute("Select * from AMIS_Details where PV_VOUCHERNO='" & xJOURNALTYPE + "-" + txtVoucherNo.Text & "' and Acct_Code =  '" & txtCOBAcctNo.Text & "'  and status <> 'C'")
            If Not rsCV_Detail.EOF And Not rsCV_Detail.BOF Then
        ...
        gconDMIS.Execute "UPDATE AMIS_AP SET STATUS='N' WHERE LEFT(VOUCHERNO,3)='" & xJOURNALTYPE & "' AND RIGHT(VOUCHERNO,6) =" & N2Str2Null(txtVoucherNo.Text) & ""

        Dim xAPVOUCHERNO                                    As String
        xAPVOUCHERNO = xJOURNALTYPE & "-" & txtVoucherNo.Text
        If xJOURNALTYPE = "VPJ" Then
            gconDMIS.Execute "DELETE FROM AMIS_AR WHERE SJVOUCHERNO = " & N2Str2Null(xAPVOUCHERNO) & ""
...
Private Sub Form_Load()
    ...
    Frame1.Top = 90
    If COMPANY_CODE = "HCA" Then txtCode.MaxLength = "10"
...
Sub GET_AP_VOUCHERNO()
    ...
    rsAP_VOUCHER.Open "SELECT DISTINCT HD.VOUCHERNO,HD.VENDORCODE,HD.JDATE,HD.JTYPE,HD.CUSTOMERCODE,HD.INVOICENO,HD.INVOICETYPE,HD.INVOICEDATE,HD.DUEDATE,HD.AMOUNTTOPAY,ACCT_CODE " & _
                      ...
                      "WHERE LEFT(DET.ACCT_CODE,2) IN ('21') AND HD.JTYPE = " & N2Str2Null(xJOURNALTYPE) & " AND HD.VOUCHERNO = " & N2Str2Null(txtVoucherNo.Text) & " AND HD.STATUS = 'P'", gconDMIS, adOpenKeyset
...
Public Sub frmNewEntity2_EntitySelected(strCode As String, strAccountName As String, strEntityClass As String)
    txtCusCde.Text = strCode
    txtCustomerName.Text = strAccountName
    lblEntity.Caption = strEntityClass
    'txtAddress.Caption = SetVendorAddressNew(strCode, strEntityClass)
End Sub
...
Function GetACCTNAME(XXX As String) As String
    Dim rsACCTNAME                                          As ADODB.Recordset
    Set rsACCTNAME = New ADODB.Recordset
    rsACCTNAME.Open "SELECT ACCOUNTNAME FROM ALL_ENTITY WHERE CODE = '" & txtCusCde.Text & "' AND ENTITYCODE = '" & lblEntity.Caption & "'", gconDMIS, adOpenForwardOnly
    If Not rsACCTNAME.EOF And Not rsACCTNAME.BOF Then
        GetACCTNAME = Null2String(rsACCTNAME!ACCOUNTNAME)
    End If
    Set rsACCTNAME = Nothing
End Function

Function GetINVOICENO() As String
    Dim rsdetail                                            As ADODB.Recordset
    Set rsdetail = New ADODB.Recordset
    rsdetail.Open "SELECT INV_NO FROM AMIS_PV_DETAIL WHERE VOUCHERNO = '" & txtVoucherNo.Text & "' AND JTYPE='" & xJOURNALTYPE & "'", gconDMIS, adOpenForwardOnly
    If Not rsdetail.EOF And Not rsdetail.BOF Then
        GetINVOICENO = Null2String(rsdetail!INV_NO)
    End If
    Set rsdetail = Nothing
End Function

Function GetREFCODE() As String
    Dim rsdetail                                            As ADODB.Recordset
    Set rsdetail = New ADODB.Recordset
    rsdetail.Open "SELECT REFCODE FROM AMIS_PV_DETAIL WHERE VOUCHERNO = '" & txtVoucherNo.Text & "' AND JTYPE='" & xJOURNALTYPE & "'", gconDMIS, adOpenForwardOnly
    If Not rsdetail.EOF And Not rsdetail.BOF Then
        GetREFCODE = Null2String(rsdetail!REFCODE)
    End If
    Set rsdetail = Nothing
End Function

Function GetEntityCode() As String
    Dim rsdetail                                            As ADODB.Recordset
    Set rsdetail = New ADODB.Recordset
    rsdetail.Open "SELECT ENTITYCODE FROM AMIS_PV_DETAIL WHERE VOUCHERNO = '" & txtVoucherNo.Text & "' AND JTYPE='" & xJOURNALTYPE & "'", gconDMIS, adOpenForwardOnly
    If Not rsdetail.EOF And Not rsdetail.BOF Then
        GetEntityCode = Null2String(rsdetail!ENTITYCODE)
    End If
    Set rsdetail = Nothing
End Function

Function GetPVAmount() As String
    Dim rsdetail                                            As ADODB.Recordset
    Set rsdetail = New ADODB.Recordset
    rsdetail.Open "SELECT AMOUNT FROM AMIS_PV_DETAIL WHERE VOUCHERNO = '" & txtVoucherNo.Text & "' AND JTYPE='" & xJOURNALTYPE & "'", gconDMIS, adOpenForwardOnly
    If Not rsdetail.EOF And Not rsdetail.BOF Then
        GetPVAmount = Null2String(rsdetail!amount)
    End If
    Set rsdetail = Nothing
End Function

Function CheckGLSLVPJ(JTYPE As String, VOUCHERNO As String) As Boolean
    ...
    If Not rsJournalHD.EOF And Not rsJournalHD.BOF Then
        ...
        rsAP.Open "SELECT SUM(AMOUNT2PAY) AS AMOUNTTOPAY FROM AMIS_AP WHERE LEFT(VOUCHERNO,3)= '" & JTYPE & "' AND RIGHT(VOUCHERNO,6) = '" & VOUCHERNO & "'", gconDMIS, adOpenForwardOnly
        If Not rsAP.EOF And Not rsAP.BOF Then
            If NumericVal(rsJournalHD!AMOUNTTOPAY) = NumericVal(rsAP!AMOUNTTOPAY) Then
                CheckGLSLVPJ = True
            Else
                MessagePop InfoWarning, "System Message", "Please check. GL Amount not equal to SL" & Chr(13) & "AMOUNT TO PAY => " & NumericVal(rsJournalHD!AMOUNTTOPAY) & Chr(13) & "DETAIL => " & NumericVal(rsAP!AMOUNTTOPAY)
                CheckGLSLVPJ = False
                Screen.MousePointer = 0
                Exit Function
            End If
