...
Begin VB.Form frmAMISMASTERFILESTemplates 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboJType 
         ...
         ForeColor       =   &H00973640&
         Height          =   330
         ItemData        =   "Templates.frx":2D71
         Left            =   1290
         List            =   "Templates.frx":2D73
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "Templates.frx":2D75
         MousePointer    =   99  'Custom
         Picture         =   "Templates.frx":2EC7
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Cancel"
         Top             =   30
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "Templates.frx":3205
         MousePointer    =   99  'Custom
         Picture         =   "Templates.frx":3357
         Style           =   1  'Graphical
         TabIndex        =   29
...
Private Sub cmdSave_Click()
    If txtDescription.Text = "" Then
        MsgBox "Description required.", vbCritical, "Information"
        Exit Sub
    End If
    ...
    ElseIf cboJTYPE.Text = "CASH DISBURSEMENT JOURNAL" Then
        VtxtJType = "'CDJ'"
    ElseIf cboJTYPE.Text = "SALES JOURNAL" Then
        VtxtJType = "'SJ'"
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Case vbKeyF3
        If AddorEdit = "ADD" Or AddorEdit = "EDIT" Then Exit Sub
...
Private Sub Form_Load()
    ...
    cboJTYPE.AddItem "SALES JOURNAL"
