...
Function GetVoucherNo(XXX As String) As String
    ...
    Set rsJournal_HD = gconDMIS.Execute("Select substring(VOUCHERNO,5,len(VOUCHERNO)) as VOUCHERNO from AMIS_Journal_HD Where Jtype = '" & XXX & "' Order by VoucherNo desc")
    If Not rsJournal_HD.EOF And Not rsJournal_HD.BOF Then
        GetVoucherNo = "CCM" + "-" + Format(NumericVal(rsJournal_HD!VOUCHERNO) + 1, "000000")
    Else
        GetVoucherNo = "CCM-000001"
    End If
End Function
...
Sub initMemvars()
    ...
    'If Not rsJournal_HDDup.EOF And Not rsJournal_HDDup.BOF Then txtVoucherNo.Text = "CCM" + "-" + Format(N2Str2Zero(rsJournal_HDDup!VOUCHERNO) + 1, "000000") Else txtVoucherNo.Text = "CCM-000001"
...
Private Sub cmdAddJournal_Click()
    ...
    End If
    fraAddJournal.Enabled = False: cmdJournalDelete.Visible = False
    AddorEdit = "ADD"
    InitJournal
    On Error Resume Next
...
Private Sub cmdPost_Click()
    ...
    If JournalPosting = False Then
        str_MSG = Replace(str_MSG, "@ACL09182716350", "Customer Credit Memo")
