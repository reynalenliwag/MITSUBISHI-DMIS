...
Begin VB.Form frmAMISMASTERFILEBanks 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "Banks.frx":0D5A
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":0EAC
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   795
         Left            =   4860
         MouseIcon       =   "Banks.frx":135E
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":14B0
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   795
         Left            =   4170
         MouseIcon       =   "Banks.frx":1816
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":1968
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   795
         Left            =   3480
         MouseIcon       =   "Banks.frx":1CCE
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":1E20
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   795
         Left            =   2790
         MouseIcon       =   "Banks.frx":214B
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":229D
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   2100
         MouseIcon       =   "Banks.frx":25F9
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":274B
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   795
         Left            =   1410
         MouseIcon       =   "Banks.frx":2A5E
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":2BB0
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   720
         MouseIcon       =   "Banks.frx":2EAA
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":2FFC
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   30
         MouseIcon       =   "Banks.frx":3354
         MousePointer    =   99  'Custom
         Picture         =   "Banks.frx":34A6
         Style           =   1  'Graphical
         TabIndex        =   12
...
Sub InitCbo()
    ...
    If COMPANY_CODE = "DGI" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "FMC" Then
