...
Begin VB.Form frmNEW_ARSchedReport 
   ...
   Begin VB.PictureBox picReport 
      ...
      Begin VB.Image Image2 
         Height          =   720
         Left            =   120
         Picture         =   "NEW_ARSchedReport.frx":6852
         Top             =   30
         Width           =   720
      End
   ...
   Begin VB.PictureBox picNolink 
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   825
         Left            =   1890
         MouseIcon       =   "NEW_ARSchedReport.frx":7148
         MousePointer    =   99  'Custom
         Picture         =   "NEW_ARSchedReport.frx":729A
         Style           =   1  'Graphical
         TabIndex        =   40
      ...
      Begin VB.CommandButton Command6 
         ...
         Height          =   825
         Left            =   1020
         MouseIcon       =   "NEW_ARSchedReport.frx":76E5
         MousePointer    =   99  'Custom
         Picture         =   "NEW_ARSchedReport.frx":7837
         Style           =   1  'Graphical
         TabIndex        =   41
   ...
   Begin VB.PictureBox picAR 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Height          =   405
         Left            =   60
         Picture         =   "NEW_ARSchedReport.frx":7CD6
         ScaleHeight     =   405
         ScaleWidth      =   465
         TabIndex        =   54
         Top             =   30
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCheck 
         ...
         Height          =   795
         Left            =   4035
         MouseIcon       =   "NEW_ARSchedReport.frx":80B7
         MousePointer    =   99  'Custom
         Picture         =   "NEW_ARSchedReport.frx":8209
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin wizProgBar.Prg progCPB 
         ...
         _ExtentX        =   8229
         _ExtentY        =   556
         Picture         =   "NEW_ARSchedReport.frx":84A4
         BarPicture      =   "NEW_ARSchedReport.frx":84C0
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Private Sub cmdPrint_Click()
    ...
    If COMPANY_CODE = "HMH" Then
        rptAMISDueReport.Formulas(3) = "TIN = '" & COMPANY_TIN & "'"
    End If
        
    If cboCOBAcctName.Text = "" And Option2.Value = True And (COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE") Then
        ...
        If Report_Type = "SCHED" Then
            ...
            If Option1.Value = True Then
                If optAsOf.Value = True Then
                    ...
                    Else
                        ...
                        'JULIEBETH 04172013
                        If COMPANY_CODE = "CMC" Or COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HGS" Then
                            If optDetailed = True Then
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\ARScheduleReport.Rpt", 1)
                            Else
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\ARScheduleReportSummary.Rpt", 1)
                            End If
                        End If
            ...
            ElseIf Option2.Value = True Then
                ...
                Else
                    ...
                    If COMPANY_CODE = "CMC" Or COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Or COMPANY_CODE = "HGS" Then
'JULIEBETH 04172013
                        If optDetailed = True Then
                        ...
                        ElseIf optSummary = True Then
                            If cboCOBAcctName.Text = "ALL" Then
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\GroupARScheduleReportSummary.Rpt", 1)
                            Else
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\GroupARScheduleReportSummaryAccount.Rpt", 1)
                            End If
                        End If
                    Else
                        Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\GroupARScheduleReport.Rpt", 1)
                    ...
                    If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Then
                        If cboCOBAcctName.Text = "ALL" Then
                                If COMPANY_CODE = "HMH" Then
                                     Call rptRep.ParameterFields(5).AddCurrentValue(CDate(dtpAsOF))
                                Else
                        ...
                        Else
                                ...
                                Else
                                    Call rptRep.ParameterFields(4).AddCurrentValue(CDate(dtpAsOF))
                                    If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DGI" Then
                                    ''EDIT BY NORMAN
                                    ''DUE TO ERROR: THE VALUE RANGE YOU ARE ADDING HAS ALL READY EXIST
                                    Else
            ...
            If Report_Type = "AGING" Then
                ...
                ElseIf Option2.Value = True Then      ' Group report by Account
                    ...
                    Else
                        ...
                        If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Or COMPANY_CODE = "HGS" Then
                            If cboCOBAcctName.Text = "ALL" Then
                                If optDetailed = True Then
                        ...
                        If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLP" Or COMPANY_CODE = "HAM" Or COMPANY_CODE = "HSP" Or COMPANY_CODE = "HGC" Or COMPANY_CODE = "HCI" Or COMPANY_CODE = "HPI" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Then
                            ...
                            Else
                                If COMPANY_CODE = "HMH" Then
                                    Call rptRep.ParameterFields(5).AddCurrentValue(CDate(dtpAsOF))
                                    Call rptRep.ParameterFields(6).AddCurrentValue(txtCOBAcctNo.Text)
                                Else
                                    Call rptRep.ParameterFields(4).AddCurrentValue(CDate(dtpAsOF))
                                    Call rptRep.ParameterFields(5).AddCurrentValue(txtCOBAcctNo.Text)
                                End If
...
Private Sub Option2_Click()
    If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HNE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HGS" Then
        ...
        rsChartOfAccounts.Open "SELECT ACCTCODE,DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('11-01','11-02','11-03','11-06','11-07') AND IS_SCHEDULE_ACCNT=1", gconDMIS, adOpenKeyset
...
Function Setacctcode(xDescription As String) As String
    ...
    rsDescription.Open "SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('11-01','11-02','11-03','11-06') AND IS_SCHEDULE_ACCNT=1 AND DESCRIPTION = '" & xDescription & "'", gconDMIS, adOpenKeyset
