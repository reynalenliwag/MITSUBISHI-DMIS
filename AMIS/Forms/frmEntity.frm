...
Sub initMemvars()
    ...
    If xJOURNALTYPE = "COB" Or xJOURNALTYPE = "VPJ" Or xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "SCHED" Or xJOURNALTYPE = "GJ" Or xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "ADJ" Or xJOURNALTYPE = "CAJ" Or xJOURNALTYPE = "PAJ" Then
...
'        End If
'    Else
    If App.EXEName = "SMIS" Then
        If xJOURNALTYPE = "COB" Or xJOURNALTYPE = "VPJ" Or xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "SCHED" Or xJOURNALTYPE = "GJ" Or xJOURNALTYPE = "CMIS" Or xJOURNALTYPE = "SMIS" Then
        ...
        End If
    Else
        If xJOURNALTYPE = "COB" Or xJOURNALTYPE = "VPJ" Or xJOURNALTYPE = "APJ" Or xJOURNALTYPE = "CDJ" Or xJOURNALTYPE = "SJ" Or xJOURNALTYPE = "CRJ" Or xJOURNALTYPE = "SCHED" Or xJOURNALTYPE = "GJ" Or xJOURNALTYPE = "CMIS" Or xJOURNALTYPE = "SMIS" Or xJOURNALTYPE = "ADJ" Or xJOURNALTYPE = "CAJ" Or xJOURNALTYPE = "PAJ" Then
            'frmAMISCustomerAROpening.txtCustCode.Text = (Trim(Me.lvCustomer.SelectedItem.Text))
            'frmAMISCustomerAROpening.txtCustName.Text = (Trim(Me.lvCustomer.SelectedItem.SubItems(1)))
            xCODE = Trim(Me.lvCustomer.SelectedItem.Text)
            XaCCOUNTNAME = Trim(Me.lvCustomer.SelectedItem.SubItems(1))
