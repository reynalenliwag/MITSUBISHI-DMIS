...
Begin VB.Form frmAMISFinancialStatementsHCA 
   BackColor       =   &H00FFFFFF&
   ...
   ClientWidth     =   10080
   ForeColor       =   &H00FFFFFF&
   Icon            =   "FinancialStatementsHCA.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.Label labScheduleOfSellingExpensesBrpSection 
            ...
            Height          =   585
            Left            =   7170
            MouseIcon       =   "FinancialStatementsHCA.frx":030A
            MousePointer    =   99  'Custom
            TabIndex        =   28
            Top             =   8190
            Width           =   1815
         End
         Begin VB.Label labIncomeStatementBRPCumulative 
            Alignment       =   2  'Center
            BackColor       =   &H00FFFFFF&
            BackStyle       =   0  'Transparent
            Caption         =   "Income Statement BRP - Cumulative"
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   6.75
               Charset         =   0
            ...
            Height          =   585
            Left            =   7320
            MouseIcon       =   "FinancialStatementsHCA.frx":0614
            MousePointer    =   99  'Custom
            TabIndex        =   27
            Top             =   4290
            Width           =   1515
         ...
         Begin VB.Label labOwnersEquity 
            ...
            Height          =   435
            Left            =   510
            MouseIcon       =   "FinancialStatementsHCA.frx":091E
            MousePointer    =   99  'Custom
            TabIndex        =   24
            Top             =   3720
            Width           =   4035
         ...
         Begin VB.Label labCashFlow 
            ...
            Height          =   255
            Left            =   4890
            MouseIcon       =   "FinancialStatementsHCA.frx":0C28
            MousePointer    =   99  'Custom
            TabIndex        =   23
            Top             =   3720
            Width           =   4035
         ...
         Begin VB.Label labIncomeStatementByProductCumulative 
            ...
            Height          =   735
            Left            =   210
            MouseIcon       =   "FinancialStatementsHCA.frx":0F32
            MousePointer    =   99  'Custom
            TabIndex        =   11
            Top             =   11910
            Width           =   4395
         ...
         Begin VB.Label labIncomeStatementByProductCurrent 
            ...
            Height          =   735
            Left            =   4860
            MouseIcon       =   "FinancialStatementsHCA.frx":123C
            MousePointer    =   99  'Custom
            TabIndex        =   10
            Top             =   11910
            Width           =   4395
         ...
         Begin VB.Label labScheduleOAdministrativeExpensesCumulative 
            ...
            Height          =   795
            Left            =   2250
            MouseIcon       =   "FinancialStatementsHCA.frx":1546
            MousePointer    =   99  'Custom
            TabIndex        =   9
            Top             =   13965
            Width           =   5055
         ...
         Begin VB.Label labScheduleOfAdminAndSellingExpensesCurrent 
            ...
            Height          =   975
            Left            =   5280
            MouseIcon       =   "FinancialStatementsHCA.frx":1850
            MousePointer    =   99  'Custom
            TabIndex        =   8
            Top             =   16800
            Width           =   3375
         ...
         Begin VB.Label labScheduleOfAdminAndSellingExpensesCumulative 
            ...
            Height          =   975
            Left            =   840
            MouseIcon       =   "FinancialStatementsHCA.frx":1B5A
            MousePointer    =   99  'Custom
            TabIndex        =   7
            Top             =   16800
            Width           =   3375
         ...
         Begin VB.Image Image22 
            Height          =   720
            Left            =   5580
            MouseIcon       =   "FinancialStatementsHCA.frx":1E64
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":1FB6
            Top             =   8850
            Width           =   585
         End
         Begin VB.Image Image21 
            Height          =   660
            Left            =   3120
            MouseIcon       =   "FinancialStatementsHCA.frx":3678
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":37CA
            Top             =   8820
            Width           =   1095
         End
         Begin VB.Image Image20 
            Height          =   615
            Left            =   390
            MouseIcon       =   "FinancialStatementsHCA.frx":5DDC
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":5F2E
            Top             =   8880
            Width           =   1755
         End
         Begin VB.Image Image19 
            Height          =   720
            Left            =   5520
            MouseIcon       =   "FinancialStatementsHCA.frx":97D0
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":9922
            Top             =   4800
            Width           =   585
         End
         Begin VB.Image Image18 
            Height          =   660
            Left            =   3120
            MouseIcon       =   "FinancialStatementsHCA.frx":AFE4
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":B136
            Top             =   4860
            Width           =   1095
         End
         Begin VB.Image Image17 
            Height          =   615
            Left            =   420
            MouseIcon       =   "FinancialStatementsHCA.frx":D748
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":D89A
            Top             =   4950
            Width           =   1755
         End
         Begin VB.Label labIncomeStatements 
            ...
            Height          =   255
            Left            =   4620
            MouseIcon       =   "FinancialStatementsHCA.frx":1113C
            MousePointer    =   99  'Custom
            TabIndex        =   22
            Top             =   1560
            Width           =   3135
         ...
         Begin VB.Label labBalanceSheets 
            ...
            Height          =   435
            Left            =   1800
            MouseIcon       =   "FinancialStatementsHCA.frx":11446
            MousePointer    =   99  'Custom
            TabIndex        =   21
            Top             =   1560
            Width           =   3135
         ...
         Begin VB.Image Image16 
            Height          =   1380
            Left            =   4260
            MouseIcon       =   "FinancialStatementsHCA.frx":11750
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":118A2
         ...
         Begin VB.Image Image15 
            Height          =   2415
            Left            =   5910
            MouseIcon       =   "FinancialStatementsHCA.frx":12337
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":12489
         ...
         Begin VB.Image Image13 
            Height          =   2415
            Left            =   3735
            MouseIcon       =   "FinancialStatementsHCA.frx":14866
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":149B8
         ...
         Begin VB.Image Image8 
            Height          =   1305
            Left            =   5490
            MouseIcon       =   "FinancialStatementsHCA.frx":16642
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":16794
         ...
         Begin VB.Image Image7 
            Height          =   1305
            Left            =   2670
            MouseIcon       =   "FinancialStatementsHCA.frx":1735A
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":174AC
         ...
         Begin VB.Image Image5 
            Height          =   2415
            Left            =   5910
            MouseIcon       =   "FinancialStatementsHCA.frx":18072
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":181C4
         ...
         Begin VB.Image Image1 
            Height          =   1230
            Left            =   2490
            MouseIcon       =   "FinancialStatementsHCA.frx":19E7C
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":19FCE
         ...
         Begin VB.Label labScheduleOfAccounts 
            ...
            Height          =   495
            Left            =   2640
            MouseIcon       =   "FinancialStatementsHCA.frx":1AB7F
            MousePointer    =   99  'Custom
            TabIndex        =   20
            Top             =   18750
            Width           =   4155
         ...
         Begin VB.Label labScheduleOfSellingExpensesServiceSection 
            ...
            Height          =   585
            Left            =   5010
            MouseIcon       =   "FinancialStatementsHCA.frx":1AE89
            MousePointer    =   99  'Custom
            TabIndex        =   19
            Top             =   8190
            Width           =   1815
         ...
         Begin VB.Label labScheduleOfSellingExpensesPartsSection 
            ...
            Height          =   585
            Left            =   2850
            MouseIcon       =   "FinancialStatementsHCA.frx":1B193
            MousePointer    =   99  'Custom
            TabIndex        =   18
            Top             =   8220
            Width           =   1815
         ...
         Begin VB.Label labScheduleOfSellingExpensesSalesSection 
            ...
            Height          =   585
            Left            =   360
            MouseIcon       =   "FinancialStatementsHCA.frx":1B49D
            MousePointer    =   99  'Custom
            TabIndex        =   17
            Top             =   8220
            Width           =   1665
         ...
         Begin VB.Label labScheduleOfSellingExpenseCumulative 
            ...
            Height          =   675
            Left            =   1650
            MouseIcon       =   "FinancialStatementsHCA.frx":1B7A7
            MousePointer    =   99  'Custom
            TabIndex        =   16
            Top             =   7260
            Width           =   3465
         ...
         Begin VB.Label labIncomeStatementServiceCumulative 
            ...
            Height          =   585
            Left            =   5190
            MouseIcon       =   "FinancialStatementsHCA.frx":1BAB1
            MousePointer    =   99  'Custom
            TabIndex        =   15
            Top             =   4290
            Width           =   1515
         ...
         Begin VB.Label labIncomeStatementPartsCumulative 
            ...
            Height          =   435
            Left            =   2970
            MouseIcon       =   "FinancialStatementsHCA.frx":1BDBB
            MousePointer    =   99  'Custom
            TabIndex        =   14
            Top             =   4320
            Width           =   1515
         ...
         Begin VB.Label labIncomeStatementVehiclesCumulative 
            ...
            Height          =   555
            Left            =   570
            MouseIcon       =   "FinancialStatementsHCA.frx":1C0C5
            MousePointer    =   99  'Custom
            TabIndex        =   13
            Top             =   4320
            Width           =   1515
         ...
         Begin VB.Image Image4 
            Height          =   2415
            Left            =   1380
            MouseIcon       =   "FinancialStatementsHCA.frx":1C3CF
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":1C521
         ...
         Begin VB.Image Image14 
            Height          =   2415
            Left            =   1380
            MouseIcon       =   "FinancialStatementsHCA.frx":1E16B
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":1E2BD
         ...
         Begin VB.Label labScheduleOfSellingExpenseCurrent 
            ...
            Height          =   645
            Left            =   4650
            MouseIcon       =   "FinancialStatementsHCA.frx":2069A
            MousePointer    =   99  'Custom
            TabIndex        =   12
            Top             =   7260
            Width           =   3285
         ...
         Begin VB.Image Image24 
            Height          =   1770
            Left            =   1410
            MouseIcon       =   "FinancialStatementsHCA.frx":209A4
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":20AF6
            Stretch         =   -1  'True
            ToolTipText     =   "View Balance Sheets"
            Top             =   2040
            Width           =   2160
         ...
         Begin VB.Image Image23 
            Height          =   1800
            Left            =   6000
            MouseIcon       =   "FinancialStatementsHCA.frx":39C36
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":39D88
         ...
         Begin VB.Image Image2 
            Height          =   1230
            Left            =   5670
            MouseIcon       =   "FinancialStatementsHCA.frx":3BB90
            MousePointer    =   99  'Custom
            Picture         =   "FinancialStatementsHCA.frx":3BCE2
            ToolTipText     =   "View Income Statements"
            Top             =   210
            Width           =   990
         End
   ...
   End
End
Attribute VB_Name = "frmAMISFinancialStatementsHCA"
...
Dim VEHICLES_FAIRVIEW_SECTION                               As String
...
Attribute OE_Prev_CapitalStock.VB_VarUserMemId = 1073938472
...
Private Sub Form_Load()
    ...
    ElseIf COMPANY_CODE = "HCC" Or COMPANY_CODE = "DGI" Then
        VEHICLES_SECTION = "10"
        PARTS_SECTION = "20"
        SERVICE_SECTION = "30"
        ADMIN_SECTION = "40"
    ...
    ElseIf COMPANY_CODE = "HCA" Then
        VEHICLES_SECTION = "10"
        VEHICLES_FAIRVIEW_SECTION = "20"
        PARTS_SECTION = "30"
        SERVICE_SECTION = "40"
        BRP_SECTION = "50"
        ADMIN_SECTION = "51"
        HR_SECTION = "52"
        ACCOUNTING_SECTION = "53"
        CNC_SECTION = "54"
        CRD_SECTION = "55"
...
'FOR HAI
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        V_GrossSales = Cummulative_Cash_GrossSales + Cummulative_Charge_GrossSales
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51')")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            Cummulative_Cash_SalesDiscountsAndReturns = N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        ...
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                             ...
                                             " AND (AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode IN ('10','20','30','40',50))")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            Cummulative_LessSellingExpense = N2Str2Zero(rsJournal_Det!LessSellingExpense)
        End If
        V_LessSellingExpense = Cummulative_LessSellingExpense
...
Private Sub labIncomeStatementBRPCumulative_Click()
    If CheckDate = False Then Exit Sub
    Dim Prev_dtpFrom, Prev_dtpTo, PRODUCT                   As String
    If dtpFrom > dtpTo Then
        MsgSpeechBox "Error In From and To date"
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        If Not (rsProfile.EOF And rsProfile.BOF) Then
            rptAMISIncomeStatement.Formulas(30) = "CompanyName = '" & Null2String(rsProfile!CompanyName) & "'"
            rptAMISIncomeStatement.Formulas(31) = "CompanyAddress = '" & Null2String(rsProfile!Companyaddress) & "'"
            rptAMISIncomeStatement.ReportTitle = "INCOME STATEMENT - BRP"
            rptAMISIncomeStatement.WindowTitle = "INCOME STATEMENT - BRP"
        End If
        PRODUCT = "'" & BRP_SECTION & "'"
        Set rsJournal_Det = New ADODB.Recordset
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers IN ('50','51') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        Set rsJournal_Det = New ADODB.Recordset
        If COMPANY_CODE = "HCA" Then
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_ChartAccount.Headers IN ('50','51') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        Else
        ...
        '=========================================
        rptAMISIncomeStatement.Formulas(30) = "ToJDate = '" & Format(dtpTo, "Short Date") & "'"
        PrintSQLReport rptAMISIncomeStatement, AMIS_REPORT_PATH & "FinancialStatement\FinancialStatements\IncomeStatementBRPCumulative.rpt", "{Journal_HD.jdate} >= date(" & Year(dtpFrom) & "," & Month(dtpFrom) & "," & Day(dtpFrom) & ") AND {Journal_HD.jdate} <= date(" & Year(dtpTo) & "," & Month(dtpTo) & "," & Day(dtpTo) & ")", DMIS_REPORT_Connection, 1
    Else
        ShowNoRecord
    End If
...
'JULIE
        PRODUCT = "'" & VEHICLES_FAIRVIEW_SECTION & "'"
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Cash_GrossSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='41' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(30) = "Present_Cash_GrossSales = " & N2Str2Zero(rsJournal_Det!Cash_GrossSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Charge_GrossSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='42' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(31) = "Present_Charge_GrossSales = " & N2Str2Zero(rsJournal_Det!Charge_GrossSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(32) = "Present_Cash_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='52' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(33) = "Present_Charge_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='61' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(34) = "Present_Cash_CostOfSales = " & N2Str2Zero(rsJournal_Det!CostOfSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='62' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(35) = "Present_Charge_CostOfSales = " & N2Str2Zero(rsJournal_Det!CostOfSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(36) = "Present_LessSellingExpense = " & N2Str2Zero(rsJournal_Det!LessSellingExpense)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(37) = "Present_LessAdminExpense = " & N2Str2Zero(rsJournal_Det!LessAdminExpense) * 0.5
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessOtherExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='91' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(38) = "Present_LessOtherExpense = " & N2Str2Zero(rsJournal_Det!LessOtherExpense)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='81') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(39) = "Present_AddOtherIncome = " & N2Str2Zero(rsJournal_Det!AddOtherIncome)
        End If
        ...
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Cash_GrossSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='41' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(30) = "Past_Cash_GrossSales = " & N2Str2Zero(rsJournal_Det!Cash_GrossSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Charge_GrossSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='42' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(41) = "Past_Charge_GrossSales = " & N2Str2Zero(rsJournal_Det!Charge_GrossSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(42) = "Past_Cash_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='52' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(43) = "Past_Charge_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='61' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(44) = "Past_Cash_CostOfSales = " & N2Str2Zero(rsJournal_Det!CostOfSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='62' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(45) = "Past_Charge_CostOfSales = " & N2Str2Zero(rsJournal_Det!CostOfSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT & ")")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(46) = "Past_LessSellingExpense = " & N2Str2Zero(rsJournal_Det!LessSellingExpense)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='72') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(47) = "Past_LessAdminExpense = " & N2Str2Zero(rsJournal_Det!LessAdminExpense) * 0.5
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessOtherExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='91' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(48) = "Past_LessOtherExpense = " & N2Str2Zero(rsJournal_Det!LessOtherExpense)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as AddOtherIncome from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='81') AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(49) = "Past_AddOtherIncome = " & N2Str2Zero(rsJournal_Det!AddOtherIncome)
        End If
        
        rptAMISIncomeStatement.Formulas(50) = "ToJDate = #" & Format(dtpTo, "Short Date") & "#"
...
'PAST
        ...
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Cash_GrossSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='41' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            rptAMISIncomeStatement.Formulas(40) = "Past_Cash_GrossSales = " & N2Str2Zero(rsJournal_Det!Cash_GrossSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Charge_GrossSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers='42' AND AMIS_ChartAccount.DepartmentCode = " & PRODUCT)
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labIncomeStatements_Click()
    ...
    Else
        ...
        If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
            ...
            End If
            Set rsJournal_Det = New ADODB.Recordset
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51')")
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
                rptAMISIncomeStatement.Formulas(2) = "Cummulative_Cash_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
            End If
            Set rsJournal_Det = New ADODB.Recordset
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers='61'")
            Else
            ...
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                                     " where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode IN ('10','20','30','40','50')")
            Else
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND Year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode IN ('51','52','53','54','55')")
            Else
            ...
            End If
            Set rsJournal_Det = New ADODB.Recordset
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers IN ('50','51')")
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
                rptAMISIncomeStatement.Formulas(12) = "Current_Cash_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
            End If
            Set rsJournal_Det = New ADODB.Recordset
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers='61'")
            Else
            ...
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                                     ...
                                                     " AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.DepartmentCode IN ('10','20','30','40','50')")
            Else
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                                     " where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "')" & _
                                                     " AND ((AMIS_ChartAccount.Headers ='71' OR AMIS_ChartAccount.Headers='72') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.DepartmentCode <> '" & ADMIN_SECTION & "')")
            ...
            End If
            Set rsJournal_Det = New ADODB.Recordset
            Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers IN ('50','51')")
            If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
                rptAMISIncomeStatement.Formulas(22) = "Previous_Cash_SalesDiscountsAndReturns = " & N2Str2Zero(rsJournal_Det!SalesDiscountsAndReturns)
            End If
            Set rsJournal_Det = New ADODB.Recordset
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers='61'")
            Else
            ...
            Set rsJournal_Det = New ADODB.Recordset
            If COMPANY_CODE = "HCA" Then
                Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessAdminExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "') AND AMIS_Journal_Det.Jtype <> 'CLO' AND AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode IN ('51','52','53','54','55')")
            Else
...
Private Sub labOwnersEquity_Click()
    ...
    If Not rsJournal_HD.EOF And Not rsJournal_HD.EOF Then
        ...
        V_SalesDiscountsAndReturns = Cummulative_Cash_SalesDiscountsAndReturns + Cummulative_Charge_SalesDiscountsAndReturns
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as CostOfSales from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.Headers=" & CASH_COSTOFSALES & " ")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            Cummulative_Cash_CostOfSales = N2Str2Zero(rsJournal_Det!CostOfSales)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        ...
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as LessSellingExpense from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode" & _
                                             " where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate <= '" & dtpTo & "')" & _
                                             " AND (AMIS_ChartAccount.Headers IN ('70','71') AND AMIS_ChartAccount.DepartmentCode IN ('50','10','20','30','40'))")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            Cummulative_LessSellingExpense = N2Str2Zero(rsJournal_Det!LessSellingExpense)
        End If
        V_LessSellingExpense = Cummulative_LessSellingExpense
        ...
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Value_Current from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate < '" & dtpFrom & "') AND AMIS_ChartAccount.titles='3100'")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
            OE_Prev_CapitalStock = N2Str2Zero(rsJournal_Det!Value_Current)
        End If
        Set rsJournal_Det = New ADODB.Recordset
        Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Credit) - SUM(AMIS_Journal_Det.Debit) as Value_Current from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND (AMIS_Journal_Det.jdate <= '" & dtpTo & "') AND AMIS_ChartAccount.titles='3100'")
        If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labScheduleOAdministrativeExpensesCumulative_Click()
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='50' OR AMIS_ChartAccount.Headers='51')")
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND (AMIS_ChartAccount.Headers='50' OR AMIS_ChartAccount.Headers='51')")
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate >= '" & Prev_dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & Prev_dtpTo & "' AND (AMIS_ChartAccount.Headers='50' OR AMIS_ChartAccount.Headers='51')")
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labScheduleOfAdminAndSellingExpensesCumulative_Click()
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51','52') AND AMIS_ChartAccount.DepartmentCode = " & SALES_PRODUCT)
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND year(AMIS_Journal_Det.jdate) = " & Year(dtpTo) & " and AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51','52')")
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labScheduleOfAdminAndSellingExpensesCurrent_Click()
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51','52') AND AMIS_ChartAccount.DepartmentCode = " & SALES_PRODUCT)
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
    ...
    End If
    Set rsJournal_Det = New ADODB.Recordset
    Set rsJournal_Det = gconDMIS.Execute("select SUM(AMIS_Journal_Det.Debit) - SUM(AMIS_Journal_Det.Credit) as SalesDiscountsAndReturns from AMIS_Journal_Det inner Join AMIS_ChartAccount on AMIS_Journal_Det.Acct_Code = AMIS_ChartAccount.AcctCode where AMIS_Journal_Det.Status = 'P' AND AMIS_Journal_Det.jdate >= '" & dtpFrom & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_Journal_Det.jdate <= '" & dtpTo & "' AND AMIS_ChartAccount.Headers IN ('50','51','52')")
    If Not rsJournal_Det.EOF And Not rsJournal_Det.EOF Then
...
Private Sub labScheduleOfSellingExpensesBrpSection_Click()
    On Error GoTo ErrorCode:
    ...
    If Not (rsProfile.EOF And rsProfile.BOF) Then
        rptAMISIncomeStatement.Formulas(2) = "CompanyName = '" & Null2String(rsProfile!CompanyName) & "'"
        rptAMISIncomeStatement.Formulas(3) = "CompanyAddress = '" & Null2String(rsProfile!Companyaddress) & "'"
        rptAMISIncomeStatement.ReportTitle = "SCHEDULE OF SELLING EXPENSES - BRP SECTION"
        rptAMISIncomeStatement.WindowTitle = "SCHEDULE OF SELLING EXPENSES - BRP SECTION"
    End If
    rptAMISIncomeStatement.Formulas(0) = "CUMULATIVE_NETSALES = " & NumericVal(vCUMULATIVE_NETSALES)
    rptAMISIncomeStatement.Formulas(1) = "CURRENT_NETSALES = " & NumericVal(vCURRENT_NETSALES)
    ReportFolder = "FinancialStatement\FinancialStatements\"
    rptAMISIncomeStatement.Formulas(30) = "ToJDate = #" & Format(dtpTo, "Short Date") & "#"
    PrintSQLReport rptAMISIncomeStatement, AMIS_REPORT_PATH & ReportFolder & "ScheduleOfSellingExpenseBRPSection.rpt", "{ChartAccount.DepartmentCode} = '" & BRP_SECTION & "' AND year({Journal_Det.jdate}) = " & Year(dtpTo) & " and {Journal_Det.jdate} <= date(" & Year(dtpTo) & "," & Month(dtpTo) & "," & Day(dtpTo) & ")", DMIS_REPORT_Connection, 1
    Call NEW_LogAudit("G", "FinancialStatement", "Schedule Of Selling Expense Service Section", "", "", "Schedule Of Selling Expense BRP Section" & "-" & dtpTo, "", "")
    Exit Sub
ErrorCode:
    ShowVBError
End Sub
