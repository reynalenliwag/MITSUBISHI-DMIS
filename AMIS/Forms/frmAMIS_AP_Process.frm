...
Begin VB.Form frmAMIS_AP_Process 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image2 
         Height          =   720
         Left            =   120
         Picture         =   "frmAMIS_AP_Process.frx":0CAB
         Top             =   30
         Width           =   720
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   825
         Left            =   2520
         MouseIcon       =   "frmAMIS_AP_Process.frx":15A1
         MousePointer    =   99  'Custom
         Picture         =   "frmAMIS_AP_Process.frx":16F3
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   825
         Left            =   1650
         MouseIcon       =   "frmAMIS_AP_Process.frx":1B3E
         MousePointer    =   99  'Custom
         Picture         =   "frmAMIS_AP_Process.frx":1C90
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.Image Image1 
         Height          =   720
         Left            =   120
         Picture         =   "frmAMIS_AP_Process.frx":212F
         Top             =   30
         Width           =   720
      End
   ...
   Begin VB.PictureBox picByAccount 
      ...
      Begin RichTextLib.RichTextBox txtCOBAcctNo 
         ...
         MultiLine       =   0   'False
         ReadOnly        =   -1  'True
         TextRTF         =   $"frmAMIS_AP_Process.frx":2A25
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   9
            Charset         =   0
...
Private Sub cmdPrint_Click()
    ...
    If (cboCOBAcctName.Text = "" And optAccount.Value = True And COMPANY_CODE = "HCA") Or (cboCOBAcctName.Text = "" And optAccount.Value = True And COMPANY_CODE = "HMH") Or (cboCOBAcctName.Text = "" And optAccount.Value = True And COMPANY_CODE = "DGI") Or (cboCOBAcctName.Text = "" And optAccount.Value = True And COMPANY_CODE = "HQA") Then
...
'JULIEBETH 04172013
                        If COMPANY_CODE = "CMC" Or COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HGS" Then
                            If optDetailed = True Then
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_ScheduleReport.Rpt", 1)
                            Else
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_ScheduleReportSummary.Rpt", 1)
                            End If
                        End If
                        ...
                        rptRep.ParameterFields.GetItemByName("CompanyAddress").AddCurrentValue COMPANY_ADDRESS
                            If COMPANY_CODE = "HMH" Or COMPANY_CODE = "HLB" Then
                                rptRep.ParameterFields.GetItemByName("TIN").AddCurrentValue COMPANY_TIN
                            Else
                            End If
                        ...
                        Call rptRep.ParameterFields(5).AddCurrentValue(CDate(dtpAsOF))
                        Else
...
'JULIEBETH 04172013
                    If optDetailed.Value = True Then
                        If COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HGS" Then
                    ...
                    ElseIf optSummary = True Then
                        If COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HGS" Then
                            If cboCOBAcctName.Text = "ALL" Then
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_ScheduleReportSummaryAccount.Rpt", 1)
                            Else
                                Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_ScheduleSummaryAccount.Rpt", 1)
                            End If
                        Else
                            Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_ScheduleReportAccount.Rpt", 1)
                        End If
                    ...
                    rptRep.ParameterFields.GetItemByName("CompanyAddress").AddCurrentValue COMPANY_ADDRESS
                        ...
                        If cboCOBAcctName.Text <> "ALL" Then
                            ...
                            Else
                            rptRep.ParameterFields.GetItemByName("@ACCTCODE").AddCurrentValue txtCOBAcctNo.Text
                            End If
                        Else
                        End If
                    rptRep.ParameterFields.GetItemByName("ReportTitle").AddCurrentValue "ACCOUNTS PAYABLE SCHEDULE REPORT AS OF: " & dtpAsOF
                    ...
                    '                Next
                    '---------------------------------------------------------------
                    If COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Then
                        If cboCOBAcctName.Text = "ALL" Then
                            If COMPANY_CODE = "HMH" Then
                                Call rptRep.ParameterFields(5).AddCurrentValue(CDate(dtpAsOF))
                            Else
            ...
            If optVendor.Value = True Then
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_AgingReportVendorByVendor.Rpt", 1)
                        End If
                        rptRep.DiscardSavedData
                        rptRep.ParameterFields.GetItemByName("CompanyName").AddCurrentValue COMPANY_NAME
                        rptRep.ParameterFields.GetItemByName("CompanyAddress").AddCurrentValue COMPANY_ADDRESS
            ...
            ElseIf optAccount.Value = True Then
                ...
                Else
                    ...
                    Else
                        ...
                        If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Or COMPANY_CODE = "HGS" Then
                            If cboCOBAcctName.Text = "ALL" Then
                                If optDetailed = True Then
                                    Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_AgingReport.Rpt", 1)
                                Else
                                    Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_AgingReportByVendor.Rpt", 1)
                                End If
                            Else
                                If optDetailed = True Then
                                    Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_AgingReportAccount.Rpt", 1)
                                Else
                                    Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_AgingReportAccountByVendor.Rpt", 1)
                                End If
                            End If
                        Else
                            Set rptRep = rptApp.OpenReport(AMIS_REPORT_PATH & "DueReports\AP_AgingReport.Rpt", 1)
                        ...
                        '                    Next
                        '----------------------------------------------------------------------
                        If COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "HNE" Then
                            If cboCOBAcctName.Text = "ALL" Then
                                    If COMPANY_CODE = "HMH" Then
                                        Call rptRep.ParameterFields(5).AddCurrentValue(CDate(dtpAsOF))
                                    Else
                            ...
                            Else
                                    ...
                                    Else
                                        Call rptRep.ParameterFields(4).AddCurrentValue(CDate(dtpAsOF))
                                        If COMPANY_CODE = "DGI" Then
                                            ''DUE TO CODE ALREADY EXIST BY NORMAN
                                        Else
                                            Call rptRep.ParameterFields(5).AddCurrentValue(txtCOBAcctNo.Text)
                                        End If
                                    End If
...
Function COMP_AP_AMT_PAID2(xAP_VOUCHERnO As String, xJType As String, xVEN_CODE As String, xACCT_CODE) As Double
    ...
    rsNO_AP8.Open "SELECT X.AP_VOUCHERNO,X.DET_ACCT_CODE,X.HD_VOUCHERNO,X.HD_JTYPE,X.HD_JDATE,X.HD_STATUS,X.HD_INV_DATE,X.HD_VEN_CODE,X.HD_INV_TYPE,X.HD_INV_AMT,X.HD_AMT_TO_PAY,X.DET_DEBIT,X.DET_CREDIT,X.HD_DUEDATE FROM (SELECT CV.PV_VOUCHERNO AS AP_VOUCHERNO,HD.VoucherNo AS HD_VOUCHERNO,HD.JType AS HD_JTYPE,HD.jdate AS HD_JDATE,HD.status AS HD_STATUS,HD.invoicetype AS HD_INV_TYPE,HD.invoicedate AS HD_INV_DATE, HD.VendorCode AS HD_VEN_CODE, HD.invoiceamt AS HD_INV_AMT,HD.amounttopay AS HD_AMT_TO_PAY,HD.amountpaid AS HD_AMT_PAID,DET.Debit AS DET_DEBIT,DET.CREDIT AS DET_CREDIT, HD.DUEDATE AS HD_DUEDATE,DET.Acct_Code AS DET_ACCT_CODE " & _
                  "FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET  ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE INNER JOIN AMIS_CV_DETAIL CV ON HD.VOUCHERNO=CV.VOUCHERNO AND HD.JTYPE=CV.CV_JTYPE WHERE HD.VOUCHERNO IN (SELECT VOUCHERNO FROM AMIS_CV_DETAIL ) AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-06','21-02','21-07') AND DET.ACCT_CODE='" & xACCT_CODE & "' AND HD.status = 'P' AND HD.VOUCHERNO = '" & xAP_VOUCHERnO & "' AND  HD.VENDORCODE = '" & Trim(xVEN_CODE) & "' AND HD.jdate < = '" & dtpAsOF & "')X " & _
...
'DESCRIPTION: COMPUTE THE ADJUSTMENT AS ADDITIONAL AMOUNT TO PAY TO ACCOUNTS PAYABLES
    ...
    If xJType = "'CDJ'" Then
        rsCOM_AP_ADJ_CREDIT.Open "SELECT ROUND(SUM(CREDIT),2) AS CREDIT FROM AMIS_JOURNAL_DET WHERE LEFT(ACCT_CODE,5) IN ('21-01','21-02','21-06','21-07') AND INVOICENO = " & xInvoiceNo & " AND RIGHT(ENTITY,6) = " & xEntity & " AND ADJ_JTYPE = " & xJType & "", gconDMIS, adOpenKeyset
    Else
        rsCOM_AP_ADJ_CREDIT.Open "SELECT ROUND(SUM(CREDIT),2) AS CREDIT FROM AMIS_JOURNAL_DET WHERE LEFT(ACCT_CODE,5) IN ('21-01','21-02','21-06','21-07') AND INVOICENO = " & xInvoiceNo & " AND INVOICETYPE = " & xInvoiceType & " AND RIGHT(ENTITY,6) = " & xEntity & "", gconDMIS, adOpenKeyset
    End If
...
'DESCRIPTION: COMPUTE THE AJUSTMENT AS ADDITIONAL PAYMENT TO THE ACCOUNT PAYABLE
    ...
    If xJType = "CDJ" Then
        rsCOMP_AP_ADJ_DEBIT.Open "SELECT ROUND(SUM(DEBIT),2) AS DEBIT FROM AMIS_JOURNAL_DET WHERE LEFT(ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') AND INVOICENO = " & xInvoiceNo & " AND RIGHT(ENTITY,6) = " & xEntity & " AND ADJ_JTYPE = '" & xJType & "'", gconDMIS, adOpenKeyset
    Else
        rsCOMP_AP_ADJ_DEBIT.Open "SELECT ROUND(SUM(DEBIT),2) AS DEBIT FROM AMIS_JOURNAL_DET WHERE LEFT(ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') AND INVOICENO = " & xInvoiceNo & " AND INVOICETYPE = " & xInvoiceType & " AND RIGHT(ENTITY,6) = " & xEntity & "", gconDMIS, adOpenKeyset
    End If
...
'             AND DETAIL DATE GREATER THE JDATE
    ...
    rsDISBURSEMENT1.Open "SELECT HD.VOUCHERNO AS HD_VOUCHERNO,HD.JTYPE AS HD_JTYPE,HD.JDATE AS HD_JDATE,HD.STATUS AS HD_STATUS,HD.INVOICETYPE AS HD_INV_TYPE,HD.INVOICEDATE AS HD_INV_DATE, HD.VENDORCODE AS HD_VEN_CODE, HD.INVOICEAMT AS HD_INV_AMT,HD.AMOUNTTOPAY AS HD_AMT_TO_PAY,HD.AMOUNTPAID AS HD_AMT_PAID,DET.DEBIT AS DET_DEBIT,DET.CREDIT AS DET_CREDIT, HD.DUEDATE AS HD_DUEDATE,DET.ACCT_CODE AS DET_ACCT_CODE FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET ON HD.VOUCHERNO=DET.VOUCHERNO AND HD.JTYPE=DET.JTYPE " & _
                         "WHERE (HD.JTYPE = 'CDJ' OR HD.JTYPE = 'GJ') AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') " & _
...
'DESCRIPTION: THIS SELECT ALL DIRECT DISBURSEMENT WHICH IS NO LINK TO THE ACCOUNTS PAYABLES
    ...
    rsDISBURSEMENT2.Open "SELECT X.AP_VOUCHERNO,X.DET_ACCT_CODE,X.HD_VOUCHERNO,X.HD_JTYPE,X.HD_JDATE,X.HD_STATUS,X.HD_INV_DATE,X.HD_VEN_CODE,X.HD_INV_TYPE,X.HD_INV_AMT,X.HD_AMT_TO_PAY,X.DET_DEBIT,X.DET_CREDIT,X.HD_DUEDATE FROM (" & _
                         "SELECT CV.PV_VOUCHERNO AS AP_VOUCHERNO,HD.VoucherNo AS HD_VOUCHERNO,HD.JType AS HD_JTYPE,HD.jdate AS HD_JDATE,HD.status AS HD_STATUS,HD.invoicetype AS HD_INV_TYPE,HD.invoicedate AS HD_INV_DATE, HD.VendorCode AS HD_VEN_CODE, HD.invoiceamt AS HD_INV_AMT,HD.amounttopay AS HD_AMT_TO_PAY,HD.amountpaid AS HD_AMT_PAID,DET.Debit AS DET_DEBIT,DET.CREDIT AS DET_CREDIT, HD.DUEDATE AS HD_DUEDATE,DET.Acct_Code AS DET_ACCT_CODE   FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET  ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE INNER JOIN AMIS_CV_DETAIL CV ON HD.VOUCHERNO=CV.VOUCHERNO AND HD.JTYPE=CV.CV_JTYPE WHERE HD.VOUCHERNO IN (SELECT VOUCHERNO FROM AMIS_CV_DETAIL ) AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-06','21-02','21-07') AND HD.status = 'P' AND HD.jdate < = '" & dtpAsOF & "'" & _
                         ")X WHERE X.AP_VOUCHERNO IN (SELECT VOUCHERNO FROM AMIS_JOURNAL_DET WHERE JTYPE ='APJ' AND ACCT_CODE='11-02000-00' AND DEBIT=0)", gconDMIS, adOpenKeyset
...
Sub DISBURSEMENT3()
    ...
    rsDISBURSEMENT3.Open "SELECT HD.VoucherNo AS HD_VOUCHERNO,HD.JType AS HD_JTYPE,HD.jdate AS HD_JDATE,HD.status AS HD_STATUS,HD.invoicetype AS HD_INV_TYPE,HD.invoicedate AS HD_INV_DATE, " & _
                         "HD.VendorCode AS HD_VEN_CODE, HD.invoiceamt AS HD_INV_AMT,HD.amounttopay AS HD_AMT_TO_PAY,HD.amountpaid AS HD_AMT_PAID,DET.Debit AS DET_DEBIT,DET.CREDIT AS DET_CREDIT, " & _
                         "HD.DUEDATE AS HD_DUEDATE,DET.Acct_Code AS DET_ACCT_CODE   FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET  ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE " & _
                         "WHERE HD.JTYPE = 'SJ' AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') AND HD.status = 'P' and HD.jdate < = '" & dtpAsOF & "'", gconDMIS, adOpenKeyset
...
'DESCRIPTION: THIS SELECT ALL DIRECT DISBURSEMENT WHICH IS NO LINK TO THE ACCOUNTS PAYABLES
    ...
    rsDISBURSEMENT5.Open "SELECT X.AP_VOUCHERNO,X.DET_ACCT_CODE,X.HD_VOUCHERNO,X.HD_JTYPE,X.HD_JDATE,X.HD_STATUS,X.HD_INV_DATE,X.HD_VEN_CODE,X.HD_INV_TYPE,X.HD_INV_AMT,X.HD_AMT_TO_PAY,X.DET_DEBIT,X.DET_CREDIT,X.HD_DUEDATE FROM (SELECT CV.PV_VOUCHERNO AS AP_VOUCHERNO,HD.VoucherNo AS HD_VOUCHERNO,HD.JType AS HD_JTYPE,HD.jdate AS HD_JDATE,HD.status AS HD_STATUS,HD.invoicetype AS HD_INV_TYPE,HD.invoicedate AS HD_INV_DATE, HD.VendorCode AS HD_VEN_CODE, HD.invoiceamt AS HD_INV_AMT,HD.amounttopay AS HD_AMT_TO_PAY,HD.amountpaid AS HD_AMT_PAID,DET.Debit AS DET_DEBIT,DET.CREDIT AS DET_CREDIT, HD.DUEDATE AS HD_DUEDATE,DET.Acct_Code AS DET_ACCT_CODE " & _
                         "FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET  ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE INNER JOIN AMIS_CV_DETAIL CV ON HD.VOUCHERNO=CV.VOUCHERNO AND HD.JTYPE=CV.CV_JTYPE WHERE HD.VOUCHERNO IN (SELECT VOUCHERNO FROM AMIS_CV_DETAIL ) AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') AND HD.status = 'P' AND HD.jdate < = '" & dtpAsOF & "')X " & _
                         "WHERE X.AP_VOUCHERNO IN (SELECT VOUCHERNO FROM AMIS_JOURNAL_DET WHERE JTYPE ='APJ' AND X.DET_DEBIT=DEBIT AND ACCT_CODE='21-01002-00' AND X.DET_DEBIT <> 0) ORDER BY AP_VOUCHERNO", gconDMIS, adOpenKeyset
...
'DESCRIPTION: THIS SELECT ALL DIRECT DISBURSEMENT WHICH IS NO LINK TO THE ACCOUNTS PAYABLES / NO DETAIL
    ...
    rsDIRECT_DSBRSMENT.Open "SELECT HD.VoucherNo AS HD_VOUCHERNO,HD.JType AS HD_JTYPE,HD.jdate AS HD_JDATE,HD.status AS HD_STATUS,HD.invoicetype AS HD_INV_TYPE,HD.invoicedate AS HD_INV_DATE, " & _
                            "HD.VendorCode AS HD_VEN_CODE, HD.invoiceamt AS HD_INV_AMT,HD.amounttopay AS HD_AMT_TO_PAY,HD.amountpaid AS HD_AMT_PAID,DET.Debit AS DET_DEBIT,DET.CREDIT AS DET_CREDIT, " & _
                            "HD.DUEDATE AS HD_DUEDATE,DET.Acct_Code AS DET_ACCT_CODE   FROM AMIS_JOURNAL_HD HD INNER JOIN AMIS_JOURNAL_DET DET  ON HD.VOUCHERNO = DET.VOUCHERNO AND HD.JTYPE = DET.JTYPE " & _
                            "WHERE (HD.JTYPE = 'CDJ') AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-06','21-02','21-07') AND HD.VOUCHERNO NOT IN (SELECT VOUCHERNO FROM AMIS_CV_DETAIL) AND HD.status = 'P' and HD.jdate < = '" & dtpAsOF & "'", gconDMIS, adOpenKeyset
...
'DESCRIPTION: GET THE DEBIT AMOUNT OF THE DIRECT DISBURSEMENT AS AN ADVANCE PAYMENT
    ...
    rsGET_DRCT_AMOUNT.Open "SELECT ROUND(SUM(DEBIT),2) AS DEBIT FROM AMIS_JOURNAL_DET WHERE VOUCHERNO = " & xVOUCHERNO & " AND JTYPE = " & xJType & " AND STATUS = 'P' AND LEFT(ACCT_CODE,5) IN('21-01','21-02','21-07','21-06') ", gconDMIS, adOpenKeyset
...
'DESCRIPTION: GET THE ADJUSTMENT AS AMOUNT TO PAY TO THE DIRECT DISBURSEMENT
    ...
    rsGET_ADJ_DRCT_AMT2PAY.Open "SELECT  ROUND(SUM(DET.CREDIT),2) AS DET_CREDIT " & _
                                ...
                                "WHERE DET.ADJ_JTYPE  = 'CDJ' AND LEFT(DET.ACCT_CODE,5) IN ('21-01','21-02','21-07','21-06') AND DET.VOUCHERNO = " & xVOUCHERNO & " AND RIGHT(ENTITY,6) = " & xCUSCDE & " AND DET.STATUS = 'P' AND DET.JTYPE = 'GJ'", gconDMIS, adOpenKeyset
...
'DESCRIPTION: THIS GET ALL THE ACCOUNTS PAYABLES
    ...
    rsTRANS.Open "SELECT  HD.VoucherNo AS HD_VOUCHERNO,HD.JType AS HD_JTYPE,HD.jdate AS HD_JDATE,HD.status AS HD_STATUS,HD.InvoiceNo as HD_INV_NO,HD.invoicetype AS HD_INV_TYPE,HD.invoicedate AS HD_INV_DATE,HD.VendorCode AS HD_VEN_CODE, " & _
                 "HD.invoiceamt AS HD_INV_AMT,HD.amounttopay AS HD_AMT_TO_PAY,HD.amountpaid AS HD_AMT_PAID,DET.Debit AS DET_DEBIT, DET.CREDIT AS DET_CREDIT,HD.DUEDATE AS HD_DUEDATE,DET.Acct_Code AS DET_ACCT_CODE " & _
                 "FROM  AMIS_Journal_HD HD INNER JOIN AMIS_Journal_Det DET ON HD.VoucherNo = DET.VoucherNo AND HD.jtype = DET.jtype " & _
                 "WHERE HD.JType IN ('APJ','VPJ','CRJ','GJ','VDJ','VCJ') AND LEFT(DET.Acct_Code,5) IN ('21-01','21-02','21-07','21-06') and HD.status='P' and HD.jdate < = '" & dtpAsOF & "'", gconDMIS, adOpenKeyset
    Label11.Caption = "Processing AP... Please Wait.."
...
Private Sub optAccount_Click()
    If COMPANY_CODE = "MGS" Or COMPANY_CODE = "DJM" Or COMPANY_CODE = "DPI" Or COMPANY_CODE = "DMI" Or COMPANY_CODE = "HSB" Or COMPANY_CODE = "HLB" Or COMPANY_CODE = "HBC" Or COMPANY_CODE = "HCR" Or COMPANY_CODE = "DAI" Or COMPANY_CODE = "HMR" Or COMPANY_CODE = "HSM" Or COMPANY_CODE = "HCA" Or COMPANY_CODE = "FMC" Or COMPANY_CODE = "HCE" Or COMPANY_CODE = "HMH" Or COMPANY_CODE = "DGI" Or COMPANY_CODE = "HQA" Or COMPANY_CODE = "DSSC" Or COMPANY_CODE = "HGS" Then
        ...
        'rsChartOfAccounts.Open "SELECT ACCTCODE,DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('21-01','21-02','21-03','21-04','21-05','21-06','21-07') AND IS_SCHEDULE_ACCNT=1", gconDMIS, adOpenKeyset
         rsChartOfAccounts.Open "SELECT ACCTCODE,DESCRIPTION FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,2) = '21' AND IS_SCHEDULE_ACCNT=1", gconDMIS, adOpenKeyset
...
Function Setacctcode(xDescription As String) As String
    ...
    'rsDescription.Open "SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,5) IN ('21-01','21-02','21-03','21-04','21-05','21-06','21-07') AND IS_SCHEDULE_ACCNT=1 AND DESCRIPTION = '" & xDescription & "'", gconDMIS, adOpenKeyset
    rsDescription.Open "SELECT ACCTCODE FROM AMIS_CHARTACCOUNT WHERE LEFT(ACCTCODE,2) = '21' AND IS_SCHEDULE_ACCNT=1 AND DESCRIPTION = '" & xDescription & "'", gconDMIS, adOpenKeyset
